Public Class Item_Group_Name_Duplicate_List
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        get_Duplicate_Item_Group_Name_List()
    End Sub
    ...
    Private Sub get_Duplicate_Item_Group_Name_List()
        ...
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Int1) select sur_name, count(*) from ItemGroup_Head Where sur_name <> '' group by sur_name having count(*) > 1"
        Cmd.ExecuteNonQuery()

        Cmd.CommandText = "select ItemGroup_IdNo, ItemGroup_Name  from ItemGroup_Head Where sur_name IN (Select sq1.Name1 from " & Trim(Common_Procedures.EntryTempTable) & " sq1) Order by ItemGroup_Name, ItemGroup_IdNo"
        ...
        With dgv_Details
            ...
            If dt1.Rows.Count > 0 Then
                ...
                For i = 0 To dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(1).Value = dt1.Rows(i).Item("ItemGroup_IdNo").ToString
                    .Rows(n).Cells(2).Value = dt1.Rows(i).Item("ItemGroup_Name").ToString
    ...
    Private Sub dgv_Details_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_Details.CellDoubleClick
        If Val(dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(1).Value) <> 0 Then

            Dim f As New ItemGroup_Creation
            f.MdiParent = MDIParent1
            f.Show()
            f.move_record(Val(dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(1).Value))
