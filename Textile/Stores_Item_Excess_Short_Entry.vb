Public Class Stores_Item_Excess_Short_Entry
    ...
    Private Pk_Condition As String = "IESE-"
    ...
    Private Sub Item_Excess_Short_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Item_Excess_Short_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Item_Excess_Short_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
        ...
        End Try
    End Sub
    Private Sub Item_Excess_Short_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt1 As New DataTable
        ...
        AddHandler txt_Scrap_Old_Qty.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name, d.Unit_name, e.Brand_Name from Stores_Item_Excess_Short_Entry_Head a INNER JOIN Stores_item_head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno LEFT OUTER JOIN Unit_Head d ON b.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head e ON a.Brand_idno = e.Brand_idno where a.Item_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Item_Excess_Short_No").ToString
                dtp_date.Text = dt1.Rows(0).Item("Item_Excess_Short_Date").ToString
                ...
                cbo_Excess_Short.Text = dt1.Rows(0).Item("Item_Excess_Short").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Excess_Short, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Excess_Short, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Stores_Item_Excess_Short_Entry, New_Entry, Me, con, "stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Entry_Code", NewCode, "Item_Excess_Short_Entry_Date", "(Item_Excess_Short_Entry_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Item_Excess_Short_Code, Company_IdNo, for_OrderBy", trans)
        ...
        Try
            ...
            cmd.CommandText = "delete from Stores_Item_Excess_Short_Entry_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Excess_Short, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Excess_Short, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
            If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Stores_Item_Excess_Short_Entry, New_Entry, Me) = False Then Exit Sub

            inpno = InputBox("Enter New Ref.No.", "FOR NEW NO INSERTION...")

            RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("select Item_Excess_Short_No from Stores_Item_Excess_Short_Entry_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Excess_Short_No from Stores_Item_Excess_Short_Entry_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Excess_Short_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Excess_Short_No from Stores_Item_Excess_Short_Entry_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Excess_Short_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Excess_Short_No from Stores_Item_Excess_Short_Entry_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Excess_Short_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Excess_Short_No from Stores_Item_Excess_Short_Entry_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Excess_Short_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        vOrdByNo = Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text)
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Entry_Stores_Item_Excess_Short, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Stores_Item_Excess_Short_Entry, New_Entry, Me, con, "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Entry_Code", NewCode, "Item_Excess_Short_Entry_Date", "(Item_Excess_Short_Entry_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Entry_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Item_Excess_Short_Entry_No desc", dtp_date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            cmd.Parameters.AddWithValue("@Excess_ShortDate", dtp_date.Value.Date)

            If New_Entry = True Then
                cmd.CommandText = "Insert into Stores_Item_Excess_Short_Entry_Head(Item_Excess_Short_Code, Company_IdNo, Item_Excess_Short_No, for_OrderBy, Item_Excess_Short_Date, Item_IdNo, Brand_IdNo, Unit_IdNo, Qty_New, Qty_Old_Usable, Qty_Old_Scrap, Item_Excess_Short) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @Excess_ShortDate,  " & Str(Val(Item_ID)) & ", " & Str(Val(Brand_ID)) & ", " & Str(Val(Unit_ID)) & ", " & Val(txt_New_Qty.Text) & ", " & Val(txt_Usable_Old_Qty.Text) & ", " & Val(txt_Scrap_Old_Qty.Text) & ", '" & Trim(cbo_Excess_Short.Text) & "')"
                cmd.ExecuteNonQuery()

            Else

                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)

                cmd.CommandText = "Update Stores_Item_Excess_Short_Entry_Head set  Item_Excess_Short_Date = @Excess_ShortDate , Item_IdNo = " & Str(Val(Item_ID)) & " , Brand_IdNo = " & Str(Val(Brand_ID)) & ", Unit_IdNo = " & Str(Val(Unit_ID)) & ", Qty_New = " & Val(txt_New_Qty.Text) & " , Qty_Old_Usable = " & Val(txt_Usable_Old_Qty.Text) & ", Qty_Old_Scrap = " & Val(txt_Scrap_Old_Qty.Text) & ", Item_Excess_Short = '" & Trim(cbo_Excess_Short.Text) & "' Where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Stores_Item_Excess_Short_Entry_Head", "Item_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)

            EntID = Trim(Pk_Condition) & Trim(lbl_RefNo.Text)
            PBlNo = Trim(lbl_RefNo.Text)
            Partcls = "ExcSht : Ref.No. " & Trim(lbl_RefNo.Text)
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Excess_Short_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Item_Excess_Short_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Excess_Short_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.item_name, c.unit_name from Stores_Item_Excess_Short_Entry_Head a left outer join Stores_item_head b on a.item_idno = b.item_idno left outer join unit_head c on b.unit_idno = c.unit_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Item_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by Item_Excess_Short_Date, for_orderby, Item_Excess_Short_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Item_Excess_Short_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Item_Excess_Short_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Stores_Item_Excess_Short_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Stores_Item_Excess_Short_Entry_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from Stores_Item_Excess_Short_Entry_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name, d.Unit_name, e.Brand_Name from Stores_Item_Excess_Short_Entry_Head a INNER JOIN Stores_item_head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno LEFT OUTER JOIN Unit_Head d ON b.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head e ON a.Brand_idno = e.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Try
            If prn_HdDt.Rows.Count > 0 Then
                ...
                CurY = CurY + TxtHgt + 10
                Common_Procedures.Print_To_PrintDocument(e, "ITEM EXCESS\SHORT", LMargin + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + qo1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Item_Excess_Short").ToString, LMargin + qo1 + 30, CurY, 0, 0, p1Font)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "ITEM EXCESS\SHORT ENTRY", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, "NO : " & prn_HdDt.Rows(0).Item("Item_Excess_Short_No").ToString, LMargin + 10, CurY, 0, 0, pFont)

        Common_Procedures.Print_To_PrintDocument(e, "DATE  : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Item_Excess_Short_Date").ToString), "dd-MM-yyyy").ToString, LMargin + 400 + 10, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_Excess_Short_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Excess_Short.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Excess_Short, txt_Scrap_Old_Qty, Nothing, "", "", "", "")

        If e.KeyCode = 40 Then
            If cbo_Excess_Short.DroppedDown = False Then
    ...
    Private Sub cbo_Excess_Short_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Excess_Short.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Excess_Short, Nothing, "", "", "", "(Brand_idno = 0)")
