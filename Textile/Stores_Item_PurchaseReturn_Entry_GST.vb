Public Class Stores_Item_PurchaseReturn_Entry_GST
    ...
    Private Pk_Condition As String = "GITPR-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Stores_Item_PurchaseReturn_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  Where a.Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Store_purchase_Return_entry, "~L~") = 0 And InStr(Common_Procedures.UR.Store_purchase_Return_entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(PurchaseReturn_Quantity) from Stores_Item_PurchaseReturn_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.CommandText = "Update Stores_Item_PO_Details Set Purchased_Quantity = a.Purchased_Quantity - b.Quantity from Stores_Item_PO_Details a, Stores_Item_PurchaseReturn_Details b where b.Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Entry_Type = 'PO' and a.Po_Code = b.Po_Code and a.PO_Details_SlNo = b.PO_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Stores_Item_PurchaseReturn_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Stores_Item_PurchaseReturn_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Store_purchase_Return_entry, "~L~") = 0 And InStr(Common_Procedures.UR.Store_purchase_Return_entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

            inpno = InputBox("Enter New Ref No.", "FOR NEW NO INSERTION...")

            RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("select Item_PurchaseReturn_No from Stores_Item_PurchaseReturn_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_PurchaseReturn_Code LIKE '" & Trim(Pk_Condition) & "%' AND Item_PurchaseReturn_Code = '" & Trim(Pk_Condition) & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_PurchaseReturn_No from Stores_Item_PurchaseReturn_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_PurchaseReturn_Code LIKE '" & Trim(Pk_Condition) & "%' AND Item_PurchaseReturn_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_PurchaseReturn_No", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_PurchaseReturn_Head", "Item_PurchaseReturn_Code", "For_OrderBy", "Item_PurchaseReturn_Code LIKE '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.userright_check(Common_Procedures.UR.Store_purchase_Return_entry, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_PurchaseReturn_Head", "Item_PurchaseReturn_Code", "For_OrderBy", "Item_PurchaseReturn_Code LIKE '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If Common_Procedures.Voucher_Updation(con, "Gst.Store.Purc.Return", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_date.Text), "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
        ...
        Catch ex As Exception
            ...
            ElseIf InStr(1, LCase(ex.Message), "ck_Stores_Item_PurchaseReturn_Details_1") > 0 Then
                MessageBox.Show("Invalid Purchase Return quantity", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)

            ElseIf InStr(1, LCase(ex.Message), "ck_Stores_Item_PurchaseReturn_Details_2") > 0 Then
    ...
    Private Sub NetAmount_Calculation()
        ...
        Dim tol_NetAmount As Double
        Dim tol_NetA As Double
        If FrmLdSTS = True Or NoCalc_Status = True Then Exit Sub
        ...
        NtAmt = Val(GrsAmt) - Val(lbl_DiscAmount.Text) + Val(lbl_CGST_Amount.Text) + Val(lbl_SGST_Amount.Text) + Val(lbl_IGST_Amount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text)
        tol_NetAmount = Format(Val(NtAmt), "#########0")

        lbl_NetAmount.Text = Common_Procedures.Currency_Format(Val(CSng(tol_NetAmount)))
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "PURCHASE RETURN", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
    ...
    Private Sub txt_AddLess_TextChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_AddLess.TextChanged
        TotalQuantity_Calculation()
        NetAmount_Calculation()
    End Sub
End Class