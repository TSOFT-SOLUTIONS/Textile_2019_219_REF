Public Class Stores_Item_Duplicate_List
    ...
    Private Sub get_Duplicate_Item_Name_List()
        ...
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Int1) select sur_name, count(*) from Stores_Item_Head Where sur_name <> '' group by sur_name having count(*) > 1"
        Cmd.ExecuteNonQuery()

        Cmd.CommandText = "select Item_IdNo, Item_Name  from Stores_Item_Head Where sur_name IN (Select sq1.Name1 from " & Trim(Common_Procedures.EntryTempTable) & " sq1) Order by Item_Name, Item_IdNo"
        ...
        With dgv_Details
            ...
            If dt1.Rows.Count > 0 Then
                ...
                For i = 0 To dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(1).Value = dt1.Rows(i).Item("Item_IdNo").ToString
