...
Public Class Cetegory_Creation
    ...
    Private Sub Cetegory_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Common_Procedures.settings.CustomerCode = "1308" Then
            Label4.Text = "Product Company Creation"
            Me.Text = "Product Company Creation"
        End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Category_Creation, "~L~") = 0 And InStr(Common_Procedures.UR.Category_Creation, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
