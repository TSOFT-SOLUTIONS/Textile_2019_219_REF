...
Public Class Fibre_Purchase_Order_GST
    ...
    Private Pk_Condition As String = "GFIPO-"           '  "GYPRO-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Fibre_Purchase_Order_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' and Entry_VAT_GST_Type = 'GST'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Fibre_Purchase_Order_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Fibre_Purchase_Order_Date")
                ...
                '  da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Mill_Name, c.Count_name , D.Colour_Name from Fibre_Purchase_Order_Details a INNER JOIN Mill_Head b ON a.Mill_IdNo = b.Mill_IdNo INNER JOIN Count_Head c ON a.Count_IdNo = c.Count_IdNo LEFT OUTER JOIN COLOUR_Head d ON a.Colour_IdNo = d.Colour_IdNo Where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Mill_Name, c.Fibre_name , D.Colour_Name from Fibre_Purchase_Order_Details a INNER JOIN Mill_Head b ON a.Mill_IdNo = b.Mill_IdNo INNER JOIN Fibre_Head c ON a.Fibre_IdNo = c.Fibre_IdNo LEFT OUTER JOIN COLOUR_Head d ON a.Colour_IdNo = d.Colour_IdNo Where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(dgvCol_Details.Count).Value = Common_Procedures.Fibre_IdNoToName(con, Val(dt2.Rows(i).Item("Fibre_idno").ToString))
                            ' .Rows(n).Cells(dgvCol_Details.Mill_Name).Value = dt2.Rows(i).Item("Mill_Name").ToString
                            .Rows(n).Cells(dgvCol_Details.Bag).Value = Val(dt2.Rows(i).Item("Bale").ToString)
                            ...
                            End If
                            .Rows(n).Cells(dgvCol_Details.Detail_slno).Value = Val(dt2.Rows(i).Item("Fibre_Purchase_Order_Details_Slno").ToString)
                            .Rows(n).Cells(dgvCol_Details.purchase_bags).Value = Val(dt2.Rows(i).Item("Purchase_Bale").ToString)
                            ...
                            If Val(.Rows(n).Cells(dgvCol_Details.purchase_weight).Value) <> 0 Then
                                For j = 0 To .ColumnCount - 1
                                    ...
                                    If j <> dgvCol_Details.cone_per_bag And j <> dgvCol_Details.Cancel_Order Then
                            ...
                            .Rows(n).Cells(dgvCol_Details.cone_per_bag).Value = Val(dt2.Rows(i).Item("Cones_per_Bale").ToString)
                            .Rows(n).Cells(dgvCol_Details.Wt_per_bag).Value = Format(Val(dt2.Rows(i).Item("Wgt_per_Bale").ToString), "########0.00")
                        Next i
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(7).Value = Format(Val(dt1.Rows(0).Item("Total_Weight").ToString), "########0.00")
                    .Rows(0).Cells(10).Value = Format(Val(dt1.Rows(0).Item("Total_Amount").ToString), "########0.00")
                End With

                da4 = New SqlClient.SqlDataAdapter("Select a.* from Fibre_Purchase_Order_GST_Tax_Details a Where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
    ...
    Private Sub Fibre_Purchase_Order_GST_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Fibre_Purchase_Order_GST_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then
            ...
            lbl_heading.Text = "GENERAL PURCHASE ORDER"
    ...
    Private Sub Fibre_Purchase_Order_GST_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub Fibre_Purchase_Order_GST_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '    If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Purchase_Order_Entry, New_Entry, Me, con, "Fibre_Purchase_Order_Head", "Fibre_Purchase_Order_Code", NewCode, "Fibre_Purchase_Order_Date", "(Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            ...
            If Val(Common_Procedures.get_FieldValue(con, "Fibre_Purchase_Order_Head", "Verified_Status", "(Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Purchase_Weight) from Fibre_Purchase_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
        ...
        Try
            ...
            ' Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Purchase_Order_Head", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Yarn_Purchase_Order_Code, Company_IdNo, for_OrderBy", trans)
            ' Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Yarn_Purchase_Order_Details", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Yarn_Purchase_Order_Code, For_OrderBy, Company_IdNo, Fibre_Purchase_Order_No, Yarn_Purchase_Order_Date, Ledger_Idno", trans)


            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Purchase_Order_Head", "Fibre_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Fibre_Purchase_Order_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Fibre_Purchase_Order_Details", "Fibre_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Fibre_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Fibre_Purchase_Order_Code, For_OrderBy, Company_IdNo, Fibre_Purchase_Order_No, Fibre_Purchase_Order_Date, Ledger_Idno", trans)


            cmd.CommandText = "delete from Fibre_Purchase_Order_GST_Tax_Details  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()


            cmd.CommandText = "delete from Fibre_Purchase_Order_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Fibre_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Purchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Purchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Fibre_Purchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Fibre_Purchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Purchase_Order_Head", "Fibre_Purchase_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red


            msk_Date.Text = Date.Today.ToShortDateString
            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*,  c.ledger_name as TaxAcName from Fibre_Purchase_Order_Head a  LEFT OUTER JOIN Ledger_Head c ON a.TaxAc_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Fibre_Purchase_Order_No desc", con)
            Da1.Fill(Dt1)

            If Dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If Dt1.Rows(0).Item("Fibre_Purchase_Order_Date").ToString <> "" Then msk_Date.Text = Dt1.Rows(0).Item("Fibre_Purchase_Order_Date").ToString
                End If
                ...
                Da1 = New SqlClient.SqlDataAdapter("Select a.* from fibre_Purchase_Order_Details a Where a.fibre_Purchase_Order_Code = '" & Trim(Dt1.Rows(0).Item("fibre_Purchase_Order_Code").ToString) & "' Order by a.sl_no", con)
                Dt2 = New DataTable
                Da1.Fill(Dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Purchase_Order_No from Fibre_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        '     If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Yarn_Purchase_Order_Entry, New_Entry, Me, con, "Fibre_Purchase_Order_Head", "Fibre_Purchase_Order_Code", NewCode, "Fibre_Purchase_Order_Date", "(Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Fibre_Purchase_Order_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            If Not (Val(Common_Procedures.User.IdNo) = 1 Or Common_Procedures.User.Show_Verified_Status = 1) Then
                ...
                If Val(Common_Procedures.get_FieldValue(con, "Fibre_Purchase_Order_Head", "Verified_Status", "(Fibre_Purchase_Order_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(dgvCol_Details.Bag).Value) <> 0 Or Val(.Rows(i).Cells(dgvCol_Details.cones).Value) <> 0 Then
                    ...
                    Cnt_ID = Common_Procedures.Fibre_NameToIdNo(con, .Rows(i).Cells(dgvCol_Details.Count).Value)
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vTotCns = Val(dgv_Details_Total.Rows(0).Cells(5).Value())
            vTotWght = Val(dgv_Details_Total.Rows(0).Cells(7).Value())
            vTotCancel_Wght = Val(dgv_Details_Total.Rows(0).Cells(12).Value())
        End If
        ...
        Else
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Purchase_Order_Head", "Fibre_Purchase_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
        ...
        cmd.CommandText = "Delete from Fibre_Purchase_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' and Purchase_Weight = 0 "
        cmd.ExecuteNonQuery()
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(dgvCol_Details.weight).Value) <> 0 Then
                    ...
                    Cnt_ID = Common_Procedures.Fibre_NameToIdNo(con, .Rows(i).Cells(dgvCol_Details.Count).Value, tr)
                    ...
                    Nr = 0
                    cmd.CommandText = "Update  Fibre_Purchase_Order_Details set Fibre_Purchase_Order_Date = @PurchaseDate ,Ledger_IdNo = " & Val(Led_ID) & ", Sl_No  = " & Str(Val(Sno)) & " , Fibre_idno = " & Str(Val(Cnt_ID)) & " ,  Mill_IdNo =  " & Str(Val(Mill_ID)) & ", Bale = " & Str(Val(.Rows(i).Cells(dgvCol_Details.Bag).Value)) & " , Cones = " & Str(Val(.Rows(i).Cells(dgvCol_Details.cones).Value)) & " ,       Weight = " & Str(Val(.Rows(i).Cells(dgvCol_Details.weight).Value)) & ",Rate_For= '" & Trim(.Rows(i).Cells(dgvCol_Details.Rate_for).Value) & "',Rate =  " & Str(Val(.Rows(i).Cells(dgvCol_Details.rate).Value)) & ",Amount =  " & Str(Val(.Rows(i).Cells(dgvCol_Details.amount).Value)) & " ,Colour_Idno = " & Str(Val(clr_ID)) & " , Cancelled_Weight = " & Val(.Rows(i).Cells(dgvCol_Details.Cancel_Order).Value) & "             where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'  and Fibre_Purchase_Order_Details_SlNo = " & Val(.Rows(i).Cells(dgvCol_Details.Detail_slno).Value)
                    Nr = cmd.ExecuteNonQuery()

                    If Nr = 0 Then


                        cmd.CommandText = "Insert into Fibre_Purchase_Order_Details ( Fibre_Purchase_Order_Code  ,               Company_IdNo       ,   Fibre_Purchase_Order_No      ,                     for_OrderBy                    , Fibre_Purchase_Order_Date,       Ledger_IdNo       ,            Sl_No     ,        Fibre_IdNo       ,          Mill_IdNo       ,                       Bale                                 ,                     Cones                                     ,                           Weight                          ,                   Rate_For                                        ,                     Rate                                 ,                               Amount                   ,                   Colour_Idno              ,    Cash_Discount_Percentage                                 ,    Cash_Discount_Amount                                    ,                 Taxable_Value                                        ,  GST_Percentage                                                   ,                       HSN_Code                           ,     Ex_Mill                                                    ,     Cancelled_Weight                                                              ,Cones_per_Bale                         ,                              Wgt_per_Bale  ) " &
            ...
            Next
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Fibre_Purchase_Order_Details", "Fibre_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Fibre_IdNo,Mill_IdNo,Bale,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Fibre_Purchase_Order_Code, For_OrderBy, Company_IdNo, Fibre_Purchase_Order_No, Fibre_Purchase_Order_Date, Ledger_Idno", tr)
        ...
        With dgv_Tax_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                    ...
                    cmd.CommandText = "Insert into Fibre_Purchase_Order_GST_Tax_Details   ( Fibre_Purchase_Order_Code  ,               Company_IdNo       ,      Fibre_Purchase_Order_No         ,      for_OrderBy             , Fibre_Purchase_Order_Date    ,         Ledger_IdNo     ,            Sl_No     ,            HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " &
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Purchase_Order_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Fibre_Purchase_Order_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Purchase_Order_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(cbo_Filter_Count.Text) <> "" Then
                ...
                Cnt_IdNo = Common_Procedures.Fibre_NameToIdNo(con, cbo_Filter_Count.Text)
            End If
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.Fibre_Idno = " & Str(Val(Cnt_IdNo)) & " "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as PartyName, d.Ledger_Name as Delv_Name from Fibre_Purchase_Order_Head a INNER JOIN Fibre_Purchase_Order_Details b ON a.Fibre_Purchase_Order_Code = b.Fibre_Purchase_Order_Code INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON a.DeliveryTo_Idno = d.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Fibre_Purchase_Order_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from Fibre_Purchase_Order_Head a INNER JOIN Yarn_Purchase_Order_Details b ON a.Yarn_Purchase_Order_Code = b.Yarn_Purchase_Order_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Purchase_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Fibre_Purchase_Order_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Fibre_Purchase_Order_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Fibre_Purchase_Order_Date").ToString), "dd-MM-yyyy")
                    ...
                    dgv_Filter_Details.Rows(n).Cells(4).Value = Common_Procedures.Fibre_IdNoToName(con, Val(dt2.Rows(i).Item("Fibre_IdNo").ToString))
                ...
                If .Visible Then
                    If .Rows.Count > 0 Then
                        If CurCol = dgvCol_Details.Bag Or CurCol = dgvCol_Details.weight Or CurCol = dgvCol_Details.Rate_for Or CurCol = dgvCol_Details.rate Or CurCol = dgvCol_Details.Cancel_Order Or CurCol = dgvCol_Details.cone_per_bag Or CurCol = dgvCol_Details.Wt_per_bag Then
                            ...
                            If Trim(UCase(.Rows(CurRow).Cells(dgvCol_Details.Rate_for).Value)) = "BALE" Then
    ...
    Private Sub Printing_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Fibre_Purchase_Order_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                'da2 = New SqlClient.SqlDataAdapter("select a.*, b.Fibre_name , c.Mill_Name,b.Count_Description ,I.Item_GST_Percentage,i.Item_HSN_Code from Fibre_Purchase_Order_Details a INNER JOIN Fibre_Head b ON a.Fibre_idno = b.Fibre_idno LEFT OUTER JOIN Mill_Head c ON a.Mill_IdNo = c.Mill_IdNo LEFT OUTER JOIN ItemGroup_Head I ON b.ItemGroup_IdNo = I.ItemGroup_IdNo where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Fibre_Purchase_Order_No", con)

                da2 = New SqlClient.SqlDataAdapter("select a.* ,b.Fibre_Name ,b.GST_Percentage,b.HSN_Code from Fibre_Purchase_Order_Details a INNER JOIN Fibre_head b ON a.Fibre_idno = b.Fibre_idno where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Fibre_Purchase_Order_No", con)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1234" Then '-----ARULJOTHI EXPORTS PVT LTD
            Printing_Format2(e)
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1334" Then '-----ARULJOTHI EXPORTS PVT LTD
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, c.Ledger_Name as Transport_Name from Fibre_Purchase_Order_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno LEFT OUTER JOIN Ledger_Head c ON c.Ledger_IdNo = a.Transport_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Order_Code = '" & Trim(EntryCode) & "' Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Purchase_Order_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Purchase_Order_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Weight").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Amount").ToString, PageWidth - 15, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "BALE/BAG", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
    ...
    Private Sub cbo_Agent_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Agent.LostFocus
        ...
        If Trim(UCase(cbo_CommType.Text)) = "BALE" Then
    ...
    Private Sub cbo_Filter_Count_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_Count.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_Count, cbo_Filter_DeliveryAt, btn_Filter_Show, "Fibre_Head", "Fibre_Name", "", "(Fibre_IdNo = 0)")
    ...
    Private Sub cbo_Filter_Count_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_Count.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_Count, btn_Filter_Show, "Fibre_Head", "Fibre_Name", "", "(Fibre_IdNo = 0)")
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If IsDBNull(dt.Rows(0).Item("GST_Percentage").ToString) = False Then
                    ...
                    GST_PerCent = Format(Val(dt.Rows(0).Item("GST_Percentage").ToString), "##########0.00")
    ...
    Private Sub Printing_FormatGST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        If Common_Procedures.settings.CustomerCode = "1186" Then
            ...
            ClArr(1) = Val(40) : ClArr(2) = 250 : ClArr(3) = 80 : ClArr(4) = 55 : ClArr(5) = 0 : ClArr(6) = 0 : ClArr(7) = 85 : ClArr(8) = 90
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        CntName1 = prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString
                        ...
                        If Common_Procedures.settings.CustomerCode <> "1186" Then
                            ...
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont)
                            End If
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Cones").ToString) <> 0 Then
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        p1Font = New Font("Calibri", 16, FontStyle.Bold)
        If Common_Procedures.settings.CustomerCode = "1186" Then
            Common_Procedures.Print_To_PrintDocument(e, "GENERAL PURCHASE ORDER", LMargin, CurY, 2, PrintWidth, p1Font)
        Else
            Common_Procedures.Print_To_PrintDocument(e, " PURCHASE ORDER", LMargin, CurY, 2, PrintWidth, p1Font)
        End If
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            End If
            Common_Procedures.Print_To_PrintDocument(e, "RATE/" & prn_DetDt.Rows(0).Item("Rate_For").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
    ...
    Private Sub Printing_FormatGST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Bale").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 5, CurY, 1, 0, pFont)
            If Common_Procedures.settings.CustomerCode <> "1186" Then
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        ' Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 10, CurY, 0, 0, pFont)
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) - 5, CurY, 1, 0, pFont)
                        End If
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Cones").ToString) <> 0 Then
    ...
    Private Sub Printing_Format2GST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Bale").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) - 5, CurY, 1, 0, pFont)
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Fibre_Purchase_Order_GST_Tax_Details Where Fibre_Purchase_Order_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Purchase_Order_Head", "Delivery_Address", "", "")
    'End Sub
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_DeliveryAddress, cbo_Delvat, cbo_Agent, "Fibre_Purchase_Order_Head", "Delivery_Address", "", "")
    'End Sub
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_DeliveryAddress, cbo_Agent, "Fibre_Purchase_Order_Head", "Delivery_Address", "", "", False)
    'End Sub
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            If Val(LedIdNo) <> 0 Then
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Fibre_Purchase_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code   LEFT OUTER JOIN Fibre_Purchase_Order_Head d ON d.Fibre_Purchase_Order_Code = a.Own_Order_Code    where a.Fibre_Purchase_Order_Code = ''  and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
            ...
            Else
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Fibre_Purchase_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Purchase_Order_Code = '" & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno    LEFT OUTER JOIN Fibre_Purchase_Order_Head d ON d.Fibre_Purchase_Order_Code = a.Own_Order_Code    where a.Fibre_Purchase_Order_Code = ''   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
    ...
    Private Sub Printing_Format_1186(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(35) : ClArr(2) = 280 : ClArr(3) = 110 : ClArr(4) = 80 : ClArr(5) = 90
        ClArr(6) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5))
    ...
    Private Sub Printing_Format_1186_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        CurY = CurY + 10
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "PO No. : GN/PO-" & prn_HdDt.Rows(0).Item("Fibre_Purchase_Order_No").ToString & "/" & Common_Procedures.FnYearCode, LMargin + 10, CurY, 0, 0, p1Font)
        'strHeight1 = e.Graphics.MeasureString(prn_HdDt.Rows(0).Item("ClothPurchase_Order_No").ToString, p1Font).Height

        Common_Procedures.Print_To_PrintDocument(e, "PO Date : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Purchase_Order_date").ToString), "dd-MM-yyyy").ToString, LMargin + ClAr(1) + ClAr(2) - 30, CurY, 2, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "Party SO No. : " & prn_HdDt.Rows(0).Item("Party_OrderNo").ToString.ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, p1Font)


        CurY = CurY + TxtHgt
        e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), LnAr(15))
        e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + +ClAr(2) - 50, CurY, LMargin + ClAr(1) + ClAr(2) - 50, LnAr(15))
        e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
        LnAr(2) = CurY
        ...
        If Trim(prn_HdDt.Rows(0).Item("Attend").ToString) <> "" Then
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Kind Attn. :  ", LMargin + ClAr(1) + ClAr(2) + 65, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Mr." & Trim(prn_HdDt.Rows(0).Item("Attend").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 40, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "RATE/", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(0).Item("Rate_For").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY + 15, 2, ClAr(5), pFont)
        Common_Procedures.Print_To_PrintDocument(e, "AMOUNT", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont)

        CurY = CurY + 15

        Common_Procedures.Print_To_PrintDocument(e, "(Excl.gst)", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + 5, CurY, 2, ClAr(6), pFont)
        CurY = CurY + TxtHgt + 5
        e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
        LnAr(5) = CurY
        pFont = New Font("Calibri", 11, FontStyle.Regular)
    ...
    Private Sub Printing_Format_1186_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_Weight").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 5, CurY, 1, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_Amount").ToString), PageWidth - 5, CurY, 1, 0, pFont)
    ...
    Private Sub cbo_transportation_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_transportation.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Purchase_Order_Head", "Transportations", "", "(Fibre_Purchase_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_transportation.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_transportation, txt_DiscPerc, cbo_TaxType, "Fibre_Purchase_Order_Head", "Transportations", "", "(Fibre_Purchase_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_transportation.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_transportation, txt_Note, "Fibre_Purchase_Order_Head", "Transportations", "", "(Fibre_Purchase_Order_No = 0)", False)

    End Sub

    Private Sub cbo_Tax_Type_GotFocus(sender As Object, e As EventArgs) Handles cbo_tax_type.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Purchase_Order_Head", "taxtype", "", "(Fibre_Purchase_Order_No=0)")
    End Sub

    Private Sub cbo_tax_Type_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_tax_type.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_tax_type, msk_DeliveryDate, Nothing, "Fibre_Purchase_Order_Head", "taxtype", "", "(Fibre_Purchase_Order_No=0)")
        If (e.KeyValue = 40) Then
    ...
    Private Sub cbo_Tax_Type_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_tax_type.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_tax_type, Nothing, "Fibre_Purchase_Order_Head", "taxtype", "", "(Fibre_Purchase_Order_No = 0)", False)
        If Asc(e.KeyChar) = 13 Then
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(dgvCol_Details.Count)
    ...
    Private Sub Fibre_Purchase_Order_GST_Layout(sender As Object, e As LayoutEventArgs) Handles Me.Layout
    ...
    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles lbl_heading.Click
