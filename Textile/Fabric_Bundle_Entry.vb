...
Public Class Fabric_Bundle_Entry
    ...
    Private Sub Fabric_Bundle_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Common_Procedures.settings.CustomerCode = "1235" Then
            Label3.Visible = True
        ...
        AddHandler Cbo_Employee_Name.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Bundle_entry, New_Entry, Me, con, "Fabric_Bundle_Entry_Head", "Fabric_Bundle_Entry_Code", NewCode, "Fabric_Bundle_Entry_Date", "(Fabric_Bundle_Entry_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Bundle_entry, New_Entry, Me) = False Then Exit Sub
        Try
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        vEmpName = Common_Procedures.Employee_Simple_NameToIdNo(con, Cbo_Employee_Name.Text)
        If Val(lbl_Company.Tag) = 0 Then
            MessageBox.Show("Invalid Company Selection", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If

        '    If Common_Procedures.UserRight_Check(Common_Procedures.UR.Bundle_entry, New_Entry) = False Then Exit Sub
        NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(vEntFnYrCode)
        ' If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Bundle_entry, New_Entry, Me, con, "Fabric_Bundle_Entry_Head", "Fabric_Bundle_Entry_Code", NewCode, "Fabric_Bundle_Entry_Date", "(Fabric_Bundle_Entry_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fabric_Bundle_Entry_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Fabric_Bundle_Entry_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Fabric_Bundle_Entry_Head(Fabric_Bundle_Entry_Code, Company_IdNo, Fabric_Bundle_Entry_No, for_OrderBy, Fabric_Bundle_Entry_Date, Total_Bundles, Total_Pcs, Total_Meters, User_idNo,Employee_IdNo) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(vTotBndls)) & ", " & Str(Val(vTotPcs)) & ", " & Str(Val(vTotYrds)) & " ,  " & Val(Common_Procedures.User.IdNo) & " ," & Val(vEmpName) & ")"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Fabric_Bundle_Entry_Head set Fabric_Bundle_Entry_Date = @EntryDate, Total_Bundles = " & Str(Val(vTotBndls)) & ", Total_Pcs = " & Str(Val(vTotPcs)) & ", Total_Meters = " & Str(Val(vTotYrds)) & " ,  User_idNo = " & Str(Val(Common_Procedures.User.IdNo)) & ",Employee_IdNo=" & Val(vEmpName) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fabric_Bundle_Entry_Code = '" & Trim(NewCode) & "' "
                cmd.ExecuteNonQuery()
    ...
    Private Sub Cbo_Employee_Name_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_Employee_Name.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_Employee_Name, dtp_Filter_ToDate, dgv_Details, "Employee_Head", "Employee_Name", "", "(Employee_IdNo=0)")
    ...
    Private Sub Cbo_Employee_Name_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_Employee_Name.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, Cbo_Employee_Name, "Employee_Head", "Employee_Name", "", "(Employee_IdNo=0)")
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update Fabric_Bundle_Entry_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fabric_Bundle_Entry_Code  = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
