Public Class Production_Entry
    ...
    Private Pk_Condition2 As String = "PRODU-"
    ...
    Private Chees_Wgt As Double
    Private Bag_Wgt As Double
    Private Cover_Wgt As Double
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Production_No from Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Production_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, Production_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Production_No from Production_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Production_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, Production_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Production_No from Production_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Production_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, Production_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Production_No from Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Production_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, Production_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Production_Head", "Production_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        With dgv_Details
            For i = 0 To dgv_Details.RowCount - 1
                If Trim(.Rows(i).Cells(2).Value) <> "" Or Val(.Rows(i).Cells(5).Value) <> 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Production_Head", "Production_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        cmd.CommandText = "Insert into Production_Details(Production_Code, Company_IdNo, Production_No, for_OrderBy, Production_Date,Sl_No, Count_IdNo, Carding_Weight , Waste_Weight  ,Invisible_Waste_Weight ,Mixed_Weight  , Production_Weight  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @PrdDate," & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & " , " & Str(Val(.Rows(i).Cells(2).Value)) & " , " & Val(.Rows(i).Cells(3).Value) & ", " & Val(.Rows(i).Cells(4).Value) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & " , " & Str(Val(.Rows(i).Cells(6).Value)) & ")"
                        cmd.ExecuteNonQuery()

                        cmd.CommandText = "Insert into Stock_LooseYarn_Processing_Details ( Reference_Code                        ,             Company_IdNo                 ,           Reference_No        ,                               For_OrderBy      ,        Reference_Date,     Party_Bill_No       ,    Entry_ID       ,            Sl_No      ,            Count_idNo,      Weight                ) " & _
                                                                    " Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PrdDate   , '" & Trim(PBlNo) & "','" & Trim(EntID) & "' , " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & "," & Str(Val(.Rows(i).Cells(6).Value)) & " )"
                        cmd.ExecuteNonQuery()
                        cmd.CommandText = "Insert into Stock_Mixing_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy             ,        Reference_Date , Entry_ID    ,     Party_Bill_No   ,   Sl_No                     ,               Count_IdNo   ,      Weight             ) " & _
                                                          "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PrdDate   , '" & Trim(EntID) & "' ,'" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ",  " & Str(-1 * Val(.Rows(i).Cells(5).Value)) & " )"
                        cmd.ExecuteNonQuery()

                        cmd.CommandText = "Insert into Stock_Carding_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy           ,        Reference_Date ,  Entry_ID                  ,   Party_Bill_No   ,   Sl_No                     ,               Count_IdNo   ,      Weight             ) " & _
                                                         "   Values  ('" & Trim(Pk_Condition2) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PrdDate   , '" & Trim(EntID) & "' ,'" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ",  " & Str(-1 * Val(.Rows(i).Cells(6).Value)) & " )"
                        cmd.ExecuteNonQuery()

                        cmd.CommandText = "Insert into Stock_Carding_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,             For_OrderBy         ,        Reference_Date, Entry_ID        ,   Party_Bill_No   ,   Sl_No    ,   Count_IdNo   ,      Weight             ) " & _
                                  "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PrdDate   ,'" & Trim(EntID) & "' , '" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ",  " & Str(Val(.Rows(i).Cells(2).Value)) & " )"
                        cmd.ExecuteNonQuery()

                        cmd.CommandText = "Insert into Stock_Waste_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                    , Reference_Date,     Party_Bill_No   ,  Entry_ID           ,     Sl_No             ,        Count_IdNo      ,    Variety_IdNo      , Lot_No   ,  Weight             ) " & _
                                                         "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PrdDate   , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "' ," & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ",     1              ,  ''        , " & Str(Val(.Rows(i).Cells(3).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            If .Visible Then
                If .CurrentCell.ColumnIndex = 2 Or .CurrentCell.ColumnIndex = 3 Or .CurrentCell.ColumnIndex = 4 Or .CurrentCell.ColumnIndex = 5 Or .CurrentCell.ColumnIndex = 6 Then
                    If Val(.CurrentCell.ColumnIndex) = 2 Or Val(.CurrentCell.ColumnIndex) = 3 Or Val(.CurrentCell.ColumnIndex) = 4 Then
                        .Rows(.CurrentCell.RowIndex).Cells(5).Value = Format(Val(dgv_Details.Rows(.CurrentCell.RowIndex).Cells(2).Value) + (Val(dgv_Details.Rows(.CurrentCell.RowIndex).Cells(3).Value) + Val(dgv_Details.Rows(.CurrentCell.RowIndex).Cells(4).Value)), "###########0.000")
                    End If
                    Total_Calculation()
                End If
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from Production_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Production_Code = '" & Trim(NewCode) & "'", con)
