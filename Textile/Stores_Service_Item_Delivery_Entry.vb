Public Class Stores_Service_Item_Delivery_Entry
    ...
    Private Pk_Condition As String = "SERDC-"
    Private Pk_Condition1 As String = "SEDAT-"
    ...
    Private Sub Service_Item_Delivery_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Service_Item_Delivery_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Service_Item_Delivery_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Service_Item_Delivery_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim da As New SqlClient.SqlDataAdapter
        ...
        cbo_Unreturnable.Items.Clear()
        cbo_Unreturnable.Items.Add("RETURN")
        cbo_Unreturnable.Items.Add("UN RETURN")
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Issued_Name) from Stores_Service_Delivery_Head order by Issued_Name", con)
        da.Fill(dt6)
        cbo_Issued.DataSource = dt6
        cbo_Issued.DisplayMember = "Issued_Name"

        da = New SqlClient.SqlDataAdapter("select distinct(Received_Name) from Stores_Service_Delivery_Head order by Received_Name ", con)
        da.Fill(dt7)
        ...
        AddHandler cbo_Unreturnable.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_Unreturnable.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Particulars.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Particulars.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_DisplayName from Stores_Service_Delivery_Head a INNER JOIN Ledger_AlaisHead b ON a.Ledger_IdNo = b.Ledger_IdNo Where a.Service_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Service_Delivery_No").ToString
                dtp_date.Text = dt1.Rows(0).Item("Service_Delivery_Date").ToString
                ...
                cbo_Unreturnable.Text = dt1.Rows(0).Item("UnReturnable").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name, d.Unit_name, e.Machine_name, f.Brand_Name from Stores_Service_Delivery_Details a INNER JOIN Stores_item_head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Machine_Head e ON a.Machine_idno = e.Machine_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Service_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Service_Delivery_Details_SlNo").ToString

                        If Val(dt2.Rows(i).Item("Receipt_Quantity").ToString) <> 0 Then
                            LockSTS = True
                        End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Service_Item_Delivery, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Service_Item_Delivery, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Store_Service_Delivery_Entry, New_Entry, Me, con, "Stores_Service_Delivery_Head", "Service_Delivery_Code", NewCode, "Service_Delivery_Date", "(Service_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Receipt_Quantity) from Stores_Service_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
                If Val(Dt1.Rows(0)(0).ToString) <> 0 Then
                    MessageBox.Show("Alreay some items received against this delivery", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Stores_Service_Delivery_Head", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Service_Delivery_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Stores_Service_Delivery_Details", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Item_IdNo, Brand_IdNo, Quantity, Unit_idNo, Machine_idNo, Receipt_Quantity", "Sl_No", "Service_Delivery_Code, For_OrderBy, Company_IdNo, Service_Delivery_No, Service_Delivery_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "Delete from Stores_Service_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Stores_Service_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Store_Service_Delivery_Entry, New_Entry, Me) = False Then Exit Sub
        

            ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Service_Item_Delivery, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Service_Item_Delivery, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

            inpno = InputBox("Enter New Dc.No.", "FOR NEW NO INSERTION...")

            RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("select Service_Delivery_No from Stores_Service_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Service_Delivery_No from Stores_Service_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Service_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Service_Delivery_No from Stores_Service_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Service_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Service_Delivery_No from Stores_Service_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Service_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Service_Delivery_No from Stores_Service_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Service_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Service_Delivery_Head", "Service_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Entry_Stores_Service_Item_Delivery, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Store_Service_Delivery_Entry, New_Entry, Me, con, "Stores_Service_Delivery_Head", "Service_Delivery_Code", NewCode, "Service_Delivery_Date", "(Service_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Service_Delivery_No desc", dtp_date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Service_Delivery_Head", "Service_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Stores_Service_Delivery_Head(Service_Delivery_Code, Company_IdNo, Service_Delivery_No, for_OrderBy, Service_Delivery_Date, Ledger_IdNo, Received_Name, Issued_Name, New_Old, Particulars, UnReturnable, Vehicle_No, Total_Quantity,    Remarks           ,  Freight                     ,Transport_Idno) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DcDate, " & Str(Val(Led_ID)) & ", '" & Trim(cbo_Received.Text) & "', '" & Trim(cbo_Issued.Text) & "','" & Trim(cbo_New_Old.Text) & "', '" & Trim(txt_Particulars.Text) & "', '" & Trim(cbo_Unreturnable.Text) & "','" & Trim(txt_Vehicle.Text) & "', " & Str(Val(vTotqty)) & " ,'" & Trim(txt_Remarks.Text) & "'," & Val(txt_Transport_Freight.Text) & " , " & Val(Trans_ID) & ")"
                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Stores_Service_Delivery_Head", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Service_Delivery_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Stores_Service_Delivery_Details", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo, Brand_IdNo, Quantity, Unit_idNo, Machine_idNo, Receipt_Quantity", "Sl_No", "Service_Delivery_Code, For_OrderBy, Company_IdNo, Service_Delivery_No, Service_Delivery_Date, Ledger_Idno", tr)

                cmd.CommandText = "Update Stores_Service_Delivery_Head set Issued_Name = '" & Trim(cbo_Issued.Text) & "', Service_Delivery_Date = @DcDate ,Ledger_IdNo = " & Str(Val(Led_ID)) & " , Received_Name = '" & Trim(cbo_Received.Text) & "', New_Old = '" & Trim(cbo_New_Old.Text) & "' , Particulars = '" & Trim(txt_Particulars.Text) & "', UnReturnable = '" & Trim(cbo_Unreturnable.Text) & "' , Vehicle_No = '" & Trim(txt_Vehicle.Text) & "' , Total_Quantity = " & Str(Val(vTotqty)) & ",Remarks = '" & Trim(txt_Remarks.Text) & "',Freight = " & Val(txt_Transport_Freight.Text) & ", Transport_Idno= " & Val(Trans_ID) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Stores_Service_Delivery_Head", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Service_Delivery_Code, Company_IdNo, for_OrderBy", tr)

          
            EntID = Trim(Pk_Condition) & Trim(lbl_DcNo.Text)
            PBlNo = Trim(lbl_DcNo.Text)
            Partcls = "Issue : Dc.No. " & Trim(lbl_DcNo.Text)
            cmd.CommandText = "Delete from Stores_Service_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "' and Receipt_Quantity = 0"
            cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Update Stores_Service_Delivery_Details set Service_Delivery_Date = @DcDate, Ledger_IdNo = " & Str(Val(Led_ID)) & ", Sl_No = " & Str(Val(Sno)) & ", Item_IdNo = " & Str(Val(Item_ID)) & ", Brand_IdNo = " & Str(Val(Brand_ID)) & ", Quantity = " & Str(Val(.Rows(i).Cells(5).Value)) & ", Unit_idNo = " & Str(Val(Unit_ID)) & ", Machine_idNo = " & Str(Val(Machine_ID)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "' and Service_Delivery_Details_SlNo = " & Str(Val(.Rows(i).Cells(8).Value))
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Stores_Service_Delivery_Details ( Service_Delivery_Code, Company_IdNo, Service_Delivery_No, for_OrderBy, Service_Delivery_Date, Ledger_IdNo, Sl_No, Item_IdNo, Brand_IdNo, Quantity, Unit_idNo, Machine_idNo, Receipt_Quantity) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DcDate, " & Str(Val(Led_ID)) & ", " & Str(Val(Sno)) & ", " & Str(Val(Item_ID)) & ", " & Str(Val(Brand_ID)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Val(Unit_ID) & ", " & Val(Machine_ID) & ", 0 )"
                            cmd.ExecuteNonQuery()
                        End If
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Stores_Service_Delivery_Details", "Service_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo, Brand_IdNo, Quantity, Unit_idNo, Machine_idNo, Receipt_Quantity", "Sl_No", "Service_Delivery_Code, For_OrderBy, Company_IdNo, Service_Delivery_No, Service_Delivery_Date, Ledger_Idno", tr)
            ...
            If Common_Procedures.Voucher_Updation(con, "SerItemDc.Frgt", Val(lbl_Company.Tag), Trim(Pk_Condition1) & Trim(NewCode), Trim(lbl_DcNo.Text), Convert.ToDateTime(dtp_date.Text), Trim(txt_Remarks.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub cbo_Grid_Department_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Department.KeyDown
        ...
        With dgv_Details
            ...
            If (e.KeyValue = 38 And cbo_Grid_Department.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                ...
                Else
                    .Focus()
                    .CurrentCell = dgv_Details.Rows(dgv_Details.CurrentRow.Index - 1).Cells(.ColumnCount - 2)
    ...
    Private Sub cbo_Received_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Received.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Received, cbo_Ledger, cbo_Issued, "Stores_Service_Delivery_Head", "Received_name", "", "")
    ...
    Private Sub cbo_Received_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Received.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Received, cbo_Issued, "Stores_Service_Delivery_Head", "Received_Name", "", "", False)
    End Sub
    ...
    Private Sub cbo_Issued_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Issued.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Issued, cbo_Received, cbo_New_Old, "Stores_Service_Delivery_Head", "Issued_Name", "", "")
    ...
    Private Sub cbo_Issued_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Issued.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Issued, cbo_New_Old, "Stores_Service_Delivery_Head", "Issued_Name", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Service_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Service_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Service_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.quantity, c.item_name, d.unit_name, e.Machine_Name from Stores_Service_Delivery_Head a left outer join Stores_Service_Delivery_Details b on a.Service_Delivery_Code = b.Service_Delivery_Code left outer join Stores_item_head c on b.item_idno = c.item_idno left outer join unit_head d on b.unit_idno = d.unit_idno left outer join Machine_head e on b.Machine_idno = e.Machine_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Service_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by Service_Delivery_Date, for_orderby, Service_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Service_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Service_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Store_Service_Delivery_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Stores_Service_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Service_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Stores_Service_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Service_Delivery_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, e.Machine_name, f.Brand_Name from Stores_Service_Delivery_Details a INNER JOIN Stores_item_head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Machine_Head e ON a.Machine_idno = e.Machine_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Service_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1391" Then '------------Sakthidharan
            NoofItems_PerPage = 5 '6 '7
        Else
            NoofItems_PerPage = 6 '7
        End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, e.Machine_name, f.Brand_Name from Stores_Service_Delivery_Details a INNER JOIN Stores_item_head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Machine_Head e ON a.Machine_idno = e.Machine_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Service_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "SERVICE DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("service_Delivery_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Service_Delivery_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_date, cbo_Received, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Unreturnable_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Unreturnable.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Unreturnable, txt_Particulars, txt_Vehicle, "", "", "", "")
    End Sub

    Private Sub cbo_Unreturnable_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Unreturnable.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Unreturnable, txt_Vehicle, "", "", "", "")
    End Sub
