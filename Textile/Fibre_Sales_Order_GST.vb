Public Class Fibre_Sales_Order_GST
    ...
    Private Pk_Condition As String = "GFISO-"          '"GYPRO-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Fibre_Sales_Order_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Sales_Order_Code = '" & Trim(NewCode) & "' and Entry_VAT_GST_Type = 'GST'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Fibre_Sales_Order_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Fibre_Sales_Order_Date")
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Mill_Name, c.Fibre_name , D.Colour_Name from Fibre_Sales_Order_Details a INNER JOIN Mill_Head b ON a.Mill_IdNo = b.Mill_IdNo INNER JOIN Fibre_Head c ON a.Fibre_IdNo = c.Fibre_IdNo LEFT OUTER JOIN COLOUR_Head d ON a.Colour_IdNo = d.Colour_IdNo Where a.Fibre_Sales_Order_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(dgvCol_Details.Count).Value = dt2.Rows(i).Item("Fibre_Name").ToString
                            ...
                            End If
                            .Rows(n).Cells(dgvCol_Details.Detail_slno).Value = Val(dt2.Rows(i).Item("Fibre_Sales_Order_Details_Slno").ToString)
                            ...
                            .Rows(n).Cells(dgvCol_Details.invoice_bags).Value = Val(dt2.Rows(i).Item("invoice_Bale").ToString)
                ...
                da4 = New SqlClient.SqlDataAdapter("Select a.* from Fibre_Sales_Order_GST_Tax_Details a Where a.Fibre_Sales_Order_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
    ...
    Private Sub Fibre_Sales_Order_GST_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Fibre_Sales_Order_GST_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then
            lbl_heading.Text = "GENERAL SALES ORDER"
            Me.Text = "GENERAL SALES ORDER"
        End If
    ...
    Private Sub Fibre_Sales_Order_GST_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub Fibre_Sales_Order_GST_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '    If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Purchase_Order_Entry, New_Entry, Me, con, "Fibre_Sales_Order_Head", "Fibre_Sales_Order_Code", NewCode, "Fibre_Sales_Order_Date", "(Fibre_Sales_Order_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            ...
            If Val(Common_Procedures.get_FieldValue(con, "Fibre_Sales_Order_Head", "Verified_Status", "(Fibre_Sales_Order_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Purchase_Weight) from Fibre_Sales_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Invoice_Weight) from Fibre_Sales_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Sales_Order_Head", "Fibre_Sales_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Fibre_Sales_Order_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Fibre_Sales_Order_Details", "Fibre_Sales_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Fibre_IdNo,Mill_IdNo,Bale,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Fibre_Sales_Order_Code, For_OrderBy, Company_IdNo, Fibre_Sales_Order_No, Fibre_Sales_Order_Date, Ledger_Idno", trans)


            cmd.CommandText = "delete from Fibre_Sales_Order_GST_Tax_Details  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()


            cmd.CommandText = "delete from Fibre_Sales_Order_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Fibre_Sales_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Sales_Order_No from Fibre_Sales_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Sales_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Sales_Order_No from Fibre_Sales_Order_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Sales_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Sales_Order_No from Fibre_Sales_Order_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Fibre_Sales_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Sales_Order_No from Fibre_Sales_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Fibre_Sales_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Sales_Order_Head", "Fibre_Sales_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red


            msk_Date.Text = Date.Today.ToShortDateString
            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*,  c.ledger_name as TaxAcName from Fibre_Sales_Order_Head a  LEFT OUTER JOIN Ledger_Head c ON a.TaxAc_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Sales_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Fibre_Sales_Order_No desc", con)
            Da1.Fill(Dt1)

            If Dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If Dt1.Rows(0).Item("Fibre_Sales_Order_Date").ToString <> "" Then msk_Date.Text = Dt1.Rows(0).Item("Fibre_Sales_Order_Date").ToString
                End If
                ...
                Da1 = New SqlClient.SqlDataAdapter("Select a.* from Fibre_Sales_Order_Details a Where a.Fibre_Sales_Order_Code = '" & Trim(Dt1.Rows(0).Item("Fibre_Sales_Order_Code").ToString) & "' Order by a.sl_no", con)
                Dt2 = New DataTable
                Da1.Fill(Dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Sales_Order_No from Fibre_Sales_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Sales_Order_No from Fibre_Sales_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            If Not (Val(Common_Procedures.User.IdNo) = 1 Or Common_Procedures.User.Show_Verified_Status = 1) Then
                ...
                If Val(Common_Procedures.get_FieldValue(con, "Fibre_Sales_Order_Head", "Verified_Status", "(Fibre_Sales_Order_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Sales_Order_Head", "Fibre_Sales_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            'cmd.CommandText = "Delete from Fibre_Sales_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "' and Purchase_Weight = 0 "
            'Nr = cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Fibre_Sales_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "' and Invoice_Weight = 0  "
            Nr = cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Fibre_Sales_Order_Details", "Fibre_Sales_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Fibre_IdNo,Mill_IdNo,Bale,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Fibre_Sales_Order_Code, For_OrderBy, Company_IdNo, Fibre_Sales_Order_No, Fibre_Sales_Order_Date, Ledger_Idno", tr)
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Fibre_Sales_Order_GST_Tax_Details   ( Fibre_Sales_Order_Code  ,               Company_IdNo       ,      Fibre_Sales_Order_No                ,                               for_OrderBy                                  , Fibre_Sales_Order_Date    ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " &
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Sales_Order_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Fibre_Sales_Order_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Sales_Order_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as PartyName, d.Ledger_Name as Delv_Name from Fibre_Sales_Order_Head a INNER JOIN Fibre_Sales_Order_Details b ON a.Fibre_Sales_Order_Code = b.Fibre_Sales_Order_Code INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON a.DeliveryTo_Idno = d.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Sales_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Fibre_Sales_Order_No", con)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Fibre_Sales_Order_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Fibre_Sales_Order_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub Printing_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Fibre_Sales_Order_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* ,b.Fibre_Name ,b.GST_Percentage,b.HSN_Code from Fibre_Sales_Order_Details a INNER JOIN Fibre_head b ON a.Fibre_idno = b.Fibre_idno where a.Fibre_sales_Order_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Fibre_Sales_Order_No", con)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1334" Then '
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, c.Ledger_Name as Transport_Name from Fibre_Sales_Order_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno LEFT OUTER JOIN Ledger_Head c ON c.Ledger_IdNo = a.Transport_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Sales_Order_Code = '" & Trim(EntryCode) & "' Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Sales_Order_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Sales_Order_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 11, CurY, 0, 0, pFont,, True, LMargin + ClArr(1) + ClArr(2) - 5)
                        'Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString & "  -  " & prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 11, CurY, 0, 0, pFont,, True, LMargin + ClArr(1) + ClArr(2) - 5)
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString) <> 0 Then
                        ...
                        'End If
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Rate").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "RATE/KG ", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)
    ...
    Private Sub cbo_Vechile_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VehicleNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Sales_Head", "Vehicle_No", "", "")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_Transport, txt_Note, "Fibre_Sales_Head", "Vehicle_No", "", "")
    ...
    Private Sub cbo_VehicleNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, txt_Note, "Fibre_Sales_Head", "Vehicle_No", "", "", False)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If Common_Procedures.settings.CustomerCode = "1333" Then
                            CntName1 = (prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString & "-" & prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString)         ' & "-" & prn_DetDt.Rows(prn_DetIndx).Item("Count_Description").ToString)
                        Else
                        ...
                        If Common_Procedures.settings.CustomerCode = "1186" Then
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Format((Val(prn_DetDt.Rows(prn_DetIndx).Item("Weight").ToString)) / (Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString)), "######0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 5, CurY, 1, 0, pFont)
                            End If
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        CurY = CurY + TxtHgt
        p1Font = New Font("Calibri", 16, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "FIBRE SALES ORDER", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            If Common_Procedures.settings.CustomerCode = "1186" Then
                Common_Procedures.Print_To_PrintDocument(e, "WGT/BALE", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont)
            Else
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        SNo = SNo + 1
                        Common_Procedures.Print_To_PrintDocument(e, Trim(Val(SNo)), LMargin + 10, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 5, CurY, 0, 0, pFont)
                        'Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("HSN_Code").ToString, LMargin + ClArr(1) + ClArr(2) + 5, CurY, 0, 0, pFont)
                        'Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("GST_Percentage").ToString), "############0.0") & "%", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
                        ' Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 10, CurY, 0, 0, pFont)
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString) <> 0 Then
    ...
    Private Sub Printing_Format2GST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        CurY = CurY + TxtHgt
        p1Font = New Font("Calibri", 16, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "FIBRE PURCHASE ORDER", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from FIbre_Sales_Order_GST_Tax_Details Where Fibre_Sales_Order_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            If Val(LedIdNo) <> 0 Then
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Fibre_Sales_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code   LEFT OUTER JOIN Fibre_Sales_Order_Head d ON d.Fibre_Sales_Order_Code = a.Own_Order_Code    where a.Fibre_Sales_Order_Code = ''  and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
            ...
            Else
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Fibre_Sales_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Sales_Order_Code = '" & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno    LEFT OUTER JOIN  Fibre_Sales_Order_Head d ON d.Fibre_Sales_Order_Code = a.Own_Order_Code    where a.Fibre_Sales_Order_Code = ''   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
    ...
    Private Sub Printing_Format_1186(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(35) : ClArr(2) = 310 : ClArr(3) = 90 : ClArr(4) = 90 : ClArr(5) = 80
        ClArr(6) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5))
    ...
    Private Sub Printing_Format_1186_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "GENERAL SALES ORDER", LMargin, CurY, 2, PrintWidth, p1Font)
        C1 = ClAr(1) + ClAr(2) + ClAr(3)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        CurY = CurY + 10
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "SO No. : GN/SO-" & prn_HdDt.Rows(0).Item("Fibre_Sales_Order_No").ToString & "/" & Common_Procedures.FnYearCode, LMargin + 10, CurY, 0, 0, p1Font)
        'strHeight1 = e.Graphics.MeasureString(prn_HdDt.Rows(0).Item("ClothPurchase_Order_No").ToString, p1Font).Height

        Common_Procedures.Print_To_PrintDocument(e, "SO Date : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Sales_Order_date").ToString), "dd-MM-yyyy").ToString, LMargin + ClAr(1) + +ClAr(2) - 30, CurY, 2, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "Party PO No. : " & prn_HdDt.Rows(0).Item("Party_OrderNo").ToString.ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, p1Font)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Attend").ToString) <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Mr." & Trim(prn_HdDt.Rows(0).Item("Attend").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 35, CurY, 0, 0, p1Font)
    ...
    Private Sub cbo_transportation_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_transportation.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Sales_Order_Head", "Transportations", "", "(Fibre_Sales_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_transportation.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_transportation, txt_DiscPerc, cbo_TaxType, "Fibre_Sales_Order_Head", "Transportations", "", "(Fibre_Sales_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_transportation.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_transportation, txt_Note, "Fibre_Sales_Order_Head", "Transportations", "", "(Fibre_Sales_Order_No = 0)", False)

    End Sub

    Private Sub cbo_Tax_Type_GotFocus(sender As Object, e As EventArgs) Handles cbo_tax_type.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Sales_Order_Head", "taxtype", "", "(Fibre_Sales_Order_No=0)")
    End Sub

    Private Sub cbo_tax_Type_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_tax_type.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_tax_type, msk_DeliveryDate, Nothing, "Fibre_Sales_Order_Head", "taxtype", "", "(Fibre_Sales_Order_No=0)")
        If (e.KeyValue = 40) Then
    ...
    Private Sub cbo_Tax_Type_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_tax_type.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_tax_type, Nothing, "Fibre_Sales_Order_Head", "taxtype", "", "(Fibre_Sales_Order_No = 0)", False)
        If Asc(e.KeyChar) = 13 Then
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(dgvCol_Details.Count)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        End If
                        If Common_Procedures.settings.CustomerCode = "1333" Then
                            CntName1 = (prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString & "-" & prn_DetDt.Rows(prn_DetIndx).Item("Count_Description").ToString)
                        Else
                            CntName1 = prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString
                        End If
    ...
    Private Sub cbo_Grid_RateFor_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_Grid_RateFor.SelectedIndexChanged
    ...
    End Sub
    Private Sub Printing_FormatGST_4(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim cmd As New SqlClient.SqlCommand
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim EntryCode As String
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_FormatGST_4_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_FormatGST_4_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, False)
                ...
                Printing_FormatGST_4_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, True)
    ...
    Private Sub Printing_FormatGST_4_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        Dim strHeight As Single = 0, strWidth As Single = 0
    ...
    Private Sub Printing_FormatGST_4_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        Dim I As Integer
        Dim Cmp_Name As String
        Dim C1 As Single, W1 As Single
