Public Class Processing_Receipt
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.Ledger_Name as Transport_Name from Cloth_Processing_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo  Where a.ClothProcess_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub Processing_Receipt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Try
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Processing_Receipt_Entry, New_Entry, Me, con, "Cloth_Processing_Receipt_Head", "ClothProcess_Receipt_Code", NewCode, "ClothProcess_Receipt_Date", "(ClothProcess_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Da = New SqlClient.SqlDataAdapter("select count(*) from Cloth_Processing_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Receipt_Code = '" & Trim(NewCode) & "' and  Cloth_Processing_BillMaking_Code <> ''", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
                If Val(Dt1.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already Receipt Prepared", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        Try
            ...
            cmd.CommandText = "Update Cloth_Processing_Delivery_Details set Receipt_Meters = a.Receipt_Meters - (b.Receipt_Meters-b.ExcSht_Meters) from Cloth_Processing_Delivery_Details a, Cloth_Processing_Receipt_Details b Where b.Cloth_Processing_Receipt_Code = '" & Trim(NewCode) & "' and a.Cloth_Processing_Delivery_code = b.Cloth_Processing_Delivery_code and a.Cloth_Processing_Delivery_SlNo = b.Cloth_Processing_Delivery_SlNo"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Cloth_Processing_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Cloth_Processing_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Receipt_No from Cloth_Processing_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Receipt_No from Cloth_Processing_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Receipt_No from Cloth_Processing_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, ClothProcess_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Receipt_No from Cloth_Processing_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, ClothProcess_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Receipt_Head", "ClothProcess_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select ClothProcess_Receipt_No from Cloth_Processing_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        '  If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.fp_Processing_Receipt_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Processing_Receipt_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Processing_Receipt_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_Processing_Receipt_Entry, New_Entry, Me, con, "Cloth_Processing_Receipt_Head", "ClothProcess_Receipt_Code", NewCode, "ClothProcess_Receipt_Date", "(ClothProcess_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, ClothProcess_Receipt_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Receipt_Head", "ClothProcess_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Cloth_Processing_Receipt_Head (ClothProcess_Receipt_Code, Company_IdNo, ClothProcess_Receipt_No, for_OrderBy, ClothProcess_Receipt_Date, Ledger_IdNo, Purchase_OrderNo, Transport_IdNo, Freight_Charges, DeliveryTo_Name,Total_Pcs,Total_Qty, Total_Meters, Total_Weight ,Total_ExcessShort , User_IdNo) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @RecDate, " & Str(Val(Led_ID)) & ", '" & Trim(txt_PoNo.Text) & "', " & Str(Val(Tr_ID)) & ", " & Str(Val(txt_Frieght.Text)) & ",  '" & Trim(txt_DelTo.Text) & "'," & Str(Val(vTotPcs)) & "," & Val(vtotqty) & " , " & Str(Val(vTotMtrs)) & ", " & Str(Val(vTotWeight)) & " , " & Val(vExcSrt) & "," & Val(lbl_UserName.Text) & ")"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Cloth_Processing_Receipt_Head set ClothProcess_Receipt_Date = @RecDate, Ledger_IdNo = " & Val(Led_ID) & ", Purchase_OrderNo = '" & Trim(txt_PoNo.Text) & "' , Transport_IdNo = " & Val(Tr_ID) & ", Freight_Charges = " & Val(txt_Frieght.Text) & ", DeliveryTo_Name = '" & Trim(txt_DelTo.Text) & "', Total_Pcs = " & Val(vTotPcs) & " ,Total_Qty = " & Val(vtotqty) & " , Total_Meters = " & Val(vTotMtrs) & ",Total_Weight = " & Val(vTotWeight) & " ,Total_ExcessShort = " & Val(vExcSrt) & ", User_idNo = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Cloth_Processing_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_receipt_Code = '" & Trim(NewCode) & "' and Cloth_Processing_BillMaking_Code = ''"
            cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_itemfp_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_itemfp.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_itemfp, Nothing, cbo_Colour, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_idno = 0)")
        With dgv_Details
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,c.*,d.Processed_Item_Name,e.Process_Name from Cloth_Processing_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Cloth_Processing_Receipt_Details c ON c.Cloth_Processing_Receipt_Code = a.ClothProcess_Receipt_Code INNER JOIN Processed_Item_Head d ON d.Processed_Item_IdNo = c.Item_To_IdNo LEFT OUTER JOIN Process_Head e ON c.Processing_Idno = e.Process_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.ClothProcess_Receipt_No", con)
            da.Fill(dt2)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RecNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.FP_Processing_Receipt_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Cloth_Processing_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,d.Ledger_Name as Transport_Name from Cloth_Processing_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Processed_Grey_Name, c.Colour_Name ,d.Lot_No ,e.Process_Name  from Cloth_Processing_Receipt_Details a INNER JOIN Processed_Item_Head b on a.Item_To_Idno = b.Processed_Item_IdNo LEFT OUTER JOIN Colour_Head c on a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Lot_Head d ON d.Lot_IdNo = a.Lot_IdNo LEFT OUTER JOIN Process_Head e ON e.Process_IdNo = a.Processing_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cloth_Processing_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            ...
            If Val(dgv_Selection.Rows(i).Cells(11).Value) = 1 Then
                ...
                If txt_PoNo.Text = "" Then
                    If (dgv_Selection.Rows(i).Cells(13).Value) <> "" Then
                        txt_PoNo.Text = Trim(dgv_Selection.Rows(i).Cells(13).Value)
                    End If
                End If
