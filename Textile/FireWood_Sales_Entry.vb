...
Imports System.IO
Public Class FireWood_Sales_Entry
    ...
    Private Sub clear()
        ...
        txt_RateFor_Kg.Text = ""
        txt__AddLess_Caption.Text = "AddLess"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Item_Name from Billing_FireWood_Sales_Details a INNER JOIN Item_Head b ON a.Item_IdNo = b.Item_IdNo  Where a.FireWood_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("Gross_Weight").ToString), "########0.000")
                            .Rows(n).Cells(3).Value = Val(dt2.Rows(i).Item("Tare_Weight").ToString)
                            .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Net_Weight").ToString), "########0.000")
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(6).Value = Format(Val(dt1.Rows(0).Item("Total_Amount").ToString), "########0.000")
                End With
    ...
    Private Sub FireWood_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            cbo_VehicleNo.Width = cbo_PartyName.Width
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Billing_FireWood_Sales_Details ( FireWood_Sales_Code ,               Company_IdNo       ,   FireWood_Sales_No    ,                     for_OrderBy                                            ,   FireWood_Sales_Date  ,             Sl_No     ,      Item_IdNo    ,            Gross_Weight                  ,                     Tare_Weight           ,                  Net_Weight                 ,                 Rate                 ,   Amount                ) " &
            ...
            Dim vLed_IdNos As String = "", vVou_Amts As String = "", ErrMsg As String = "", VNarr As String = ""
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1398" Then
                ...
                VNarr = Trim(vTotNetWgt) & " Tonn" & "," & Trim(txt_Note.Text)
            Else
                VNarr = Trim(vTotNetWgt) & " Tonn"

            End If



            If Common_Procedures.Voucher_Updation(con, "FireWood.sales", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, Trim(VNarr), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            ...
            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(lbl_RefNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "DR", Trim(Pk_Condition) & Trim(NewCode), tr)
        ...
        With dgv_Details
            If .Visible Then
                ...
                If CurCol = 2 Or CurCol = 3 Or CurCol = 4 Or CurCol = 5 Then
                    ...
                    End If
                    If Val(vRATEFOR) = 0 Then vRATEFOR = 1

                    .Rows(CurRow).Cells(6).Value = Format(Val(.Rows(CurRow).Cells(4).Value) * Val(.Rows(CurRow).Cells(5).Value) / Val(vRATEFOR), "###########0.00")
    ...
    Private Sub Total_Calculation()
        ...
        Sno = 0
        TotGrsWgt = 0 : TotTareWgt = 0 : TotNetWgt = 0 : TotAmt = 0
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" And (Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0) Then
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from Billing_FireWood_Sales_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.FireWood_Sales_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.* ,i.Item_HSN_Code from Billing_FireWood_Sales_Details a  INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo Left Outer JOIN itemgroup_Head I on b.itemgroup_idno = I.itemgroup_idno   where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                da2.Fill(prn_DetDt)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1398" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1401" Then
            Dim CMPNAME As String = ""

            CMPNAME = prn_HdDt.Rows(0).Item("Company_Name").ToString.ToUpper

            If (InStr(1, CMPNAME, "LAKSHMI") > 0 And InStr(1, CMPNAME, "PRIYA") > 0 And InStr(1, CMPNAME, "AGENCY") > 0) Or (InStr(1, CMPNAME, "MANOJ") > 0 And InStr(1, CMPNAME, "KUMAR") > 0 And InStr(1, CMPNAME, "CO") > 0) Or (InStr(1, CMPNAME, "NSK") > 0 And InStr(1, CMPNAME, "AGENCY") > 0) Or (InStr(1, CMPNAME, "SAMY") > 0 And InStr(1, CMPNAME, "CO") > 0) Or (InStr(1, CMPNAME, "SELVALAKSHMI") > 0 And InStr(1, CMPNAME, "MOHANRAJ") > 0) Then
    ...
    Private Sub txt_Note_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Note.KeyDown
        If e.KeyValue = 38 Then txt_Freight.Focus()
        If e.KeyValue = 40 Then
    ...
    Private Sub Printing_Format_SALES_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1398" Then '---- A R TRADERS (BHAVANI)
            Common_Procedures.Print_To_PrintDocument(e, Cmp_Name, LMargin, CurY, 2, PrintWidth, p1Font, Brushes.RoyalBlue)
        Else
            Common_Procedures.Print_To_PrintDocument(e, Cmp_Name, LMargin, CurY, 2, PrintWidth, p1Font)
        End If
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1492" Then
                Common_Procedures.Print_To_PrintDocument(e, " RATE /", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
                Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("RateFor_Kg").ToString) & " KG", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY + 20, 2, ClAr(8), pFont)
            Else
                Common_Procedures.Print_To_PrintDocument(e, "RATE", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
            End If
    ...
    Private Sub Printing_Format_SALES_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1393" And Print_PDF_Status = True Then
                e.Graphics.DrawImage(DirectCast(Global.Textile.My.Resources.Resources.Eesan_mills_sign, Drawing.Image), PageWidth - 120, CurY + 5, 80, 45)
...
LOOP2:
    ...
    Private Sub Printing_Format_1398_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
                ...
                If Not imageData Is Nothing Then
                    Using ms As New MemoryStream(imageData, 0, imageData.Length)
                        ...
                        If imageData.Length > 0 Then
                            ...
                            ' e.Graphics.DrawImage(DirectCast(pic_IRN_QRCode_Image_forPrinting.BackgroundImage, Drawing.Image), PageWidth - 108, CurY + 10, 90, 90)
                            e.Graphics.DrawImage(DirectCast(Image.FromStream(ms), Drawing.Image), LMargin + 10, CurY + 15, 100, 110)
        ...
        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, Trim(Cmp_PhNo & "   " & Cmp_EMail), LMargin + 20, CurY, 2, PrintWidth, pFont)
    ...
    Private Sub Printing_Format_1398_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1401" Then
                ...
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, "Current Balance  :  " & vCURRBAL, LMargin + 10, CurY, 0, 0, p1Font)
            ...
            If Print_PDF_Status = True Then
                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1398" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1401" Then
                    ...
                    ElseIf (InStr(1, Trim(UCase(Cmp_Name)), "GUNASUNDARI FIRE WOOD") > 0) Or (InStr(1, Trim(UCase(Cmp_Name)), "GUNASUNDARI FIREWOOD") > 0) Then
                        e.Graphics.DrawImage(DirectCast(Global.Textile.My.Resources.Resources.GUNASUNDARI_FIREWOODS_SIGN, Drawing.Image), PageWidth - 160, CurY + 5, 120, 40)
                    End If
                End If
            End If
