...
Public Class General_Delivery
    ...
    Private Pk_Condition As String = "GENDC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from General_Delivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.General_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("General_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("General_Delivery_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from General_Delivery_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.Unit_idno = c.Unit_idno where a.General_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(11).Value = Format(Val(dt2.Rows(i).Item("RateWithTax").ToString), "########0.00")
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(4).Value = Format(Val(dt1.Rows(0).Item("Total_Qty").ToString), "########0.00") 'Val(dt1.Rows(0).Item("Total_Qty").ToString)
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1218" Then
            lbl_NetAmt_Caption.Text = "Approximate Amount"
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1218" Then
            '   If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.ent_Delivery_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.ent_Delivery_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error) : Exit Sub
        End If
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Receipt_Quantity) from General_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from General_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select General_Delivery_No from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' and General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%'  Order by for_Orderby, General_Delivery_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select General_Delivery_No from General_Delivery_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' and General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, General_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select General_Delivery_No from General_Delivery_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' and General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, General_Delivery_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select General_Delivery_No from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' and General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%'  Order by for_Orderby desc, General_Delivery_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            'If Common_Procedures.settings.Delivery_Serial_No = 1 Then
            '    lbl_InvoiceNo.Text = Common_Procedures.get_Delivery_MaxCode(con, Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            'Else
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "General_Delivery_Head", "General_Delivery_Code", "For_OrderBy", "(General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            'End If
            'lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "General_Delivery_Head", "General_Delivery_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select General_Delivery_No from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "' and Entry_VAT_GST_Type = 'GST'"
            dr = cmd.ExecuteReader
            ...
            'vCSInvCode = "GSADC-" & Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            '    Da = New SqlClient.SqlDataAdapter("select General_Delivery_No from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(vCSInvCode) & "' and General_Delivery_Code LIKE 'GSADC-%' ", con)
            '    Dt = New DataTable
            '    Da.Fill(Dt)
            ...
            ElseIf Val(vCSMovNo) <> 0 Then
                MessageBox.Show("This DC No. in Rental DC", "DOES NOT FIND...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Dim vYSInvCode As String = ""
        Dim vYSMovNo As String = ""
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.ent_Delivery_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.ent_Delivery_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select General_Delivery_No from General_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "'  "
            dr = cmd.ExecuteReader
            ...
            ElseIf Val(vYSMovNo) <> 0 Then
                MessageBox.Show("Already this DC No. in Rental DC", "DOES NOT INSERT NEW BILL...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)

            Else
                If Val(inpno) = 0 Then
                    MessageBox.Show("Invalid Dc No.", "DOES NOT INSERT NEW Ref...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTot_Qty As String = 0
        Dim NR As Integer = 0

        If Common_Procedures.settings.CustomerCode = "1218" Then
            ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.ent_Delivery_Entry, New_Entry) = False Then Exit Sub
        End If
        ...
        With dgv_Details
            For i = 0 To dgv_Details.RowCount - 1
                ...
                If Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    If Val(.Rows(i).Cells(4).Value) = 0 Then
                        MessageBox.Show("Invalid Particulars", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                        If .Enabled And .Visible Then
                            .Focus()
        ...
        If dgv_Details_Total.RowCount > 0 Then
            vTot_Qty = Format(Val(dgv_Details_Total.Rows(0).Cells(4).Value()), "########0.00")
            VTotAmt = Format(Val(dgv_Details_Total.Rows(0).Cells(8).Value()), "########0.00")
        End If
        ...
        Try
            ...
            Else
                ...
                'If Common_Procedures.settings.Delivery_Serial_No = 1 Then
                '    lbl_InvoiceNo.Text = Common_Procedures.get_Delivery_MaxCode(con, Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)

                'Else
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "General_Delivery_Head", "General_Delivery_Code", "For_OrderBy", "(General_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into General_Delivery_Head( Entry_VAT_GST_Type ,        General_Delivery_Code ,             Company_IdNo         ,              General_Delivery_No             ,                               for_OrderBy      , General_Delivery_Date,           Ledger_IdNo   ,                 Order_No             ,                Order_Date         ,    Transport_IdNo         ,            Vehicle_No            ,              Remarks           ,              Total_Qty         ,   Entry_GST_Tax_Type ,                 CGst_Amount          ,                 SGst_Amount          ,               IGst_Amount                     , SubTotal_Amount ,        Round_Off             ,             Net_Amount                             ,  Assessable_Value ) " &
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(2).Value) <> "" Or Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Update General_Delivery_Details set General_Delivery_Date = @DcDate,  Ledger_IdNo = " & Str(Val(led_id)) & ",  Sl_No = " & Str(Val(Sno)) & ", Item_Idno = " & Str(Val(itm_id)) & ", Item_Description = '" & Trim(.Rows(i).Cells(2).Value) & "', Unit_Idno = " & Val(unt_id) & ", Quantity = " & Str(Val(.Rows(i).Cells(4).Value)) & ",Rate =" & Str(Val(.Rows(i).Cells(7).Value)) & ",Amount = " & Str(Val(.Rows(i).Cells(8).Value)) & ",HSN_Code = '" & Trim(.Rows(i).Cells(9).Value) & "',Tax_Perc = " & Str(Val(.Rows(i).Cells(10).Value)) & "  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "' and Sales_Delivery_Detail_SlNo = " & Str(Val(.Rows(i).Cells(5).Value))
                        NR = cmd.ExecuteNonQuery()

                        If NR = 0 Then
                            cmd.CommandText = "Insert into General_Delivery_Details ( General_Delivery_Code,    Company_IdNo          ,      General_Delivery_No  ,                                              for_OrderBy                   , General_Delivery_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo           ,      Item_Description                    ,          Unit_IdNo         ,                         Quantity          ,   Receipt_Quantity ,     Rate                ,                      Amount                     ,                             HSN_Code           ,                      Tax_Perc              ,   RateWithTax) " &
        ...
        Catch ex As Exception
            tr.Rollback()
            If InStr(1, Err.Description, "CK_General_Delivery_Details_1") > 0 Then
            ...
            ElseIf InStr(1, Err.Description, "CK_General_Delivery_Details_2") > 0 Then
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(9).Value = txt_Hsn_Sac_Code.Text


                    .Rows(i).Cells(10).Value = Format(Val(txt_GstPerc.Text), "########0.00")
                    .Rows(i).Cells(11).Value = Format(Val(txt_RateWithTax.Text), "########0.00")
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(9).Value = txt_Hsn_Sac_Code.Text


                .Rows(n).Cells(10).Value = Format(Val(txt_GstPerc.Text), "########0.00")
                .Rows(n).Cells(11).Value = Format(Val(txt_RateWithTax.Text), "########0.00")
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, txt_Description, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) )", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_Description, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) )", "(Ledger_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, txt_VehicleNo, txt_Narration, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_Transport_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Transport.KeyPress
        con = New SqlClient.SqlConnection(Common_Procedures.Connection_String)
        con.Open()
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Transport, txt_Narration, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        txt_Hsn_Sac_Code.Text = Trim(.Rows(i).Cells(9).Value)
                        txt_GstPerc.Text = Format(Val(.Rows(i).Cells(10).Value), "########0.00")



                        txt_RateWithTax.Text = Format(Val(.Rows(i).Cells(11).Value), "########0.00")
                        Exit For
                    End If
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.General_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = " a.General_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.General_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Itm_IdNo) <> 0 Then
                ...
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.General_Delivery_Code IN (select z.General_Delivery_Code from General_Delivery_Details z where z.Item_IdNo = " & Str(Val(Itm_IdNo)) & ") "
            End If

            da = New SqlClient.SqlDataAdapter("select a.*,b.* from General_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo   where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.General_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.General_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("General_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("General_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(2).Value) <> "" Then
            ...
            txt_Hsn_Sac_Code.Text = Trim(dgv_Details.CurrentRow.Cells(9).Value)
            txt_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(10).Value), "########0.00")
            txt_RateWithTax.Text = Format(Val(dgv_Details.CurrentRow.Cells(11).Value), "########0.00")
            If txt_Description.Enabled And txt_Description.Visible Then txt_Description.Focus()
    ...
    Public Sub print_Invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from General_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and General_Delivery_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,d.Ledger_Name as TransportName, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from General_Delivery_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.General_Delivery_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* from General_Delivery_Details a  where a.General_Delivery_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.General_Delivery_No", con)
...
LOOP1:
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from General_Delivery_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.General_Delivery_Code = '" & Trim(EntryCode) & "'  Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        If dt2.Rows.Count > NoofItems_PerPage Then
            Common_Procedures.Print_To_PrintDocument(e, "Page : " & Trim(Val(PageNo)), LMargin + 10, CurY - TxtHgt, 0, 0, pFont)
        End If
        dt2.Clear()
        p1Font = New Font("Calibri", 12, FontStyle.Regular)
        ...
        '        e.Graphics.DrawImage(DirectCast(Global.Textile.My.Resources.Resources.Company_Logo_Arul, Drawing.Image), LMargin, CurY + 15, 140, 100)
        ...
        '        e.Graphics.DrawImage(DirectCast(Global.Textile.My.Resources.Resources.Company_Logo_Avs, Drawing.Image), LMargin, CurY + 15, 140, 100)
        '    End If
        'End If
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("General_Delivery_No").ToString, LMargin + C1 + W1 - 20, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("General_Delivery_Date").ToString), "dd-MM-yyyy").ToString & " - " & Format(Now, "hh:mm tt"), LMargin + C1 + W1 - 20, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format2(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 50 : ClArr(2) = 480 : ClArr(3) = 0 : ClArr(4) = 0
        ClArr(5) = 100
...
LOOP1:
                        ...
                        'Common_Procedures.Print_To_PrintDocument(e, (prn_DetDt.Rows(prn_DetIndx).Item("Hsn_Code").ToString), LMargin + ClArr(1) + ClArr(2) + 3, CurY, 0, 0, pFont)
                        ' Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Tax_Perc").ToString) & "%", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Quantity").ToString), "##########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "DC DATE", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("General_Delivery_Date").ToString), "dd-MM-yyyy"), LMargin + C1 + W1 - 20, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), "##########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 5, CurY, 1, 0, pFont)
...
LOOP1:
    ...
    Private Sub txt_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_VehicleNo.KeyDown
        ...
        If e.KeyCode = 38 Then
            ...
            If txt_Description.Enabled = True And txt_Description.Enabled = True Then
                txt_Description.Focus() ' SendKeys.Send("+{TAB}")
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, txt_OrderDate, txt_Description, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_TaxType_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TaxType.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TaxType, txt_Description, "", "", "", "", True)
            If Asc(e.KeyChar) = 13 Then
        ...
        If GridAll_Row_STS = True Then
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    End If
                    If Trim(UCase(cbo_TaxType.Text)) = "GST" Then
                        .Rows(i).Cells(9).Value = Trim(txt_Hsn_Sac_Code.Text) 'dt.Rows(0)("Item_HSN_Code").ToString
    ...
    Private Sub TotalAmount_Calculation()
        ...
        Dim TotGrsAmt As String = 0
        Dim TotDiscAmt As String = 0
        Dim TotAssval As String = 0
        ...
        With dgv_Details_Total
            If .RowCount = 0 Then .Rows.Add()
            .Rows(0).Cells(4).Value = Format(Val(TotQty), "########0.00")
            ...
            With dgv_Details
                ...
                If .Rows.Count > 0 Then
                    For i = 0 To .Rows.Count - 1
                        ...
                        If Trim(.Rows(i).Cells(2).Value) <> "" And Trim(.Rows(i).Cells(9).Value) <> "" And Val(.Rows(i).Cells(10).Value) <> 0 Then
    ...
    Private Sub btn_Add_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Add.TextChanged
        Call Amount_Calculation(False)
    End Sub
    ...
    Private Sub Rate_Calculation_WithTax()
    ...
    Private Sub txt_RateWithTax_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_RateWithTax.KeyUp
        Call Rate_Calculation_WithTax()
    End Sub
    Private Sub Rate_Calculation()
        Dim TaxRate As Single = 0
        Dim Itm_Id As Integer
        Itm_Id = Common_Procedures.Item_NameToIdNo(con, Trim(cbo_ItemName.Text))
        TaxRate = Common_Procedures.get_FieldValue(con, "item_head", "Gst_Percentage", "(Item_IdNo = " & Str(Val(Itm_Id)) & ")")
        ...
        lbl_Amount.Text = Format(Val(lbl_Amount.Text) * Val(txt_Rate.Text), "#########0.00")
