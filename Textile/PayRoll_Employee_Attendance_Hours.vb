Public Class PayRoll_Employee_Attendance_Hours
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ADVANCE, New_Entry, Me, con, "PayRoll_Employee_Attendance_Head", "Employee_Attendance_Code", Pk_Condition & NewCode, "Employee_Attendance_Date", "(Employee_Attendance_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Employee_Attendance_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Employee_Attendance_No desc", dtp_Date.Value.Date) = False Then Exit Sub
