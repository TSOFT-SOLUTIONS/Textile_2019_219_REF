Public Class Piece_Excess_Short
    ...
    Private Pk_Condition As String = "PCSES-"
    ...
    Private Sub Piece_Excess_Short_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbo_ExcessShort.Enabled = False
        cbo_ExcessShort.Items.Clear()
        cbo_ExcessShort.Items.Add("EXCESS")
        cbo_ExcessShort.Items.Add("SHORT")
        ...
        AddHandler cbo_ExcessShort.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_ExcessShort.LostFocus, AddressOf ControlLostFocus
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from Piece_Excess_Short_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Piece_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Piece_Excess_Short_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Piece_Excess_Short_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.clothtype_name, c.Ledger_Name, d.cloth_name from Piece_Excess_Short_Details a INNER JOIN ClothType_Head b ON a.ClothType_IdNo <> 0 and a.ClothType_IdNo = b.ClothType_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Party_Idno <> 0 and a.Party_Idno = c.Ledger_Idno LEFT OUTER JOIN Cloth_Head d ON a.Cloth_Idno <> 0 and a.Cloth_Idno = d.Cloth_Idno where a.Piece_Excess_Short_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Piece_Excess_Short_Entry, New_Entry, Me, con, "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", NewCode, "Piece_Excess_Short_Date", "(Piece_Excess_Short_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Piece_Excess_Short_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Piece_Excess_Short_Details", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Lot_No, Pcs_No, ClothType_IdNo, Meters, Weight, Weight_Meter, Party_IdNo ,  Lot_Code", "Sl_No", "Piece_Excess_Short_Code, For_OrderBy, Company_IdNo, Piece_Excess_Short_No, Piece_Excess_Short_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "delete from Piece_Excess_Short_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Piece_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Piece_Excess_Short_No from Piece_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Piece_Excess_Short_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Piece_Excess_Short_No from Piece_Excess_Short_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Piece_Excess_Short_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Piece_Excess_Short_No from Piece_Excess_Short_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Piece_Excess_Short_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Piece_Excess_Short_No from Piece_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Piece_Excess_Short_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red


            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Piece_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Piece_Excess_Short_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Piece_Excess_Short_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Piece_Excess_Short_Date").ToString
                End If
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Piece_Excess_Short_No from Piece_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code = '" & Trim(RecCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Piece_Excess_Short_Entry, New_Entry, Me, con, "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", NewCode, "Piece_Excess_Short_Date", "(Piece_Excess_Short_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Piece_Excess_Short_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Piece_Excess_Short_Head(Piece_Excess_Short_Code, Company_IdNo, Piece_Excess_Short_No, for_OrderBy, Piece_Excess_Short_Date, Cloth_IdNo , ClothType_IdNo, ExcessShort_Type, Folding, Total_Pcs, Total_Meters, Total_Weight, Note , Ledger_IdNo   , User_IdNo  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @RecDate,  " & Str(Val(Clth_ID)) & ", " & Str(Val(Clthty_ID)) & ", '" & Trim(cbo_ExcessShort.Text) & "',  " & Str(Val(txt_Folding.Text)) & ", " & Str(Val(vTotPcs)) & ", " & Str(Val(vTotMtrs)) & " , " & Str(Val(vTotWgt)) & " , '" & Trim(txt_Note.Text) & "', " & Str(Val(led_id)) & "," & Val(lbl_UserName.Text) & " )"
                cmd.ExecuteNonQuery()

            Else

                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Piece_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Piece_Excess_Short_Details", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Lot_No, Pcs_No, ClothType_IdNo, Meters, Weight, Weight_Meter, Party_IdNo ,  Lot_Code", "Sl_No", "Piece_Excess_Short_Code, For_OrderBy, Company_IdNo, Piece_Excess_Short_No, Piece_Excess_Short_Date, Ledger_Idno", tr)


                cmd.CommandText = "Update Piece_Excess_Short_Head set Piece_Excess_Short_Date = @RecDate, Cloth_IdNo = " & Str(Val(Clth_ID)) & " , ClothType_IdNo = " & Str(Val(Clthty_ID)) & " , ExcessShort_Type = '" & Trim(cbo_ExcessShort.Text) & "'   ,   Folding = " & Str(Val(txt_Folding.Text)) & ", Total_Pcs = " & Str(Val(vTotPcs)) & ", Total_Weight = " & Str(Val(vTotWgt)) & " , Total_Meters = " & Str(Val(vTotMtrs)) & " , Note = '" & Trim(txt_Note.Text) & "' , Ledger_IdNo = " & Str(Val(led_id)) & " , User_IdNo = " & Val(lbl_UserName.Text) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Piece_Excess_Short_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Piece_Excess_Short_Head", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Piece_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)
            ...
            Delv_ID = 0
            Rec_ID = 0
            If Trim(UCase(cbo_ExcessShort.Text)) = "SHORT" Then
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        Sno = Sno + 1
                        cmd.CommandText = "Insert into Piece_Excess_Short_Details(Piece_Excess_Short_Code, Company_IdNo, Piece_Excess_Short_No, for_OrderBy, Piece_Excess_Short_Date,  Cloth_IdNo, Folding, Sl_No,   Lot_No, Pcs_No, ClothType_IdNo, Meters, Weight, Weight_Meter, Party_IdNo ,  Lot_Code ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @RecDate, " & Str(Val(dClo_ID)) & ",  " & Str(Val(txt_Folding.Text)) & ",  " & Str(Val(Sno)) & ",  '" & Trim(.Rows(i).Cells(1).Value) & "', '" & Trim(.Rows(i).Cells(2).Value) & "', " & Str(Val(dCloTyp_ID)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(party_ID)) & " ,'" & Trim(.Rows(i).Cells(8).Value) & "' )"
                        cmd.ExecuteNonQuery()
                ...
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Piece_Excess_Short_Details", "Piece_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Lot_No, Pcs_No, ClothType_IdNo, Meters, Weight, Weight_Meter, Party_IdNo ,  Lot_Code", "Sl_No", "Piece_Excess_Short_Code, For_OrderBy, Company_IdNo, Piece_Excess_Short_No, Piece_Excess_Short_Date, Ledger_Idno", tr)
    ...
    Private Sub cbo_ExcessShort_Type_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ExcessShort.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "", "", "", "")

    End Sub
    Private Sub cbo_ExcessShort_Type_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ExcessShort.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ExcessShort, cbo_ClothType, txt_Folding, "", "", "", "")

    End Sub

    Private Sub cbo_ExcessShort_Type_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ExcessShort.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ExcessShort, txt_Folding, "", "", "", "")
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Piece_Excess_Short_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Piece_Excess_Short_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Piece_Excess_Short_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(txt_Filter_LotNo.Text) <> "" Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Piece_Excess_Short_Code IN (select z1.Piece_Excess_Short_Code from Piece_Excess_Short_Details z1 where z1.Lot_No = '" & Trim(txt_Filter_LotNo.Text) & "') "
            End If
            If Trim(txt_Filter_PcsNo.Text) <> "" Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Piece_Excess_Short_Code IN (select z2.Piece_Excess_Short_Code from Piece_Excess_Short_Details z2 where z2.Pcs_No = '" & Trim(txt_Filter_PcsNo.Text) & "') "
            End If

            da = New SqlClient.SqlDataAdapter("select a.* , b.Cloth_name from Piece_Excess_Short_Head a Inner join Cloth_Head b on a.cloth_idno = b.cloth_idno where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Piece_Excess_Short_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Piece_Excess_Short_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Piece_Excess_Short_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Piece_Excess_Short_Date").ToString), "dd-MM-yyyy")
