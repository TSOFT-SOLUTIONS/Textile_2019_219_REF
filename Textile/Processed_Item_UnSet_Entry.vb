Public Class Processed_Item_UnSet_Entry
    ...
    Private Pk_Condition As String = "FPUNS-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name , c.rack_no as Rackno from UnSet_Head a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_IdNo Left Outer Join Rack_Head c On a.Rack_Idno = C.Rack_Idno Where a.UnSet_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RefNo.Text = dt1.Rows(0).Item("UnSet_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("UnSet_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,b.Processed_Item_Name , C.Rack_No as Rackno from  UnSet_Details a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_Idno Left Outer Join Rack_Head c On a.Rack_Idno = C.Rack_Idno  where a.UnSet_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(5).Value = dt2.Rows(i).Item("Rackno").ToString
                    Next i
    ...
    Private Sub Processed_Item_UnSet_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Processed_Item_UnSet_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Processed_Item_UnSet_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Hide_CurrentStock_Display()
    End Sub

    Private Sub Processed_Item_UnSet_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '  If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.UnSet_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.UnSet_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)



        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_UnSet_Entry, New_Entry, Me, con, "UnSet_Head", "UnSet_Code", NewCode, "UnSet_Date", "(UnSet_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from UnSet_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()



            cmd.CommandText = "delete from UnSet_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 UnSet_No from UnSet_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,UnSet_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 UnSet_No from UnSet_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,UnSet_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 UnSet_No from UnSet_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,UnSet_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 UnSet_No from UnSet_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,UnSet_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "UnSet_Head", "UnSet_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select UnSet_No from UnSet_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.UnSet_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.FP_UnSet_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_UnSet_Entry, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select UnSet_No from UnSet_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.UnSet_Entry, New_Entry) = False Then Exit Sub
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_UnSet_Entry, New_Entry, Me, con, "UnSet_Head", "UnSet_Code", NewCode, "UnSet_Date", "(UnSet_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, UnSet_No desc", dtp_Date.Value.Date) = False Then Exit Sub
            ...
            For i = 0 To dgv_Details.RowCount - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Then
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) = "" Then
                        MessageBox.Show("Invalid  Processed Item Name", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        Else
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "UnSet_Head", "UnSet_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
        ...
        If New_Entry = True Then
            cmd.CommandText = "Insert into UnSet_Head (UnSet_Code, Company_IdNo,UnSet_No, for_OrderBy,UnSet_Date,Processed_Item_Idno , Rack_Idno , Quantity , Meters , Total_Qty , Total_Mtr_Qty , Total_Meters , User_IdNo) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @SetDate, " & Str(Val(Procit_ID)) & "," & Str(Val(Rack_ID)) & "," & Val(txt_Quantity.Text) & "," & Val(txt_Meters.Text) & ", " & Str(Val(vTotQty)) & ", " & Str(Val(vTotMtrQty)) & "," & Val(vTotMtrs) & ", " & Val(lbl_UserName.Text) & ")"
            cmd.ExecuteNonQuery()

        Else

            cmd.CommandText = "Update UnSet_Head set UnSet_Date = @SetDate, Processed_Item_Idno = " & Val(Procit_ID) & ", Rack_Idno = " & Str(Val(Rack_ID)) & " , Quantity = " & Val(txt_Quantity.Text) & ", Meters = " & Val(txt_Meters.Text) & ",Total_Qty = " & (vTotQty) & " , Total_Mtr_Qty = " & Val(vTotMtrQty) & ", Total_Meters = " & Val(vTotMtrs) & " , User_IdNo = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and UnSet_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    cmd.CommandText = "Insert into UnSet_Details(UnSet_Code, Company_IdNo,UnSet_No, for_OrderBy, UnSet_Date,Sl_No,Processed_Item_Idno,Quantity,Meter_Qty,Meters,Rack_Idno) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @SetDate," & Str(Val(Sno)) & "," & Val(Procit_ID) & ", " & Val(.Rows(i).Cells(2).Value) & "," & Val(.Rows(i).Cells(3).Value) & ", " & Val(.Rows(i).Cells(4).Value) & " , " & Str(Val(Rack_ID)) & ")"
                    cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_RackNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RackNo.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RackNo, cbo_ItemName, txt_Quantity, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")
    ...
    Private Sub cbo_RackNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RackNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RackNo, txt_Quantity, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.UnSet_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.UnSet_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.UnSet_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name  , C.Rack_No As RackNo from UnSet_Head a INNER JOIN Processed_Item_Head b on a.Processed_Item_IdNo = b.Processed_Item_IdNo LEFT OUTER JOIN RACK_Head C ON a.Rack_Idno = C.Rack_Idno where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.UnSet_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.UnSet_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("UnSet_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("UnSet_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub txt_Meters_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Meters.KeyDown
        If e.KeyCode = 40 Then
            ...
            dgv_Details.CurrentCell.Selected = True
        End If
        If e.KeyCode = 38 Then txt_Quantity.Focus()
    ...
    Private Sub btn_Filter_Close_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Filter_Close.Click
        pnl_Back.Enabled = True
        pnl_Filter.Visible = False
        Filter_Status = False
    End Sub
