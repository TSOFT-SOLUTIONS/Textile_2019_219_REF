Public Class OE_Stores_Item_PO_Entry
            ...
            If IsNothing(dgv1) = False Then
                ...
                With dgv1
                    ...
                    If keyData = Keys.Enter Or keyData = Keys.Down Then
                        ...
                        If .CurrentCell.ColumnIndex >= .ColumnCount - 11 Then
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 PO_No from Stores_Item_PO_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and PO_Code like '" & Trim(Pk_Condition) & "%" & Common_Procedures.FnYearCode & "' Order by for_Orderby, PO_No", con)
            da.Fill(dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_PoNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.OEENTRY_STOCK_TRANSFER_ENTRY, New_Entry, Me, con, "Stores_Item_PO_Head", "Po_Code", NewCode, "Po_Date", "(Po_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Po_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Po_No desc", dtp_date.Value.Date) = False Then Exit Sub
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Item_PO_GST_Tax_Details   ( PO_Code                                 ,    Company_IdNo                  ,    PO_No                     ,                               for_OrderBy                              , PO_Date      ,         Ledger_IdNo       ,            Sl_No     , HSN_Code                               ,      Taxable_Amount                      ,      CGST_Percentage                    ,       CGST_Amount                         ,      SGST_Percentage                     ,                    SGST_Amount          ,                    IGST_Percentage       ,                   IGST_Amount ) " &
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            ItmName(0) = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Item_Name").ToString) & IIf(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Brand_Name").ToString) <> "", " - ", "") & Trim(prn_DetDt.Rows(prn_DetIndx).Item("Brand_Name").ToString) & IIf(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Item_Description").ToString) <> "", " (" & Trim(prn_DetDt.Rows(prn_DetIndx).Item("Item_Description").ToString) & ")", "")
