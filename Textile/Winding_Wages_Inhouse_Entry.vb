Public Class Winding_Wages_Inhouse_Entry
    ...
    Private Pk_Condition As String = "IWIWA-"
    ...
    Private Sub clear()
        ...
        dgv_Winding_Wages_Details.Rows.Clear()
        dgv_Winding_wages_Total.Rows.Clear()
        dgv_Winding_wages_Total.Rows.Add()
    ...
    Private Sub ControlGotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.ActiveControl.Name <> dgv_Winding_Wages_Details.Name Then
            Grid_DeSelect()
        End If
    ...
    Private Sub Grid_DeSelect()
        ...
        If Not IsNothing(dgv_Winding_Wages_Details.CurrentCell) Then dgv_Winding_Wages_Details.CurrentCell.Selected = False
        If Not IsNothing(dgv_Winding_wages_Total.CurrentCell) Then dgv_Winding_wages_Total.CurrentCell.Selected = False
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If ActiveControl.Name = dgv_Winding_Wages_Details.Name Or ActiveControl.Name = dgv_Winding_Wages_Details.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then

            'On Error Resume Next

            dgv1 = Nothing

            If ActiveControl.Name = dgv_Winding_Wages_Details.Name Then
                dgv1 = dgv_Winding_Wages_Details


            ElseIf dgv_Winding_Wages_Details.IsCurrentRowDirty = True Then
                dgv1 = dgv_Winding_Wages_Details
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Loom_Name  from  Winding_Wages_Head a LEFT OUTER JOIN Loom_Head b ON a.Loom_IdNo = b.Loom_IdNo Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Winding_Wages_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Winding_Wages_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Winding_Wages_Date").ToString
                ...
                'da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Loom_Name from Weaver_ClothReceipt_Piece_Details a LEFT OUTER JOIN Loom_Head b ON a.Loom_IdNo = b.Loom_IdNo where a.Winding_Wages_Code = '" & Trim(NewCode) & "' Order by a.Piece_No", con)
                'dt2 = New DataTable
                'da2.Fill(dt2)
                ...
                da3 = New SqlClient.SqlDataAdapter("Select a.*, b.Employee_Name from Winding_Wages_Details a inner join PayRoll_Employee_Head b On a.Employee_idno = b.Employee_idno Where Winding_Wages_Code = '" & Trim(NewCode) & "'", con)
                dt3 = New DataTable
                da3.Fill(dt3)
                With dgv_Winding_Wages_Details
                    .Rows.Clear()
                    SNo = 0
                ...
                '    If .RowCount = 0 Then .Rows.Add()
                '    .Rows(0).Cells(2).Value = Format(Val(dt1.Rows(0).Item("Total_Checking_Meters").ToString), "########0.00")
                '    .Rows(0).Cells(3).Value = Format(Val(dt1.Rows(0).Item("Total_Weight").ToString), "########0.000")
                'End With

                dt2.Clear()

                'da2 = New SqlClient.SqlDataAdapter("select Weaver_Wages_Code from Weaver_Cloth_Receipt_Head Where Winding_Wages_Code = '" & Trim(NewCode) & "'", con)
                'dt2 = New DataTable
                'da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Inhouse_Piece_Checking_Entry, New_Entry, Me, con, "Winding_Wages_Head", "Winding_Wages_Code", NewCode, "Winding_Wages_Date", "(Winding_Wages_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        'Da = New SqlClient.SqlDataAdapter("select Weaver_Wages_Code from Weaver_Cloth_Receipt_Head Where Winding_Wages_Code = '" & Trim(NewCode) & "'", con)
        'Dt1 = New DataTable
        'Da.Fill(Dt1)
        ...
        Try
            ...
            '   Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Winding_Wages_Head", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Winding_Wages_Code, Company_IdNo, for_OrderBy", trans)

            '   Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Weaver_ClothReceipt_Piece_Details", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Piece_No,PieceNo_OrderBy,ReceiptMeters_Checking", "Sl_No", "Winding_Wages_Code, For_OrderBy, Company_IdNo, Winding_Wages_No, Winding_Wages_Date, Ledger_Idno", trans)

            '----- Less Checking Meters (Consumption)
            'cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Production_Meters = a.Production_Meters - b.BeamConsumption_Checking from Stock_SizedPavu_Processing_Details a, Weaver_Cloth_Receipt_Head b where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and  b.set_code1 <> '' and b.Beam_No1 <> '' and a.set_code = b.Set_code1 and a.Beam_No = b.Beam_No1"
            'cmd.ExecuteNonQuery()
            'cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Production_Meters = a.Production_Meters - b.BeamConsumption_Checking from Stock_SizedPavu_Processing_Details a, Weaver_Cloth_Receipt_Head b where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and  b.set_code2 <> '' and b.Beam_No2 <> '' and a.set_code = b.Set_code2 and a.Beam_No = b.Beam_No2"
            'cmd.ExecuteNonQuery()
            ''----- Add Doffing Meters (Consumption)
            'cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Production_Meters = a.Production_Meters + b.BeamConsumption_Receipt from Stock_SizedPavu_Processing_Details a, Weaver_Cloth_Receipt_Head b where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and  b.set_code1 <> '' and b.Beam_No1 <> '' and a.set_code = b.Set_code1 and a.Beam_No = b.Beam_No1"
            'cmd.ExecuteNonQuery()
            'cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Production_Meters = a.Production_Meters + b.BeamConsumption_Receipt from Stock_SizedPavu_Processing_Details a, Weaver_Cloth_Receipt_Head b where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and  b.set_code2 <> '' and b.Beam_No2 <> '' and a.set_code = b.Set_code2 and a.Beam_No = b.Beam_No2"
            'cmd.ExecuteNonQuery()

            'cmd.CommandText = "Update Stock_Yarn_Processing_Details set Particulars = 'Doff : Roll.No. ' + b.Weaver_ClothReceipt_No +  ', Cloth : ' + c.Cloth_Name + ', Meters : ' +  cast(ROUND(b.ReceiptMeters_Receipt,2) as varchar), Weight = b.ConsumedYarn_Receipt from Stock_Yarn_Processing_Details a, Weaver_Cloth_Receipt_Head b, Cloth_Head c Where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and a.Reference_Code = '" & Trim(Pk_Condition2) & "' + b.Weaver_ClothReceipt_Code and b.Weaver_Wages_Code = '' and b.cloth_idno = c.cloth_idno"
            'cmd.ExecuteNonQuery()

            'cmd.CommandText = "Update Stock_Pavu_Processing_Details set Meters = b.ConsumedPavu_Receipt from Stock_Pavu_Processing_Details a, Weaver_Cloth_Receipt_Head b Where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and a.Reference_Code = '" & Trim(Pk_Condition2) & "' + b.Weaver_ClothReceipt_Code and b.Weaver_Wages_Code = ''"
            'cmd.ExecuteNonQuery()

            'cmd.CommandText = "Update Stock_Cloth_Processing_Details set reference_date = (case when b.Weaver_Wages_Code <> '' then b.Weaver_Wages_Date else b.Weaver_ClothReceipt_Date end), Folding = b.Folding_Receipt, UnChecked_Meters = (case when b.Weaver_Wages_Code = '' then b.ReceiptMeters_Receipt else 0 end), Meters_Type1 = (case when b.Weaver_Wages_Code <> '' then b.Type1_Wages_Meters else 0 end), Meters_Type2 = (case when b.Weaver_Wages_Code <> '' then b.Type2_Wages_Meters else 0 end), Meters_Type3 = (case when b.Weaver_Wages_Code <> '' then b.Type3_Wages_Meters else 0 end), Meters_Type4 = (case when b.Weaver_Wages_Code <> '' then b.Type4_Wages_Meters else 0 end), Meters_Type5 = (case when b.Weaver_Wages_Code <> '' then b.Type5_Wages_Meters else 0 end) from Stock_Cloth_Processing_Details a, Weaver_Cloth_Receipt_Head b Where b.Winding_Wages_Code = '" & Trim(NewCode) & "' and a.Reference_Code = '" & Trim(Pk_Condition2) & "' + b.Weaver_ClothReceipt_Code"
            'cmd.ExecuteNonQuery()

            'cmd.CommandText = "Update Weaver_Cloth_Receipt_Head set Winding_Wages_Code = '', Weaver_Piece_Checking_Increment = Weaver_Piece_Checking_Increment - 1, Winding_Wages_Date = Null, Receipt_Meters = ReceiptMeters_Receipt, Folding = Folding_Receipt, Consumed_Yarn = ConsumedYarn_Receipt, Consumed_Pavu = ConsumedPavu_Receipt, BeamConsumption_Meters = BeamConsumption_Receipt, Folding_Checking = 0, ReceiptMeters_Checking = 0, ConsumedYarn_Checking = 0, ConsumedPavu_Checking = 0, BeamConsumption_Checking = 0, Type1_Checking_Meters = 0, Type2_Checking_Meters = 0, Type3_Checking_Meters = 0, Type4_Checking_Meters = 0, Type5_Checking_Meters = 0, Total_Checking_Meters = 0 Where Winding_Wages_Code = '" & Trim(NewCode) & "'"
            'cmd.ExecuteNonQuery()


            'cmd.CommandText = "delete from Weaver_ClothReceipt_Piece_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(NewCode) & "'"
            'cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Winding_Wages_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Winding_Wages_No from Winding_Wages_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby, Winding_Wages_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Winding_Wages_No from Winding_Wages_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Winding_Wages_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Winding_Wages_No from Winding_Wages_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby desc, Winding_Wages_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Winding_Wages_No from Winding_Wages_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby desc, Winding_Wages_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Winding_Wages_Head", "Winding_Wages_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red


            dtp_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Winding_Wages_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Winding_Wages_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Winding_Wages_Date").ToString <> "" Then dtp_Date.Text = dt1.Rows(0).Item("Winding_Wages_Date").ToString
                End If
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Winding_Wages_No from Winding_Wages_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(RecCode) & "' ", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Inhouse_Piece_Checking_Entry, New_Entry, Me, con, "Winding_Wages_Head", "Winding_Wages_Code", NewCode, "Winding_Wages_Date", "(Winding_Wages_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Winding_Wages_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        If dgv_Winding_wages_Total.RowCount > 0 Then
            vTot_wagMtr = Val(dgv_Winding_wages_Total.Rows(0).Cells(2).Value())
            vTot_WagAmt = Val(dgv_Winding_wages_Total.Rows(0).Cells(4).Value())
        End If
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Winding_Wages_Head", "Winding_Wages_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Winding_Wages_Head (  Winding_Wages_Code,             Company_IdNo         ,      Winding_Wages_No ,                               for_OrderBy                              ,                   Winding_Wages_Date,       Loom_IdNo        ,     Total_Wages_Meters   ,          Total_Wages_Amount  , User_idno ) " & _
            ...
            Else
                'Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Winding_Wages_Head", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Winding_Wages_Code, Company_IdNo, for_OrderBy", tr)

                'Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Weaver_ClothReceipt_Piece_Details", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Piece_No,PieceNo_OrderBy,ReceiptMeters_Checking", "Sl_No", "Winding_Wages_Code, For_OrderBy, Company_IdNo, Winding_Wages_No, Winding_Wages_Date, Ledger_Idno", tr)


                cmd.CommandText = "Update Winding_Wages_Head set Winding_Wages_Date = @ChkDate, Winding_Wages_No ='" & Trim(lbl_RefNo.Text) & "',  Loom_IdNo = " & Val(Lm_ID) & ", Total_Wages_Meters = " & Str(Val(vTot_wagMtr)) & ", Total_Wages_Amount = " & Str(Val(vTot_WagAmt)) & " , User_idno = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            End If
            '   Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Winding_Wages_Head", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Winding_Wages_Code, Company_IdNo, for_OrderBy", tr)
            ...
            '    Next
            '    Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Weaver_ClothReceipt_Piece_Details", "Winding_Wages_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Piece_No,PieceNo_OrderBy,ReceiptMeters_Checking", "Sl_No", "Winding_Wages_Code, For_OrderBy, Company_IdNo, Winding_Wages_No, Winding_Wages_Date, Ledger_Idno", tr)

            'End With

            cmd.CommandText = "Delete from Winding_Wages_Details where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            With dgv_Winding_Wages_Details
                ...
                For i = 0 To .RowCount - 1
                    If Val(.Rows(i).Cells(2).Value) <> 0 Then
                        ...
                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Winding_Wages_Details ( Winding_Wages_Code ,             Company_IdNo         ,     Winding_Wages_No   ,  Winding_Wages_Date,                                         for_orderby                               ,                               Employee_IdNo   ,  Sl_No      ,                 Wages_Meters               ,                            Wages_Rate        ,   Wages_Amount  ) " & _
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Winding_Wages_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Winding_Wages_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Winding_Wages_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Loom_Name  from Winding_Wages_Head a  LEFT OUTER JOIN Loom_Head b ON a.Loom_IdNo = b.Loom_IdNo Where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Winding_Wages_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Winding_Wages_Date, a.for_orderby, a.Winding_Wages_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Winding_Wages_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Winding_Wages_Date").ToString), "dd-MM-yyyy")
    ...
    '    Da = New SqlClient.SqlDataAdapter("Select Winding_Wages_No from Winding_Wages_Head where Receipt_PkCondition = '" & Trim(Pk_Condition2) & "' and Piece_Receipt_Code = '" & Trim(LtCd) & "' and Receipt_Type = 'L'", con)
    '    Dt1 = New DataTable
    '    Da.Fill(Dt1)

    '    If Dt1.Rows.Count > 0 Then
    '        Call move_record(Dt1.Rows(0).Item("Winding_Wages_No").ToString)
    ...
    '        Da.Fill(Dt2)
    '        If Dt2.Rows.Count > 0 Then
    '            If IsDBNull(Dt2.Rows(0).Item("Winding_Wages_Date").ToString) = False Then
    '                If IsDate(Dt2.Rows(0).Item("Winding_Wages_Date").ToString) = True Then
    '                    dtp_Date.Text = Dt2.Rows(0).Item("Winding_Wages_Date").ToString
    '                End If
    '            End If
    ...
    Private Sub cbo_LoomNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_LoomNo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_LoomNo, dtp_Date, dgv_Winding_Wages_Details, "Loom_Head", "Loom_Name", "", "(Loom_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_LoomNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_LoomNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_LoomNo, dgv_Winding_Wages_Details, "Loom_Head", "Loom_Name", "", "(Loom_IdNo = 0 )")
    End Sub
    ...
    Private Sub Printing_BarCode_Sticker(ByVal NewCode As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Winding_Wages_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Winding_Wages_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument2_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument2.BeginPrint
        ...
        Try
            ...
            'SQL = "select a.*, b.* ,c.* , d.Cloth_Name from Winding_Wages_Head a " & _
            ...
            '     " and a.Winding_Wages_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'" & _
            '    IIf(Trim(Condt) <> "", " and ", "") & Condt & _
            '    " ORDER BY Winding_Wages_No ASC "
            ...
            SQL = "Select a.*, b.Piece_Receipt_No, d.Cloth_Name,d.CLoth_Description from Weaver_ClothReceipt_Piece_Details a " & _
                " INNER JOIN Winding_Wages_Head b on  a.Winding_Wages_Code= b.Winding_Wages_Code " & _
                 " LEFT OUTER JOIN Cloth_Head d ON d.Cloth_IdNo = a.Cloth_Idno " & _
                " where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & _
                " and a.Winding_Wages_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'" & _
                IIf(Trim(Condt) <> "", " and ", "") & Condt & _
    ...
    Private Sub dgv_Production_Wages_CellEndEdit(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Winding_Wages_Details.CellEndEdit
        dgv_Production_Wages_CellLeave(sender, e)
    End Sub

    Private Sub dgv_Production_Wages_Details_RowsAdded(sender As Object, e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_Winding_Wages_Details.RowsAdded
        Dim n As Integer
        If IsNothing(dgv_Winding_Wages_Details.CurrentCell) Then Exit Sub
        With dgv_Winding_Wages_Details
            n = .RowCount
    ...
    Private Sub dgv_Production_Wages_CellEnter(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Winding_Wages_Details.CellEnter
        Dim Da As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim Dt2 As New DataTable
        Dim Dt3 As New DataTable
    ...
    Private Sub dgv_Production_Wages_CellLeave(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Winding_Wages_Details.CellLeave
        With dgv_Winding_Wages_Details
    ...
    Private Sub dgv_Production_Wages_CellValueChanged(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Winding_Wages_Details.CellValueChanged
        Try
            If IsNothing(dgv_Winding_Wages_Details.CurrentCell) Then Exit Sub
            With dgv_Winding_Wages_Details
                If .Visible Then
    ...
    Private Sub dgv_Production_Wages_EditingControlShowing(sender As Object, e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles dgv_Winding_Wages_Details.EditingControlShowing
        dgtxt_WagesDetails = CType(dgv_Winding_Wages_Details.EditingControl, DataGridViewTextBoxEditingControl)
        dgtxt_WagesDetails.CharacterCasing = CharacterCasing.Upper
    End Sub

    Private Sub dgv_Production_Wages_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles dgv_Winding_Wages_Details.KeyUp
        Dim i As Integer
        Dim n As Integer
        Try
    ...
    Private Sub dgv_Production_Wages_LostFocus(sender As Object, e As System.EventArgs) Handles dgv_Winding_Wages_Details.LostFocus
        On Error Resume Next
        If Not IsNothing(dgv_Winding_Wages_Details.CurrentCell) Then dgv_Winding_Wages_Details.CurrentCell.Selected = False
    End Sub
    ...
    Private Sub dgtxt_WagesDetails_Enter(sender As Object, e As System.EventArgs) Handles dgtxt_WagesDetails.Enter
        Try
            dgv_Winding_Wages_Details.EditingControl.BackColor = Color.Lime
            dgv_Winding_Wages_Details.EditingControl.ForeColor = Color.Blue
