Public Class OE_Reeling_Receipt
    ...
    Private Pk_Condition As String = "REREC-"
    ...
    Private Sub Cotton_Order_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            End If
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_Grid_Conetype.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "COLOUR" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
    ...
    Private Sub Cotton_Order_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Cotton_Order_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    '
    Private Sub Cotton_Order_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt1 As New DataTable
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Reeling_Receipt_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Reeling_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Reeling_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Reeling_Receipt_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Count_Name, c.ConeType_Name from Reeling_Receipt_Details a LEFT OUTER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN ConeType_Head c ON a.ConeType_IdNo = c.ConeType_IdNo Where a.Reeling_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(2).Value = dt2.Rows(i).Item("ConeType_Name").ToString
                            .Rows(n).Cells(3).Value = Val(dt2.Rows(i).Item("Chippam").ToString)
                            .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Weight_Chippam").ToString), "########0.000")
                ...
                With dgv_Details_Total
                    If .RowCount = 0 Then .Rows.Add()
                    .Rows(0).Cells(3).Value = Val(dt1.Rows(0).Item("Total_Chippam").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.OEENTRY_REELING_RECEIPT_ENTRY, New_Entry, Me, con, "Reeling_Receipt_Head", "Reeling_Receipt_Code", NewCode, "Reeling_Receipt_Date", "(Reeling_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from Reeling_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Reeling_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Reeling_Receipt_No from Reeling_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Reeling_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Reeling_Receipt_No from Reeling_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Reeling_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Reeling_Receipt_No from Reeling_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Reeling_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Reeling_Receipt_No from Reeling_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Reeling_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Reeling_Receipt_Head", "Reeling_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Reeling_Receipt_No from Reeling_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.OEENTRY_REELING_RECEIPT_ENTRY, New_Entry, Me) = False Then Exit Sub

        Try

            inpno = InputBox("Enter New Rec No.", "FOR NEW REC NO. INSERTION...")
            ...
            Else
                If Val(inpno) = 0 Then
                    MessageBox.Show("Invalid Rec No.", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotChipp As Single, vTotWgt As Single, vTotAmt As Single
        ...
        End If
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.OEENTRY_REELING_RECEIPT_ENTRY, New_Entry, Me, con, "Reeling_Receipt_Head", "Reeling_Receipt_Code", NewCode, "Reeling_Receipt_Date", "(Reeling_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Reeling_Receipt_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(3).Value) <> 0 Then
                ...
                CnTy_Id = Common_Procedures.ConeType_NameToIdNo(con, dgv_Details.Rows(i).Cells(2).Value)
                If CnTy_Id = 0 Then
        ...
        vTotChipp = 0 : vTotWgt = 0 : vTotAmt = 0

        If dgv_Details_Total.RowCount > 0 Then
            vTotChipp = Val(dgv_Details_Total.Rows(0).Cells(3).Value())
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Reeling_Receipt_Head", "Reeling_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Reeling_Receipt_Head ( Reeling_Receipt_Code ,               Company_IdNo       ,     Reeling_Receipt_No  ,                                               for_OrderBy                    , Reeling_Receipt_Date  ,              Ledger_IdNo,                JJFrom_No         ,                  Van_No      ,                    Party_Dc_No    ,         Total_Chippam    ,          Total_Weight   ) " &
                                    "     Values                              (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",       @RecDate   , " & Str(Val(Led_ID)) & ", '" & Trim(txt_JJFromNo.Text) & "', '" & Trim(txt_VanNo.Text) & "' ,'" & Trim(txt_PartyDcNo.Text) & "' , " & Str(Val(vTotChipp)) & ", " & Str(Val(vTotWgt)) & ") "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Reeling_Receipt_Head set Reeling_Receipt_Date = @RecDate, Ledger_IdNo =  " & Str(Val(Led_ID)) & " , JJFrom_No = '" & Trim(txt_JJFromNo.Text) & "',Van_No = '" & Trim(txt_VanNo.Text) & "' ,Party_Dc_No = '" & Trim(txt_PartyDcNo.Text) & "' , Total_Chippam = " & Str(Val(vTotChipp)) & "  ,  Total_Weight = " & Str(Val(vTotWgt)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            Partcls = "Rec : Rec.No. " & Trim(lbl_DcNo.Text)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        CnTy_Id = Common_Procedures.ConeType_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)

                        cmd.CommandText = "Insert into Reeling_Receipt_Details ( Reeling_Receipt_Code ,               Company_IdNo                 ,   Reeling_Receipt_No    ,                     for_OrderBy                                            , Reeling_Receipt_Date        ,                     Sl_No       ,        Count_IdNo          ,       ConeType_IdNo         ,                 Chippam           ,                      Weight_Chippam        ,  Weight    ) " &
                                            "     Values                        (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",       @RecDate            ,  " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & "   , " & Str(Val(CnTy_Id)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & " , " & Str(Val(.Rows(i).Cells(5).Value)) & " ) "
                        cmd.ExecuteNonQuery()
                        ...
                        cmd.CommandText = "Insert into Stock_hankYarn_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                       ,        Reference_Date,     Party_Bill_No   , Entry_ID      ,  Sl_No      ,     Ledger_idNo      ,               Count_IdNo    ,           ConeType_IdNo     ,                   Form_No               ,           Chippam               ,        Weight                                 ) " &
                                                                   "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",    @RecDate   , '" & Trim(PBlNo) & "'  , '" & Trim(EntID) & "', " & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & ", " & Str(Val(Cnt_ID)) & "," & Str(Val(CnTy_Id)) & ",  '" & Trim(txt_JJFromNo.Text) & "',   " & (1 * Val(.Rows(i).Cells(3).Value)) & "," & Str(1 * Val(.Rows(i).Cells(5).Value)) & " )"
                        cmd.ExecuteNonQuery()


                        cmd.CommandText = "Insert into Stock_Reeling_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                   ,      Reference_Date,     Party_Bill_No   , Entry_ID   ,  Sl_No      ,     Ledger_idNo      ,               Count_IdNo    ,           ConeType_IdNo     ,                   Form_No        ,        Weight                                 ) " &
                                                                  "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",    @RecDate   , '" & Trim(PBlNo) & "','" & Trim(EntID) & "' , " & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & ", " & Str(Val(Cnt_ID)) & "," & Str(Val(CnTy_Id)) & ",  '" & Trim(txt_JJFromNo.Text) & "',   " & Str(-1 * Val(.Rows(i).Cells(5).Value)) & " )"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Then
                    ...
                    TotChipp = TotChipp + Val(.Rows(i).Cells(3).Value())
        ...
        With dgv_Details_Total
            If .RowCount = 0 Then .Rows.Add()
            .Rows(0).Cells(3).Value = Val(TotChipp)
            .Rows(0).Cells(5).Value = Format(Val(TotWgt), "########0.00")
    ...
    Private Sub cbo_Grid_Count_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Count.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_Count, txt_VanNo, cbo_Grid_Conetype, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    ...
    Private Sub cbo_Grid_Count_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Grid_Count.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_Count, cbo_Grid_Conetype, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    ...
    Private Sub cbo_Grid_Colour_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_Conetype.GotFocus
        vCbo_ItmNm = Trim(cbo_Grid_Conetype.Text)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "ConeType_Head", "ConeType_Name", "", "(ConeType_IdNo = 0)")

    End Sub

    Private Sub cbo_Grid_Colour_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Conetype.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_Conetype, Nothing, Nothing, "ConeType_Head", "ConeType_Name", "", "(ConeType_IdNo = 0)")
        vcbo_KeyDwnVal = e.KeyValue
    ...
    Private Sub cbo_Grid_Colour_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Grid_Conetype.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_Conetype, Nothing, "ConeType_Head", "ConeType_Name", "", "(ConeType_IdNo = 0)")
        ...
        With dgv_Details
            ...
            If e.ColumnIndex = 2 Then
                ...
                If cbo_Grid_Conetype.Visible = False Or Val(cbo_Grid_Conetype.Tag) <> e.RowIndex Then
                    ...
                    cbo_Grid_Conetype.DisplayMember = "ConeType_Name"
    ...
    Private Sub cbo_Grid_Colour_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Conetype.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    Private Sub cbo_Grid_Colour_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_Conetype.TextChanged
        Try
            If cbo_Grid_Conetype.Visible Then
                With dgv_Details
                    If Val(cbo_Grid_Conetype.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 2 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Reeling_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Reeling_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Reeling_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(cbo_Filter_Colour.Text) <> "" Then
                clr_IdNo = Common_Procedures.ConeType_NameToIdNo(con, cbo_Filter_Colour.Text)
            End If
            ...
            If Val(clr_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.ConeType_IdNo = " & Str(Val(clr_IdNo))
            End If

            da = New SqlClient.SqlDataAdapter("select a.*, b.*,c.Count_Name, d.ConeType_Name, e.Ledger_Name from Reeling_Receipt_Head a left outer join Reeling_Receipt_Details b on a.Reeling_Receipt_Code = b.Reeling_Receipt_Code left outer join Count_head c on b.Count_idno = c.Count_idno left outer join ConeType_Head d on b.ConeType_IdNo = d.ConeType_IdNo inner join Ledger_head e on a.Ledger_idno = e.Ledger_idno  where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Reeling_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Reeling_Receipt_Date, a.for_orderby, a.Reeling_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Reeling_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Reeling_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, dtp_Filter_ToDate, cbo_Filter_Colour, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.OEENTRY_REELING_RECEIPT_ENTRY, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Reeling_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Reeling_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Reeling_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_name, d.ClothType_name from Reeling_Receipt_Details a INNER JOIN Cloth_Head b ON a.Cloth_idno = b.Cloth_idno LEFT OUTER JOIN ClothType_Head d ON a.ClothType_idno = d.ClothType_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Reeling_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_name, d.ClothType_name from Reeling_Receipt_Details a INNER JOIN Cloth_Head b ON a.Cloth_idno = b.Cloth_idno LEFT OUTER JOIN ClothType_Head d ON a.ClothType_idno = d.ClothType_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Reeling_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Reeling_Receipt_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Reeling_Receipt_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt + 10
    ...
    Private Sub cbo_Filter_Colour_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_Colour.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Dim f As New Color_Creation
