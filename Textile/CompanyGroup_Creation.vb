Public Class CompanyGroup_Creation
    ...
    Private Sub clear()
        ...
        If Month(Date.Today) >= 4 Then
            ...
            dttm = New DateTime(Year(Date.Today), 4, 1)
            dtp_FromDate.Text = dttm

            dttm = New DateTime(Year(Date.Today) + 1, 3, 31)
            dtp_ToDate.Text = dttm

        Else

            dttm = New DateTime(Year(Date.Today) - 1, 4, 1)
            dtp_FromDate.Text = dttm

            dttm = New DateTime(Year(Date.Today), 3, 31)
            dtp_ToDate.Text = dttm
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select * from CompanyGroup_Head where CompanyGroup_IdNo = " & Str(Val(idno))
            ...
            If dr.HasRows Then
                If dr.Read() Then
                    ...
                    dttm = New DateTime(Microsoft.VisualBasic.Left(dr("Financial_Range").ToString, 4), Microsoft.VisualBasic.DateAndTime.Month(dr("From_Date")), Microsoft.VisualBasic.DateAndTime.Day(dr("From_Date")))
                    dtp_FromDate.Text = dttm

                    dttm = New DateTime(Microsoft.VisualBasic.Right(dr("Financial_Range").ToString, 4), Microsoft.VisualBasic.DateAndTime.Month(dr("To_Date")), Microsoft.VisualBasic.DateAndTime.Day(dr("To_Date")))
                    dtp_ToDate.Text = dttm
    ...
    Private Sub ItemGroup_Creation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            ...
            Else
                If MessageBox.Show("Do you want to close?", "FOR CLOSING...", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    Me.Close()
                Else
                    txt_Name.Focus()
                End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Trim(UCase(Common_Procedures.Password_Input)) <> "TSDCG222" Then
            MessageBox.Show("Invalid Password", "DOES NOT DELETE COMPANY GROUP...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select min(CompanyGroup_IdNo) from CompanyGroup_Head where CompanyGroup_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(CompanyGroup_IdNo) from CompanyGroup_Head where CompanyGroup_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select min(CompanyGroup_IdNo) from CompanyGroup_Head where CompanyGroup_IdNo > " & Str(Val(txt_IdNo.Text)) & " and CompanyGroup_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(CompanyGroup_IdNo) from CompanyGroup_Head where CompanyGroup_IdNo < " & Str(Val(txt_IdNo.Text)) & " and CompanyGroup_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Trim(txt_Name.Text) = "" Then
            MessageBox.Show("Invalid Company Group Name", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
        End If

        If IsDate(dtp_FromDate.Value) = False Then
            MessageBox.Show("Invalid Financial From Date", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            If dtp_FromDate.Enabled Then dtp_FromDate.Focus()
            Exit Sub
        End If

        If IsDate(dtp_ToDate.Value) = False Then
            MessageBox.Show("Invalid Financial To Date", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        ...
        If System.IO.File.Exists(Pth) = False Then
            MessageBox.Show("Invalid script file", "DOES NOT CREATE COMPANY GROUP...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
        End If

        FnRange = Year(dtp_FromDate.Value) & "-" & Year(dtp_ToDate.Value)
    ...
    Private Sub CreateNewDb_For_CompanyGroup(ByVal DataBaseName As String)
        ...
        If Dt1.Rows.Count = 0 Then
            ...
            Conn_String = Common_Procedures.Create_Sql_ConnectionString(DataBaseName)
    ...
    Private Sub Run_database_Script(ByVal Cn2 As SqlClient.SqlConnection)
        ...
        Try
            ...
            If System.IO.File.Exists(pth) = True Then
                ...
                fs.Dispose()
            Else
                MessageBox.Show("Invalid script file", "DOES NOT CREATE NEW COMPANY...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                Exit Sub
            ...
            Else
                MessageBox.Show("Invalid database script", "DOES NOT CREATE NEW COMPANY...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                Exit Sub
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "DOES NOT CREATE NEW COMPANY...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
