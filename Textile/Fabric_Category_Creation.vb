Public Class Fabric_Category_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Fabric_Category_IdNo, Fabric_Category_Name from Fabric_Category_Head where Fabric_Category_IdNo = " & Str(Val(idno))

            dr = cmd.ExecuteReader

            If dr.HasRows Then
                If dr.Read() Then
                    lbl_IdNo.Text = dr("Fabric_Category_IdNo").ToString()
                    txt_Name.Text = dr("Fabric_Category_Name").ToString()
                End If
            End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            'da = New SqlClient.SqlDataAdapter("select count(*) from Ledger_Head where Fabric_Category_IdNo = " & Str(Val(lbl_IdNo.Text)), con)
            'Dt = New DataTable
            'da.Fill(Dt)
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Fabric_Category_Head where Fabric_Category_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Fabric_Category_IdNo, Fabric_Category_Name from Fabric_Category_Head where Fabric_Category_IdNo <> 0 order by Fabric_Category_IdNo", con)
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "FABRIC CATEGORY NAME"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Fabric_Category_IdNo) from Fabric_Category_Head Where Fabric_Category_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select max(Fabric_Category_IdNo) from Fabric_Category_Head WHERE Fabric_Category_IdNo <> 0"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select min(Fabric_Category_IdNo) from Fabric_Category_Head where Fabric_Category_IdNo > " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Fabric_Category_IdNo) from Fabric_Category_Head where Fabric_Category_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and Fabric_Category_IdNo <> 0 ", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Fabric_Category_Head", "Fabric_Category_IdNo", "")

        'cmd.Connection = con
        'cmd.CommandText = "select max(Fabric_Category_IdNo) from Fabric_Category_Head"
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Fabric_Category_Name from Fabric_Category_Head order by Fabric_Category_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Find.DataSource = dt
        cbo_Find.DisplayMember = "Fabric_Category_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Fabric_Category_Head", "Fabric_Category_IdNo", "", trans)

                cmd.CommandText = "Insert into Fabric_Category_Head(Fabric_Category_IdNo, Fabric_Category_Name, sur_name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Fabric_Category_Head set Fabric_Category_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "' where Fabric_Category_IdNo = " & Str(Val(lbl_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "FABRIC CATEGORY"
        ...
        Catch ex As Exception
            ...
            If InStr(1, Trim(LCase(ex.Message)), "ix_Fabric_Category_Head") > 0 Then
                MessageBox.Show("Duplicate Fabric Category Name", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Find_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Find.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Fabric_Category_IdNo from Fabric_Category_Head where Fabric_Category_Name = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Find_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Find.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fabric_Category_Head", "Fabric_Category_Name", "", "")
    ...
    Private Sub cbo_Find_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Find.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Find, Nothing, Nothing, "Fabric_Category_Head", "Fabric_Category_Name", "", "")
    End Sub
    ...
    Private Sub cbo_Find_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Find.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Find, Nothing, "Fabric_Category_Head", "Fabric_Category_Name", "", "")
        Dim Indx As Integer
