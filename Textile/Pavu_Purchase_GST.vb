Public Class Pavu_Purchase_GSt
    ...
    Private Pk_Condition As String = "GPAVP-"
    Private PkCondition2_TDSPP As String = "TDSPP-"
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Pavu_Purchase_Entry, New_Entry, Me, con, "Pavu_Purchase_Head", "Pavu_Purchase_Code", NewCode, "Pavu_Purchase_Date", "(Pavu_Purchase_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            ...
            If Val(Common_Procedures.get_FieldValue(con, "Pavu_Purchase_Head", "Verified_Status", "(Pavu_Purchase_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Pavu_Purchase_Head", "Pavu_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Pavu_Purchase_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Pavu_Purchase_Details", "Pavu_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Purchase_Code, For_OrderBy, Company_IdNo, Pavu_Purchase_No, Pavu_Purchase_Date, Ledger_Idno", trans)

            Common_Procedures.Voucher_Deletion(con, Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), trans)
            Common_Procedures.Voucher_Deletion(con, Val(lbl_Company.Tag), Trim(PkCondition2_TDSPP) & Trim(NewCode), trans)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Pavu_Purchase_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Pavu_Purchase_Entry, New_Entry, Me, con, "Pavu_Purchase_Head", "Pavu_Purchase_Code", NewCode, "Pavu_Purchase_Date", "(Pavu_Purchase_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Pavu_Purchase_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Pavu_Purchase_Head (Entry_VAT_GST_Type , Pavu_Purchase_Code, Company_IdNo, Pavu_Purchase_No, for_OrderBy, Pavu_Purchase_Date, Ledger_IdNo, DeliveryTo_IdNo, Party_DcNo, Set_No,PurchaseAc_IdNo , EndsCount_IdNo, Pcs_Length, Total_Beam,Total_Pcs ,Total_Meters,Rate_Meters,Gross_Amount,Add_Less,Net_Amount,User_idno ,CGST_Percentage  ,CGST_Amount   ,SGST_Percentage  ,SGST_Amount,IGST_Percentage  ,IGST_Amount ,Verified_Status , TDS_Tax_Status , EDIT_TDS_TaxableValue , TDS_Percentage , TDS_Amount , TDS_Taxable_Value , Bill_amount) Values ('GST' , '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(Led_ID)) & ", " & Str(Val(DelvTo_ID)) & ", '" & Trim(txt_PartyBillNo.Text) & "', '" & Trim(txt_SetNo.Text) & "'," & Str(Val(PurcAc_ID)) & ", " & Val(EdsCnt_ID) & ", " & Val(txt_PcsLength.Text) & ", " & Str(Val(vTotPvuBms)) & "," & Str(Val(vTotPvuPcs)) & ", " & Str(Val(vTotPvuMtrs)) & "," & Val(txt_RateMeters.Text) & "," & Val(lbl_GrossAmount.Text) & "," & Val(txt_AddLess.Text) & "," & Str(Val(CDbl(lbl_NetAmount.Text))) & "," & Val(lbl_UserName.Text) & "," & Str(Val(txt_CGST_Perc.Text)) & "," & Str(Val(lbl_CGstAmount.Text)) & "," & Str(Val(txt_SGST_Perc.Text)) & "," & Str(Val(lbl_SGstAmount.Text)) & "," & Str(Val(txt_IGST_Perc.Text)) & "," & Str(Val(lbl_IGstAmount.Text)) & ", " & Val(Verified_STS) & " , " & Str(Val(vTDS_Tax_Sts)) & " , " & Str(Val(vTDS_AssVal_EditSTS)) & " , " & Str(Val(txt_TdsPerc.Text)) & " , " & Str(Val(lbl_TdsAmount.Text)) & ", " & Str(Val(txt_TDS_TaxableValue.Text)) & " , " & Val(lbl_BillAmount.Text) & ")"
                cmd.ExecuteNonQuery()

            Else

                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Pavu_Purchase_Head", "Pavu_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Pavu_Purchase_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Pavu_Purchase_Details", "Pavu_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Purchase_Code, For_OrderBy, Company_IdNo, Pavu_Purchase_No, Pavu_Purchase_Date, Ledger_Idno", tr)
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(dgv_PavuDetails.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Pavu_Purchase_Details (  Pavu_Purchase_Code ,              Company_IdNo        ,     Pavu_Purchase_No    ,                               for_OrderBy                              , Pavu_Purchase_Date ,                                  Ledger_IdNo     ,               Set_No          ,         Set_Code      ,             Sl_No    ,                    Beam_No             ,                      Pcs                 ,          Meters_Pc       ,                       Meters               ) " &
                        ...
                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Stock_SizedPavu_Processing_Details (                     Reference_Code          ,              Company_IdNo        ,               Reference_No    ,                               for_OrderBy                              , Reference_Date,         Ledger_IdNo     ,           StockAt_IdNo      ,         Set_Code      ,           Set_No              ,    setcode_forSelection     ,      Ends_Name         ,     count_idno           ,         EndsCount_IdNo     , Mill_IdNo, Beam_Width_Idno, Sizing_SlNo,         Sl_No        ,                    Beam_No             ,                               ForOrderBy_BeamNo                                 , Gross_Weight, Tare_Weight, Net_Weight,                      Noof_Pcs            ,          Meters_Pc      ,                      Meters               ) " &
                ...
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Pavu_Purchase_Details", "Pavu_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Purchase_Code, For_OrderBy, Company_IdNo, Pavu_Purchase_No, Pavu_Purchase_Date, Ledger_Idno", tr)
            ...
            If Val(lbl_BillAmount.Text) <> 0 Then
                ...
                vVou_Amts = Format(Val(CSng(lbl_BillAmount.Text)), "#########0.00") & "|" & -1 * Format(Val(CSng(lbl_BillAmount.Text)), "#########0.00")
            ...
            If Common_Procedures.Voucher_Updation(con, "pavuPurc.Tds", Val(lbl_Company.Tag), Trim(PkCondition2_TDSPP) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(msk_Date.Text), "Bill No : " & Trim(txt_PartyBillNo.Text) & " , pavuPurc.No : " & Trim(lbl_RefNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                Throw New ApplicationException(ErrMsg)
            End If


            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(txt_PartyBillNo.Text), 0, Val(lbl_BillAmount.Text), "CR", Trim(Pk_Condition) & Trim(NewCode), tr)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Pavu_Purchase_Entry, New_Entry) = False Then Exit Sub
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , d.EndsCount_Name ,f.*,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code from Pavu_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN State_HEad LSH on B.Ledger_State_IdNo = LSH.State_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo INNER JOIN Company_Head f ON a.Company_IdNo = f.Company_IdNo LEFT OUTER JOIN State_HEad CSH on F.Company_State_IdNo = CSH.State_IdNo where a.Pavu_Purchase_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Printing_Format1GST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "BILL NO", LMargin + M1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Party_DcNo").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
        CurY = CurY + TxtHgt + 10
        e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
        LnAr(3) = CurY
    ...
    Private Sub Printing_Format1GST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            If Val(prn_HdDt.Rows(0).Item("Rate_Meters").ToString) <> 0 Then
                Common_Procedures.Print_To_PrintDocument(e, "Rate/ Meters", LMargin + C1 + 10, CurY, 0, 0, pFont)
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Rate_Meters").ToString), PageWidth - 5, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Gross_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "" & (prn_HdDt.Rows(0).Item("Gross_Amount").ToString), PageWidth - 5, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Add_Less").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Add_Less").ToString), PageWidth - 5, CurY, 1, 0, pFont)
                End If
            End If
    ...
    Private Sub NetAmount_Calculation()
        ...
        lbl_CGstAmount.Text = Format(Val(lbl_GrossAmount.Text) * Val(txt_CGST_Perc.Text) / 100, "##########0.00")
        lbl_SGstAmount.Text = Format(Val(lbl_GrossAmount.Text) * Val(txt_SGST_Perc.Text) / 100, "###########0.00")
        lbl_IGstAmount.Text = Format(Val(lbl_GrossAmount.Text) * Val(txt_IGST_Perc.Text) / 100, "##########0.00")
        vBlAmt = Format(Val(lbl_GrossAmount.Text) + Val(txt_AddLess.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text), "##########0.00")
        ...
        If chk_TDS_Tax.Checked = True Then
            ...
            If vTDS_DED_STS = True Then
                ...
                If txt_TDS_TaxableValue.Enabled = False Then
                    ...
                    vTOT_SalAmt = Format(Val(lbl_GrossAmount.Text), "###########0")
    ...
    Private Sub cbo_Sizing_LostFocus(sender As Object, e As EventArgs) Handles cbo_Sizing.LostFocus
        If Trim(UCase(cbo_Sizing.Tag)) <> Trim(UCase(cbo_Sizing.Text)) Then
            cbo_Sizing.Tag = cbo_Sizing.Text
            get_Ledger_City_Name()
        End If
