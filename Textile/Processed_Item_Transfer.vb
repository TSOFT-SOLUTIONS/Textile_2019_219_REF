Public Class Processed_Item_Transfer
    ...
    Private Pk_Condition As String = "FPITM-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Item_From ,c.Processed_Item_Name as Item_To , D.Rack_No As RackNo_Frm , e.Rack_No As RackNo_Too  from Item_Transfer_Head a INNER JOIN Processed_Item_Head b ON a.Item_From_Idno = b.Processed_Item_IdNo INNER JOIN Processed_Item_Head c ON a.Item_To_Idno = c.Processed_Item_IdNo LEFT OUTER JOIN Rack_Head d ON d.Rack_Idno = A.RackFrom_IdNo LEFT OUTER JOIN Rack_Head e ON e.Rack_Idno = A.RackTo_IdNo  Where a.Item_Transfer_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Item_Transfer_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Item_Transfer_Date").ToString
                ...
                txt_Meters_from.Text = Format(Val(dt1.Rows(0).Item("Meters").ToString), "########0.00")
                txt_Meters_To.Text = Format(Val(dt1.Rows(0).Item("Meters_To").ToString), "########0.00")
    ...
    Private Sub Processed_Item_Transfer_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_ItemTo.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "FINISHEDPRODUCT" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_ItemTo.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_RackTo.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "RACK" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_RackTo.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
    ...
    Private Sub Processed_Item_Transfer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_Meters_from.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Meters_To.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_ItemTo.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Meters_from.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Meters_To.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Meters_from.KeyDown, AddressOf TextBoxControlKeyDown

        AddHandler dtp_Date.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Quantity.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler dtp_Filter_Fromdate.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler dtp_Filter_ToDate.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Meters_from.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub Processed_Item_Transfer_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    ...
    Private Sub Processed_Item_Transfer_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Item_transfer_Entry, New_Entry, Me, con, "Item_Transfer_Head", "Item_Transfer_Code", NewCode, "Item_Transfer_Date", "(Item_Transfer_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from Item_Transfer_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Transfer_No from Item_Transfer_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,Item_Transfer_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Transfer_No from Item_Transfer_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,Item_Transfer_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Transfer_No from Item_Transfer_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,Item_Transfer_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Transfer_No from Item_Transfer_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,Item_Transfer_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Item_Transfer_Head", "Item_Transfer_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Item_Transfer_No from Item_Transfer_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.FP_Item_Transfer_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Item_Transfer_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Item_transfer_Entry, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Item_Transfer_No from Item_Transfer_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_Item_transfer_Entry, New_Entry, Me, con, "Item_Transfer_Head", "Item_Transfer_Code", NewCode, "Item_Transfer_Date", "(Item_Transfer_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Item_Transfer_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        procto_ID = Common_Procedures.Processed_Item_NameToIdNo(con, cbo_ItemTo.Text)
        If procto_ID = 0 Then
            MessageBox.Show("Invalid Item ToName", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
            If cbo_ItemTo.Enabled And cbo_ItemTo.Visible Then cbo_ItemTo.Focus()
            Exit Sub
        End If
        ...
        Racto_Id = Common_Procedures.Rack_NoToIdNo(con, cbo_RackTo.Text)
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Item_Transfer_Head", "Item_Transfer_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Item_Transfer_Head (Item_Transfer_Code, Company_IdNo,Item_Transfer_No, for_OrderBy,Item_Transfer_Date,Item_From_Idno ,Item_To_Idno, RackFrom_IdNo , RackTo_IdNo , Quantity , Meters , Meters_to ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @TransferDate, " & Val(Procfm_ID) & "," & Str(Val(procto_ID)) & ", " & Str(Val(Racfrm_Id)) & ", " & Str(Val(Racto_Id)) & "," & Val(txt_Quantity.Text) & "," & Val(txt_Meters_from.Text) & " , " & Val(txt_Meters_To.Text) & " )"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Item_Transfer_Head set Item_Transfer_Date = @TransferDate, Item_From_Idno = " & Val(Procfm_ID) & ", Item_To_Idno =  " & Val(procto_ID) & ", RackFrom_IdNo = " & Str(Val(Racfrm_Id)) & " , RackTo_IdNo = " & Str(Val(Racto_Id)) & " , Quantity = " & Val(txt_Quantity.Text) & ", Meters = " & Val(txt_Meters_from.Text) & " ,Meters_to = " & Val(txt_Meters_To.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Transfer_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Stock_Type, Reference_Code, Reference_Date, Company_Idno, Ledger_Idno         , Item_IdNo, Rack_IdNo ) " & _
                                     " Select                               'PI'    , Reference_Code, Reference_Date, Company_IdNo, DeliveryTo_StockIdNo, Item_IdNo, Rack_IdNo from Stock_Item_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Insert into Stock_Item_Processing_Details ( Reference_Code                          ,            Company_IdNo          ,            Reference_No      ,            For_OrderBy                                                       ,  Reference_Date     ,   ReceivedFrom_StockIdNo ,    DeliveryTo_StockIdNo        , Delivery_PartyIdNo               , Received_PartyIdNo              , Entry_ID                     , Party_Bill_No                               , Particulars            , SL_No   ,       Item_IdNo            , Rack_IdNo                          ,                      Quantity          ,      Meters                 ) " & _
                                                       " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'      , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @TransferDate         ,               0         ,  " & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & "        ,              0                   ,         0                    ,'" & Trim(EntID) & "' , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',  1    , " & Str(Val(procto_ID)) & " , " & Str(Val(Racto_Id)) & " ,  " & Str(Val(txt_Quantity.Text)) & "   , " & Val(txt_Meters_To.Text) & "       ) "
            cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_itemFrom_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemFrom.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemFrom, dtp_Date, cbo_ItemTo, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_IdNo = 0)")
    ...
    Private Sub cbo_ItemFrom_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemFrom.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemFrom, cbo_ItemTo, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_RackFrom_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RackFrom.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RackFrom, cbo_ItemTo, cbo_RackTo, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_RackFrom_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RackFrom.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RackFrom, cbo_RackTo, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")

    End Sub

    Private Sub cbo_ItemTo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemTo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_IdNo = 0)")

    End Sub

    Private Sub cbo_ItemTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemTo.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemTo, cbo_ItemFrom, cbo_RackFrom, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_IdNo = 0)")

    End Sub

    Private Sub cbo_ItemTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemTo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemTo, cbo_RackFrom, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_IdNo = 0)")

    End Sub

    Private Sub cbo_ITemTo_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemTo.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then

            Dim f As New FinishedProduct_Creation

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_ItemTo.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_RackTo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_RackTo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")

    End Sub


    Private Sub cbo_RackTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RackTo.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RackTo, cbo_RackFrom, txt_Quantity, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")

    End Sub

    Private Sub cbo_RackTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RackTo.KeyPress

        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RackTo, txt_Quantity, "Rack_Head", "Rack_No", "(Close_Status = 0)", "(Rack_IdNo = 0)")
    ...
    Private Sub cbo_RackTo_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RackTo.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Dim f As New RackNo_Creation

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_RackTo.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
            Condt = "a.Item_Transfer_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
        ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
            Condt = "a.Item_Transfer_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
        ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
            Condt = "a.Item_Transfer_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
        End If
        ...
        da = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Item_From_Name,c.Processed_Item_Name as Item_To_Name from Item_Transfer_Head a INNER JOIN Processed_Item_Head b on a.Item_From_Idno = b.Processed_Item_IdNo INNER JOIN Processed_Item_Head c on a.Item_To_Idno = c.Processed_Item_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Transfer_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Item_Transfer_No", con)
        da.Fill(dt2)
        ...
        If dt2.Rows.Count > 0 Then
            ...
            For i = 0 To dt2.Rows.Count - 1
                ...
                dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Item_Transfer_No").ToString
                dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Item_Transfer_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub txt_Meters_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Meters_from.KeyDown
    ...
    Private Sub txt_Meters_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Meters_from.KeyPress
        If Val(Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar))) = 0 Then
            e.Handled = True
        End If
    End Sub

    Private Sub txt_Meters_to_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Meters_To.KeyDown
        If e.KeyCode = 40 Then
            If MessageBox.Show("Do you want to save?", "FOR SAVING...", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                save_record()
            Else
        ...
        If e.KeyCode = 38 Then
            Show_Item_CurrentStock()
            txt_Meters_from.Focus()
        End If

    End Sub

    Private Sub txt_Meters_to_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Meters_To.KeyPress
        If Val(Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar))) = 0 Then
            e.Handled = True
        End If
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_RackFrom_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_RackFrom.SelectedIndexChanged
