Public Class Sizing_Chemical_ExcessShort
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Sizing_Chemical_Item_ExcessShort_Head a INNER JOIN Sizing_Item_Head b ON a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c ON a.Unit_IdNo = c.Unit_IdNo where a.Item_ExcessShort_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_Quantity.Text = Trim(Format(Val(dt1.Rows(0).Item("Quantity").ToString), "########0.000"))
    ...
    Private Sub Chemical_ExcessShort_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_Unit.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "ITEM" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
    ...
    Private Sub Chemical_ExcessShort_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Chemical_ExcessShort_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Chemical_ExcessShort_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Dim da As SqlClient.SqlDataAdapter
        Dim dt1 As New DataTable
        Dim NoofComps As Integer
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_EXCESS_SHORT, New_Entry, Me, con, "Sizing_Chemical_Item_ExcessShort_Head", "Item_ExcessShort_Code", NewCode, "Item_ExcessShort_Date", "(Item_ExcessShort_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.Connection = con
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Sizing_Chemical_Item_ExcessShort_Head", "Item_ExcessShort_COde", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Item_ExcessShort_Code, Company_IdNo, for_OrderBy")
            ...
            cmd.CommandText = "delete from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_EXCESS_SHORT, New_Entry, Me) = False Then Exit Sub
            ...
            cmd.Connection = con
            cmd.CommandText = "select Item_ExcessShort_No from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Item_ExcessShort_No from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_ExcessShort_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Item_ExcessShort_No from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_ExcessShort_No desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Item_ExcessShort_No from Sizing_Chemical_Item_ExcessShort_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_ExcessShort_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Item_ExcessShort_No from Sizing_Chemical_Item_ExcessShort_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_ExcessShort_No desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Item_ExcessShort_no from Sizing_Chemical_Item_ExcessShort_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code = '" & Trim(NewCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_EXCESS_SHORT, New_Entry, Me, con, "Sizing_Chemical_Item_ExcessShort_Head", "Item_ExcessShort_Code", NewCode, "Item_ExcessShort_Date", "(Item_ExcessShort_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Item_ExcessShort_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            If Trim(cbo_ExCessShort.Text) = "EXCESS" Then
                Exc_Sht = Format(Val(txt_Quantity.Text), "##########0.000")
            Else
                Exc_Sht = Format(-1 * Val(txt_Quantity.Text), "##########0.000")
            End If

            If New_Entry = True Then

                cmd.CommandText = "Insert into Sizing_Chemical_Item_ExcessShort_Head(User_IdNo,Item_ExcessShort_Code, Company_IdNo, Item_ExcessShort_No, for_OrderBy, Item_ExcessShort_Date, Item_IdNo, Unit_IdNo, ExcessShort_Type, Quantity) Values (" & Str(UserIdNo) & ",'" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @ExcShtDate, " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", '" & Trim(cbo_ExCessShort.Text) & "', " & Str(Val(txt_Quantity.Text)) & " )"

                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Sizing_Chemical_Item_ExcessShort_Head", "Item_ExcessShort_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_ExcessShort_Code, Company_IdNo, for_OrderBy", tr)

                cmd.CommandText = "Update Sizing_Chemical_Item_ExcessShort_Head set User_IdNo=" & Str(UserIdNo) & ",Item_ExcessShort_Date = @ExcShtDate, ExcessShort_Type = '" & Trim(cbo_ExCessShort.Text) & "', Item_IdNo = " & Str(Val(itm_id)) & ", Unit_IdNo = " & Str(Val(unt_id)) & ", Quantity = " & Str(Val(txt_Quantity.Text)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_ExcessShort_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Sizing_Chemical_Item_ExcessShort_Head", "Item_ExcessShort_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_ExcessShort_Code, Company_IdNo, for_OrderBy", tr)


            Sno = 1
            cmd.CommandText = "Insert into Stock_Chemical_Processing_Details(Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, Ledger_IdNo, Party_Bill_No, SL_No, Item_IdNo , Quantity) Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @ExcShtDate, 0, '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(Exc_Sht)) & " )"
            cmd.ExecuteNonQuery()
    ...
    Private Sub txt_Quantity_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Quantity.GotFocus
        With txt_Quantity
            .BackColor = Color.Lime
            .ForeColor = Color.Blue
            .SelectionStart = 0
    ...
    Private Sub txt_Quantity_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Quantity.KeyDown
        If e.KeyCode = 40 Then
            ...
            End If
        End If
        If e.KeyCode = 38 Then cbo_ExCessShort.Focus()
    End Sub
    ...
    Private Sub txt_Quantity_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Quantity.LostFocus
        With txt_Quantity
            .BackColor = Color.White
            .ForeColor = Color.Black
        End With
