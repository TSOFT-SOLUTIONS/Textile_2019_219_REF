...
Public Class Payroll_Employee_Creation
    ...
    Private Sub clear()
        ...
        cbo_AccountsGroup.Text = Common_Procedures.AccountsGroup_IdNoToName(con, 16) ' Common_Procedures.AccountsGroup_IdNoToName(con, 14)
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                cbo_Company.Text = Common_Procedures.Company_IdNoToName(con, Val(dt.Rows(0).Item("Company_IdNo").ToString))
                If IsDBNull(dt.Rows(0).Item("Employee_Image")) = False Then
                    ...
                    End If
                End If
                cbo_AccountsGroup.Text = Common_Procedures.AccountsGroup_IdNoToName(con, Trim(dt.Rows(0).Item("AccountsGroup_IdNo").ToString))
                ...
                txt_BankAcNo.Text = Val(dt.Rows(0).Item("Bank_Ac_No").ToString)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_SchemeSalarydetails.Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("For_Salary").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Esi_Pf").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("O_T").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("D_A").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("H_R_A").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Conveyance_Esi_Pf").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("Conveyance_Salary").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(10).Value = Format(Val(dt2.Rows(i).Item("Washing").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(11).Value = Format(Val(dt2.Rows(i).Item("Entertainment").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(12).Value = Format(Val(dt2.Rows(i).Item("Maintenance").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(13).Value = Format(Val(dt2.Rows(i).Item("MessDeduction").ToString), "#########0.000")
                        dgv_SchemeSalarydetails.Rows(n).Cells(14).Value = Val(dt2.Rows(i).Item("CL").ToString)
                        dgv_SchemeSalarydetails.Rows(n).Cells(15).Value = Val(dt2.Rows(i).Item("SL").ToString)
    ...
    Private Sub Employee_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler cbo_AccountsGroup.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_AccountsGroup.LostFocus, AddressOf ControlLostFocus
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_CREATION, New_Entry, Me) = False Then Exit Sub
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                If Val(dt.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already used this Employee in Attendance", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                If Val(dt.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already used this Employee in Voucher", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                If Val(dt.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already used this Employee in Salary", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                If Val(dt.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already used this Employee in Deduction", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                If Val(dt.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already used this Employee in Payment", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Da1 = New SqlClient.SqlDataAdapter("select top 1 a.* from PayRoll_Employee_Head a   Order by  a.Employee_IdNo desc", con)
        Dt1 = New DataTable
        Da1.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            cbo_AccountsGroup.Text = Common_Procedures.AccountsGroup_IdNoToName(con, Val(Dt1.Rows(0).Item("AccountsGroup_IdNo").ToString))
        End If
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_CREATION, New_Entry, Me) = False Then Exit Sub
        ...
        If Trim(cbo_Category.Text) = "" Then
            MessageBox.Show("Invalid Category", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
            If cbo_Category.Enabled And cbo_Category.Visible Then cbo_Category.Focus()
            Exit Sub
        End If

        If Trim(msk_JoinDate.Text) = "" Then
            MessageBox.Show("Invalid Join Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        If Trim(cbo_PaymentType.Text) = "" Then
            MessageBox.Show("Invalid Payment Type", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        '        MessageBox.Show("Invalid ESI Join Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '        If msk_EsiJoinDate.Enabled And msk_EsiJoinDate.Visible Then msk_EsiJoinDate.Focus()
        '        Exit Sub
        '    End If
        '    esijndt = Trim(msk_EsiJoinDate.Text)
        'ElseIf chk_Esists.Checked = True Or chk_EsiSalary.Checked = True Then
        '    'MessageBox.Show("Invalid ESI Join Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '    'If msk_EsiJoinDate.Enabled And msk_EsiJoinDate.Visible Then msk_EsiJoinDate.Focus()
        '    'Exit Sub
        'End If
        ...
        '        MessageBox.Show("Invalid ESI Leave Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        '        MessageBox.Show("Invalid PF Join Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '        If msk_pfJoinDate.Enabled And msk_pfJoinDate.Visible Then msk_pfJoinDate.Focus()
        '        Exit Sub
        '    End If
        '    pfjndt = Trim(msk_pfJoinDate.Text)
        'ElseIf chk_Pfsts.Checked = True Or chk_PfSalary.Checked = True Then
        'MessageBox.Show("Invalid  PF Join Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        'If msk_pfJoinDate.Enabled And msk_pfJoinDate.Visible Then msk_pfJoinDate.Focus()
        'Exit Sub
        'End If
        ...
        If Not Trim(msk_pfLeaveDate.Text) = "-  -" Then
            If Not IsDate(msk_pfLeaveDate.Text) Then
                MessageBox.Show("Invalid PF leave Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        If chk_ReleaveDate.Checked = True Then
            If Trim(msk_ReleaveDate.Text) = "-  -" Then
                MessageBox.Show("Invalid Releve Date", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        If Not Trim(msk_DateOfBirth.Text) = "-  -" Then
            If Not IsDate(msk_DateOfBirth.Text) Then
                MessageBox.Show("Invalid Date of Birth", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        AcGrp_IDNo = Common_Procedures.AccountsGroup_NameToIdNo(con, cbo_AccountsGroup.Text)
        If AcGrp_IDNo = 0 Then
            MessageBox.Show("Invalid Accounts Group Name?.....", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
            cbo_AccountsGroup.Focus()
        End If
        ...
        Com_id = Common_Procedures.Company_NameToIdNo(con, cbo_Company.Text)
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(13).Value) <> 0 Then
                    ...
                    If Trim(.Rows(i).Cells(1).Value) = "" Then
                        MessageBox.Show("Invalid Salary From Date", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    ...
                    If Trim(.Rows(i).Cells(2).Value) <> "" Then
                        If IsDate(.Rows(i).Cells(2).Value) = False Then
                            MessageBox.Show("Invalid Salary To Date", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Tab_Main.SelectTab(5)
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" Then
                    ...
                    If IsDate(.Rows(i).Cells(1).Value) = True Then
                        ...
                        If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(13).Value) <> 0 Then
                            ...
                            cmd.CommandText = "Insert into PayRoll_Employee_Salary_Details (             Employee_IdNo      ,            sl_no     ,                    From_Date           , From_DateTime,                    To_date             ,                                                To_DateTime            ,                      For_Salary          ,                      Esi_Pf              ,                      O_T                  ,                      D_A                 ,                      H_R_A               ,              Conveyance_Esi_Pf           ,                      Conveyance_Salary   ,                      Washing              ,                      Entertainment        ,                      Maintenance          ,                      MessDeduction        ,                      CL                   ,                      SL                    ) " &
    ...
    Private Sub dgv_Releavedetails_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_Releavedetails.RowsAdded
        ...
        If IsNothing(dgv_Releavedetails.CurrentCell) Then Exit Sub
        With dgv_Releavedetails
            n = .RowCount
            .Rows(n - 1).Cells(0).Value = Val(n)
        End With
    ...
    Private Sub msk_JoinDate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles msk_JoinDate.KeyDown
        ...
        End If
        If e.KeyCode = 38 Then
            If cbo_AccountsGroup.Visible Then
                cbo_AccountsGroup.Focus()
            Else
                cbo_Company.Focus()
            End If
    ...
    Private Sub cbo_Company_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Company.GotFocus
        ...
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Company_Head", "Company_Name", CompCondt, "(Company_IdNo = 0)")
    ...
    Private Sub cbo_company1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Company.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Company, cbo_Area, Nothing, "Company_Head", "Company_Name", CompCondt, "(Company_IdNo = 0)")
    ...
    Private Sub cbo_company1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Company.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Company, Nothing, "Company_Head", "Company_Name", CompCondt, "(Company_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
            If cbo_AccountsGroup.Visible Then
                cbo_AccountsGroup.Focus()
            Else
    ...
    Private Sub cbo_AccountsGroup_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_AccountsGroup.GotFocus
    ...
    Private Sub cbo_AccountsGroup_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_AccountsGroup.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_AccountsGroup, cbo_Company, Nothing, "AccountsGroup_Head", "AccountsGroup_Name", "", "(AccountsGroup_IdNo = 0)")
        If e.KeyCode = 40 And cbo_AccountsGroup.DroppedDown = False Or (e.Control = True And e.KeyCode = 40) Then
            Tab_Main.SelectTab(0)
            msk_JoinDate.Focus()
        End If
    ...
    Private Sub cbo_AccountsGroup_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_AccountsGroup.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_AccountsGroup, Nothing, "AccountsGroup_Head", "AccountsGroup_Name", "", "(AccountsGroup_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
            Tab_Main.SelectTab(0)
            msk_JoinDate.Focus()
        End If
    ...
    Private Sub cbo_AccountsGroup_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_AccountsGroup.KeyUp
        If e.KeyCode = 17 And e.Control = False Then
            ...
            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_AccountsGroup.Name
            Common_Procedures.Master_Return.Master_Type = ""
            Common_Procedures.Master_Return.Return_Value = ""
