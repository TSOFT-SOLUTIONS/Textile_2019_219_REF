Public Class Weaver_KuraiPavu_Receipt
    ...
    Private Pk_Condition As String = "KPVRC-"
    ...
    Private Sub Weaver_KuraiPavu_Receipt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Weaver_KuraiPavu_Receipt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New SqlClient.SqlDataAdapter("select Vechile_No from Weaver_KuraiPavu_Receipt_Head order by Vechile_No", con)
        da.Fill(dt7)
        ...
        da.Fill(dt7)
        cbo_RecForm.DataSource = dt7
        cbo_RecForm.DisplayMember = "Ledger_DisplayName"

        da = New SqlClient.SqlDataAdapter("select Ledger_DisplayName from Ledger_AlaisHead where (Ledger_IdNo = 0 or Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'JOBWORKER') and Close_status = 0 order by Ledger_DisplayName", con)
        da.Fill(dt8)
        cbo_DeliveryTo.DataSource = dt8
        cbo_DeliveryTo.DisplayMember = "Ledger_DisplayName"
    ...
    Private Sub Weaver_KuraiPavu_Receipt_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Weaver_KuraiPavu_Receipt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as RecFromName, dh.Ledger_Name as DelivToName, c.Ledger_Name as TransportName, d.EndsCount_Name from Weaver_KuraiPavu_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.ReceivedFrom_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head dh ON a.DeliveryTo_IdNo = dh.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo Where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RecNo.Text = dt1.Rows(0).Item("Weaver_KuraiPavu_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Weaver_KuraiPavu_Receipt_Date").ToString
                ...
                cbo_DeliveryTo.Text = dt1.Rows(0).Item("DelivToName").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Pavu_Delivery_Increment, c.EndsCount_Name, d.Beam_Width_Name from Weaver_KuraiPavu_Receipt_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and (case when a.New_Receipt_BeamNo <> '' then a.New_Receipt_BeamNo else a.Beam_No end) = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON a.Beam_Width_Idno = d.Beam_Width_Idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            If Val(dt2.Rows(i).Item("Pcs").ToString) <> 0 Then
                                .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Pcs").ToString), "########0.00")
                            End If
                            ...
                            If Val(dt2.Rows(i).Item("Rcpt_Pcs").ToString) <> 0 Then
                                .Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Rcpt_Pcs").ToString), "########0.00")
                            End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Weaver_KuraiPavu_Rceipt_Entry, New_Entry, Me, con, "Weaver_KuraiPavu_Receipt_Head", "Weaver_KuraiPavu_Receipt_Code", NewCode, "Weaver_KuraiPavu_Receipt_Date", "(Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Weaver_KuraiPavu_Receipt_Details", "Weaver_KuraiPavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, " Set_No,Beam_No,EndsCount_IdNo,Pcs,Meters_Pc,Meters,Rcpt_Pcs,Rcpt_Meters,Beam_Width_Idno,Noof_Used,Set_Code,New_Receipt_BeamNo", "Sl_No", "Weaver_KuraiPavu_Receipt_Code, For_OrderBy, Company_IdNo, Weaver_KuraiPavu_Receipt_No, Weaver_KuraiPavu_Receipt_Date, Ledger_Idno", trans)

            Common_Procedures.Voucher_Deletion(con, Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), trans)

            Da = New SqlClient.SqlDataAdapter("Select * from Weaver_KuraiPavu_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    cmd.CommandText = "update Stock_SizedPavu_Processing_Details set " _
                                  ...
                                  & " Pavu_Delivery_Code = '' , close_status = 0 " _
                                  & " Where " _
            ...
            cmd.CommandText = "delete from Weaver_KuraiPavu_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Weaver_KuraiPavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_KuraiPavu_Receipt_No from Weaver_KuraiPavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Weaver_KuraiPavu_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_KuraiPavu_Receipt_No from Weaver_KuraiPavu_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Weaver_KuraiPavu_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_KuraiPavu_Receipt_No from Weaver_KuraiPavu_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_KuraiPavu_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_KuraiPavu_Receipt_No from Weaver_KuraiPavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_KuraiPavu_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_KuraiPavu_Receipt_Head", "Weaver_KuraiPavu_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RecNo.ForeColor = Color.Red


            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Weaver_KuraiPavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_KuraiPavu_Receipt_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Weaver_KuraiPavu_Receipt_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Weaver_KuraiPavu_Receipt_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Weaver_KuraiPavu_Receipt_No from Weaver_KuraiPavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        End If
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RecNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Weaver_KuraiPavu_Rceipt_Entry, New_Entry, Me, con, "Weaver_KuraiPavu_Receipt_Head", "Weaver_KuraiPavu_Receipt_Code", NewCode, "Weaver_KuraiPavu_Receipt_Date", "(Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Weaver_KuraiPavu_Receipt_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Delv_ID = Common_Procedures.Ledger_AlaisNameToIdNo(con, Trim(cbo_DeliveryTo.Text)) 'Val(Common_Procedures.CommonLedger.Godown_Ac)
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_KuraiPavu_Receipt_Head", "Weaver_KuraiPavu_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Weaver_KuraiPavu_Receipt_Head ( Weaver_KuraiPavu_Receipt_Code,             Company_IdNo         ,      Weaver_KuraiPavu_Receipt_No   ,             for_OrderBy     , Weaver_KuraiPavu_Receipt_Date,         DeliveryTo_IdNo  ,      ReceivedFrom_IdNo  ,             Empty_Beam         ,           Pavu_Meters         ,             EndsCount_IdNo       ,               Party_DcNo           ,               Vechile_No          ,          Transport_Idno   ,                 Freight           ,            Note              ,            Total_Beam       ,           Total_Pcs         ,             Total_Meters     ,               Total_Rcpt_Pcs    ,            Total_Rcpt_Meters    , User_idNo    ,Verified_Status , ClothSales_OrderCode_forSelection) " &
                                                "                Values (  '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(vForOrdByNo)) & ",          @EntryDate     , " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & ", " & Val(txt_KuraiPavuBeam.Text) & ", " & Val(txt_KuraiPavuMeters.Text) & ", " & Str(Val(KuPvu_EdsCnt_ID)) & ", '" & Trim(txt_Party_DcNo.Text) & "', '" & Trim(cbo_VehicleNo.Text) & "', " & Str(Val(Trans_ID)) & ", " & Str(Val(txt_Freight.Text)) & ", '" & Trim(txt_Note.Text) & "', " & Str(Val(vTotPvuBms)) & ", " & Str(Val(vTotPvuPcs)) & ", " & Str(Val(vTotPvuMtrs)) & ",  " & Str(Val(vTotPvuRctPcs)) & ", " & Str(Val(vTotPvuRctMtrs)) & "  , " & Val(lbl_UserName.Text) & "  , " & Val(Verified_STS) & " , '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "') "
                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Weaver_KuraiPavu_Receipt_head", "Weaver_KuraiPavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Weaver_KuraiPavu_Receipt_Code, Company_IdNo, for_OrderBy", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Weaver_KuraiPavu_Receipt_Details", "Weaver_KuraiPavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, " Set_No,Beam_No,EndsCount_IdNo,Pcs,Meters_Pc,Meters,Rcpt_Pcs,Rcpt_Meters,Beam_Width_Idno,Noof_Used,Set_Code,New_Receipt_BeamNo", "Sl_No", "Weaver_KuraiPavu_Receipt_Code, For_OrderBy, Company_IdNo, Weaver_KuraiPavu_Receipt_No, Weaver_KuraiPavu_Receipt_Date, Ledger_Idno", tr)

                cmd.CommandText = "Update Weaver_KuraiPavu_Receipt_Head set Weaver_KuraiPavu_Receipt_Date = @EntryDate, DeliveryTo_IdNo = " & Str(Val(Delv_ID)) & ", ReceivedFrom_IdNo = " & Str(Val(Rec_ID)) & ", Party_DcNo = '" & Trim(txt_Party_DcNo.Text) & "', Empty_Beam = " & Str(Val(txt_KuraiPavuBeam.Text)) & ", Pavu_Meters = " & Str(Val(txt_KuraiPavuMeters.Text)) & ",  EndsCount_IdNo = " & Str(Val(KuPvu_EdsCnt_ID)) & ", Vechile_No = '" & Trim(cbo_VehicleNo.Text) & "', Transport_Idno = " & Str(Val(Trans_ID)) & ", Freight = " & Str(Val(txt_Freight.Text)) & ", Note = '" & Trim(txt_Note.Text) & "', Total_Beam = " & Str(Val(vTotPvuBms)) & ", Total_Pcs = " & Str(Val(vTotPvuPcs)) & ", Total_Meters = " & Str(Val(vTotPvuMtrs)) & ", Total_Rcpt_Pcs = " & Str(Val(vTotPvuRctPcs)) & ", Total_Rcpt_Meters = " & Str(Val(vTotPvuRctMtrs)) & ",  User_IdNo = " & Val(lbl_UserName.Text) & ",Verified_Status= " & Val(Verified_STS) & " , ClothSales_OrderCode_forSelection = '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                ...
                If Dt1.Rows.Count > 0 Then
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        cmd.CommandText = "update Stock_SizedPavu_Processing_Details Set " _
                                  ...
                                  & " Pavu_Delivery_Code = '" & Trim(NewCode) & "'"
                        Nr = cmd.ExecuteNonQuery()
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Weaver_KuraiPavu_Receipt_head", "Weaver_KuraiPavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Weaver_KuraiPavu_Receipt_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 And Val(.Rows(i).Cells(8).Value) <> 0 Then
                        ...
                        If Val(.Rows(i).Cells(11).Value) = 0 Or (Val(.Rows(i).Cells(11).Value) > 0 And Val(.Rows(i).Cells(11).Value) = Val(.Rows(i).Cells(13).Value)) Then
                            ...
                            Nr = 0
                            cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Pavu_Delivery_Code = '" & Trim(NewCode) & "', StockAt_IdNo = " & Str(Val(Delv_ID)) & ", Pavu_Delivery_Increment = Pavu_Delivery_Increment + 1 , close_status = 1 " & _
                        ...
                        cmd.CommandText = "Insert into Weaver_KuraiPavu_Receipt_Details ( Weaver_KuraiPavu_Receipt_Code,              Company_IdNo        ,    Weaver_KuraiPavu_Receipt_No,            for_OrderBy       , Weaver_KuraiPavu_Receipt_Date,       DeliveryTo_IdNo    ,      ReceivedFrom_IdNo   ,           Sl_No      ,                    Set_No              ,                    Beam_No             ,              EndsCount_IdNo       ,                      Pcs                  ,                      Meters_Pc           ,                      Meters              ,                      Rcpt_Pcs            ,                      Rcpt_Meters         ,         Beam_Width_Idno  ,             Noof_Used         ,                    Set_Code             ,   New_Receipt_BeamNo     ) " & _
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Weaver_KuraiPavu_Receipt_Details", "Weaver_KuraiPavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, " Set_No,Beam_No,EndsCount_IdNo,Pcs,Meters_Pc,Meters,Rcpt_Pcs,Rcpt_Meters,Beam_Width_Idno,Noof_Used,Set_Code,New_Receipt_BeamNo", "Sl_No", "Weaver_KuraiPavu_Receipt_Code, For_OrderBy, Company_IdNo, Weaver_KuraiPavu_Receipt_No, Weaver_KuraiPavu_Receipt_Date, Ledger_Idno", tr)
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, txt_KuraiPavuMeters, cbo_VehicleNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_VehicleNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VehicleNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Weaver_KuraiPavu_Receipt_Head", "Vechile_No", "", "")
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_Transport, txt_Freight, "Weaver_KuraiPavu_Receipt_Head", "Vechile_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, txt_Freight, "Weaver_KuraiPavu_Receipt_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Weaver_KuraiPavu_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Weaver_KuraiPavu_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Weaver_KuraiPavu_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(cbo_Verified_Sts.Text) = "YES" Then
                Verfied_Sts = 1
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Weaver_KuraiPavu_Receipt_Code IN ( select z2.Weaver_KuraiPavu_Receipt_Code from Weaver_KuraiPavu_Receipt_Head z2 where z2.Verified_Status = " & Str(Val(Verfied_Sts)) & " )"
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.EndsCount_Name from Weaver_KuraiPavu_Receipt_Head a INNER JOIN Weaver_KuraiPavu_Receipt_Details d on a.Weaver_KuraiPavu_Receipt_Code = d.Weaver_KuraiPavu_Receipt_Code INNER JOIN Ledger_Head b on a.ReceivedFrom_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head c on d.EndsCount_IdNo = c.EndsCount_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_KuraiPavu_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Weaver_KuraiPavu_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Weaver_KuraiPavu_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Weaver_KuraiPavu_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Filter_PartyName.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, dtp_Filter_ToDate, cbo_Filter_EndsCountName, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, cbo_Filter_EndsCountName, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub TotalPavu_Calculation()
        ...
        With dgv_PavuDetails_Total
            ...
            .Rows(0).Cells(4).Value = Format(Val(TotPcs), "########0.00")
            .Rows(0).Cells(6).Value = Format(Val(TotMtrs), "########0.00")

            .Rows(0).Cells(7).Value = Format(Val(TotPcs), "########0.00")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , d.EndsCount_Name , e.Ledger_Name as Trasport_Name from Weaver_KuraiPavu_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.ReceivedFrom_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo  where a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
        ...
        vPrnt_2Copy_In_SinglePage = Common_Procedures.settings.WeaverWagesKuraiPavuReceipt_print_2Copy_In_SinglePage
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , d.EndsCount_Name , e.Ledger_Name as Trasport_Name ,f.* from Weaver_KuraiPavu_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.ReceivedFrom_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo  INNER JOIN Company_Head f ON a.Company_IdNo = f.Company_IdNo where a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.* , d.EndsCount_Name from Weaver_KuraiPavu_Receipt_Details a LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_idno = d.EndsCount_idno where Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        If Val(Common_Procedures.settings.WeaverWagesKuraiPavuReceipt_print_2Copy_In_SinglePage) = 1 Then
...
LOOP2:
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Weaver_KuraiPavu_Receipt_No").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Weaver_KuraiPavu_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + M1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.noof_used as Ent_NoofUsed, a.Rcpt_Pcs, a.Rcpt_Meters, a.New_Receipt_BeamNo, b.*, c.Pavu_Delivery_Increment as New_Receipt_Beam_Pavu_Delv_Inc, d.EndsCount_Name, e.Beam_Width_Name from Weaver_KuraiPavu_Receipt_Details a INNER JOIN Company_Head tZ ON a.company_idno <> 0 and a.company_idno = tZ.company_idno INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No LEFT OUTER JOIN Stock_SizedPavu_Processing_Details c ON c.Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and a.Set_Code = c.Set_Code and a.New_Receipt_BeamNo = c.Beam_No INNER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head e ON b.Beam_Width_Idno = e.Beam_Width_Idno Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "' order by a.for_orderby, a.Set_Code, b.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            'Da = New SqlClient.SqlDataAdapter("select a.noof_used as Ent_NoofUsed, a.Rcpt_Pcs, a.Rcpt_Meters, b.*, c.EndsCount_Name, d.Beam_Width_Name from Weaver_KuraiPavu_Receipt_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON b.Beam_Width_Idno = d.Beam_Width_Idno where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.Weaver_KuraiPavu_Receipt_Code = '" & Trim(NewCode) & "' order by a.for_orderby, a.Set_Code, b.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            ...
            Da = New SqlClient.SqlDataAdapter("select a.*, b.EndsCount_Name, c.Beam_Width_Name from Stock_SizedPavu_Processing_Details a INNER JOIN Company_Head tZ ON a.company_idno <> 0 and a.company_idno = tZ.company_idno INNER JOIN EndsCount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head c ON a.Beam_Width_Idno = c.Beam_Width_Idno Where a.Pavu_Delivery_Code = '' and a.Beam_Knotting_Code = '' and a.close_status = 0 and a.StockAt_IdNo = " & Str(Val(Led_IdNo)) & " order by a.for_orderby, a.Set_Code, a.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
    ...
    Private Sub cbo_DeliveryTo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_DeliveryTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DeliveryTo, cbo_RecForm, cbo_EndsCount, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( (  Ledger_Type = 'GODOWN' or Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_DeliveryTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DeliveryTo, cbo_EndsCount, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( (  Ledger_Type = 'GODOWN' or Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_DeliveryTo_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.Control = False And e.KeyValue = 17 Then
    ...
    Private Sub cbo_RecForm_GotFocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_RecForm.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_RecForm_KeyDown1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecForm.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecForm, txt_Party_DcNo, cbo_EndsCount, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_RecForm_KeyPress1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RecForm.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RecForm, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = 'WEAVER' or Ledger_type = 'SIZING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) ) and Close_status = 0) or Show_In_All_Entry = 1 ) ", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_RecForm_KeyUp1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecForm.KeyUp
        If e.Control = False And e.KeyValue = 17 Then
            Common_Procedures.UR.Ledr_Wea_Siz_Rw_Trans_JbWrk_Creation = Common_Procedures.UR.Ledger_Creation
    ...
    Private Sub btn_SMS_Click(sender As System.Object, e As System.EventArgs) Handles btn_SMS.Click
        ...
        Try
            ...
            If dgv_PavuDetails_Total.RowCount > 0 Then
                ...
                smstxt = smstxt & " METERS  : " & Val(dgv_PavuDetails_Total.Rows(0).Cells(6).Value()) & vbCrLf
            End If
            ...
            If dgv_PavuDetails.RowCount > 0 Then
                ...
                smstxt = smstxt & " ENDS COUNT  : " & Val(dgv_PavuDetails.Rows(0).Cells(3).Value()) & vbCrLf
