Public Class Sizing_KurAi_Pavu_Receipt
    ...
    Private Pk_Condition As String = "KPARC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as SizingName, c.Ledger_Name as DeliveryTo_Name, d.Count_Name from Kurai_Pavu_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  INNER JOIN Ledger_Head c ON a.DeliveryTo_IdNo = c.Ledger_IdNo INNER JOIN Count_Head d ON a.Count_IdNo = d.Count_IdNo Where a.Pavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Pavu_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Pavu_Receipt_Date").ToString
                ...
                txt_EndsName.Text = dt1.Rows(0).Item("Ends_Name").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Pavu_Delivery_Code, b.Pavu_Delivery_Increment  from Kurai_Pavu_Receipt_Details a, Stock_SizedPavu_Processing_Details b where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Receipt_Code = '" & Trim(NewCode) & "' and b.Reference_Code = '" & Trim(Pk_Condition) & "' + a.Pavu_Receipt_Code and a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For I = 0 To dt2.Rows.Count - 1
                        ...
                        If Trim(dt2.Rows(I).Item("Pavu_Delivery_Code").ToString) <> "" Or Val(dt2.Rows(I).Item("Pavu_Delivery_Increment").ToString) <> 0 Then
    ...
    Private Sub Pavu_Purchase_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_Count.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "ENDSCOUNT" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
    ...
    Private Sub Pavu_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_EndsName.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_EndsName.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_EndsName.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_EndsName.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_KURAI_PAVU_RECEIPT, New_Entry, Me, con, "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", NewCode, "Pavu_Receipt_Date", "(Pavu_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Pavu_Receipt_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Kurai_Pavu_Receipt_Details", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Receipt_Code, For_OrderBy, Company_IdNo, Pavu_Receipt_No, Pavu_Receipt_Date", trans)
            ...
            cmd.CommandText = "Delete from Kurai_Pavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Receipt_No from Kurai_Pavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Pavu_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Receipt_No from Kurai_Pavu_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Pavu_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Receipt_No from Kurai_Pavu_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Receipt_No from Kurai_Pavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Kurai_Pavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Receipt_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Pavu_Receipt_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("Pavu_Receipt_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Pavu_Receipt_No from Kurai_Pavu_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_KURAI_PAVU_RECEIPT, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_KURAI_PAVU_RECEIPT, New_Entry, Me, con, "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", NewCode, "Pavu_Receipt_Date", "(Pavu_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Pavu_Receipt_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Kurai_Pavu_Receipt_Head ( Pavu_Receipt_Code, Company_IdNo, Pavu_Receipt_No, for_OrderBy, Pavu_Receipt_Date, Ledger_IdNo, DeliveryTo_IdNo, Party_DcNo, Set_No,PurchaseAc_IdNo , Ends_Name,Count_IdNo, Pcs_Length, Total_Beam,Total_Pcs ,Total_Meters,Rate_Meters,Gross_Amount,Add_Less,Net_Amount,User_idno  ) Values ( '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(Led_ID)) & ", " & Str(Val(DelvTo_ID)) & ", '" & Trim(txt_PartyBillNo.Text) & "', '" & Trim(txt_SetNo.Text) & "'," & Str(Val(PurcAc_ID)) & ",'" & Trim(txt_EndsName.Text) & "', " & Val(Cnt_ID) & ", " & Val(txt_PcsLength.Text) & ", " & Str(Val(vTotPvuBms)) & "," & Str(Val(vTotPvuPcs)) & ", " & Str(Val(vTotPvuMtrs)) & "," & Val(txt_RateMeters.Text) & "," & Val(lbl_GrossAmount.Text) & "," & Val(txt_AddLess.Text) & "," & Val(lbl_NetAmount.Text) & " ," & Val(lbl_UserName.Text) & ")"
                cmd.ExecuteNonQuery()

            Else

                'Da = New SqlClient.SqlDataAdapter("select count(*) from Kurai_Pavu_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code = '" & Trim(NewCode) & "' and Sizing_Specification_Code <> ''", con)
                ...
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Pavu_Receipt_Code, Company_IdNo, for_OrderBy", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Kurai_Pavu_Receipt_Details", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Receipt_Code, For_OrderBy, Company_IdNo, Pavu_Receipt_No, Pavu_Receipt_Date", tr)




                cmd.CommandText = "Update Kurai_Pavu_Receipt_Head set Pavu_Receipt_Date = @EntryDate, Ledger_IdNo = " & Str(Val(Led_ID)) & ", DeliveryTo_IdNo = " & Str(Val(DelvTo_ID)) & ", Party_DcNo = '" & Trim(txt_PartyBillNo.Text) & "',PurchaseAc_IdNo = " & Str(Val(PurcAc_ID)) & ",  Set_No = '" & Trim(txt_SetNo.Text) & "',Ends_Name = '" & Trim(txt_EndsName.Text) & "', Count_IdNo = " & Str(Val(Cnt_ID)) & ", Pcs_Length = '" & Trim(txt_PcsLength.Text) & "', Total_Beam = " & Str(Val(vTotPvuBms)) & " ,Total_pcs = " & Str(Val(vTotPvuPcs)) & " , Total_Meters =  " & Str(Val(vTotPvuMtrs)) & " ,Rate_Meters = " & Val(txt_RateMeters.Text) & ", Gross_Amount = " & Val(lbl_GrossAmount.Text) & ", Add_Less = " & Val(txt_AddLess.Text) & ", Net_Amount = " & Val(lbl_NetAmount.Text) & " , User_idno = " & Val(lbl_UserName.Text) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Stock_SizedPavu_Processing_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and Pavu_Delivery_Code = '' and Pavu_Delivery_Increment = 0 "
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Kurai_Pavu_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()


            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Kurai_Pavu_Receipt_Head", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Pavu_Receipt_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(dgv_PavuDetails.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Kurai_Pavu_Receipt_Details (  Pavu_Receipt_Code ,              Company_IdNo        ,     Pavu_Receipt_No    ,                               for_OrderBy                              , Pavu_Receipt_Date ,                                  Ledger_IdNo     ,               Set_No          ,         Set_Code      ,             Sl_No    ,                    Beam_No             ,                      Pcs                 ,          Meters_Pc       ,                       Meters               ) " &
                        ...
                        Dim vStk_IDNo As Integer = 0

                        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1220" Then '---- Sri Meenakshi Sizing (Somanur)
                            vStk_IDNo = Val(Common_Procedures.CommonLedger.Godown_Ac)
                        Else
                            vStk_IDNo = 0
                        End If

                        Nr = 0
                        cmd.CommandText = "Update Stock_SizedPavu_Processing_Details set Reference_Date = @EntryDate, Sl_No = " & Str(Val(Sno)) & ", Ledger_IdNo = " & Str(Val(vStk_IDNo)) & " " &
                        ...
                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Stock_SizedPavu_Processing_Details (                          Reference_Code       ,              Company_IdNo        ,               Reference_No    ,                               for_OrderBy                               , Reference_Date ,         Ledger_IdNo        ,           Set_Code    ,           Set_No              ,    setcode_forSelection     ,               Ends_Name          ,     count_idno          ,  Mill_IdNo, Beam_Width_Idno, Sizing_SlNo,         Sl_No        ,                    Beam_No             ,                               ForOrderBy_BeamNo                                 , Gross_Weight, Tare_Weight, Net_Weight,                      Noof_Pcs            ,          Meters_Pc      ,                      Meters               ,  EndsCount_Idno ) " &
                                                        "    Values                           (  '" & Trim(Pk_Condition) & Trim(NewCode) & "' , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & " ,   @EntryDate   , " & Str(Val(vStk_IDNo)) & ", '" & Trim(vSetCd) & "', '" & Trim(txt_SetNo.Text) & "', '" & Trim(Selc_SetCode) & "', '" & Trim(txt_EndsName.Text) & "', " & Str(Val(Cnt_ID)) & ",     0     ,      0         ,      0     , " & Str(Val(Sno)) & ", '" & Trim(.Rows(i).Cells(1).Value) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(.Rows(i).Cells(1).Value))) & ",      0      ,       0    ,      0    , " & Str(Val(.Rows(i).Cells(2).Value)) & ", " & Str(Val(Mtr_Pc)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & " ,  0        ) "
                            cmd.ExecuteNonQuery()
                        End If
            ...
            End With
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Kurai_Pavu_Receipt_Details", "Pavu_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Beam_No,Pcs,Meters_Pc,Meters", "Sl_No", "Pavu_Receipt_Code, For_OrderBy, Company_IdNo, Pavu_Receipt_No, Pavu_Receipt_Date", tr)
            ...
            If Val(vTotPvuMtrs) <> 0 Then
                ...
                'YrnPartcls = Partcls & ",  Beams : " & Val(vTotPvuBms) & ", Meters : " & Val(vTotPvuMtrs)

                'cmd.CommandText = "Insert into Stock_Yarn_Processing_Details ( Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno,  Particulars, Party_Bill_No, Sl_No, Count_IdNo, Yarn_Type, Mill_IdNo, Bags, Cones, Weight ) Values ( '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(Del_ID)) & ", " & Str(Val(Rec_ID)) & ", '" & Trim(YrnPartcls) & "', '" & Trim(PBlNo) & "', 1, " & Val(Cnt_ID) & ", 'MILL', 0, 0, 0, 0 )"
                'cmd.ExecuteNonQuery()

            End If

            'If Val(vTotPvuBms) <> 0 Then
            '    cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details ( Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno,  Party_Bill_No, Sl_No, Beam_Width_IdNo, Empty_Beam, Particulars ) Values ( '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(Del_ID)) & ", " & Str(Val(Rec_ID)) & ",  '" & Trim(PBlNo) & "', 2, 0, " & Str(Val(vTotPvuBms)) & ", '" & Trim(Partcls) & "')"
            '    cmd.ExecuteNonQuery()
            'End If
            ...
            If Val(CSng(lbl_NetAmount.Text)) <> 0 Then
                ...
                If Common_Procedures.Voucher_Updation(con, "Pavu.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_Date.Text), "Bill No : " & Trim(txt_PartyBillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Sizing_Software) = False Then
            ...
            '    If Common_Procedures.Voucher_Updation(con, "Ag.Comm", Val(lbl_Company.Tag), Trim(Pk_Condition2) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(msk_Date.Text), "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr,Common_Procedures.SoftwareTypes.Sizing_Software) = False Then
            '        Throw New ApplicationException(ErrMsg)
            '    End If
            'End If

            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(txt_PartyBillNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "CR", Trim(Pk_Condition) & Trim(NewCode), tr, Common_Procedures.SoftwareTypes.Sizing_Software)
    ...
    Private Sub cbo_Sizing_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Sizing.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Sizing, msk_Date, txt_PartyBillNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 and Close_Status = 0 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Sizing_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Sizing.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Sizing, txt_PartyBillNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 and Close_Status = 0 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Count_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Count.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Count, txt_EndsName, txt_PcsLength, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Count_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Count.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Count, txt_PcsLength, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Pavu_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Pavu_Receipt_Code IN (select z1.Pavu_Receipt_Code from Sizing_SpecificationYarn_Details z1 where z1.Count_IdNo = " & Str(Val(Cnt_IdNo)) & ")"
            End If

            If Val(Mil_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Pavu_Receipt_Code IN (select z1.Pavu_Receipt_Code from Sizing_SpecificationYarn_Details z1 where z1.Mill_IdNo = " & Str(Val(Mil_IdNo)) & ")"
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as SizingName , c.*  from Kurai_Pavu_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head c ON c.EndsCount_IdNo = a.EndsCount_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Pavu_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Pavu_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = dt2.Rows(i).Item("Set_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(3).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Pavu_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_KURAI_PAVU_RECEIPT, New_Entry) = False Then Exit Sub

        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from Kurai_Pavu_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Pavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            Try
                ...
                If Val(Common_Procedures.settings.Printing_Show_PrintDialogue) = 1 Then
                    ...
                    If PrintDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
                        ...
                        If Val(Common_Procedures.settings.KuraiPavu_Receipt_Print_2Copy_In_SinglePage) = 1 Then
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, f.*, d.Count_Name  from Kurai_Pavu_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Company_Head f ON a.Company_IdNo = f.Company_IdNo INNER JOIN Count_Head d ON a.Count_IdNo = d.Count_IdNo Where a.Pavu_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.* from Kurai_Pavu_Receipt_Details a where Pavu_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    For i = 0 To prn_DetDt.Rows.Count - 1
                        If Val(prn_DetDt.Rows(i).Item("Meters").ToString) <> 0 Then
                            ...
                            prn_DetAr(prn_DetMxIndx, 5) = Trim(Microsoft.VisualBasic.Left(prn_HdDt.Rows(0).Item("Ends_Name").ToString & "/" & prn_HdDt.Rows(0).Item("Count_Name").ToString, 15))
                        End If
                    Next i
                End If
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Common_Procedures.settings.KuraiPavu_Receipt_Print_2Copy_In_SinglePage = 1 Then
            Printing_Format2(e)
        Else
            Printing_Format1(e)
        End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Pavu_Receipt_No").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Pavu_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + M1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, cbo_DeliveryTo, txt_EndsName, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_PurchaseAc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PurchaseAc.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PurchaseAc, txt_EndsName, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub txt_RateMeters_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_RateMeters.TextChanged
        TotalPavu_Calculation()
        lbl_NetAmount.Text = Format(Val(lbl_GrossAmount.Text), "##########0.00")
    End Sub
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update Kurai_Pavu_Receipt_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Update  Kurai_Pavu_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
        ...
        For PCnt = 1 To PrntCnt
            ...
            Try
                ...
                If prn_HdDt.Rows.Count > 0 Then
                            ...
                            If NoofDets >= NoofItems_PerPage Then
                                If Val(Common_Procedures.settings.KuraiPavu_Receipt_Print_2Copy_In_SinglePage) = 1 Then
                                    If PCnt = 2 And PrntCnt = 2 And PrntCnt2ndPageSTS = False Then
                                        ...
                                        Printing_Format2_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, PCnt, False)
                    ...
                    Printing_Format2_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, PCnt, True)
...
LOOP10:
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TpMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim dt3 As New DataTable
        Dim dt4 As New DataTable
