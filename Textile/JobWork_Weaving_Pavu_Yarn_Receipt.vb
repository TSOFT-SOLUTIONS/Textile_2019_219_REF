Public Class JobWork_Weaving_Pavu_Yarn_Receipt
    ...
    Private Pk_Condition As String = "JWPYR-"
    ...
    Private Sub clear()
        ...
        cbo_Transport.Text = ""
        cbo_VehicleNo.Text = ""
        cbo_JobWorkerName.Text = Common_Procedures.Ledger_IdNoToName(con, 4)
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as DelvName, c.Ledger_Name as TransportName, d.EndsCount_Name,e.Ledger_Name as RecFromName from JobWork_Weaving_PavuYarn_Receipt_Head a INNER JOIN Ledger_Head b ON a.DeliveryTo_Idno = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.ReceivedFrom_Idno = e.Ledger_IdNO Where a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RecNo.Text = dt1.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_Date").ToString
                msk_date.Text = dtp_Date.Text

                cbo_JobWorkerName.Text = dt1.Rows(0).Item("DelvName").ToString
                ...
                cbo_RecFrom.Text = dt1.Rows(0).Item("RecFromName").ToString
                txt_Freight.Text = Val(dt1.Rows(0).Item("Freight_Charge").ToString)
                txt_Note.Text = dt1.Rows(0).Item("Note").ToString

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Pavu_Delivery_Increment, c.EndsCount_Name, d.Beam_Width_Name from JobWork_Weaving_Pavu_Receipt_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON a.Beam_Width_Idno = d.Beam_Width_Idno where a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                'da2 = New SqlClient.SqlDataAdapter("Select a.*, b.EndsCount_Name, c.Beam_Width_Name from JobWork_Weaving_Pavu_Receipt_Details a INNER JOIN EndsCount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head c ON a.Beam_Width_Idno = c.Beam_Width_Idno where a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Mill_Name from JobWork_Weaving_Yarn_Receipt_Details a INNER JOIN Count_Head b on a.Count_IdNo = b.Count_IdNo INNER JOIN Mill_Head c on a.Mill_IdNo = c.Mill_IdNo where a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Private Sub Pavu_Yarn_Receipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        da.Fill(dt1)
        cbo_JobWorkerName.DataSource = dt1
        cbo_JobWorkerName.DisplayMember = "Ledger_DisplayName"

        da = New SqlClient.SqlDataAdapter("select Distinct(Vehicle_No) from JobWork_Weaving_PavuYarn_Receipt_Head order by Vehicle_No", con)
        da.Fill(dt7)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.JobWork_Weaving_PavuYarn_Receipt_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.JobWork_Weaving_PavuYarn_Receipt_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("Select * from JobWork_Weaving_Pavu_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'", con)
            ...
            cmd.CommandText = "delete from JobWork_Weaving_Pavu_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from JobWork_Weaving_Yarn_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from JobWork_Weaving_PavuYarn_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 JobWork_Weaving_PavuYarn_Receipt_No from JobWork_Weaving_PavuYarn_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, JobWork_Weaving_PavuYarn_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 JobWork_Weaving_PavuYarn_Receipt_No from JobWork_Weaving_PavuYarn_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, JobWork_Weaving_PavuYarn_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 JobWork_Weaving_PavuYarn_Receipt_No from JobWork_Weaving_PavuYarn_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, JobWork_Weaving_PavuYarn_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "JobWork_Weaving_PavuYarn_Receipt_Head", "JobWork_Weaving_PavuYarn_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RecNo.ForeColor = Color.Red

            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from JobWork_Weaving_PavuYarn_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, JobWork_Weaving_PavuYarn_Receipt_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select JobWork_Weaving_PavuYarn_Receipt_No from JobWork_Weaving_PavuYarn_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.JobWork_Weaving_PavuYarn_Receipt_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.JobWork_Weaving_PavuYarn_Receipt_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim Prtcls_RecIdNo As Integer = 0
        Dim Prtcls_DelvIdNo As Integer = 0
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.JobWork_Weaving_PavuYarn_Receipt_Entry, New_Entry) = False Then Exit Sub
        ...
        If Rec_ID = 0 Then
            MessageBox.Show("Invalid Received Name", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
            If cbo_RecFrom.Enabled And cbo_RecFrom.Visible Then cbo_RecFrom.Focus()
            Exit Sub
        End If

        Del_ID = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_JobWorkerName.Text)
        If Del_ID = 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "JobWork_Weaving_PavuYarn_Receipt_Head", "JobWork_Weaving_PavuYarn_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If Val(txt_KuraiPavuMeters.Text) <> 0 And Val(KuPvu_EdsCnt_ID) <> 0 Then
                ...
                Stk_DelvIdNo = 0
                Stk_RecIdNo = Del_ID
                cmd.CommandText = "Insert into Stock_Pavu_Processing_Details(Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno, Cloth_Idno, Entry_ID, Party_Bill_No, Particulars, Sl_No, EndsCount_IdNo, Sized_Beam, Meters, DeliveryToIdno_ForParticulars, ReceivedFromIdno_ForParticulars ) Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @EntryDate, " & Str(Val(Stk_DelvIdNo)) & ", " & Str(Val(Stk_RecIdNo)) & ", " & Str(Val(Clo_ID)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "', -102, " & Str(Val(KuPvu_EdsCnt_ID)) & ", " & Str(Val(txt_KuraiPavuBeam.Text)) & ", " & Str(Val(txt_KuraiPavuMeters.Text)) & ", " & Str(Val(Prtcls_DelvIdNo)) & ", " & Str(Val(Prtcls_RecIdNo)) & "  )"
                cmd.ExecuteNonQuery()
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(dgv_PavuDetails.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into JobWork_Weaving_Pavu_Receipt_Details(JobWork_Weaving_PavuYarn_Receipt_Code,              Company_IdNo        ,     JobWork_Weaving_PavuYarn_Receipt_No     ,                               for_OrderBy                             , JobWork_Weaving_PavuYarn_Receipt_Date,       DeliveryTo_IdNo    ,      ReceivedFrom_IdNo  ,          Sl_No       ,               Set_No                   ,                 Beam_No                ,                    Pcs                    ,                    Meters                ,             EndsCount_IdNo       ,           Beam_Width_IdNo,              Noof_Used        ,                  Set_Code              ) " & _
            ...
            With dgv_YarnDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into JobWork_Weaving_Yarn_Receipt_Details(JobWork_Weaving_PavuYarn_Receipt_Code, Company_IdNo, JobWork_Weaving_PavuYarn_Receipt_No, for_OrderBy, JobWork_Weaving_PavuYarn_Receipt_Date, Sl_No, count_idno, Yarn_Type, Mill_IdNo,  Bags, Cones, Weight ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @EntryDate,  " & Str(Val(Sno)) & ", " & Str(Val(YCnt_ID)) & ", '" & Trim(.Rows(i).Cells(2).Value) & "', " & Str(Val(YMil_ID)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            If Val(txt_KuraiPavuBeam.Text) <> 0 Or Val(vTotPvuBms) <> 0 Or Val(vTotYrnBags) <> 0 Or Val(vTotYrnCones) <> 0 Then
                ...
                Sno = Sno + 1
                cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details ( Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno, Party_Bill_No, Sl_No, Beam_Width_IdNo, Empty_Beam, Pavu_Beam, Yarn_Bags, Yarn_Cones, Particulars, Entry_ID ) Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @EntryDate, " & Str(Val(Stk_DelvIdNo)) & ", " & Str(Val(Stk_RecIdNo)) & ", '" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", 0, 0, " & Str(Val(txt_KuraiPavuBeam.Text) + Val(vTotPvuBms)) & ", " & Str(Val(vTotYrnBags)) & ", " & Str(Val(vTotYrnCones)) & ", '" & Trim(Partcls) & "', '" & Trim(EntID) & "')"
                cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_JobWorkerName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_JobWorkerName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_JobWorkerName, cbo_RecFrom, txt_PartyDcNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or Ledger_Type = 'JOBWORKER')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_VehicleNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VehicleNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "JobWork_Weaving_PavuYarn_Receipt_Head", "Vehicle_No", "", "(Vehicle_No = '')")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_Transport, txt_Freight, "JobWork_Weaving_PavuYarn_Receipt_Head", "Vehicle_No", "", "(Vehicle_No = '')")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, txt_Freight, "JobWork_Weaving_PavuYarn_Receipt_Head", "Vehicle_No", "", "(Vehicle_No = '')", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.JobWork_Weaving_PavuYarn_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.JobWork_Weaving_PavuYarn_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.JobWork_Weaving_PavuYarn_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.JobWork_Weaving_PavuYarn_Receipt_Code IN (select z1.JobWork_Weaving_PavuYarn_Receipt_Code from JobWork_Weaving_Yarn_Receipt_Details z1 where z1.Count_IdNo = " & Str(Val(Cnt_IdNo)) & ")"
            End If

            If Val(Mil_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.JobWork_Weaving_PavuYarn_Receipt_Code IN (select z1.JobWork_Weaving_PavuYarn_Receipt_Code from JobWork_Weaving_Yarn_Receipt_Details z1 where z1.Mill_IdNo = " & Str(Val(Mil_IdNo)) & ")"
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as Deliv_Name from JobWork_Weaving_PavuYarn_Receipt_Head a INNER JOIN Ledger_Head b on a.ReceivedFrom_Idno = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.JobWork_Weaving_PavuYarn_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("JobWork_Weaving_PavuYarn_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("JobWork_Weaving_PavuYarn_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_DeliveryName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Filter_DeliveryName.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_DeliveryName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_DeliveryName, dtp_Filter_ToDate, cbo_Filter_CountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_DeliveryName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_DeliveryName, cbo_Filter_CountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_IdNo = 0)")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from JobWork_Weaving_PavuYarn_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Recfrom_Name, c.Ledger_Address1, c.Ledger_Address2 ,c.Ledger_Address3,c.Ledger_Address4 from JobWork_Weaving_PavuYarn_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.ReceivedFrom_Idno <> 0 and a.ReceivedFrom_Idno = c.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Mill_Name, c.Count_Name from JobWork_Weaving_Yarn_Receipt_Details a INNER JOIN Mill_Head b on a.Mill_IdNo = b.Mill_IdNo INNER JOIN Count_Head c on a.Count_IdNo = c.Count_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                ...
                da1 = New SqlClient.SqlDataAdapter("select a.*,b.* from JobWork_Weaving_Pavu_Receipt_Details a INNER JOIN EndsCount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                Dt1 = New DataTable
                da1.Fill(Dt1)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Mill_Name, c.Count_Name  from JobWork_Weaving_Yarn_Receipt_Details a INNER JOIN Mill_Head b on a.Mill_IdNo = b.Mill_IdNo LEFT OUTER JOIN Count_Head c on a.Count_IdNo = c.Count_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("JobWork_Weaving_PavuYarn_Receipt_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_RecForm_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_RecFrom.GotFocus
    ...
    Private Sub cbo_RecForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecFrom.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecFrom, msk_date, cbo_JobWorkerName, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER')", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_RecForm_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RecFrom.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RecFrom, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER')", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_RecForm_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecFrom.KeyUp
        If e.Control = False And e.KeyValue = 17 Then
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        LedNo = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_RecFrom.Text)
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.noof_used as Ent_NoofUsed, b.*, c.EndsCount_Name, d.Beam_Width_Name from JobWork_Weaving_Pavu_Receipt_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON b.Beam_Width_Idno = d.Beam_Width_Idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.JobWork_Weaving_PavuYarn_Receipt_Code = '" & Trim(NewCode) & "' and a.ReceivedFrom_IdNo = " & Str(Val(LedNo)) & " order by a.for_orderby, a.Set_Code, b.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
