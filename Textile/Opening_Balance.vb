Public Class Opening_Balance
    ...
    Private Pk_Condition As String = "OPNAM-"
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Ledger_Opening_Balance, "~L~") = 0 And InStr(Common_Procedures.UR.Ledger_Opening_Balance, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(Val(lbl_IdNo.Text)) & "/"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Ledger_Opening_Balance, New_Entry) = False Then Exit Sub
    ...
    Private Sub cbo_Ledger_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Ledger.GotFocus
        With cbo_Ledger
            ...
            .SelectionStart = 0
            .SelectionLength = .Text.Length
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo IN (select aa1.ledger_idno from ledger_head aa1 where aa1.Bill_Type <> 'BILL TO BILL') )", "(Ledger_IdNo = 0)")
        End With
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Try
            ...
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, Nothing, txt_OpAmount, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo IN (select aa1.ledger_idno from ledger_head aa1 where aa1.Bill_Type <> 'BILL TO BILL') )", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        ...
        Try
            ...
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_OpAmount, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo IN (select aa1.ledger_idno from ledger_head aa1 where aa1.Bill_Type <> 'BILL TO BILL') )", "(Ledger_IdNo = 0)")
