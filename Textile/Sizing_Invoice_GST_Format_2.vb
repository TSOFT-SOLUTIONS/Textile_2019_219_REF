Public Class Sizing_Invoice_GST_Format_2
    ...
    Private Pk_Condition2 As String = "SITDS-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Sizing_invoice_head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.InVoice_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_addless2.Text = Format(Val(dt1.Rows(0).Item("Add_Less2").ToString), "##########0.00")
                ...
                lbl_bill_amount.Text = Format(Val(dt1.Rows(0).Item("bill_Amount").ToString), "##########0.00")
                lbl_Tds_Amount.Text = Format(Val(dt1.Rows(0).Item("Tds_Amount").ToString), "##########0.00")

                da2 = New SqlClient.SqlDataAdapter("select a.*, ch.count_Name, Mh.Mill_Name from Sizing_invoice_details a Left outer join Count_Head ch on a.Count_IdNo = ch.count_IdNo Left outer join MIll_Head mh ON a.Mill_IdNo = mh.Mill_IdNo where a.Invoice_Code = '" & Trim(NewCode) & "'", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Ref_Date").ToString), "dd-MM-yyyy")
                            .Rows(n).Cells(1).Value = dt2.Rows(i).Item("Set_IdNo").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "Select Invoice_RefNo from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "Select top 1 Invoice_RefNo from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Invoice_RefNo"
            dr = cmd.ExecuteReader
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Invoice_RefNo from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Invoice_RefNo desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Invoice_RefNo from Sizing_invoice_head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Invoice_RefNo"
            dr = cmd.ExecuteReader
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Invoice_RefNo from Sizing_invoice_head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_company.Tag)) & " and  Invoice_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,Invoice_RefNo desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            dt = New DataTable
            da.Fill(dt)
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from Sizing_invoice_head where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Invoice_RefNo desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        da = New SqlClient.SqlDataAdapter("select top 1 * from Sizing_invoice_head where for_orderby < " & Str(Val(vOrdByRefNo)) & " and company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Invoice_RefNo desc", con)
        dt1 = New DataTable
        da.Fill(dt1)
        If dt1.Rows.Count > 0 Then
        ...
        vPrevRefDte = #1/1/2000#
        vOrdByRefNo = Common_Procedures.OrderBy_CodeToValue(Trim(lbl_Invoice_No.Text))
        da = New SqlClient.SqlDataAdapter("select top 1 * from Sizing_invoice_head where for_orderby > " & Str(Val(vOrdByRefNo)) & " and company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Invoice_RefNo", con)
        dt1 = New DataTable
        da.Fill(dt1)
        If dt1.Rows.Count > 0 Then
            vPrevRefNo = dt1.Rows(0).Item("Invoice_RefNo").ToString
        ...
        Try
            ...
            Else
                lbl_Invoice_No.Text = Common_Procedures.get_MaxCode(con, "Sizing_invoice_head", "Invoice_Code", "For_OrderBy", "(Invoice_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_company.Tag), Common_Procedures.FnYearCode, tr)
                NewCode = Trim(Pk_Condition) & Trim(Val(lbl_company.Tag)) & "-" & Trim(lbl_Invoice_No.Text) & "/" & Trim(Common_Procedures.FnYearCode)
                vInvoNo = Trim(txt_Invoice_Prefix_No.Text) & Trim(lbl_Invoice_No.Text) & Trim(cbo_Invoice_Suffix_No.Text)
            End If
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Sizing_invoice_head ( User_IdNo            ,    Invoice_Code       ,               Company_IdNo        ,                Invoice_SuffixNo            ,           Invoice_RefNo             ,         Invoice_No      ,                               for_OrderBy                                    ,                     Invoice_PrefixNo              , Invoice_Date ,      Ledger_IdNo   ,        SetCode_ForSelection   ,          Set_Code     ,          Set_No       ,     OnAccount_IdNo  ,               Tax_Type           ,              AddLess_Caption            ,            Add_Less          ,            Freight           ,            Assessable_Value           ,           CGST_Percentage      ,             CGST_Amount          ,            SGST_Percentage     ,             SGST_Amount          ,            IGST_Percentage     ,            IGST_Amount           ,             Net_Amount        , add_Less_Caption                         ,        Total_OtherCharges      , Sizing_Charges_Account       ,               Total_RewindingCharges      ,     RoundOff_Amount         ,bill_amount                    ,   Tds_perc                    ,Tds_amount             ,      Add_less2               ,               Bill_No           ) " & _
                                  "Values                   (" & Str(UserIdNo) & " ,'" & Trim(NewCode) & "', " & Str(Val(lbl_company.Tag)) & " , '" & Trim(cbo_Invoice_Suffix_No.Text) & "' , '" & Trim(lbl_Invoice_No.Text) & "' , '" & Trim(vInvoNo) & "' , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Invoice_No.Text))) & " , '" & Trim(UCase(txt_Invoice_Prefix_No.Text)) & "' , @InvoiceDate , " & Val(led_id) & ", '" & Trim(Cbo_SetNo.Text) & "', '" & Trim(vSetCd) & "', '" & Trim(vSetNo) & "', " & Val(OnAc_id) & ", '" & Trim(Cbo_Tax_Type.Text) & "' ,'" & Trim(txt_AddLess_Caption.Text) & "' ," & Val(txt_AddLess.Text) & " ," & Val(txt_Freight.Text) & " ," & Val(lbl_Assessable_Value.Text) & " ," & Val(txt_CGST_Perc.Text) & " ," & Val(lbl_CGST_Amount.Text) & " ," & Val(txt_SGST_Perc.Text) & " ," & Val(lbl_SGST_Amount.Text) & " ," & Val(txt_IGST_Perc.Text) & " ," & Val(lbl_IGST_Amount.Text) & " ," & Val(lbl_Net_Amount.Text) & ", '" & Trim(txt_AddLess_Caption.Text) & "', " & Val(Total_OtherCharges) & ", " & Val(Siz_Charges_Acc) & " ,  " & Str(Val(Total_RewindingCharges)) & " ," & Val(lbl_RoundOff_Amt.Text) & " ," & Val(lbl_bill_amount.Text) & ", " & Val(txt_Tds.Text) & "   ," & Val(lbl_Tds_Amount.Text) & ", " & Val(txt_addless2.Text) & ", '" & Trim(txt_BillNo.Text) & "' ) "
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Sizing_invoice_head set Invoice_Date = @InvoiceDate , User_IdNo = " & Str(UserIdNo) & " , Ledger_IdNo = " & Val(led_id) & " , Invoice_SuffixNo  = '" & Trim(cbo_Invoice_Suffix_No.Text) & "', Invoice_No = '" & Trim(vInvoNo) & "', Invoice_RefNo =  '" & Trim(lbl_Invoice_No.Text) & "' , Invoice_PrefixNo = '" & Trim(UCase(txt_Invoice_Prefix_No.Text)) & "' ,SetCode_ForSelection = '" & Trim(Cbo_SetNo.Text) & "', Set_Code ='" & Trim(vSetCd) & "', Set_No = '" & Trim(vSetNo) & "', OnAccount_IdNo = " & Val(OnAc_id) & " , Tax_Type =  '" & Trim(Cbo_Tax_Type.Text) & "' ,AddLess_Caption = '" & Trim(txt_AddLess_Caption.Text) & "' ,Add_Less = " & Val(txt_AddLess.Text) & " , Freight = " & Val(txt_Freight.Text) & " , Assessable_Value = " & Val(lbl_Assessable_Value.Text) & " , CGST_Percentage = " & Val(txt_CGST_Perc.Text) & " , CGST_Amount = " & Val(lbl_CGST_Amount.Text) & " , SGST_Percentage = " & Val(txt_SGST_Perc.Text) & " , SGST_Amount = " & Val(lbl_SGST_Amount.Text) & " , IGST_Percentage = " & Val(txt_IGST_Perc.Text) & " , IGST_Amount = " & Val(lbl_IGST_Amount.Text) & " , Net_Amount = " & Val(lbl_Net_Amount.Text) & ", add_Less_Caption = '" & Trim(txt_AddLess_Caption.Text) & "', Total_OtherCharges = " & Val(Total_OtherCharges) & ", Sizing_Charges_Account =  " & Val(Siz_Charges_Acc) & ",Total_RewindingCharges = " & Str(Val(Total_RewindingCharges)) & " , RoundOff_Amount = " & Val(lbl_RoundOff_Amt.Text) & ",bill_amount=" & Val(lbl_bill_amount.Text) & ", Tds_perc=" & Val(txt_Tds.Text) & "   ,Tds_amount=" & Val(lbl_Tds_Amount.Text) & ",add_less2=" & Val(txt_addless2.Text) & " , Bill_No = '" & Trim(txt_BillNo.Text) & "' Where Company_IdNo = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "DELETE FROM Sizing_invoice_details WHERE Company_IdNo = " & Val(lbl_company.Tag) & " AND Invoice_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            Dim vNetAmt As String = Format(Val(CSng(lbl_bill_amount.Text)), "#############0.00")
            ...
            vLed_IdNos = Cr_ID & "|" & Dr_ID & "|" & Trim(Val(vCGST_AcIdNo)) & "|" & Trim(Val(vSGST_AcIdNo)) & "|" & Trim(Val(vIGST_AcIdNo)) & "|30"
            ...
            Else
                vVou_Amts = Val(vNetAmt) & "|" & -1 * (Val(vNetAmt) - (Val(vCGSTAmt) + Val(vSGSTAmt) + Val(vIGSTAmt) + Val(lbl_RoundOff_Amt.Text))) & "|" & -1 * Val(vCGSTAmt) & "|" & -1 * Val(vSGSTAmt) & "|" & -1 * Val(vIGSTAmt) & "|" & -1 * Val(lbl_RoundOff_Amt.Text)
            End If


            If Common_Procedures.Voucher_Updation(con, "Siz.Inv", Val(lbl_company.Tag), Trim(NewCode), Trim(lbl_Invoice_No.Text), Convert.ToDateTime(dtp_Date.Text), "Sizing Inv.No : " & Trim(txt_BillNo.Text) & "", vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            ...
            '---Bill Posting
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1224" Then '---- KAVITHAA FABRICS (PALLADAM)
                VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_company.Tag), dtp_Date.Text, led_id, Trim(txt_BillNo.Text), 0, Val(CSng(lbl_Net_Amount.Text)), "DR", Trim(NewCode), tr)

            Else
                VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_company.Tag), dtp_Date.Text, led_id, Trim(txt_BillNo.Text), 0, Val(CSng(lbl_Net_Amount.Text)), "CR", Trim(NewCode), tr)
            ...
            Else
                vVou_Amts = -1 * Val(lbl_Tds_Amount.Text) & "|" & Val(lbl_Tds_Amount.Text)
            End If

            If Common_Procedures.Voucher_Updation(con, "Siz.Inv.Tds", Val(lbl_company.Tag), Trim(Pk_Condition2) & Trim(NewCode), Trim(lbl_Invoice_No.Text), Convert.ToDateTime(msk_Date.Text), "Sizing Inv.No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                Throw New ApplicationException(ErrMsg)
                Exit Sub
            End If
    ...
    Private Sub Invoice_GST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbo_grid_count.Items.Clear()
        cbo_grid_millname.Items.Clear()
    ...
    Private Sub cbo_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_Party_Name.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_Party_Name, msk_Date, txt_BillNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 and Close_Status = 0 )", "(Ledger_IdNo = 0)")
    ...
    Private Sub printing_invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Sizing_invoice_head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Invoice_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("Select a.*, b.*, c.*,id.*,id.Rewinding_Amount as Rewinding, id.packing_Amount as Packing ,Ch.Count_Name, mh.Mill_Name, Csh.State_Name as Company_State_Name,  Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code,  dph.Ledger_Name as Delivery_Name ,dph.Ledger_Address1 as Delivery_Address1, dph.Ledger_Address2 as Delivery_Address2, dph.Ledger_Address3 as Delivery_Address3, dph.Ledger_Address4 as Delivery_Address4, dph.Ledger_GSTinNo as Delivery_GST_No  from Sizing_invoice_head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_Head Csh ON b.Company_State_Idno  = Csh.State_IdNo INNER JOIN Ledger_Head c ON (case when a.OnAccount_IdNo   <> 0 then a.OnAccount_IdNo else a.Ledger_IdNo end) = c.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON c.ledger_State_IdNo = Lsh.State_IdNo LEFT OUTER JOIN Delivery_Party_Head dph ON Dph.Ledger_IdNo = a.DeliveryTo_IdNo Left outer join Sizing_invoice_details id ON a.Invoice_code = id.Invoice_code left outer join Count_Head ch on id.Count_IdNo = ch.count_IdNo LEFT OUTER JOIN Mill_Head mh ON id.Mill_IdNo = mh.Mill_IdNo where a.company_idno = " & Str(Val(lbl_company.Tag)) & " and a.Invoice_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            'da2 = New SqlClient.SqlDataAdapter("Select a.*, b.* from Sizing_invoice_details a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo  where a.company_idno = " & Str(Val(lbl_company.Tag)) & " and a.Invoice_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Printing_Format12_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        'da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, c.Ledger_Name, d.Company_Description as Transport_Name from ClothSales_Sizing_invoice_head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno LEFT OUTER JOIN Ledger_Head c ON c.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Company_Head d ON d.Company_IdNo = a.Company_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothSales_Invoice_Code = '" & Trim(EntryCode) & "' Order by a.For_OrderBy", con)
        'da2.Fill(dt2)
    ...
    Private Sub Printing_GST_HSN_Details_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByRef CurY As Single, ByVal LMargin As Integer, ByVal PageWidth As Integer, ByVal PrintWidth As Double, ByVal LnAr As Single)
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select * from Sizing_invoice_head where Invoice_Code = '" & Trim(EntryCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update Sizing_invoice_head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_company.Tag)) & " and Invoice_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Private Sub Printing_Format6_GST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        'If prn_HdDt.Rows(0).Item("Ledger_Address1").ToString <> "" And Trim(prn_HdDt.Rows(0).Item("Vendor_Name").ToString) = "" Then
        '     CurY2 = CurY + TxtHgt
        ...
        If Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString) <> "" Then
            CurY2 = CurY2 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_Name").ToString, LMargin + C1 + C2 + C3 + C4 + C5 + C6 + 10, CurY2, 0, 0, p1Font)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString) <> "" And prn_HdDt.Rows(0).Item("Ledger_Address1").ToString <> "" Then
            CurY2 = CurY2 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_Address1").ToString & " " & prn_HdDt.Rows(0).Item("Ledger_Address2").ToString, LMargin + C1 + C2 + C3 + C4 + C5 + 10, CurY2, 0, 0, pFont)
        ...
        ElseIf prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString <> "" Then
            CurY2 = CurY2 + TxtHgt
        ...
        If Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString) <> "" And prn_HdDt.Rows(0).Item("Ledger_Address3").ToString <> "" Then
            CurY2 = CurY2 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_Address3").ToString & " " & prn_HdDt.Rows(0).Item("Ledger_Address4").ToString, LMargin + C1 + C2 + (C3 / 3) + 10, CurY2, 0, 0, pFont)
            ' Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_GST_No").ToString, LMargin + C1 + C2 + C3 + C4 + C5 + 10, CurY2, 0, 0, pFont)
        ElseIf prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString <> "" Then
            CurY2 = CurY2 + TxtHgt
            ...
            'ElseIf prn_HdDt.Rows(0).Item("GST_No").ToString <> "" Then
            'CurY2 = CurY2 + TxtHgt
            'Common_Procedures.Print_To_PrintDocument(e, Cmp_GSTIN_Cap & prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString, LMargin + C1 + C2 + C3 + C4 + C5 + 10, CurY2, 0, 0, p1Font)
        End If
        ...
        NetAmt = Format(Val(prn_HdDt.Rows(0).Item("Assessable_Value").ToString) + Val(prn_HdDt.Rows(0).Item("CGST_Amount").ToString) + Val(prn_HdDt.Rows(0).Item("SGST_Amount").ToString) + Val(prn_HdDt.Rows(0).Item("IGST_Amount").ToString), "##########0.00")
    ...
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Sizing_invoice_head", "Vechile_No", "", "")
    'End Sub

    'Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vechile, Cbo_Tax_Type, Nothing, "Sizing_invoice_head", "Vechile_No", "", "")
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vechile, Nothing, "Sizing_invoice_head", "Vechile_No", "", "", False)
    '    If Asc(e.KeyChar) = 13 Then
    '        If txt_CGST_Perc.Visible = True Then
    '            txt_CGST_Perc.Focus()
    '        Else
    ...
    'Private Sub cbo_VendorName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Vendor_AlaisHead", "Vendor_DisplayName", "", "(Vendor_IdNo = 0)")
    'End Sub

    'Private Sub cbo_VendorName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    vcbo_KeyDwnVal = e.KeyValue
    ...
    'Private Sub cbo_VendorName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    'Private Sub cbo_VendorName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    'Private Sub cbo_DelieveryTo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub cbo_DelieveryTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    vcbo_KeyDwnVal = e.KeyValue
    ...
    'Private Sub cbo_DelieveryTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    ''    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ''        Dim f As New Delivery_Creation
    ''        Common_Procedures.Master_Return.Form_Name = Me.Name
                ...
                If .Rows.Count > 0 Then
                    ...
                    If e.ColumnIndex = 19 Then
                        ...
                        If cbo_Grid_DiscType.Visible = False Or Val(cbo_Grid_DiscType.Tag) <> e.RowIndex Then
                            ...
                            'Da = New SqlClient.SqlDataAdapter("SELECT Discount_Type from Sizing_invoice_details ORDER BY Discount_Type", con)
                            'Dt = New DataTable
                            'Da.Fill(Dt1)
                    ...
                    If e.ColumnIndex = 4 Then
                        ...
                        If cbo_grid_count.Visible = False Or Val(cbo_grid_count.Tag) <> e.RowIndex Then
                            ...
                            'cbo_grid_count.DisplayMember = "Discount_Type"
                            ''cbo_grid_count.ValueMember = ""
                            ...
                            cbo_grid_count.DropDownHeight = 106
                            ...
                            'cbo_grid_count.Items.Clear()
                            'cbo_grid_count.Items.Add("")
                            'cbo_grid_count.Items.Add("%")
                            'cbo_grid_count.Items.Add("KG")
                        End If
                    Else
                        cbo_grid_count.Visible = False
                    ...
                    If e.ColumnIndex = 5 Then
                        ...
                        If cbo_grid_millname.Visible = False Or Val(cbo_grid_millname.Tag) <> e.RowIndex Then
                            ...
                            'cbo_grid_millname.DisplayMember = "Discount_Type"
                            ''cbo_grid_millname.ValueMember = ""
                            ...
                            cbo_grid_millname.DropDownHeight = 106
                            ...
                            'cbo_grid_millname.Items.Clear()
                            'cbo_grid_millname.Items.Add("")
                            'cbo_grid_millname.Items.Add("%")
                            'cbo_grid_millname.Items.Add("KG")
                        End If
                    Else
                        cbo_grid_millname.Visible = False
        ...
        With dgv_Details
            ...
            If .Visible Then
                If e.KeyValue = Keys.Delete Then
                    If .CurrentCell.ColumnIndex <= 1 And Trim(.Rows(.CurrentCell.RowIndex).Cells(16).Value) <> "" Then
                        e.Handled = True
        ...
        Try
            With dgv_Details
                If .Visible Then
                    ...
                    If .CurrentCell.ColumnIndex = 1 Or .CurrentCell.ColumnIndex = 6 Or .CurrentCell.ColumnIndex = 7 Or .CurrentCell.ColumnIndex = 8 Or .CurrentCell.ColumnIndex = 9 Or .CurrentCell.ColumnIndex = 10 Or .CurrentCell.ColumnIndex = 11 Or .CurrentCell.ColumnIndex = 12 Or .CurrentCell.ColumnIndex = 13 Or .CurrentCell.ColumnIndex = 14 Or .CurrentCell.ColumnIndex = 15 Or .CurrentCell.ColumnIndex = 16 Or .CurrentCell.ColumnIndex = 17 Or .CurrentCell.ColumnIndex = 18 Or .CurrentCell.ColumnIndex = 20 Or .CurrentCell.ColumnIndex = 21 Or .CurrentCell.ColumnIndex = 22 Then
        ...
        If ActiveControl.Name = dgv_Details.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then
            ...
            With dgv1
                ...
                ElseIf keyData = Keys.Up Then
                    If .CurrentCell.ColumnIndex <= 1 Then
                        If .CurrentCell.RowIndex = 0 Then
                            cbo_Sizing_Charges_Account.Focus()
    ...
    Private Sub cbo_grid_millname_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_grid_millname.KeyDown
        ...
        With dgv_Details
            If e.KeyCode = 38 And cbo_grid_millname.DroppedDown = False Or (e.Control = True And e.KeyCode = 38) Then
                If .Visible = True Then
                    .Focus()
                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex - 1)
                End If
            End If
            If e.KeyCode = 40 And cbo_grid_millname.DroppedDown = False Or (e.Control = True And e.KeyCode = 40) Then
                If .Visible = True Then
                    .Focus()
                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex + 1)
                End If
    ...
    Private Sub cbo_grid_millname_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_grid_millname.TextChanged
        Try
            If cbo_grid_millname.Visible Then
                With dgv_Details
                    If Val(cbo_grid_millname.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 5 Then
    ...
    Private Sub cbo_grid_count_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_grid_count.KeyDown
        ...
        With dgv_Details
            If e.KeyCode = 38 And cbo_grid_count.DroppedDown = False Or (e.Control = True And e.KeyCode = 38) Then
                If .Visible = True Then
                    .Focus()
                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex - 1)
                End If
            End If
            If e.KeyCode = 40 And cbo_grid_count.DroppedDown = False Or (e.Control = True And e.KeyCode = 40) Then
                If .Visible = True Then
                    .Focus()
                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex + 1)
                End If
    ...
    Private Sub cbo_grid_count_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_grid_count.TextChanged
        Try
            If cbo_grid_count.Visible Then
                With dgv_Details
                    If Val(cbo_grid_count.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 4 Then
    ...
    Private Sub NetAmount_Calculation()
        ...
        tdsamt = Format((Val(lbl_bill_amount.Text)) * Val(txt_Tds.Text) / 100, "########0")

        GST_Calculation()

        Tax_Amt = Val(lbl_CGST_Amount.Text) + Val(lbl_SGST_Amount.Text) + Val(lbl_IGST_Amount.Text)

        vNet_Amt = Format(Val(AssAmt) + Val(Tax_Amt), "##########0.00")

        lbl_bill_amount.Text = Format(Val(vNet_Amt) + Val(txt_addless2.Text), "########0")


        lbl_RoundOff_Amt.Text = Format(Val(lbl_bill_amount.Text) - Val(vNet_Amt), "#########0.00")
        lbl_Tds_Amount.Text = Format(Val(tdsamt), "########0.00")

        lbl_Net_Amount.Text = Format(Val(lbl_bill_amount.Text) - Val(lbl_Tds_Amount.Text), "########0")
    ...
    Private Sub GST_Calculation()
        ...
        Dim vComp_StIdNo As Integer = 0
        Dim vLed_StIdNo As Integer = 0
        Dim vLed_IdNo As Integer = 0

        vComp_StIdNo = Val(Common_Procedures.get_FieldValue(con, "Company_Head", "Company_State_IdNo", "(Company_IdNo = " & Str(Val(lbl_company.Tag)) & ")"))
        vLed_IdNo = Common_Procedures.Ledger_AlaisNameToIdNo(con, Cbo_Party_Name.Text)
        vLed_StIdNo = Val(Common_Procedures.get_FieldValue(con, "Ledger_Head", "Ledger_State_IdNo", "(Ledger_IdNo = " & Str(Val(vLed_IdNo)) & ")"))

        If vLed_IdNo <> 0 And vComp_StIdNo <> vLed_StIdNo Then

            txt_CGST_Perc.Text = ""
            txt_SGST_Perc.Text = ""
            txt_IGST_Perc.Text = "5.0"
    ...
    Private Sub cbo_Sizing_Charges_Account_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Sizing_Charges_Account.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 5 or AccountsGroup_IdNo = 6 or AccountsGroup_IdNo = 15 or AccountsGroup_IdNo = 16 or AccountsGroup_IdNo = 23 or AccountsGroup_IdNo = 27 or AccountsGroup_IdNo = 28)", "")
    End Sub
    ...
    Private Sub cbo_Sizing_Charges_Account_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Sizing_Charges_Account.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Sizing_Charges_Account, Nothing, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 5 or AccountsGroup_IdNo = 6 or AccountsGroup_IdNo = 15 or AccountsGroup_IdNo = 16 or AccountsGroup_IdNo = 23 or AccountsGroup_IdNo = 27 or AccountsGroup_IdNo = 28)", "")
    ...
    Private Sub txt_Tds_TextChanged(sender As Object, e As System.EventArgs) Handles txt_Tds.TextChanged
        NetAmount_Calculation()

    End Sub

    Private Sub txt_addless2_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txt_addless2.KeyDown
        If e.KeyCode = 38 Then
            txt_IGST_Perc.Focus()
    ...
    Private Sub txt_addless2_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txt_addless2.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then
            e.Handled = True
        End If
        NetAmount_Calculation()
    ...
    Private Sub Cbo_Party_Name_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cbo_Party_Name.TextChanged
        GST_Calculation()
    End Sub
End Class
