Public Class Weaver_Pavu_Bobin_Yarn_Jari_Delivery_Entry
    ...
    Private Pk_Condition As String = "VPYJD-"
    ...
    Private vPrn_PvuTotAMT As String
    ...
    Private prn_TOTBEAMS As String
    Private prn_TOTBOBINS As String
    Private prn_TOTPAVUMTRS As String
    Private prn_TOTBOBMTRS As String
    Private prn_TOTYARNWGT As String
    Private prn_TOTJARIWGT As String
    ...
    Private prn_Option_STS As Integer
    ...
    Private Sub clear()
        ...
        dgv_PavuBobinDetails.Rows.Clear()
        dgv_YarnZari_Details.Rows.Clear()

        dgv_YarnZari_Details_Total.Rows.Clear()
        dgv_YarnZari_Details_Total.Rows.Add()
        Grid_DeSelect()
    ...
    Private Sub Grid_DeSelect()
        ...
        If Not IsNothing(dgv_YarnZari_Details.CurrentCell) Then dgv_YarnZari_Details.CurrentCell.Selected = False
        If Not IsNothing(dgv_PavuBobinDetails.CurrentCell) Then dgv_PavuBobinDetails.CurrentCell.Selected = False
    ...
    Private Sub ControlGotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.ActiveControl.Name <> dgv_PavuBobinDetails.Name Then
            Grid_DeSelect()
        End If

        If Me.ActiveControl.Name <> dgv_YarnZari_Details.Name Then
            Grid_DeSelect()
        End If
    ...
    Private Sub ControlLostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNothing(Prec_ActCtrl) = False Then
            ...
            ElseIf TypeOf Prec_ActCtrl Is Button Then
                If Prec_ActCtrl.Name = btn_close.Name Or Prec_ActCtrl.Name = btn_Print_Cancel.Name Then
                    Prec_ActCtrl.BackColor = Color.Tomato
                    Prec_ActCtrl.ForeColor = Color.White
                ElseIf Prec_ActCtrl.Name = btn_Print_Delivery_Without_Value.Name Or Prec_ActCtrl.Name = btn_Print_Delivery_With_Value.Name Then
                    Prec_ActCtrl.BackColor = Color.FromArgb(64, 64, 64)
                    Prec_ActCtrl.ForeColor = Color.White
                Else
    ...
    Private Sub Grid_Cell_DeSelect()
        ...
        If Not IsNothing(dgv_YarnZari_Details.CurrentCell) Then dgv_YarnZari_Details.CurrentCell.Selected = False
        If Not IsNothing(dgv_PavuBobinDetails.CurrentCell) Then dgv_PavuBobinDetails.CurrentCell.Selected = False
        If Not IsNothing(dgv_PavuBobinDetails_Total.CurrentCell) Then dgv_PavuBobinDetails_Total.CurrentCell.Selected = False
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Weaver_PavuBobin_YarnJari_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo   Where a.Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_DcNo.Text = dt1.Rows(0).Item("Pavu_Yarn_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Pavu_Yarn_Delivery_Date")
                ...
                lbl_TotalAmount.Text = Format(Val(dt1.Rows(0).Item("Total_Amount").ToString), "########0.00")
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.EndsCount_Name from Weaver_Pavu_Bobin_Details a INNER JOIN Endscount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo  Where a.Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        n = dgv_PavuBobinDetails.Rows.Add()


                        SNo = SNo + 1
                        dgv_PavuBobinDetails.Rows(n).Cells(0).Value = Val(SNo)
                        dgv_PavuBobinDetails.Rows(n).Cells(1).Value = dt2.Rows(i).Item("EndsCount_Name").ToString
                        dgv_PavuBobinDetails.Rows(n).Cells(2).Value = Val(dt2.Rows(i).Item("Beams").ToString)
                        dgv_PavuBobinDetails.Rows(n).Cells(3).Value = Val(dt2.Rows(i).Item("Bobins").ToString)
                        dgv_PavuBobinDetails.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("METERS").ToString), "########0.00")
                        dgv_PavuBobinDetails.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                        dgv_PavuBobinDetails.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                ...
                With dgv_PavuBobinDetails_Total
                    If .RowCount = 0 Then .Rows.Add()
                    .Rows(0).Cells(2).Value = Val(dt1.Rows(0).Item("Total_Beams").ToString)
                    ...
                    .Rows(0).Cells(6).Value = Format(Val(dt1.Rows(0).Item("Total_PavuBobin_Amount").ToString), "########0.00")
                End With


                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name from Weaver_Yarn_Jari_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo  where a.Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        n = dgv_YarnZari_Details.Rows.Add()

                        SNo = SNo + 1
                        dgv_YarnZari_Details.Rows(n).Cells(0).Value = Val(SNo)
                        dgv_YarnZari_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Count_Name").ToString
                        dgv_YarnZari_Details.Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("Weight").ToString), "########0.000")
                        dgv_YarnZari_Details.Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                        dgv_YarnZari_Details.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                    Next i

                End If

                With dgv_YarnZari_Details_Total
                    If .RowCount = 0 Then .Rows.Add()

                    .Rows(0).Cells(2).Value = Format(Val(dt1.Rows(0).Item("Total_Weight").ToString), "########0.000")
                    .Rows(0).Cells(4).Value = Format(Val(dt1.Rows(0).Item("Total_YarnJari_Amount").ToString), "########0.000")
    ...
    Private Sub Weaver_Bobin_Delivery_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'da = New SqlClient.SqlDataAdapter("select distinct(Vechile_No) from Weaver_PavuBobin_YarnJari_Head order by Vechile_No", con)
        'da.Fill(dt4)
        ...
        AddHandler btn_Print_Delivery_Without_Value.GotFocus, AddressOf ControlGotFocus
        AddHandler btn_Print_Delivery_With_Value.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler btn_Print_Delivery_Without_Value.LostFocus, AddressOf ControlLostFocus
        AddHandler btn_Print_Delivery_With_Value.LostFocus, AddressOf ControlLostFocus
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If ActiveControl.Name = dgv_PavuBobinDetails.Name Or ActiveControl.Name = dgv_YarnZari_Details.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then

            On Error Resume Next

            dgv1 = Nothing

            If ActiveControl.Name = dgv_PavuBobinDetails.Name Then
                dgv1 = dgv_PavuBobinDetails

            ElseIf dgv_PavuBobinDetails.IsCurrentRowDirty = True Then
                dgv1 = dgv_PavuBobinDetails

            ElseIf ActiveControl.Name = dgv_YarnZari_Details.Name Then
                dgv1 = dgv_YarnZari_Details

            ElseIf dgv_YarnZari_Details.IsCurrentRowDirty = True Then
                dgv1 = dgv_YarnZari_Details


            ElseIf Trim(UCase(dgv_ActCtrlName)) = Trim(UCase(dgv_PavuBobinDetails.Name.ToString)) Then
                dgv1 = dgv_PavuBobinDetails

            ElseIf Trim(UCase(dgv_ActCtrlName)) = Trim(UCase(dgv_YarnZari_Details.Name.ToString)) Then
                dgv1 = dgv_YarnZari_Details
                    ...
                    If keyData = Keys.Enter Or keyData = Keys.Down Then
                        If .CurrentCell.ColumnIndex >= .ColumnCount - 2 Then
                            If .CurrentCell.RowIndex = .RowCount - 1 Then
                                If dgv1.Name = dgv_PavuBobinDetails.Name Then
                                    txt_Remarks.Focus()
                                ElseIf dgv1.Name = dgv_YarnZari_Details.Name Then
                                    txt_Remarks.Focus()
                    ...
                    ElseIf keyData = Keys.Up Then
                        ...
                        If .CurrentCell.ColumnIndex <= 1 Then
                            If .CurrentCell.RowIndex = 0 Then
                                ...
                                Else
                                    If dgv_PavuBobinDetails.Rows.Count > 0 Then
                                        dgv_PavuBobinDetails.Focus()
                                        dgv_PavuBobinDetails.CurrentCell = dgv_PavuBobinDetails.Rows(0).Cells(1)
                                    Else
                                        cbo_Ledger.Focus()
                                    End If
                                End If
                        ...
                        ElseIf .CurrentCell.ColumnIndex = 6 Then
                            If dgv1.Name = dgv_YarnZari_Details.Name Then
                                .CurrentCell = .Rows(.CurrentCell.RowIndex).Cells(3)
                            ElseIf dgv1.Name = dgv_PavuBobinDetails.Name Then
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry, Me, con, "Weaver_PavuBobin_YarnJari_Head", "Weaver_Pavu_Yarn_Delivery_Code", NewCode, "Weaver_Pavu_Yarn_Delivery_Date", "(Weaver_Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "Delete from Stock_Empty_BeamBagCone_Processing_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reference_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Weaver_Pavu_Bobin_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Weaver_Yarn_Jari_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Weaver_PavuBobin_YarnJari_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Yarn_Delivery_No from Weaver_PavuBobin_YarnJari_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Pavu_Yarn_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, Pavu_Yarn_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Yarn_Delivery_No from Weaver_PavuBobin_YarnJari_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Pavu_Yarn_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, Pavu_Yarn_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Yarn_Delivery_No from Weaver_PavuBobin_YarnJari_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Pavu_Yarn_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Pavu_Yarn_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_PavuBobin_YarnJari_Head", "Pavu_Yarn_Delivery_Code", "For_OrderBy", "( Pavu_Yarn_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' )", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red
            da = New SqlClient.SqlDataAdapter("select top 1 * from Weaver_PavuBobin_YarnJari_Head  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby desc, Pavu_Yarn_Delivery_No desc", con)
            dt = New DataTable
            da.Fill(dt)

            If dt.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt.Rows(0).Item("Pavu_Yarn_Delivery_Date").ToString <> "" Then msk_date.Text = dt.Rows(0).Item("Pavu_Yarn_Delivery_Date").ToString
                End If
            End If
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Pavu_Yarn_Delivery_No from Weaver_PavuBobin_YarnJari_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim del_Nam As String = ""
        Dim Rec_nam As String = ""
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry, Me, con, "Weaver_PavuBobin_YarnJari_Head", "Weaver_Pavu_Yarn_Delivery_Code", NewCode, "Weaver_Pavu_Yarn_Delivery_Date", "(Weaver_Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Pavu_Yarn_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Weaver_Pavu_Yarn_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Delv_ID = Led_ID
        del_Nam = Common_Procedures.Ledger_IdNoToName(con, Delv_ID)
        Rec_ID = Val(Common_Procedures.CommonLedger.Godown_Ac)
        Rec_nam = Common_Procedures.Ledger_IdNoToName(con, Rec_ID)
        Trans_ID = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Transport.Text)

        With dgv_PavuBobinDetails
        ...
        Dim vTotBemS As String = 0
        Dim vTotPavBm_Amt As String = 0
        Dim vTotYnJariAmt As String = 0

        vTotBemS = 0 : vTotBbns = 0 : vTotMtrs = 0 : vTotPavBm_Amt = 0

        If dgv_PavuBobinDetails_Total.RowCount > 0 Then

            vTotBemS = Val(dgv_PavuBobinDetails_Total.Rows(0).Cells(2).Value())
            vTotBbns = Val(dgv_PavuBobinDetails_Total.Rows(0).Cells(3).Value())
            vTotMtrs = Val(dgv_PavuBobinDetails_Total.Rows(0).Cells(4).Value())
            vTotPavBm_Amt = Val(dgv_PavuBobinDetails_Total.Rows(0).Cells(6).Value())

        End If

        vTotJumbo = 0 : vTotCns = 0 : vTotWgt = 0 : vTotYnJariAmt = 0

        If dgv_YarnZari_Details_Total.RowCount > 0 Then
            'vTotJumbo = Val(dgv_YarnZari_Details_Total.Rows(0).Cells(5).Value())
            'vTotCns = Val(dgv_YarnZari_Details_Total.Rows(0).Cells(6).Value())

            vTotWgt = Val(dgv_YarnZari_Details_Total.Rows(0).Cells(2).Value())
            vTotYnJariAmt = Val(dgv_YarnZari_Details_Total.Rows(0).Cells(4).Value())
        ...
        Partcls = "Weaver Sales : Dc.No. " & Trim(lbl_DcNo.Text)
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_PavuBobin_YarnJari_Head", "Pavu_Yarn_Delivery_Code", "For_OrderBy", "(Pavu_Yarn_Delivery_Code LIKE '" & Trim(Pk_Condition) & "%' )", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Weaver_PavuBobin_YarnJari_Head ( Pavu_Yarn_Delivery_Code, Company_IdNo,          Pavu_Yarn_Delivery_No,          for_OrderBy,        Pavu_Yarn_Delivery_Date, Ledger_IdNo,                        Vechile_No,                        Transport_IdNo  ,         Total_Beams,                             Total_Bobins ,          Total_Meters,                        Total_PavuBobin_Amount   ,                       Total_Weight,        Total_YarnJari_Amount      ,                             Remarks             ,           Report_Particulars     , Total_Amount) " &
                                                        "Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate,               " & Str(Val(Led_ID)) & ",'" & Trim(cbo_VechileNo.Text) & "', " & Str(Val(Trans_ID)) & ",    " & Str(Val(vTotBemS)) & "    ,      " & Str(Val(vTotBbns)) & " , " & Str(Val(vTotMtrs)) & ",        " & Str(Val(vTotPavBm_Amt)) & "        ,    " & Str(Val(vTotWgt)) & " ,       " & Str(Val(vTotYnJariAmt)) & "    ,   '" & Trim(txt_Remarks.Text) & "', '" & Trim(Partcls) & "' ,       " & Str(Val(lbl_TotalAmount.Text)) & ") "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Weaver_PavuBobin_YarnJari_Head set Pavu_Yarn_Delivery_Date = @EntryDate, Ledger_IdNo = " & Val(Led_ID) & ", Vechile_No = '" & Trim(cbo_VechileNo.Text) & "', Transport_IdNo = " & Str(Val(Trans_ID)) & ", Total_Beams =    " & Str(Val(vTotBemS)) & " ,  Total_Bobins = " & Val(vTotBbns) & " , Total_Meters = " & Val(vTotMtrs) & ", Total_PavuBobin_Amount  = " & Str(Val(vTotPavBm_Amt)) & " ,  Total_Weight = " & Val(vTotWgt) & ",  Total_YarnJari_Amount =    " & Str(Val(vTotYnJariAmt)) & "  ,   Remarks = '" & Trim(txt_Remarks.Text) & "' ,   Report_Particulars = '" & Trim(Partcls) & "' ,  Total_Amount = " & Str(Val(lbl_TotalAmount.Text)) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_PavuBobinDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Weaver_Pavu_Bobin_Details ( Pavu_Yarn_Delivery_Code, Company_IdNo, Pavu_Yarn_Delivery_No, for_OrderBy, Pavu_Yarn_Delivery_Date, Sl_No, EndsCount_IdNo, Beams ,  Bobins,  Meters  , Rate ,  Amount  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Ens_ID)) & ",  " & Val(.Rows(i).Cells(2).Value) & ", " & Val(.Rows(i).Cells(3).Value) & ",  " & Val(.Rows(i).Cells(4).Value) & ",   " & Val(.Rows(i).Cells(5).Value) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            With dgv_YarnZari_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Or Val(.Rows(i).Cells(2).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Weaver_Yarn_Jari_Details ( Pavu_Yarn_Delivery_Code, Company_IdNo, Pavu_Yarn_Delivery_No, for_OrderBy, Pavu_Yarn_Delivery_Date, Sl_No, Count_IdNo ,  Weight , Rate , AMount  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ", " & Val(.Rows(i).Cells(2).Value) & ", " & Val(.Rows(i).Cells(3).Value) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ")"
                        cmd.ExecuteNonQuery()
            ...
            If Val(vTotBemS) <> 0 Or Val(vTotBbns) <> 0 Then
                cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details (     Reference_Code    ,                  Company_IdNo    ,            Reference_No      ,       for_OrderBy    , Reference_Date,     DeliveryTo_Idno      ,     ReceivedFrom_Idno   ,     Entry_ID         ,     Party_Bill_No    ,      Particulars       , Sl_No,             Empty_Beam    ,             Empty_Bobin   ) " &
                                    " Values                                              ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ",    @EntryDate , " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',   1  , " & Str(Val(vTotBemS)) & ", " & Str(Val(vTotBbns)) & ") "
                cmd.ExecuteNonQuery()
            End If
            ...
            vLed_IdNos = Val(Common_Procedures.CommonLedger.WEAVER_Sales_Ac) & "|" & Led_ID
            vVou_Amts = (Val(vTotPavBm_Amt) + Val(vTotYnJariAmt)) & "|" & -1 * (Val(vTotPavBm_Amt) + Val(vTotYnJariAmt))

            If Common_Procedures.Voucher_Updation(con, "Wea.Sales", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_DcNo.Text), Convert.ToDateTime(dtp_Date.Text), Partcls, vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub Total_Calculation()
        Dim vTotBbnS As Single, vTotMtrs As Single, vTotBemS As Single
        Dim vTotJumbo As Single, vTotCns As Single, vTotWgt As Single
        Dim i As Integer
        Dim sno As Integer
        Dim vTotPavBm_Amt As String = 0
        Dim vTotYnJari_Amt As String = 0

        vTotBbnS = 0 : vTotMtrs = 0 : vTotPavBm_Amt = 0
        ...
        With dgv_PavuBobinDetails
            For i = 0 To .Rows.Count - 1
                ...
                If Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    vTotBemS = vTotBemS + Val(.Rows(i).Cells(2).Value)
                    vTotBbnS = vTotBbnS + Val(.Rows(i).Cells(3).Value)
                    vTotMtrs = vTotMtrs + Val(.Rows(i).Cells(4).Value)
                    vTotPavBm_Amt = vTotPavBm_Amt + Val(.Rows(i).Cells(6).Value)

                End If
            Next
        End With

        If dgv_PavuBobinDetails_Total.Rows.Count <= 0 Then dgv_PavuBobinDetails_Total.Rows.Add()


        dgv_PavuBobinDetails_Total.Rows(0).Cells(2).Value = Val(vTotBemS)
        dgv_PavuBobinDetails_Total.Rows(0).Cells(3).Value = Val(vTotBbnS)
        dgv_PavuBobinDetails_Total.Rows(0).Cells(4).Value = Format(Val(vTotMtrs), "#########0.00")
        dgv_PavuBobinDetails_Total.Rows(0).Cells(6).Value = Format(Val(vTotPavBm_Amt), "#########0.00")
        ...
        With dgv_YarnZari_Details
            For i = 0 To .Rows.Count - 1
                ...
                If Val(.Rows(i).Cells(2).Value) <> 0 Then
                    ...
                    vTotWgt = vTotWgt + Val(.Rows(i).Cells(2).Value)
                    vTotYnJari_Amt = vTotYnJari_Amt + Val(.Rows(i).Cells(4).Value)
        ...
        If dgv_YarnZari_Details_Total.Rows.Count <= 0 Then dgv_YarnZari_Details_Total.Rows.Add()

        dgv_YarnZari_Details_Total.Rows(0).Cells(2).Value = Format(Val(vTotWgt), "#########0.000")
        dgv_YarnZari_Details_Total.Rows(0).Cells(4).Value = Format(Val(vTotYnJari_Amt), "#########0.000")

        lbl_TotalAmount.Text = Format(Val(vTotPavBm_Amt) + Val(vTotYnJari_Amt), "#########0.000")

    End Sub

    Private Sub cbo_Ledger_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Ledger.GotFocus

        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1)", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, msk_date, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1)", "(Ledger_idno = 0)")

        'If Asc(e.KeyCode) = 40 Then
        '    If dgv_PavuBobinDetails.Rows.Count > 0 Then
        '        dgv_PavuBobinDetails.Focus()
        '        dgv_PavuBobinDetails.CurrentCell = dgv_PavuBobinDetails.Rows(0).Cells(1)
        '        dgv_PavuBobinDetails.CurrentCell.Selected = True
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1)", "(Ledger_idno = 0)")
    ...
    Private Sub dgv_BobinDetails_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_PavuBobinDetails.CellEndEdit
        With dgv_PavuBobinDetails
    ...
    Private Sub dgv_BobinDetails_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_PavuBobinDetails.CellEnter
        Dim Da As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim Dt2 As New DataTable
        Dim Dt3 As New DataTable
        ...
        '        For i = 0 To .Rows.Count - 1
        '            EndsCnt_id = Val(Common_Procedures.EndsCount_NameToIdNo(con, Trim(.Rows(i).Cells(8).Value)))
        '            Ends_Cnt = Trim(Ends_Cnt) & IIf(Trim(Ends_Cnt) <> "", ", ", "") & Trim(Val(EndsCnt_id))
        '            'MrkGrp = Trim(MrkGrp) & IIf(Trim(MrkGrp) <> "", ", ", "") & Trim(Val(Dt1.Rows(i).Item("Mark")))
        '        Next
        '    End If

        'End With
        'If Trim(Ends_Cnt) <> "" Then
        '    Ends_Cnt = "(" & Ends_Cnt & ")"
    ...
    Private Sub dgv_Details_CellLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_PavuBobinDetails.CellLeave
    ...
    Private Sub dgv_Details_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_PavuBobinDetails.CellValueChanged
        On Error Resume Next

        If Not IsNothing(dgv_PavuBobinDetails.CurrentCell) Then
            With dgv_PavuBobinDetails
                If .Visible Then
                    If .CurrentCell.ColumnIndex = 4 Or .CurrentCell.ColumnIndex = 5 Or .CurrentCell.ColumnIndex = 6 Then

                        .Rows(e.RowIndex).Cells(6).Value = Format(Val(.Rows(e.RowIndex).Cells(4).Value) * Val(.Rows(e.RowIndex).Cells(5).Value), "#########0.00")
    ...
    Private Sub dgv_Details_EditingControlShowing(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles dgv_PavuBobinDetails.EditingControlShowing
        dgtxt_BobinDetails = CType(dgv_PavuBobinDetails.EditingControl, DataGridViewTextBoxEditingControl)
    End Sub

    Private Sub dgtxt_BobinDetails_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgtxt_BobinDetails.Enter
        dgv_ActCtrlName = dgv_PavuBobinDetails.Name
        dgv_PavuBobinDetails.EditingControl.BackColor = Color.Lime
        dgv_PavuBobinDetails.EditingControl.ForeColor = Color.Blue
    ...
    Private Sub dgtxt_BobinDetails_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_BobinDetails.KeyPress
        ...
        With dgv_PavuBobinDetails
            ...
            If Val(dgv_PavuBobinDetails.CurrentCell.ColumnIndex.ToString) = 2 Or Val(dgv_PavuBobinDetails.CurrentCell.ColumnIndex.ToString) = 3 Or Val(dgv_PavuBobinDetails.CurrentCell.ColumnIndex.ToString) = 4 Or Val(dgv_PavuBobinDetails.CurrentCell.ColumnIndex.ToString) = 5 Or Val(dgv_PavuBobinDetails.CurrentCell.ColumnIndex.ToString) = 6 Then
    ...
    Private Sub dgv_Details_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgv_PavuBobinDetails.KeyUp
        Dim n As Integer
    ...
    Private Sub dgv_Details_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_PavuBobinDetails.RowsAdded
        Dim n As Integer
    ...
    Private Sub dgv_BobinDetails_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_PavuBobinDetails.LostFocus
        dgv_PavuBobinDetails.CurrentCell.Selected = False
    End Sub
    ...
    Private Sub cbo_Ends_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_BobinEnds.KeyDown
        ...
        'End If
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_BobinEnds, Nothing, Nothing, "EndsCount_Head", "EndsCount_Name", "", "(EndsCount_IdNo = 0)")
        ...
        With dgv_PavuBobinDetails
            ...
            If (e.KeyValue = 40 And cbo_BobinEnds.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
                ...
                If .CurrentCell.RowIndex = .Rows.Count - 1 And Trim(.Rows(.CurrentCell.RowIndex).Cells.Item(1).Value) = "" Then
                    If dgv_YarnZari_Details.Rows.Count > 0 Then


                        dgv_YarnZari_Details.Focus()
                        dgv_YarnZari_Details.CurrentCell = dgv_YarnZari_Details.Rows(0).Cells(1)
                    Else
    ...
    Private Sub cbo_Ends_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BobinEnds.KeyPress
        ...
        'End If
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_BobinEnds, Nothing, "EndsCount_Head", "EndsCount_Name", " ", "(EndsCount_IdNo = 0)")
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            With dgv_PavuBobinDetails
                ...
                If Val(Led_ID) <> 0 Then
                    ...
                    EndsCnt_id = Val(Common_Procedures.EndsCount_NameToIdNo(con, cbo_BobinEnds.Text))

                    Da = New SqlClient.SqlDataAdapter("select Rate , * from vendor_PriceList_EndsCount_Details where EndsCount_idno = " & Str(Val(EndsCnt_id)) & " and Weaver_idno = " & Str(Val(Led_ID)), con)
                    Da.Fill(Dt)

                    If Dt.Rows.Count > 0 Then
                        ' dgv_PavuBobinDetails.Rows(0).Cells(5).Value = Dt.Rows(0).Item("Rate").ToString
                        .CurrentRow.Cells(5).Value = Dt.Rows(0).Item("Rate").ToString
                    End If
    ...
    End Sub
    'Private Sub cbo_BorderName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    'Private Sub cbo_BorderName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    Dim da As New SqlClient.SqlDataAdapter
    '    Dim dt As New DataTable
    ...
    'End Sub
    'Private Sub cbo_BorderName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    'Private Sub cbo_BorderName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Try
    ...
    '    End Try
    'End Sub
    'Private Sub cbo_BorderSize_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    'End Sub
    'Private Sub cbo_BorderSize_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    'Private Sub cbo_BorderSize_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    '    End If
    'End Sub
    'Private Sub cbo_BorderSize_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Try
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VechileNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VechileNo, cbo_Transport, Nothing, "Weaver_PavuBobin_YarnJari_Head", "Vechile_No", "", "")
        If e.KeyValue = 40 And cbo_VechileNo.DroppedDown = False Then
            If dgv_PavuBobinDetails.Rows.Count > 0 Then
                dgv_PavuBobinDetails.Focus()
                dgv_PavuBobinDetails.CurrentCell = dgv_PavuBobinDetails.Rows(0).Cells(1)
                dgv_PavuBobinDetails.CurrentCell.Selected = True
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VechileNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VechileNo, Nothing, "Weaver_PavuBobin_YarnJari_Head", "Vechile_No", "", "", False)

        If Asc(e.KeyChar) = 13 And cbo_VechileNo.DroppedDown = False Then
            If dgv_PavuBobinDetails.Rows.Count > 0 Then
                dgv_PavuBobinDetails.Focus()
                dgv_PavuBobinDetails.CurrentCell = dgv_PavuBobinDetails.Rows(0).Cells(1)
                dgv_PavuBobinDetails.CurrentCell.Selected = True
    ...
    Private Sub dgv_Details_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_PavuBobinDetails.GotFocus
        dgv_PavuBobinDetails.Focus()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Yarn_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Pavu_Yarn_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Yarn_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            'If Trim(cbo_Filter_EndsName.Text) <> "" Then
            '    Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Weaver_PavuBobin_YarnJari_Head IN (select z1.Weaver_PavuBobin_YarnJari_Head from Weaver_Pavu_Bobin_Details z1 where z1.Ends = '" & Trim(cbo_Filter_EndsName.Text) & "')"
            'End If

            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Weaver_PavuBobin_YarnJari_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Yarn_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Pavu_Yarn_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Pavu_Yarn_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Pavu_Yarn_Delivery_Date").ToString), "dd-MM-yyyy")
                    ...
                    dgv_Filter_Details.Rows(n).Cells(4).Value = Val(dt2.Rows(i).Item("Total_Beams").ToString)
                    ...
                    dgv_Filter_Details.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Total_Amount").ToString), "########0.00")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, dtp_Filter_ToDate, btn_Filter_Show, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = 'WEAVER' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1)", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, btn_Filter_Show, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = 'WEAVER' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1) ", "(Ledger_idno = 0)")
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry) = False Then Exit Sub
        ...
        pnl_Back.Enabled = False
        pnl_PrintRange.Visible = False
        If btn_Print_Delivery_Without_Value.Enabled And btn_Print_Delivery_Without_Value.Visible Then
            btn_Print_Delivery_Without_Value.Focus()
        End If
    ...
    Private Sub btn_Print_Delivery_Without_Value_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Print_Delivery_Without_Value.Click
    ...
    Public Sub Printing_Delivery()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Weaver_PavuBobin_YarnJari_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by for_orderby, Pavu_Yarn_Delivery_No, Pavu_Yarn_Delivery_Code", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Weaver_PavuBobin_YarnJari_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Pavu_Yarn_Delivery_No, a.Pavu_Yarn_Delivery_Code", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                cmd.CommandText = "Insert into EntryTemp( Int1, Int2, Name1                                                                                ,    Int3 ,  Name2, Weight1, Name3 ,                                                          Meters1     ,                                                    Meters2           , Currency1,   Currency2     ) " &
                                        "Select  1, a.Sl_No, b.EndscOUNT_Name + (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN ' Bobin' ELSE ' Pavu' END),  a.Beams, 'Beam', a.Meters, 'Mtr', (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN 0 ELSE a.Meters END), (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN a.Meters ELSE 0 END), a.Rate   , a.Amount from Weaver_Pavu_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  a.Pavu_Yarn_Delivery_Code =  '" & Trim(NewCode) & "' and a.Beams <> 0 and a.Meters <> 0 Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into EntryTemp( Int1, Int2, Name1                                                                                ,    Int3  ,  Name2 , Weight1, Name3   ,                                                          Meters1     ,                                                    Meters2          , Currency1,   Currency2          ) " &
                                        "Select  2, a.Sl_No, b.EndscOUNT_Name + (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN ' Bobin' ELSE ' Pavu' END),  a.Bobins, 'Bobin', a.Meters, 'Mtr' , (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN 0 ELSE a.Meters END), (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN a.Meters ELSE 0 END), a.Rate   , a.Amount  from Weaver_Pavu_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  a.Pavu_Yarn_Delivery_Code =  '" & Trim(NewCode) & "' and a.Bobins <> 0 and a.Meters <> 0 Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into EntryTemp( Int1, Int2, Name1                                                                                 , Int3,  Name2,  Weight1, Name3   ,                                                          Meters1     ,                                                    Meters2          , Currency1,   Currency2          ) " &
                                        "Select  3, a.Sl_No, b.EndscOUNT_Name  + (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN ' Bobin' ELSE ' Pavu' END),  0  ,   ''  , a.Meters, 'Mtr' , (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN 0 ELSE a.Meters END), (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN a.Meters ELSE 0 END) , a.Rate   , a.Amount from Weaver_Pavu_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  a.Pavu_Yarn_Delivery_Code =  '" & Trim(NewCode) & "' and a.Beams = 0 and a.Bobins = 0 and a.Meters <> 0 Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into EntryTemp ( Int1, Int2, Name1                                                                              , Int3,  Name2 ,  Weight1, Name3   ,                                                          Weight2     ,                                                    Weight3            , Currency1,   Currency2        ) " &
                                           "Select  4, a.Sl_No, b.COUNT_Name  + (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN ' Jari' ELSE ' Yarn' END),   0  ,   ''  , a.Weight, 'Kg'    , (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN 0 ELSE a.Weight END), (CASE WHEN b.Cotton_Polyester_Jari = 'JARI' THEN a.Weight ELSE 0 END) , a.Rate   , a.Amount   from Weaver_Yarn_Jari_Details a INNER JOIN cOUNT_Head b ON a.cOUNT_idno = b.cOUNT_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & "   and a.Pavu_Yarn_Delivery_Code = '" & Trim(NewCode) & "' and a.Weight <> 0 Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                da2 = New SqlClient.SqlDataAdapter("select a.Name1 as Particulars, a.Int3 as Noof_Beam_Bobin, a.Name2 as Beam_Bobin_Type, a.Weight1 as Quantity, a.Name3 as UOM, a.meters1 as PavuMeters, a.meters2 as BobinMeters, a.Weight2 as YarnWeight, a.Weight3 as JariWeight, a.Currency1 as Rate, a.Currency2 as Amount from EntryTemp a Where Weight1 <> 0 Order by a.Int1, a.Int2, a.Name1", con)
    ...
    Private Sub Printing_Delivery_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        If prn_Option_STS = 2 Then
            ClAr(1) = 35 : ClAr(3) = 80 : ClAr(4) = 100 : ClAr(5) = 80 : ClAr(6) = 100
            ClAr(2) = PageWidth - (LMargin + ClAr(1) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6))

        Else
            ClAr(1) = 40 : ClAr(3) = 120 : ClAr(4) = 150 : ClAr(5) = 0 : ClAr(6) = 0
            ClAr(2) = PageWidth - (LMargin + ClAr(1) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6))
                ...
                If prn_HeadIndx <= prn_HdDt.Rows.Count - 1 Then
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Beam_Bobin").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Beam_Bobin").ToString) & " " & Trim(prn_DetDt.Rows(prn_DetIndx).Item("Beam_Bobin_Type").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) - 10, CurY, 1, 0, pFont)
                            End If
                            If InStr(1, Trim(UCase(prn_DetDt.Rows(prn_DetIndx).Item("UOM").ToString)), "KG") > 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Quantity").ToString), "#########0.000") & " " & Trim(prn_DetDt.Rows(prn_DetIndx).Item("UOM").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                            Else
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Quantity").ToString), "#########0.00") & " " & Trim(prn_DetDt.Rows(prn_DetIndx).Item("UOM").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                            End If

                            If Val(ClAr(5)) > 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Rate").ToString), "#########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                            End If
                            If Val(ClAr(6)) > 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Amount").ToString), "#########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
                            End If
                            ...
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("PavuMeters").ToString) <> 0 Then
                                prn_TOTBEAMS = Val(prn_TOTBEAMS) + Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Beam_Bobin").ToString)
                                prn_TOTPAVUMTRS = Format(Val(prn_TOTPAVUMTRS) + Val(prn_DetDt.Rows(prn_DetIndx).Item("PavuMeters").ToString), "##########0.00")
                            End If

                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("BobinMeters").ToString) <> 0 Then
                                prn_TOTBOBINS = Val(prn_TOTBOBINS) + Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Beam_Bobin").ToString)
                                prn_TOTBOBMTRS = Format(Val(prn_TOTBOBMTRS) + Val(prn_DetDt.Rows(prn_DetIndx).Item("BobinMeters").ToString), "##########0.00")
                            End If

                            prn_TOTYARNWGT = Format(Val(prn_TOTYARNWGT) + Val(prn_DetDt.Rows(prn_DetIndx).Item("YarnWeight").ToString), "##########0.000")
                            prn_TOTJARIWGT = Format(Val(prn_TOTJARIWGT) + Val(prn_DetDt.Rows(prn_DetIndx).Item("JariWeight").ToString), "##########0.000")

                            vPrn_PvuTotAMT = Format(Val(vPrn_PvuTotAMT) + Val(prn_DetDt.Rows(prn_DetIndx).Item("amount").ToString), "##########0.00")
    ...
    Private Sub Printing_Delivery_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.* from EntryTemp a ", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "WEAVER DELIVERY CHALLAN", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(prn_HeadIndx).Item("Pavu_Yarn_Delivery_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(prn_HeadIndx).Item("Pavu_Yarn_Delivery_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(prn_HeadIndx).Item("Ledger_Address3").ToString & " " & prn_HdDt.Rows(prn_HeadIndx).Item("Ledger_Address4").ToString, LMargin + S1 + 10, CurY, 0, 0, pFont)
        ...
        'Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(prn_HeadIndx).Item("Vechile_No").ToString, LMargin + C1 + s2 + 30, CurY, 0, 0, pFont)
        ...
        'Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(prn_HeadIndx).Item("TransportName").ToString, LMargin + s2 + 30, CurY, 0, 0, pFont)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "BEAMS/", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
        Common_Procedures.Print_To_PrintDocument(e, "BOBINS", LMargin + ClAr(1) + ClAr(2), CurY + TxtHgt, 2, ClAr(3), pFont)
    ...
    Private Sub Printing_Delivery_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Dim p1Font As Font
        Dim W1 As Single = 0, W2 As Single = 0, W3 As Single = 0, W4 As Single = 0
        ...
        W2 = e.Graphics.MeasureString("TOTAL BOBIN :  ", pFont).Width
        W3 = e.Graphics.MeasureString("TOTAL BOBIN :  ", pFont).Width
        W4 = e.Graphics.MeasureString("TOTAL BOBIN :  ", pFont).Width
        ...
        If Val(ClAr(6)) > 0 Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Val(vPrn_PvuTotAMT), "#########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
            CurY = CurY + 5
        End If
        ...
        CurY = CurY + TxtHgt - 10
        If Val(prn_TOTPAVUMTRS) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL PAVU ", LMargin + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTBEAMS, LMargin + W1 + 30, CurY, 0, 0, pFont)
        End If

        If Val(prn_TOTBOBMTRS) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL BOBIN ", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTBOBINS, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        End If

        If Val(prn_TOTYARNWGT) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL YARN ", LMargin + C2 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + C2 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTYARNWGT, LMargin + C2 + W1 + 30, CurY, 0, 0, pFont)
        End If
        ...
        If Val(prn_TOTPAVUMTRS) <> 0 Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTPAVUMTRS, LMargin + W1 + 30, CurY, 0, 0, pFont)
        End If

        If Val(prn_TOTBOBMTRS) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL METERS", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTBOBMTRS, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        End If


        If Val(prn_TOTJARIWGT) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL JARI", LMargin + C2 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + C2 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_TOTJARIWGT, LMargin + C2 + W1 + 30, CurY, 0, 0, pFont)
        End If
    ...
    Private Sub txt_PartyBobin_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub txt_PartyBobin_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub txt_OutBobin_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.KeyValue = 40 Then
            If dgv_YarnZari_Details.Rows.Count > 0 Then
                dgv_YarnZari_Details.Focus()
                dgv_YarnZari_Details.CurrentCell = dgv_YarnZari_Details.Rows(0).Cells(1)
                dgv_YarnZari_Details.CurrentCell.Selected = True
    ...
    Private Sub txt_OutBobin_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            If dgv_YarnZari_Details.Rows.Count > 0 Then
                dgv_YarnZari_Details.Focus()
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            With dgv_YarnZari_Details
                ...
                If Val(Led_ID) <> 0 Then
                    ...
                    cntid = Val(Common_Procedures.Count_NameToIdNo(con, cbo_KuriCount.Text))

                    Da = New SqlClient.SqlDataAdapter("select Rate , * from vendor_PriceList_Count_Details where Count_idno = " & Str(Val(cntid)) & " and Weaver_idno = " & Str(Val(Led_ID)), con)
                    Da.Fill(Dt)

                    If Dt.Rows.Count > 0 Then
                        .CurrentRow.Cells(3).Value = Dt.Rows(0).Item("Rate").ToString
                    End If
    ...
    'Private Sub cbo_KuriColour_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Colour_Head", "Colour_Name", "", "(Colour_IdNo = 0)")
    'End Sub

    'Private Sub cbo_KuriColour_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Dim dep_idno As Integer = 0
    ...
    'Private Sub cbo_KuriColour_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    Dim da As New SqlClient.SqlDataAdapter
    '    Dim dt As New DataTable
    ...
    'Private Sub cbo_KuriColour_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    '        Dim f As New Color_Creation
    ...
    'Private Sub cbo_KuriColour_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    End Try
    'End Sub
    'Private Sub cbo_millName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Mill_Head", "Mill_Name", "", "(Mill_IdNo = 0)")
    'End Sub

    'Private Sub cbo_millName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Dim dep_idno As Integer = 0
    ...
    'Private Sub cbo_millName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    Dim da As New SqlClient.SqlDataAdapter
    '    Dim dt As New DataTable
    ...
    'Private Sub cbo_millName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    'Private Sub cbo_millName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    End Try
    'End Sub
    'Private Sub cbo_KuriBorderSize_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "BorderSize_Head", "BorderSize_Name", "", "(BorderSize_IdNo = 0)")
    'End Sub

    'Private Sub cbo_KuriBorderSize_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    'Private Sub cbo_KuriBorderSize_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    'Private Sub cbo_KuriBorderSize_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    '        Dim f As New BorderSize_Creation()
    ...
    'Private Sub cbo_KuriBorderSize_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub dgv_KuriDetails_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_YarnZari_Details.CellEndEdit
        Try
            With dgv_YarnZari_Details
    ...
    Private Sub dgv_KuriDetails_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_YarnZari_Details.CellEnter
        Dim Da As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim Dt2 As New DataTable
        Dim Dt3 As New DataTable
        ...
        With dgv_YarnZari_Details
            ...
            If e.ColumnIndex = 1 Then
                ...
                If cbo_KuriCount.Visible = False Or Val(cbo_KuriCount.Tag) <> e.RowIndex Then
                    ...
                    dgv_ActCtrlName = dgv_YarnZari_Details.Name
    ...
    Private Sub dgv_KuriDetails_CellLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_YarnZari_Details.CellLeave
        Try
            With dgv_YarnZari_Details
    ...
    Private Sub dgv_KuriDetails_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_YarnZari_Details.CellValueChanged

        Try
            If Not IsNothing(dgv_YarnZari_Details.CurrentCell) Then
                With dgv_YarnZari_Details
                    If .Visible Then
                        If .Rows.Count > 0 Then
                            If .CurrentCell.ColumnIndex = 2 Or .CurrentCell.ColumnIndex = 3 Then
    ...
    Private Sub dgv_KuriDetails_EditingControlShowing(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles dgv_YarnZari_Details.EditingControlShowing
        dgtxt_KuriDetails = CType(dgv_YarnZari_Details.EditingControl, DataGridViewTextBoxEditingControl)
    End Sub

    Private Sub dgtxt_KuriDetails_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgtxt_KuriDetails.Enter
        dgv_ActCtrlName = dgv_YarnZari_Details.Name
        dgv_YarnZari_Details.EditingControl.BackColor = Color.Lime
        dgv_YarnZari_Details.EditingControl.ForeColor = Color.Blue
    ...
    Private Sub dgtxt_KuriDetails_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_KuriDetails.KeyPress
        ...
        With dgv_YarnZari_Details
            ...
            If Val(dgv_YarnZari_Details.CurrentCell.ColumnIndex.ToString) = 2 Or Val(dgv_YarnZari_Details.CurrentCell.ColumnIndex.ToString) = 3 Then
    ...
    Private Sub dgv_KuriDetails_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgv_YarnZari_Details.KeyUp
        Dim n As Integer
    ...
    Private Sub dgv_KuriDetails_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_YarnZari_Details.RowsAdded
        Dim n As Integer
    ...
    Private Sub dgv_KuriDetails_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_YarnZari_Details.LostFocus
        On Error Resume Next
        dgv_YarnZari_Details.CurrentCell.Selected = False
    End Sub
    ...
    Private Sub btn_SaveAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim pwd As String = ""
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update Weaver_PavuBobin_YarnJari_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_BobinJari_Return_Code  = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Private Sub dgtxt_BobinDetails_TextChanged(sender As Object, e As EventArgs) Handles dgtxt_BobinDetails.TextChanged
        Try
            With dgv_PavuBobinDetails
                If .Rows.Count <> 0 Then
    ...
    Private Sub dgtxt_KuriDetails_TextChanged(sender As Object, e As EventArgs) Handles dgtxt_KuriDetails.TextChanged
        Try
            With dgv_YarnZari_Details
                If .Rows.Count <> 0 Then
                    .Rows(.CurrentCell.RowIndex).Cells.Item(.CurrentCell.ColumnIndex).Value = Trim(dgtxt_KuriDetails.Text)
                End If
            End With
    ...
    Private Sub btn_Print_Delivery_With_Value_Click(sender As Object, e As EventArgs) Handles btn_Print_Delivery_With_Value.Click
        prn_Option_STS = 2
