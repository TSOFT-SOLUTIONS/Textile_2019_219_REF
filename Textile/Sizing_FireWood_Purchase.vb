Public Class Sizing_FireWood_Purchase
    ...
    Private Pk_Condition As String = "FWPUR-"
    Private Pk_Condition_GST As String = "GFWPU-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from FireWood_Purchase_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Item_Name from FireWood_Purchase_Details a INNER JOIN Sizing_Item_Head b ON a.Item_IdNo = b.Item_IdNo  Where a.FireWood_Purchase_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Tare_Weight").ToString), "########0.000")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_FIREWOOD_PURCHASE, New_Entry, Me, con, "FireWood_Purchase_Head", "FireWood_Purchase_Code", NewCode, "FireWood_Purchase_Date", "(FireWood_Purchase_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "FireWood_Purchase_Head", "FireWood_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "FireWood_Purchase_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "FireWood_Purchase_Details", "FireWood_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Item_IdNo,Gross_Weight,Tare_Weight,Net_Weight,Rate,Amount", "Sl_No", "FireWood_Purchase_Code, For_OrderBy, Company_IdNo, FireWood_Purchase_No, FireWood_Purchase_Date", trans)
            ...
            cmd.CommandText = "delete from FireWood_Purchase_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from FireWood_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Purchase_No from FireWood_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND FireWood_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FireWood_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Purchase_No from FireWood_Purchase_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND FireWood_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FireWood_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Purchase_No from FireWood_Purchase_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND  FireWood_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FireWood_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "FireWood_Purchase_Head", "FireWood_Purchase_Code", "For_OrderBy", "FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red

            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as PurchaseAcName from FireWood_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.PurchaseAc_IdNo = b.Ledger_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.FireWood_Purchase_No desc", con)
            Da1.Fill(Dt1)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FireWood_Purchase_No from FireWood_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_FIREWOOD_PURCHASE, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FireWood_Purchase_No from FireWood_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "FireWood_Purchase_Head", "FireWood_Purchase_Code", "For_OrderBy", "FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "FireWood_Purchase_Head", "FireWood_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "FireWood_Purchase_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into FireWood_Purchase_Details ( FireWood_Purchase_Code ,               Company_IdNo       ,   FireWood_Purchase_No    ,                     for_OrderBy                                            ,   FireWood_Purchase_Date  ,             Sl_No     ,      Item_IdNo    ,            Gross_Weight                  ,                     Tare_Weight           ,                  Net_Weight                 ,                 Rate                 ,   Amount                ) " &
            ...
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "FireWood_Purchase_Details", "FireWood_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo,Gross_Weight,Tare_Weight,Net_Weight,Rate,Amount", "Sl_No", "FireWood_Purchase_Code, For_OrderBy, Company_IdNo, FireWood_Purchase_No, FireWood_Purchase_Date", tr)


            Dim vLed_IdNos As String = "", vVou_Amts As String = "", ErrMsg As String = ""
            vLed_IdNos = Led_ID & "|" & PurAc_ID
            vVou_Amts = Val(CSng(lbl_NetAmount.Text)) & "|" & -1 * (Val(CSng(lbl_NetAmount.Text)))
            If Common_Procedures.Voucher_Updation(con, "FireWood.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, Trim(vTotNetWgt) & " Tonn", vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Sizing_Software) = False Then
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, txt_BillNo, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*,  c.Ledger_Name as PartyName from FireWood_Purchase_Head a  INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND a.FireWood_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FireWood_Purchase_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from FireWood_Purchase_Head a INNER JOIN FireWood_Purchase_Details b ON a.FireWood_Purchase_Code = b.FireWood_Purchase_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FireWood_Purchase_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("FireWood_Purchase_No").ToString
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(TotAmt) + Val(txt_AddLess.Text) + Val(txt_Freight.Text)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_FIREWOOD_PURCHASE, New_Entry) = False Then Exit Sub

        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from FireWood_Purchase_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.FireWood_Purchase_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            'da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*  from FireWood_Purchase_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code = '" & Trim(NewCode) & "'", con)
            'da1.Fill(prn_HdDt)

            'If prn_HdDt.Rows.Count > 0 Then

            '    da2 = New SqlClient.SqlDataAdapter("select a.*, b.* from FireWood_Purchase_Details a  INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            '    da2.Fill(prn_DetDt)
            ...
            'End If
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code from FireWood_Purchase_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_HEad CSH on b.Company_State_IdNo = CSH.State_IdNo LEFT OUTER JOIN State_HEad LSH on c.Ledger_State_IdNo = LSH.State_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.* from FireWood_Purchase_Details a  INNER JOIN sizing_Item_Head b on a.Item_IdNo = b.Item_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Purchase_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                da2.Fill(prn_DetDt)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name from FireWood_Purchase_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo  where a.FireWood_Purchase_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update FireWood_Purchase_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
