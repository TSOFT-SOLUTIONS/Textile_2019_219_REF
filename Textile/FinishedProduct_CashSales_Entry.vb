Public Class FinishedProduct_CashSales_Entry
    ...
    Private Pk_Condition As String = "FPCSL-"
    Private PkCondition_GST As String = "GFPCS-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from FinishedProduct_CashSales_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_CashSales_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FinishedProduct_CashSales_No from FinishedProduct_CashSales_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_CashSales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and FinishedProduct_CashSales_Code not like '" & Trim(PkCondition_GST) & "%' Order by for_Orderby desc, FinishedProduct_CashSales_No desc", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FinishedProduct_CashSales_No from FinishedProduct_CashSales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_CashSales_Code = '" & Trim(InvCode) & "' and FinishedProduct_CashSales_Code not like '" & Trim(PkCondition_GST) & "%'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "FinishedProduct_CashSales_Head", "FinishedProduct_CashSales_Code", "For_OrderBy", "FinishedProduct_CashSales_Code not like '" & Trim(PkCondition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 And Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into FinishedProduct_CashSales_Details ( FinishedProduct_CashSales_Code ,               Company_IdNo       ,   FinishedProduct_CashSales_No    ,                     for_OrderBy                                            , FinishedProduct_CashSales_Date,              Party_Name           ,          Sl_No     ,        FinishedProduct_IdNo,       Rack_IdNo         ,                     Quantity             ,                 Meter_Qty                ,                   Meters                 ,            Unit_IdNo    ,                   Rate                   ,                     Amount                ) " & _
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.* from FinishedProduct_CashSales_Head a where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_CashSales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FinishedProduct_CashSales_No", con)
            da.Fill(dt2)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, d.Ledger_Name as Transport_Name  from FinishedProduct_CashSales_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo  LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo =a.Transport_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_CashSales_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub cbo_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Agent.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Agent, txt_PartyName, cbo_SalesAc, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT' and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_VatAc_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VatAc.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 12 and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_VatAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VatAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VatAc, txt_DiscPerc, cbo_TaxType, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 12 and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_VatAc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VatAc.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VatAc, cbo_TaxType, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 12 and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
