Public Class Advance_Bill_Adjustment
    ...
    Private vSaveAllEntry_STS As Boolean = False
    ...
    Private Sub Advance_Bill_Adjustment_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        With dgv_BillDetails
            ...
            End If
        End With
        If vSaveAllEntry_STS = True Then
    ...
    Public Sub Bills_Display(ByVal Cn1 As SqlClient.SqlConnection, ByVal Comp_IdNo As Integer, ByVal vou_bill_code As String, ByVal vou_bill_date As Date, ByVal c_ledidno As Integer, ByVal par_bill_no As String, ByVal Agt_Idno As Integer, ByVal crdr_type As String, ByVal c_amt As Single, ByVal ent_idn As String, ByRef Tot_AdvBil_Amt As Single, Optional ByRef SqlTr As SqlClient.SqlTransaction = Nothing, Optional ByVal SaveAll_STS As Boolean = False)
        ...
        Da1 = New SqlClient.SqlDataAdapter("Select Name1, Date1, Name2, sum(Currency1) as amount_1, sum(Currency2) as amount_2, Name3 from " & Trim(Common_Procedures.ReportTempSubTable) & " group by Name1, date1, Name2, Name3 order by date1, name1, name2", Cn1)
        'Da1 = New SqlClient.SqlDataAdapter("Select Name1, Date1, Name2, sum(Currency1) as amount_1, sum(Currency2) as amount_2, Name3 from " & Trim(Common_Procedures.ReportTempSubTable) & " group by Name1, date1, Name2, Name3 order by sum(Currency1) desc, date1", Cn1)
        If IsNothing(SqlTr) = False Then
