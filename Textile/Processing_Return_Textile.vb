Public Class Processing_Return_Textile
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.Ledger_Name as Transport_Name from Textile_Processing_Return_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo  Where a.ClothProcess_Return_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,b.Cloth_Name as Grey_Item_Name,c.Colour_Name,d.Lot_No,e.Process_Name from Textile_Processing_Return_Details a INNER JOIN Cloth_Head b ON b.Cloth_Idno = a.Item_Idno LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Lot_Head d ON a.Lot_IdNo = d.Lot_IdNo LEFT OUTER JOIN Process_Head e ON a.Processing_Idno = e.Process_IdNo where a.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Private Sub Processing_Return_Textile_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub processing_Return_Textile_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Hide_CurrentStock_Display()
    End Sub

    Private Sub Processing_Return_Textile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Processing_Return, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Processing_Return, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "Update Textile_Processing_Delivery_Details set Return_Meters = a.Return_Meters - (b.Return_Meters-b.ExcSht_Meters) , Receipt_Pcs = a.Receipt_Pcs - (b.Receipt_Pcs) , Receipt_Qty = a.Receipt_Qty - (b.Receipt_Qty)  from Textile_Processing_Delivery_Details a, Textile_Processing_Return_Details b Where b.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' and a.Cloth_Processing_Delivery_code = b.Cloth_Processing_Delivery_code and a.Cloth_Processing_Delivery_SlNo = b.Cloth_Processing_Delivery_SlNo"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Textile_Processing_Return_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Textile_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Textile_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Return_No", con)
        da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Textile_Processing_Return_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Return_No", con)
        da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Textile_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, ClothProcess_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RetNo.Text = Common_Procedures.get_MaxCode(con, "Textile_Processing_Return_Head", "ClothProcess_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select ClothProcess_Return_No from Textile_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Processing_Return, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Processing_Return, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Entry_Processing_Return, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RetNo.Text = Common_Procedures.get_MaxCode(con, "Textile_Processing_Return_Head", "ClothProcess_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Textile_Processing_Return_Head(ClothProcess_Return_Code, Company_IdNo, ClothProcess_Return_No, for_OrderBy, ClothProcess_Return_Date, Ledger_IdNo, Purchase_OrderNo, Transport_IdNo, Freight_Charges, DeliveryTo_Name,Total_Pcs,Total_Qty, Total_Meters,Total_ExcessShort,Lot_Status  ,  user_idNo ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RetNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RetNo.Text))) & ", @RetDate, " & Str(Val(Led_ID)) & ", '" & Trim(txt_PoNo.Text) & "', " & Str(Val(Tr_ID)) & ", " & Str(Val(txt_Frieght.Text)) & ",  '" & Trim(txt_DelTo.Text) & "'," & Str(Val(vTotPcs)) & ", " & Val(vtotqty) & ", " & Str(Val(vTotMtrs)) & ", " & Val(vExcSrt) & ", " & Val(lotSts) & " , " & Val(lbl_UserName.Text) & ")"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Textile_Processing_Return_Head set ClothProcess_Return_Date = @RetDate, Ledger_IdNo = " & Val(Led_ID) & ", Purchase_OrderNo = '" & Trim(txt_PoNo.Text) & "' , Transport_IdNo = " & Val(Tr_ID) & ", Freight_Charges = " & Val(txt_Frieght.Text) & ", DeliveryTo_Name = '" & Trim(txt_DelTo.Text) & "', Total_Pcs = " & Val(vTotPcs) & " , Total_Qty = " & Val(vtotqty) & " , Total_Meters = " & Val(vTotMtrs) & " ,Total_ExcessShort = " & Val(vExcSrt) & " ,Lot_Status =" & Val(lotSts) & " , user_idNo = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(8).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Or Val(.Rows(i).Cells(9).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Textile_Processing_Return_Details(Cloth_Processing_Return_Code, Company_IdNo, Cloth_Processing_Return_No, for_OrderBy, Cloth_Processing_Return_Date,Sl_No,Dc_Rc_No,Item_Idno,Colour_Idno,Processing_Idno,Lot_IdNo,Return_Pcs,Return_Qty,Return_Meters,ExcSht_Meters , Cloth_Processing_Delivery_code , Cloth_Processing_Delivery_Slno ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RetNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RetNo.Text))) & ", @RetDate," & Str(Val(Sno)) & ", '" & Trim(.Rows(i).Cells(1).Value) & "', " & Str(Val(itgry_id)) & ", " & Val(Col_ID) & ",  " & Val(Proc_ID) & " , " & Val(Lot_ID) & " ," & Val(.Rows(i).Cells(6).Value) & ", " & Val(.Rows(i).Cells(7).Value) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & ", " & Str(Val(.Rows(i).Cells(9).Value)) & " , '" & Trim(.Rows(i).Cells(10).Value) & "', " & Str(Val(.Rows(i).Cells(11).Value)) & " )"
                        cmd.ExecuteNonQuery()

                        Nr = 0
                        cmd.CommandText = "Update Textile_Processing_Delivery_Details set Return_Meters = Return_Meters + " & Str(Val(.Rows(i).Cells(8).Value) - Val(.Rows(i).Cells(9).Value)) & " , Receipt_Pcs = Receipt_Pcs + " & Str(Val(.Rows(i).Cells(6).Value)) & " , Receipt_Qty = Receipt_Qty + " & Str(Val(.Rows(i).Cells(7).Value)) & "   Where Cloth_Processing_Delivery_code = '" & Trim(.Rows(i).Cells(10).Value) & "' and Cloth_Processing_Delivery_SlNo = " & Str(Val(.Rows(i).Cells(11).Value)) & " and Ledger_IdNo = " & Str(Val(Led_ID))
                        Nr = cmd.ExecuteNonQuery()
                        If Nr = 0 Then
                            Throw New ApplicationException("Mismatch of Order and Party Details")
                        End If

                        cmd.CommandText = "Insert into Stock_Cloth_Processing_Details ( Reference_Code,             Company_IdNo         ,           Reference_No       ,                               for_OrderBy                             , Reference_Date,     DeliveryTo_Idno     ,                            ReceivedFrom_Idno              ,         Entry_ID     ,       Party_Bill_No  ,       Particulars      ,           Sl_No      ,           Cloth_Idno      ,   Folding  ,   Meters_Type1                    ) " &
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, txt_DelTo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'GODOWN' or ( Ledger_Type = '' AND (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ))", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_DelTo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'GODOWN' or ( Ledger_Type = '' AND (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ))", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_itemgrey_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_itemgrey.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_itemgrey, Nothing, cbo_Colour, "Cloth_Head", "Cloth_Name", "", "(Cloth_Idno = 0)")
        With dgv_Details
    ...
    Private Sub cbo_itemgrey_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_itemgrey.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_itemgrey, cbo_Colour, "Cloth_Head", "Cloth_Name", "", "(Cloth_Idno = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,z1.*,c.Processed_Item_Name,d.Process_Name from Textile_Processing_Return_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Textile_Processing_Return_Details z1 ON z1.Cloth_Processing_Return_Code = a.ClothProcess_Return_Code INNER JOIN Processed_Item_Head c ON z1.Item_IdNo = c.Processed_Item_IdNo  LEFT OUTER JOIN Process_Head d ON z1.Processing_Idno = d.Process_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.ClothProcess_Return_No", con)
            da.Fill(dt2)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Textile_Processing_Return_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub cbo_TransportName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportName, txt_DelTo, txt_PoNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Transportname_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportName, txt_PoNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.*, b.*, e.Ledger_Name as Transportname,h.Return_Pcs As Ent_Pcs, h.Return_Meters as Ent_Mtrs, h.Return_Qty As Ent_Qty, g.Cloth_Name as Fp_Item_Name , I.Lot_No , j.Process_Name , k.Colour_Name from Textile_Processing_Delivery_Head a INNER JOIN Textile_Processing_Delivery_Details b ON a.ClothProcess_Delivery_Code = b.Cloth_Processing_Delivery_Code INNER JOIN Cloth_Head g ON g.Cloth_Idno = b.Item_Idno LEFT OUTER JOIN Lot_Head i ON b.Lot_IdNo = i.Lot_IdNo LEFT OUTER JOIN Process_Head J ON J.Process_IdNo = b.Processing_Idno LEFT OUTER JOIN Colour_Head k ON b.Colour_IdNo = k.Colour_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo LEFT OUTER JOIN Textile_Processing_Return_Details h ON h.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' and b.Cloth_Processing_Delivery_Code = h.Cloth_Processing_Delivery_Code and b.Cloth_Processing_Delivery_SlNo = h.Cloth_Processing_Delivery_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.ledger_Idno = " & Str(Val(LedIdNo)) & " and (((b.Delivery_Meters - b.Receipt_Meters - b.Return_Meters) > 0 and a.Lot_Close_Status = 0) or h.Return_Meters > 0 ) order by a.ClothProcess_Delivery_Date, a.for_orderby, a.ClothProcess_Delivery_No", con)
            Dt1 = New DataTable
            nr = Da.Fill(Dt1)
