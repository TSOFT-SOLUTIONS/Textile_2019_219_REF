Imports System.IO
Public Class Yarn_Purchase_Order_GST
    ...
    Private WithEvents dgvtxt_DelvSche_Details As New DataGridViewTextBoxEditingControl      '----------delivery Schedule details
    ...
    Private Sub clear()
        ...
        pnl_Delivery_schedule.Visible = False
        ...
        cbo_YarnDetails_Description.Text = ""
        ...
        txt_AvgCount.Text = ""
        txt_CSP.Text = ""
        txt_Cv_Perc_Count.Text = ""
        txt_Cv_Perc_Strength.Text = ""
        txt_RkmUT3.Text = ""
        txt_Rkm_CV_Perc.Text = ""
        txt_Elongation_perc.Text = ""
        txt_Elongation_Cv_perc.Text = ""
        txt_Hairiness_Index.Text = ""
        txt_imperfection.Text = ""
        txt_ConeWt.Text = ""
        txt_BagWt.Text = ""
        txt_No_Per_Bag.Text = ""
        txt_Noof_Bag.Text = ""
        ...
        Dgv_Delv_Schedule_details.Rows.Clear()
        ...
        cbo_ClothSales_OrderCode_forSelection.Enabled = True
    ...
    Private Sub Grid_Cell_DeSelect()
        ...
        If Not IsNothing(Dgv_Delv_Schedule_details.CurrentCell) Then Dgv_Delv_Schedule_details.CurrentCell.Selected = False
    End Sub
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Yarn_Purchase_Order_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "' and Entry_VAT_GST_Type = 'GST'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                dtp_Date.Text = dt1.Rows(0).Item("Yarn_Purchase_Order_Date")
                ...
                cbo_YarnDetails_Description.Text = Trim(dt1.Rows(0).Item("Yarn_Description").ToString)
                ...
                txt_Delivery_Terms.Text = Trim(dt1.Rows(0).Item("Delivery_Terms").ToString)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            End If
                            .Rows(n).Cells(dgvCol_Details.Detail_slno).Value = Val(dt2.Rows(i).Item("Yarn_Purchase_Order_Details_Slno").ToString)
                            ...
                            If Val(.Rows(n).Cells(dgvCol_Details.purchase_weight).Value) <> 0 Then
                                For j = 0 To .ColumnCount - 1
                                    If j <> dgvCol_Details.Bag And j <> dgvCol_Details.weight And j <> dgvCol_Details.cone_per_bag And j <> dgvCol_Details.Cancel_Order Then
                ...
                With dgv_Details_Total
                    If .RowCount = 0 Then .Rows.Add()
                    .Rows(0).Cells(dgvCol_Details.Bag).Value = Val(dt1.Rows(0).Item("Total_Bags").ToString)
                    .Rows(0).Cells(dgvCol_Details.cones).Value = Val(dt1.Rows(0).Item("Total_Cones").ToString)
                    .Rows(0).Cells(dgvCol_Details.weight).Value = Format(Val(dt1.Rows(0).Item("Total_Weight").ToString), "########0.00")
                    .Rows(0).Cells(dgvCol_Details.amount).Value = Format(Val(dt1.Rows(0).Item("Total_Amount").ToString), "########0.00")
                End With

                da4 = New SqlClient.SqlDataAdapter("Select a.* from Yarn_Purchase_Order_GST_Tax_Details a Where a.Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
                ...
                '-----------------------START   DELIVERY_SCHEDULE 

                txt_AvgCount.Text = dt1.Rows(0).Item("Yrn_Spci_Average_Count").ToString
                txt_CSP.Text = dt1.Rows(0).Item("Yrn_Spci_Csp").ToString
                txt_Cv_Perc_Count.Text = dt1.Rows(0).Item("Yrn_Spci_Cv_Perc_Count").ToString
                txt_Cv_Perc_Strength.Text = dt1.Rows(0).Item("Yrn_Spci_Cv_Perc_Strength").ToString
                txt_RkmUT3.Text = dt1.Rows(0).Item("Yrn_Spci_Rkm_UT3").ToString
                txt_Rkm_CV_Perc.Text = dt1.Rows(0).Item("Yrn_Spci_Rkm_Cv_Perc").ToString
                txt_Elongation_perc.Text = dt1.Rows(0).Item("Yrn_Spci_Elongation_perc").ToString
                txt_Elongation_Cv_perc.Text = dt1.Rows(0).Item("Yrn_Spci_Elongation_Cv_perc").ToString
                txt_Hairiness_Index.Text = dt1.Rows(0).Item("Yrn_Spci_Hairiness").ToString
                txt_imperfection.Text = dt1.Rows(0).Item("Yrn_Spci_Imperfection_Km").ToString
                txt_ConeWt.Text = dt1.Rows(0).Item("Yrn_Spci_Cone_Weight").ToString
                txt_BagWt.Text = dt1.Rows(0).Item("Yrn_Spci_Bag_Weight").ToString
                txt_No_Per_Bag.Text = dt1.Rows(0).Item("Yrn_Spci_Noof_Cone_per_Bag").ToString
                txt_Noof_Bag.Text = dt1.Rows(0).Item("Yrn_Spci_No_of_Bag").ToString


                da5 = New SqlClient.SqlDataAdapter("select a.* from  Yarn_PO_Delivery_Schedule_details a  where Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "' ", con)
                dt5 = New DataTable
                da5.Fill(dt5)


                With Dgv_Delv_Schedule_details
                    ...
                    If dt5.Rows.Count > 0 Then
                        For i = 0 To dt5.Rows.Count - 1
                            ...
                            .Rows(n).Cells(0).Value = dt5.Rows(i).Item("Sl_No").ToString
                            .Rows(n).Cells(1).Value = dt5.Rows(i).Item("DeliveryDate_Text").ToString
                            .Rows(n).Cells(2).Value = dt5.Rows(i).Item("Delivery_Month").ToString
                            .Rows(n).Cells(3).Value = Format(Val(dt5.Rows(i).Item("Weight").ToString), "#########0.000")

                            .Rows(n).Cells(4).Value = dt5.Rows(i).Item("Yarn_Purchase_Order_Code").ToString
            ...
            If LockSTS = True Then
                ...
                cbo_ClothSales_OrderCode_forSelection.Enabled = False
                cbo_ClothSales_OrderCode_forSelection.BackColor = Color.LightGray
            End If
    ...
    Private Sub Yarn_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        btn_Delivery_Schedule.Visible = False
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1464" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
            btn_Delivery_Schedule.Visible = True
        Else
            btn_Delivery_Schedule.Visible = False
            btn_Delivery_Schedule.Enabled = False
        End If
        ...
        If Common_Procedures.settings.CustomerCode = "1186" Then
            lbl_PaymenTerms.Text = "Payment Terms"
        Else
            lbl_PaymenTerms.Text = "Delivery Days"
        End If
        ...
        pnl_Delivery_schedule.Visible = False
        pnl_Delivery_schedule.Location = New Point(230, 9)
        pnl_Delivery_schedule.BringToFront()
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1464" Then
            lbl_Elongation.Text = "Tm"
            lbl_Elongationcv.Text = "Tpi"
            lbl_RkmCv.Text = "U%"
        End If
        ...
        AddHandler cbo_YarnDetails_Description.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_YarnDetails_Description.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_AvgCount.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_CSP.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Cv_Perc_Count.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Cv_Perc_Strength.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_RkmUT3.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Rkm_CV_Perc.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Elongation_perc.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Elongation_Cv_perc.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Hairiness_Index.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_imperfection.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_ConeWt.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_BagWt.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_No_Per_Bag.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Noof_Bag.GotFocus, AddressOf ControlGotFocus

        AddHandler txt_AvgCount.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_CSP.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Cv_Perc_Count.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Cv_Perc_Strength.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_RkmUT3.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Rkm_CV_Perc.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Elongation_perc.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Elongation_Cv_perc.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Hairiness_Index.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_imperfection.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_ConeWt.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_BagWt.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_No_Per_Bag.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Noof_Bag.LostFocus, AddressOf ControlLostFocus
 ...
 AddHandler cbo_ClothSales_OrderCode_forSelection.GotFocus, AddressOf ControlGotFocus
    ...
    Private Sub Yarn_purchase_Order_GST_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        ...
        Try
            ...
            If Asc(e.KeyChar) = 27 Then
                ...
                ElseIf pnl_Selection.Visible = True Then
                    ...
                    Exit Sub
                ElseIf pnl_Delivery_schedule.Visible = True Then
                    btn_DelSchedule_Close_Click(sender, e)
                    Exit Sub
                Else
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If ActiveControl.Name = dgv_Details.Name Or ActiveControl.Name = Dgv_Delv_Schedule_details.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then
            ...
            ElseIf ActiveControl.Name = Dgv_Delv_Schedule_details.Name Then
                dgv1 = Dgv_Delv_Schedule_details


            ElseIf dgv_ActiveCtrl_Name = dgv_Details.Name Then
                dgv1 = dgv_Details

            ElseIf dgv_ActiveCtrl_Name = Dgv_Delv_Schedule_details.Name Then
                dgv1 = Dgv_Delv_Schedule_details
            ...
            With dgv1
                ...
                If dgv1.Name = Dgv_Delv_Schedule_details.Name Then
                    ...
                    ElseIf keyData = Keys.Up Then
                        If .CurrentCell.ColumnIndex <= 1 Then
                            If .CurrentCell.RowIndex = 0 Then
                                ...
                                If Dgv_Delv_Schedule_details.Visible = True Then
                                    txt_Noof_Bag.Focus()
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Purchase_Order_Entry, New_Entry, Me, con, "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", NewCode, "Yarn_Purchase_Order_Date", "(Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            ...
            If Val(Common_Procedures.get_FieldValue(con, "Yarn_Purchase_Order_Head", "Verified_Status", "(Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Yarn_Purchase_Order_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Yarn_Purchase_Order_Details", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Yarn_Purchase_Order_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_Order_No, Yarn_Purchase_Order_Date, Ledger_Idno", trans)


            cmd.CommandText = "delete from Yarn_Purchase_Order_GST_Tax_Details  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_Order_No from Yarn_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Yarn_Purchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_Order_No from Yarn_Purchase_Order_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Yarn_Purchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_Order_No from Yarn_Purchase_Order_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Yarn_Purchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_Order_No from Yarn_Purchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Yarn_Purchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                If Dt1.Rows(0).Item("DeliveryTo_Idno").ToString <> "" Then cbo_Delvat.Text = Common_Procedures.Ledger_IdNoToName(con, Val(Dt1.Rows(0).Item("DeliveryTo_Idno").ToString))
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Yarn_Purchase_Order_Entry, New_Entry, Me, con, "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", NewCode, "Yarn_Purchase_Order_Date", "(Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Yarn_Purchase_Order_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            If Not (Val(Common_Procedures.User.IdNo) = 1 Or Common_Procedures.User.Show_Verified_Status = 1) Then
                ...
                If Val(Common_Procedures.get_FieldValue(con, "Yarn_Purchase_Order_Head", "Verified_Status", "(Yarn_Purchase_Order_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Then
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        If IsDate(.Rows(i).Cells(1).Value) <> True Then
                            If MessageBox.Show("Invalid Date in Delivery Schedule  Details ", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error) = DialogResult.OK Then
                                pnl_Delivery_schedule.Visible = True
                                pnl_Delivery_schedule.Enabled = True
                                pnl_Back.Enabled = False
                                If txt_AvgCount.Enabled And txt_AvgCount.Visible Then txt_AvgCount.Focus()
                                Exit Sub
                            End If
                        End If
                    End If
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Yarn_Purchase_Order_Head (  Entry_VAT_GST_Type , Yarn_Purchase_Order_Code ,               Company_IdNo       ,     Yarn_Purchase_Order_No     ,                               for_OrderBy                               , Yarn_Purchase_Order_Date ,        Ledger_IdNo      ,             Agent_IdNo    ,        DeliveryTo_Idno  ,        Agent_Commission_Rate   ,         Agent_Commission_Type    ,   Agent_Commission_Commission   ,       Total_Bags     ,           Total_Cones     ,          Total_Weight      , Total_Cancelled_Weight            ,               Total_Amount             ,             Discount_Percentage     ,              Discount_Amount          ,                AddLess_BeforeTax_Amount      ,                 Assessable_Value           ,           TaxAc_IdNo      ,               Tax_Type           ,                  Freight_Amount     ,               AddLessAfterTax_Text            ,                   AddLess_Amount            ,               RoundOff_Amount      ,                  Net_Amount               ,         Transport_IdNo    ,              Note            ,              User_idNo          ,               Vehicle_No           ,          Total_CGST_Amount        ,              Total_SGST_Amount    ,          Total_IGST_Amount        ,               Delivery_Address           ,               Order_No           ,               Own_Order_Code       ,            Due_Days          , Delivery_Date ,            Payment_Terms          ,  Verified_Status  ,Attend,Gr_Date,Taxtype,                         Transportations,                    Through_Name,                           Party_OrderNo             ,         Yrn_Spci_Average_Count  ,            Yrn_Spci_Csp        ,          Yrn_Spci_Cv_Perc_Count         ,             Yrn_Spci_Cv_Perc_Strength      ,           Yrn_Spci_Rkm_UT3     ,          Yrn_Spci_Rkm_Cv_Perc        ,     Yrn_Spci_Elongation_perc            ,         Yrn_Spci_Elongation_Cv_perc         ,           Yrn_Spci_Hairiness            ,         Yrn_Spci_Imperfection_Km      ,      Yrn_Spci_Cone_Weight       ,    Yrn_Spci_Bag_Weight         ,    Yrn_Spci_Noof_Cone_per_Bag      ,       Yrn_Spci_No_of_Bag          ,                Yarn_Description                    ,       Order_Close_Status  , ClothSales_OrderCode_forSelection                          , YarnPurchase_OrderCode_forSelection  ,      Delivery_Terms             ,            created_useridno           ,       created_DateTime,          created_DateTime_Text    , Last_modified_useridno, Last_modified_DateTime, Last_modified_DateTime_Text    )  " &
                "Values                                                 (           'GST'     ,  '" & Trim(NewCode) & "' , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "' , " & Str(Val(vOrdByNo)) & " ,        @PurchaseDate     , " & Str(Val(Led_ID)) & ", " & Str(Val(Agt_Idno)) & ", " & Str(Val(Del_ID)) & ", " & Val(txt_CommRate.Text) & " , '" & Trim(cbo_CommType.Text) & "', " & Val(lbl_CommAmount.Text) & ", " & Val(vTotBgs) & " , " & Str(Val(vTotCns)) & " , " & Str(Val(vTotWght)) & " , " & Str(Val(vTotCancel_Wght)) & " , " & Str(Val(lbl_GrossAmount.Text)) & " , " & Str(Val(txt_DiscPerc.Text)) & " , " & Str(Val(lbl_DiscAmount.Text)) & " , " & Str(Val(txt_AddLess_BeforeTax.Text)) & " , " & Str(Val(txt_AssessableValue.Text)) & " , " & Str(Val(TxAc_ID)) & " , '" & Trim(cbo_TaxType.Text) & "' ,  " & Str(Val(txt_Freight.Text)) & " , '" & Trim(txt_AddLessAfterTax_Text.Text) & "' , " & Str(Val(txt_AddLess_AfterTax.Text)) & " , " & Str(Val(lbl_RoundOff.Text)) & ", " & Str(Val(CSng(lbl_NetAmount.Text))) & ", " & Str(Val(Trans_ID)) & ",'" & Trim(txt_Note.Text) & "' ,  " & Val(lbl_UserName.Text) & " , '" & Trim(cbo_VehicleNo.Text) & "' , " & Val(lbl_CGST_Amount.Text) & " , " & Val(lbl_SGST_Amount.Text) & " , " & Val(lbl_IGST_Amount.Text) & " , '" & Trim(Cbo_DeliveryAddress.Text) & "' , '" & Trim(lbl_OrderNo.Text) & "' , '" & Trim(lbl_OrderCode.Text) & "' ," & Val(txt_DueDays.Text) & " , @DeliveryDate ,'" & Trim(txt_PaymenTerms.Text) & "' ," & Val(Verified_STS) & ",'" & Trim(txt_Attend.Text) & "',@Grdate,'" & Trim(cbo_tax_type.Text) & "','" & Trim(cbo_transportation.Text) & "','" & Trim(cbo_Through.Text) & "','" & Trim(txt_Sales_Order_No.Text) & "' , '" & Trim(txt_AvgCount.Text) & "' , '" & Trim(txt_CSP.Text) & "' ,  '" & Trim(txt_Cv_Perc_Count.Text) & "'  , '" & Trim(txt_Cv_Perc_Strength.Text) & "' ,'" & Trim(txt_RkmUT3.Text) & "' ,  '" & Trim(txt_Rkm_CV_Perc.Text) & "' ,'" & Trim(txt_Elongation_perc.Text) & "' ,'" & Trim(txt_Elongation_Cv_perc.Text) & "' ,'" & Trim(txt_Hairiness_Index.Text) & "' , '" & Trim(txt_imperfection.Text) & "' ,  '" & Trim(txt_ConeWt.Text) & "' ,'" & Trim(txt_BagWt.Text) & "' ,'" & Trim(txt_No_Per_Bag.Text) & "' ,'" & Trim(txt_Noof_Bag.Text) & "'  ,  '" & Trim(cbo_YarnDetails_Description.Text) & "'  ,   " & Val(vCLOSE_STS) & " ,'" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "'   , '" & Trim(vSELC_LOTCODE) & "'  , '" & Trim(txt_Delivery_Terms.Text) & "', " & Str(Val(Common_Procedures.User.IdNo)) & ",  @createddatetime ,  '" & Trim(vCREATED_DTTM_TXT) & "',              0        ,     NUll              ,          ''  ) "
                cmd.ExecuteNonQuery()
            ...
            Else
                ...
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Yarn_Purchase_Order_Code, Company_IdNo, for_OrderBy", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Yarn_Purchase_Order_Details", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Yarn_Purchase_Order_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_Order_No, Yarn_Purchase_Order_Date, Ledger_Idno", tr)


                cmd.CommandText = "Update Yarn_Purchase_Order_Head Set Entry_VAT_GST_Type = 'GST' , Yarn_Purchase_Order_Date = @PurchaseDate, Delivery_Date = @DeliveryDate , Ledger_IdNo = " & Str(Val(Led_ID)) & ", Agent_IdNo = " & Str(Val(Agt_Idno)) & ", DeliveryTo_Idno = " & Str(Val(Del_ID)) & ", Agent_Commission_Rate = " & Val(txt_CommRate.Text) & ",Vehicle_No = '" & Trim(cbo_VehicleNo.Text) & "' ,  Agent_Commission_Type = '" & Trim(cbo_CommType.Text) & "', Agent_Commission_Commission =" & Val(lbl_CommAmount.Text) & ", Total_Bags = " & Val(vTotBgs) & ",Total_Cones  = " & Str(Val(vTotCns)) & ", Total_Weight = " & Str(Val(vTotWght)) & " , Total_Cancelled_Weight = " & Str(Val(vTotCancel_Wght)) & " , Total_Amount = " & Str(Val(lbl_GrossAmount.Text)) & ", Discount_Percentage = " & Str(Val(txt_DiscPerc.Text)) & ", Discount_Amount = " & Str(Val(lbl_DiscAmount.Text)) & ", AddLess_BeforeTax_Amount = " & Str(Val(txt_AddLess_BeforeTax.Text)) & ", Assessable_Value = " & Str(Val(txt_AssessableValue.Text)) & ", Tax_Type = '" & Trim(cbo_TaxType.Text) & "',Freight_Amount = " & Str(Val(txt_Freight.Text)) & ", AddLessAfterTax_Text = '" & Trim(txt_AddLessAfterTax_Text.Text) & "', AddLess_Amount = " & Str(Val(txt_AddLess_AfterTax.Text)) & ", RoundOff_Amount = " & Str(Val(lbl_RoundOff.Text)) & ", Net_Amount = " & Str(Val(CSng(lbl_NetAmount.Text))) & ", Transport_IdNo  = " & Str(Val(Trans_ID)) & ", Note = '" & Trim(txt_Note.Text) & "' ,   User_IdNo = " & Val(lbl_UserName.Text) & " ,Total_CGST_Amount = " & Val(lbl_CGST_Amount.Text) & " ,Total_SGST_Amount = " & Val(lbl_SGST_Amount.Text) & ",Total_IGST_Amount =" & Val(lbl_IGST_Amount.Text) & ",Delivery_Address = '" & Trim(Cbo_DeliveryAddress.Text) & "',Order_No = '" & Trim(lbl_OrderNo.Text) & "',Own_Order_Code = '" & Trim(lbl_OrderCode.Text) & "' , Due_Days = " & Val(txt_DueDays.Text) & " , Payment_Terms = '" & Trim(txt_PaymenTerms.Text) & "',Verified_Status= " & Val(Verified_STS) & " ,Attend='" & Trim(txt_Attend.Text) & "' ,Gr_Date=@Grdate,TaxType='" & Trim(cbo_tax_type.Text) & "',transportations='" & Trim(cbo_transportation.Text) & "',Through_Name='" & Trim(cbo_Through.Text) & "' ,Party_OrderNo='" & Trim(txt_Sales_Order_No.Text) & "', Yrn_Spci_Average_Count ='" & Trim(txt_AvgCount.Text) & "' , Yrn_Spci_Csp = '" & Trim(txt_CSP.Text) & "' ,Yrn_Spci_Cv_Perc_Count=  '" & Trim(txt_Cv_Perc_Count.Text) & "'  ,Yrn_Spci_Cv_Perc_Strength ='" & Trim(txt_Cv_Perc_Strength.Text) & "' ,Yrn_Spci_Rkm_UT3  ='" & Trim(txt_RkmUT3.Text) & "' ,Yrn_Spci_Rkm_Cv_Perc =  '" & Trim(txt_Rkm_CV_Perc.Text) & "' ,Yrn_Spci_Elongation_perc  ='" & Trim(txt_Elongation_perc.Text) & "' ,Yrn_Spci_Elongation_Cv_perc='" & Trim(txt_Elongation_Cv_perc.Text) & "' ,Yrn_Spci_Hairiness='" & Trim(txt_Hairiness_Index.Text) & "' ,Yrn_Spci_Imperfection_Km= '" & Trim(txt_imperfection.Text) & "'  , Yrn_Spci_Cone_Weight='" & Trim(txt_ConeWt.Text) & "' ,    Yrn_Spci_Bag_Weight ='" & Trim(txt_BagWt.Text) & "',Yrn_Spci_Noof_Cone_per_Bag='" & Trim(txt_No_Per_Bag.Text) & "',Yrn_Spci_No_of_Bag='" & Trim(txt_Noof_Bag.Text) & "' , Yarn_Description = '" & Trim(cbo_YarnDetails_Description.Text) & "' , Order_Close_Status = " & Val(vCLOSE_STS) & " ,ClothSales_OrderCode_forSelection = '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "'   , YarnPurchase_OrderCode_forSelection = '" & Trim(vSELC_LOTCODE) & "' , Delivery_Terms = '" & Trim(txt_Delivery_Terms.Text) & "' ,Last_modified_useridno = " & Str(Val(Common_Procedures.User.IdNo)) & ", Last_modified_DateTime = @modifieddatetime, Last_modified_DateTime_Text = '" & Trim(vMODIFIED_DTTM_TXT) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()


            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Yarn_Purchase_Order_Head", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Yarn_Purchase_Order_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Yarn_Purchase_Order_Details", "Yarn_Purchase_Order_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage,HSN_Code,Ex_Mill,Cancelled_Weight", "Sl_No", "Yarn_Purchase_Order_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_Order_No, Yarn_Purchase_Order_Date, Ledger_Idno", tr)
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Yarn_Purchase_Order_GST_Tax_Details   ( Yarn_Purchase_Order_Code  ,               Company_IdNo       ,      Yarn_Purchase_Order_No                ,                               for_OrderBy                                  , Yarn_Purchase_Order_Date    ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " &
            ...
            cmd.CommandText = "delete from Yarn_PO_Delivery_Schedule_details where Yarn_Purchase_Order_Code='" & Trim(NewCode) & "' "
            cmd.ExecuteNonQuery()
            ...
            With Dgv_Delv_Schedule_details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Trim(.Rows(i).Cells(3).Value) <> "" Then
                        ...
                        cmd.Parameters.Clear()
                        cmd.Parameters.AddWithValue("@DelvDate", Convert.ToDateTime(.Rows(i).Cells(1).Value))

                        cmd.CommandText = "insert into Yarn_PO_Delivery_Schedule_details (   Yarn_Purchase_Order_Code   ,        Sl_No          ,               Delivery_DateTime                                             ,          DeliveryDate_Text                 ,                  Delivery_Month ,                     Weight              )" &
                                                                             " values    (    '" & Trim(NewCode) & "'   ," & Str(Val(Sno)) & "  ,  " & IIf(IsDate(.Rows(i).Cells(1).Value) = True, "@DelvDate", "Null") & "   ,  '" & Trim(.Rows(i).Cells(1).Value) & "'  ,  '" & Trim(.Rows(i).Cells(2).Value) & "' ," & Format(Val(.Rows(i).Cells(3).Value)) & " )"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, txt_AddLess_AfterTax, txt_Delivery_Terms, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
        Get_vehicle_from_Transport()
    End Sub


    Private Sub cbo_Transport_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Transport.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Transport, txt_Delivery_Terms, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
        Get_vehicle_from_Transport()
    End Sub
    ...
    Private Sub cbo_Delvat_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Delvat.KeyDown
        ...
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Delvat, txt_Sales_Order_No, txt_Attend, "Ledger_AlaisHead", "Ledger_DisplayName", "( Ledger_Type = 'SIZING' )", "(Ledger_IdNo = 0)")
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Delvat, txt_Sales_Order_No, txt_Attend, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        End If
    ...
    Private Sub cbo_Delvat_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Delvat.KeyPress
        ...
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Delvat, txt_Attend, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'SIZING')", "(Ledger_IdNo = 0)")
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Delvat, txt_Attend, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        End If
    End Sub
            ...
            With dgv_Details
                If .Visible Then
                    ...
                    If .Rows.Count > 0 Then
                        ...
                        If .CurrentCell.ColumnIndex = dgvCol_Details.Bag Or .CurrentCell.ColumnIndex = dgvCol_Details.cones Or .CurrentCell.ColumnIndex = dgvCol_Details.weight Or .CurrentCell.ColumnIndex = dgvCol_Details.rate Or .CurrentCell.ColumnIndex = dgvCol_Details.amount Or .CurrentCell.ColumnIndex = dgvCol_Details.cone_per_bag Or .CurrentCell.ColumnIndex = dgvCol_Details.Wt_per_bag Then
    ...
    Private Sub txt_Note_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Note.KeyDown
        If e.KeyValue = 38 Then
            ...
            If cbo_VehicleNo.Visible And cbo_VehicleNo.Enabled = True Then
                cbo_VehicleNo.Focus()
            Else
    ...
    Private Sub Total_Calculation()
        Dim Sno As Integer
        Dim TotBgs As String
        Dim TotCns As String
        Dim TotWgt As String
        Dim TotAmt As String
        Dim Tot_Cnsl_Odr As String
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(i).Cells(dgvCol_Details.Count).Value) <> "" And (Val(.Rows(i).Cells(dgvCol_Details.Bag).Value) <> 0 Or Val(.Rows(i).Cells(dgvCol_Details.weight).Value) <> 0) Then
                    ...
                    TotBgs = Val(TotBgs) + Val(.Rows(i).Cells(dgvCol_Details.Bag).Value)
                    TotCns = Val(TotCns) + Val(.Rows(i).Cells(dgvCol_Details.cones).Value)
                    TotWgt = Format(Val(TotWgt) + Val(.Rows(i).Cells(dgvCol_Details.weight).Value), "########0.000")
                    TotAmt = Format(Val(TotAmt) + Val(.Rows(i).Cells(dgvCol_Details.amount).Value), "########0.00")
                    Tot_Cnsl_Odr = Format(Val(Tot_Cnsl_Odr) + Val(.Rows(i).Cells(dgvCol_Details.Cancel_Order).Value), "########0.000")
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(txt_AssessableValue.Text) + Val(txt_AddLess_AfterTax.Text) + Val(GST_Amt)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_Delv_DetDt.Rows.Count > 0 Then
                    ...
                    For J = 0 To prn_Delv_DetDt.Rows.Count - 1
                        ...
                        'If Trim(Common_Procedures.settings.CustomerCode) = "1464" Then '----- MANI OMEGA FAB
                        '    VCont = Trim(VCont) & IIf(Trim(VCont) <> "", ",", "") & Microsoft.VisualBasic.Left(Trim(prn_Delv_DetDt.Rows(J).Item("Delivery_Month").ToString), 3) & "-" & Trim(prn_Delv_DetDt.Rows(J).Item("Weight").ToString) & " Kgs"
                        'Else
                        VCont = Trim(VCont) & IIf(Trim(VCont) <> "", ",", "") & Trim(prn_Delv_DetDt.Rows(J).Item("DeliveryDate_Text").ToString) & "-" & Trim(prn_Delv_DetDt.Rows(J).Item("Weight").ToString) & " Kgs"
                        ' End If
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1037" Then '-----PRAKASH TEXTILES
            Printing_FormatGST_1037(e)
            'Printing_Format2GST(e)
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1234" Then '-----ARULJOTHI EXPORTS PVT LTD
            Printing_Format2(e)
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1334" Then '-----SIVASELVI TEXTILES(VANJIPALAYAM)
        ...
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1464" Then '----- MANI OMEGA FAB
            Printing_FormatGST_1464(e)
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1267" Then '----- BRT TEXTILE
            Printing_FormatGST_1267(e)
        Else
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        ...
        If (e.KeyValue = 40 And cbo_TaxType.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            ...
            If cbo_YarnDetails_Description.Enabled And cbo_YarnDetails_Description.Visible = True Then
                cbo_YarnDetails_Description.Focus()
            Else
    ...
    Private Sub cbo_Grid_ItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_CountName.KeyDown
        ...
        With dgv_Details
            ...
            If (e.KeyValue = 38 And cbo_Grid_CountName.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                ...
                ElseIf cbo_YarnDetails_Description.Enabled And cbo_YarnDetails_Description.Visible = True Then
                    cbo_YarnDetails_Description.Focus()
                    Else
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, txt_Delivery_Terms, txt_Note, "Yarn_Sales_Head", "Vehicle_No", "", "")
    ...
    Private Sub GST_Calculation()
        ...
        Dim CGST_Per As String = 0, SGST_Per As String = 0, IGST_Per As String = 0, GST_Per As String = 0
        Dim HSN_Code As String = ""
        Dim vTaxable_Amount As String = 0
                ...
                If dgv_Details.Rows.Count > 0 Then
                    ...
                    For RowIndx = 0 To dgv_Details.Rows.Count - 1
                        ...
                        If Trim(.Rows(RowIndx).Cells(dgvCol_Details.Count).Value) <> "" Or Val(.Rows(RowIndx).Cells(dgvCol_Details.Bag).Value) = 0 Or Val(.Rows(RowIndx).Cells(dgvCol_Details.weight).Value) = 0 Or Val(.Rows(RowIndx).Cells(dgvCol_Details.amount).Value) = 0 Then
                            ...
                            .Rows(RowIndx).Cells(dgvCol_Details.Disc_AMt).Value = Format(Val(.Rows(RowIndx).Cells(dgvCol_Details.amount).Value) * (Val(.Rows(RowIndx).Cells(dgvCol_Details.Disc_perc).Value) / 100), "########0.00")

                            '-- Taxable value = amount -  cash disc
                            vTaxable_Amount = Format(Val(.Rows(RowIndx).Cells(dgvCol_Details.amount).Value) - Val(.Rows(RowIndx).Cells(dgvCol_Details.Disc_AMt).Value), "##########0.00")


                            .Rows(RowIndx).Cells(dgvCol_Details.Taxable_value).Value = Format(Val(vTaxable_Amount), "##########0.00")
    ...
    End Sub
    Private Sub Get_GST_Percentage_From_ItemGroup(ByVal CountName As String, ByRef HSN_Code As String, ByRef GST_PerCent As String)
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt As New DataTable
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If IsDBNull(dt.Rows(0).Item("Item_GST_Percentage").ToString) = False Then
                    ...
                    GST_PerCent = Format(Val(dt.Rows(0).Item("Item_GST_Percentage").ToString), "##########0.00")
    ...
    Private Sub Printing_FormatGST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Dim LnAr(15) As Single, ClArr(15) As Single
        Dim ItmNm1 As String, ItmNm2 As String
        Dim CntName1 As String, CntName2 As String, CntName3 As String, CntName4 As String
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        CntName3 = ""
                        If Len(CntName2) > 10 Then
                            For I = 20 To 1 Step -1
                                If Mid$(Trim(CntName2), I, 1) = " " Or Mid$(Trim(CntName2), I, 1) = "," _
                                    Or Mid$(Trim(CntName2), I, 1) = "." Or Mid$(Trim(CntName2), I, 1) = "-" _
                                    Or Mid$(Trim(CntName2), I, 1) = "/" Or Mid$(Trim(CntName2), I, 1) = "_" _
                                    Or Mid$(Trim(CntName2), I, 1) = "(" Or Mid$(Trim(CntName2), I, 1) = ")" _
                                    Or Mid$(Trim(CntName2), I, 1) = "\" Or Mid$(Trim(CntName2), I, 1) = "[" _
                                    Or Mid$(Trim(CntName2), I, 1) = "]" Or Mid$(Trim(CntName2), I, 1) = "{" Or Mid$(Trim(CntName2), I, 1) = "}" Then Exit For
                            Next I
                            If I = 0 Then I = 20

                            CntName3 = Microsoft.VisualBasic.Right(Trim(CntName2), Len(CntName2) - I)
                            CntName2 = Microsoft.VisualBasic.Left(Trim(CntName2), I - 1)
                        End If



                        CntName4 = ""
                        If Len(CntName3) > 10 Then
                            For I = 20 To 1 Step -1
                                If Mid$(Trim(CntName3), I, 1) = " " Or Mid$(Trim(CntName3), I, 1) = "," _
                                    Or Mid$(Trim(CntName3), I, 1) = "." Or Mid$(Trim(CntName3), I, 1) = "-" _
                                    Or Mid$(Trim(CntName3), I, 1) = "/" Or Mid$(Trim(CntName3), I, 1) = "_" _
                                    Or Mid$(Trim(CntName3), I, 1) = "(" Or Mid$(Trim(CntName3), I, 1) = ")" _
                                    Or Mid$(Trim(CntName3), I, 1) = "\" Or Mid$(Trim(CntName3), I, 1) = "[" _
                                    Or Mid$(Trim(CntName3), I, 1) = "]" Or Mid$(Trim(CntName3), I, 1) = "{" Or Mid$(Trim(CntName3), I, 1) = "}" Then Exit For
                            Next I
                            If I = 0 Then I = 20

                            CntName4 = Microsoft.VisualBasic.Right(Trim(CntName3), Len(CntName3) - I)
                            CntName3 = Microsoft.VisualBasic.Left(Trim(CntName3), I - 1)
                        End If
                        ...
                        Else
                            If Trim(CntName2) <> "" Or Trim(CntName3) <> "" Or Trim(CntName4) <> "" Then
                                CurY = CurY + TxtHgt - 5
                                Common_Procedures.Print_To_PrintDocument(e, Trim(CntName2), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                                NoofDets = NoofDets + 1
                                CurY = CurY + TxtHgt - 5
                                Common_Procedures.Print_To_PrintDocument(e, Trim(CntName3), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                                NoofDets = NoofDets + 1
                                CurY = CurY + TxtHgt - 5
                                Common_Procedures.Print_To_PrintDocument(e, Trim(CntName4), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                                NoofDets = NoofDets + 1
                            End If
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
                ...
                If Not imageData Is Nothing Then
                    Using ms As New MemoryStream(imageData, 0, imageData.Length)
                        ...
                        If imageData.Length > 0 Then
                            ...
                            e.Graphics.DrawImage(DirectCast(Image.FromStream(ms), Drawing.Image), LMargin + 20, CurY + 10, 110, 100)
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Then
                Common_Procedures.Print_To_PrintDocument(e, "TO :  " & "M/s." & prn_HdDt.Rows(0).Item("Ledger_mainName").ToString, LMargin + 10, CurY, 0, 0, p2Font)
            Else
    ...
    Private Sub Printing_FormatGST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Trim(prn_HdDt.Rows(0).Item("Payment_Terms").ToString) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, " Delivery Days  :  " & prn_HdDt.Rows(0).Item("Payment_Terms").ToString & " Days", LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, p1Font)
            End If
            ...
            CurY = CurY + TxtHgt
            ' Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Gr_Date").ToString), "dd-MM-yyyy"), LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, " Payment Date : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Gr_Date").ToString), "dd-MM-yyyy"), LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, p1Font)
            ...
            If Common_Procedures.settings.CustomerCode <> "1369" And Common_Procedures.settings.CustomerCode <> "1186" Then
                ...
                CurY = CurY + TxtHgt - 10
                Common_Procedures.Print_To_PrintDocument(e, "GST on Reverse Charge", LMargin + C1, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Assessable_Value").ToString), "##########0.00"), PageWidth - 5, CurY, 1, 0, pFont)
            End If
            CurY = CurY + TxtHgt + 5
            e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Yarn_Purchase_Order_GST_Tax_Details Where Yarn_Purchase_Order_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Yarn_Purchase_Order_Head", "Delivery_Address", "", "")
    'End Sub
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_DeliveryAddress, cbo_Delvat, cbo_Agent, "Yarn_Purchase_Order_Head", "Delivery_Address", "", "")
    'End Sub
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_DeliveryAddress, cbo_Agent, "Yarn_Purchase_Order_Head", "Delivery_Address", "", "", False)
    'End Sub
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            If Val(LedIdNo) <> 0 Then
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Yarn_Purchase_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code   LEFT OUTER JOIN Yarn_Purchase_Order_Head d ON d.Yarn_Purchase_Order_Code = a.Own_Order_Code    where a.Yarn_Purchase_Order_Code = ''  and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
            ...
            Else
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Yarn_Purchase_Order_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Yarn_Purchase_Order_Code = '" & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno    LEFT OUTER JOIN Yarn_Purchase_Order_Head d ON d.Yarn_Purchase_Order_Code = a.Own_Order_Code    where a.Yarn_Purchase_Order_Code = ''   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                NR = Da.Fill(Dt1)
    ...
    Private Sub Printing_Format_1186(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(35) : ClArr(2) = 100 : ClArr(3) = 60 : ClArr(4) = 150 : ClArr(5) = 50 : ClArr(6) = 50 : ClArr(7) = 65 : ClArr(8) = 65 : ClArr(9) = 60
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Weight").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 5, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format_1186_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        CurY = CurY + 10
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "PO No. : YN/PO-" & prn_HdDt.Rows(0).Item("Yarn_Purchase_Order_No").ToString & "/" & Common_Procedures.FnYearCode, LMargin + 10, CurY, 0, 0, p1Font)
        'strHeight1 = e.Graphics.MeasureString(prn_HdDt.Rows(0).Item("ClothPurchase_Order_No").ToString, p1Font).Height

        Common_Procedures.Print_To_PrintDocument(e, "PO Date : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Yarn_Purchase_Order_date").ToString), "dd-MM-yyyy").ToString, LMargin + ClAr(1) + +ClAr(2) + ClAr(3) + (ClAr(4) / 2) + 20, CurY, 2, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "Party SO No. : " & prn_HdDt.Rows(0).Item("Party_OrderNo").ToString.ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + 60, CurY, 0, 0, p1Font)
        ...
        CurY = CurY + TxtHgt + 5
        Common_Procedures.Print_To_PrintDocument(e, "We are hereby confirming the purchase of yarn as follows :", LMargin + ClAr(1), CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt + 20
    ...
    Private Sub Printing_Format_1186_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_Weight").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 5, CurY, 1, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_Amount").ToString), PageWidth - 5, CurY, 1, 0, pFont)
    ...
    Private Sub cbo_transportation_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_transportation.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Yarn_Purchase_Order_Head", "Transportations", "", "(Yarn_Purchase_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_transportation.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_transportation, txt_DiscPerc, txt_Delivery_Terms, "Yarn_Purchase_Order_Head", "Transportations", "", "(Yarn_Purchase_Order_No=0)")
        'Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_transportation, txt_DiscPerc, cbo_TaxType, "Yarn_Purchase_Order_Head", "Transportations", "", "(Yarn_Purchase_Order_No=0)")
    ...
    Private Sub cbo_transportation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_transportation.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_transportation, txt_Delivery_Terms, "Yarn_Purchase_Order_Head", "Transportations", "", "(Yarn_Purchase_Order_No = 0)", False)

    End Sub

    Private Sub cbo_Tax_Type_GotFocus(sender As Object, e As EventArgs) Handles cbo_tax_type.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Yarn_Purchase_Order_Head", "taxtype", "", "(Yarn_Purchase_Order_No=0)")
    End Sub

    Private Sub cbo_tax_Type_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_tax_type.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_tax_type, msk_DeliveryDate, Nothing, "Yarn_Purchase_Order_Head", "taxtype", "", "(Yarn_Purchase_Order_No=0)")
        If (e.KeyValue = 40) Then
    ...
    Private Sub cbo_Tax_Type_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_tax_type.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_tax_type, Nothing, "Yarn_Purchase_Order_Head", "taxtype", "", "(Yarn_Purchase_Order_No = 0)", False)
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub Yarn_Purchase_Order_GST_Layout(sender As Object, e As LayoutEventArgs) Handles Me.Layout
    ...
    Private Sub txt_DueDays_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_DueDays.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub


    Private Sub Printing_FormatGST_1037(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim cmd As New SqlClient.SqlCommand
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim EntryCode As String
        ...
        ClArr(1) = 35 : ClArr(2) = 160 : ClArr(3) = 72 : ClArr(4) = 55 : ClArr(5) = 55 : ClArr(6) = 65 : ClArr(7) = 100 : ClArr(8) = 80
        ClArr(9) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8))
        ClArr(10) = 0
        'ClArr(9) = 85
        'ClArr(10) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9))
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_FormatGST_PageHeader_1037(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_FormatGST_PageFooter_1037(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, False)
                ...
                Printing_FormatGST_PageFooter_1037(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, True)
    ...
    Private Sub Printing_FormatGST_PageHeader_1037(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        Dim strHeight As Single = 0, strWidth As Single = 0
        ...
        Try
            ...
            If Trim(prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString, LMargin + S1 + 10, CurY, 0, 0, pFont)
            End If
            If Trim(prn_HdDt.Rows(0).Item("Delivery_Date").ToString) <> "" Then
                If IsDate(prn_HdDt.Rows(0).Item("Delivery_Date").ToString) = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Delivery Date", LMargin + C1 + 10, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Delivery_Date").ToString), "dd-MM-yyyy"), LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
                End If
    ...
    Private Sub Printing_FormatGST_PageFooter_1037(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        Dim I As Integer
        Dim Cmp_Name As String
        Dim C1 As Single, W1 As Single
    ...
    End Sub
    Private Sub btn_Delivery_Schedule_Click(sender As Object, e As EventArgs) Handles btn_Delivery_Schedule.Click
        pnl_Delivery_schedule.Visible = True
        pnl_Delivery_schedule.Enabled = True
        pnl_Back.Enabled = False
        If txt_AvgCount.Enabled And txt_AvgCount.Visible Then txt_AvgCount.Focus()
    ...
    Private Sub btn_DelSchedule_Close_Click(sender As Object, e As EventArgs) Handles btn_DelSchedule_Close.Click
        pnl_Back.Enabled = True
        pnl_Delivery_schedule.Visible = False
    End Sub
    Private Sub Dgv_Delivery_Schedule_RowsAdded(sender As Object, e As DataGridViewRowsAddedEventArgs) Handles Dgv_Delv_Schedule_details.RowsAdded
        Dim n As Integer = 0
    ...
    Private Sub txt_AvgCount_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_AvgCount.KeyDown
        If e.KeyValue = 38 Then
            SendKeys.Send("+{TAB}")
    ...
    Private Sub txt_AvgCount_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_AvgCount.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_CSP.Focus()
        End If
    End Sub

    Private Sub txt_CSP_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_CSP.KeyDown
        If e.KeyValue = 38 Then
            txt_AvgCount.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_Cv_Perc_Count.Focus()

        End If
    End Sub

    Private Sub txt_CSP_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_CSP.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Cv_Perc_Count.Focus()
        End If
    End Sub

    Private Sub txt_Cv_Perc_Count_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Cv_Perc_Count.KeyDown
        If e.KeyValue = 38 Then
            txt_CSP.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_Cv_Perc_Strength.Focus()

        End If
    End Sub

    Private Sub txt_Cv_Perc_Count_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Cv_Perc_Count.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Cv_Perc_Strength.Focus()
        End If
    End Sub

    Private Sub txt_Cv_Perc_Strength_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Cv_Perc_Strength.KeyDown
        If e.KeyValue = 38 Then
            txt_Cv_Perc_Count.Focus()
        ElseIf e.KeyValue = 40 Then
            txt_RkmUT3.Focus()
    ...
    Private Sub txt_Cv_Perc_Strength_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Cv_Perc_Strength.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_RkmUT3.Focus()
        End If
    End Sub

    Private Sub txt_RkmUT3_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_RkmUT3.KeyDown
        If e.KeyValue = 38 Then
            txt_Cv_Perc_Strength.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_Rkm_CV_Perc.Focus()

        End If
    End Sub

    Private Sub txt_RkmUT3_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_RkmUT3.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Rkm_CV_Perc.Focus()
        End If
    End Sub

    Private Sub txt_Rkm_CV_Perc_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Rkm_CV_Perc.KeyDown
        If e.KeyValue = 38 Then
            txt_RkmUT3.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_Elongation_perc.Focus()
        End If
    End Sub

    Private Sub txt_Rkm_CV_Perc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Rkm_CV_Perc.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Elongation_perc.Focus()
        End If
    End Sub

    Private Sub txt_Elongation_perc_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Elongation_perc.KeyDown
        If e.KeyValue = 38 Then
            txt_Rkm_CV_Perc.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_Elongation_Cv_perc.Focus()

        End If
    End Sub

    Private Sub txt_Elongation_perc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Elongation_perc.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Elongation_Cv_perc.Focus()
        End If
    End Sub

    Private Sub txt_Elongation_Cv_perc_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Elongation_Cv_perc.KeyDown
        If e.KeyValue = 38 Then
            txt_Elongation_perc.Focus()


        ElseIf e.KeyValue = 40 Then
            txt_Hairiness_Index.Focus()
        End If
    End Sub

    Private Sub txt_Elongation_Cv_perc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Elongation_Cv_perc.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Hairiness_Index.Focus()
        End If
    End Sub

    Private Sub txt_Hairiness_Index_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Hairiness_Index.KeyDown
        If e.KeyValue = 38 Then
            txt_Elongation_Cv_perc.Focus()

        ElseIf e.KeyValue = 40 Then
            txt_imperfection.Focus()

        End If
    End Sub

    Private Sub txt_Hairiness_Index_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Hairiness_Index.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_imperfection.Focus()
        End If
    End Sub

    Private Sub txt_imperfection_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_imperfection.KeyDown
        If e.KeyValue = 38 Then
            txt_Hairiness_Index.Focus()
    ...
    Private Sub txt_imperfection_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_imperfection.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_ConeWt.Focus()
        End If
    End Sub

    Private Sub txt_ConeWt_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_ConeWt.KeyDown
        If e.KeyValue = 38 Then
            txt_imperfection.Focus()
        ElseIf e.KeyValue = 40 Then
            txt_BagWt.Focus()
    ...
    Private Sub txt_ConeWt_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_ConeWt.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_BagWt.Focus()
    ...
    Private Sub txt_BagWt_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_BagWt.KeyDown
        If e.KeyValue = 38 Then
            txt_ConeWt.Focus()
        ElseIf e.KeyValue = 40 Then
            txt_No_Per_Bag.Focus()

        End If
    End Sub

    Private Sub txt_BagWt_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_BagWt.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_No_Per_Bag.Focus()
        End If
    End Sub

    Private Sub txt_No_Per_Bag_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_No_Per_Bag.KeyDown
        If e.KeyValue = 38 Then
            txt_BagWt.Focus()
    ...
    Private Sub txt_No_Per_Bag_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_No_Per_Bag.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Noof_Bag.Focus()
    ...
    Private Sub txt_Noof_Bag_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Noof_Bag.KeyDown
        If e.KeyValue = 38 Then
            txt_No_Per_Bag.Focus()

        ElseIf e.KeyValue = 40 Then

            If Dgv_Delv_Schedule_details.Rows.Count > 0 Then
                Dgv_Delv_Schedule_details.Focus()
                Dgv_Delv_Schedule_details.CurrentCell = Dgv_Delv_Schedule_details.Rows(0).Cells(1)
            End If
    ...
    Private Sub txt_Noof_Bag_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Noof_Bag.KeyPress
        If Asc(e.KeyChar) = 13 Then
            If Dgv_Delv_Schedule_details.Rows.Count > 0 Then
                Dgv_Delv_Schedule_details.Focus()
                Dgv_Delv_Schedule_details.CurrentCell = Dgv_Delv_Schedule_details.Rows(0).Cells(1)
    ...
    Private Sub Dgv_Delivery_Schedule_EditingControlShowing(sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles Dgv_Delv_Schedule_details.EditingControlShowing

        dgvtxt_DelvSche_Details = CType(Dgv_Delv_Schedule_details.EditingControl, DataGridViewTextBoxEditingControl)

    End Sub

    Private Sub cbo_tax_type_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_tax_type.SelectedIndexChanged

    End Sub

    Private Sub dgvtxt_DelvSche_Details_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvtxt_DelvSche_Details.Enter
        Try
            dgv_ActiveCtrl_Name = Dgv_Delv_Schedule_details.Name
            Dgv_Delv_Schedule_details.EditingControl.BackColor = Color.Lime
            Dgv_Delv_Schedule_details.EditingControl.ForeColor = Color.Blue

            dgvtxt_DelvSche_Details.SelectAll()
    ...
    Private Sub dgvtxt_DelvSche_Details_KeyPress(sender As Object, e As KeyPressEventArgs) Handles dgvtxt_DelvSche_Details.KeyPress
    ...
    Private Sub dgvtxt_DelvSche_Details_TextChanged(sender As Object, e As EventArgs) Handles dgvtxt_DelvSche_Details.TextChanged
        Try
            With Dgv_Delv_Schedule_details

                If .Visible Then
                    If .Rows.Count > 0 Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(.CurrentCell.ColumnIndex).Value = Trim(dgvtxt_DelvSche_Details.Text)
                    End If
                End If
            End With
    ...
    Private Sub Dgv_Delv_Schedule_details_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Delv_Schedule_details.CellEnter
        dgv_ActiveCtrl_Name = Dgv_Delv_Schedule_details.Name
    End Sub
    Private Sub Printing_FormatGST_1464(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim cmd As New SqlClient.SqlCommand
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim EntryCode As String
        ...
        ClArr(1) = Val(40) : ClArr(2) = 205 : ClArr(3) = 75 : ClArr(4) = 55 : ClArr(5) = 40 : ClArr(6) = 65 : ClArr(7) = 85 : ClArr(8) = 75
        ClArr(9) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8))
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_FormatGST_1464_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_FormatGST_1464_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, False)
                ...
                '    Do While prn_DetIndx <= prn_Delv_DetDt.Rows.Count - 1

                '        ' For J = 1 To prn_Delv_DetDt.Rows.Count - 1



                '        Dim delvDate As String = ""
                '        Dim DelvWgt As String = ""
                '        Dim Vkg As String = "kgs"
                '        Dim VCont As String
                '        Dim c1, c2 As Integer
                '        Dim item1, item2, item3, item4, item5 As String

                '        c1 = ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5)
                '        c2 = ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7)

                '        delvDate = Trim(prn_Delv_DetDt.Rows(prn_DetIndx).Item("DeliveryDate_Text").ToString)
                '        DelvWgt = Trim(prn_Delv_DetDt.Rows(prn_DetIndx).Item("Weight").ToString)

                '        VCont = String.Concat(Trim(delvDate), "/" & Trim(DelvWgt) & " " & Trim(Vkg) & ",")
                ...
                '        If Len(item1) > 15 Then
                '            For I = 25 To 1 Step -1
                '                If Mid$(Trim(item1), I, 1) = "," Then Exit For
                '            Next I
                '            If I = 0 Then I = 25

                '            item2 = Microsoft.VisualBasic.Right(Trim(item1), I)
                '            item1 = Microsoft.VisualBasic.Left(Trim(item1), I)
                '        End If


                '        Common_Procedures.Print_To_PrintDocument(e, "Delivery Schedule", LMargin + c1 + 10, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + c1 + ClArr(7) + 45, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        Common_Procedures.Print_To_PrintDocument(e, Trim(item1), LMargin + c2 - 10, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        '      Common_Procedures.Print_To_PrintDocument(e, Trim(item3), LMargin + c1 + W1 + 30, CurY, 0, 0, pFont)



                '        'If Trim(item2) <> "" Or Trim(item4) <> "" Or Trim(item5) <> "" Then
                '        '    CurY = CurY + TxtHgt
                '        '    Common_Procedures.Print_To_PrintDocument(e, Trim(item2), LMargin + c2 - 10, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        '    Common_Procedures.Print_To_PrintDocument(e, Trim(item4), LMargin + c2 - 10, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        '    Common_Procedures.Print_To_PrintDocument(e, Trim(item5), LMargin + c2 - 10, CurY - ClArr(2) + 10, 0, 0, pFont)
                '        'End If
                ...
                Printing_FormatGST_1464_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, True)
    ...
    Private Sub Printing_FormatGST_1464_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
                ...
                If Not imageData Is Nothing Then
                    Using ms As New MemoryStream(imageData, 0, imageData.Length)
                        ...
                        If imageData.Length > 0 Then
                            ...
                            ' e.Graphics.DrawImage(DirectCast(pic_IRN_QRCode_Image_forPrinting.BackgroundImage, Drawing.Image), PageWidth - 108, CurY + 10, 90, 90)
                            e.Graphics.DrawImage(DirectCast(Image.FromStream(ms), Drawing.Image), LMargin + 25, CurY + 20, 110, 100)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Payment Due Days", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Due_Days").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            If Trim(vDELVSCH_item2) <> "" Or Trim(vDELVSCH_item3) <> "" Or Trim(vDELVSCH_item4) <> "" Or Trim(vDELVSCH_item5) <> "" Or Trim(vDELVSCH_item6) <> "" Or Trim(vDELVSCH_item7) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, Trim(vDELVSCH_item6) & Trim(vDELVSCH_item7), LMargin + C1 + 10, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Delivery_Terms").ToString) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Delivery_Terms").ToString), LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("TransportName").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("TransportName").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
            Else
                Common_Procedures.Print_To_PrintDocument(e, "-NA-", LMargin + W1 + 30, CurY, 0, 0, pFont)
            End If
            ...
            CurY = CurY + 10
            Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yarn_Description").ToString), LMargin + ClAr(1) + 5, CurY, 0, 0, p1Font)
            CurY = CurY + TxtHgt - 10
    ...
    Private Sub Printing_FormatGST_1464_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Dim DELVADD3 As String = ""
            Dim DELVGSTIN As String = ""


            DELVADD3 = Trim(prn_HdDt.Rows(0).Item("DelAdd3").ToString)
            If Trim(prn_HdDt.Rows(0).Item("DelGSTinNo").ToString) <> "" Then
                DELVGSTIN = Trim("GSTIN  :   " & prn_HdDt.Rows(0).Item("DelGSTinNo").ToString)

            End If

            Common_Procedures.Print_To_PrintDocument(e, "" & prn_HdDt.Rows(0).Item("DelName").ToString, LMargin + 10, CurY + TxtHgt + 5, 0, 0, p1Font)

            Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("DelAdd1").ToString, LMargin + 10, CurY + TxtHgt + TxtHgt + 5, 0, 0, p1Font)

            Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("DelAdd2").ToString, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, p1Font)
            Common_Procedures.Print_To_PrintDocument(e, " " & Trim(DELVADD3), LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, p1Font)
            'Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("DelAdd3").ToString, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 10, 0, 0, p1Font)

            Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("DelAdd4").ToString & "          " & Trim(DELVGSTIN), LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, p1Font)


            'If Trim(prn_HdDt.Rows(0).Item("DelGSTinNo").ToString) <> "" Then
            '    Common_Procedures.Print_To_PrintDocument(e, "GSTIN  :   " & prn_HdDt.Rows(0).Item("DelGSTinNo").ToString, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, p1Font)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then

                If Val(prn_HdDt.Rows(0).Item("Total_CGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : CGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY + 15, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_CGST_Amount").ToString), "##########0.00"), PageWidth - 5, CurY + 15, 1, 0, pFont)
                    End If

                Else
                    Common_Procedures.Print_To_PrintDocument(e, "Add : CGST  @ ", LMargin + C1 + 10, CurY + 15, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, "0.00", PageWidth - 10, CurY + 15, 1, 0, pFont)
            ...
            Else
                ...
                If Val(prn_HdDt.Rows(0).Item("Total_CGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : CGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY + 10, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_CGST_Amount").ToString), "##########0.00"), PageWidth - 5, CurY + 10, 1, 0, pFont)
                    End If

                Else
                    Common_Procedures.Print_To_PrintDocument(e, "Add : CGST  @ ", LMargin + C1 + 10, CurY + 10, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, "0.00", PageWidth - 10, CurY + 10, 1, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then
                ...
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY)

                Common_Procedures.Print_To_PrintDocument(e, "YARN SPECIFICATION", LMargin + ClAr(1) + ClAr(2) - 50, CurY + 5, 2, 0, p1Font)
                CurY = CurY + TxtHgt + 5
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY)

                LnAr(10) = CurY
                CurY = CurY - TxtHgt
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + 5)
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + TxtHgt + 5)
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5)
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + TxtHgt + +TxtHgt + TxtHgt + 5)
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + TxtHgt + +TxtHgt + TxtHgt + TxtHgt + 5)
                e.Graphics.DrawLine(Pens.Black, LMargin, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, PageWidth - ClAr(5) - ClAr(6) - ClAr(7) - ClAr(8), CurY + TxtHgt + TxtHgt + TxtHgt + +TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5)


                CurY = CurY + TxtHgt + 5
                Common_Procedures.Print_To_PrintDocument(e, "Avg Count", LMargin + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "U %", LMargin + 10, CurY + TxtHgt, 0, 0, pFont)
                'Common_Procedures.Print_To_PrintDocument(e, "RKM CV %", LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Rkm_Cv_Perc").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "CV % Of Count", LMargin + 10, CurY + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Cv_Perc_Count").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "CSP", LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Csp").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "CV % Of Strength", LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Cv_Perc_Strength").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "RKM UT3", LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, " :", LMargin + ClAr(1) + 80, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Rkm_UT3").ToString), LMargin + ClAr(1) + ClAr(2) - 100, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "Total Imperfection / Km :" & " " & Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Imperfection_Km").ToString), LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, pFont)
                'Common_Procedures.Print_To_PrintDocument(e, "Total Imperfection / Km :" & " " & Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Imperfection_Km").ToString), LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "Hairiness Index ", LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Hairiness").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "TM ", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt, 0, 0, pFont)
                'Common_Procedures.Print_To_PrintDocument(e, "Elongation %", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Elongation_perc").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "TPI ", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt, 0, 0, pFont)
                'Common_Procedures.Print_To_PrintDocument(e, "Elongation CV % :", LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Elongation_Cv_perc").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt + TxtHgt, 0, 0, pFont)


                Common_Procedures.Print_To_PrintDocument(e, "Cone Weight ", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Yrn_Spci_Cone_Weight").ToString), "#########0.000") & "  Kgs", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "Bag Weight", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Yrn_Spci_Bag_Weight").ToString), "#########0.000") & "  Kgs", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "No of Cone per Bag", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Noof_Cone_per_Bag").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, "No of Bag", LMargin + ClAr(1) + ClAr(2) + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_No_of_Bag").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 5, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then
                ...
                If Val(prn_HdDt.Rows(0).Item("Total_SGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : SGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY - TxtHgt - TxtHgt + 10, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_SGST_Amount").ToString), "##########0.00"), PageWidth - 5, CurY - TxtHgt - TxtHgt + 10, 1, 0, pFont)
                    End If

                Else
                    Common_Procedures.Print_To_PrintDocument(e, "Add : SGST  @ ", LMargin + C1 + 10, CurY - TxtHgt - TxtHgt + 10, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, "0.00", PageWidth - 10, CurY - TxtHgt - TxtHgt + 10, 1, 0, pFont)
                End If
            Else
                If Val(prn_HdDt.Rows(0).Item("Total_SGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : SGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then
                ...
                If Val(prn_HdDt.Rows(0).Item("Total_IGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : IGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY - TxtHgt - TxtHgt + 10, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_IGST_Amount").ToString), "##########0.00"), PageWidth - 5, CurY - TxtHgt - TxtHgt + 10, 1, 0, pFont)
                    End If

                Else
                    Common_Procedures.Print_To_PrintDocument(e, "Add : IGST  @ ", LMargin + C1 + 10, CurY - TxtHgt - TxtHgt + 10, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, "0.00", PageWidth - 10, CurY - TxtHgt - TxtHgt + 10, 1, 0, pFont)
                End If
            Else

                If Val(prn_HdDt.Rows(0).Item("Total_IGST_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add : IGST  @ " & Format(Val(vTaxPerc), "##########0.0") & " %", LMargin + C1 + 10, CurY + 5, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Total_IGST_Amount").ToString), "##########0.00"), PageWidth - 5, CurY + 5, 1, 0, pFont)
                    End If

                Else
                    Common_Procedures.Print_To_PrintDocument(e, "Add : IGST  @ ", LMargin + C1 + 10, CurY + 5, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, "0.00", PageWidth - 10, CurY + 5, 1, 0, pFont)
                End If
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then
                ...
                If Val(prn_HdDt.Rows(0).Item("RoundOff_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "RoundOff ", LMargin + C1 + 10, CurY - TxtHgt - TxtHgt + 10, 0, 0, pFont)
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("RoundOff_Amount").ToString), "##########0.00"), PageWidth - 5, CurY - TxtHgt - TxtHgt + 10, 1, 0, pFont)
                    End If
            ...
            e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8), CurY + TxtHgt + TxtHgt, PageWidth, CurY + TxtHgt + TxtHgt)
            LnAr(8) = CurY
            CurY = CurY + TxtHgt - 10
            'Common_Procedures.Print_To_PrintDocument(e, "E & O.E", LMargin + ClAr(1) + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "GRAND TOTAL", LMargin + C1 + 10, CurY + TxtHgt + 10, 0, 0, pFont)
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, " " & Trim(prn_HdDt.Rows(0).Item("Net_Amount").ToString), PageWidth - 5, CurY + TxtHgt + 10, 1, 0, p1Font)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Yrn_Spci_Average_Count").ToString) <> "" Then
                e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2), CurY - 2, LMargin + ClAr(1) + ClAr(2), LnAr(10))
            End If

            e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + +ClAr(6), CurY - 2, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), LnAr(4))
            e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8), CurY - 2, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8), LnAr(4))
            CurY = CurY + TxtHgt - 10
    ...
    End Sub
    Private Sub cbo_YarnDetails_Description_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_YarnDetails_Description.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_YarnDetails_Description, Nothing, "Yarn_Purchase_Order_Head", "Yarn_Description", "", "", False)

        If Asc(e.KeyChar) = 13 Then
            If cbo_ClothSales_OrderCode_forSelection.Enabled And cbo_ClothSales_OrderCode_forSelection.Visible Then
                cbo_ClothSales_OrderCode_forSelection.Focus()
            Else
                If dgv_Details.Rows.Count > 0 Then
                    dgv_Details.Focus()
    ...
    Private Sub cbo_YarnDetails_Description_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_YarnDetails_Description.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_YarnDetails_Description, Nothing, Nothing, "Yarn_Purchase_Order_Head", "Yarn_Description", "", "")

        If (e.KeyValue = 38 And cbo_YarnDetails_Description.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
            msk_DeliveryDate.Focus()
        End If
        If (e.KeyValue = 40 And cbo_YarnDetails_Description.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
    ...
    Private Sub cbo_YarnDetails_Description_GotFocus(sender As Object, e As EventArgs) Handles cbo_YarnDetails_Description.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Yarn_Purchase_Order_Head", "Yarn_Description", "", "")
    End Sub
    ...
    Private Sub cbo_ClothSales_OrderCode_forSelection_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_ClothSales_OrderCode_forSelection.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, sender, cbo_YarnDetails_Description, Nothing, "ClothSales_Order_Head", "ClothSales_OrderCode_forSelection", vCLO_CONDT, "(ClothSales_Order_Code = '999999/00-00')")
    ...
    Private Sub Dgv_Delv_Schedule_details_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Delv_Schedule_details.CellValueChanged
        If Not IsNothing(Dgv_Delv_Schedule_details.CurrentCell) Then
                ...
                If .Rows.Count > 0 Then
                    ...
                    If e.ColumnIndex = 1 Then
                        ...
                        If Trim(.Rows(e.RowIndex).Cells(1).Value) <> "" Then
                            If IsDate(.Rows(e.RowIndex).Cells(1).Value) Then
                                vDate = CDate(.Rows(e.RowIndex).Cells(1).Value)
                            End If

                        End If

                        If vDate.HasValue Then
                            .Rows(e.RowIndex).Cells(2).Value = UCase(vDate.Value.ToString("MMMM"))
                        Else
    ...
    Private Sub txt_Delivery_Terms_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Delivery_Terms.KeyPress
        If Asc(e.KeyChar) = 13 Then
            If cbo_VehicleNo.Visible And cbo_VehicleNo.Enabled = True Then
                cbo_VehicleNo.Focus()
            Else
    ...
    Private Sub txt_Delivery_Terms_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Delivery_Terms.KeyDown
        If e.KeyCode = 40 Then
            If cbo_VehicleNo.Visible And cbo_VehicleNo.Enabled = True Then
                cbo_VehicleNo.Focus()
            Else
        ...
        If e.KeyCode = 38 Then
            If cbo_transportation.Visible And cbo_transportation.Enabled = True Then
                cbo_transportation.Focus()
            ElseIf cbo_Transport.Visible And cbo_Transport.Enabled = True Then
                cbo_Transport.Focus()
            End If
        End If
    ...
    Private Sub Printing_FormatGST_1267(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim cmd As New SqlClient.SqlCommand
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim EntryCode As String
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_FormatGST_PageHeader_1267(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_FormatGST_PageFooter_1267(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, False)
                ...
                Printing_FormatGST_PageFooter_1267(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, True)
    ...
    Private Sub Printing_FormatGST_PageFooter_1267(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        Dim I As Integer
        Dim Cmp_Name As String
        Dim C1 As Single, W1 As Single
