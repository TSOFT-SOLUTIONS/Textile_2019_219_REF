Public Class Weaver_Yarn_Delivery2
    ...
    Private Pk_Condition As String = "YNDL2-"
    ...
    Private Sub Weaver_Yarn_Delivery_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler txt_Cone.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Cone.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Cone.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Ewave_Bill_No.KeyDown, AddressOf TextBoxControlKeyDown

        'AddHandler msk_date.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Bag.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Cone.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                lbl_DcNo.Text = dt1.Rows(0).Item("Weaver_Yarn_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Weaver_Yarn_Delivery_Date").ToString
                ...
                txt_Bag.Text = Val(dt1.Rows(0).Item("Bags").ToString)
                txt_Cone.Text = Val(dt1.Rows(0).Item("Cones").ToString)
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* from Weaver_Yarn_Delivery_Details a  where a.Weaver_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_YarnDetails.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Meters").ToString), "########0.00")
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_Yarn_Delivery_No from Weaver_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Weaver_Yarn_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_Yarn_Delivery_No from Weaver_Yarn_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Weaver_Yarn_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_Yarn_Delivery_No from Weaver_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_Yarn_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotYrnBags As Single, vTotYrnCones As Single, vTotYrnWeight As Single, vTotYrnMtr As Single
        Dim EntID As String = ""
        ...
        vTotYrnBags = 0 : vTotYrnCones = 0 : vTotYrnWeight = 0 : vTotYrnMtr = 0
        If dgv_YarnDetails_Total.RowCount > 0 Then
            vTotYrnBags = Val(dgv_YarnDetails_Total.Rows(0).Cells(2).Value())
            ...
            vTotYrnMtr = Val(dgv_YarnDetails_Total.Rows(0).Cells(5).Value())
        End If
        ...
        If Val(vTotYrnBags) <> Val(txt_Bag.Text) Then
            MessageBox.Show("Mismatch of Bags", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        Try
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Weaver_Yarn_Delivery_Head(Weaver_Yarn_Delivery_Code, Company_IdNo, Weaver_Yarn_Delivery_No, for_OrderBy, Weaver_Yarn_Delivery_Date, DeliveryTo_idNo  , ReceivedFrom_IdNo,Count_IdNo  ,  Yarn_Type  ,  Mill_IdNo  ,  Bags   ,   Cones  ,   Weight  , Transport_IdNo,  Vechile_No, Total_Bags, Total_Cones, Total_Weight ,Total_Meters , Freight, Party_DcNo,        Cloth_IdNo           ,  User_Idno  , Ewave_Bill_No   ,   Value ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, 0  , " & Str(Val(Rec_ID)) & " ," & Str(Val(YCnt_ID)) & ",'" & Trim(cbo_YarnType.Text) & "' , " & Str(Val(YMil_ID)) & ", " & Str(Val(txt_Bag.Text)) & ", " & Str(Val(txt_Cone.Text)) & "," & Str(Val(txt_Weight.Text)) & ",   " & Str(Val(Trans_ID)) & ",   '" & Trim(cbo_Vechile.Text) & "' , " & Str(Val(vTotYrnBags)) & ", " & Str(Val(vTotYrnCones)) & ", " & Str(Val(vTotYrnWeight)) & " , " & Str(Val(vTotYrnMtr)) & "  ,   " & Str(Val(txt_Freight.Text)) & " , '" & Trim(txt_Party_DcNo.Text) & "' ," & Val(Clo_ID) & " , " & Val(lbl_UserName.Text) & ",'" & Trim(txt_Ewave_Bill_No.Text) & "'," & Val(txt_value.Text) & " )"
                cmd.ExecuteNonQuery()
            ...
            With dgv_YarnDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Weaver_Yarn_Delivery_Details(Weaver_Yarn_Delivery_Code, Company_IdNo, Weaver_Yarn_Delivery_No, for_OrderBy, Weaver_Yarn_Delivery_Date,  Sl_No,  ReceiverFrom_IdNo , DeliveryTo_idNo ,Count_IdNo  ,   Mill_idno  ,  Yarn_Type , Bags, Cones, Weight ,Meters) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Sno)) & ",   " & Str(Val(Rec_ID)) & ", " & Str(Val(Delv_ID)) & "," & Str(Val(YCnt_ID)) & "," & Str(Val(YMil_ID)) & ", '" & Trim(cbo_YarnType.Text) & "' ," & Str(Val(.Rows(i).Cells(2).Value)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & "," & Str(Val(.Rows(i).Cells(5).Value)) & ")"
                        cmd.ExecuteNonQuery()
                        ...
                        If Val(dgv_YarnDetails.Rows(i).Cells(2).Value) <> 0 Or Val(dgv_YarnDetails.Rows(i).Cells(3).Value) <> 0 Then
                            YSno = YSno + 1
                            cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details ( Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno, Entry_ID, Party_Bill_No, Particulars, Sl_No,  Yarn_Bags, Yarn_Cones ) Values ( '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "', " & Str(Val(YSno)) & ", " & Str(Val(dgv_YarnDetails.Rows(i).Cells(2).Value)) & "," & Str(Val(dgv_YarnDetails.Rows(i).Cells(3).Value)) & ")"
                            cmd.ExecuteNonQuery()
                        End If
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_DelvTo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DelvTo, cbo_RecFrom, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Rec_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecFrom.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecFrom, msk_date, txt_Party_DcNo, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'REWINDING' or Ledger_Type = 'JOBWORKER' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1) and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Vechile.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vechile, cbo_TransportName, txt_Freight, "Weaver_Yarn_Delivery_Head", "Vechile_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Vechile.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vechile, txt_Freight, "Weaver_Yarn_Delivery_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub YarnInMeter_Calculation(ByVal RwNo As Integer)
        ...
        With dgv_YarnDetails
            ...
            .Rows(RwNo).Cells(5).Value = ""
            If Val(.Rows(RwNo).Cells(4).Value) <> 0 Then

                If Val(Clo_Mtrs_Pc) <> 0 Then
                    YarnInMtrs = Format(Val(.Rows(RwNo).Cells(4).Value) / Clo_Mtrs_Pc, "##########0")
                    .Rows(RwNo).Cells(5).Value = Format(Val(YarnInMtrs), "###########0.00")
                End If
    ...
    Private Sub TotalYarnTaken_Calculation()
        Dim Sno As Integer
        Dim TotBags As Single, TotCones As Single, TotWeight As Single, TotMtr As Single
    ...
    Private Sub cbo_Grid_MillName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_MillName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_MillName, cbo_YarnType, txt_Bag, "Mill_Head", "Mill_Name", "", "(Mill_IdNo = 0)")
    ...
    Private Sub cbo_Grid_MillName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_MillName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_MillName, txt_Bag, "Mill_Head", "Mill_Name", "", "(Mill_IdNo = 0)")
    ...
    Private Sub cbo_Grid_CountName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_CountName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_CountName, cbo_Cloth, cbo_YarnType, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    ...
    Private Sub cbo_Grid_CountName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_CountName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_CountName, cbo_YarnType, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
    ...
    Private Sub txt_Empty_Beam_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Bag.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_MainName as Ledger1_Name ,d.Ledger_Address1 as RecAdd1,d.Ledger_Address2 as RecAdd2,d.Ledger_Address3 as RecAdd3,d.Ledger_Address4 as RecAdd4,d.Area_Idno as RecArea, e.Transport_Name  from Weaver_Yarn_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.DeliveryTo_IdNo = c.Ledger_IdNo Left Outer JOIN Ledger_Head d ON a.ReceivedFrom_IdNo = d.Ledger_IdNo Left Outer JOIN Transport_Head e ON a.Transport_IdNo = e.Transport_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Yarn_Delivery_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.* from Weaver_Yarn_Delivery_Details a where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Yarn_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
    ...
    Private Sub cbo_cloth_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Cloth.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Cloth, txt_Party_DcNo, cbo_CountName, "Cloth_Head", "cloth_name", "", "(cloth_name)")
    ...
    Private Sub cbo_cloth_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Cloth.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Cloth, cbo_CountName, "Cloth_Head", "cloth_name", "", "(cloth_name)")
    ...
    Private Sub txt_Cone_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Cone.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub txt_Bag_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Bag.LostFocus
        get_MillCount_Details()
    End Sub

    Private Sub txt_Bag_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Bag.TextChanged
        get_MillCount_Details()
    End Sub
