Public Class Billing_Purchase_Return_Gst
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Distribution_Purchase_Return_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Distribution_Purchase_Return_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Distribution_Purchase_Return_Entry, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, led_id, Trim(txt_BillNo.Text), 0, Val((txt_NetAmount.Text)), "DR", Trim(NewCode), tr)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "PURCHASE RETURN", LMargin, CurY - TxtHgt, 2, PrintWidth, p1Font)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Return No.", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, pFont)
            ...
            BlockInvNoY = BlockInvNoY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Return Date", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Bill_Date").ToString) <> "" Then
                p1Font = New Font("Calibri", 10, FontStyle.Regular)
                Common_Procedures.Print_To_PrintDocument(e, "Bill Date", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, p1Font)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Bill_Date").ToString, LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, p1Font)
            End If
            BlockInvNoY = BlockInvNoY + TxtHgt
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, cbo_PaymentMethod, If(cbo_OrderNo.Visible = True, cbo_OrderNo, txt_BillNo), "", "", "", "")
    End Sub
    ...
    Private Sub cbo_TaxType_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TaxType.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TaxType, If(cbo_OrderNo.Visible = True, cbo_OrderNo, txt_BillNo), "", "", "", "")
        If Asc(e.KeyChar) = 13 Then
