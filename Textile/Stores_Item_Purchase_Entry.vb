Public Class Stores_Item_Purchase_Entry
    ...
    Private Pk_Condition As String = "ITPUR-"
    Private Pk_Condition1 As String = "ITPAY-"

    Private Pk_Condition_GST As String = "GITPU-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Stores_Item_Purchase_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  Where a.Item_Purchase_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(PurchaseReturn_Quantity) from Stores_Item_Purchase_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.CommandText = "Update Stores_Item_PO_Details Set Purchased_Quantity = a.Purchased_Quantity - b.Quantity from Stores_Item_PO_Details a, Stores_Item_Purchase_Details b where b.Item_Purchase_Code = '" & Trim(NewCode) & "' and b.Entry_Type = 'PO' and a.Po_Code = b.Po_Code and a.PO_Details_SlNo = b.PO_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Stores_Item_Purchase_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Stores_Item_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Item_Purchase_No from Stores_Item_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND Item_Purchase_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Purchase_No from Stores_Item_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND Item_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Purchase_No from Stores_Item_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND Item_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Purchase_Head", "Item_Purchase_Code", "For_OrderBy", "Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Da = New SqlClient.SqlDataAdapter("select * from Stores_Item_Purchase_Head where Ledger_IdNo = " & Str(Val(Led_IdNo)) & " and Bill_No = '" & Trim(txt_BillNo.Text) & "' and Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and Item_Purchase_Code <> '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Purchase_Head", "Item_Purchase_Code", "For_OrderBy", "Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Stores_Item_Purchase_Head(Item_Purchase_Code,             Company_IdNo         ,           Item_Purchase_No   ,                               for_OrderBy                             , Item_Purchase_Date,                 Entry_Type      ,           Ledger_IdNo     ,  Cash_PartyName ,             Bill_No          ,           PurchaseAc_IdNo  ,        Total_Quantity    ,       Total_Amount       ,      CashDiscount_Percentage       ,       CashDiscount_Amount            ,            Assessable_Value               ,            TaxAc_IdNo    ,             Tax_Type            ,             Tax_Percentage        ,             Tax_Amount              ,               Freight_Amount       ,             AddLess_Amount       ,             RoundOff_Amount         ,                   Net_Amount             ,               Remarks       ,Payment_Method    ) " & _
            ...
            If Common_Procedures.Voucher_Updation(con, "Store.ItemPurc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_date.Text), "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            ...
            If Trim(UCase(cbo_PaymentMethod.Text)) = "CASH" And Led_IdNo <> 1 Then
                ...
                If Val(CSng(lbl_NetAmount.Text)) <> 0 Then
                    ...
                    vVou_Amts = Val(CSng(lbl_NetAmount.Text)) & "|" & -1 * (Val(CSng(lbl_NetAmount.Text)))
                    If Common_Procedures.Voucher_Updation(con, "Store.ItemPayment", Val(lbl_Company.Tag), Trim(Pk_Condition1) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_date.Text), "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                        Throw New ApplicationException(ErrMsg)
                    End If
                End If
            End If
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Stores_Item_Purchase_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  Item_Purchase_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND Item_Purchase_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*,c.Ledger_Name from Stores_Item_Purchase_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Purchase_Code = '" & Trim(NewCode) & "'", con)
