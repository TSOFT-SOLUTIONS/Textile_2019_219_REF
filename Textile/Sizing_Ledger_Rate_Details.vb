Public Class Sizing_Ledger_Rate_Details
    ...
    Private Sub move_record(ByVal idno As Integer)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Ledger_Rate_Head a Where a.Ledger_Rate_IdNo = " & Str(Val(idno)) & "", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.* from Ledger_Rate_Details a  where  a.Ledger_Rate_IdNo = " & Str(Val(idno)) & " ", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Private Sub Ledger_Rate_Details_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Ledger_Rate_Details_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Ledger_Rate_Details_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Last_Closed_FormName = Me.Name
    End Sub

    Private Sub Ledger_Rate_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Delete from Ledger_Rate_Details Where Ledger_Rate_IdNo = " & Str(Val(lbl_IdNo.Text)) & " "
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Ledger_Rate_Head Where Ledger_Rate_IdNo = " & Str(Val(lbl_IdNo.Text)) & " "
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Ledger_Rate_IdNo from Ledger_Rate_Head where Ledger_Rate_IdNo <> 0 Order by Ledger_Rate_IdNo"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Ledger_Rate_IdNo from Ledger_Rate_Head where Ledger_Rate_IdNo > " & Str(OrdByNo) & " Order by Ledger_Rate_IdNo", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Ledger_Rate_IdNo from Ledger_Rate_Head where Ledger_Rate_IdNo < " & Str(Val(OrdByNo)) & " Order by Ledger_Rate_IdNo desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select top 1 Ledger_Rate_IdNo from Ledger_Rate_Head where Ledger_Rate_IdNo <> 0 Order by Ledger_Rate_IdNo desc", con)
        Dim dt As New DataTable
        Dim movno As Integer
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Ledger_Rate_Head", "Ledger_Rate_IdNo", "")
            ...
            With dgv_RateDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If Val(.Rows(i).Cells(4).Value) <> 0 Then
                            'Nr = 0
                            'cmd.CommandText = "update Ledger_Rate_Details set " _
                            ...
                            '    vou_bil_no = Common_Procedures.get_MaxCode(con, "Ledger_Rate_Details", "Voucher_Bill_Code", "For_OrderBy", "", Val(lbl_Company.Tag), OpYrCode, tr)
                            '    vou_bil_code = Trim(Val(lbl_Company.Tag)) & "-" & Trim(vou_bil_no) & "/" & Trim(OpYrCode)

                            cmd.CommandText = "Insert into Ledger_Rate_Details ( Ledger_Rate_IdNo        ,       Ledger_IdNo        , Sl_No            ,           Count_Idno    ,              Ends_From                ,                  Ends_To            ,         Rate                                    ) " _
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            'End If
            cmd.Connection = con
            cmd.CommandText = "select Ledger_Rate_IdNo from Ledger_Rate_Head where Ledger_idno = " & Val(LedIdNo) & "   "
