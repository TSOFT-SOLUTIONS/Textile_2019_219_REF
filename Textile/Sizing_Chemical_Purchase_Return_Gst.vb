Public Class Sizing_Chemical_Purchase_Return_Gst
    ...
    Private Pk_Condition As String = "GCHRT-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Chemical_Purchase_Return_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "' and a.Entry_VAT_GST_Type = 'GST'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Chemical_Purchase_Return_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Chemical_Purchase_Return_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Item_Name, c.Packing_name from Chemical_Purchase_Return_Details a INNER JOIN Sizing_Item_Head b ON a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Waste_Head c ON a.Packing_IdNo = c.Packing_IdNo Where a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                da1 = New SqlClient.SqlDataAdapter("Select a.* from Chemical_Purchase_Return_GST_Tax_Details a Where a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da1.Fill(dt4)
    ...
    Private Sub Chemical_Purchase_Return_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Chemical_Purchase_Return_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Item_Name) from Sizing_Item_Head order by Item_Name", con)
        da.Fill(dt7)
    ...
    Private Sub Chemical_Purchase_Return_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub Chemical_Purchase_Return_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_PURCHASE_RETURN, New_Entry, Me, con, "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", NewCode, "Chemical_Purchase_Return_Date", "(Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Chemical_Purchase_Return_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Chemical_Purchase_Return_Details", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, " Item_IdNo,Packing_IdNo,Noofs,Weight_pack,Quantity,Rate_Quantity,Amount", "Sl_No", "Chemical_Purchase_Return_Code, For_OrderBy, Company_IdNo, Chemical_Purchase_Return_No, Chemical_Purchase_Return_Date ", trans)
            ...
            cmd.CommandText = "delete from Chemical_Purchase_Return_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Chemical_Purchase_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Chemical_Purchase_Return_No from Chemical_Purchase_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Chemical_Purchase_Return_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Chemical_Purchase_Return_No from Chemical_Purchase_Return_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Chemical_Purchase_Return_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Chemical_Purchase_Return_No from Chemical_Purchase_Return_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Chemical_Purchase_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red

            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as PurchaseAcName from Chemical_Purchase_Return_Head a LEFT OUTER JOIN Ledger_Head b ON a.PurchaseAc_IdNo = b.Ledger_IdNo   where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Chemical_Purchase_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Chemical_Purchase_Return_No desc", con)
            Da1.Fill(Dt1)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Chemical_Purchase_Return_No from Chemical_Purchase_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(RefCode) & "' and Entry_VAT_GST_Type = 'GST' ", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_PURCHASE_RETURN, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Chemical_Purchase_Return_No from Chemical_Purchase_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_PURCHASE_RETURN, New_Entry, Me, con, "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", NewCode, "Chemical_Purchase_Return_Date", "(Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Chemical_Purchase_Return_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Chemical_Purchase_Return_Head ( User_IdNo ,Entry_VAT_GST_Type    ,      Chemical_Purchase_Return_Code ,               Company_IdNo       ,           Chemical_Purchase_Return_No    ,                               for_OrderBy                              , Chemical_Purchase_Return_Date   , Entry_Type                       ,       Ledger_IdNo       ,       Receipt_No           ,     PurchaseAc_IdNo    ,                Bill_No            ,                Vehicle_No             ,     Total_Noof_Packs      ,          Total_Quantity  ,          Total_Amount      ,   AddLess_Amount                    ,                  AddLess_Amount2       ,                     Net_Amount           ,         Transport_IdNo    ,            Note             , RoundOff_Amount                         , Assessable_Value                 ,             Freight                   ,            Entry_GST_Tax_Type ,                 CGst_Amount          ,                 SGst_Amount          ,               IGst_Amount             , TaxAmount_RoundOff_Status                     , Bill_Date ,              Total_net_amount ) " &
            ...
            Else
                ...
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Chemical_Purchase_Return_Code, Company_IdNo, for_OrderBy,Entry_VAT_GST_Type", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Chemical_Purchase_Return_Details", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, " Item_IdNo, Packing_IdNo, Noof_Packs, Weight_pack, Quantity, Rate_Quantity, Amount, HSN_Code, Gst_Perc", "Sl_No", "Chemical_Purchase_Return_Code, For_OrderBy, Company_IdNo, Chemical_Purchase_Return_No, Chemical_Purchase_Return_Date,   Entry_Type ", tr)




                cmd.CommandText = "Update Chemical_Purchase_Return_Head set User_IdNo=" & Str(UserIdNo) & ", Entry_VAT_GST_Type = 'GST', Chemical_Purchase_Return_Date = @PurDate, Entry_Type = '" & Trim(cbo_EntType.Text) & "', Ledger_IdNo = " & Str(Val(Led_ID)) & ", Receipt_No = '" & Trim(txt_RecNo.Text) & "',  PurchaseAc_IdNo = " & Str(Val(PurAc_ID)) & ", Bill_No = '" & Trim(txt_BillNo.Text) & "', Vehicle_No = '" & Trim(txt_VehicleNo.Text) & "', Total_Noof_Packs = " & Val(vTotNoofs) & ",Total_Quantity  = " & Str(Val(vTotQty)) & ", Total_Amount = " & Str(Val(vTotAmt)) & ", AddLess_Amount = " & Str(Val(txt_AddLess_BeforeTax.Text)) & ",   AddLess_Amount2 = " & Str(Val(txt_AddLess_AfterTax.Text)) & ", RoundOff_Amount = " & Str(Val(lbl_RoundOff.Text)) & " , Assessable_Value = " & Str(Val(lbl_Assessable.Text)) & " ,   Net_Amount = " & Str(Val(CSng(lbl_NetAmount.Text))) & ", Transport_IdNo  = " & Str(Val(Trans_ID)) & ", Note = '" & Trim(txt_Note.Text) & "'  ,  Freight  = " & Str(Val(txt_Freight.Text)) & ",Entry_GST_Tax_Type = '" & Trim(cbo_TaxType.Text) & "',  CGst_Amount = " & Str(Val(lbl_CGstAmount.Text)) & " , SGst_Amount = " & Str(Val(lbl_SGstAmount.Text)) & " , IGst_Amount = " & Str(Val(lbl_IGstAmount.Text)) & ", TaxAmount_RoundOff_Status = " & Str(Val(RndOff_STS)) & ",Bill_Date= @BillDate, Total_net_amount=" & Str(Val(vTotNetAmt)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                'cmd.CommandText = "Update Chemical_Po_Details set Purchased_Quantity = a.Purchased_Quantity - b.Quantity from Chemical_Po_Details a, Chemical_Purchase_Return_Details b Where b.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "' and b.Entry_Type ='PO' and a.Po_code = b.Po_code and a.PO_Details_SlNo = b.PO_Details_SlNo"
                'cmd.ExecuteNonQuery()
            End If

            cmd.CommandText = "Delete from Chemical_Purchase_Return_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Chemical_Purchase_Return_Head", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Chemical_Purchase_Return_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Chemical_Purchase_Return_Details ( Chemical_Purchase_Return_Code ,               Company_IdNo       ,   Chemical_Purchase_Return_No    ,                     for_OrderBy                                            ,   Chemical_Purchase_Return_Date  ,  Entry_Type ,           Sl_No     ,              Item_IdNo                      ,          Packing_IdNo       ,                     Noof_Packs                                   ,                 Weight_pack                                   ,                        Quantity                                  ,                     Rate_Quantity                                  ,                  Amount                                          ,                   HSN_Code                                 ,                      Gst_Perc                                    ,  Po_No                ,     Po_Code             ,  PO_Details_Slno  ,                                     Disc_perc                   ,                                   Disc_amount                 ,Total_Amount) " &
                        ...
                        cmd.CommandText = "Insert into Stock_Chemical_Processing_Details ( Reference_Code,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                              , Reference_Date,        Ledger_IdNo      ,      Party_Bill_No   ,           Sl_No      ,          Item_IdNo      ,                Quantity                  ,                      Rate                ,                      Amount               ) " &
                                            "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @PurDate   , " & Str(Val(Led_ID)) & ", '" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Itm_ID)) & ", " & Str(-1 * Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            End With
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Chemical_Purchase_Return_Details", "Chemical_Purchase_Return_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, " Item_IdNo,Packing_IdNo,Noofs,Weight_pack,Quantity,Rate_Quantity,Amount", "Sl_No", "Chemical_Purchase_Return_Code, For_OrderBy, Company_IdNo, Chemical_Purchase_Return_No, Chemical_Purchase_Return_Date ", tr)
            ...
            With dgv_GSTTax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Chemical_Purchase_Return_GST_Tax_Details   (    Chemical_Purchase_Return_Code  ,               Company_IdNo       ,        Chemical_Purchase_Return_No   ,                               for_OrderBy                              , Chemical_Purchase_Return_Date ,         Ledger_IdNo     ,            Sl_No     ,                    HSN_Code            ,                      Taxable_Amount      ,                      CGST_Percentage     ,                      CGST_Amount         ,                      SGST_Percentage      ,                      SGST_Amount         ,                      IGST_Percentage     ,                      IGST_Amount          ) " &
            ...
            ' vLed_IdNos = Led_ID & "|" & PurAc_ID & "|" & TxAc_ID & "|" & TxAc_Id2

            ' vVou_Amts = -1 * Val(CSng(lbl_NetAmount.Text)) & "|" & (Val(CSng(lbl_NetAmount.Text)) - Val(txt_VatAmoun.Text) - Val(txt_VatAmount2.Text)) & "|" & Val(txt_VatAmount.Text) & "|" & Val(txt_VatAmount2.Text)
            vLed_IdNos = Led_ID & "|" & PurAc_ID & "|24|25|26"

            vVou_Amts = -1 * Val(CSng(lbl_NetAmount.Text)) & "|" & 1 * (Val(CSng(lbl_NetAmount.Text)) - Val(lbl_CGstAmount.Text) - Val(lbl_SGstAmount.Text) - Val(lbl_IGstAmount.Text)) & "|" & Val(lbl_CGstAmount.Text) & "|" & Val(lbl_SGstAmount.Text) & "|" & Val(lbl_IGstAmount.Text)

            'vVou_Amts = -1 * Val(vNetAmt) & "|" & (Val(lbl_AssessableValue.Text) + Val(txt_addless.Text)) & "|" & Trim(vVOUPOS_GST_AMTS) & "|" & Val(vTCSAmt) & "|" & Val(lbl_RoundOff.Text) + Val(lbl_RoundOff_Invoice_Value_Before_TCS.Text)

            If Common_Procedures.Voucher_Updation(con, "ChemPurc.Ret", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Sizing_Software) = False Then
                Throw New ApplicationException(ErrMsg)
                Exit Sub
            End If

            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(txt_BillNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "DR", Trim(Pk_Condition) & Trim(NewCode), tr, Common_Procedures.SoftwareTypes.Sizing_Software)
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Chemical_Purchase_Return_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Chemical_Purchase_Return_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Chemical_Purchase_Return_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*,  c.Ledger_Name as PartyName from Chemical_Purchase_Return_Head a  INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Entry_VAT_GST_Type = 'GST' and a.Chemical_Purchase_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Chemical_Purchase_Return_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from Chemical_Purchase_Return_Head a INNER JOIN Chemical_Purchase_Return_Details b ON a.Chemical_Purchase_Return_Code = b.Chemical_Purchase_Return_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Chemical_Purchase_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Chemical_Purchase_Return_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Chemical_Purchase_Return_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Chemical_Purchase_Return_Date").ToString), "dd-MM-yyyy")
        ...
        With dgv_Details
            ...
            If .CurrentCell.ColumnIndex = 1 Then
                If Trim(.CurrentRow.Cells(dgvCol_chemical.ITEM_NAME).Value) <> "" Then
                    Itm_Id = Common_Procedures.Sizing_Item_NameToIdNo(con, Trim(.CurrentRow.Cells(dgvCol_chemical.ITEM_NAME).Value))

                    If Itm_Id <> 0 Then

                        Da = New SqlClient.SqlDataAdapter("select * from sizing_Item_Head where Item_IdNo = " & Str(Val(Itm_Id)), con)
                        Dt = New DataTable
                        Da.Fill(Dt)
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Format(Val(TotAmt) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_AddLess_BeforeTax.Text) + Val(txt_AddLess_AfterTax.Text) + Val(txt_Freight.Text), "########0.00")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.ENTRY_SIZING_JOBWORK_MODULE_CHEMICAL_PURCHASE_RETURN, New_Entry) = False Then Exit Sub
    ...
    Private Sub Print_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* from Chemical_Purchase_Return_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* ,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code from Chemical_Purchase_Return_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_HEad CSH on b.Company_State_IdNo = CSH.State_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_HEad LSH on c.Ledger_State_IdNo = LSH.State_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.*,c.* from Chemical_Purchase_Return_Details a  INNER JOIN sizing_Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Waste_Head c ON a.Packing_IdNo = c.Packing_IdNO where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                da2.Fill(prn_DetDt)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Packing_Name from Chemical_Purchase_Return_Details a INNER JOIN Sizing_Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Waste_Head c ON c.Packing_IdNo = a.Packing_IdNo where a.Chemical_Purchase_Return_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Chemical_Purchase_Return_No").ToString, LMargin + C1 + W1 + 25, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Chemical_Purchase_Return_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Chemical_Purchase_Return_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Chemical_Purchase_Return_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Chemical_Purchase_Return_GST_Tax_Details Where Chemical_Purchase_Return_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "update Chemical_Purchase_Return_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Chemical_Purchase_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
