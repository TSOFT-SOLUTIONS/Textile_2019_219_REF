Public Class PayRoll_Employee_Salary_Hours
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_SALARY, New_Entry, Me, con, "PayRoll_Salary_Head", "Salary_Code", Trim(Pk_Condition) & NewCode, "Salary_Date", "(Salary_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        End If
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_SALARY, New_Entry, Me, con, "PayRoll_Salary_Head", "Salary_Code", Pk_Condition & NewCode, "Salary_Date", "(Salary_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Salary_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Salary_No desc", dtp_Date.Value.Date) = False Then Exit Sub
