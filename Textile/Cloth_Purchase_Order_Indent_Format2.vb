Public Class Cloth_Purchase_Order_Indent_Format2
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            If Val(dt2.Rows(i).Item("Order_Pcs").ToString) <> 0 Then
                                .Rows(n).Cells(5).Value = Val(dt2.Rows(i).Item("Order_Pcs").ToString)
                            End If
                            .Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Order_Meters").ToString), "########0.00")
                            ...
                            If Val(dt2.Rows(i).Item("Order_Cancel_Meters").ToString) <> 0 Then
                                .Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Order_Cancel_Meters").ToString), "########0.00")
                            End If
                            .Rows(n).Cells(9).Value = dt2.Rows(i).Item("ClothPurchase_Order_SlNo").ToString
                            .Rows(n).Cells(10).Value = dt2.Rows(i).Item("Purchase_Meters").ToString

                            .Rows(n).Cells(11).Value = dt2.Rows(i).Item("ClothPurchase_Offer_No").ToString
                            .Rows(n).Cells(12).Value = dt2.Rows(i).Item("ClothPurchase_Offer_Code").ToString
                            .Rows(n).Cells(13).Value = dt2.Rows(i).Item("ClothPurchase_Offer_Slno").ToString
                            If Val(dt2.Rows(i).Item("Amount").ToString) <> 0 Then
                                .Rows(n).Cells(19).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                            End If
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothPurchase_Order_No from ClothPurchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, ClothPurchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothPurchase_Order_No from ClothPurchase_Order_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, ClothPurchase_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothPurchase_Order_No from ClothPurchase_Order_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, ClothPurchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 ClothPurchase_Order_No from ClothPurchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, ClothPurchase_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select top 1 * from ClothPurchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, ClothPurchase_Order_No desc", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select ClothPurchase_Order_No from ClothPurchase_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vOrdByNo As String = ""
        Dim DeliveryTo_ID As Integer = 0
        vOrdByNo = Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text)
        ...
        DeliveryTo_ID = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_deliveryAt.Text)
        ...
        Try
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into ClothPurchase_Order_Head ( ClothPurchase_Order_Code ,               Company_IdNo       ,                 ClothPurchase_Order_No  ,                     for_OrderBy                                        , ClothPurchase_Order_Date  ,              Ledger_IdNo,          Party_OrderNo ,                         Through_Name                     ,     Agent_IdNo          ,  Agent_Comm_Perc                , Agent_Comm_Type                 ,   Despatch_To                   ,   Transport_IdNo           ,  Delivery_Address1             , Delivery_Address2               ,      Note      ,                 Total_Bales ,               Total_Pcs  ,          Total_Order_Meters,             Total_Cancel_Meters  ,                      User_idNo     ,                 Gr_Time                   ,         Gr_Date        ,    Selection_Type  ,         Total_amount            ,             Discount_Percentage     ,              Discount_Amount          ,                AddLess_BeforeTax_Amount      ,                 Assessable_Value           ,                  Freight_Amount     ,               AddLessAfterTax_Text            ,                   AddLess_Amount            ,               RoundOff_Amount      ,                  Net_Amount             ,          Total_CGST_Amount        ,              Total_SGST_Amount    ,          Total_IGST_Amount,            DeliveryTo_Idno  ) " &
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        EnqNo = ""
                        If Trim(UCase(cbo_Type.Text)) = "OFFER" Then
                            EnqNo = Trim(.Rows(i).Cells(11).Value)
                            EnqCd = Trim(.Rows(i).Cells(12).Value)

                            EnqSlno = Val(.Rows(i).Cells(13).Value)
                        End If
                        Nr = 0
                        cmd.CommandText = "Update  ClothPurchase_Order_Details set ClothPurchase_Order_Date = @OrderDate , Ledger_IdNo = " & Str(Val(Led_ID)) & ", Sl_No  = " & Str(Val(Sno)) & " , Cloth_IdNo = " & Str(Val(clth_ID)) & " , ClothType_IdNo = " & Str(Val(clthtyp_ID)) & " , Fold_Perc =  " & Str(Val(.Rows(i).Cells(3).Value)) & ", Bales = " & Str(Val(.Rows(i).Cells(4).Value)) & " , Order_Pcs = " & Str(Val(.Rows(i).Cells(5).Value)) & " ,       Order_Meters = " & Str(Val(.Rows(i).Cells(6).Value)) & " , Rate= " & Str(Val(.Rows(i).Cells(7).Value)) & "  , Order_Cancel_Meters =  " & Str(Val(.Rows(i).Cells(8).Value)) & " ,   ClothPurchase_Offer_No  ='" & Trim(EnqNo) & "'          ,  ClothPurchase_Offer_Code  = '" & Trim(EnqCd) & "'         ,    ClothPurchase_Offer_Slno = " & Val(EnqSlno) & ",Selection_Type= '" & Trim(cbo_Type.Text) & "'  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothPurchase_Order_Code = '" & Trim(NewCode) & "'  and ClothPurchase_Order_SlNo = " & Val(.Rows(i).Cells(9).Value)
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then
                            cmd.CommandText = "Insert into ClothPurchase_Order_Details ( ClothPurchase_Order_Code ,               Company_IdNo                 ,   ClothPurchase_Order_No    ,                     for_OrderBy                                            , ClothPurchase_Order_Date        ,      Ledger_IdNo       ,          Sl_No       ,        Cloth_IdNo          ,       ClothType_IdNo         ,                   Fold_Perc            ,                     Bales                   ,        Order_Pcs                     ,       Order_Meters            ,                      Rate                   ,           Order_Cancel_Meters                           ,     ClothPurchase_Offer_No        ,  ClothPurchase_Offer_Code        ,    ClothPurchase_Offer_Slno ,        Selection_Type,Amount) " & _
                                                "     Values                        (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",       @OrderDate            , " & Str(Val(Led_ID)) & ", " & Str(Val(Sno)) & ", " & Str(Val(clth_ID)) & "   , " & Str(Val(clthtyp_ID)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & "," & Str(Val(.Rows(i).Cells(4).Value)) & " , " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ",  " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & "   ,  '" & Trim(EnqNo) & "'           ,  '" & Trim(EnqCd) & "'           , " & Val(EnqSlno) & "      , '" & Trim(cbo_Type.Text) & "', " & Str(Val(.Rows(i).Cells(19).Value)) & ") "
                            cmd.ExecuteNonQuery()
                        End If
                        If Trim(UCase(cbo_Type.Text)) = "OFFER" And Trim(.Rows(i).Cells(11).Value) <> "" Then
                            Nr = 0
                            cmd.CommandText = "Update ClothPurchase_Offer_Details set Order_Meters = Order_Meters + " & Str(Val(.Rows(i).Cells(6).Value)) & " Where ClothPurchase_Offer_Code = '" & Trim(.Rows(i).Cells(12).Value) & "' and ClothPurchase_Offer_Slno = " & Str(Val(.Rows(i).Cells(13).Value)) & " and Ledger_IdNo = " & Str(Val(Led_ID))
                            Nr = cmd.ExecuteNonQuery()
                            If Nr = 0 Then
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into cloth_Purchase_Order_GST_Tax_Details   ( cloth_Purchase_Order_Code  ,               Company_IdNo       ,      cloth_Purchase_Order_No                ,                               for_OrderBy                                  , cloth_Purchase_Order_Date    ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " & _
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(6).Value) <> 0 Then
                    ...
                    TotAmounts = TotAmounts + Val(.Rows(i).Cells(19).Value())
                End If
    ...
    Private Sub cbo_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, cbo_Type, Nothing, "LedgEr_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_DespTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_DespTo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DespTo, msk_GrDate, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", " ( (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 ) ) or Show_In_All_Entry = 1) ", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_DespTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_DespTo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DespTo, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", " ( (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 ) ) or Show_In_All_Entry = 1) ", "(Ledger_IdNo = 0)")
    End Sub
        ...
        Try
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("ClothPurchase_Order_No").ToString
    ...
    Private Sub Cloth_Invoice_Selection()
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(11).Value) = 1 Then
                ...
                dgv_Details.Rows(n).Cells(11).Value = dgv_Selection.Rows(i).Cells(1).Value
                dgv_Details.Rows(n).Cells(12).Value = dgv_Selection.Rows(i).Cells(18).Value
    ...
    Private Sub Amount_Calculation(ByVal CurRow As Integer, ByVal CurCol As Integer)
        Try
            With dgv_Details
                If .Visible Then
                    If .Rows.Count > 0 Then
                        If CurCol = 6 Or CurCol = 7 Then


                            .Rows(CurRow).Cells(19).Value = Format(Val(.Rows(CurRow).Cells(6).Value) * Val(.Rows(CurRow).Cells(7).Value), "#########0.00")
            ...
            With dgv_Details
                ...
                If dgv_Details.Rows.Count > 0 Then
                    ...
                    For RowIndx = 0 To dgv_Details.Rows.Count - 1
                        ...
                        .Rows(RowIndx).Cells(15).Value = Format(Val(.Rows(RowIndx).Cells(19).Value) * (Val(.Rows(RowIndx).Cells(14).Value) / 100), "########0.00")

                        '-- Taxable value = amount -  cash disc
                        Taxable_Amount = Val(.Rows(RowIndx).Cells(19).Value) - Val(.Rows(RowIndx).Cells(15).Value)
    ...
    Private Sub Get_HSN_CodeWise_Tax_Details()
        ...
        Try
            ...
            With dgv_Details
                ...
                If .Rows.Count > 0 Then
                    For i = 0 To .Rows.Count - 1
                        If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(17).Value) <> 0 And Trim(.Rows(i).Cells(18).Value) <> "" Then
    ...
    Private Sub cbo_deliveryAt_GotFocus(sender As Object, e As System.EventArgs) Handles cbo_deliveryAt.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = ''  ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_deliveryAt_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cbo_deliveryAt.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_deliveryAt, msk_GrDate, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = ''  ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        If (e.KeyValue = 40 And cbo_PartyName.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(1)
    ...
    Private Sub cbo_deliveryAt_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_deliveryAt.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_deliveryAt, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = ''  ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(1)
    ...
    Private Sub cbo_deliveryAt_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cbo_deliveryAt.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    Private Sub Printing_FormatGST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = Val(35) : ClAr(2) = 280 : ClAr(3) = 70 : ClAr(4) = 70 : ClAr(5) = 100 : ClAr(6) = 80
        ClAr(7) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6))
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_FormatGST_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClAr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_FormatGST_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, False)
     ...
     NoofDets = NoofDets + 1
                ...
                Printing_FormatGST_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, True)
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Due Days", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("gr_time").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_FormatGST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY = CurY + TxtHgt - 10
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL", LMargin + ClAr(1) + 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Order_Meters").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 5, CurY, 1, 0, pFont)
            ' Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Cones").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 5, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_amount").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
          ...
          e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1), CurY, LMargin + ClAr(1), LnAr(3))
            ...
            ItmNm1 = Trim(prn_HdDt.Rows(0).Item("note").ToString)
            ItmNm2 = ""
            ...
            ' Common_Procedures.Print_To_PrintDocument(e, " " & prn_HdDt.Rows(0).Item("DelGSTinNo").ToString, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + 10, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, " Remarks  :  " & ItmNm1, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, p1Font)
            Common_Procedures.Print_To_PrintDocument(e, " " & ItmNm2, LMargin + 10, CurY + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt + TxtHgt, 0, 0, p1Font)
            'Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Due_Days").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            End If
            CurY = CurY + TxtHgt
            'Common_Procedures.Print_To_PrintDocument(e, " " & ItmNm2, LMargin + 10, CurY, 0, 0, p1Font)
            ...
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, " " & Trim(prn_HdDt.Rows(0).Item("Net_Amount").ToString), PageWidth - 5, CurY, 1, 0, p1Font)
            If Common_Procedures.settings.CustomerCode <> "1369" Then
                CurY = CurY + TxtHgt + 10
                e.Graphics.DrawLine(Pens.Black, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, PageWidth, CurY)
                LnAr(8) = CurY
