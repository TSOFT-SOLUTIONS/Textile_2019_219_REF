Imports System.IO
Public Class Yarn_Sales_Delivery
    ...
    Private Sub Yarn_Sales_Delivery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Yarn_Sales_Delivery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub
    Private Sub Yarn_Sales_Delivery_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Vechile_No) from Weaver_Sales_Yarn_Delivery_Head order by Vechile_No", con)
        da.Fill(dt7)
    ...
    End Sub
    Private Sub Yarn_Sales_Delivery_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from Weaver_Sales_Yarn_Delivery_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Mill_Name from Weaver_Sales_Yarn_Delivery_Details a INNER JOIN Count_Head b on a.Count_IdNo = b.Count_IdNo INNER JOIN Mill_Head c on a.Mill_IdNo = c.Mill_IdNo where a.Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.yarn_Delivery_Entry, New_Entry, Me, con, "Weaver_Sales_Yarn_Delivery_Head", "Weaver_Sales_Yarn_Delivery_Code", NewCode, "Weaver_Sales_Yarn_Delivery_Date", "(Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub


        If Common_Procedures.settings.Vefified_Status = 1 Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

            If Val(Common_Procedures.get_FieldValue(con, "Weaver_Sales_Yarn_Delivery_Head", "Verified_Status", "(Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Sales_Weight) from Weaver_Sales_Yarn_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Weaver_Sales_Yarn_Delivery_Head", "Weaver_Sales_Yarn_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Weaver_Sales_Yarn_Delivery_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Weaver_Sales_Yarn_Delivery_Details", "Weaver_Sales_Yarn_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Yarn_Type, Mill_IdNo,count_idno, Bags, Cones, Weight , Rate, Amount, Bag_No,  Weaver_Sales_Yarn_Delivery_Detail_SlNo ", "Sl_No", "Weaver_Sales_Yarn_Delivery_Code, For_OrderBy, Company_IdNo, Weaver_Sales_Yarn_Delivery_No, Weaver_Sales_Yarn_Delivery_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "delete from Weaver_Sales_Yarn_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Weaver_Sales_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_Sales_Yarn_Delivery_No from Weaver_Sales_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Weaver_Sales_Yarn_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Weaver_Sales_Yarn_Delivery_No from Weaver_Sales_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_Sales_Yarn_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_Sales_Yarn_Delivery_Head", "Weaver_Sales_Yarn_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red


            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Weaver_Sales_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Weaver_Sales_Yarn_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Weaver_Sales_Yarn_Delivery_No from Weaver_Sales_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotYrnBags As String, vTotYrnCones As String, vTotYrnWeight, vTotYrnThiri As String, vTotYrnAmount As String
        Dim EntID As String = ""
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.yarn_Delivery_Entry, New_Entry, Me, con, "Weaver_Sales_Yarn_Delivery_Head", "Weaver_Sales_Yarn_Delivery_Code", NewCode, "Weaver_Sales_Yarn_Delivery_Date", "(Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Weaver_Sales_Yarn_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub

        If Common_Procedures.settings.Vefified_Status = 1 Then
            If Not (Val(Common_Procedures.User.IdNo) = 1 Or Common_Procedures.User.Show_Verified_Status = 1) Then
                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

                If Val(Common_Procedures.get_FieldValue(con, "Weaver_Sales_Yarn_Delivery_Head", "Verified_Status", "(Weaver_Sales_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_Sales_Yarn_Delivery_Head", "Weaver_Sales_Yarn_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            cmd.CommandText = "Delete from Weaver_Sales_Yarn_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "' and Sales_Weight = 0"
            cmd.ExecuteNonQuery()
            ...
            With dgv_YarnDetails
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Weaver_Sales_Yarn_Delivery_Details", "Weaver_Sales_Yarn_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Yarn_Type, Mill_IdNo,count_idno, Bags, Cones, Weight , Rate, Amount, Bag_No,  Weaver_Sales_Yarn_Delivery_Detail_SlNo ", "Sl_No", "Weaver_Sales_Yarn_Delivery_Code, For_OrderBy, Company_IdNo, Weaver_Sales_Yarn_Delivery_No, Weaver_Sales_Yarn_Delivery_Date, Ledger_Idno", tr)
    ...
    Private Sub cbo_Vechile_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Vechile.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Weaver_Sales_Yarn_Delivery_Head", "Vechile_No", "", "")
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Vechile.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vechile, cbo_TransportName, txt_Freight, "Weaver_Sales_Yarn_Delivery_Head", "Vechile_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Vechile.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vechile, txt_Freight, "Weaver_Sales_Yarn_Delivery_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub TotalYarnTaken_Calculation()
        Dim Sno As Integer
        Dim TotBags As String, TotCones As String, TotWeight As String, TotThiri As String, TotAmount As String
        ...
        With dgv_YarnDetails
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(6).Value) <> 0 Then
                    TotBags = Val(TotBags) + Val(.Rows(i).Cells(4).Value)
                    TotCones = Val(TotCones) + Val(.Rows(i).Cells(5).Value)
                    TotWeight = Format(Val(TotWeight) + Val(.Rows(i).Cells(6).Value), "##########0.000")
                    TotAmount = Format(Val(TotAmount) + Val(.Rows(i).Cells(8).Value), "##########0.000")
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Weaver_Sales_Yarn_Delivery_Code IN ( select z1.Weaver_Sales_Yarn_Delivery_Code from Weaver_Sales_Yarn_Delivery_Details z1 where z1.Count_IdNo = " & Str(Val(Cnt_IdNo)) & " )"
                'Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.Count_IdNo = " & Str(Val(Cnt_IdNo)) & ""
            End If

            If Val(Mil_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Weaver_Sales_Yarn_Delivery_Code IN ( select z2.Weaver_Sales_Yarn_Delivery_Code from Weaver_Sales_Yarn_Delivery_Details z2 where z2.Mill_IdNo = " & Str(Val(Mil_IdNo)) & " )"
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, e.Ledger_Name from Weaver_Sales_Yarn_Delivery_Head a inner join Ledger_head e on a.DeliveryTo_IdNo = e.Ledger_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Weaver_Sales_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Weaver_Sales_Yarn_Delivery_Date, a.for_orderby, a.Weaver_Sales_Yarn_Delivery_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, e.Ledger_Name from Weaver_Sales_Yarn_Delivery_Head a left outer join Weaver_Sales_Yarn_Delivery_Details b on a.Weaver_Sales_Yarn_Delivery_Code = b.Weaver_Sales_Yarn_Delivery_Code left outer join Ledger_head e on a.Ledger_idno = e.Ledger_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Weaver_Sales_Yarn_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Weaver_Sales_Yarn_Delivery_Date, a.for_orderby, a.Weaver_Sales_Yarn_Delivery_No", con)
            da.Fill(dt2)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Weaver_Sales_Yarn_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Sales_Yarn_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Mill_name, d.*  from Weaver_Sales_Yarn_Delivery_Details a INNER JOIN Mill_Head b ON a.Mill_idno = b.Mill_idno LEFT OUTER JOIN Count_Head d ON a.Count_idno = d.Count_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Sales_Yarn_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1369" Then '---- ANCHANEYA TEXTILE INDUSTRIES(KARUMATHAMPATTI)
                            ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Count_Name").ToString) & "  Yarn"
                        Else
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Mill_name, d.Count_name  from Weaver_Sales_Yarn_Delivery_Details a INNER JOIN Mill_Head b ON a.Mill_idno = b.Mill_idno LEFT OUTER JOIN Count_Head d ON a.Count_idno = d.Count_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Sales_Yarn_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
