...
Public Class Packing_Slip
    ...
    Private Sub clear()
        ...
        vPRN_Packing_Slip_Status = False
        ...
        Chk_Barcode_Print_Sts.Checked = False
        ...
        cbo_Bale_Bundle.Enabled = True
        If Trim(UCase(PkCondition_Entry)) = Trim(UCase(PkCondition_BaleOnly)) Or Trim(UCase(PkCondition_Entry)) = Trim(UCase(PkCondition_RollOnly)) Or Trim(UCase(PkCondition_Entry)) = Trim(UCase(PkCondition_BundleOnly)) Then
            cbo_Bale_Bundle.Enabled = False
            If Trim(UCase(PkCondition_Entry)) = PkCondition_RollOnly Then
                cbo_Bale_Bundle.Text = "ROLL"

            ElseIf Trim(UCase(PkCondition_Entry)) = PkCondition_BundleOnly Then
                cbo_Bale_Bundle.Text = "BUNDLE"
            Else
                cbo_Bale_Bundle.Text = "BALE"
            End If
        ...
        txt_Note.Text = ""
        chk_PcsSelection_SelectAllPcs.Checked = False
        ...
        lbl_PcsSelection_TotalPcs.Text = ""
        lbl_PcsSelection_TotalMeters.Text = ""
        lbl_PcsSelection_TotalSelectedPcs.Text = ""
        lbl_PcsSelection_TotalSelectedMeters.Text = ""
        ...
        cbo_Sales_Party_Name.Text = ""

        txt_net_weight.Enabled = True
    ...
    Private Sub ControlGotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.ActiveControl.Name <> cbo_Cloth.Name And Me.ActiveControl.Name <> cbo_ClothType.Name And Me.ActiveControl.Name <> cbo_Bale_Bundle.Name And Me.ActiveControl.Name <> txt_Folding.Name And Me.ActiveControl.Name <> dgv_Details.Name And Me.ActiveControl.Name <> dgtxt_Details.Name Then
    ...
    Private Sub Packing_Slip_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Btn_PackingSlip_Print.Visible = False
        ...
        ElseIf Trim(UCase(vEntryType)) = "BALE" Then
            ...
            lbl_BaleNo_Caption.Text = "Bale No"
        ...
        ElseIf Trim(UCase(vEntryType)) = "ROLL" Then
            ...
            Me.BackColor = Color.FromArgb(227, 239, 255) ' Color.LightGray ' Color.LightSalmon  ' Color.LightSeaGreen

            txt_BalePrefixNo.Visible = True
            cbo_BaleSuffixNo.Visible = True

            lbl_BaleNo_Caption.Text = "Roll No"
        ...
        ElseIf Trim(UCase(vEntryType)) = "BUNDLE" Then
            ...
            Me.BackColor = Color.FloralWhite  ' Color.LightGoldenrodYellow

            txt_BalePrefixNo.Visible = True
            cbo_BaleSuffixNo.Visible = True

            lbl_BaleNo_Caption.Text = "Bundle No"
        ...
        ElseIf Common_Procedures.settings.CustomerCode = "1608" Then
            btn_BarcodePrint.Visible = True
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1438" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1487" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1612" Then
            '-----SATHY TEXTILES (SATHYAMANGALAM)
            lbl_BaleNo_Caption.Text = "Packing Slip No."
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1578" Then
            lbl_BaleNo_Caption.Text = "Packing Slip No"
            dgv_Details.Columns(1).HeaderText = "ROLL.NO"
            dgv_Selection.Columns(1).HeaderText = "ROLL.NO"
            Btn_PackingSlip_Print.Visible = True
        Else
            lbl_BaleNo_Caption.Text = "Ref.No"
            dgv_Details.Columns(1).HeaderText = "LOT.NO"
            dgv_Selection.Columns(1).HeaderText = "LOT.NO"
            Btn_PackingSlip_Print.Visible = False
        End If
        ...
        If Common_Procedures.settings.JOBWORKENTRY_Status = 0 And Common_Procedures.settings.Multi_Godown_Status = 0 Then
            ...
            lbl_ClothTypeCaption.Top = lbl_ClothTypeCaption.Top - X
            cbo_ClothType.Top = cbo_ClothType.Top - X
        End If
        ...
        Chk_Barcode_Print_Sts.Visible = False
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
            Chk_Barcode_Print_Sts.Visible = True
        End If
            ...
            If IsNothing(dgv1) = False And Pnl_Back.Enabled = True Then
                ...
                With dgv1
                    ...
                    If keyData = Keys.Enter Or keyData = Keys.Down Or keyData = Keys.Up Then
                        ...
                        Common_Procedures.DGVGrid_Cursor_Focus(dgv1, keyData, txt_Folding, txt_net_weight, dgvDet_CboBx_ColNos_Arr, dgtxt_Details, msk_date)
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                cbo_BaleSuffixNo.Text = dt1.Rows(0).Item("Packing_Slip_SuffixNo").ToString
                ...
                lbl_Weight_per_Mtr.Text = dt1.Rows(0).Item("Weight_PER_Meter").ToString
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(15).Value = dgv_Details.Rows(n).Cells(4).Value
                        ...
                        dgv_Details.Rows(n).Cells(14).Value = Format(Val(dt2.Rows(i).Item("ExcSht_Meters").ToString), "########0.00")
                        If Val(dgv_Details.Rows(n).Cells(14).Value) = 0 Then
                            dgv_Details.Rows(n).Cells(14).Value = ""
                        End If

                        If dgv_Details.Columns(15).Visible = True Then

                            dgv_Details.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Piece_Actual_Meters").ToString), "########0.00")
                            If Val(dgv_Details.Rows(n).Cells(4).Value) = 0 Then
                                dgv_Details.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Meters").ToString), "########0.00")
                            End If

                            dgv_Details.Rows(n).Cells(15).Value = Format(Val(dt2.Rows(i).Item("Meters").ToString), "########0.00")
            ...
            If LockSTS = True And chk_Bale_Close_Sts.Checked = False Then
                ...
                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- BRT TEXTILES (SOMANUR)
                    If Trim(UCase(NewCode)) = Trim(UCase("1-1441-114/18-19")) Then
                        cDelvCheck_STS = False
                    End If
                End If

                If cDelvCheck_STS = True Then
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select count(*) from Packing_Slip_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Packing_Slip_Code = '" & Trim(NewCode) & "' and Delivery_Code like  'UNPAK-%' and  Delivery_Code <> ''  and Delivery_Code NOT LIKE '%/CLOSE' and Bale_Close_Sts = 0 ", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select count(*) from Packing_Slip_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Packing_Slip_Code = '" & Trim(NewCode) & "' and Delivery_Code <> '' and Delivery_Code NOT LIKE '%/CLOSE'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            Else
                ...
                da = New SqlClient.SqlDataAdapter("select top 1 a.Packing_Slip_RefNo from Packing_Slip_Head a where a.for_orderby < " & Str(Val(OrdByNo)) & " and a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Packing_Slip_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and " & Other_Condition & "  and " & Other_Condtn2 & " Order by a.for_Orderby desc, a.Packing_Slip_RefNo desc, a.Packing_Slip_No desc", con)
                dt = New DataTable
                da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from Packing_Slip_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Packing_Slip_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and " & Other_Condition & " Order by for_Orderby desc, Packing_Slip_RefNo desc, Packing_Slip_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                ...
                If txt_BalePrefixNo.Visible = True Then
                    txt_BalePrefixNo.Text = dt1.Rows(0).Item("Packing_Slip_PrefixNo").ToString
                End If
                If cbo_BaleSuffixNo.Visible = True Then
                    cbo_BaleSuffixNo.Text = dt1.Rows(0).Item("Packing_Slip_SuffixNo").ToString
                End If
            ...
            ElseIf cbo_PartyName_StockOF.Enabled And cbo_PartyName_StockOF.Visible Then
                cbo_PartyName_StockOF.Focus()
            ElseIf cbo_Godown_StockIN.Enabled And cbo_Godown_StockIN.Visible Then
                cbo_Godown_StockIN.Focus()
            ElseIf cbo_Cloth.Enabled And cbo_Cloth.Visible Then
                cbo_Cloth.Focus()
            End If
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotMtrs As String, vTotPcs As Integer, vTotWgt As String, vTotPCS_EXSH_Mtrs As String, vTotPCS_ACT_Mtrs As String
        ...
        Dim CloID_Cond As String, Clo_GrpIdNos As String
        ...
        Dim vBALEMTR_FLDNAME As String
        Dim vPCMTR_FLDNAME As String
        Dim vBarcode_Print_STS As Integer = 0
        ...
        Led_ID = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Sales_Party_Name.Text)
        If Clth_ID = 0 Then
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- BRT TEXTILES (SOMANUR)
                        ...
                        dCloTyp_ID = Common_Procedures.ClothType_NameToIdNo(con, .Rows(i).Cells(3).Value)

                        vCloTyp_FldName = ""
                        If dCloTyp_ID = 1 Then
                            vCloTyp_FldName = " Type1_Meters <> 0 and "
                        ElseIf dCloTyp_ID = 2 Then
                            vCloTyp_FldName = " Type2_Meters <> 0 and "
                        ElseIf dCloTyp_ID = 3 Then
                            vCloTyp_FldName = " Type3_Meters <> 0 and "
                        ElseIf dCloTyp_ID = 4 Then
                            vCloTyp_FldName = " Type4_Meters <> 0 and "
                        ElseIf dCloTyp_ID = 5 Then
                            vCloTyp_FldName = " Type5_Meters <> 0 and "
                        End If

                        SQL1 = "Select count(*) from Weaver_ClothReceipt_Piece_Details Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and " & vCloTyp_FldName & " Weaver_Piece_Checking_Date > '" & Trim(Format(dtp_Date.Value, "MM/dd/yyyy")) & "'"
                        cmd.CommandText = "EXEC [SP_ExecuteQuery] '" & Replace(Trim(SQL1), "'", "''") & "'"
                        'cmd.CommandText = "Select count(*) from Weaver_ClothReceipt_Piece_Details Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and " & vCloTyp_FldName & " Weaver_Piece_Checking_Date > @EntryDate"
                        ...
                        If Dt1.Rows.Count > 0 Then
                            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
                                If Val(Dt1.Rows(0)(0).ToString) > 0 Then
                                    MessageBox.Show("Invalid Piece Selection - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & " ,   Dated : " & Trim(Dt1.Rows(0).Item("Weaver_Piece_Checking_Date").ToString) & Chr(13) & " Piece Checking date should be lesser than Packing Slip Date", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                    ...
                    If .Columns(11).Visible = True And .Columns(12).Visible = True And .Columns(13).Visible = True Then

                        If Val(.Rows(i).Cells(11).Value) <> 0 Then

                            If Val(.Rows(i).Cells(11).Value) > Val(.Rows(i).Cells(4).Value) Then
                                MessageBox.Show("Invalid Packing Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The packing meter should not be greater than the piece meter", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                            ...
                            If Val(.Rows(i).Cells(11).Value) < 0 Then
                                MessageBox.Show("Invalid Packing Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The packing meter should not be negative", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                                    .CurrentCell = .Rows(i).Cells(11)
                                End If
                        ...
                        If Val(.Rows(i).Cells(13).Value) <> 0 Then
                            ...
                            If Val(.Rows(i).Cells(11).Value) <= 0 Then
                                MessageBox.Show("Invalid Packing Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The Packing meters should not be zero , if there is New Piece meter.", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                                    .CurrentCell = .Rows(i).Cells(11)
                                End If
                            ...
                            If Val(.Rows(i).Cells(13).Value) < 0 Then
                                MessageBox.Show("Invalid New Piece Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The New Piece meter should not be negative", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                            ...
                            If Val(.Rows(i).Cells(13).Value) > Val(.Rows(i).Cells(4).Value) Then
                                MessageBox.Show("Invalid New Piece Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The New Piece meter should not be greater than the piece meter", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                                    .CurrentCell = .Rows(i).Cells(13)
                                End If
                            ...
                            If Trim(.Rows(i).Cells(12).Value) = "" Then
                                MessageBox.Show("Invalid New Piece Number - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The New Piece number should not be blank", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                        ...
                        If Trim(.Rows(i).Cells(12).Value) <> "" Then
                            ...
                            If Val(.Rows(i).Cells(13).Value) <= 0 Then
                                MessageBox.Show("Invalid New Piece Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The New Piece meter should not be zero", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                                If .Enabled And .Visible Then
                                    .Focus()
                                    .CurrentCell = .Rows(i).Cells(13)
                                End If
                    ...
                    If .Columns(14).Visible = True And .Columns(15).Visible = True Then
                        If Val(.Rows(i).Cells(15).Value) < 0 Then
                            MessageBox.Show("Invalid Net Piece Meters - Lot No. : " & Trim(.Rows(i).Cells(1).Value) & " ,   Piece_No : " & Trim(.Rows(i).Cells(2).Value) & Chr(13) & "The Net Piece meter should not be negative", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                            If .Enabled And .Visible Then
                                .Focus()
        ...
        vBarcode_Print_STS = 0
        If Chk_Barcode_Print_Sts.Checked = True Then vBarcode_Print_STS = 1

        Total_Calculation()

        vTotMtrs = 0 : vTotPcs = 0 : vTotWgt = 0 : vTotPCS_ACT_Mtrs = 0 : vTotPCS_EXSH_Mtrs = 0
        If dgv_Details_Total.RowCount > 0 Then
            If dgv_Details_Total.Columns(11).Visible = True And dgv_Details_Total.Columns(12).Visible = True And dgv_Details_Total.Columns(13).Visible = True Then
                vTotMtrs = Format(Val(dgv_Details_Total.Rows(0).Cells(15).Value), "#########0.00")
                vTotPCS_ACT_Mtrs = Format(Val(dgv_Details_Total.Rows(0).Cells(11).Value), "#########0.00")
            Else
                vTotMtrs = Format(Val(dgv_Details_Total.Rows(0).Cells(4).Value), "#########0.00")
                vTotPCS_ACT_Mtrs = Format(Val(dgv_Details_Total.Rows(0).Cells(4).Value), "#########0.00")
            End If

            vTotPcs = Val(dgv_Details_Total.Rows(0).Cells(2).Value)
            vTotWgt = Format(Val(dgv_Details_Total.Rows(0).Cells(5).Value), "#########0.000")
            vTotPCS_EXSH_Mtrs = Format(Val(dgv_Details_Total.Rows(0).Cells(14).Value), "#########0.00")
        End If

        If vTotMtrs = 0 Then
            MessageBox.Show("Invalid PackingSlip - No Piece Selected", "DOES Not SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1155" Then
                lbl_BaleNo.Text = Trim(lbl_BaleRefNo.Text) & Trim(cbo_BaleSuffixNo.Text)
            Else
                lbl_BaleNo.Text = Trim(txt_BalePrefixNo.Text) & Trim(lbl_BaleRefNo.Text) & Trim(cbo_BaleSuffixNo.Text)
            End If
            ...
            If cDelvCheck_STS = True Then
                ...
                Da = New SqlClient.SqlDataAdapter("Select count(*) from Packing_Slip_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Packing_Slip_Code = '" & Trim(NewCode) & "' and Delivery_Code <> '' and Bale_Close_Sts = 0 ", con)
            ...
            vOrdByNo = Common_Procedures.OrderBy_CodeToValue(lbl_BaleRefNo.Text)

            vBARCODE = Trim(Common_Procedures.FnYearCode) & Trim(Val(lbl_Company.Tag)) & Trim(UCase(lbl_BaleNo.Text))

            If New_Entry = True Then

                cmd.CommandText = "Insert into Packing_Slip_Head(   Packing_Slip_Code   ,                 Company_IdNo     ,        Packing_Slip_PrefixNo         ,            Packing_Slip_RefNo     ,             Packing_Slip_SuffixNo    ,            Packing_Slip_No     ,             for_OrderBy    , Packing_Slip_Date  ,              Cloth_IdNo   ,           ClothType_IdNo    ,                    Bale_Bundle       ,                  Folding            ,              Total_Pcs    ,              Total_Meters  ,           Total_Weight    ,               Note            ,           Ledger_IdNo      ,            User_IdNo                    ,     WareHouse_IdNo    ,              BaleGroup_IdNo           ,Verified_Status            ,Net_Weight                             ,Tare_Weight                            ,               Gross_Weight            ,    Bale_Close_Sts       ,                 Weight_PER_Meter          ,                        Year_Code            ,           Bale_Barcode  , Bale_Verification_Status,     Sales_Party_idno     ,       Total_ExcSht_Meters          ,       Total_Piece_Actual_Meters    ) " &
                                  "Values                       ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(txt_BalePrefixNo.Text) & "', '" & Trim(lbl_BaleRefNo.Text) & "', '" & Trim(cbo_BaleSuffixNo.Text) & "', '" & Trim(lbl_BaleNo.Text) & "', " & Str(Val(vOrdByNo)) & " ,        @EntryDate  ,  " & Str(Val(Clth_ID)) & ", " & Str(Val(Clthty_ID)) & " , '" & Trim(cbo_Bale_Bundle.Text) & "' ,  " & Str(Val(txt_Folding.Text)) & " , " & Str(Val(vTotPcs)) & " , " & Str(Val(vTotMtrs)) & " , " & Str(Val(vTotWgt)) & " , '" & Trim(txt_Note.Text) & "' , " & Str(Val(vLed_IdNo)) & "," & Val(Common_Procedures.User.IdNo) & " ," & Val(vGdwn_IdNo) & ",  " & Str(Val(vEntry_BaleGroupIdNo)) & "," & Val(Verified_STS) & ", " & Str(Val(txt_net_weight.Text)) & ", " & Str(Val(txt_Tare_weight.Text)) & ", " & Str(Val(txt_gross_weight.Text)) & " , " & Val(BaleCls_STS) & ", " & Str(Val(lbl_Weight_per_Mtr.Text)) & " , '" & Trim(Common_Procedures.FnYearCode) & "', '" & Trim(vBARCODE) & "',         0               , " & Str(Val(Led_ID)) & " , " & Str(Val(vTotPCS_EXSH_Mtrs)) & ", " & Str(Val(vTotPCS_ACT_Mtrs)) & " ) "
                cmd.ExecuteNonQuery()
            ...
            Else
                ...
                cmd.CommandText = "Update Packing_Slip_Head set Packing_Slip_PrefixNo = '" & Trim(txt_BalePrefixNo.Text) & "', Packing_Slip_RefNo = '" & Trim(lbl_BaleRefNo.Text) & "', Packing_Slip_SuffixNo = '" & Trim(cbo_BaleSuffixNo.Text) & "', Packing_Slip_No = '" & Trim(lbl_BaleNo.Text) & "', Packing_Slip_Date = @EntryDate, Cloth_IdNo = " & Str(Val(Clth_ID)) & " , ClothType_IdNo = " & Str(Val(Clthty_ID)) & " , Bale_Bundle = '" & Trim(cbo_Bale_Bundle.Text) & "'   ,   Folding = " & Str(Val(txt_Folding.Text)) & ", Total_Pcs = " & Str(Val(vTotPcs)) & ", Total_Weight = " & Str(Val(vTotWgt)) & " , Total_Meters = " & Str(Val(vTotMtrs)) & " , Note = '" & Trim(txt_Note.Text) & "' , Ledger_IdNo = " & Str(Val(vLed_IdNo)) & " , User_IdNo = " & Val(Common_Procedures.User.IdNo) & ", WareHouse_IdNo = " & Val(vGdwn_IdNo) & " , BaleGroup_IdNo = " & Str(Val(vEntry_BaleGroupIdNo)) & ",Verified_Status= " & Val(Verified_STS) & " ,Net_Weight=" & Str(Val(txt_net_weight.Text)) & ", Tare_Weight=" & Str(Val(txt_Tare_weight.Text)) & ",Gross_Weight= " & Str(Val(txt_gross_weight.Text)) & " , Bale_Close_Sts =  " & Val(BaleCls_STS) & ", Weight_PER_Meter = " & Str(Val(lbl_Weight_per_Mtr.Text)) & ", Year_Code = '" & Trim(Common_Procedures.FnYearCode) & "', Bale_Barcode = '" & Trim(vBARCODE) & "', Sales_Party_idno = " & Str(Val(Led_ID)) & " , Total_ExcSht_Meters = " & Str(Val(vTotPCS_EXSH_Mtrs)) & ", Total_Piece_Actual_Meters = " & Str(Val(vTotPCS_ACT_Mtrs)) & " , Barcode_Print_Status = " & Str(Val(vBarcode_Print_STS)) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Packing_Slip_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            If chk_Bale_Close_Sts.Checked = True Then
                cmd.CommandText = "Update Packing_Slip_Head set Delivery_Code = '999999/CLOSE', Delivery_No = '999999', Delivery_DetailsSlNo = 0, Delivery_Increment = 1, Delivery_Date = @EntryDate Where Packing_Slip_Code = '" & Trim(NewCode) & "'  "
                cmd.ExecuteNonQuery()
            End If
            ...
            Else
                Clo_GrpIdNos = "(" & Trim(Val(Clth_ID)) & ")"
            End If

            CloID_Cond = ""
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1267" Then '---- BRT SIZING (SOMANUR)
                CloID_Cond = " and (Cloth_idno = " & Str(Clth_ID) & " or Cloth_idno IN " & Trim(Clo_GrpIdNos) & ")"
            End If
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        vPCS_ACTMtr = Val(.Rows(i).Cells(4).Value)
                        vBALE_PCS_MTRS = vPCS_ACTMtr
                        vPCS_EXCSHT_Mtr = 0
                        vBALE_PCS_WGT = Val(.Rows(i).Cells(5).Value)

                        vCloTypMtrs_FldNameVal = ""
                        ...
                        If .Columns(11).Visible = True And .Columns(12).Visible = True And .Columns(13).Visible = True Then
                            ...
                            If Val(.Rows(i).Cells(11).Value) <> 0 And Val(.Rows(i).Cells(13).Value) <> 0 And Trim(.Rows(i).Cells(12).Value) <> "" Then

                                vPCS_ACTMtr = Val(.Rows(i).Cells(11).Value)
                                vBALE_PCS_WGT = Format(Val(vBALE_PCS_MTRS) * Val(.Rows(i).Cells(6).Value), "##########0.000")


                                vCloTypMtrs_FldNameVal = ""
                                If dCloTyp_ID = 1 Then
                                    vCloTypMtrs_FldNameVal = " Type1_Meters = " & Str(Val(.Rows(i).Cells(11).Value)) & ", "
                                    vNEW_PCS_TYP1MTRS = Val(.Rows(i).Cells(13).Value)
                                ElseIf dCloTyp_ID = 2 Then
                                    vCloTypMtrs_FldNameVal = " Type2_Meters = " & Str(Val(.Rows(i).Cells(11).Value)) & ", "
                                    vNEW_PCS_TYP2MTRS = Val(.Rows(i).Cells(13).Value)
                                ElseIf dCloTyp_ID = 3 Then
                                    vCloTypMtrs_FldNameVal = " Type3_Meters = " & Str(Val(.Rows(i).Cells(11).Value)) & ", "
                                    vNEW_PCS_TYP3MTRS = Val(.Rows(i).Cells(13).Value)
                                ElseIf dCloTyp_ID = 4 Then
                                    vCloTypMtrs_FldNameVal = " Type4_Meters = " & Str(Val(.Rows(i).Cells(11).Value)) & ", "
                                    vNEW_PCS_TYP4MTRS = Val(.Rows(i).Cells(13).Value)
                                ElseIf dCloTyp_ID = 5 Then
                                    vCloTypMtrs_FldNameVal = " Type5_Meters = " & Str(Val(.Rows(i).Cells(11).Value)) & ", "
                                    vNEW_PCS_TYP5MTRS = Val(.Rows(i).Cells(13).Value)
                                End If
                        ...
                        If .Columns(14).Visible = True And .Columns(15).Visible = True Then
                            vPCS_EXCSHT_Mtr = Val(.Rows(i).Cells(14).Value)

                            vBALE_PCS_MTRS = Val(.Rows(i).Cells(15).Value)
                            If Val(vBALE_PCS_MTRS) = 0 Then vBALE_PCS_MTRS = Val(vPCS_ACTMtr)

                        Else
                            vBALE_PCS_MTRS = Val(vPCS_ACTMtr)

                        End If


                        If Val(vBALE_PCS_MTRS) = 0 Then
                            vBALE_PCS_MTRS = Val(.Rows(i).Cells(4).Value)
                        End If
                        ...
                        Nr = 0
                        If dCloTyp_ID = 1 Then
                            cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set " & vCloTypMtrs_FldNameVal & " PackingSlip_Code_Type1 = '" & Trim(NewCode) & "', PackingSlip_Inc_Type1 = PackingSlip_Inc_Type1 + 1 Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and PackingSlip_Code_Type1 = '' " & CloID_Cond
                            Nr = cmd.ExecuteNonQuery()

                        ElseIf dCloTyp_ID = 2 Then
                            cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set " & vCloTypMtrs_FldNameVal & " PackingSlip_Code_Type2 = '" & Trim(NewCode) & "', PackingSlip_Inc_Type2 = PackingSlip_Inc_Type2 + 1 Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and PackingSlip_Code_Type2 = '' " & CloID_Cond
                            Nr = cmd.ExecuteNonQuery()

                        ElseIf dCloTyp_ID = 3 Then
                            cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set " & vCloTypMtrs_FldNameVal & " PackingSlip_Code_Type3 = '" & Trim(NewCode) & "', PackingSlip_Inc_Type3 = PackingSlip_Inc_Type3 + 1 Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and PackingSlip_Code_Type3 = '' " & CloID_Cond
                            Nr = cmd.ExecuteNonQuery()

                        ElseIf dCloTyp_ID = 4 Then
                            cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set " & vCloTypMtrs_FldNameVal & " PackingSlip_Code_Type4 = '" & Trim(NewCode) & "', PackingSlip_Inc_Type4 = PackingSlip_Inc_Type4 + 1 Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and PackingSlip_Code_Type4 = '' " & CloID_Cond
                            Nr = cmd.ExecuteNonQuery()

                        ElseIf dCloTyp_ID = 5 Then
                            cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set  " & vCloTypMtrs_FldNameVal & " PackingSlip_Code_Type5 = '" & Trim(NewCode) & "', PackingSlip_Inc_Type5 = PackingSlip_Inc_Type5 + 1 Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' and PackingSlip_Code_Type5 = '' " & CloID_Cond
                            Nr = cmd.ExecuteNonQuery()
                        ...
                        If .Columns(11).Visible = True And .Columns(12).Visible = True And .Columns(13).Visible = True Then
                            ...
                            If Val(.Rows(i).Cells(11).Value) <> 0 And Val(.Rows(i).Cells(13).Value) <> 0 And Trim(.Rows(i).Cells(12).Value) <> "" Then
                                ...
                                '-----Updating OLD PIECE METER

                                cmd.CommandText = "update Weaver_ClothReceipt_Piece_Details set Total_Checking_Meters = (Type1_Meters+Type2_Meters+Type3_Meters+Type4_Meters+Type5_Meters) Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "'"
                                Nr = cmd.ExecuteNonQuery()


                                vTOT_BEAM_CONS_MTRS = 0
                                vTOT_CHK_MTRS = 0
                                SQL1 = "Select Set_Code1, Beam_No1, Set_Code2, Beam_No2, Width_Type, Crimp_Percentage, SUM(Total_Checking_Meters) as Tot_CheckingMeters, SUM(BeamConsumption_Meters) as Tot_Beam_ConsumptionMeters from Weaver_ClothReceipt_Piece_Details a Where a.lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and a.Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "' group by Set_Code1, Beam_No1, Set_Code2, Beam_No2, Width_Type, Crimp_Percentage"
                                cmd.CommandText = "EXEC [SP_ExecuteQuery] '" & Replace(Trim(SQL1), "'", "''") & "'"
                                Da = New SqlClient.SqlDataAdapter(cmd)
                                Dt1 = New DataTable
                                Da.Fill(Dt1)
                                If Dt1.Rows.Count > 0 Then
                                    If IsDBNull(Dt1.Rows(0).Item("Beam_No1").ToString) = False Then
                                        vPCS_BeamNo1 = Dt1.Rows(0).Item("Beam_No1").ToString
                                    End If
                                    If IsDBNull(Dt1.Rows(0).Item("Beam_No2").ToString) = False Then
                                        vPCS_BeamNo2 = Dt1.Rows(0).Item("Beam_No2").ToString
                                    End If
                                    If IsDBNull(Dt1.Rows(0).Item("Width_Type").ToString) = False Then
                                        vPCS_WidthType = Dt1.Rows(0).Item("Width_Type").ToString
                                    End If
                                    If IsDBNull(Dt1.Rows(0).Item("Crimp_Percentage").ToString) = False Then
                                        vPCS_CrimpPerc = Format(Val(Dt1.Rows(0).Item("Crimp_Percentage").ToString), "#########0.00")
                                    End If
                                    If IsDBNull(Dt1.Rows(0).Item("Tot_CheckingMeters").ToString) = False Then
                                        vTOT_CHK_MTRS = Format(Val(Dt1.Rows(0).Item("Tot_CheckingMeters").ToString), "#########0.00")
                                    End If
                                    If IsDBNull(Dt1.Rows(0).Item("Tot_Beam_ConsumptionMeters").ToString) = False Then
                                        vTOT_BEAM_CONS_MTRS = Format(Val(Dt1.Rows(0).Item("Tot_Beam_ConsumptionMeters").ToString), "#########0.00")
                                    End If
                                End If
                                Dt1.Clear()

                                vBALE_PCS_WGT = Format(Val(vTOT_CHK_MTRS) * Val(.Rows(i).Cells(6).Value), "##########0.000")

                                vOLD_PC_BEAM_CONS_MTRS = Calculation_Beam_ConsumptionPavu(dClo_ID, vLmIdNo, vTOT_CHK_MTRS, vPCS_WidthType, vPCS_CrimpPerc, vPCS_BeamNo1, vPCS_BeamNo2, tr)


                                Nr = 0
                                cmd.CommandText = "Update Weaver_ClothReceipt_Piece_Details set Weight = " & Str(Val(vBALE_PCS_WGT)) & ", BeamConsumption_Meters = " & Str(Val(vOLD_PC_BEAM_CONS_MTRS)) & " Where lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "'"
                                Nr = cmd.ExecuteNonQuery()
                                If Nr <> 1 Then
                                    Throw New ApplicationException("Invalid Pcs Details  -  LotNo. " & Trim(.Rows(i).Cells(8).Value) & " , Piece No = " & Trim(.Rows(i).Cells(2).Value))
                                    Exit Sub
                                ...
                                vNEWPCNo_OrdBy = Val(Common_Procedures.OrderBy_CodeToValue(Trim(UCase(dgv_Details.Rows(i).Cells(12).Value))))

                                vNEW_PC_BEAM_CONS_MTRS = Calculation_Beam_ConsumptionPavu(dClo_ID, vLmIdNo, (Val(vNEW_PCS_TYP1MTRS) + Val(vNEW_PCS_TYP2MTRS) + Val(vNEW_PCS_TYP3MTRS) + Val(vNEW_PCS_TYP4MTRS) + Val(vNEW_PCS_TYP5MTRS)), vPCS_WidthType, vPCS_CrimpPerc, vPCS_BeamNo1, vPCS_BeamNo2, tr)
                                ...
                                SQL1 = SQL1 & "     Select                              a.Weaver_Piece_Checking_Code , a.Company_IdNo, a.Weaver_Piece_Checking_No, a.Weaver_Piece_Checking_Date, a.Ledger_Idno, a.StockOff_IdNo, a.Weaver_ClothReceipt_Code, a.Weaver_ClothReceipt_No, a.for_orderby, a.Weaver_ClothReceipt_Date, a.Lot_Code, a.Lot_No, a.Cloth_IdNo, a.Folding_Checking, a.Folding, " & Str(Val(.Rows(i).Cells(12).Value)) & ", '" & Trim(.Rows(i).Cells(12).Value) & "', '" & Trim(Val(.Rows(i).Cells(12).Value)) & "', " & Str(Val(vNEWPCNo_OrdBy)) & ",          0            ,         0     , a.Loom_No, a.Is_LastPiece, a.Pick, a.Width, " & Str(Val(vNEW_PCS_TYP1MTRS)) & ", " & Str(Val(vNEW_PCS_TYP2MTRS)) & ", " & Str(Val(vNEW_PCS_TYP3MTRS)) & ", " & Str(Val(vNEW_PCS_TYP4MTRS)) & ", " & Str(Val(vNEW_PCS_TYP5MTRS)) & ", " & Str(Val(vNEW_PCS_TYP1MTRS) + Val(vNEW_PCS_TYP2MTRS) + Val(vNEW_PCS_TYP3MTRS) + Val(vNEW_PCS_TYP4MTRS) + Val(vNEW_PCS_TYP5MTRS)) & ", (" & Str(Val(vNEW_PCS_TYP1MTRS) + Val(vNEW_PCS_TYP2MTRS) + Val(vNEW_PCS_TYP3MTRS) + Val(vNEW_PCS_TYP4MTRS) + Val(vNEW_PCS_TYP5MTRS)) & "*a.Weight_Meter), a.Weight_Meter, a.Beam_Knotting_Code, a.Beam_Knotting_No, a.Loom_IdNo, a.Width_Type, a.Crimp_Percentage, a.Set_Code1, a.Set_No1, a.Beam_No1,    0           , a.Set_Code2, a.Set_No2, a.Beam_No2,       0        , " & Str(Val(vNEW_PC_BEAM_CONS_MTRS)) & "  "
                                SQL1 = SQL1 & "  from Weaver_ClothReceipt_Piece_Details a Where a.lot_code = '" & Trim(.Rows(i).Cells(8).Value) & "' and a.Piece_No = '" & Trim(.Rows(i).Cells(2).Value) & "'"
                                Nr = 0
                                cmd.CommandText = "EXEC [SP_ExecuteQuery] '" & Replace(Trim(SQL1), "'", "''") & "'"
                                Nr = cmd.ExecuteNonQuery()
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1155" And Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1267" And Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1490" And Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1558" And Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1608" Then

                '----- Saving Cross Checking - 1

                If dgv_Details.Columns(14).Visible = True And dgv_Details.Columns(15).Visible = True Then
                    vBALEMTR_FLDNAME = "Total_Piece_Actual_Meters"
                Else
                    vBALEMTR_FLDNAME = "Total_Meters"
                End If

                If dgv_Details.Columns(14).Visible = True And dgv_Details.Columns(15).Visible = True Then
                    vPCMTR_FLDNAME = "Piece_Actual_Meters"
                Else
                    vPCMTR_FLDNAME = "Meters"
                End If

                vERRMSG = ""
                If Common_Procedures.Cross_Checking_PackingSlip_With_PieceChecking_by_PackingSlipCode(con, NewCode, vBALEMTR_FLDNAME, vPCMTR_FLDNAME, vERRMSG, tr) = False Then
                ...
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select " & vBALEMTR_FLDNAME & " from Packing_Slip_Head where Packing_Slip_Code = '" & Trim(NewCode) & "'"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select -1*Type1_Meters from Weaver_ClothReceipt_Piece_Details Where PackingSlip_Code_Type1 = '" & Trim(NewCode) & "' and Type1_Meters <> 0"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select -1*Type2_Meters from Weaver_ClothReceipt_Piece_Details Where PackingSlip_Code_Type2 = '" & Trim(NewCode) & "' and Type2_Meters <> 0"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select -1*Type3_Meters from Weaver_ClothReceipt_Piece_Details Where PackingSlip_Code_Type3 = '" & Trim(NewCode) & "' and Type3_Meters <> 0"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select -1*Type4_Meters from Weaver_ClothReceipt_Piece_Details Where PackingSlip_Code_Type4 = '" & Trim(NewCode) & "' and Type4_Meters <> 0"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Meters1) select -1*Type5_Meters from Weaver_ClothReceipt_Piece_Details Where PackingSlip_Code_Type5 = '" & Trim(NewCode) & "' and Type5_Meters <> 0"
                'cmd.ExecuteNonQuery()
                ...
                '            Throw New ApplicationException("Invalid Piece Selection : Mismatch of Bale && Piece Meters")
                '            Exit Sub
                '        End If
                '    End If
                'End If
                ...
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select Lot_Code, Pcs_No, Cloth_idno, ClothType_IdNo, " & vPCMTR_FLDNAME & " from Packing_Slip_Details Where Packing_Slip_Code = '" & Trim(NewCode) & "'"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select a.Lot_Code, a.Piece_No, a.Cloth_idno, 1, -1*a.Type1_Meters from Weaver_ClothReceipt_Piece_Details a, Packing_Slip_Details b Where b.Packing_Slip_Code = '" & Trim(NewCode) & "' and b.ClothType_IdNo = 1 and a.Type1_Meters <> 0 and a.lot_code = b.lot_code and a.piece_no = b.pcs_no"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select a.Lot_Code, a.Piece_No, a.Cloth_idno, 2, -1*a.Type2_Meters from Weaver_ClothReceipt_Piece_Details a, Packing_Slip_Details b Where b.Packing_Slip_Code = '" & Trim(NewCode) & "' and b.ClothType_IdNo = 2 and a.Type2_Meters <> 0 and a.lot_code = b.lot_code and a.piece_no = b.pcs_no"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select a.Lot_Code, a.Piece_No, a.Cloth_idno, 3, -1*a.Type3_Meters from Weaver_ClothReceipt_Piece_Details a, Packing_Slip_Details b Where b.Packing_Slip_Code = '" & Trim(NewCode) & "' and b.ClothType_IdNo = 3 and a.Type3_Meters <> 0 and a.lot_code = b.lot_code and a.piece_no = b.pcs_no"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select a.Lot_Code, a.Piece_No, a.Cloth_idno, 4, -1*a.Type4_Meters from Weaver_ClothReceipt_Piece_Details a, Packing_Slip_Details b Where b.Packing_Slip_Code = '" & Trim(NewCode) & "' and b.ClothType_IdNo = 4 and a.Type4_Meters <> 0 and a.lot_code = b.lot_code and a.piece_no = b.pcs_no"
                'cmd.ExecuteNonQuery()
                'cmd.CommandText = "Insert Into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Name2, Int1, Int2, Meters1) select a.Lot_Code, a.Piece_No, a.Cloth_idno, 5, -1*a.Type5_Meters from Weaver_ClothReceipt_Piece_Details a, Packing_Slip_Details b Where b.Packing_Slip_Code = '" & Trim(NewCode) & "' and b.ClothType_IdNo = 5 and a.Type5_Meters <> 0 and a.lot_code = b.lot_code and a.piece_no = b.pcs_no"
                'cmd.ExecuteNonQuery()

                'Da = New SqlClient.SqlDataAdapter("select Name1, Name2, Int1, Int2, sum(Meters1) as ProdMtrs from " & Trim(Common_Procedures.EntryTempTable) & " Group by Name1, Name2, Int1, Int2 having sum(Meters1) <> 0", con)
                'Da.SelectCommand.Transaction = tr
                'Dt2 = New DataTable
                'Da.Fill(Dt2)
                'If Dt2.Rows.Count > 0 Then
                ...
                Da = New SqlClient.SqlDataAdapter("select distinct(Lot_Code) as lotno from Packing_Slip_Details Where Packing_Slip_Code = '" & Trim(NewCode) & "' and lot_code <> ''", con)
                Da.SelectCommand.Transaction = tr
                Dt2 = New DataTable
                Da.Fill(Dt2)
                If Dt2.Rows.Count > 0 Then
                ...
                '--***********************************************************COMMEMTED BY GOPI FOR -  BRT TEXTILE - TODAY-ONLY(14-09-2023)
                If dgv_Details.Columns(14).Visible = True And dgv_Details.Columns(15).Visible = True Then
                    vPCMTR_FLDNAME = "Piece_Actual_Meters"
                Else
                    vPCMTR_FLDNAME = "Meters"
                ...
                vERRMSG = ""
                If Common_Procedures.Cross_Checking_PieceChecking_PackingSlip_Meters(con, vFAB_LOTCODE, vERRMSG, tr, vPCMTR_FLDNAME) = False Then
                    Throw New ApplicationException(vERRMSG)
                    Exit Sub
                End If
    ...
    Private Sub Total_Calculation()
        Dim Sno As Integer
        Dim TotMtrs As String = 0, TotPcs As Integer = 0, TotWgt As String = 0
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    If .Columns(11).Visible = True And .Columns(13).Visible = True Then
                        ...
                        If Val(.Rows(i).Cells(11).Value) > 0 Then
                            If Val(.Rows(i).Cells(11).Value) < Val(.Rows(i).Cells(4).Value) Then
                                vNEW_PCSMTR = Format(Val(.Rows(i).Cells(4).Value) - Val(.Rows(i).Cells(11).Value), "########0.00")
                            End If
                        End If


                        If Val(.Rows(i).Cells(11).Value) > 0 Then
                            vPCS_NETMTR = Format(Val(.Rows(i).Cells(11).Value) + Val(.Rows(i).Cells(14).Value), "########0.00")
                        Else
                            vPCS_NETMTR = Format(Val(.Rows(i).Cells(4).Value) + Val(.Rows(i).Cells(14).Value), "########0.00")
                        End If

                    End If

                    .Rows(i).Cells(13).Value = Format(Val(vNEW_PCSMTR), "########0.00")
                    .Rows(i).Cells(15).Value = Format(Val(vPCS_NETMTR), "########0.00")

                    TotMtrs = Format(Val(TotMtrs) + Val(.Rows(i).Cells(4).Value), "########0.00")
                    TotWgt = Format(Val(TotWgt) + Val(.Rows(i).Cells(5).Value), "########0.000")
                    vTOT_NEWPCSMTR = Format(Val(vTOT_NEWPCSMTR) + Val(.Rows(i).Cells(13).Value), "########0.00")

                    vTOT_EXCSHTMTR = Format(Val(vTOT_EXCSHTMTR) + Val(.Rows(i).Cells(14).Value), "########0.00")
                    vTOT_PCSMTR = Format(Val(vTOT_PCSMTR) + Val(.Rows(i).Cells(15).Value), "########0.00")
            ...
            vTOT_PACKMTR = Format(Val(TotMtrs) - Val(vTOT_NEWPCSMTR), "########0.00")
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(11).Value = Format(Val(vTOT_PACKMTR), "########0.00")
            .Rows(0).Cells(13).Value = Format(Val(vTOT_NEWPCSMTR), "########0.00")
            .Rows(0).Cells(14).Value = Format(Val(vTOT_EXCSHTMTR), "########0.00")
            .Rows(0).Cells(15).Value = Format(Val(vTOT_PCSMTR), "########0.00")
        End With

        If dgv_Details_Total.Rows(0).Cells(5).Value <> 0 Then
            txt_net_weight.Enabled = False
            txt_net_weight.Text = Format(Val(dgv_Details_Total.Rows(0).Cells(5).Value), "########0.000")
        End If
    ...
    Private Sub chk_PcsSelection_SelectAllPcs_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_PcsSelection_SelectAllPcs.CheckedChanged
        Dim i As Integer
        Dim J As Integer
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1438" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1487" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1578" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1612" Then '-----SATHY TEXTILES (SATHYAMANGALAM)
                vORDBY = "a.PieceNo_OrderBy, a.Piece_No, a.for_orderby, a.Weaver_ClothReceipt_No"
            Else
                vORDBY = "a.Weaver_ClothReceipt_Date, a.for_orderby, a.Weaver_ClothReceipt_No, a.PieceNo_OrderBy, a.Piece_No"
            End If

            If CloTypIdNo = 1 Then

                SQL1 = "select a.Lot_Code, a.Lot_No, a.Piece_No, a.Type1_Meters, a.BuyerOffer_Passed_Meters_Type1, a.Weight_Meter, a.BuyerOffer_Code_Type1, a.Loom_IdNo, a.Loom_No, a.Checked_Pcs_Barcode_Type1, c.Ledger_Name, d.cloth_name from Weaver_ClothReceipt_Piece_Details a  INNER JOIN Company_Head tZ ON a.company_idno = tZ.company_idno LEFT OUTER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Cloth_Head d ON a.Cloth_IdNo <> 0 and a.Cloth_IdNo = d.Cloth_IdNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.Type1_Meters <> 0 and a.PackingSlip_Code_Type1 = '" & Trim(NewCode) & "' and " & CloID_Cond & IIf(CloID_Cond <> "", " and ", " ") & "  a.Folding = " & Str(Val(txt_Folding.Text)) & " order by " & vORDBY
                cmd.CommandText = "EXEC [SP_ExecuteQuery] '" & Replace(Trim(SQL1), "'", "''") & "'"
                Da = New SqlClient.SqlDataAdapter(cmd)
                'Da = New SqlClient.SqlDataAdapter("select a.* , c.Ledger_Name, d.cloth_name from Weaver_ClothReceipt_Piece_Details a  INNER JOIN Company_Head tZ ON a.company_idno = tZ.company_idno LEFT OUTER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Cloth_Head d ON a.Cloth_IdNo <> 0 and a.Cloth_IdNo = d.Cloth_IdNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.Type1_Meters <> 0 and a.PackingSlip_Code_Type1 = '" & Trim(NewCode) & "' and " & CloID_Cond & IIf(CloID_Cond <> "", " and ", " ") & "  a.Folding = " & Str(Val(txt_Folding.Text)) & " order by " & vORDBY, con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        If Trim(Dt1.Rows(i).Item("BuyerOffer_Code_Type1").ToString) <> "" And Val(Dt1.Rows(i).Item("BuyerOffer_Passed_Meters_Type1").ToString) <> 0 Then
                            PcsMtrs = Val(Dt1.Rows(i).Item("BuyerOffer_Passed_Meters_Type1").ToString)
                        Else
                            PcsMtrs = Val(Dt1.Rows(i).Item("Type1_Meters").ToString)
                        End If
                        ...
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Checked_Pcs_Barcode_Type1").ToString
            ...
            If CloTypIdNo = 1 Or CloTypIdNo = 2 Then
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Checked_Pcs_Barcode_Type2").ToString
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1490" Then '---- BRT TEXTTILES (SOMANUR)
            ...
            If CloTyp_Selc_STS = True Then
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(11).Value = vLmNo
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Checked_Pcs_Barcode_Type3").ToString
            ...
            If CloTyp_Selc_STS = True Then
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(11).Value = vLmNo
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Checked_Pcs_Barcode_Type4").ToString
            ...
            CloTyp_Selc_STS = False
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1490" Then
                If CloTypIdNo = 1 Or CloTypIdNo = 5 Then
                    CloTyp_Selc_STS = True
                End If
            Else
            ...
            If CloTyp_Selc_STS = True Then
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(11).Value = vLmNo
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Checked_Pcs_Barcode_Type5").ToString
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- BRT TEXTTILES (SOMANUR)
            txt_PcsSelection_BarCode.Focus()
        ...
        If Val(Common_Procedures.Print_OR_Preview_Status) = 1 Then
            ...
            If Print_PDF_Status = True Then
                ...
                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- BRT SPINNERS PRIVATE LIMITED (FABRIC DIVISION)
                    vFILNm = Trim("PackingList_" & Trim(lbl_BaleRefNo.Text) & "_" & Trim(vPARTYNM) & ".pdf")
                ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Then '-----K V P WEAVES (ANNUR)
                    ...
                    vFILNm = Trim("PackingList_" & Trim(lbl_BaleRefNo.Text) & "_" & Trim(vPARTYNM) & "_" & Trim(v1st_CLONM) & ".pdf")
                Else
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        prn_HdIndx = 1
        prn_DetIndx = 0
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1391" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1438" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1487" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1520" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1612" Then
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*,(case when a.Net_Weight <> 0 then a.Net_Weight else a.Total_Weight end) as Pak_Weight, tZ.*, c.Cloth_Name, c.Cloth_Description, tL.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code  from Packing_Slip_Head a INNER JOIN Company_head tZ ON a.company_idno = tZ.Company_Idno  LEFT OUTER JOIN State_Head Csh ON tZ.Company_State_IdNo = Csh.State_IdNo INNER JOIN Cloth_Head c ON a.Cloth_IdNo = c.Cloth_IdNo  LEFT OUTER JOIN Ledger_Head tL ON a.Sales_Party_idno = tL.Ledger_IdNo Where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Packing_Slip_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'  and " & Trim(Other_Condition) & IIf(Trim(Condt) <> "", " and ", "") & Condt & " order by a.for_orderby, a.Packing_Slip_Code", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                For i = 0 To prn_HdDt.Rows.Count - 1
                    ...
                    prn_HdAr(prn_HdMxIndx, 10) = Format(Val(prn_HdDt.Rows(i).Item("Pak_Weight").ToString), "#########0.000")
                            ...
                            For j = 0 To prn_DetDt.Rows.Count - 1
                                If Val(prn_DetDt.Rows(j).Item("Meters").ToString) <> 0 Then
                                    ...
                                    Else
                                        ...
                                        prn_DetAr1(prn_DetMxIndx, 5) = Trim(prn_HdDt.Rows(i).Item("Packing_Slip_No").ToString)
                                        prn_DetAr1(prn_DetMxIndx, 7) = prn_DetAr1(prn_DetMxIndx, 5) + "/" + prn_DetAr1(prn_DetMxIndx, 1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Else
            ...
            ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1391" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1438" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1487" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1520" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1578" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1612" Then
                ...
                ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1578" Then

                    If vPRN_Packing_Slip_Status = True Then

                        Common_Procedures.Printing_PackingSlip_Format_1578(PrintDocument1, e, prn_HdDt, prn_DetDt, prn_DetMxIndx, prn_DetAr1, prn_PageNo, prn_Count, prn_HdIndx, prn_DetIndx, prn_NoofBmDets, vPRN_Weight_Column_Status, vPacking_SlipNo, "", "", vPartyName, vPartyCityName, "", prn_Clothname, Pack_Type_Name, Total_pcs, vTot_Mtrs, vtot_wgt, "", vFOLDING, vPACKINGSLIPDATE)
            ...
            ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1608" Then
                Common_Procedures.Printing_PackingSlip_Format5_1608(PrintDocument1, e, prn_HdDt, prn_HdMxIndx, prn_DetMxIndx, prn_HdAr, prn_DetAr, prn_PageNo, prn_Count, prn_HdIndx, prn_DetIndx)
    ...
    Private Sub txt_PcsSelction_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_PcsNo.KeyDown
        If e.KeyValue = 40 Then
            If dgv_Selection.Rows.Count > 0 Then
                dgv_Selection.Focus()
                dgv_Selection.CurrentCell = dgv_Selection.Rows(0).Cells(0)
    ...
    Private Sub txt_PcsSelction_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_PcsNo.KeyPress
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub txt_PcsSelection_LotNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_LotNo.KeyDown
        If (e.KeyValue = 40) Then
            txt_PcsSelection_PcsNo.Focus()
        End If
    End Sub

    Private Sub txt_PcsSelection_LotNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_LotNo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_PcsSelection_PcsNo.Focus()
        End If
    End Sub

    Private Sub btn_PcsSelection_Select_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_PcsSelection_Select.Click
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim LtNo As String
        Dim PcsNo As String
    ...
    Private Sub btn_PcsSelection_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_PcsSelection_Show.Click
    ...
    Private Sub btn_PcsSelection_ShowAll_Pieces_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_PcsSelection_ShowAll_Pieces.Click
        Dim i As Integer = 0
    ...
    Private Sub txt_PcsSelection_MetersEqualTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_MetersEqualTo.KeyDown
        If e.KeyValue = 40 Then
    ...
    Private Sub txt_PcsSelection_MetersEqualTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_MetersEqualTo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            btn_PcsSelection_Show_Click(sender, e)
        End If
    End Sub

    Private Sub txt_PcsSelection_MetersFrom_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_MetersFrom.KeyDown
        If e.KeyValue = 40 Then
    ...
    Private Sub txt_PcsSelection_MetersFrom_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_MetersFrom.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_PcsSelection_MetersTo.Focus()
        End If
    End Sub

    Private Sub txt_PcsSelection_MetersTo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_MetersTo.KeyDown
        If e.KeyValue = 40 Then
    ...
    Private Sub txt_PcsSelection_MetersTo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_MetersTo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            btn_PcsSelection_Show_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub txt_PcsSelection_BarCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PcsSelection_BarCode.KeyDown
        If e.KeyValue = 40 Then
            If dgv_Selection.Rows.Count > 0 Then
                dgv_Selection.Focus()
                dgv_Selection.CurrentCell = dgv_Selection.Rows(0).Cells(0)
    ...
    Private Sub txt_PcsSelection_BarCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PcsSelection_BarCode.KeyPress
        If Asc(e.KeyChar) = 13 Then
            If Trim(txt_PcsSelection_BarCode.Text) <> "" Then
                btn_PcsSelection_Select_Click(sender, e)
            End If
    ...
    Private Sub btn_BarcodePrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_BarcodePrint.Click
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
            ...
            For i = prtFrm To prtTo

                NewCode = Trim(PkCondition_Entry) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(i) & "/" & Trim(Common_Procedures.FnYearCode)

                cmd.CommandText = "Update Packing_Slip_Head set Barcode_Print_Status = 1, Barcode_Print_Date = CAST(GETDATE() AS DATE) Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Packing_Slip_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            Next

        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1608" Then
            Printing_BarCode_Sticker_Format5_1608_DosPrint()
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1155" Then
            Prn_BarcodeSticker = True
            vPRN_Weight_Column_Status = False
            Printing_Bale()
    ...
    Private Sub txt_net_weight_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_net_weight.TextChanged
        Calculation_GrossWeight()
    End Sub
    ...
    Private Sub cbo_PcsSelection_VendorName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_PcsSelection_VendorName.GotFocus
    ...
    Private Sub cbo_PcsSelection_VendorName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PcsSelection_VendorName.KeyDown
    ...
    Private Sub cbo_PcsSelection_VendorName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PcsSelection_VendorName.KeyPress
    ...
    Private Sub cbo_Cloth_TextChanged(sender As Object, e As EventArgs) Handles cbo_Cloth.TextChanged
        Dim Clo_IdNo As Integer
        Clo_IdNo = Common_Procedures.Cloth_NameToIdNo(con, cbo_Cloth.Text)
    ...
    Private Sub txt_net_weight_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_net_weight.KeyDown
    ...
    Private Sub cbo_Sales_Party_Name_GotFocus(sender As Object, e As EventArgs) Handles cbo_Sales_Party_Name.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Sales_Party_Name_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Sales_Party_Name.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
    ...
    Private Sub cbo_Sales_Party_Name_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Sales_Party_Name.KeyPress
    ...
    Private Sub cbo_Sales_Party_Name_KeyUp(sender As Object, e As KeyEventArgs) Handles cbo_Sales_Party_Name.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    Private Sub cbo_BaleSuffixNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_BaleSuffixNo.GotFocus
    ...
    End Sub
    Private Sub cbo_BaleSuffixNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_BaleSuffixNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, sender, txt_Note, msk_date, "Cloth_BitsGroup_Head", "Cloth_BitsGroup_Name", "", "(Cloth_BitsGroup_Name='')")
    End Sub

    Private Sub cbo_BaleSuffixNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BaleSuffixNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, sender, msk_date, "Cloth_BitsGroup_Head", "Cloth_BitsGroup_Name", "", "(Cloth_BitsGroup_Name='')")
    End Sub

    Private Sub cbo_BaleSuffixNo_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_BaleSuffixNo.KeyUp
        If e.Control = False And e.KeyValue = 17 Then
...
GO_TO_LOOP1:
    ...
    Private Sub cbo_Cloth_Enter(sender As Object, e As EventArgs) Handles cbo_Cloth.Enter
        Fabric_Stock_Display()
    End Sub

    Private Sub cbo_ClothType_Enter(sender As Object, e As EventArgs) Handles cbo_ClothType.Enter
        Fabric_Stock_Display()
    End Sub

    Private Sub cbo_Bale_Bundle_Enter(sender As Object, e As EventArgs) Handles cbo_Bale_Bundle.Enter
        Fabric_Stock_Display()
    End Sub

    Private Sub txt_Folding_Enter(sender As Object, e As EventArgs) Handles txt_Folding.Enter
        Fabric_Stock_Display()
    End Sub
    ...
    Private Sub Printing_BarCode_Sticker_Format5_1608_DosPrint()
        Dim da1 As New SqlClient.SqlDataAdapter
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim NewCode As String = ""
        Dim PrnTxt As String = ""
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Do While prn_HeadIndx <= prn_HdDt.Rows.Count - 1
                    ...
                    If Val(vFldMtrs) <> 0 Then
                        ...
                        PrnTxt = "CLS"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "BOX 25,11,639,307,3"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "CODEPAGE 1252"
                        sw.WriteLine(PrnTxt)


                        PrnTxt = "TEXT 620,277,""0"",180,14,17,""CLOTH NAME"""
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 620,181,""0"",180,14,14,""BALE NO"""
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 620,110,""ROMAN.TTF"",180,1,14,""NO. OF PCS """
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 387,283,""0"",180,28,17,"":"""
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 384,181,""ROMAN.TTF"",180,1,14,"":"""
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 384,110,""ROMAN.TTF"",180,1,14,"":"""
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 356,294,""ROMAN.TTF"",180,1,12,""" & Trim(ItmNm1) & """"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 356,254,""ROMAN.TTF"",180,1,12,""" & Trim(ItmNm2) & """"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 368,181,""ROMAN.TTF"",180,1,15,""" & Trim(Trim(prn_HdDt.Rows(prn_HeadIndx).Item("Packing_Slip_RefNo").ToString)) & """"

                        sw.WriteLine(PrnTxt)
                        PrnTxt = "QRCODE 187,205,L,6,A,180,M2,S7,""" & Trim(UCase(vBarCode)) & """"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 192,60,""ROMAN.TTF"",180,1,12,""" & Trim(UCase(vBarCode)) & """"
                        sw.WriteLine(PrnTxt)
                        PrnTxt = "TEXT 362,111,""ROMAN.TTF"",180,1,15,""" & Trim(Val((prn_HdDt.Rows(prn_HeadIndx).Item("Total_Pcs").ToString))) & """"
                        sw.WriteLine(PrnTxt)
    ...
    End Sub
    Private Sub Btn_PackingSlip_Print_Click(sender As Object, e As EventArgs) Handles Btn_PackingSlip_Print.Click
        vPRN_Weight_Column_Status = False
        vPRN_Packing_Slip_Status = True
        Printing_Bale()
    End Sub
    ...
    '        vSNO = 0
    '        da1 = New SqlClient.SqlDataAdapter("select a.*,b.*,L.*,c.cloth_name from ClothSales_Invoice_Head a INNER JOIN Company_head b ON a.company_idno = b.Company_Idno INNER JOIN Ledger_Head L ON a.Ledger_IdNo = L.Ledger_IdNo INNER JOIN ClothSales_Invoice_Details Cd ON a.ClothSales_Invoice_code = Cd.ClothSales_Invoice_code INNER JOIN Cloth_Head C ON cd.Cloth_IdNo = C.Cloth_IdNo Where a.ClothSales_Invoice_Code = '" & Trim(NewCode) & "'", con)
    '        prn_HdDt = New DataTable
    '        da1.Fill(prn_HdDt)

    '        If prn_HdDt.Rows.Count > 0 Then
    '            da2 = New SqlClient.SqlDataAdapter("select a.*, b.Total_Weight,b.Bale_Bundle,b.Total_Pcs,b.net_Weight,b.Total_Meters,b.Gross_Weight as grs_wgt from Packing_Slip_Details a, Packing_Slip_Head b Where a.Packing_Slip_Code = b.Packing_Slip_Code and ( b.Delivery_Code = '" & Trim(NewCode) & "' or b.Delivery_Code IN ( select 'CSDLV-' + sq1.ClothSales_Delivery_Code from ClothSales_Invoice_Details sq1 where sq1.ClothSales_Invoice_Code = '" & Trim(NewCode) & "' and sq1.Invoice_Selection_Type = 'DELIVERY' and sq1.ClothSales_Delivery_Code <> '')  ) order by b.Packing_Slip_Date, b.for_orderby, b.Packing_Slip_No, b.Packing_Slip_Code, a.Sl_No", con)
    '            prn_DetDt = New DataTable
    '            da2.Fill(prn_DetDt)
    ...
    '                        prn_DetAr1(prn_DetMxIndx, 7) = Trim(prn_DetDt.Rows(i).Item("Lot_no").ToString) + "/" + prn_DetAr1(prn_DetMxIndx, 1)
    ...
    '        vClothSales_Inv_No = prn_HdDt.Rows(0).Item("ClothSales_Invoice_No").ToString
    '        vClothSales_Inv_Date = Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("ClothSales_Invoice_Date").ToString), "dd-MM-yyyy").ToString
    ...
    '    NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_BaleRefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
    ...
    '        vPARTYNM = ""
    '        v1st_CLONM = ""
    '        da1 = New SqlClient.SqlDataAdapter("Select a.*, b.* from ClothSales_Invoice_Head a LEFT OUTER JOIN ClothSales_Invoice_Details b ON a.ClothSales_Invoice_Code = b.ClothSales_Invoice_Code Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothSales_Invoice_Code = '" & Trim(NewCode) & "' Order by a.ClothSales_Invoice_Code, b.sl_no", con)
    '        dt1 = New DataTable
    '        da1.Fill(dt1)
    '        If dt1.Rows.Count >= 0 Then
    ...
    '                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- BRT SPINNERS PRIVATE LIMITED (FABRIC DIVISION)
    '                    vFILNm = Trim("PackingList_of_Invoice_" & Trim(lbl_BaleRefNo.Text) & "_" & Trim(vPARTYNM) & ".pdf")
    '                ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1489" Then '-----K V P WEAVES (ANNUR)
    '                    v1st_CLONM = Common_Procedures.Replace_SpecialCharacters_With_UnderScore(v1st_CLONM)
    '                    vFILNm = Trim("PackingList_of_Invoice_" & Trim(lbl_BaleRefNo.Text) & "_" & Trim(vPARTYNM) & "_" & Trim(v1st_CLONM) & ".pdf")
    '                Else
    '                    vFILNm = Trim("PackingList_of_Invoice_" & Trim(lbl_BaleRefNo.Text) & ".pdf")
    '                End If
    '                'vFILNm = Trim("PackingList_" & Trim(lbl_BaleRefNo.Text) & ".pdf")
    ...
    '                PrintDocument2.DocumentName = Trim(vFILNm)
    '                PrintDocument2.PrinterSettings.PrinterName = Trim(vPRNTRNAME)    ' "Microsoft Print to PDF"
    '                'PrintDocument6.PrinterSettings.PrinterName = "doPDF v7"
    '                PrintDocument2.PrinterSettings.PrintToFile = True
    '                PrintDocument2.PrinterSettings.PrintFileName = Trim(vPDFFLPATH_and_NAME)
    '                PrintDocument2.Print()

    '                PrintDocument2.PrinterSettings.PrinterName = Trim(Def_PrntrNm)
    '                Print_PDF_Status = False
