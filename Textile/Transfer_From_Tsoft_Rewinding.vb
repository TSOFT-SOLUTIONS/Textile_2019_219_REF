...
Public Class Transfer_From_Tsoft_Rewinding
    ...
    Private Sub Transfer_Master_Ledgers_From_Smart_TextileNT9_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(cbo_DBFrom, CnTo, "master..sysdatabases", "name", "(name LIKE 'tsoft%rewinding%')", "")
    ...
    Private Sub LedgerHead_Transfer(ByVal sqltr As SqlClient.SqlTransaction)
        ...
        Da1 = New SqlClient.SqlDataAdapter("select a.* from Ledger_Head a  where Ledger_IdNo > 20 Order by Ledger_IdNo", CnFrm)
        Dt1 = New DataTable
        Da1.Fill(Dt1)
        ...
        If Dt1.Rows.Count > 0 Then
            ...
            For I = 0 To Dt1.Rows.Count - 1
                ...
                If vOldLID = 0 Then
                    ...
                    Da1 = New SqlClient.SqlDataAdapter("select * from Mill_Head where mill_idno = " & Str(Val(vMill_IdNo)) & " ", CnFrm)
                    Dt2 = New DataTable
                    Da1.Fill(Dt2)
