Public Class Cloth_Purchase_Order_GST
    ...
    Private Sub ClothSales_Order_Indent_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgv_Details.Columns(dgvCol_DelvDetails.Loom_Type).Visible = False
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then

            Label21.Text = "Cr Days"
            Label20.Text = "Due Date"
            dgv_Details.Columns(dgvCol_DelvDetails.Cloth_name).Width = dgv_Details.Columns(dgvCol_DelvDetails.Cloth_name).Width + dgv_Details.Columns(dgvCol_DelvDetails.Order_pCs).Width + dgv_Details.Columns(dgvCol_DelvDetails.Fold_perc).Width
            dgv_Details.Columns(dgvCol_DelvDetails.Loom_Type).Visible = True
            dgv_Details.Columns(dgvCol_DelvDetails.Fold_perc).Visible = False
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            End If
                            If Val(.Rows(n).Cells(dgvCol_DelvDetails.Cloth_Purchase_meters).Value) <> 0 Then
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(6).Value) <> 0 Then
                ...
                clth_ID = Common_Procedures.Cloth_NameToIdNo(con, dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Cloth_name).Value)
                If clth_ID = 0 Then
                    MessageBox.Show("Invalid Cloth Name", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    If dgv_Details.Enabled And dgv_Details.Visible Then
                        dgv_Details.Focus()
                        dgv_Details.CurrentCell = dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Cloth_name)
                    End If
                    Exit Sub
                End If
                ...
                If Val(dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Fold_perc).Value) = 0 Then
                    MessageBox.Show("Invalid Folding", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    If dgv_Details.Enabled And dgv_Details.Visible Then
                        dgv_Details.Focus()
                        dgv_Details.CurrentCell = dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Fold_perc)
                    End If
                    Exit Sub
                End If
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(dgvCol_DelvDetails.Order_Mtrs).Value) <> 0 Then
                        ...
                        Loom_Type = Common_Procedures.LoomType_NameToIdNo(con, dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Loom_Type).Value, tr)
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        ...
        If (e.KeyValue = 40) Then
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(dgvCol_DelvDetails.Cloth_name)
        ...
        With dgv_Details
            ...
            If (e.KeyValue = 40 And cbo_Grid_ClothName.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
                ...
                Else
                    ...
                    If dgv_Details.Columns(dgvCol_DelvDetails.Loom_Type).Visible = True Then
                        .Focus()
    ...
    Private Sub btn_SMS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_SMS.Click
        ...
        Try
            ...
            If dgv_Details.RowCount > 0 Then
                For i = 0 To dgv_Details.RowCount - 1
                    If Val(dgv_Details.Rows(i).Cells(6).Value) <> 0 Then
                        smstxt = smstxt & "  Cloth Name : " & Trim((dgv_Details.Rows(i).Cells(dgvCol_DelvDetails.Cloth_name).Value)) & Chr(13)
    ...
    Private Sub Cloth_Invoice_Selection()
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(11).Value) = 1 Then
                ...
                sno = sno + 1
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.SlNo).Value = Val(sno)
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Cloth_name).Value = dgv_Selection.Rows(i).Cells(3).Value
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Type).Value = dgv_Selection.Rows(i).Cells(4).Value
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Fold_perc).Value = dgv_Selection.Rows(i).Cells(5).Value

                If Val(dgv_Selection.Rows(i).Cells(20).Value) <> 0 Then
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.bales).Value = dgv_Selection.Rows(i).Cells(20).Value
                Else
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.bales).Value = dgv_Selection.Rows(i).Cells(6).Value
                End If


                If Val(dgv_Selection.Rows(i).Cells(21).Value) <> 0 Then
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Order_pCs).Value = dgv_Selection.Rows(i).Cells(21).Value
                Else
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Order_pCs).Value = dgv_Selection.Rows(i).Cells(7).Value
                End If

                If Val(dgv_Selection.Rows(i).Cells(22).Value) <> 0 Then
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Order_Mtrs).Value = dgv_Selection.Rows(i).Cells(22).Value
                Else
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Order_Mtrs).Value = dgv_Selection.Rows(i).Cells(8).Value
                End If

                If Val(dgv_Selection.Rows(i).Cells(23).Value) <> 0 Then
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.RAte).Value = dgv_Selection.Rows(i).Cells(23).Value
                Else
                    dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.RAte).Value = dgv_Selection.Rows(i).Cells(9).Value
                End If

                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Cancel_Mtrs).Value = dgv_Selection.Rows(i).Cells(10).Value
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Offer_No).Value = dgv_Selection.Rows(i).Cells(1).Value
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Cloth_Purchase_Offer_Code).Value = dgv_Selection.Rows(i).Cells(18).Value
                dgv_Details.Rows(n).Cells(dgvCol_DelvDetails.Cloth_Purchase_Offer_Slno).Value = dgv_Selection.Rows(i).Cells(19).Value
    ...
    Private Sub cbo_Grid_loomType_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Grid_LoomType.KeyDown
        ...
        If (e.KeyValue = 40 And cbo_Grid_LoomType.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            ...
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(dgvCol_DelvDetails.Cloth_name)
            End If
        ...
        ElseIf (e.KeyValue = 38 And cbo_Grid_LoomType.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            ...
            If dgv_Details.Rows.Count > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(dgvCol_DelvDetails.Order_Mtrs)
            End If
    ...
    Private Sub Printing_Format_1186(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = Val(35) : ClAr(2) = 300 : ClAr(3) = 100 : ClAr(4) = 0 : ClAr(5) = 100 : ClAr(6) = 80
        ClAr(7) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6))
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(prn_DetIndx).Item("Sl_No").ToString), LMargin + 15, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClAr(1) + 10, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(prn_DetIndx).Item("loomType_Name").ToString), LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                        'Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Fold_Perc").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Order_Meters").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Rate").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format_1186_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        If prn_HdDt.Rows(0).Item("Delivery_GSTinNo").ToString <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, "GSTIN  : " & prn_HdDt.Rows(0).Item("Delivery_GSTinNo").ToString, LMargin + C1 + w2 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format_1186_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        CurY = CurY + TxtHgt - 10
        If Trim(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> "" Then
            Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("AddLessAfterTax_Text").ToString), LMargin + 10, CurY, 0, 0, p1Font)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Discount_Amount").ToString) <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, " : " & Trim(prn_HdDt.Rows(0).Item("Discount_Amount").ToString), LMargin + W1 + 10, CurY, 0, 0, pFont)
        ...
        Common_Procedures.Print_To_PrintDocument(e, " : " & Trim(prn_HdDt.Rows(0).Item("Gr_time").ToString) & " / " & Trim(prn_HdDt.Rows(0).Item("Gr_Date").ToString), LMargin + W1 + 10, CurY, 0, 0, pFont)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, " GST %", LMargin + 10, CurY, 0, 0, p1Font)
        Common_Procedures.Print_To_PrintDocument(e, " : " & Val(prn_DetDt.Rows(0).Item("Item_GST_Percentage").ToString), LMargin + W1 + 10, CurY, 0, 0, pFont)
        If Trim(prn_HdDt.Rows(0).Item("Delivery_Schedule").ToString) <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, " : " & Trim(prn_HdDt.Rows(0).Item("Delivery_Schedule").ToString), LMargin + W1 + 10, CurY, 0, 0, pFont)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Transportname").ToString) <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, " : " & Trim(prn_HdDt.Rows(0).Item("Transportname").ToString), LMargin + W1 + 10, CurY, 0, 0, pFont)
        End If
