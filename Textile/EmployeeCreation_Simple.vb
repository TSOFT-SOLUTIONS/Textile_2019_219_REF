Public Class EmployeeCreation_Simple
    ...
    Private Sub EmployeeCreation_Simple_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1428" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1474" Then
            txt_Salary_Bobin.Visible = False
            Label3.Visible = False
        Else
            txt_Salary_Bobin.Visible = True
            Label3.Visible = True
        End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Employee_Creation, New_Entry, Me) = False Then Exit Sub


        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Masters_Employee_Simple_Creation, "~L~") = 0 And InStr(Common_Procedures.UR.Masters_Employee_Simple_Creation, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Masters_Employee_Simple_Creation, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Employee_Creation, New_Entry, Me) = False Then Exit Sub
    ...
    Private Sub txt_Name_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Name.KeyDown
        ...
        If e.KeyCode = 40 Then
            If txt_Salary_Bobin.Visible Then
                txt_Salary_Bobin.Focus()
            Else
                If MessageBox.Show("Do you want to save?", "FOR SAVING...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    save_record()
                End If
