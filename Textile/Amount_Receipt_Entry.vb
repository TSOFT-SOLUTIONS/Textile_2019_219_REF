Public Class Amount_Receipt_entry
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.ledger_Name  from Receipt_Voucher_Head a LEFT OUTER JOIN Ledger_Head b ON a.ledger_IdNo = b.ledger_IdNo  where a.Receipt_Voucher_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RecNo.Text = dt1.Rows(0).Item("Receipt_Voucher_No").ToString
                ' dtp_Date.Text = dt1.Rows(0).Item("Receipt_Voucher_Date").ToString

                dtp_voucher_date.Text = dt1.Rows(0).Item("Receipt_Voucher_Date").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code = '" & Trim(NewCode) & "' "
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Receipt_Voucher_No from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code = '" & Trim(Pk_Condition) & Trim(InvCode) & "' AND Receipt_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Receipt_Voucher_No from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Receipt_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%'  Order by for_Orderby, Receipt_Voucher_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Receipt_Voucher_No from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Receipt_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Receipt_Voucher_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Receipt_Voucher_No from Receipt_Voucher_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Receipt_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, Receipt_Voucher_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Receipt_Voucher_No from Receipt_Voucher_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  AND Receipt_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Receipt_Voucher_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Receipt_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            dt = New DataTable
            da.Fill(dt)
            ...
            Da1 = New SqlClient.SqlDataAdapter("select top 1 * from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Receipt_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by  Receipt_Voucher_No desc, For_OrderBy desc", con)
            Dt1 = New DataTable
            Da1.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
                '  dtp_Date.Text = Dt1.Rows(0).Item("Receipt_Voucher_Date").ToString
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.CommandText = "select Receipt_Voucher_No from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Receipt_Voucher_No = '" & Trim(inpno) & "' and Receipt_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'"
            'cmd.CommandText = "select Receipt_Voucher_No from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Receipt_Voucher_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        '    Da1 = New SqlClient.SqlDataAdapter("Select a.*, c.ledger_name as Employee_name, d.ledger_name as Debitor_name, c.ledger_address1, c.ledger_address2, c.ledger_address3, c.ledger_address4 from Receipt_Voucher_Head a, ledger_head c, ledger_head d where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Receipt_Voucher_Code = '" & Trim(entcode) & "' and a.Employee_idno = c.ledger_idno and a.DebitAc_idno = d.ledger_idno", con)
        '    Da1.Fill(Dt1)
        '    ' Else
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        'If Trim(LCase(lbl_VouType.Text)) = "purc" Or Trim(LCase(lbl_VouType.Text)) = "rcpt" Or Trim(LCase(lbl_VouType.Text)) = "csrp" Or Trim(LCase(lbl_VouType.Text)) = "crnt" Then
        Da1 = New SqlClient.SqlDataAdapter("Select a.*, d.ledger_name as Debitor_name,  b.*  from Receipt_Voucher_Head a,c.*,Ledger_head c,  ledger_head d,Company_Head b where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Receipt_Voucher_Code = '" & Trim(entcode) & "' and a.member_IdNo = c.ledger_IdNo and a.DebitAc_idno = d.ledger_idno and a.Company_IdNo = b.Company_IdNo", con)
        Da1.Fill(prn_HdDt)
        ' Else
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Receipt_Voucher_Head", "Receipt_Voucher_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Receipt_Voucher_Head (        Receipt_Voucher_Code   ,                 Company_IdNo     ,          Receipt_Voucher_No  ,                               for_OrderBy                               , Receipt_Voucher_Date,           Ledger_IdNo      ,                 Amount   ,               Payment_Mode          ,                   DebitAc_IdNo        ,               Reference_No ,        ChequeBank_Name        ,    Cheque_Date    ,              Remarks    ) " &
            ...
            If Common_Procedures.Voucher_Updation(con, "Rec.Vou", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_RecNo.Text), dtp_voucher_date.Value.Date, Trim(vVouNar) & " ", vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub btn_filtershow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_filtershow.Click
        ...
        Try
            ...
            If IsDate(dtp_FilterFrom_date.Value) = True And IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a.Receipt_Voucher_Date between '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterFrom_date.Value) = True Then
                Condt = "a.Receipt_Voucher_Date = '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a.Receipt_Voucher_Date= '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as Member_Name from Receipt_Voucher_Head a INNER JOIN Ledger_Head b ON a.Ledger_Idno = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Receipt_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Receipt_Voucher_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_filter.Rows(n).Cells(0).Value = " " & dt2.Rows(i).Item("Receipt_Voucher_No").ToString
                    ' dgv_filter.Rows(n).Cells(1).Value = " " & dt2.Rows(i).Item("Voucher_No").ToString
                    dgv_filter.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Receipt_Voucher_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_CashCheque_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PaymentMode.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            If Trim(cbo_PaymentMode.Text) <> "CASH" Then
                ...
                Da1 = New SqlClient.SqlDataAdapter("select top 1 * from Receipt_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Receipt_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and Payment_Mode ='CHEQUE' ", con)
                Dt1 = New DataTable
                Da1.Fill(Dt1)
                If Dt1.Rows.Count > 0 Then
                    '  dtp_Date.Text = Dt1.Rows(0).Item("Receipt_Voucher_Date").ToString
            ...
            If FrmLdSTS = True Then
                ...
                If Val(RptSubReport_Index) > 0 And Trim(RptSubReport_VouCode) <> "" Then
                    ...
                    If Common_Procedures.CompIdNo <> 0 Then
                        ...
                        OrdByNo_Code = ""
                        Da1 = New SqlClient.SqlDataAdapter("Select a.For_OrderBy from Receipt_Voucher_Head a Where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Receipt_Voucher_Code = '" & Trim(RptSubReport_VouCode) & "' ", con)
                        Dt1 = New DataTable
                        Da1.Fill(Dt1)
                        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub cbo_chequeBank_GotFocus(sender As Object, e As System.EventArgs) Handles cbo_chequeBank.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Receipt_Voucher_Head", "ChequeBank_Name", "", "")
    End Sub
    ...
    Private Sub cbo_chequeBank_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cbo_chequeBank.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_chequeBank, txt_ReferenceNo, msk_Date, "Receipt_Voucher_Head", "ChequeBank_Name", "", "")
    End Sub
    ...
    Private Sub cbo_chequeBank_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_chequeBank.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_chequeBank, msk_Date, "Receipt_Voucher_Head", "ChequeBank_Name", "", "", False)
    End Sub
