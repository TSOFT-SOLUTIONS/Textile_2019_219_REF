Public Class Garments_Price_List_Entry
    ...
    Private Sub Grid_Cell_DeSelect()
        On Error Resume Next
        If Not IsNothing(dgv_PriceListdetails.CurrentCell) Then dgv_PriceListdetails.CurrentCell.Selected = False
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Garments_Price_List_Details where Price_List_IdNo = " & Str(Val(lbl_IdNo.Text))
            cmd.ExecuteNonQuery()


            cmd.Connection = con
            cmd.CommandText = "delete from Garments_Price_List_Head where Price_List_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select * from Garments_Price_List_Head where Price_List_IdNo = " & Str(Val(idno)), con)
        dt = New DataTable
        da.Fill(dt)
        ...
        If dt.Rows.Count > 0 Then
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name from Garments_Price_List_Details a, Item_Head b where a.Price_List_IdNo = " & Str(Val(idno)) & " and a.Item_idno = b.Item_idno Order by a.sl_no", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_PriceListdetails.Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("Rate")), "#########0.00")
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Price_List_IdNo) from Garments_Price_List_Head Where Price_List_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Price_List_IdNo) from Garments_Price_List_Head Where Price_List_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Price_List_IdNo) from Garments_Price_List_Head Where Price_List_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and Price_List_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Price_List_IdNo) from Garments_Price_List_Head Where Price_List_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and Price_List_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Garments_Price_List_Head", "Price_List_IdNo", "")
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Garments_Price_List_Head", "Price_List_IdNo", "", trans)

                cmd.CommandText = "Insert into Garments_Price_List_Head(Price_List_IdNo, Price_List_Name, Sur_Name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_PriceListName.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Garments_Price_List_Head set Price_List_Name = '" & Trim(txt_PriceListName.Text) & "', Sur_Name = '" & Trim(Sur) & "' Where Price_List_IdNo = " & Str(Val(lbl_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            With dgv_PriceListdetails
                ...
                For i = 0 To .RowCount - 1
                    Itm_id = Common_Procedures.Item_NameToIdNo1(con, .Rows(i).Cells(1).Value, trans)

                    If Val(Itm_id) <> 0 Then
                        SNo = SNo + 1
                        cmd.CommandText = "Insert into Garments_Price_List_Details(Price_List_IdNo, sl_no, Item_IdNo,Rate) values (" & Str(Val(lbl_IdNo.Text)) & ", " & Str(Val(SNo)) & ", " & Str(Val(Itm_id)) & ", " & Str(Val(.Rows(i).Cells(2).Value)) & ")"
                        cmd.ExecuteNonQuery()
                    End If
                Next
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), Trim(LCase("ix_Garments_Price_List_Head_1"))) > 0 Then
                MessageBox.Show("Duplicate PriceList Name for this Party", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            ElseIf InStr(1, Trim(LCase(ex.Message)), Trim(LCase("ix_Garments_Price_List_Head_2"))) > 0 Then
                MessageBox.Show("Duplicate PriceList Name", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        da = New SqlClient.SqlDataAdapter("select Price_List_Name from Garments_Price_List_Head order by Price_List_Name", con)
        da.Fill(dt)
    ...
    Private Sub dgv_countdetails_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_PriceListdetails.RowsAdded
        ...
        If IsNothing(dgv_PriceListdetails.CurrentCell) Then Exit Sub
        With dgv_PriceListdetails
    ...
    Private Sub btn_Find_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Find.Click
        ...
        If Trim(cbo_Open.Text) = "" Then
            MessageBox.Show("Invalid PriceList Name", "DOES NOT FIND...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Private Sub cbo_Open_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Open.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Open, Nothing, "Garments_Price_List_Head", "Price_List_Name", "", "(Price_List_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
