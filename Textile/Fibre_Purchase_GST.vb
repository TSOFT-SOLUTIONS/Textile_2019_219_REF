Public Class Fibre_Purchase_GST
    ...
    Private Pk_Condition As String = "FIPUR-"
    Private Pk_Condition2 As String = "FIPAC-"
    Private Pk_Condition3 As String = "FIPFR-"
    Private Pk_Condition4 As String = "FIPAT-"
    Private PkCondition5_TDSYP As String = "FITDS-"
    ...
    Private Sub clear()
        ...
        dtp_BillDate.Text = ""
        'If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then  '---- BRT Textiles (Somanur)
        '    msk_BillDate.Enabled = False
        'Else
        '    msk_BillDate.Enabled = True
        'End If
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Fibre_Purchase_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                lbl_RefNo.Text = dt1.Rows(0).Item("Fibre_Purchase_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Fibre_Purchase_Date")
                ...
                'da2 = New SqlClient.SqlDataAdapter("Select a.*, b.MILL_Name, c.Fibre_name , D.Colour_Name from Fibre_Purchase_details a INNER JOIN Mill_Head b ON a.Mill_IdNo = b.Mill_IdNo INNER JOIN Fibre_Head c ON a.Fibre_IdNo = c.Fibre_IdNo LEFT OUTER JOIN COLOUR_Head d ON a.Colour_IdNo = d.Colour_IdNo Where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                '  da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Fibre_Name from Fibre_Purchase_details a INNER JOIN Fibre_Head b  ON a.Fibre_IdNo = b.Fibre_IdNo Where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                da2 = New SqlClient.SqlDataAdapter("Select  a.*, b.Fibre_Name ,c.Mill_name from Fibre_Purchase_details a  INNER JOIN Fibre_Head b   ON a.Fibre_IdNo = b.Fibre_IdNo left join Mill_Head c on a.mill_idno = c.Mill_IdNo Where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(1).Value = Common_Procedures.Fibre_IdNoToName(con, Val(dt2.Rows(i).Item("Fibre_Idno")).ToString)
                            .Rows(n).Cells(2).Value = dt2.Rows(i).Item("Mill_Name").ToString
                            .Rows(n).Cells(3).Value = Val(dt2.Rows(i).Item("bale").ToString)
                            ...
                            End If
                            .Rows(n).Cells(10).Value = dt2.Rows(i).Item("Fibre_Purchase_Receipt_No").ToString



                            '   .Rows(n).Cells(10).Value = dt2.Rows(i).Item("Fibre_Purchase_Receipt_No").ToString
                            .Rows(n).Cells(11).Value = dt2.Rows(i).Item("Fibre_Purchase_Receipt_Code").ToString
                            .Rows(n).Cells(12).Value = Val(dt2.Rows(i).Item("Fibre_Purchase_Receipt_Details_SlNo").ToString)
                            ...
                            .Rows(n).Cells(18).Value = dt2.Rows(i).Item("Fibre_Purchase_Order_No").ToString

                            .Rows(n).Cells(19).Value = dt2.Rows(i).Item("Fibre_Purchase_Order_Code").ToString
                            .Rows(n).Cells(20).Value = Val(dt2.Rows(i).Item("Fibre_Purchase_Order_Details_SlNo").ToString)
                            ...
                            .Rows(n).Cells(21).Value = Format(Val(dt2.Rows(i).Item("Add_Weight").ToString), "########0.000")
                            .Rows(n).Cells(22).Value = Format(Val(dt2.Rows(i).Item("Net_Weight").ToString), "########0.000")
                            .Rows(n).Cells(23).Value = dt2.Rows(i).Item("Lot_No").ToString
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(21).Value = Format(Val(dt1.Rows(0).Item("Total_Add_Weight").ToString), "########0.000")
                    .Rows(0).Cells(22).Value = Format(Val(dt1.Rows(0).Item("Total_Net_Weight").ToString), "########0.000")


                End With
                da4 = New SqlClient.SqlDataAdapter("Select a.* from Fibre_Purchase_GST_Tax_Details a Where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
    ...
    Private Sub Fibre_Purchase_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Fibre_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cbo_CommType.Items.Add("BALE")
        cbo_CommType.Items.Add("%")

        'Common_Procedures.get_VehicleNo_From_All_Entries(con)

        da = New SqlClient.SqlDataAdapter("select distinct(Fibre_Name) from Fibre_Head order by Fibre_Name", con)
        da.Fill(dt7)
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Vehicle_No) from Fibre_Purchase_head order by Vehicle_No", con)
        da.Fill(dt9)
        cbo_VehicleNo.DataSource = dt9
        cbo_VehicleNo.DisplayMember = "Vehicle_No"

        cbo_Grid_RateFor.Items.Clear()
        cbo_Grid_RateFor.Items.Add("BALE")
        cbo_Grid_RateFor.Items.Add("KG")
        cbo_Grid_RateFor.Items.Add("QTL")
        cbo_Grid_RateFor.Items.Add("TONS")
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then
            lbl_heading.Text = "GENERAL PURCHASE"
            Me.Text = "GENERAL PURCHASE"
        End If
        ...
        '        Label1.Text = "VISCOSE YARN PURCHASE"
        ...
        '        Label1.Text = " COTTON YARN PURCHASE"
        '        Label1.Tag = Val(vEntry_Yarn_No)
    ...
    Private Sub Fibre_Purchase_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub Fibre_purchase_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
            ...
            With dgv1
                ...
                If keyData = Keys.Enter Or keyData = Keys.Down Then
                    ...
                    If dgv_Details.Columns(9).Visible = True Then
                        ...
                        If .CurrentCell.ColumnIndex >= .ColumnCount - 12 Then
                            ...
                            Else
                                If Trim(UCase(cbo_EntryType.Text)) = "RECEIPT" Or Trim(UCase(cbo_EntryType.Text)) = "ORDER" Then
                    ...
                    Else
                        ...
                        ElseIf .CurrentCell.ColumnIndex = 7 Then
                            ...
                            .CurrentCell = .Rows(.CurrentCell.RowIndex).Cells(21)
                ...
                ElseIf keyData = Keys.Up Then
                    ...
                    Else
                        ...
                        ElseIf .CurrentCell.ColumnIndex = 21 Then
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '    If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Purchase_Entry, New_Entry, Me, con, "Yarn_Purchase_Head", "Fibre_Purchase_Code", NewCode, "Yarn_Purchase_Date", "(Fibre_Purchase_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub


        If Common_Procedures.settings.Vefified_Status = 1 Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
            If Val(Common_Procedures.get_FieldValue(con, "Fibre_Purchase_Head", "Verified_Status", "(Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        Try
            ...
            ' Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Purchase_Head", "Fibre_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Fibre_Purchase_Code, Company_IdNo, for_OrderBy", trans)
            '  Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Fibre_Purchase_Details", "Fibre_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Fibre_IdNo,Lot_No,bale,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Fibre_Purchase_Receipt_No ,  Fibre_Purchase_Receipt_Code,  Fibre_Purchase_Receipt_Details_SlNo,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage", "Sl_No", "Fibre_Purchase_Code, For_OrderBy, Company_IdNo, Fibre_Purchase_No, Fibre_Purchase_Date, Ledger_Idno,Mill_Idno", trans)
            ...
            '    cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Stock_Type, Reference_Code, Reference_Date, Company_Idno, Ledger_Idno    , Fibre_Idno, Yarn_Type, Mill_IdNo ) " &
            '                          " Select                               'YARN'    , Reference_Code, Reference_Date, Company_IdNo, DeliveryTo_Idno, Fibre_Idno, Yarn_Type, Mill_IdNo from Stock_Yarn_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            '    cmd.ExecuteNonQuery()

            'End If

            'cmd.CommandText = "Update SizSoft_Yarn_Receipt_Details set Fibre_Purchase_Code = '' Where Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            'cmd.ExecuteNonQuery()
            ...
            'cmd.CommandText = "Update Yarn_Purchase_Receipt_Details set Purchase_Bags = a.Purchase_Bags - b.Bags,Purchase_Cones = a.Purchase_Cones - b.Cones,Purchase_Weight = a.Purchase_Weight - b.Weight from Yarn_Purchase_Receipt_Details a, Fibre_Purchase_Details b, Yarn_Purchase_Head c Where b.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Purchase_Type = 'RECEIPT' and b.Fibre_Purchase_Code = c.Fibre_Purchase_Code and a.Yarn_Purchase_Receipt_Code = b.Yarn_Purchase_Receipt_Code and a.Yarn_Purchase_Receipt_Details_SlNo = b.Yarn_Purchase_Receipt_Details_SlNo"
            'cmd.ExecuteNonQuery()

            cmd.CommandText = "Update Fibre_Purchase_Order_Details set Purchase_bale = a.Purchase_bale - b.bale,Purchase_Cones = a.Purchase_Cones - b.Cones,Purchase_Weight = a.Purchase_Weight - b.Weight from Fibre_Purchase_order_Details a, Fibre_Purchase_Details b, Fibre_Purchase_Head c Where b.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Purchase_Type = 'ORDER' and b.Fibre_Purchase_Code = c.Fibre_Purchase_Code and a.Fibre_Purchase_order_Code = b.Fibre_Purchase_Order_Code and a.Fibre_Purchase_Order_Details_SlNo = b.Fibre_Purchase_Order_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "delete from Fibre_Purchase_GST_Tax_Details  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Fibre_Purchase_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Fibre_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_No from Fibre_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code like  '%/" & Trim(Common_Procedures.FnYearCode) & "' and Fibre_Purchase_Code like  '" & Trim(Pk_Condition) & "%' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_No from Fibre_Purchase_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Fibre_Purchase_Code like  '" & Trim(Pk_Condition) & "%' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Fibre_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Purchase_No from Fibre_Purchase_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'and  Fibre_Purchase_Code like  '" & Trim(Pk_Condition) & "%'  and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Fibre_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Purchase_Head", "Fibre_Purchase_Code", "For_OrderBy", "(Fibre_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red


            msk_Date.Text = Date.Today.ToShortDateString
            msk_Date.SelectionStart = 0
            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as PurchaseAcName, c.ledger_name as TaxAcName from Fibre_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.PurchaseAc_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.TaxAc_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Fibre_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' Order by a.for_Orderby desc, a.Fibre_Purchase_No desc", con)
            Da1.Fill(Dt1)

            If Dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If Dt1.Rows(0).Item("Fibre_Purchase_Date").ToString <> "" Then msk_Date.Text = Dt1.Rows(0).Item("Fibre_Purchase_Date").ToString
                End If
                ...
                If Trim(txt_AddLessAfterTax_Text.Text) = "" Then txt_AddLessAfterTax_Text.Text = "Add/Less"
                If Dt1.Rows(0).Item("Purchase_Type").ToString <> "" Then cbo_EntryType.Text = Dt1.Rows(0).Item("Purchase_Type").ToString
                ...
                Da1 = New SqlClient.SqlDataAdapter("Select a.* from Fibre_Purchase_details a Where a.Fibre_Purchase_Code = '" & Trim(Dt1.Rows(0).Item("Fibre_Purchase_Code").ToString) & "' Order by a.sl_no", con)
                Dt2 = New DataTable
                Da1.Fill(Dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Purchase_No from Fibre_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Purchase_No from Fibre_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim lotno As String = ""
        Dim AddAmunt As Single
        Dim NetAmunt As Single
        ...
        '   If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Yarn_Purchase_Entry, New_Entry, Me, con, "Yarn_Purchase_Head", "Fibre_Purchase_Code", NewCode, "Yarn_Purchase_Date", "(Fibre_Purchase_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Yarn_Purchase_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Then
                    ...
                    Cnt_ID = Common_Procedures.Fibre_NameToIdNo(con, .Rows(i).Cells(1).Value)
                    If Cnt_ID = 0 Then
        ...
        If Trim(txt_BillNo.Text) <> "" Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
            Da = New SqlClient.SqlDataAdapter("select * from Fibre_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_IdNo = " & Str(Val(Led_ID)) & " and Bill_No = '" & Trim(txt_BillNo.Text) & "' and Fibre_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and Fibre_Purchase_Code <> '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Purchase_Head", "Fibre_Purchase_Code", "For_OrderBy", "Fibre_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        Cnt_ID = Common_Procedures.Fibre_NameToIdNo(con, .Rows(i).Cells(1).Value, tr)
                        Mill_ID = Common_Procedures.Mill_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)
                        lotno = .Rows(i).Cells(23).Value
                        'AddAmunt = .Rows(i).Cells(10).Value()
                        'NetAmunt = .Rows(i).Cells(18).Value()
                        ...
                        cmd.CommandText = "Insert into Fibre_Purchase_Details ( Fibre_Purchase_Code                        ,               Company_IdNo       ,  Fibre_Purchase_No                  ,            for_OrderBy           , Fibre_Purchase_Date,                    Sl_No     ,                Fibre_IdNo           ,                         Lot_No          ,                        Bale                ,                 Cones                    ,                        Weight            ,                   Rate_For             ,                     Rate                 ,                  Amount                   ,    Colour_Idno            ,   Fibre_Purchase_Receipt_No ,    Fibre_Purchase_Receipt_Code   ,  Fibre_Purchase_Receipt_Details_SlNo ,         Cash_Discount_Percentage             ,              Cash_Discount_Amount         ,                      Taxable_Value        ,                  GST_Percentage           ,                    HSN_Code             , Fibre_Purchase_Order_No         ,        Fibre_Purchase_Order_Code           ,        Fibre_Purchase_Order_Details_Slno           ,                   Add_Weight                ,              Net_Weight                      ,         Mill_Idno       ) " &
                                            "     Values                     ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'       , " & Str(Val(vOrdByNo)) & "       ,   @PurchaseDate   ,          " & Str(Val(Sno)) & ",            " & Str(Val(Cnt_ID)) & ",                  '" & Trim(lotno) & "'  ,   " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", '" & Trim(.Rows(i).Cells(6).Value) & "', " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & " , " & Str(Val(clr_ID)) & ",     '" & Trim(RecNo) & "'    ,    '" & Trim(RecCd) & "'          ,   " & Val(RecSlNo) & "                , " & Str(Val(.Rows(i).Cells(13).Value)) & "  ,       " & Str(Val(.Rows(i).Cells(14).Value)) & ", " & Str(Val(.Rows(i).Cells(15).Value)) & ", " & Str(Val(.Rows(i).Cells(16).Value)) & ", '" & Trim(.Rows(i).Cells(17).Value) & "', '" & Trim(OrderNo) & "'   ,          '" & Trim(OrderCd) & "'           ,          " & Val(OrderSlNo) & "                   ,   " & Str(Val(.Rows(i).Cells(21).Value)) & " ," & Str(Val(.Rows(i).Cells(22).Value)) & "   ,     " & Val(Mill_ID) & " ) "
                        cmd.ExecuteNonQuery()

                        If Trim(UCase(cbo_EntryType.Text)) = "ORDER" Then
                            If Trim(OrderCd) <> "" Then
                                Nr = 0
                                cmd.CommandText = "Update Fibre_Purchase_Order_Details set Purchase_bale = Purchase_bale + " & Str(Val(.Rows(i).Cells(3).Value)) & ",Purchase_Cones = Purchase_Cones + " & Str(Val(.Rows(i).Cells(4).Value)) & ",Purchase_Weight = Purchase_Weight + " & Str(Val(.Rows(i).Cells(5).Value)) & " Where Fibre_Purchase_Order_Code = '" & Trim(OrderCd) & "' and Fibre_Purchase_Order_Details_SlNo = " & Str(Val(OrderSlNo))
                        ...
                        If Trim(UCase(cbo_EntryType.Text)) <> "RECEIPT" Then
                            cmd.CommandText = "Insert into Stock_Fibre_Processing_Details(      Reference_Code,             Company_IdNo                     , Reference_No       ,         for_OrderBy       , Reference_Date,            DeliveryTo_Idno         , ReceivedFrom_Idno,              Entry_ID,          Particulars,                Party_Bill_No,        Sl_No,                   Fibre_IdNo,       Yarn_Type,         Mill_IdNo,                     Bale,                                    Cones,                                          Weight ,                               Colour_IdNo,         DeliveryToIdno_ForParticulars,           ReceivedFromIdno_ForParticulars    ,         Lot_No            ,                Amount                          ,            Fibre_Taxable_Amount ) " &
                                    "Values                       ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(vOrdByNo)) & ", @PurchaseDate ,             " & Str(Val(Del_ID)) & ",       0                , '" & Trim(EntID) & "', '" & Trim(Partcls) & "', '" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ", 'MILL', " & Str(Val(Mill_ID)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(22).Value)) & " , " & Str(Val(clr_ID)) & ",                 0,                                " & Str(Val(Led_ID)) & "        ,  '" & Trim(lotno) & "'   , " & Str(Val(CDbl(lbl_NetAmount.Text))) & "    ,    " & Str(Val(CDbl(txt_AssessableValue.Text))) & "   )"
                            Nr = cmd.ExecuteNonQuery()
                        End If
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1044" Then '---- Ganesh karthick 
                ...
                If Val(vTotBgs) <> 0 Then
                    Bill_Details = Bill_Details & IIf(Bill_Details <> "", ", ", "") & " Total bale : " & Val(vTotBgs)
                End If
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Fibre_Purchase_Details", "Fibre_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Fibre_IdNo,Lot_No,bale,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Fibre_Purchase_Receipt_No ,  Fibre_Purchase_Receipt_Code,  Fibre_Purchase_Receipt_Details_SlNo,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage", "Sl_No", "Fibre_Purchase_Code, For_OrderBy, Company_IdNo, Fibre_Purchase_No, Fibre_Purchase_Date, Ledger_Idno,Mill_Idno", tr)
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Fibre_Purchase_GST_Tax_Details   ( Fibre_Purchase_Code          ,               Company_IdNo       ,      Fibre_Purchase_No                ,                   for_OrderBy     , Fibre_Purchase_Date    ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount                                   ,  GST_Percentage        ) " &
            ...
            cmd.CommandText = "insert into Entry_GST_Tax_Details_Temp(GST_Percentage, CGST_Amount, SGST_Amount, IGST_Amount) select (CGST_Percentage + SGST_Percentage + IGST_Percentage), sum(CGST_Amount), sum(SGST_Amount), sum(IGST_Amount) from Fibre_Purchase_GST_Tax_Details where Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and (CGST_Percentage <> 0 or SGST_Percentage <> 0 or IGST_Percentage <> 0) and (CGST_Amount <> 0 or SGST_Amount <> 0 or IGST_Amount <> 0) Group by CGST_Percentage,  SGST_Percentage,  IGST_Percentage Having sum(CGST_Amount) <> 0 or sum(SGST_Amount) <> 0 or sum(IGST_Amount) <> 0"
            cmd.ExecuteNonQuery()
            ...
            If Common_Procedures.Voucher_Updation(con, "Fibr.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(msk_BillDate.Text), Bill_Details, vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Textile_Software) = False Then
            ...
            vFrgtPartcls = "Purc : Ref No. " & Trim(lbl_RefNo.Text) & " - " & "Mill : " & Trim(vFrstMIlNm) & ", bale : " & Trim(vTotBgs)

            If Common_Procedures.Voucher_Updation(con, "Fibr.Frgt", Val(lbl_Company.Tag), Trim(Pk_Condition3) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(msk_BillDate.Text), vFrgtPartcls, vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Textile_Software) = False Then
                Throw New ApplicationException(ErrMsg)
            End If
            ...
            If Common_Procedures.Voucher_Updation(con, "Fibr.Tds", Val(lbl_Company.Tag), Trim(PkCondition5_TDSYP) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(msk_BillDate.Text), "Bill No : " & Trim(txt_BillNo.Text) & " , FibrPurc.No : " & Trim(lbl_RefNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                Throw New ApplicationException(ErrMsg)
            End If
            ...
            '    cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Stock_Type, Reference_Code, Reference_Date, Company_Idno, Ledger_Idno      , Fibre_Idno, Yarn_Type, Mill_IdNo ) " &
            '                              " Select                               'YARN'    , Reference_Code, Reference_Date, Company_IdNo, ReceivedFrom_Idno, Fibre_Idno, Yarn_Type, Mill_IdNo from Stock_Yarn_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            '    cmd.ExecuteNonQuery()
    ...
    '    CntID = Common_Procedures.Fabric_NameToIdNo(con, dgv_Details.Rows(dgv_Details.CurrentRow.Index).Cells(1).Value)
    ...
    '        Da = New SqlClient.SqlDataAdapter("select * from Mill_Count_Details where mill_idno = " & Str(Val(MilID)) & " and Fibre_Idno = " & Str(Val(CntID)), con)
    '        Da.Fill(Dt)
    '        With dgv_Details

    '            If Dt.Rows.Count > 0 Then
    '                If IsDBNull(Dt.Rows(0)(0).ToString) = False Then
    '                    Wgt_Bag = Dt.Rows(0).Item("Weight_Bale").ToString
    '                    Wgt_Cn = Dt.Rows(0).Item("Weight_Cone").ToString
    '                    Cn_bag = Dt.Rows(0).Item("Cones_Bale").ToString
    '                End If
    '            End If
    ...
    Private Sub cbo_Party_Name_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1094" Then '---- SivaPrakash Cotton Mills (Somanur)
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, msk_Date, cbo_EntryType, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( (( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Ledger_Type = '' or  Ledger_Type = 'AGENT') and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1186" Then ''-----united

            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, msk_Date, cbo_EntryType, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = '' and ( AccountsGroup_IdNo = 14) ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, msk_Date, cbo_EntryType, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        End If
    ...
    Private Sub cbo_Party_Name_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PartyName.KeyPress
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1094" Then '---- SivaPrakash Cotton Mills (Somanur)
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyName, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Ledger_Type = '' or  Ledger_Type = 'AGENT') and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1186" Then ''-----united
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyName, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( ( Ledger_Type = '' and ( AccountsGroup_IdNo = 14) ) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        Else
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, Nothing, txt_delivery_terms, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Purchase_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Fibre_Purchase_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Purchase_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as PartyName, d.Ledger_Name as Delv_Name,b.Lot_No as lot  from Fibre_Purchase_Head a INNER JOIN Fibre_Purchase_Details b ON a.Fibre_Purchase_Code = b.Fibre_Purchase_Code INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON a.DeliveryTo_Idno = d.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " AND Entry_VAT_GST_Type = 'GST' Order by a.for_orderby, a.Fibre_Purchase_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from Yarn_Purchase_Head a INNER JOIN Fibre_Purchase_Details b ON a.Fibre_Purchase_Code = b.Fibre_Purchase_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Yarn_Purchase_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Fibre_Purchase_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Fibre_Purchase_Date").ToString), "dd-MM-yyyy")
                    ...
                    dgv_Filter_Details.Rows(n).Cells(5).Value = Val(dt2.Rows(i).Item("bale").ToString)
                    dgv_Filter_Details.Rows(n).Cells(6).Value = Val(dt2.Rows(i).Item("Lot").ToString)
                ...
                If .Visible = True Then
                    If .Rows.Count > 0 Then
                        ...
                        If e.ColumnIndex = 2 Then
                            ...
                            If cbo_Grid_MillName.Visible = False And (Trim(UCase(cbo_EntryType.Text)) <> "RECEIPT") Or Val(cbo_Grid_MillName.Tag) <> e.RowIndex Then
                        ...
                        If e.ColumnIndex = 23 Then
                            ...
                            If cbo_Grid_lotNo.Visible = False Or Val(cbo_Grid_lotNo.Tag) <> e.RowIndex Then
                                ...
                                Da = New SqlClient.SqlDataAdapter("select LotNo_Name  from Fibre_Lot_Head order by Lot_Idno", con)
                                dt3 = New DataTable
                                Da.Fill(Dt3)
                                cbo_Grid_lotNo.DataSource = dt3
                                cbo_Grid_lotNo.DisplayMember = "LotNo_Name"
    ...
    Private Sub dgv_Details_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellValueChanged
        ...
        Try
            ...
            If dgv_Details.Visible Then
                If dgv_Details.Rows.Count > 0 Then
                    If dgv_Details.CurrentCell.ColumnIndex = 5 Or dgv_Details.CurrentCell.ColumnIndex = 21 Then
                        dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(22).Value = Format(Val(dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(5).Value) + Val(dgv_Details.Rows(dgv_Details.CurrentCell.RowIndex).Cells(21).Value), "########0.000")
                    End If
                    If dgv_Details.CurrentCell.ColumnIndex = 3 Or dgv_Details.CurrentCell.ColumnIndex = 5 Or dgv_Details.CurrentCell.ColumnIndex = 6 Or dgv_Details.CurrentCell.ColumnIndex = 7 Or dgv_Details.CurrentCell.ColumnIndex = 21 Then
            ...
            With dgv_Details
                If .Visible Then
                    ...
                    If .Rows.Count > 0 Then
                        ...
                        If .CurrentCell.ColumnIndex = 3 Or .CurrentCell.ColumnIndex = 4 Or .CurrentCell.ColumnIndex = 6 Or .CurrentCell.ColumnIndex = 21 Or .CurrentCell.ColumnIndex = 22 Then
                    ...
                    If .Rows.Count > 0 Then
                        If CurCol = 3 Or CurCol = 5 Or CurCol = 6 Or CurCol = 7 Then
                            If Common_Procedures.settings.RoundOff_GST_Values = 1 Then
                                ...
                                If Trim(UCase(.Rows(CurRow).Cells(6).Value)) = "BALE" Then
    ...
    Private Sub Total_Calculation()
        ...
        Sno = 0
        TotBgs = 0 : TotCns = 0 : TotWgt = 0 : TotAmt = 0 : TotAddWgt = 0 : TotNetWgt = 0
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" And (Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0) Then
                    ...
                    TotAddWgt = Format(TotAddWgt + Val(.Rows(i).Cells(21).Value), "#########0.000")
                    TotNetWgt = Format(TotNetWgt + Val(.Rows(i).Cells(22).Value), "#########0.000")
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(21).Value = Format(Val(TotAddWgt), "#########0.000")
            .Rows(0).Cells(22).Value = Format(Val(TotNetWgt), "#########0.000")
        End With
    ...
    Private Sub Print_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Fibre_Purchase_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as Transport_Name , e.Ledger_Name as Agent_Name,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code  from Fibre_Purchase_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_HEad CSH on b.Company_State_IdNo = CSH.State_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_HEad LSH on c.Ledger_State_IdNo = LSH.State_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.Agent_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                '    da2 = New SqlClient.SqlDataAdapter("select a.*, b.Fibre_name , c.Mill_Name  from Fibre_Purchase_Details a INNER JOIN Fibre_Head b ON a.Fibre_IdNo = b.Fibre_IdNo LEFT OUTER JOIN Mill_Head c ON a.Mill_IdNo = c.Mill_IdNo where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.for_orderby, a.Fibre_Purchase_No", con)
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Fibre_name , a.lot_no  from Fibre_Purchase_Details a INNER JOIN Fibre_Head b ON a.Fibre_IdNo = b.Fibre_IdNo  where a.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.for_orderby, a.Fibre_Purchase_No", con)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If prn_Status = 1 Then
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1033" Then '----RAJESWARI WEAVING MILLS
                Printing_Format3(e)

            ElseIf Common_Procedures.settings.CustomerCode = "1186" Then
                Printing_Format2_1186(e)
            Else
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + ClArr(2) + 10, CurY, 0, 0, pFont)
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 10, CurY, 1, 0, pFont)
                        End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, c.Ledger_Name as Transport_Name from Fibre_Purchase_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno LEFT OUTER JOIN Ledger_Head c ON c.Ledger_IdNo = a.Transport_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Purchase_Code = '" & Trim(EntryCode) & "' Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Purchase_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "FIBRE", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "" & Trim(prn_HdDt.Rows(0).Item("Total_bale").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format2(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(60) : ClArr(2) = 150 : ClArr(3) = 250 : ClArr(4) = 75 : ClArr(5) = 95 : ClArr(6) = 70
        ClArr(7) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6))
                ...
                If prn_HdDt.Rows.Count > 0 Then
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 11, CurY, 0, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Lot_No").ToString, LMargin + ClArr(1) + ClArr(2) + 11, CurY, 0, 0, pFont)
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 15, CurY, 1, 0, pFont)
                            End If
                            ...
                            'End If
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Weight").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 15, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Rate").ToString, PageWidth - 15, CurY, 1, 0, pFont)
...
LOOP2:
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        CurY = CurY + TxtHgt
        p1Font = New Font("Calibri", 16, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, " FIBRE PURCHASE RECEIPT", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Purchase_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ' End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "FIBRE NAME", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "LOT NO", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "BALE/BAG", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + ClArr(1) + 11, CurY, 0, 0, pFont)
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) - 15, CurY, 1, 0, pFont)
                        End If
    ...
    Private Sub cbo_Agent_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Agent.LostFocus
        ...
        End If
    End Sub
    Private Sub txt_Test1_Cone1_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone1_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone1_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone1_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone1_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone2_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone2_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone2_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone2_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone2_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone3_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone3_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone3_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone3_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone3_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone4_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone4_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone4_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone4_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone4_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone5_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone5_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone5_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone5_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone5_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone6_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone6_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone6_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test1_Cone6_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub


    Private Sub txt_Test2_Cone1_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone1_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone1_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone1_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone1_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone2_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone2_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone2_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone2_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone2_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone3_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone3_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone3_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone3_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone3_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone4_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone4_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone4_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone4_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone4_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone5_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone5_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone5_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone5_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone5_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone6_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone6_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone6_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test2_Cone6_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone1_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone1_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone1_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone1_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone1_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone2_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone2_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone2_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone2_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone2_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone3_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone3_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone3_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone3_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone3_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone4_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone4_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone4_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone4_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone4_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone5_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone5_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone5_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone5_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone5_YarnWeight5_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone6_YarnWeight1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone6_YarnWeight2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone6_YarnWeight3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Test3_Cone6_YarnWeight4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub
    ...
    'Private Sub txt_Test1_Cone2_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone2_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone2_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone2_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone2_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone3_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone3_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone3_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone3_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone3_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone4_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone4_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone4_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone4_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone4_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test1_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_Test1_Cone5_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone5_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone5_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone5_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone5_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test1_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_Test1_Cone6_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone6_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone6_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone6_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_Test1_Cone6_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone1_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone1_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone1_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone1_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone1_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone2_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone2_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone2_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone2_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone2_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone3_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone3_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone3_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone3_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone3_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone4_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone4_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone4_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone4_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone4_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test2_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_test2_Cone5_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone5_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone5_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone5_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone5_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test2_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_test2_Cone6_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone6_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone6_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone6_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test2_Cone6_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone1_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone1_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone1_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone1_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone1_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone2_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone2_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone2_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone2_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone2_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone3_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone3_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone3_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone3_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone3_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone4_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone4_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone4_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone4_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone4_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test3_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_test3_Cone5_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone5_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone5_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone5_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone5_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Final_Test3_Average_Mean_SD_CV_Calculation()
    'End Sub
    'Private Sub txt_test3_Cone6_YarnWeight1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone6_YarnWeight2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone6_YarnWeight3_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone6_YarnWeight4_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_test3_Cone6_YarnWeight5_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        If Trim(UCase(cbo_EntryType.Text)) = "RECEIPT" Then
            ...
            With dgv_Selection
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_Name,d.Mill_Name,e.Ledger_Name as DeliveryAt ,f.Ledger_Name as Transport,h.Bags as Ent_Bags, h.Cones as Ent_Cones, h.Weight as Ent_Wgt,h.Rate as Ent_Rate from Yarn_Purchase_Receipt_Head a INNER JOIN Yarn_Purchase_Receipt_details b ON a.Yarn_Purchase_Receipt_Code = b.Yarn_Purchase_Receipt_Code INNER JOIN Fibre_Head c ON b.Fibre_Idno = c.Fibre_Idno INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo  LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.DeliveryAt_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Fibre_Purchase_Details h ON h.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Purchase_Receipt_Code = h.Yarn_Purchase_Receipt_Code and b.Yarn_Purchase_Receipt_Details_SlNo = h.Yarn_Purchase_Receipt_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "  ((b.Weight - b.Purchase_Weight) > 0 or h.Weight > 0 ) order by a.Yarn_Purchase_Receipt_Date, a.for_orderby, a.Yarn_Purchase_Receipt_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(6).Value = Dt1.Rows(i).Item("DeliveryAt").ToString

                        .Rows(n).Cells(7).Value = (Val(Dt1.Rows(i).Item("Bags").ToString) - Val(Dt1.Rows(i).Item("Purchase_Bags").ToString) + Val(Ent_Bags))
                        .Rows(n).Cells(8).Value = (Val(Dt1.Rows(i).Item("Cones").ToString) - Val(Dt1.Rows(i).Item("Purchase_Cones").ToString) + Val(Ent_Cones))
                        .Rows(n).Cells(9).Value = Format(Val(Dt1.Rows(i).Item("Weight").ToString) - Val(Dt1.Rows(i).Item("Purchase_Weight").ToString) + Val(Ent_Wgt), "#########0.00")
        ...
        ElseIf Trim(UCase(cbo_EntryType.Text)) = Trim(UCase("ORDER")) Then

            vLED_UndIdNo = LedIdNo

            Da = New SqlClient.SqlDataAdapter("select * from Ledger_Head where Ledger_idno = " & Str(Val(vLED_UndIdNo)), con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
                If IsDBNull(Dt1.Rows(0).Item("LedgerGroup_Idno").ToString) = False Then
                    If Val(Dt1.Rows(0).Item("LedgerGroup_Idno").ToString) <> 0 Then vLED_UndIdNo = Val(Dt1.Rows(0).Item("LedgerGroup_Idno").ToString)
                End If
            End If
            Dt1.Clear()

            Da = New SqlClient.SqlDataAdapter("select * from Ledger_Head where LedgerGroup_Idno = " & Str(Val(vLED_UndIdNo)), con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            ...
            If Dt1.Rows.Count > 0 Then
                For i = 0 To Dt1.Rows.Count - 1
                    vLED_GrpIdNos = Trim(vLED_GrpIdNos) & IIf(Trim(vLED_GrpIdNos) <> "", ", ", "") & Trim(Val(Dt1.Rows(i).Item("Ledger_IdNo")))
                Next
            End If
            If Trim(vLED_GrpIdNos) <> "" Then
                vLED_GrpIdNos = "(" & vLED_GrpIdNos & ")"
            Else
                vLED_GrpIdNos = "(" & Trim(Val(LedIdNo)) & ")"
            End If

            vLEDID_Cond = "(a.Ledger_IdNo = " & Str(LedIdNo) & " or a.Ledger_IdNo IN " & Trim(vLED_GrpIdNos) & ")"
            ...
            With dgv_Order_Selection
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Fibre_nAME, e.Ledger_Name as DeliveryAt ,f.Ledger_Name as Transport,h.bale as Ent_bale, h.Cones as Ent_Cones, h.Weight as Ent_Wgt,h.Rate as Ent_Rate from Fibre_Purchase_Order_Head a INNER JOIN Fibre_Purchase_Order_Details b ON a.Fibre_Purchase_Order_Code = b.Fibre_Purchase_Order_Code INNER JOIN Fibre_Head c ON b.Fibre_Idno = c.Fibre_Idno   LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.DeliveryTo_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Fibre_Purchase_Details h ON h.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Fibre_Purchase_Order_Code = h.Fibre_Purchase_Order_Code and b.Fibre_Purchase_Order_Details_SlNo = h.Fibre_Purchase_Order_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "  " & Trim(vLEDID_Cond) & " and ((b.Weight - b.Purchase_Weight - b.Cancelled_Weight) > 0 or h.Weight > 0 ) order by a.Fibre_Purchase_Order_Date, a.for_orderby, a.Fibre_Purchase_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        Ent_Wgt = 0
                        Ent_Rate = 0
                        If IsDBNull(Dt1.Rows(i).Item("Ent_bale").ToString) = False Then
                            Ent_Bags = Val(Dt1.Rows(i).Item("Ent_bale").ToString)
                        End If
                        If IsDBNull(Dt1.Rows(i).Item("Ent_Cones").ToString) = False Then
                            Ent_Cones = Dt1.Rows(i).Item("Ent_Cones").ToString
                        End If
                        ...
                        SNo = SNo + 1
                        .Rows(n).Cells(0).Value = Val(SNo)
                        .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_No").ToString
                        .Rows(n).Cells(2).Value = Format(Convert.ToDateTime(Dt1.Rows(i).Item("Fibre_Purchase_Order_Date").ToString), "dd-MM-yyyy")
                        .Rows(n).Cells(3).Value = Dt1.Rows(i).Item("Fibre_nAME").ToString
                        ...
                        If Trim(.Rows(n).Cells(1).Value) = "12" Then
                            Debug.Print("aaa")
                        End If
                        .Rows(n).Cells(6).Value = (Val(Dt1.Rows(i).Item("Bale").ToString) - Val(Dt1.Rows(i).Item("Purchase_Bale").ToString)) '+ Val(Ent_Bags))
                        .Rows(n).Cells(7).Value = (Val(Dt1.Rows(i).Item("Cones").ToString) - Val(Dt1.Rows(i).Item("Purchase_Cones").ToString)) '+ Val(Ent_Cones))
                        .Rows(n).Cells(8).Value = Format(Val(Dt1.Rows(i).Item("Weight").ToString) - Val(Dt1.Rows(i).Item("Purchase_Weight").ToString) - Val(Dt1.Rows(i).Item("Cancelled_Weight").ToString) + Val(Ent_Wgt), "#########0.00")
                        ...
                        .Rows(n).Cells(14).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_Code").ToString
                        .Rows(n).Cells(15).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_Details_SlNo").ToString


                        .Rows(n).Cells(16).Value = Val(Ent_Bags)
                        .Rows(n).Cells(17).Value = Ent_Cones
        ...
        ElseIf Trim(UCase(cbo_EntryType.Text)) = Trim(UCase("SIZING-YARNRECEIPT")) Then
            ...
            With dgv_Sizing_YarnReceipt_Selection
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_nAME, d.Mill_Name, isnull(f.Ledger_Name,'') as TransportName, " &
                                                  " isnull(h.Bags, 0) as Ent_Bags, isnull(h.Cones,0) as Ent_Cones, isnull(h.Weight,0) as Ent_Wgt, isnull(h.Rate,0) as Ent_Rate , " &
                                                  " isnull(h.Rate_For,'') as Ent_RateFor " &
                                                  " from SizSoft_Yarn_Receipt_Head a " &
                                                  " INNER JOIN SizSoft_Yarn_Receipt_Details b ON a.Yarn_Receipt_Code = b.Yarn_Receipt_Code " &
                                                  " INNER JOIN Fibre_Purchase_Order_Head tYPOH ON tYPOH.Ledger_IdNo = " & Str(Val(LedIdNo)) & " and tYPOH.Fibre_Purchase_Order_Code = b.Fibre_Purchase_Order_Code " &
                                                  " INNER JOIN Fibre_Head c ON b.Fibre_Idno = c.Fibre_Idno INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo " &
                                                  " LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo " &
                                                  " LEFT OUTER JOIN Fibre_Purchase_Details h ON h.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Receipt_Code = h.SizSoft_Yarn_Receipt_Code and b.Yarn_Receipt_DetailsSlno = h.SizSoft_Yarn_Receipt_Details_Slno " &
                                                  " Where a.Entry_Type = 'ORDER' and (b.Fibre_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' or b.Fibre_Purchase_Code = '') and tYPOH.Ledger_IdNo = " & Str(Val(LedIdNo)) & " " &
                                                  " Order by b.Fibre_Purchase_Code Desc, a.Yarn_Receipt_Date, a.for_orderby, a.Yarn_Receipt_No, a.Yarn_Receipt_Code", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        If IsDBNull(Dt1.Rows(i).Item("Ent_Rate").ToString) = False Then
                            Ent_Rate = Val(Dt1.Rows(i).Item("Ent_Rate").ToString)
                        End If
                        If IsDBNull(Dt1.Rows(i).Item("Ent_RateFor").ToString) = False Then
                            Ent_Ratefor = Dt1.Rows(i).Item("Ent_RateFor").ToString
                        End If

                        SNo = SNo + 1
                        .Rows(n).Cells(0).Value = Val(SNo)
                        .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("Yarn_Receipt_No").ToString
                        .Rows(n).Cells(2).Value = Format(Convert.ToDateTime(Dt1.Rows(i).Item("Yarn_Receipt_Date").ToString), "dd-MM-yyyy")
                        .Rows(n).Cells(3).Value = Dt1.Rows(i).Item("Bill_No").ToString
                        .Rows(n).Cells(4).Value = Dt1.Rows(i).Item("Count_Name").ToString
                        .Rows(n).Cells(5).Value = Dt1.Rows(i).Item("Mill_Name").ToString
                        ...
                        .Rows(n).Cells(9).Value = Format(Val(Dt1.Rows(i).Item("Weight").ToString), "##########0.000")
                        ...
                        End If
                        .Rows(n).Cells(11).Value = Dt1.Rows(i).Item("Yarn_Receipt_Code").ToString
                        .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Yarn_Receipt_DetailsSlno").ToString


                        .Rows(n).Cells(13).Value = Ent_Bags
                        .Rows(n).Cells(14).Value = Ent_Cones
                        .Rows(n).Cells(15).Value = Ent_Wgt
                        .Rows(n).Cells(16).Value = Dt1.Rows(i).Item("TransportName").ToString
                        .Rows(n).Cells(17).Value = Dt1.Rows(i).Item("Vehicle_No").ToString
                        .Rows(n).Cells(18).Value = Ent_Rate
                        .Rows(n).Cells(19).Value = Ent_Ratefor
                        .Rows(n).Cells(20).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_No").ToString
                        .Rows(n).Cells(21).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_Code").ToString
                        .Rows(n).Cells(22).Value = Dt1.Rows(i).Item("Fibre_Purchase_Order_Details_SlNo").ToString

                    Next

                End If
                Dt1.Clear()
                pnl_Sizing_YarnReceipt_Selection.Visible = True
                pnl_Sizing_YarnReceipt_Selection.BringToFront()
                pnl_Back.Enabled = False
                dgv_Sizing_YarnReceipt_Selection.Focus()
            ...
            '            Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Purchase_Code = '" & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
            '            Dt1 = New DataTable
            '            Da.Fill(Dt1)
            ...
            '            Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code   LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Fibre_Purchase_Code = a.Own_order_Code    where a.Fibre_Purchase_Code = ''  and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
            '            Dt1 = New DataTable
            '            Da.Fill(Dt1)
            ...
            '            Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Fibre_Purchase_Code = '" & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
            '            Dt1 = New DataTable
            '            Da.Fill(Dt1)
            ...
            '            Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno    LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Fibre_Purchase_Code = a.Own_Order_Code    where a.Fibre_Purchase_Code = ''   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
            '            Dt1 = New DataTable
            '            Da.Fill(Dt1)
    ...
    Private Sub Get_GST_Percentage_From_ItemGroup(ByVal CountName As String, ByRef HSN_Code As String, ByRef GST_PerCent As Single)
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("Select * from Fibre_Head a Where a.Fibre_Name ='" & Trim(CountName) & "'", con)
            '  da = New SqlClient.SqlDataAdapter("select a.* from ItemGroup_Head a INNER JOIN Fibre_Head b ON a.ItemGroup_IdNo = b.ItemGroup_IdNo Where b.Count_Name ='" & Trim(CountName) & "'", con)
            dt = New DataTable
            da.Fill(dt)
            ...
            If dt.Rows.Count > 0 Then
                ...
                End If
                If IsDBNull(dt.Rows(0).Item("GST_Percentage").ToString) = False Then
                    ...
                    GST_PerCent = Val(dt.Rows(0).Item("GST_Percentage").ToString)
    ...
    Private Sub Printing_FormatGST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(30) : ClArr(2) = 130 : ClArr(3) = 85 : ClArr(4) = 60 : ClArr(5) = 80 : ClArr(6) = 55 : ClArr(7) = 100 : ClArr(8) = 80
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Lot_No").ToString)
                        ItmNm2 = ""
                        ...
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 10, CurY, 1, 0, pFont)
                        End If
    ...
    Private Sub Printing_FormatGST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_bale").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Fibre_Purchase_GST_Tax_Details Where Fibre_Purchase_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub dgv_Selectiodgv_Order_Selection_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgv_Order_Selection.KeyDown
        Dim n As Integer
    ...
    Private Sub btn_Close_Order_Selection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Close_Order_Selection.Click
        Close_Purchase_Order_Selection()
    End Sub

    Private Sub Close_Purchase_Order_Selection()
        Dim Da1 As New SqlClient.SqlDataAdapter
        Dim Dt1 As New DataTable
        Dim n As Integer = 0
        Dim sno As Integer = 0
        ...
        For i = 0 To dgv_Order_Selection.RowCount - 1
            ...
            If Val(dgv_Order_Selection.Rows(i).Cells(12).Value) = 1 Then
                ...
                lbl_OrderCode.Text = dgv_Order_Selection.Rows(i).Cells(29).Value
                cbo_Delvat.Text = dgv_Order_Selection.Rows(i).Cells(13).Value
                ...
                txt_AddLess_BeforeTax.Text = dgv_Order_Selection.Rows(i).Cells(24).Value
                txt_Freight.Text = dgv_Order_Selection.Rows(i).Cells(25).Value
                ...
                End If
                If Trim(UCase(dgv_Order_Selection.Rows(i).Cells(9).Value)) = "BALE" Then
                ...
                dgv_Details.Rows(n).Cells(22).Value = Val(dgv_Details.Rows(n).Cells(5).Value)
    ...
    Private Sub msk_Date_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles msk_Date.TextChanged
        ...
        NetAmount_Calculation()
    End Sub
    'Private Sub dgv_OwnOrderSelection_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
    ...
    'Private Sub dgv_OwnOrderSelection_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Dim n As Integer
    ...
    'Private Sub btn_Close_OwnOrderSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs)
...
LOOP2:
    ...
    Private Sub Printing_Format2_1186_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
        CurY = CurY + TxtHgt - 12
        Common_Procedures.Print_To_PrintDocument(e, " GENERAL PURCHASE RECEIPT", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "S.NO", LMargin, CurY, 2, ClAr(1), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "PARTICULAR", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "LOT NO", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "BALE/BAG", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "CONES", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
    ...
    Private Sub Close_SizingYarnReceipt_Selection()
        ...
        For i = 0 To dgv_Sizing_YarnReceipt_Selection.RowCount - 1
            ...
            If Val(dgv_Sizing_YarnReceipt_Selection.Rows(i).Cells(10).Value) = 1 Then
                ...
                vDELVTONAME = ""
                vAGENTNAME = ""
                Da = New SqlClient.SqlDataAdapter("select a.Rate, a.Rate_For, tDELV.Ledger_Name as DelvToName, tAG.Ledger_Name as AgentName from Fibre_Purchase_Order_Details a INNER JOIN Fibre_Purchase_Order_Head b ON a.Fibre_Purchase_Order_Code = b.Fibre_Purchase_Order_Code INNER JOIN Ledger_Head tDELV ON tDELV.Ledger_IdNo = b.DeliveryTo_Idno LEFT OUTER JOIN Ledger_Head tAG ON tAG.Ledger_IdNo = b.Agent_IdNo Where a.Fibre_Purchase_Order_Code = '" & Trim(dgv_Sizing_YarnReceipt_Selection.Rows(i).Cells(21).Value) & "' and a.Fibre_Purchase_Order_Details_Slno = " & Str(Val(dgv_Sizing_YarnReceipt_Selection.Rows(i).Cells(22).Value)) & " ", con)
                Dt = New DataTable
                Da.Fill(Dt)
                If Dt.Rows.Count > 0 Then
                ...
                If Trim(UCase(dgv_Sizing_YarnReceipt_Selection.Rows(i).Cells(9).Value)) = Trim(UCase("BALE")) Then
                    dgv_Details.Rows(n).Cells(8).Value = Format(Val(dgv_Details.Rows(n).Cells(3).Value) * Val(dgv_Details.Rows(n).Cells(7).Value), "###########0.00")
                Else
                    dgv_Details.Rows(n).Cells(8).Value = Format(Val(dgv_Details.Rows(n).Cells(5).Value) * Val(dgv_Details.Rows(n).Cells(7).Value), "###########0.00")
                End If
    ...
    Private Sub cbo_Grid_lotNo_GotFocus(sender As Object, e As EventArgs) Handles cbo_Grid_lotNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = '')")
    End Sub

    Private Sub cbo_Grid_lotNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Grid_lotNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_lotNo, Nothing, Nothing, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = '')")
    ...
    Private Sub cbo_Grid_lotNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Grid_lotNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_lotNo, Nothing, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = '')")
    ...
    Private Sub cbo_Grid_lotNo_TextChanged(sender As Object, e As EventArgs) Handles cbo_Grid_lotNo.TextChanged
        Try
            If cbo_Grid_lotNo.Visible Then

                If IsNothing(dgv_Details.CurrentCell) Then Exit Sub
                With dgv_Details
                    If Val(cbo_Grid_lotNo.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 23 Then
    ...
    Private Sub cbo_Grid_lotNo_KeyUp(sender As Object, e As KeyEventArgs) Handles cbo_Grid_lotNo.KeyUp
