Public Class FinishedProduct_Sales_Delivery_1516
    ...
    Private Pk_Condition As String = "SALDE-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from FP_Sales_Delivery_Head a  Where a.FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_Del_No.Text = dt1.Rows(0).Item("FP_Sales_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("FP_Sales_Delivery_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,C.Processed_Item_Name as Fp_Name,d.Colour_Name,e.Size_Name,L.Lot_No from FP_Sales_Delivery_Details a INNER JOIN Processed_Item_Head c ON  c.Processed_Item_IdNo = a.FP_Idno LEFT OUTER JOIN Colour_Head d ON d.Colour_IdNo = a.Colour_IdNo LEFT OUTER JOIN Size_Head e ON e.Size_IdNo = a.Size_IdNo left outer join Lot_Head L on a.Lot_idNo = l.Lot_IdNo where a.FP_Sales_Delivery_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from FP_Sales_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from FP_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Sales_Delivery_No from FP_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, FP_Sales_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Sales_Delivery_No from FP_Sales_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, FP_Sales_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Sales_Delivery_No from FP_Sales_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, FP_Sales_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Sales_Delivery_No from FP_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, FP_Sales_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_Del_No.Text = Common_Procedures.get_MaxCode(con, "FP_Sales_Delivery_Head", "FP_Sales_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode)

            lbl_Del_No.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from FP_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FP_Sales_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    ...
                    If dt1.Rows(0).Item("FP_Sales_Delivery_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("FP_Sales_Delivery_Date").ToString
                End If
            End If
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FP_Sales_Delivery_No from FP_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If Insert_Entry = True Or New_Entry = False Then
                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_Del_No.Text) & "/" & Trim(EntFnYrCode)
            Else
                lbl_Del_No.Text = Common_Procedures.get_MaxCode(con, "FP_Sales_Delivery_Head", "FP_Sales_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode, tr)
                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_Del_No.Text) & "/" & Trim(EntFnYrCode)
            End If
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into FP_Sales_Delivery_Head([FP_Sales_Delivery_Code],	[FP_Sales_Delivery_No]    ,	[For_OrderBy]                                                        ,	[Company_IdNo]                  ,Ledger_IdNo              ,	[FP_Sales_Delivery_Date] ,	[JobCard_Processing_No]  ,	[Total_Quantity]        ,	[user_Idno]            ,	[Delivery_From_IdNo]       ,Transport_IdNo           ,Vehicle_No) Values " &
                                                                         "('" & Trim(NewCode) & "'      , '" & Trim(lbl_Del_No.Text) & "'  , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Del_No.Text))) & ", " & Str(Val(lbl_Company.Tag)) & "," & Led_ID.ToString & "         , @ProcessingDate           ,''                        , " & Str(Val(vTotQty)) & "," & Val(lbl_UserName.Text) & "," & Del_Led_Id.ToString & " ," & Trans_Id.ToString & ",'" & cbo_VehicleNo.Text & "')"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update FP_Sales_Delivery_Head set Ledger_IdNo = " & Led_ID.ToString & ",[FP_Sales_Delivery_Date] =  @ProcessingDate ,	[Total_Quantity]  = " & Str(Val(vTotQty)) & " ,	[user_Idno]  = " & Val(lbl_UserName.Text) & "   ,	[Delivery_From_IdNo] = " & Del_Led_Id.ToString & ",Transport_IdNo = " & Trans_Id.ToString & ",Vehicle_No = '" & cbo_VehicleNo.Text & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into FP_Sales_Delivery_Details ([FP_Sales_Delivery_Code],[Company_IdNo]                    ,Ledger_IdNo            ,	[FP_Sales_Delivery_No] ,	[for_OrderBy]                                                         ,	[FP_Sales_Delivery_Date] ,	[Sl_No]             ,		[FP_IdNo]       ,	[Colour_IdNo]          ,	[Quantity]                        ,Lot_IdNo) " &
                                                                             " Values ('" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & "," & Led_ID.ToString & ",'" & Trim(lbl_Del_No.Text) & "' , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Del_No.Text))) & ", @ProcessingDate               ," & Str(Val(Sno)) & " ," & Str(Val(FP_Id)) & ", " & Str(Val(Col_ID)) & " ,  " & Val(.Rows(i).Cells(5).Value) & "," & Lot_Id.ToString & ")"
                        cmd.ExecuteNonQuery()

                        Nr = 0

                        cmd.CommandText = "Insert into Stock_Item_Processing_Details ( Reference_Code                             ,         Company_IdNo             ,           Reference_No         ,                               for_OrderBy                               , Reference_Date       , ReceivedFrom_StockIdNo       ,    DeliveryTo_StockIdNo          ,         Entry_ID     ,       Particulars      ,  Sl_No            , Item_IdNo         ,  Quantity                            ,Lot_IdNo               ) " &
                                          " Values                                   ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_Del_No.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Del_No.Text))) & ",  @ProcessingDate     , " & Str(Val(Del_Led_Id)) & " , " & Str(Val(Led_ID)) & "         , '" & Trim(EntID) & "', '" & Trim(Partcls) & "', " & i.ToString & "," & Str(FP_Id) & " ,  " & Val(.Rows(i).Cells(5).Value) & "," & Lot_Id.ToString & ") "
                        cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FP_Sales_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.FP_Sales_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FP_Sales_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            End If
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,c.*,d.Processed_Item_Name as Fp_Name,e.Colour_Name,f.Cloth_Name from FP_Sales_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN FP_Sales_Delivery_Details c ON c.FP_Sales_Delivery_Code = a.FP_Sales_Delivery_Code INNER JOIN Processed_Item_Head d ON d.Processed_Item_IdNo = c.FinishedProduct_IdNo INNER JOIN Colour_Head e ON c.Colour_Idno = e.Colour_IdNo LEFT oUTER JOIN Cloth_Head f ON c.Fabric_Idno = f.Cloth_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Sales_Delivery_Code LIKE '%/" & Trim(EntFnYrCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FP_Sales_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("FP_Sales_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("FP_Sales_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from FP_Sales_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from FP_Sales_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)


            If prn_HdDt.Rows.Count > 0 Then
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Fp_Name, c.Colour_Name ,d.Cloth_Name as Fabric_Name ,e.Process_Name  from FP_Sales_Delivery_Details a LEFT OUTER JOIN Processed_Item_Head b on a.FinishedProduct_Idno = b.Processed_Item_IdNo LEFT OUTER JOIN Colour_Head c on a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Cloth_Head d ON d.Cloth_idNo = a.Fabric_Idno LEFT OUTER JOIN Process_Head e ON e.Process_IdNo = a.Process_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Sales_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*,C.Processed_Item_Name as Fp_Name,d.Colour_Name,e.Size_Name,f.Cloth_Name as Fabric_Name,g.Process_Name from FP_Sales_Delivery_Details a INNER JOIN Processed_Item_Head c ON  c.Processed_Item_IdNo = a.FinishedProduct_Idno LEFT OUTER JOIN Colour_Head d ON d.Colour_IdNo = a.Colour_IdNo LEFT OUTER JOIN Size_Head e ON e.Size_IdNo = a.Size_IdNo LEFT OUTER JOIN Cloth_Head f ON f.Cloth_idNo = a.Fabric_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Sales_Delivery_Code = '" & Trim(EntryCode) & "' Order by Sl_No", con)
        dt2 = New DataTable
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FP_Sales_Delivery_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FP_Sales_Delivery_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.* , b.* , c.Cloth_Name, d.Colour_Name ,e.Process_Name,f.Processed_Item_Name ,h.Consum_Meters As Ent_Mtrs, h.Quantity as Ent_Qty from Fabric_Delivery_Processing_Head a INNER JOIN Fabric_Delivery_Processing_details b ON a.Fabric_Delivery_Processing_Code = b.Fabric_Delivery_Processing_Code LEFT OUTER JOIN Cloth_Head c ON c.Cloth_IdNo = b.Fabric_IdNo  LEFT OUTER JOIN Colour_Head d ON b.Colour_IdNo = d.Colour_IdNo LEFT OUTER JOIN Processed_Item_Head f ON f.Processed_Item_IdNo = b.Processed_Item_IdNo LEFT OUTER JOIN FP_Sales_Delivery_Details h ON h.FP_Sales_Delivery_Code = '" & Trim(NewCode) & "'  and b.Fabric_Delivery_Processing_Code = h.Fabric_Delivery_Processing_Code and b.Fabric_Delivery_Processing_details_SlNo = h.Fabric_Delivery_Processing_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " and ((b.Quantity - b.Receipt_Quantity ) > 0 or h.Quantity > 0 ) order by a.Fabric_Delivery_Processing_Date, a.for_orderby, a.Fabric_Delivery_Processing_No", con)
            Dt1 = New DataTable
            nr = Da.Fill(Dt1)
    ...
    Private Sub cbo_Delivery_From_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Delivery_From.KeyDown
        ...
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Delivery_From, cbo_Ledger, cbo_TransportName, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Delivery_From_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Delivery_From.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Delivery_From, cbo_TransportName, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Process_Enter(sender As Object, e As EventArgs)
    ...
    Private Sub cbo_VehicleNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, Nothing, Nothing, "FP_Sales_Delivery_Head", "Vehicle_No", " ", "")
    ...
    Private Sub cbo_VehicleNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, Nothing, "FP_Sales_Delivery_Head", "Vehicle_No", " ", "", False)
    ...
    Private Sub cbo_TransportName_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_TransportName.KeyDown
        ...
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportName, cbo_Delivery_From, cbo_VehicleNo, "Ledger_Head", "Ledger_Name", "Ledger_Type = 'TRANSPORT'", "(Ledger_IdNo = 0)")
