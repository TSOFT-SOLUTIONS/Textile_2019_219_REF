Public Class Mixing_Entry
    ...
    Private Sub clear()
        ...
        cbo_Colour.Tag = -1
        cbo_GridVariety.Visible = False
        cbo_GridVariety.Tag = -1
    ...
    Private Sub ControlGotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.ActiveControl.Name <> cbo_Colour.Name Then
            cbo_Colour.Visible = False
        End If
        If Me.ActiveControl.Name <> cbo_GridVariety.Name Then
            cbo_GridVariety.Visible = False
        End If
    ...
    Private Sub ControlLostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNothing(Prec_ActCtrl) = False Then
            If TypeOf Prec_ActCtrl Is TextBox Or TypeOf Prec_ActCtrl Is ComboBox Or TypeOf Prec_ActCtrl Is ComboBox Or TypeOf Prec_ActCtrl Is MaskedTextBox Then
    ...
    Private Sub Grid_Cell_DeSelect()
        ...
        dgv_wasteDetails.CurrentCell.Selected = False
        dgv_MixingDetails.CurrentCell.Selected = False
        dgv_MixingDetails_Total.CurrentCell.Selected = False
    ...
    Private Sub Cotton_Mixing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler cbo_GridVariety.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_GridVariety.LostFocus, AddressOf ControlLostFocus
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from Mixing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Mixing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Mixing_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Mixing_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("Mixing_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@MixDate", Convert.ToDateTime(msk_Date.Text))
            ...
            With dgv_wasteDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Stock_Waste_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                         ,        Reference_Date,     Party_Bill_No   , Entry_ID       ,   Sl_No      ,              Count_IdNo      ,   Variety_IdNo           ,                                  Lot_No      ,                      Bale_No        ,   Bale ,         Weight             ) " & _
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Mixing_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Mixing_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                cmd.CommandText = "Insert into EntryTemp( Name1   , Name2          ,Name3     ,Name4          ,Name5         ) " & _
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.Name1   , a.Name2  , a.Name3  , a.Name4  , a.Name5  from  EntryTemp a  Order by a.Name1", con)
    ...
    Private Sub cbo_GridVariety_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_GridVariety.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Variety_Head", "Variety_Name", "(Variety_IdNo = 1)", "(Variety_IdNo = 0)")
    End Sub

    Private Sub cbo_GridVariety_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_GridVariety.KeyDown
        Dim dep_idno As Integer = 0

        Try
            vcbo_KeyDwnVal = e.KeyValue

            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_GridVariety, Nothing, Nothing, "Variety_Head", "Variety_Name", "(Variety_IdNo = 1)", "(Variety_IdNo = 0)")
            With dgv_wasteDetails

                If (e.KeyValue = 38 And cbo_GridVariety.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                ...
                If (e.KeyValue = 40 And cbo_GridVariety.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
    ...
    Private Sub cbo_GridVariety_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_GridVariety.KeyPress
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt As New DataTable

        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_GridVariety, Nothing, "Variety_Head", "Variety_Name", "(Variety_IdNo = 1)", "(Variety_IdNo = 0)")

            If Asc(e.KeyChar) = 13 Then
                With dgv_wasteDetails
                    If .Rows.Count > 0 Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(1).Value = Trim(cbo_GridVariety.Text)
                        If .CurrentCell.RowIndex = .RowCount - 1 And .CurrentCell.ColumnIndex >= 1 And Trim(.CurrentRow.Cells(1).Value) = "" Then
                            txt_TareWgt.Focus()
                        Else
                            .Focus()
    ...
    Private Sub cbo_GridVariety_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_GridVariety.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Dim f As New Variety_Creation

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_GridVariety.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_GridVariety_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_GridVariety.TextChanged

        Try
            If cbo_GridVariety.Visible Then
                With dgv_wasteDetails
                    If .Rows.Count > 0 Then
                        If Val(cbo_GridVariety.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 1 Then
                            .Rows(.CurrentCell.RowIndex).Cells.Item(.CurrentCell.ColumnIndex).Value = Trim(cbo_GridVariety.Text)
                        End If
                    End If
                End With
            End If
        ...
        Try
            ...
            With dgv_wasteDetails
                ...
                If e.ColumnIndex = 1 Then
                    ...
                    If cbo_GridVariety.Visible = False Or Val(cbo_GridVariety.Tag) <> e.RowIndex Then

                        cbo_GridVariety.Tag = -1
                        Da = New SqlClient.SqlDataAdapter("select variety_Name from variety_Head order by variety_Name", con)
                        Dt2 = New DataTable
                        Da.Fill(Dt2)
                        cbo_GridVariety.DataSource = Dt2
                        cbo_GridVariety.DisplayMember = "variety_Name"

                        rect = .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False)

                        cbo_GridVariety.Left = .Left + rect.Left  '  .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Left
                        cbo_GridVariety.Top = .Top + rect.Top  ' .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Top
                        cbo_GridVariety.Width = rect.Width  ' .CurrentCell.Size.Width
                        cbo_GridVariety.Height = rect.Height  ' rect.Height

                        cbo_GridVariety.Text = .CurrentCell.Value  '  Trim(.CurrentRow.Cells(e.ColumnIndex).Value)

                        cbo_GridVariety.Tag = Val(e.RowIndex)
                        cbo_GridVariety.Visible = True

                        cbo_GridVariety.BringToFront()
                        cbo_GridVariety.Focus()
