Public Class FinishedProduct_Receipt_FromProcessing_1516
    ...
    Private Pk_Condition As String = "FPPRC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from FP_Receipt_Processing_Head a  Where a.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RecNo.Text = dt1.Rows(0).Item("FP_Receipt_Processing_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("FP_Receipt_Processing_Date").ToString
                ...
                If Not IsDBNull(dt1.Rows(0).Item("Receipt_Type")) Then
                    cbo_Receipt_Type.Text = dt1.Rows(0).Item("Receipt_Type")
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,C.Processed_Item_Name as Fp_Name,d.Colour_Name,e.Size_Name,g.Process_Name,L.Lot_No from FP_Receipt_Processing_Details a INNER JOIN Processed_Item_Head c ON  c.Processed_Item_IdNo = a.FP_Idno LEFT OUTER JOIN Colour_Head d ON d.Colour_IdNo = a.Colour_IdNo LEFT OUTER JOIN Size_Head e ON e.Size_IdNo = a.Size_IdNo LEFT OUTER JOIN Process_Head g ON g.Process_idNo = a.Process_Idno left outer join Lot_Head L on l.lot_idno = a.Lot_IdNo where a.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(6).Value = dt2.Rows(i).Item("Quantity").ToString
                        ...
                        dgv_Details.Rows(n).Cells(7).Value = dt2.Rows(i).Item("FP_Delivery_Processing_Code").ToString
                        dgv_Details.Rows(n).Cells(8).Value = Val(dt2.Rows(i).Item("FP_Delivery_Processing_Details_SlNo").ToString)
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(6).Value = Val(dt1.Rows(0).Item("Total_Quantity").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Update FP_Delivery_Processing_Details set Received_Meters = a.Received_Meters - (b.Consum_Meters) ,  Received_Quantity = a.Received_Quantity - (b.Quantity)  from FP_Delivery_Processing_Details a, FP_Receipt_Processing_Details b Where b.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "' and a.FP_Delivery_Processing_code = b.FP_Delivery_Processing_code and a.FP_Delivery_Processing_details_SlNo = b.FP_Delivery_Processing_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "delete from FP_Receipt_Processing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Receipt_Processing_No from FP_Receipt_Processing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FP_Receipt_Processing_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Receipt_Processing_No from FP_Receipt_Processing_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FP_Receipt_Processing_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Receipt_Processing_No from FP_Receipt_Processing_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FP_Receipt_Processing_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 FP_Receipt_Processing_No from FP_Receipt_Processing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FP_Receipt_Processing_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "FP_Receipt_Processing_Head", "FP_Receipt_Processing_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RecNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from FP_Receipt_Processing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FP_Receipt_Processing_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("FP_Receipt_Processing_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("FP_Receipt_Processing_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FP_Receipt_Processing_No from FP_Receipt_Processing_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "FP_Receipt_Processing_Head", "FP_Receipt_Processing_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
                NewCode = Pk_Condition & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RecNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into FP_Receipt_Processing_Head(FP_Receipt_Processing_Code, Company_IdNo, FP_Receipt_Processing_No, for_OrderBy, FP_Receipt_Processing_Date, Ledger_IdNo,Party_Dc_No,   Total_Quantity, user_Idno ,Receipt_Type) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @SewingDate, " & Str(Val(Led_ID)) & ",'" & Trim(txt_PartyDcNo.Text) & "' , " & Str(Val(vTotQty)) & "," & Val(lbl_UserName.Text) & " ,'" & cbo_Receipt_Type.Text & "')"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update FP_Receipt_Processing_Head set FP_Receipt_Processing_Date = @SewingDate, Ledger_IdNo = " & Val(Led_ID) & ",Party_Dc_No = '" & Trim(txt_PartyDcNo.Text) & "', Total_Quantity = " & Val(vTotQty) & ", user_idno = " & Val(lbl_UserName.Text) & ",Receipt_Type = '" & cbo_Receipt_Type.Text & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

                cmd.CommandText = "Update FP_Delivery_Processing_Details set Received_Quantity = isnull(a.Received_Quantity,0) - isnull(b.Quantity,0) from FP_Delivery_Processing_Details a, FP_Receipt_Processing_Details b Where b.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "' and a.FP_Delivery_Processing_code = b.FP_Delivery_Processing_code and a.FP_Delivery_Processing_details_SlNo = b.FP_Delivery_Processing_Details_SlNo"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into FP_Receipt_Processing_Details(FP_Receipt_Processing_Code, Company_IdNo, FP_Receipt_Processing_No, for_OrderBy, FP_Receipt_Processing_Date,Sl_No, Ledger_IdNo,  FP_IdNo, Colour_Idno ,Size_IdNo , Quantity,Lot_IdNo,Process_idNo, FP_Delivery_Processing_Code,FP_Delivery_Processing_Details_Slno) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @SewingDate," & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & " ," & Str(Val(FP_Id)) & ", " & Str(Val(Col_ID)) & "," & Str(Val(Sz_ID)) & ",  " & Val(.Rows(i).Cells(6).Value) & "," & Str(Val(Lot_Id)) & "," & Str(Val(Proc_Id)) & ",'" & Trim(.Rows(i).Cells(7).Value) & "', " & Val(.Rows(i).Cells(8).Value) & ")"
                        cmd.ExecuteNonQuery()

                        Nr = 0
                        cmd.CommandText = "Update FP_Delivery_Processing_Details set   Received_Quantity = isnull(Received_Quantity,9) + " & Str(Val(.Rows(i).Cells(6).Value)) & "   Where FP_Delivery_Processing_code = '" & Trim(.Rows(i).Cells(7).Value) & "' and FP_Delivery_Processing_Details_SlNo = " & Str(Val(.Rows(i).Cells(8).Value)) & " and Ledger_IdNo = " & Str(Val(Led_ID))
                        ...
                        cmd.CommandText = " Insert into Stock_Item_Processing_Details ( Reference_Code,         Company_IdNo                       ,           Reference_No        ,                               for_OrderBy                , Reference_Date , ReceivedFrom_StockIdNo  ,    DeliveryTo_StockIdNo                                   ,         Entry_ID     ,       Party_Bill_No  ,       Particulars        ,  Sl_No            , Lot_IdNo           , Item_IdNo             , Quantity                 ,  Meters                ) " &
                                          " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ",  @SewingDate   , " & Str(Val(Led_ID)) & ", " & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "'  , " & i.ToString & "," & Str(Lot_Id) & " , " & FP_Id.ToString & "," & Str(Val(vTotQty)) & " ," & Str(Val(vTotCMtrs)) & ") "
                        cmd.ExecuteNonQuery()
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details
            For i = 0 To dgv_Details.Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(6).Value) <> 0 Then
                    vTotQty = vTotQty + Val(dgv_Details.Rows(i).Cells(6).Value)
                    'vTotCMtrPcs = vTotCMtrPcs + Val(dgv_Details.Rows(i).Cells(7).Value)
                    'vtotCMtrs = vtotCMtrs + Val(dgv_Details.Rows(i).Cells(8).Value)
                End If
            Next
        End With
        ...
        dgv_Details_Total.Rows(0).Cells(6).Value = Val(vTotQty)
        'dgv_Details_Total.Rows(0).Cells(7).Value = Format(Val(vTotCMtrPcs), "#########0.00")
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, msk_Date, txt_PartyDcNo, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    ...
    Private Sub dgv_Details_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEnter
        ...
        Try
            ...
            With dgv_Details
                ...
                If e.ColumnIndex = 1 And (Val(.Rows(.CurrentCell.RowIndex).Cells(8).Value)) = 0 And Not dgv_Details.Columns(1).ReadOnly Then
                ...
                If e.ColumnIndex = 2 And (Val(.Rows(.CurrentCell.RowIndex).Cells(8).Value)) = 0 And Not dgv_Details.Columns(2).ReadOnly Then
                ...
                If e.ColumnIndex = 4 And (Val(.Rows(.CurrentCell.RowIndex).Cells(8).Value)) = 0 And Not dgv_Details.Columns(4).ReadOnly Then
                    ...
                    If cbo_LotNo.Visible = False Or Val(cbo_LotNo.Tag) <> e.RowIndex Then
                        ...
                        cbo_LotNo.DisplayMember = "Process_Name"
                ...
                If e.ColumnIndex = 5 And (Val(.Rows(.CurrentCell.RowIndex).Cells(8).Value)) = 0 And Not dgv_Details.Columns(5).ReadOnly Then

                    If cbo_LotNo.Visible = False Or Val(cbo_Process.Tag) <> e.RowIndex Then

                        cbo_Process.Tag = -1
                        Da = New SqlClient.SqlDataAdapter("select Process_Name from Process_Head Where FP_Returned = 1 order by Process_Name", con)
                        Dt3 = New DataTable
                        Da.Fill(Dt3)
                        cbo_Process.DataSource = Dt3
                        cbo_Process.DisplayMember = "Process_Name"

                        rect = .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False)

                        cbo_Process.Left = .Left + rect.Left  '  .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Left
                        cbo_Process.Top = .Top + rect.Top  ' .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Top
                        cbo_Process.Width = rect.Width  ' .CurrentCell.Size.Width
                        cbo_Process.Height = rect.Height  ' rect.Height

                        cbo_Process.Text = .CurrentCell.Value  '  Trim(.CurrentRow.Cells(e.ColumnIndex).Value)

                        cbo_Process.Tag = Val(e.RowIndex)
                        cbo_Process.Visible = True

                        cbo_Process.BringToFront()
                        cbo_Process.Focus()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FP_Receipt_Processing_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.FP_Receipt_Processing_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FP_Receipt_Processing_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            End If
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,c.*,d.Processed_Item_Name as Fp_Name,e.Colour_Name,f.Cloth_Name from FP_Receipt_Processing_Head a INNER JOIN Ledger_Head b on a.Sewing_IdNo = b.Ledger_IdNo INNER JOIN FP_Receipt_Processing_Details c ON c.FP_Receipt_Processing_Code = a.FP_Receipt_Processing_Code INNER JOIN Processed_Item_Head d ON d.Processed_Item_IdNo = c.FinishedProduct_IdNo INNER JOIN Colour_Head e ON c.Colour_Idno = e.Colour_IdNo LEFT oUTER JOIN Cloth_Head f ON c.Fabric_Idno = f.Cloth_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Receipt_Processing_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FP_Receipt_Processing_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("FP_Receipt_Processing_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("FP_Receipt_Processing_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from FP_Receipt_Processing_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from FP_Receipt_Processing_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Sewing_IdNo = c.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)


            If prn_HdDt.Rows.Count > 0 Then
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Fp_Name, c.Colour_Name ,d.Cloth_Name as Fabric_Name ,e.Process_Name  from FP_Receipt_Processing_Details a LEFT OUTER JOIN Processed_Item_Head b on a.FinishedProduct_Idno = b.Processed_Item_IdNo LEFT OUTER JOIN Colour_Head c on a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Cloth_Head d ON d.Cloth_idNo = a.Fabric_Idno LEFT OUTER JOIN Process_Head e ON e.Process_IdNo = a.Process_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*,C.Processed_Item_Name as Fp_Name,d.Colour_Name,e.Size_Name,f.Cloth_Name as Fabric_Name,g.Process_Name from FP_Receipt_Processing_Details a INNER JOIN Processed_Item_Head c ON  c.Processed_Item_IdNo = a.FinishedProduct_Idno LEFT OUTER JOIN Colour_Head d ON d.Colour_IdNo = a.Colour_IdNo LEFT OUTER JOIN Size_Head e ON e.Size_IdNo = a.Size_IdNo LEFT OUTER JOIN Cloth_Head f ON f.Cloth_idNo = a.Fabric_Idno LEFT OUTER JOIN Process_Head g ON g.Process_idNo = a.Process_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FP_Receipt_Processing_Code = '" & Trim(EntryCode) & "' Order by Sl_No", con)
        dt2 = New DataTable
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FP_Receipt_Processing_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FP_Receipt_Processing_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            'and ((b.Quantity - ISNULL(b.Received_Quantity,0) ) > 0 or h.Quantity > 0 ) 
            Da = New SqlClient.SqlDataAdapter("select a.* , b.* ,  d.Colour_Name ,e.Process_Name,f.Processed_Item_Name , h.Quantity as Ent_Qty,L.Lot_No from FP_Delivery_Processing_Head a INNER JOIN FP_Delivery_Processing_details b ON a.FP_Delivery_Processing_Code = b.FP_Delivery_Processing_Code LEFT OUTER JOIN Colour_Head d ON b.Colour_IdNo = d.Colour_IdNo LEFT OUTER JOIN Process_Head e ON e.Process_IdNo = b.Process_Idno  LEFT OUTER JOIN Processed_Item_Head f ON f.Processed_Item_IdNo = b.FP_IdNo LEFT OUTER JOIN FP_Receipt_Processing_Details h ON h.FP_Receipt_Processing_Code = '" & Trim(NewCode) & "'  and b.FP_Delivery_Processing_Code = h.FP_Delivery_Processing_Code and b.FP_Delivery_Processing_details_SlNo = h.FP_Delivery_Processing_Details_SlNo left outer Join Lot_Head l on b.Lot_IdNo = L.Lot_IdNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.Ledger_Idno = " & Str(Val(LedIdNo)) & " order by a.FP_Delivery_Processing_Date, a.for_orderby, a.FP_Delivery_Processing_No", con)
            Dt1 = New DataTable
            nr = Da.Fill(Dt1)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("FP_Delivery_Processing_No").ToString
                    .Rows(n).Cells(2).Value = Format(Convert.ToDateTime(Dt1.Rows(i).Item("FP_Delivery_Processing_Date").ToString), "dd-MM-yyyy")
                    ...
                    .Rows(n).Cells(7).Value = Dt1.Rows(i).Item("Process_Name").ToString
                    .Rows(n).Cells(8).Value = Format(Val(Dt1.Rows(i).Item("Quantity").ToString) - Val(Dt1.Rows(i).Item("Received_Quantity").ToString) + Val(Ent_Qty), "#########0")
                    ...
                    .Rows(n).Cells(11).Value = Dt1.Rows(i).Item("FP_Delivery_Processing_Details_Slno").ToString
                    .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("FP_Delivery_Processing_code").ToString
    ...
    Private Sub cbo_Receipt_Type_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Receipt_Type.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Receipt_Type, msk_Date, cbo_Ledger, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_Process_Enter(sender As Object, e As EventArgs) Handles cbo_Process.Enter
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Process_Head", "Process_Name", "FP_Returned = 1", "(Process_Idno = 0)")
    End Sub

    Private Sub cbo_Process_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Process.KeyDown

        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Process, Nothing, Nothing, "Process_Head", "Process_Name", "FP_Returned = 1", "(Process_Idno = 0)")

        With dgv_Details

            If (e.KeyValue = 38 And cbo_Process.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                .Focus()
                .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex - 1)
            End If

            If (e.KeyValue = 40 And cbo_Process.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
                .Focus()
                .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex + 1)
            End If
    ...
    Private Sub cbo_Process_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Process.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Process, Nothing, "Process_Head", "Process_Name", "FP_Returned = 1", "(Process_Idno = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_Process_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_Process.SelectedIndexChanged

        Try
            If cbo_Process.Visible Then
                With dgv_Details
                    If Val(cbo_FP_Name.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 5 Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(.CurrentCell.ColumnIndex).Value = Trim(cbo_Process.Text)
                    End If
                End With
            End If
    ...
    Private Sub cbo_Receipt_Type_Leave(sender As Object, e As EventArgs) Handles cbo_Receipt_Type.Leave
        ...
        If cbo_Receipt_Type.Tag <> cbo_Receipt_Type.Text Then
            ...
            If Len(Trim(cbo_Receipt_Type.Tag)) <> 0 Then
                If MessageBox.Show("Changing the Receipt Type Will Clear all Data in the Details. Continue Anyway ?", "Change Receipt Type ?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                    Exit Sub
                End If
            End If
