Public Class Amount_Payment_entry
    ...
    Private Pk_Condition As String = "AMPAY-"
    ...
    Private Sub clear()
        ...
        'cbo_CreditAccount.Text = Common_Procedures.Ledger_IdNoToName(con, 1)
        txt_Amount.Text = ""
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.ledger_Name  from Payment_Voucher_Head a LEFT OUTER JOIN Ledger_Head b ON a.ledger_IdNo = b.ledger_IdNo  where a.Payment_Voucher_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RecNo.Text = dt1.Rows(0).Item("Payment_Voucher_No").ToString

                dtp_voucher_date.Text = dt1.Rows(0).Item("Payment_Voucher_Date").ToString
                ...
                cbo_CreditAccount.Text = Common_Procedures.Ledger_IdNoToName(con, Val(dt1.Rows(0).Item("Creditor_IdNo").ToString))
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Voucher_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Voucher_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code = '" & Trim(NewCode) & "' "
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Dim NewCode As String
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Voucher_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Voucher_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'"
            'cmd.CommandText = "select Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Voucher_No = '" & Trim(inpno) & "' and Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'"
            ''cmd.CommandText = "select Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Payment_Voucher_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Payment_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%'  Order by for_Orderby, Payment_Voucher_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Payment_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Payment_Voucher_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Payment_Voucher_No from Payment_Voucher_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Payment_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, Payment_Voucher_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Payment_Voucher_No from Payment_Voucher_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  AND Payment_Voucher_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Payment_Voucher_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            dt = New DataTable
            da.Fill(dt)
            ...
            Da1 = New SqlClient.SqlDataAdapter("select top 1 * from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by  Payment_Voucher_No desc, For_OrderBy desc", con)
            Dt1 = New DataTable
            Da1.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
                '  dtp_Date.Text = Dt1.Rows(0).Item("Payment_Voucher_Date").ToString
                cbo_PaymentMode.Text = Dt1.Rows(0).Item("Payment_Mode").ToString
                cbo_CreditAccount.Text = Common_Procedures.Ledger_IdNoToName(con, Val(Dt1.Rows(0).Item("Creditor_IdNo").ToString))
            End If
            Dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            inpno = InputBox("Enter Payment Voucher No", "FOR FINDING...")

            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            cmd.Connection = con

            cmd.CommandText = "select Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Payment_Voucher_No = '" & Trim(inpno) & "' and Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "'"
            'cmd.CommandText = "select Payment_Voucher_No from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Payment_Voucher_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        'entcode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RecNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        'Try
        ...
        '    Da1 = New SqlClient.SqlDataAdapter("Select a.*, c.ledger_name as Employee_name, d.ledger_name as Debitor_name, c.ledger_address1, c.ledger_address2, c.ledger_address3, c.ledger_address4 from Payment_Voucher_Head a, ledger_head c, ledger_head d where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Payment_Voucher_Code = '" & Trim(entcode) & "' and a.Employee_idno = c.ledger_idno and a.Creditor_IdNo = d.ledger_idno", con)
        '    Da1.Fill(Dt1)
        '    ' Else
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        'If Trim(LCase(lbl_VouType.Text)) = "purc" Or Trim(LCase(lbl_VouType.Text)) = "rcpt" Or Trim(LCase(lbl_VouType.Text)) = "csrp" Or Trim(LCase(lbl_VouType.Text)) = "crnt" Then
        Da1 = New SqlClient.SqlDataAdapter("Select a.*, d.ledger_name as Debitor_name,  b.*  from Payment_Voucher_Head a,c.*,Ledger_head c,  ledger_head d,Company_Head b where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Payment_Voucher_Code = '" & Trim(entcode) & "' and a.member_IdNo = c.ledger_IdNo and a.Creditor_IdNo = d.ledger_idno and a.Company_IdNo = b.Company_IdNo", con)
        Da1.Fill(prn_HdDt)
        ' Else
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, "      " & prn_HdDt.Rows(0).Item("address1").ToString, LMargin + 10, CurY, 0, 0, pFont)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, "      " & prn_HdDt.Rows(0).Item("address2").ToString, LMargin + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, "Voucher Date", LMargin + C1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Employee_Receipt_Date").ToString)), LMargin + C1 + W1 + 25, CurY, 0, 0, pFont)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, "      " & prn_HdDt.Rows(0).Item("address3").ToString, LMargin + 10, CurY, 0, 0, pFont)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, "      " & prn_HdDt.Rows(0).Item("District").ToString, LMargin + 10, CurY, 0, 0, pFont)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        CrdtAc_id = Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_CreditAccount.Text)
        If CrdtAc_id = 0 Then
            MessageBox.Show("Invalid Debit Account", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            If cbo_CreditAccount.Enabled Then cbo_CreditAccount.Focus()
            Exit Sub
        End If

        If Trim(cbo_PaymentMode.Text) = "" Then
            MessageBox.Show("Invalid PaymentMode", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Payment_Voucher_Head", "Payment_Voucher_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Payment_Voucher_Head (        Payment_Voucher_Code   ,                 Company_IdNo     ,          Payment_Voucher_No  ,                               for_OrderBy                               , Payment_Voucher_Date,           Ledger_IdNo      ,                 Amount   ,                      Payment_Mode          ,                   Creditor_IdNo        ,     Reference_No ,                   ChequeBank_Name        ,    Cheque_Date    ,              Remarks) " &
            ...
            Else
                ...
                cmd.CommandText = "Update Payment_Voucher_Head set Payment_Voucher_Date = @EntryDate, Ledger_IdNo = " & Str(Val(Mem_id)) & ", Amount = " & Str(Val(txt_Amount.Text)) & ",Payment_Mode = '" & Trim(cbo_PaymentMode.Text) & "', Creditor_IdNo = " & Str(Val(CrdtAc_id)) & ",  Reference_No ='" & Trim(txt_ReferenceNo.Text) & "' ,ChequeBank_Name ='" & Trim(cbo_chequeBank.Text) & "', Cheque_Date = @ChequeDate , Remarks = '" & Trim(txt_Remarks.Text) & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Payment_Voucher_Code = '" & Trim(NewCode) & "'  "
                cmd.ExecuteNonQuery()
            ...
            If Trim(UCase(cbo_PaymentMode.Text)) = "CASH" Then
                vVouNar = Trim(txt_Remarks.Text)

            Else

                If Trim(UCase(cbo_PaymentMode.Text)) = "CHEQUE" Then
                    vVouNar = "Cheque No :" & Trim(txt_ReferenceNo.Text)

                Else
                    vVouNar = Trim(cbo_PaymentMode.Text) & " : Ref. No. " & Trim(txt_ReferenceNo.Text)
            ...
            If Common_Procedures.Voucher_Updation(con, "Pymt.Vou", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_RecNo.Text), dtp_voucher_date.Value.Date, Trim(vVouNar) & " ", vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub cbo_EmployeeName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, Msk_Date_Voucher, txt_Amount, "ledger_Head", "Ledger_Name", "", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub btn_filtershow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_filtershow.Click
        ...
        Try
            ...
            If IsDate(dtp_FilterFrom_date.Value) = True And IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a.Payment_Voucher_Date between '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterFrom_date.Value) = True Then
                Condt = "a.Payment_Voucher_Date = '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a.Payment_Voucher_Date= '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as Member_Name from Payment_Voucher_Head a INNER JOIN Ledger_Head b ON a.Ledger_Idno = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & "and a.Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Payment_Voucher_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_filter.Rows(n).Cells(0).Value = " " & dt2.Rows(i).Item("Payment_Voucher_No").ToString
                    ' dgv_filter.Rows(n).Cells(1).Value = " " & dt2.Rows(i).Item("Voucher_No").ToString
                    dgv_filter.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Payment_Voucher_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_CreditAccount_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_CreditAccount.GotFocus
    ...
    Private Sub cbo_CreditAccount_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_CreditAccount.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_CreditAccount, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 5 or AccountsGroup_IdNo = 6)", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_CreditAccount_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_CreditAccount.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_CreditAccount, cbo_PaymentMode, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 5 or AccountsGroup_IdNo = 6)", "(Ledger_IdNo = 0)") ' (AccountsGroup_IdNo = 5 or AccountsGroup_IdNo = 6)
        If (e.KeyValue = 38 And cbo_CreditAccount.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
            e.Handled = True : e.SuppressKeyPress = True
            cbo_PaymentMode.Focus()
        End If
        If (e.KeyValue = 40 And cbo_CreditAccount.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            e.Handled = True : e.SuppressKeyPress = True
            If txt_ReferenceNo.Enabled And txt_ReferenceNo.Visible = True Then
                txt_ReferenceNo.Focus()
            Else
    ...
    Private Sub cbo_CashCheque_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PaymentMode.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PaymentMode, cbo_CreditAccount, "", "", "", "")
        ...
        If Asc(e.KeyChar) = 13 Then
            If Trim(cbo_PaymentMode.Text) <> "CASH" Then
                ...
                Da1 = New SqlClient.SqlDataAdapter("select top 1 * from Payment_Voucher_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "and Payment_Voucher_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and Payment_Mode ='CHEQUE' ", con)
                Dt1 = New DataTable
                Da1.Fill(Dt1)
                If Dt1.Rows.Count > 0 Then
                    cbo_CreditAccount.Text = Common_Procedures.Ledger_IdNoToName(con, Val(Dt1.Rows(0).Item("Creditor_IdNo").ToString))
    ...
    Private Sub cbo_CashCheque_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PaymentMode.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PaymentMode, txt_Amount, cbo_CreditAccount, "", "", "", "")
    End Sub
    ...
    Private Sub Employee_Receipt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            End If
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_CreditAccount.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_CreditAccount.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
            ...
            If FrmLdSTS = True Then
                ...
                If Val(RptSubReport_Index) > 0 And Trim(RptSubReport_VouCode) <> "" Then
                    ...
                    If Common_Procedures.CompIdNo <> 0 Then
                        ...
                        OrdByNo_Code = ""
                        Da1 = New SqlClient.SqlDataAdapter("Select a.For_OrderBy from Payment_Voucher_Head a Where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Payment_Voucher_Code = '" & Trim(RptSubReport_VouCode) & "' ", con)
                        Dt1 = New DataTable
                        Da1.Fill(Dt1)
                        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub Employee_Receipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler cbo_CreditAccount.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_CreditAccount.LostFocus, AddressOf ControlLostFocus
    ...
    Private Sub cbo_DebitAccount_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_CreditAccount.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Common_Procedures.MDI_LedType = ""
            Dim f As New Ledger_Creation
            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_CreditAccount.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
            f.MdiParent = MDIParent1
            f.Show()
    ...
    Private Sub cbo_chequeBank_GotFocus(sender As Object, e As System.EventArgs) Handles cbo_chequeBank.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Payment_Voucher_Head", "ChequeBank_Name", "", "")
    End Sub
    ...
    Private Sub cbo_chequeBank_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles cbo_chequeBank.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_chequeBank, txt_ReferenceNo, msk_Date, "Payment_Voucher_Head", "ChequeBank_Name", "", "")
    End Sub
    ...
    Private Sub cbo_chequeBank_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_chequeBank.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_chequeBank, msk_Date, "Payment_Voucher_Head", "ChequeBank_Name", "", "", False)
    End Sub
    ...
    Private Sub Msk_Date_Voucher_GotFocus(sender As Object, e As System.EventArgs) Handles Msk_Date_Voucher.GotFocus
        pnl_CurrentBalance.Visible = False
    End Sub
    'Private Sub dtp_Date_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles dtp_Date.KeyDown
    '    vcbo_KeyDwnVal = e.KeyValue
    '    If e.KeyValue = 38 Then
    '        e.Handled = True : e.SuppressKeyPress = True
    '        txt_Remarks.Focus()
    ...
    'Private Sub dtp_Date_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles dtp_Date.KeyPress
    '    If Asc(e.KeyChar) = 13 Then
    '        cbo_PartyName.Focus()
    '    End If
    'End Sub

    'Private Sub dtp_Date_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles dtp_Date.KeyUp
    '    If e.KeyCode = 17 And e.Control = False And vcbo_KeyDwnVal = e.KeyValue Then
    '        dtp_cheque_date.Text = Date.Today
    '    End If
    'End Sub
