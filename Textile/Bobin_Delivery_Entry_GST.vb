Public Class Bobin_Delivery_Entry_GST
    ...
    Private Pk_Condition As String = "GBBDL-"
    ...
    Private Sub clear()
        ...
        cbo_KuriBorderSize.Enabled = True
        cbo_KuriBorderSize.BackColor = Color.White

        cbo_KuriColour.Enabled = True
        cbo_KuriColour.BackColor = Color.White

        cbo_KuriCount.Enabled = True
        cbo_KuriCount.BackColor = Color.White
        ...
        cbo_Grid_BobinSize.Enabled = True
        cbo_Grid_BobinSize.BackColor = Color.White

        dgv_BobinDetails.ReadOnly = False
        dgv_KuriDetails.ReadOnly = False
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Bobin_Jari_Delivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo   Where a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.EndsCount_Name, c.Colour_Name, d.BorderSize_Name from Bobin_Jari_Delivery_Bobin_Details a INNER JOIN Endscount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo Where a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_BobinDetails.Rows(n).Cells(4).Value = Common_Procedures.BobinSize_IdNoToName(con, dt2.Rows(i).Item("Bobin_Size_IdNo").ToString)
                        ...
                        dgv_BobinDetails.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Bobin_Jari_Sales_Invoice_Code").ToString
                        dgv_BobinDetails.Rows(n).Cells(9).Value = dt2.Rows(i).Item("Bobin_Jari_Delivery_Bobin_Slno").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Colour_Name, d.BorderSize_Name from Bobin_Jari_Delivery_Jari_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo where a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
            ...
            If LockSTS = True Then
                ...
                cbo_KuriBorderSize.Enabled = False
                cbo_KuriBorderSize.BackColor = Color.LightGray

                cbo_KuriColour.Enabled = False
                cbo_KuriColour.BackColor = Color.LightGray

                cbo_KuriCount.Enabled = False
                cbo_KuriCount.BackColor = Color.LightGray
                ...
                cbo_Grid_BobinSize.Enabled = False
                cbo_Grid_BobinSize.BackColor = Color.LightGray

                dgv_BobinDetails.ReadOnly = True
                dgv_KuriDetails.ReadOnly = True
    ...
    Private Sub Bobin_Delivery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Bobin_Delivery_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'da = New SqlClient.SqlDataAdapter("select distinct(Vechile_No) from Bobin_Jari_Delivery_Head order by Vechile_No", con)
        'da.Fill(dt4)
    ...
    Private Sub Bobin_Delivery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub Bobin_Delivery_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select BobinSales_Invoice_Code from Bobin_Jari_Delivery_Head Where Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.CommandText = "Delete from Bobin_Jari_Delivery_Bobin_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "delete from Bobin_Jari_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Delivery_No from Bobin_Jari_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Bobin_Jari_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Delivery_No from Bobin_Jari_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Bobin_Jari_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Delivery_No from Bobin_Jari_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Bobin_Jari_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Delivery_No from Bobin_Jari_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Bobin_Jari_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Jari_Delivery_Head", "Bobin_Jari_Delivery_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Bobin_Jari_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Bobin_Jari_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Bobin_Jari_Delivery_No from Bobin_Jari_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Jari_Delivery_Head", "Bobin_Jari_Delivery_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)

                NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

            End If

            Da = New SqlClient.SqlDataAdapter("select count(*) from Bobin_Jari_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' and BobinSales_Invoice_Code <> ''", con)
            ...
            With dgv_BobinDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        BbnSz_ID = Common_Procedures.BobinSize_NameToIdNo(con, .Rows(i).Cells(4).Value, tr)

                        Nr = 0
                        cmd.CommandText = "Update  Bobin_Jari_Delivery_Bobin_Details set Bobin_Jari_Delivery_Date = @EntryDate , Sl_No  = " & Str(Val(Sno)) & " , EndsCount_IdNo = " & Str(Val(Ens_ID)) & "  , Colour_IdNo = " & Str(Val(Clr_ID)) & "  , BorderSize_IdNo = " & Str(Val(BthSz_ID)) & " , Bobins = " & Val(.Rows(i).Cells(5).Value) & " , Meter_Bobin = " & Val(.Rows(i).Cells(6).Value) & " , Meters = " & Val(.Rows(i).Cells(7).Value) & " , Bobin_Jari_Sales_Invoice_Code = '" & Trim(.Rows(i).Cells(8).Value) & "' , Bobin_Size_IdNo = " & Str(Val(BbnSz_ID)) & "  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'  and Bobin_Jari_Delivery_Bobin_Slno = " & Str(Val(.Rows(i).Cells(9).Value))
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then

                            cmd.CommandText = "Insert into Bobin_Jari_Delivery_Bobin_Details ( Bobin_Jari_Delivery_Code, Company_IdNo                      , Bobin_Jari_Delivery_No       , for_OrderBy          , Bobin_Jari_Delivery_Date, Sl_No                , EndsCount_IdNo          , Colour_IdNo              , BorderSize_IdNo           , Bobins                              , Meter_Bobin                         , Meters                                   , Bobin_Jari_Sales_Invoice_Code           , Bobin_Size_IdNo           ) " & _
                            "Values                                                          ('" & Trim(NewCode) & "'  , " & Str(Val(lbl_Company.Tag)) & " , '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate              , " & Str(Val(Sno)) & ", " & Str(Val(Ens_ID)) & ", " & Str(Val(Clr_ID)) & " , " & Str(Val(BthSz_ID)) & ", " & Val(.Rows(i).Cells(5).Value) & ", " & Val(.Rows(i).Cells(6).Value) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & ", '" & Trim(.Rows(i).Cells(8).Value) & "' , " & Str(Val(BbnSz_ID)) & ")"
                            cmd.ExecuteNonQuery()
            ...
            With dgv_KuriDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(6).Value) <> "" And Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        Nr = 0
                        cmd.CommandText = "Update  Bobin_Jari_Delivery_Jari_Details set Bobin_Jari_Delivery_Date = @EntryDate , Sl_No  = " & Str(Val(Sno)) & " , Count_IdNo = " & Str(Val(Cnt_ID)) & "  , Colour_IdNo = " & Str(Val(Clr_ID)) & "  , BorderSize_IdNo = " & Str(Val(BthSz_ID)) & " , Noof_Jumbos = " & Val(.Rows(i).Cells(4).Value) & " , Noof_Cones = " & Val(.Rows(i).Cells(5).Value) & " , Weight = " & Val(.Rows(i).Cells(6).Value) & " , Bobin_Jari_Sales_Invoice_Code = '" & Trim(.Rows(i).Cells(7).Value) & "'  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'  and Bobin_Jari_Delivery_Jari_Slno = " & Str(Val(.Rows(i).Cells(8).Value))
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Bobin_Jari_Delivery_Jari_Details ( Bobin_Jari_Delivery_Code, Company_IdNo, Bobin_Jari_Delivery_No, for_OrderBy, Bobin_Jari_Delivery_Date, Sl_No, Count_IdNo, Colour_IdNo, BorderSize_IdNo, Noof_Jumbos, Noof_Cones, Weight, Bobin_Jari_Sales_Invoice_Code) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ", " & Str(Val(Clr_ID)) & " , " & Str(Val(BthSz_ID)) & ", " & Val(.Rows(i).Cells(4).Value) & ", " & Val(.Rows(i).Cells(5).Value) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ", '" & Trim(.Rows(i).Cells(7).Value) & "')"
                            cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, msk_Date, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", "( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", "( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_idno = 0)")
        Catch ex As Exception
            '----
        End Try
            ...
            With dgv_BobinDetails
                ...
                If e.ColumnIndex = 4 Then
                    ...
                    If cbo_Grid_BobinSize.Visible = False Or Val(cbo_Grid_BobinSize.Tag) <> e.RowIndex Then
                        ...
                        Dt2 = New DataTable
                        Da.Fill(Dt2)
                        cbo_Grid_BobinSize.DataSource = Dt2
                        cbo_Grid_BobinSize.DisplayMember = "Bobin_Size_Name"

                        rect = .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False)

                        cbo_Grid_BobinSize.Left = .Left + rect.Left  '  .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Left
                        cbo_Grid_BobinSize.Top = .Top + rect.Top  ' .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Top
                        cbo_Grid_BobinSize.Width = rect.Width  ' .CurrentCell.Size.Width
                        cbo_Grid_BobinSize.Height = rect.Height  ' rect.Height

                        cbo_Grid_BobinSize.Text = .CurrentCell.Value  '  Trim(.CurrentRow.Cells(e.ColumnIndex).Value)
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VechileNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VechileNo, cbo_Transport, txt_Freight, "Bobin_Jari_Delivery_Head", "Vechile_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VechileNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VechileNo, txt_Freight, "Bobin_Jari_Delivery_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If Trim(cbo_Filter_EndsName.Text) <> "" Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Bobin_Jari_Delivery_Head IN (select z1.Bobin_Jari_Delivery_Head from Bobin_Jari_Delivery_Bobin_Details z1 where z1.Ends = '" & Trim(cbo_Filter_EndsName.Text) & "')"
            End If

            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Bobin_Jari_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Bobin_Jari_Delivery_No", con)
            da.Fill(dt2)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Bobin_Jari_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5         ) " & _
                                        "select  b.EndscOUNT_Name , c.Colour_name , a.Bobins , ''  , a.Meters from Bobin_Jari_Delivery_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno LEFT OUTER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5         ) " & _
                                       "select  b.cOUNT_Name , c.Colour_name , a.Noof_Jumbos , a.Noof_Cones  , a.Weight  from Bobin_Jari_Delivery_Jari_Details a INNER JOIN cOUNT_Head b ON a.cOUNT_idno = b.cOUNT_idno LEFT OUTER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()
        ...
        Try
            ...
            With dgv_BobinDetails
                ...
                If cbo_Grid_BobinSize.Visible = True Then
                    If Val(cbo_Grid_BobinSize.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 4 Then
