Public Class Billing_Item_ExcessShort
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Item_Excess_Short, "~L~") = 0 And InStr(Common_Procedures.UR.Item_Excess_Short, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Item_Excess_Short, "~L~") = 0 And InStr(Common_Procedures.UR.Item_Excess_Short, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Item_Excess_Short, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Reference_Code, Reference_Date, Company_Idno, Item_IdNo ) " &
                                      " Select                               Reference_Code, Reference_Date, Company_IdNo, Item_IdNo from Item_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
