Public Class Bobin_Sales_Invoice_Entry_GST
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(DGVCol_BobinDetails.Ends).Value = dt2.Rows(i).Item("Bobin_Delivery_Date").ToString
                            ...
                            .Rows(n).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value = Format(Val(dt2.Rows(i).Item("No_OF_Bobin").ToString), "########0")
                            .Rows(n).Cells(DGVCol_BobinDetails.NoOfJumpo).Value = Format(Val(dt2.Rows(i).Item("No_OF_Jumpo").ToString), "########0")
                            ...
                            .Rows(n).Cells(DGVCol_BobinDetails.Rate_For).Value = dt2.Rows(i).Item("Rate_For").ToString
                            ...
                            .Rows(n).Cells(DGVCol_BobinDetails.Disc_Percentage).Value = dt2.Rows(i).Item("Cash_Discount_Percentage").ToString
                            .Rows(n).Cells(DGVCol_BobinDetails.Disc_Amount).Value = dt2.Rows(i).Item("Cash_Discount_Amount").ToString
                            ...
                            .Rows(n).Cells(DGVCol_BobinDetails.Bobin_Size).Value = Common_Procedures.BobinSize_IdNoToName(con, Trim(dt2.Rows(i).Item("Bobin_Size_IdNo").ToString))
                ...
                With dgv1
                    ...
                    If keyData = Keys.Enter Or keyData = Keys.Down Then
                        If .CurrentCell.ColumnIndex >= .ColumnCount - 9 Then
                            ...
                            Else
                                .CurrentCell = .Rows(.CurrentCell.RowIndex + 1).Cells(DGVCol_BobinDetails.Rate)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "BobinSales_Invoice_Head", "BobinSales_Invoice_Code", Val(lbl_Company.Tag), NewCode, lbl_InvoiceNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "BobinSales_Invoice_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "BobinSales_Invoice_Details", "BobinSales_Invoice_Code", Val(lbl_Company.Tag), NewCode, lbl_InvoiceNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Bobin_Delivery_No, Bobin_Delivery_Date,EndsCount_Idno,Count_Idno, No_OF_Bobin, No_OF_Jumpo,  No_OF_Cones, Meters, Weights, Rate_For, Rate,Amount", "Sl_No", "BobinSales_Invoice_Code, For_OrderBy, Company_IdNo, BobinSales_Invoice_No, BobinSales_Invoice_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "Delete from BobinSales_Invoice_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and BobinSales_Invoice_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "BobinSales_Invoice_Head", "BobinSales_Invoice_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If (Trim(.Rows(i).Cells(DGVCol_BobinDetails.Ends).Value) <> "" And Trim(.Rows(i).Cells(DGVCol_BobinDetails.Count).Value) <> "") Or (Val(.Rows(i).Cells(DGVCol_BobinDetails.NoOfCones).Value) <> 0 And Val(.Rows(i).Cells(DGVCol_BobinDetails.Meters).Value) <> 0) Then
                    ...
                    If Val(.Rows(i).Cells(DGVCol_BobinDetails.NoOfCones).Value) = 0 Then
                        MessageBox.Show("Invalid Meters", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        If .Enabled And .Visible Then
                            .Focus()
                            .CurrentCell = .Rows(i).Cells(DGVCol_BobinDetails.NoOfCones)
                        End If
                        Exit Sub
                    End If
                    If Val(.Rows(i).Cells(DGVCol_BobinDetails.Meters).Value) = 0 Then
                        MessageBox.Show("Invalid Weight", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        If .Enabled And .Visible Then
                            .Focus()
                            .CurrentCell = .Rows(i).Cells(DGVCol_BobinDetails.Meters)
                        End If
                        Exit Sub
                    End If
        ...
        Try
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "BobinSales_Invoice_Head", "BobinSales_Invoice_Code", Val(lbl_Company.Tag), NewCode, lbl_InvoiceNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "BobinSales_Invoice_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into BobinSales_Invoice_GST_Tax_Details   ( BobinSales_Invoice_Code  ,               Company_IdNo       ,      BobinSales_Invoice_No        ,                               for_OrderBy                                  , BobinDelivery_Invoice_Date  ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " &
                ...
                Next i
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "BobinSales_Invoice_Details", "BobinSales_Invoice_Code", Val(lbl_Company.Tag), NewCode, lbl_InvoiceNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Bobin_Delivery_No, Bobin_Delivery_Date,EndsCount_Idno,Count_Idno, No_OF_Bobin, No_OF_Jumpo,  No_OF_Cones, Meters, Weights, Rate_For, Rate,Amount", "Sl_No", "BobinSales_Invoice_Code, For_OrderBy, Company_IdNo, BobinSales_Invoice_No, BobinSales_Invoice_Date, Ledger_Idno", tr)
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, msk_PoDate, cbo_Vechile, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")

            'If (e.KeyValue = 40 And cbo_Transport.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            '    If dgv_Details.Rows.Count > 0 Then
            '        dgv_Details.Focus()
            '        dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(DGVCol_BobinDetails.Rate_For)
            ...
            With dgv_Details
                If .Visible Then
                    If .Rows.Count > 0 Then
                        If e.ColumnIndex = DGVCol_BobinDetails.Meters Or e.ColumnIndex = DGVCol_BobinDetails.Weight Or e.ColumnIndex = DGVCol_BobinDetails.Rate_For Or e.ColumnIndex = DGVCol_BobinDetails.Rate Then

                            If Trim(UCase(.CurrentRow.Cells(DGVCol_BobinDetails.Rate_For).Value)) = "KG" Then
            ...
            With dgv_Details
                If .Visible Then
                    If .Rows.Count > 0 Then
                        ...
                        If Trim(.Rows(CurRow).Cells(DGVCol_BobinDetails.Ends).Value) <> "" Then

                            EndsCnt_ID = Common_Procedures.EndsCount_NameToIdNo(con, Trim(.Rows(CurRow).Cells(DGVCol_BobinDetails.Ends).Value))
                        ...
                        If EndsCnt_ID <> 0 Then
                            ...
                            Dim MtrsINbobin_Per_Set As String = 0

                            MtrsINbobin_Per_Set = Format(2 * (Val(.Rows(CurRow).Cells(DGVCol_BobinDetails.Meters).Value) / Val(.Rows(CurRow).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value)), "##########0.00")

                            conspn = (Val(.Rows(CurRow).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value) * Val(MtrsINbobin_Per_Set) * Val(ends) * Val(cnt)) / 9000000
                            'conspn = (Val(.Rows(CurRow).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value) * Val(.Rows(CurRow).Cells(DGVCol_BobinDetails.Meters).Value) * Val(ends) * Val(cnt)) / 9000000
                            .Rows(CurRow).Cells(DGVCol_BobinDetails.Weight).Value = Format(Val(conspn), "#######0.000")
    ...
    Private Sub dgtxt_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_Details.KeyPress
        Try
            With dgv_Details
                If .Visible Then
                    If .Rows.Count > 0 Then
                        If .CurrentCell.ColumnIndex = DGVCol_BobinDetails.NoOf_Bobins Or .CurrentCell.ColumnIndex = DGVCol_BobinDetails.NoOfJumpo Or .CurrentCell.ColumnIndex = DGVCol_BobinDetails.NoOfCones Or .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Meters Or .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Weight Or .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Rate Then
    ...
    Private Sub txt_DiscPerc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_DiscPerc.TextChanged
        If dgv_Details.Rows.Count > 0 Then
            For i = 0 To dgv_Details.Rows.Count - 1
                dgv_Details.Rows(i).Cells(DGVCol_BobinDetails.Disc_Percentage).Value = Val(txt_DiscPerc.Text)
            Next
        End If
            ...
            With dgv_Details
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(DGVCol_BobinDetails.Ends).Value) <> "" Or Trim(.Rows(i).Cells(DGVCol_BobinDetails.Count).Value) <> "" Then
                        ...
                        Totbob = Totbob + Val(.Rows(i).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value)
                        TotJum = TotJum + Val(.Rows(i).Cells(DGVCol_BobinDetails.NoOfJumpo).Value)
                        ...
                        TotDisc = TotDisc + Val(.Rows(i).Cells(DGVCol_BobinDetails.Disc_Amount).Value)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName, f.Ledger_Name as SalesAcc_Name  ,SH.* ,Lsh.State_Name as Ledger_State_Name ,Lsh.State_Code as Ledger_State_Code , G.Ledger_mainName as DeliveryTo_LedgerName, G.Ledger_Address1 as DeliveryTo_LedgerAddress1, G.Ledger_Address2 as DeliveryTo_LedgerAddress2, G.Ledger_Address3 as DeliveryTo_LedgerAddress3, G.Ledger_Address4 as DeliveryTo_LedgerAddress4, G.Ledger_PhoneNo as DeliveryTo_LedgerPhoneNo, G.Ledger_GSTinNo as DeliveryTo_LedgerGSTinNo, G.Ledger_Mail as DeliveryTo_LedgerMailNo, G.Ledger_pHONENo as DeliveryTo_LedgerPhoneNo, G.MobileNo_Frsms as DeliveryTo_LedgerMobileNo_Frsms, G.Pan_No as DeliveryTo_PanNo, Dsh.State_Name as DeliveryTo_State_Name, Dsh.State_Code as DeliveryTo_State_Code from BobinSales_Invoice_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_Head SH ON b.Company_State_IdNo =SH.State_IdNo  INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_Head Lsh ON c.Ledger_State_IdNo = Lsh.State_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo =a.SalesAc_IdNo LEFT OUTER JOIN Ledger_Head G ON (case when a.DeliveryTo_IdNo <> 0 then a.DeliveryTo_IdNo else a.Ledger_IdNo end) = G.Ledger_IdNo LEFT OUTER JOIN State_Head Dsh ON G.Ledger_State_IdNo = Dsh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.BobinSales_Invoice_Code = '" & Trim(NewCode) & "'", con)

            'da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName, f.Ledger_Name as SalesAcc_Name  ,SH.* ,Lsh.State_Name as Ledger_State_Name ,Lsh.State_Code as Ledger_State_Code from BobinSales_Invoice_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_Head SH ON b.Company_State_IdNo =SH.State_IdNo  INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_Head Lsh ON c.Ledger_State_IdNo = Lsh.State_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo =a.SalesAc_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.BobinSales_Invoice_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Close_Order_Selection()
        ...
        If Trim(UCase(cbo_Type.Text)) = "DELIVERY" Then
            ...
            For i = 0 To dgv_Selection.Rows.Count - 1
                ...
                If Val(dgv_Selection.Rows(i).Cells(DGVCol_BobinDetails.Meters).Value) = 1 Then
                    ...
                    If Dt1.Rows.Count > 0 Then
                        ...
                        For j = 0 To Dt1.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.DC_No).Value = Dt1.Rows(j).Item("Bobin_Jari_Delivery_No").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.DC_Date).Value = Format(Convert.ToDateTime(Dt1.Rows(j).Item("Bobin_Jari_Delivery_Date").ToString), "dd-MM-yyyy")
                            'dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Ends).Value = Dt1.Rows(j).Item("EndsCount_Name").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Count).Value = Dt1.Rows(j).Item("Count_Name").ToString
                            'dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.noof_bobins).Value = Val(Dt1.Rows(j).Item("Bobins").ToString)
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.NoOfJumpo).Value = Val(Dt1.Rows(j).Item("Noof_Jumbos").ToString)
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.NoOfCones).Value = Val(Dt1.Rows(j).Item("Noof_Cones").ToString)
                            'dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.meters).Value = Format(Val(Dt1.Rows(j).Item("Meters").ToString), "#########0.00")
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Weight).Value = Format(Val(Dt1.Rows(j).Item("Weight").ToString), "#########0.000")
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate_For).Value = "KG"
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate).Value = ""
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Delivery_Code).Value = Dt1.Rows(j).Item("Bobin_Jari_Delivery_Code").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Delivery_SlNo).Value = Dt1.Rows(j).Item("Bobin_Jari_Delivery_Jari_Slno").ToString
                            ...
                            If Dt3.Rows.Count > 0 Then
                                If Trim(Dt3.Rows(0).Item("Rate_For").ToString) <> "" Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate_For).Value = (Dt3.Rows(0).Item("Rate_For").ToString)
                                End If

                                If Val(Dt3.Rows(0).Item("Rate").ToString) <> 0 Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate).Value = Format(Val(Dt3.Rows(0).Item("Rate").ToString), "#########0.00")
                                End If
                                If Val(Dt3.Rows(0).Item("Amount").ToString) <> 0 Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Amount).Value = Format(Val(Dt3.Rows(0).Item("Amount").ToString), "#########0.00")
                                End If
                    ...
                    If Dt2.Rows.Count > 0 Then
                        ...
                        For j = 0 To Dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.DC_No).Value = Dt2.Rows(j).Item("Bobin_Jari_Delivery_No").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.DC_Date).Value = Format(Convert.ToDateTime(Dt2.Rows(j).Item("Bobin_Jari_Delivery_Date").ToString), "dd-MM-yyyy")
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Ends).Value = Dt2.Rows(j).Item("EndsCount_Name").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.NoOf_Bobins).Value = Val(Dt2.Rows(j).Item("Bobins").ToString)
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Meters).Value = Format(Val(Dt2.Rows(j).Item("Meters").ToString), "#########0.00")
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate_For).Value = "MTRS"
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Delivery_Code).Value = Dt2.Rows(j).Item("Bobin_Jari_Delivery_Code").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Delivery_SlNo).Value = Dt2.Rows(j).Item("Bobin_Jari_Delivery_Bobin_Slno").ToString
                            dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Bobin_Size).Value = Common_Procedures.BobinSize_IdNoToName(con, Dt2.Rows(j).Item("Bobin_Size_IdNo").ToString)
                            ...
                            If Dt4.Rows.Count > 0 Then
                                If Trim(Dt4.Rows(0).Item("Rate_For").ToString) <> "" Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate_For).Value = (Dt4.Rows(0).Item("Rate_For").ToString)
                                End If
                                If Val(Dt4.Rows(0).Item("Rate").ToString) <> 0 Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Rate).Value = Format(Val(Dt4.Rows(0).Item("Rate").ToString), "#########0.00")
                                End If
                                If Val(Dt4.Rows(0).Item("Amount").ToString) <> 0 Then
                                    dgv_Details.Rows(n).Cells(DGVCol_BobinDetails.Amount).Value = Format(Val(Dt4.Rows(0).Item("Amount").ToString), "#########0.00")
                                End If
                            End If
                            Dt4.Clear()
    ...
    Private Sub cbo_Grid_RateFor_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Grid_RateFor.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            With dgv_Details
                ...
                .Focus()
                .Rows(.CurrentCell.RowIndex).Cells.Item(DGVCol_BobinDetails.Rate_For).Value = Trim(cbo_Grid_RateFor.Text)
                .CurrentCell = .Rows(.CurrentCell.RowIndex).Cells(.CurrentCell.ColumnIndex + 1)
    ...
    Private Sub cbo_Grid_RateFor_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_RateFor.TextChanged
        Try
            ...
            If cbo_Grid_RateFor.Visible Then
                With dgv_Details
                    If IsNothing(dgv_Details.CurrentCell) Then Exit Sub
                    If Val(cbo_Grid_RateFor.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Rate_For Then
    ...
    Private Sub cbo_GridCount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_CountName.TextChanged
        Try
            If cbo_Grid_CountName.Visible Then
                If IsNothing(dgv_Details.CurrentCell) Then Exit Sub
                With dgv_Details
                    If Val(cbo_GridEnds.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Count Then
    ...
    Private Sub dgv_Details_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEnter
        ...
        With dgv_Details
            ...
            If e.ColumnIndex = DGVCol_BobinDetails.Rate_For Then
                ...
                If dgv_Details.Rows.Count > 0 Then
                    ...
                    For RowIndx = 0 To dgv_Details.Rows.Count - 1
                        ...
                        If Trim(.Rows(RowIndx).Cells(DGVCol_BobinDetails.DC_No).Value) <> "" Or Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Count).Value) = 0 Or Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Weight).Value) = 0 Or Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Amount).Value) = 0 Then
                            ...
                            '--Cash discount
                            .Rows(RowIndx).Cells(DGVCol_BobinDetails.Disc_Percentage).Value = Format(Val(txt_DiscPerc.Text), "########0.00")
                            .Rows(RowIndx).Cells(DGVCol_BobinDetails.Disc_Amount).Value = Format(Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Amount).Value) * (Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Disc_Percentage).Value) / 100), "########0.00")

                            '-- Taxable value = amount -  cash disc
                            Taxable_Amount = Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Amount).Value) - Val(.Rows(RowIndx).Cells(DGVCol_BobinDetails.Disc_Amount).Value)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        SNo = SNo + 1
                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Sl_No").ToString), LMargin + 10, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_GST_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Cmp_State = "" : Cmp_StateCode = "" : Cmp_GSTIN_No = "" : Cmp_UAMNO = ""
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("BobinSales_Invoice_No").ToString, LMargin + W1 + 30, CurY, 0, 0, p1Font)


            Common_Procedures.Print_To_PrintDocument(e, "EWAYBILL NO", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 20, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Eway_BillNo").ToString, LMargin + C1 + W1 + 40, CurY, 0, 0, p1Font)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "DATE ", LMargin + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("BobinDelivery_Invoice_Date").ToString), "dd-MM-yyyy").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
            ...
            If (prn_HdDt.Rows(0).Item("DeliveryTo_LedgerName").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "SHIPPED TO :", LMargin + C1 + 10, CurY1, 0, 0, p1Font)

                p1Font = New Font("Calibri", 10, FontStyle.Bold)

                CurY1 = CurY1 + TxtHgt + 5

                Common_Procedures.Print_To_PrintDocument(e, "M/s. " & prn_HdDt.Rows(0).Item("DeliveryTo_LedgerName").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, p1Font)

            End If
            pFont = New Font("Calibri", 11, FontStyle.Regular)
            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress1").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, pFont)

            If Trim(prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress2").ToString) <> "" Then
                CurY1 = CurY1 + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress2").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, pFont)
            End If
            CurY1 = CurY1 + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress3").ToString) <> "" Then

                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress3").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, pFont)
            End If
            CurY1 = CurY1 + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress4").ToString) <> "" Then

                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("DeliveryTo_LedgerAddress4").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, pFont)
            End If

            CurY1 = CurY1 + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("DeliveryTo_LedgerPhoneNo").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, " PHONE : " & prn_HdDt.Rows(0).Item("DeliveryTo_LedgerPhoneNo").ToString, LMargin + C1 + S1 + 10, CurY1, 0, 0, pFont)
            End If
            ...
            If Trim(prn_HdDt.Rows(0).Item("Po_No").ToString) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Po_No").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
            End If



            If Trim(prn_HdDt.Rows(0).Item("Po_Date").ToString) <> "" Then
                strWidth = e.Graphics.MeasureString(prn_HdDt.Rows(0).Item("Po_No").ToString, pFont).Width
                Common_Procedures.Print_To_PrintDocument(e, "Date : " & prn_HdDt.Rows(0).Item("Po_Date").ToString, LMargin + W1 + 30 + strWidth + 15, CurY, 0, 0, pFont)
            End If


            If Trim(prn_HdDt.Rows(0).Item("TransportName").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "TRNASPORT", LMargin + C1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Lr_Date").ToString) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, "Date : " & prn_HdDt.Rows(0).Item("Lr_Date").ToString, LMargin + W1 + 30 + strWidth + 15, CurY, 0, 0, pFont)
            End If

            If Trim(prn_HdDt.Rows(0).Item("Vechile_No").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Vechile_No", LMargin + C1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
    ...
    Private Function Get_HSN_CODE_Count() As Integer
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select count(HSN_Code) as HsnCnt from BobinSales_Invoice_GST_Tax_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and BobinSales_Invoice_Code = '" & Trim(NewCode) & "' ", con)
            da.Fill(dt)
            If dt.Rows.Count > 0 Then
                If IsDBNull(dt.Rows(0)(0).ToString) = False Then
    ...
    Private Sub Printing_GST_HSN_Details_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByRef CurY As Single, ByVal LMargin As Integer, ByVal PageWidth As Integer, ByVal PrintWidth As Double, ByVal LnAr As Single)
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select * from BobinSales_Invoice_GST_Tax_Details where BobinSales_Invoice_Code = '" & Trim(EntryCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
            ...
            If Dt.Rows.Count > 0 Then
                ...
                Do While vprn_HSN_DetIndx <= Dt.Rows.Count - 1

                    ItmNm1 = Trim(Dt.Rows(vprn_HSN_DetIndx).Item("HSN_Code").ToString)
                    ...
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("Taxable_Amount").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("Taxable_Amount").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("CGST_Percentage").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("CGST_Percentage").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("CGST_Amount").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("CGST_Amount").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) + SubClAr(4) - 5, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("SGST_Percentage").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("SGST_Percentage").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) + SubClAr(4) + SubClAr(5) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("SGST_Amount").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("SGST_Amount").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) + SubClAr(4) + SubClAr(5) + SubClAr(6) - 5, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("IGST_Percentage").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("IGST_Percentage").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) + SubClAr(4) + SubClAr(5) + SubClAr(6) + SubClAr(7) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Dt.Rows(vprn_HSN_DetIndx).Item("IGST_Amount").ToString) <> 0, Common_Procedures.Currency_Format(Val(Dt.Rows(vprn_HSN_DetIndx).Item("IGST_Amount").ToString)), ""), LMargin + SubClAr(1) + SubClAr(2) + SubClAr(3) + SubClAr(4) + SubClAr(5) + SubClAr(6) + SubClAr(7) + SubClAr(8) - 5, CurY, 1, 0, pFont)
                    ...
                    Ttl_TaxAmt = Ttl_TaxAmt + Val(Dt.Rows(vprn_HSN_DetIndx).Item("Taxable_Amount").ToString)
                    Ttl_CGst = Ttl_CGst + Val(Dt.Rows(vprn_HSN_DetIndx).Item("CGST_Amount").ToString)
                    Ttl_Sgst = Ttl_Sgst + Val(Dt.Rows(vprn_HSN_DetIndx).Item("SGST_Amount").ToString)
                    Ttl_igst = Ttl_igst + Val(Dt.Rows(vprn_HSN_DetIndx).Item("IGST_Amount").ToString)
                    vprn_HSN_DetIndx = vprn_HSN_DetIndx + 1
                Loop
    ...
    Private Sub cbo_Grid_Bobin_Size_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_Bobin_Size.TextChanged
        Try
            If IsNothing(dgv_Details.CurrentCell) Then Exit Sub
            With dgv_Details
                If cbo_Grid_Bobin_Size.Visible = True Then
                    If Val(cbo_Grid_Bobin_Size.Tag) = Val(.CurrentRow.Index) And .CurrentCell.ColumnIndex = DGVCol_BobinDetails.Bobin_Size Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(.CurrentCell.ColumnIndex).Value = Trim(cbo_Grid_Bobin_Size.Text)
                    End If
                End If
            End With
        Catch ex As Exception
    ...
    Private Sub cbo_Vechile_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Vechile.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vechile, cbo_Transport, cbo_DeliveryTo, "BobinSales_Invoice_Head", "Vechile_No", "", "")
    End Sub

    Private Sub cbo_Vechile_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Vechile.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vechile, cbo_DeliveryTo, "BobinSales_Invoice_Head", "Vechile_No", "", "", False)
    End Sub

    Private Sub cbo_Vechile_Enter(sender As Object, e As EventArgs) Handles cbo_Vechile.Enter
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "BobinSales_Invoice_Head", "Vechile_No", "", "")
    End Sub

    Private Sub cbo_DeliveryTo_Enter(sender As Object, e As EventArgs) Handles cbo_DeliveryTo.Enter
        cbo_DeliveryTo.Tag = Trim(UCase(cbo_DeliveryTo.Text))
    ...
    Private Sub cbo_DeliveryTo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_DeliveryTo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DeliveryTo, Nothing, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", " ( (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 ) ) or Show_In_All_Entry = 1) ", "(Ledger_IdNo = 0)")
    ...
    Private Sub btn_GENERATEEWB_Click(sender As Object, e As EventArgs) Handles btn_GENERATEEWB.Click
        ...
        Dim da As New SqlClient.SqlDataAdapter("Select Eway_BillNo from BobinSales_Invoice_Head where BobinSales_Invoice_Code = '" & NewCode & "'", con)
        Dim dt As New DataTable
        ...
        CMD.CommandText = "Insert into EWB_Head ([SupplyType]  ,[SubSupplyType]  , [SubSupplyDesc]  ,[DocType]  ,	[EWBGenDocNo]                           ,[EWBDocDate]        ,[FromGSTIN]       ,[FromTradeName]  ,[FromAddress1]   ,[FromAddress2]     ,[FromPlace] ," &
                         ...
                         "[Distance], [VehicleNo]      ,[VehicleType]   , [InvCode], [ShippedToGSTIN], [ShippedToTradeName] ) " &
                         " " &
                         " " &
                         "  SELECT               'O'              , '1'             ,   ''              ,    'INV'    , a.BobinSales_Invoice_No ,a.BobinDelivery_Invoice_Date          , C.Company_GSTINNo, C.Company_Name   ,C.Company_Address1+C.Company_Address2,c.Company_Address3+C.Company_Address4,C.Company_City ," &
                         ...
                         " 1                     , a.RoundOff_Amount  , A.Total_Taxable_Value    , A.Total_CGST_Amount  ,  A.Total_SGST_Amount , A.Total_IGST_Amount   ,   0         ,0                   , t.Ledger_GSTINNo  , t.Ledger_MainName , " &
                         " a.LR_No        ,a.LR_Date            ,a.Net_Amount         ,   '1'  AS TrMode ," &
                         " (CASE WHEN a.DeliveryTo_IdNo <> 0 THEN  tDELV.Distance ELSE L.Distance END), a.Vechile_No, 'R', '" & NewCode & "', tDELV.Ledger_GSTINNo as ShippedTo_GSTIN, tDELV.Ledger_MainName as ShippedTo_LedgerName from BobinSales_Invoice_Head a inner Join Company_Head C on a.Company_IdNo = C.Company_IdNo " &
                         ...
                         " where a.BobinSales_Invoice_Code = '" & Trim(NewCode) & "'"
        CMD.ExecuteNonQuery()
        ...
        '                 " a.Vehicle_No,'R','" & NewCode & "' from Yarn_Sales_Head a inner Join Company_Head C on a.Company_IdNo = C.Company_IdNo " &
        ...
        da = New SqlClient.SqlDataAdapter(" Select  I.EndsCount_Name,IG.ItemGroup_Name,IG.Item_HSN_Code,IG.Item_GST_Percentage,sum(SD.Taxable_Value) As TaxableAmt,sum(SD.Weights) as Qty,Min(Sl_No), 'WGT' AS Units " &
                                          " from BobinSales_Invoice_Details SD Inner Join EndsCount_Head I On SD.EndsCount_IdNo = I.EndsCount_IdNo Inner Join Count_Head CH On I.Count_IdNo = CH.Count_IdNo Inner Join ItemGroup_Head IG on CH.ItemGroup_IdNo = IG.ItemGroup_IdNo " &
                                          " Where SD.BobinSales_Invoice_Code = '" & Trim(NewCode) & "' Group By " &
                                          " I.EndsCount_Name,IG.ItemGroup_Name,IG.Item_HSN_Code,IG.ItemGroup_Name ,IG.Item_HSN_Code,IG.Item_GST_Percentage", con)
        dt1 = New DataTable
        da.Fill(dt1)
        ...
        '                                  " from Yarn_Sales_Details SD Inner Join Count_Head I On SD.Count_IdNo = I.Count_IdNo Inner Join ItemGroup_Head IG on I.ItemGroup_IdNo = IG.ItemGroup_IdNo " &
        ...
        EWB.GenerateEWB(NewCode, con, rtbEWBResponse, txt_EWBNo, "BobinSales_Invoice_Head", "Eway_BillNo", "BobinSales_Invoice_Code", Pk_Condition)
    End Sub
    ...
    Private Sub btn_CancelEWB_1_Click(sender As Object, e As EventArgs) Handles btn_CancelEWB_1.Click
        ...
        EWB.CancelEWB(txt_EWBNo.Text, NewCode, con, rtbEWBResponse, txt_EWBNo, "BobinSales_Invoice_Head", "Eway_BillNo", "BobinSales_Invoice_Code")
    End Sub
    ...
    Private Sub btn_EWayBIll_Generation_Click(sender As Object, e As EventArgs) Handles btn_EWayBIll_Generation.Click
        ...
        Grp_EWB.Left = (Me.Width - pnl_Back.Width) / 2 + 200
