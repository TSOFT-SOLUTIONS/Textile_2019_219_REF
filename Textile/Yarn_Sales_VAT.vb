Public Class Yarn_Sales_VAT
    ...
    Private Pk_Condition As String = "YNSAL-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Yarn_Sales_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Sales_Code = '" & Trim(NewCode) & "' and  Entry_VAT_GST_Type <> 'GST' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Mill_Name, c.Count_name from Yarn_Sales_Details a INNER JOIN Mill_Head b ON a.Mill_IdNo = b.Mill_IdNo INNER JOIN Count_Head c ON a.Count_IdNo = c.Count_IdNo Where a.Yarn_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Private Sub Yarn_Sales_VAT_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Yarn_Sales_VAT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Yarn_Sales_VAT_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Yarn_Sales_VAT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Yarn_Sales_Entry_vat, "~L~") = 0 And InStr(Common_Procedures.UR.Yarn_Sales_Entry_vat, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Sales_Entry_vat, New_Entry, Me, con, "Yarn_Sales_Head", "Yarn_Sales_Code", NewCode, "Yarn_Sales_Date", "(Yarn_Sales_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            If Trim(UCase(cbo_Type.Text)) = "DELIVERY" Then
                cmd.CommandText = "Update Weaver_Sales_Yarn_Delivery_Details set Sales_Bag = a.Sales_Bag - (b.Bags) , Sales_Cone = a.Sales_Cone - (b.Cones) , Sales_Weight = a.Sales_Weight - (b.Weight ) from Weaver_Sales_Yarn_Delivery_Details a, Yarn_Sales_Details b Where b.Yarn_Sales_Code = '" & Trim(NewCode) & "' and a.Weaver_Sales_Yarn_Delivery_Code = b.Weaver_Sales_Yarn_Delivery_Code and a.Weaver_Sales_Yarn_Delivery_Detail_SlNo = b.Weaver_Sales_Yarn_Delivery_Detail_SlNo"
                cmd.ExecuteNonQuery()
            End If
            ...
            cmd.CommandText = "delete from Yarn_Sales_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Yarn_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Sales_No from Yarn_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  and Entry_VAT_GST_Type <> 'GST' Order by for_Orderby, Yarn_Sales_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Sales_No from Yarn_Sales_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  and Entry_VAT_GST_Type <> 'GST' Order by for_Orderby, Yarn_Sales_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Sales_No from Yarn_Sales_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type <> 'GST' Order by for_Orderby desc, Yarn_Sales_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Sales_No from Yarn_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  and Entry_VAT_GST_Type <> 'GST' Order by for_Orderby desc, Yarn_Sales_No desc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Yarn_Sales_Head", "Yarn_Sales_Code", "For_OrderBy", "(Entry_VAT_GST_Type <> 'GST')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_InvoiceNo.ForeColor = Color.Red

            msk_date.Text = Date.Today.ToShortDateString
            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as PurchaseAcName, c.ledger_name as TaxAcName from Yarn_Sales_Head a LEFT OUTER JOIN Ledger_Head b ON a.PurchaseAc_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.TaxAc_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Yarn_Sales_No desc", con)
            Da1.Fill(Dt1)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                Da1 = New SqlClient.SqlDataAdapter("Select a.* from Yarn_Sales_Details a Where a.Yarn_Sales_Code = '" & Trim(Dt1.Rows(0).Item("Yarn_Sales_Code").ToString) & "' Order by a.sl_no", con)
                Dt2 = New DataTable
                Da1.Fill(Dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Yarn_Sales_No from Yarn_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Yarn_Sales_Entry_vat, "~L~") = 0 And InStr(Common_Procedures.UR.Yarn_Sales_Entry_vat, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Yarn_Sales_Entry_vat, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Yarn_Sales_No from Yarn_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Yarn_Sales_Details ( Yarn_Sales_Code ,               Company_IdNo       ,   Yarn_Sales_No                                  ,                     for_OrderBy                                            ,              Yarn_Sales_Date,             Sl_No     ,              Count_IdNo         ,          Mill_IdNo       ,                     Bags            ,                 Cones                ,                        Weight         ,                   Rate_For                       ,                     Rate                 ,                  Amount          ,      Bag_No                          ,    Delivery_No          ,Weaver_Sales_Yarn_Delivery_Code,Weaver_Sales_Yarn_Delivery_Detail_SlNo) " & _
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, cbo_Through, cbo_VehicleNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_Transport, Cbo_RecFrom, "Yarn_Sales_Head", "Vehicle_No", "", "")
    ...
    Private Sub cbo_VehicleNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, Cbo_RecFrom, "Yarn_Sales_Head", "Vehicle_No", "", "", False)
        'If Asc(e.KeyChar) = 13 Then
        '    dgv_Details.Focus()
        '    dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(1)
        '    dgv_Details.CurrentCell.Selected = True
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" And (Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0) Then
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Yarn_Sales_Entry_vat, New_Entry) = False Then Exit Sub
    ...
    Private Sub Print_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Yarn_Sales_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Sales_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,d.Ledger_Name as TransportName,e.Ledger_Name as Agent_Name from Yarn_Sales_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo =a.Transport_IdNo  LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.Agent_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Sales_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.Mill_Name  from Yarn_Sales_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Mill_Head c ON a.Mill_IdNo = c.Mill_IdNo where a.Yarn_Sales_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Yarn_Sales_No", con)
...
8:
    ...
    Private Sub msk_OrderDate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles msk_OrderDate.KeyDown
        If e.KeyValue = 40 Then
            If cbo_YarnType.Visible And cbo_YarnType.Enabled Then
                cbo_YarnType.Focus()
            ElseIf txt_DateAndTime_Invoice.Visible And txt_DateAndTime_Invoice.Enabled Then
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.* , b.* ,  e.Ledger_Name as Transportname,h.Bags As Ent_Bag,  h.Weight As Ent_Wgt, h.Cones As Ent_COne, g.Count_Name , I.Mill_Name   from Weaver_Sales_Yarn_Delivery_Head a INNER JOIN Weaver_Sales_Yarn_Delivery_Details b ON a.Weaver_Sales_Yarn_Delivery_Code = b.Weaver_Sales_Yarn_Delivery_Code INNER JOIN Count_Head g ON g.Count_Idno = b.Count_IdNo  LEFT OUTER JOIN Mill_Head i ON b.Mill_IdNo = i.Mill_IdNo   LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo LEFT OUTER JOIN Yarn_Sales_Details h ON h.Yarn_Sales_Code = '" & Trim(NewCode) & "' and b.Weaver_Sales_Yarn_Delivery_Code = h.Weaver_Sales_Yarn_Delivery_Code and b.Weaver_Sales_Yarn_Delivery_Detail_SlNo = h.Weaver_Sales_Yarn_Delivery_Detail_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.DeliveryTo_idNo = " & Str(Val(LedIdNo)) & " and ((b.Weight - b.Sales_Weight ) > 0 or h.Weight > 0 ) order by a.Weaver_Sales_Yarn_Delivery_Date, a.for_orderby, a.Weaver_Sales_Yarn_Delivery_No", con)
            Dt1 = New DataTable
            nr = Da.Fill(Dt1)
...
8:
    ...
    Private Sub cbo_YarnType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_YarnType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_YarnType, msk_OrderDate, txt_DateAndTime_Invoice, "YarnType_Head", "Yarn_Type", "", "Yarn_Type")
    End Sub
    ...
    Private Sub cbo_YarnType_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_YarnType.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_YarnType, txt_DateAndTime_Invoice, "YarnType_Head", "Yarn_Type", "", "Yarn_Type")
    End Sub
End Class