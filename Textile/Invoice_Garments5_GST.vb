Public Class Invoice_Garments5_GST
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name as itemsizename from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.Size_idno = c.Size_idno where a.Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If Common_Procedures.Voucher_Updation(con, "GarmentSales", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_InvoiceNo.Text), dtp_Date.Value.Date, "Bill No . : " & Trim(lbl_InvoiceNo.Text), vVouPos_IdNos, vVouPos_Amts, vVouPos_ErrMsg, tr) = False Then
            ...
            '-----Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), Convert.ToDateTime(dtp_Date.Text), led_id, Trim(lbl_InvoiceNo.Text), AgntId, Val(vNetAmt), "DR", Trim(Pk_Condition) & Trim(NewCode), tr, Common_Procedures.SoftwareTypes.Textile_Software)
    ...
    Private Sub cbo_PaymentTerms_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_PaymentTerms.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, sender, txt_Noof_Bundles, txt_Electronic_RefNo, "Sales_Head", "Payment_Terms", "", "")
    End Sub

    Private Sub cbo_PaymentTerms_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_PaymentTerms.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, sender, txt_Electronic_RefNo, "Sales_Head", "Payment_Terms", "", "", False)
    End Sub

    Private Sub cbo_PaymentTerms_GotFocus(sender As Object, e As EventArgs) Handles cbo_PaymentTerms.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Sales_Head", "Payment_Terms", "", "")
    End Sub
    ...
    Private Sub txt_SlNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_SlNo.KeyDown
        ...
        If e.KeyCode = 38 Then e.Handled = True : cbo_AgentName.Focus()
    End Sub
    ...
    Private Sub txt_LrDate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_LrDate.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        If e.KeyCode = 40 Then e.Handled = True : cbo_PaymentTerms.Focus()
...
LOOP1:
    ...
    Private Sub cbo_TransportMode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportMode.KeyDown
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportMode, cbo_DocumentThrough, cbo_VehicleNo, "", "", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub cbo_RateFor_Pcs_OR_Box_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RateFor_Pcs_OR_Box.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, sender, cbo_AgentName, txt_SlNo, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_TransportMode, cbo_Transport, "Sales_Head", "Vehicle_No", "", "")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, cbo_Transport, "Sales_Head", "Vehicle_No", "", "", False)
    End Sub
    ...
    Private Sub Printing_GST_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, PageHeight As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean, ByVal vLine_Pen As Pen)
        ...
        Try
            ...
            If is_LastPage = True Then
                ...
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Trim(BankNm1), LMargin + 10, CurY, 0, 0, p1Font)


                Cmp_Name = prn_HdDt.Rows(0).Item("Company_Name").ToString
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, "For " & Trim(Cmp_Name), PageWidth - 15, CurY, 1, 0, p1Font)

                CurY = CurY + TxtHgt
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Trim(BankNm2), LMargin + 10, CurY, 0, 0, p1Font)

                CurY = CurY + TxtHgt
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Trim(BankNm3), LMargin + 10, CurY, 0, 0, p1Font)

                CurY = CurY + TxtHgt
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Trim(BankNm4), LMargin + 10, CurY, 0, 0, p1Font)

                CurY = CurY + TxtHgt
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Trim(BankNm5), LMargin + 10, CurY, 0, 0, p1Font)

                'CurY = CurY + TxtHgt
                'p1Font = New Font("Calibri", 12, FontStyle.Bold)
                'Common_Procedures.Print_To_PrintDocument(e, BankNm6, LMargin + 10, CurY, 0, 0, p1Font)


                If Trim(prn_HdDt.Rows(0).Item("Prepared_By").ToString) <> "" Then
    ...
    Private Sub Printing_GST_Format1_HSN_Details(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Integer, ByVal PageWidth As Integer, ByVal PrintWidth As Double, ByRef CurY As Single, ByRef TopLnYAxis As Single, ByVal vLine_Pen As Pen)
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select * from Sales_GST_Tax_Details where Sales_Code = '" & Trim(EntryCode) & "' order by HSN_Code, CGST_Percentage, SGST_Percentage, IGST_Percentage", con)
            Dt = New DataTable
            Da.Fill(Dt)
    ...
    Private Function get_GSTPercentage_and_GSTAmount_For_Printing(ByVal EntryCode As String) As String
        ...
        Nr = Cmd.ExecuteNonQuery()
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSubTable) & " (Int1, Name1, Meters1, Currency1) select 1, 'CGST @', CGST_Percentage, CGST_Amount from Sales_GST_Tax_Details Where Sales_Code = '" & Trim(EntryCode) & "' and CGST_Amount <> 0"
        Nr = Cmd.ExecuteNonQuery()
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSubTable) & " (Int1, Name1, Meters1, Currency1) select 2, 'SGST @', SGST_Percentage, SGST_Amount from Sales_GST_Tax_Details Where Sales_Code = '" & Trim(EntryCode) & "' and SGST_Amount <> 0"
        Nr = Cmd.ExecuteNonQuery()
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSubTable) & " (Int1, Name1, Meters1, Currency1) select 3, 'IGST @', IGST_Percentage, IGST_Amount from Sales_GST_Tax_Details Where Sales_Code = '" & Trim(EntryCode) & "' and IGST_Amount <> 0"
        Nr = Cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Close_PackSlip_Selection_Click(sender As Object, e As EventArgs) Handles btn_Close_PackSlip_Selection.Click
        ...
        If Dt1.Rows.Count > 0 Then
            ...
            For i = 0 To Dt1.Rows.Count - 1
                ...
                Da = New SqlClient.SqlDataAdapter("Select a.* from Sales_Details a Where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and Item_IdNo = " & Str(Val(Dt1.Rows(i).Item("Item_IdNo").ToString)) & " Order by a.sl_no", con)
