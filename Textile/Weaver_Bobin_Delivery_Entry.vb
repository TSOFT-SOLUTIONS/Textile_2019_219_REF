...
Public Class Weaver_Bobin_Delivery_Entry
    ...
    Public vBeam_Mtr As String

    Private Prn_Jari_Delivery_STS As Boolean = False
    ...
    Private Sub clear()
        ...
        vBeam_Mtr = cbo_KuriBorderSize.Text
    ...
    Private Sub Grid_Cell_DeSelect()
        On Error Resume Next
        dgv_Req_Details.CurrentCell.Selected = False
    ...
    Private Sub Weaver_Bobin_Delivery_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1414" Then
            ...
            btn_Print_Delivery.Text = "BOBIN"
            btn_Print_Jari_Delivery.Visible = True
        Else
            btn_Print_Delivery.Text = "DELIVERY"
            btn_Print_Jari_Delivery.Visible = False
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Weaver_bobin_delivery_Entry, New_Entry, Me, con, "Weaver_BobinJari_Delivery_Head", "Bobin_Jari_Delivery_Code", NewCode, "Bobin_Jari_Delivery_Date", "(Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Weaver_bobin_delivery_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Weaver_bobin_delivery_Entry, New_Entry, Me, con, "Weaver_BobinJari_Delivery_Head", "Bobin_Jari_Delivery_Code", NewCode, "Bobin_Jari_Delivery_Date", "(Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Bobin_Jari_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub
            ...
            With dgv_Req_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Weaver_Bobin_Delivery_Requirement_Details ( Weaver_Bobin_Delivery_Requirement_Code, Company_IdNo, Weaver_Bobin_Delivery_Requirement_No, for_OrderBy, Weaver_Bobin_Delivery_Requirement_Date, Sl_No, Ledger_IdNo, Requirement_No, Requirement_Date , loom_No, Mark, Noof_Bobin  ,Weaver_PavuBobin_Requirement_Code, Weaver_PavuBobin_Requirement_Slno ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & ",'" & Trim(.Rows(i).Cells(1).Value) & "', '" & Trim(.Rows(i).Cells(2).Value) & "', " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ",'" & Trim(.Rows(i).Cells(6).Value) & "', " & Str(Val(.Rows(i).Cells(7).Value)) & " )"
                        cmd.ExecuteNonQuery()
    ...
    End Sub
    Private Sub Weight_Caluculation(ByVal vCURROW As Integer)
        Dim i As Integer
        Dim sno As Integer
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1414" Then ' -------------Mahalakshmi Textile

            With dgv_KuriDetails

                'For i = 0 To dgv_KuriDetails.Rows.Count - 1
                ...
                Wgt = Val(dgv_KuriDetails.Rows(vCURROW).Cells(5).Value) * Val(dgv_KuriDetails.Rows(vCURROW).Cells(6).Value)


                dgv_KuriDetails.Rows(vCURROW).Cells(7).Value = Format(Val(Wgt), "#########0.00")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Weaver_bobin_delivery_Entry, New_Entry) = False Then Exit Sub
        If Trim(Common_Procedures.settings.CustomerCode) = "1414" Then
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If Trim(Common_Procedures.settings.CustomerCode) = "1414" Then ' ---  SRI MAHALAKSHMI TEXTILES (SOMANUR - THOTTIPALAYAM)
                    If Prn_Jari_Delivery_STS = True Then
                        cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5            ,meters1  , Name6  ) " &
                                                                                     "select  b.cOUNT_Name , c.Colour_name , a.Noof_Jumbos , a.Noof_Cones  , a.Weight , 0 ,d.BorderSize_Name  from Weaver_BobinJari_Delivery_Jari_Details a INNER JOIN cOUNT_Head b ON a.cOUNT_idno = b.cOUNT_idno INNER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                        nr = cmd.ExecuteNonQuery()

                        'cmd by lalith


                        '         cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5            ,meters1    ) " &
                        '"select  b.cOUNT_Name , c.Colour_name , a.Noof_Jumbos , a.Noof_Cones  , a.Weight , 0   from Weaver_BobinJari_Delivery_Jari_Details a INNER JOIN cOUNT_Head b ON a.cOUNT_idno = b.cOUNT_idno INNER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                        '         nr = cmd.ExecuteNonQuery()


                    Else
                        cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1      ,     Name2          ,  Name3     , Name4   ,   Name5    , Meters1     ) " &
                                                                     "select                 b.EndscOUNT_Name  ,     c.Colour_name  , a.Bobins   ,   ''    ,  a.Meters  , a.Meter_Bobin  from Weaver_BobinJari_Delivery_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno INNER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                        nr = cmd.ExecuteNonQuery()
                    End If
                Else
                    cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1      ,     Name2          ,  Name3     , Name4   ,   Name5    , Meters1     ) " &
                    ...
                    nr = cmd.ExecuteNonQuery()
                End If
                da2 = New SqlClient.SqlDataAdapter("select a.Name1   , a.Name2  , a.Name3  , a.Name4  , a.Name5  , a.meters1 , a.Name6 from  " & Trim(Common_Procedures.EntryTempTable) & " a  Order by a.Name1", con)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1414" Then
            Printing_Delivery_Format2_1414(e)
        Else
    ...
    Private Sub cbo_KuriBorderSize_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_KuriBorderSize.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            If Trim(UCase(vBeam_Mtr)) <> Trim(UCase(cbo_KuriBorderSize.Text)) Then

                vBeam_Mtr = cbo_KuriBorderSize.Text

                Get_Meter_From_BorderSize()
            End If
                    ...
                    If .Rows.Count > 0 Then
                        ...
                        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1414" Then
                            ...
                            If .CurrentCell.ColumnIndex = 5 Or .CurrentCell.ColumnIndex = 6 Then
                                Weight_Caluculation(e.RowIndex)
                            End If
    ...
    Private Sub dgtxt_KuriDetails_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_KuriDetails.KeyPress
        ...
        With dgv_KuriDetails
            ...
            If Val(dgv_KuriDetails.CurrentCell.ColumnIndex.ToString) = 6 Or Val(dgv_KuriDetails.CurrentCell.ColumnIndex.ToString) = 7 Then
    ...
    Private Sub YarnDelivery_Selection()
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(6).Value) = 1 Then
                ...
                ' dgv_Req_Details.Rows(n).Cells(8).Value = dgv_Selection.Rows(i).Cells(9).Value
    ...
    End Sub
    Private Sub Printing_Delivery_Format2_1414(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim pFont As Font
        'Dim ps As Printing.PaperSize
        Dim LMargin As Single, RMargin As Single, TMargin As Single, BMargin As Single
        Dim PrintWidth As Single, PrintHeight As Single
        ...
        If Prn_Jari_Delivery_STS = True Then
            ...
            ClAr(1) = 35 : ClAr(2) = 190 : ClAr(3) = 160 : ClAr(4) = 160 : ClAr(5) = 0
            ClAr(6) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5))

        Else

            ClAr(1) = 35 : ClAr(2) = 250 : ClAr(3) = 180 : ClAr(4) = 80 : ClAr(5) = 100
            ClAr(6) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5))
        ...
        Try
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_Delivery_Format2_1414_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClAr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_Delivery_Format2_1414_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, False)
                        ...
                        If Trim(prn_DetDt.Rows(prn_DetIndx).Item("Name2").ToString) <> "" Then
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Name2").ToString, LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                        End If
                        ...
                        If Prn_Jari_Delivery_STS = True Then
                            ...
                            If Trim(prn_DetDt.Rows(prn_DetIndx).Item("Name6").ToString) <> "" Then
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Name6").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont)
                            End If

                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Name3").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Name3").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
                            End If

                        Else

                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Name3").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Name3").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont)
                            End If

                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Meters1").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Meters1").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                            End If
                            If Val(prn_DetDt.Rows(prn_DetIndx).Item("Name5").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Name5").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
                            End If
                ...
                Printing_Delivery_Format2_1414_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, True)
    ...
    Private Sub Printing_Delivery_Format2_1414_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        Dim Cmp_Name As String, Cmp_Add1 As String, Cmp_Add2 As String
        ...
        If ClAr(5) > 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "BOBIN DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        Else
            Common_Procedures.Print_To_PrintDocument(e, "JUMBO DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        End If
        ...
        If ClAr(5) = 0 Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, "COUNT", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "NAME", LMargin + ClAr(1), CurY + TxtHgt, 2, ClAr(2), pFont)

            Common_Procedures.Print_To_PrintDocument(e, "SIZE", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)

            Common_Procedures.Print_To_PrintDocument(e, "JUMBO", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont)

        Else

            Common_Procedures.Print_To_PrintDocument(e, "ENDS", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "COUNT", LMargin + ClAr(1), CurY + TxtHgt, 2, ClAr(2), pFont)

            Common_Procedures.Print_To_PrintDocument(e, "BOBINS", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)

            Common_Procedures.Print_To_PrintDocument(e, "METER/", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "BOBIN", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY + TxtHgt, 2, ClAr(5), pFont)
    ...
    Private Sub Printing_Delivery_Format2_1414_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim i As Integer
        Dim Cmp_Name As String
        Dim p1Font As Font
        Dim W1 As Single = 0
        ...
        If Trim(prn_HdDt.Rows(0).Item("Remarks").ToString) <> "" Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, " :  ", LMargin + s2 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Remarks").ToString, LMargin + s2 + 30, CurY, 0, 0, pFont)
        End If
    ...
    Private Sub btn_Print_Jari_Delivery_Click(sender As Object, e As EventArgs) Handles btn_Print_Jari_Delivery.Click
        Prn_Jari_Delivery_STS = True
        Printing_Delivery()
        btn_print_Close_Click(sender, e)
    End Sub


    Public Sub Get_Meter_From_BorderSize()

        Dim da As New SqlClient.SqlDataAdapter
        Dim dt As New DataTable
        Dim cmd As New SqlClient.SqlCommand
        Dim Siz_Nm As String
        Dim Beam_Meter As String

        Siz_Nm = dgv_KuriDetails.Rows(dgv_KuriDetails.CurrentRow.Index).Cells(4).Value
        Beam_Meter = 0
        If Trim(Siz_Nm) <> "" Then
            da = New SqlClient.SqlDataAdapter("Select Beam_Meter From BorderSize_Head Where BorderSize_Name = '" & Trim(Siz_Nm) & "' ", con)
            dt = New DataTable
            da.Fill(dt)
        End If
        ...
        If dt.Rows.Count > 0 Then
            If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                Beam_Meter = Val(dt.Rows(0)(0).ToString)
            End If
        End If



        dgv_KuriDetails.Rows(dgv_KuriDetails.CurrentRow.Index).Cells(6).Value = Format(Val(Beam_Meter), "#########0.00")

    End Sub

    Private Sub cbo_KuriBorderSize_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_KuriBorderSize.SelectedIndexChanged
    ...
    Private Sub dgv_KuriDetails_Total_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_KuriDetails_Total.CellValueChanged

    End Sub

    Private Sub cbo_millName_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_millName.SelectedIndexChanged
