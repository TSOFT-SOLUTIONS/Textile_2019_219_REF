Public Class FireWood_Sales
    ...
    Private Pk_Condition As String = "FWOSA-"
    Private Pk_Condition_GST As String = "GFWSA-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Billing_FireWood_Sales_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("FireWood_Sales_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("FireWood_Sales_Date").ToString
                ...
                txt_Gross_Weight.Text = Format(Val(dt1.Rows(0).Item("Gross_Weight").ToString), "#########0.000")
                txt_Tare_Weight.Text = Format(Val(dt1.Rows(0).Item("Tare_Weight").ToString), "#########0.000")
                lbl_Net_Weight.Text = Format(Val(dt1.Rows(0).Item("Net_Weight").ToString), "#########0.000")
                ...
                'txt_Driver_LicenseNo.Text = dt1.Rows(0).Item("Driver_LicenseNo").ToString


                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Item_Name, c.Unit_Name from Billing_FireWood_Sales_Details a INNER JOIN Item_Head b ON a.Item_IdNo = b.Item_IdNo Inner JOin Unit_Head c On c.Unit_Idno = a.Unit_Idno  Where a.FireWood_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(2).Value = dt2.Rows(i).Item("Unit_Name").ToString
                            .Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Quantity").ToString), "########0.00")
                            .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                            .Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(3).Value = Format(Val(dt1.Rows(0).Item("Total_Quantity").ToString), "########0.00")
    ...
    Private Sub FireWood_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_Driver_LicenseNo.GotFocus, AddressOf ControlGotFocus
        ...
        '   AddHandler txt_License_AadharNo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Driver_LicenseNo.LostFocus, AddressOf ControlLostFocus
        '  AddHandler txt_License_AadharNo.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Driver_LicenseNo.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Driver_LicenseNo.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Firewood_Purchase_Entry, New_Entry, Me, con, "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", NewCode, "FireWood_Sales_Date", "(FireWood_Sales_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "FireWood_Sales_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Billing_FireWood_Sales_Details", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Item_IdNo,Gross_Weight,Tare_Weight,Net_Weight,Rate,Amount", "Sl_No", "FireWood_Sales_Code, For_OrderBy, Company_IdNo, FireWood_Sales_No, FireWood_Sales_Date", trans)
            ...
            cmd.CommandText = "delete from Billing_FireWood_Sales_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Billing_FireWood_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Sales_No from Billing_FireWood_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND FireWood_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FireWood_Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Sales_No from Billing_FireWood_Sales_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND FireWood_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, FireWood_Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Sales_No from Billing_FireWood_Sales_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND  FireWood_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FireWood_Sales_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 FireWood_Sales_No from Billing_FireWood_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND  FireWood_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, FireWood_Sales_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", "For_OrderBy", "FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_RefNo.ForeColor = Color.Red

            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as PurchaseAcName from Billing_FireWood_Sales_Head a LEFT OUTER JOIN Ledger_Head b ON a.SalesAc_IdNo = b.Ledger_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.FireWood_Sales_No desc", con)
            Da1.Fill(Dt1)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FireWood_Sales_No from Billing_FireWood_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FireWood_Sales_No from Billing_FireWood_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotQty As Single, vTotTareWgt As Single, vTotNetWgt As Single, vTotAmt As Single
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Firewood_Purchase_Entry, New_Entry, Me, con, "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", NewCode, "FireWood_Sales_Date", "(FireWood_Sales_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, FireWood_Sales_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", "For_OrderBy", "FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Billing_FireWood_Sales_Head (  User_IdNo ,     FireWood_Sales_Code ,               Company_IdNo       ,           FireWood_Sales_No    ,                               for_OrderBy           ,                      FireWood_Sales_Date   ,     Ledger_IdNo      ,          SalesAc_IdNo    ,                Bill_No            ,                Vehicle_No             ,                        Gross_Weight  ,                          Tare_Weight       ,                Net_Weight             ,             Total_Amount       ,Total_Quantity     ,   AddLess_Amount                ,      Net_Amount                        ,         Transport_IdNo    ,            Note               ,          RoundOff_Amount            ,              Freight     ,                      Unloading_Charge_Amount) " &
                                    "     Values                  (  " & Str(UserIdNo) & " ,  '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",      @PurDate    ,      " & Str(Val(Led_ID)) & ",    " & Str(Val(PurAc_ID)) & ",   '" & Trim(txt_BillNo.Text) & "', '" & Trim(cbo_VehicleNo.Text) & "',    " & Str(Val(txt_Gross_Weight.Text)) & "  ," & Str(Val(txt_Tare_Weight.Text)) & "  , " & Str(Val(lbl_Net_Weight.Text)) & "  ," & Str(Val(vTotAmt)) & "," & Str(Val(vTotQty)) & ", " & Str(Val(txt_AddLess.Text)) & "," & Str(Val(CSng(lbl_NetAmount.Text))) & ", " & Str(Val(Trans_ID)) & ",'" & Trim(txt_Note.Text) & "'  ,  " & Str(Val(lbl_RoundOff.Text)) & " ,    " & Str(Val(txt_Freight.Text)) & " ,       " & Str(Val(txt_Unloading_Charge.Text)) & "  ) "
                cmd.ExecuteNonQuery()
            Else


                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "FireWood_Sales_Code, Company_IdNo, for_OrderBy", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Billing_FireWood_Sales_Details", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo,Gross_Weight,Tare_Weight,Net_Weight,Rate,Amount", "Sl_No", "FireWood_Sales_Code, For_OrderBy, Company_IdNo, FireWood_Sales_No, FireWood_Sales_Date", tr)



                cmd.CommandText = "Update Billing_FireWood_Sales_Head set User_IdNo = " & Str(UserIdNo) & " , FireWood_Sales_Date = @PurDate, Ledger_IdNo = " & Str(Val(Led_ID)) & ", SalesAc_IdNo = " & Str(Val(PurAc_ID)) & ", Bill_No = '" & Trim(txt_BillNo.Text) & "', Vehicle_No = '" & Trim(cbo_VehicleNo.Text) & "', Gross_Weight  = " & Str(Val(txt_Gross_Weight.Text)) & ", Tare_Weight  = " & Str(Val(txt_Tare_Weight.Text)) & ", Net_Weight  = " & Str(Val(lbl_Net_Weight.Text)) & ", Total_Amount = " & Str(Val(vTotAmt)) & ", Total_Quantity = " & Str(Val(vTotQty)) & ", AddLess_Amount = " & Str(Val(txt_AddLess.Text)) & ",  RoundOff_Amount = " & Str(Val(lbl_RoundOff.Text)) & " ,  Net_Amount = " & Str(Val(CSng(lbl_NetAmount.Text))) & ", Transport_IdNo  = " & Str(Val(Trans_ID)) & ", Note = '" & Trim(txt_Note.Text) & "'  ,  Freight  = " & Str(Val(txt_Freight.Text)) & " , Unloading_Charge_Amount = " & Str(Val(txt_Unloading_Charge.Text)) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            End If
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Billing_FireWood_Sales_Head", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "FireWood_Sales_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        Unit_ID = Common_Procedures.Unit_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)

                        cmd.CommandText = "Insert into Billing_FireWood_Sales_Details ( FireWood_Sales_Code ,               Company_IdNo       ,   FireWood_Sales_No    ,                     for_OrderBy                                            ,   FireWood_Sales_Date  ,           Ledger_IdNo  ,           Sl_No     ,             Item_IdNo    ,                  Unit_Idno ,                             Quantity   ,                                 Rate                 ,                   Amount                ) " &
                                            "     Values                 (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",       @PurDate      ,     " & Str(Val(Led_ID)) & "  ,  " & Str(Val(Sno)) & ", " & Str(Val(Itm_ID)) & ",     " & Str(Val(Unit_ID)) & ",  " & Str(Val(.Rows(i).Cells(3).Value)) & ",    " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ") "
                        cmd.ExecuteNonQuery()
            ...
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Billing_FireWood_Sales_Details", "FireWood_Sales_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo,Gross_Weight,Tare_Weight,Net_Weight,Rate,Amount", "Sl_No", "FireWood_Sales_Code, For_OrderBy, Company_IdNo, FireWood_Sales_No, FireWood_Sales_Date", tr)


            Dim vLed_IdNos As String = "", vVou_Amts As String = "", ErrMsg As String = ""
            vLed_IdNos = Led_ID & "|" & PurAc_ID
            vVou_Amts = (-1 * Val(CSng(lbl_NetAmount.Text)) & "|" & (Val(CSng(lbl_NetAmount.Text))))
            If Common_Procedures.Voucher_Updation(con, "FireWood.sales", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, Trim(vTotNetWgt) & " Tonn", vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            ...
            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(txt_BillNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "CR", Trim(Pk_Condition) & Trim(NewCode), tr)
            If Trim(UCase(VouBil)) = "ERROR" Then
                Throw New ApplicationException("Error on Voucher Bill Posting")
            End If
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, Nothing, txt_VehicleNo, "Transport_Head", "Transport_Name", "", "(Transport_IdNo = 0)")
    ...
    Private Sub cbo_Transport_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Transport.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Transport, txt_VehicleNo, "Transport_Head", "Transport_Name", "", "(Transport_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_SalesAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_SalesAc, txt_BillNo, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 28)", "(Ledger_IdNo = 0)")
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FireWood_Sales_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.FireWood_Sales_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FireWood_Sales_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*,  c.Ledger_Name as PartyName from Billing_FireWood_Sales_Head a  INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' AND a.FireWood_Sales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FireWood_Sales_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from Billing_FireWood_Sales_Head a INNER JOIN Billing_FireWood_Sales_Details b ON a.FireWood_Sales_Code = b.FireWood_Sales_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FireWood_Sales_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("FireWood_Sales_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("FireWood_Sales_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Ledger_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyUp
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Common_Procedures.MDI_LedType = "FIREWOOD"
    ...
    Private Sub Amount_Calculation(ByVal CurRow As Integer, ByVal CurCol As Integer)
        ...
        With dgv_Details
            If .Visible Then
                If CurCol = 3 Or CurCol = 4 Or CurCol = 5 Then
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(3).Value = Format(Val(TotQty), "########0.00")
    ...
    Private Sub NetAmount_Calculation()
        ...
        With dgv_Details_Total
            If .RowCount > 0 Then
                TotAmt = Val(.Rows(0).Cells(5).Value)
            End If
        End With
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Billing_FireWood_Sales_Head a where a.FireWood_Sales_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            'da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*  from Billing_FireWood_Sales_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "'", con)
            'da1.Fill(prn_HdDt)

            'If prn_HdDt.Rows.Count > 0 Then

            '    da2 = New SqlClient.SqlDataAdapter("select a.*, b.* from Billing_FireWood_Sales_Details a  INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            '    da2.Fill(prn_DetDt)
            ...
            'End If
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code from Billing_FireWood_Sales_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_HEad CSH on b.Company_State_IdNo = CSH.State_IdNo LEFT OUTER JOIN State_HEad LSH on c.Ledger_State_IdNo = LSH.State_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.*,u.* from Billing_FireWood_Sales_Details a  INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head u on a.unit_IdNo = u.unit_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.FireWood_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                da2.Fill(prn_DetDt)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name from Billing_FireWood_Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo  where a.FireWood_Sales_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FireWood_Sales_No").ToString, LMargin + C1 + W1 + 25, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FireWood_Sales_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemName.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            Itm_idno = Common_Procedures.Item_NameToIdNo1(con, Trim(cbo_ItemName.Text))

            da = New SqlClient.SqlDataAdapter("select  b.unit_name from Item_Head a left outer join unit_head b on a.unit_idno = b.unit_idno Where a.item_IdNo = " & Str(Val(Itm_idno)), con)
            da.Fill(dt)
            ...
            dgv_Details.Rows(dgv_Details.CurrentRow.Index).Cells(2).Value = Trim(Unt_nm)
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Unit_Name").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) - 5, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, (prn_DetDt.Rows(prn_DetIndx).Item("Quantity").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 3, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Rate").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Amount").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 5, CurY, 1, 0, pFont)
                            'Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Amount").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 5, CurY, 1, 0, pFont)
                    ...
                    CurY = CurY + TxtHgt
                    w1 = e.Graphics.MeasureString("GROSS WEIGHT                ", pFont).Width
                    pFont1 = New Font("Calibri", 11, FontStyle.Bold)
                    If Val(prn_HdDt.Rows(0).Item("Gross_Weight").ToString) <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "GROSS WEIGHT   ", LMargin + ClArr(1) + 10, CurY, 0, 0, pFont1)
                        Common_Procedures.Print_To_PrintDocument(e, " : " & Format(Val(prn_HdDt.Rows(0).Item("Gross_Weight").ToString), "##########0.00"), LMargin + ClArr(1) + w1 + 10, CurY, 0, 0, pFont1)


                    End If
                    CurY = CurY + TxtHgt

                    If Val(prn_HdDt.Rows(0).Item("Tare_Weight").ToString) <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "TARE WEIGHT   ", LMargin + ClArr(1) + 10, CurY, 0, 0, pFont1)
                        Common_Procedures.Print_To_PrintDocument(e, " : " & Format(Val(prn_HdDt.Rows(0).Item("Tare_Weight").ToString), "##########0.00"), LMargin + ClArr(1) + w1 + 10, CurY, 0, 0, pFont1)


                    End If
                    CurY = CurY + TxtHgt
                    If Val(prn_HdDt.Rows(0).Item("Net_Weight").ToString) <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "NET WEIGHT   ", LMargin + ClArr(1) + 10, CurY, 0, 0, pFont1)
                        Common_Procedures.Print_To_PrintDocument(e, " : " & Format(Val(prn_HdDt.Rows(0).Item("Net_Weight").ToString), "##########0.00"), LMargin + ClArr(1) + w1 + 10, CurY, 0, 0, pFont1)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "SNO", LMargin, CurY, 2, ClAr(1), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "ITEM NAME", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "UNIT", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            ...
            'Common_Procedures.Print_To_PrintDocument(e, "", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If is_LastPage = True Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_Quantity").ToString), "#########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 5, CurY, 1, 0, pFont)
                If Val(prn_HdDt.Rows(0).Item("Total_aMOUNT").ToString) <> 0 Then
            ...
            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 11, FontStyle.Underline Or FontStyle.Bold)
            ...
            If BankNm2 <> "" Then
                CurY = CurY + TxtHgt + 3
                Common_Procedures.Print_To_PrintDocument(e, "ACCOUNT NO     :  " & BankNm2, LMargin + 10, CurY, 0, 0, p3Font)
            End If
            If BankNm3 <> "" Then
                CurY = CurY + TxtHgt + 3
                Common_Procedures.Print_To_PrintDocument(e, "BRANCH NAME :  " & BankNm3, LMargin + 10, CurY, 0, 0, p3Font)
            End If
            If BankNm4 <> "" Then
                CurY = CurY + TxtHgt + 3
            ...
            p1Font = New Font("Calibri", 10, FontStyle.Bold)
            CurY = CurY + 5
            Common_Procedures.Print_To_PrintDocument(e, "Note  : " & Trim(prn_HdDt.Rows(0).Item("Note").ToString), LMargin + 10, CurY, 0, 0, p1Font)
    ...
    Private Sub Update_PrintOut_Status(Optional ByVal sqltr As SqlClient.SqlTransaction = Nothing)
        ...
        Try
            ...
            cmd.CommandText = "Update Billing_FireWood_Sales_Head set PrintOut_Status = " & Str(Val(vPrnSTS)) & " where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FireWood_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
...
LOOP2:
    ...
    Private Sub Printing_Format4_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            '''''''
            CurY = CurY + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("Driver_LicenseNo").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Licence No : " & prn_HdDt.Rows(0).Item("Driver_LicenseNo").ToString, LMargin + S1 + 10, CurY, 0, 0, pFont)
            End If
            '''''''
    ...
    Private Sub txt_Gross_Weight_TextChanged(sender As Object, e As EventArgs) Handles txt_Gross_Weight.TextChanged
        ...
        lbl_Net_Weight.Text = Format(Val(txt_Gross_Weight.Text) - Val(txt_Tare_Weight.Text).ToString, "########0.000")


    End Sub

    Private Sub txt_Tare_Weight_TextChanged(sender As Object, e As EventArgs) Handles txt_Tare_Weight.TextChanged
    ...
    Private Sub txt_Gross_Weight_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Gross_Weight.KeyDown
        If e.KeyValue = 38 Then
    ...
    Private Sub txt_Gross_Weight_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Gross_Weight.KeyPress
    ...
    Private Sub cbo_VehicleNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, cbo_SalesAc, Nothing, "Billing_FireWood_Sales_Head", "Vehicle_No", "", "")
        If e.KeyValue = 40 Then
            If dgv_Details.RowCount > 0 Then
                dgv_Details.Focus()
                dgv_Details.CurrentCell = dgv_Details.Rows(dgv_Details.CurrentRow.Index).Cells(1)
    ...
    Private Sub cbo_VehicleNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, Nothing, "Billing_FireWood_Sales_Head", "Vehicle_No", "", "", False)
    ...
    Private Sub cbo_VehicleNo_Enter(sender As Object, e As EventArgs) Handles cbo_VehicleNo.Enter
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Billing_FireWood_Sales_Head", "Vehicle_No", "", "")
    End Sub
