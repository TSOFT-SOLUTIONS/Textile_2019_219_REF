Public Class Cotton_Purchase_gst
    ...
    Private Sub clear()
        ...
        txt_AddLess_AfterAmount.Text = "0.00"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_AddLess_AfterAmount.Text = Format(Val(dt1.Rows(0).Item("AddLess_AfterAmount").ToString), "#########0.00")
    ...
    Private Sub Cotton_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_AddLess_AfterAmount.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_AddLess_AfterAmount.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_AddLess_AfterAmount.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_AddLess_AfterAmount.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If Common_Procedures.Voucher_Updation(con, "GST-Cotn.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(lbl_RefNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.OE_Software) = False Then
            ...
            If Common_Procedures.Voucher_Updation(con, "GST-AgComm.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition2) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(lbl_RefNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.OE_Software) = False Then
                Throw New ApplicationException(ErrMsg)
            End If
            ...
            If Common_Procedures.Voucher_Updation(con, "CtnPurc.Tds", Val(lbl_Company.Tag), Trim(PkCondition3_TDSCO) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_Date.Text), "Bill No : " & Trim(txt_BillNo.Text) & " , CtnPurc.No : " & Trim(lbl_RefNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                Throw New ApplicationException(ErrMsg)
            End If
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, txt_Freight, txt_AddLess_AfterAmount, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_Transport_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Transport.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Transport, txt_AddLess_AfterAmount, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub Total_Calculation()
        ...
        lbl_Assessable.Text = Format(Val(TotAmt) + Val(txt_AddLess.Text) + +Val(txt_Freight.Text), "########0.00")
    ...
    Private Sub NetAmount_Calculation()
        ...
        Dim IGSTAmt As Single = 0 ''Txt_Cess_Amount
        Dim CESSAmt As Single = 0
        ...
        If chk_TDS_Tax.Checked = True Then
            ...
            If DateDiff("d", vTDS_StartDate.Date, dtp_Date.Value.Date) > 0 Then
                ...
                If txt_TDS_TaxableValue.Enabled = False Then
                    ...
                    If Val((lbl_TotalSales_Amount_Previous_Year.Text)) > Val(vMIN_TDS_assval) Then

                        vTDS_AssVal = Format(Val(vTOT_SalAmt), "############0")

                    ElseIf Val((lbl_TotalSales_Amount_Current_Year.Text)) > Val(vMIN_TDS_assval) Then
                        vTDS_AssVal = Format(Val(vTOT_SalAmt), "############0")

                    ElseIf (Val((lbl_TotalSales_Amount_Current_Year.Text)) + Val(vTOT_SalAmt)) > Val(vMIN_TDS_assval) Then
        ...
        Bill_Amt = Val(lbl_Assessable.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_AddLess_AfterAmount.Text) + Val(Txt_Cess_Amount.Text) + Val(lbl_TcsAmount.Text)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        '        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Variety_name , c.Mill_Name  from Cotton_Purchase_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Mill_Head c ON a.Mill_IdNo = c.Mill_IdNo where a.Cotton_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.for_orderby, a.Cotton_Purchase_No", con)
        ...
        Try
            ...
            For I = 0 To dgv_Direct_BaleDetails.Rows.Count - 1
                ...
                If Trim(dgv_Direct_BaleDetails.Rows(I).Cells(1).Value) <> "" And Val(dgv_Direct_BaleDetails.Rows(I).Cells(2).Value) <> 0 Then
                    ...
                    Cmd.CommandText = "Insert into EntryTemp(Name1, Meters1) values ('" & Trim(dgv_Direct_BaleDetails.Rows(I).Cells(1).Value) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(dgv_Direct_BaleDetails.Rows(I).Cells(1).Value))) & " ) "
                    Cmd.ExecuteNonQuery()
            ...
            Da1 = New SqlClient.SqlDataAdapter("Select Name1 as Bale_No, Meters1 as fororderby_baleno from entrytemp where Name1 <> '' order by Meters1, Name1", con)
            Dt1 = New DataTable
            Da1.Fill(Dt1)
...
LOOP1:
    ...
    Private Sub chk_TaxAmount_RoundOff_STS_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_TaxAmount_RoundOff_STS.CheckedChanged
        ...
        NetAmount_Calculation()
    End Sub
    Private Sub txt_AddLess_AfterAmount_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_AddLess_AfterAmount.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_AddLess_AfterAmount_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_AddLess_AfterAmount.LostFocus
        If Val(txt_AddLess_AfterAmount.Text) <> 0 Then
            txt_AddLess_AfterAmount.Text = Format(Val(txt_AddLess_AfterAmount.Text), "#########0.00")
        Else
            txt_AddLess_AfterAmount.Text = ""
        End If
    End Sub

    Private Sub txt_AddLess_AfterAmount_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_AddLess_AfterAmount.TextChanged
        Total_Calculation()
        'NetAmount_Calculation()
    End Sub
    ...
    Private Sub dtp_Date_TextChanged(sender As Object, e As System.EventArgs) Handles dtp_Date.TextChanged
        NetAmount_Calculation()
    End Sub
