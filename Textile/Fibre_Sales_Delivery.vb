Public Class Fibre_Sales_Delivery
    ...
    Private Pk_Condition As String = "FISDC-"
    ...
    Private vdgvLevCol_FibreDetails As Integer
    Private vdgv_FibreDet_PrevLotNo As String
    ...
    Private Sub clear()
        ...
        dgv_FibreDetails_Total.Rows.Clear()
        dgv_FibreDetails_Total.Rows.Add()
        ...
        cbo_Grid_FibreName.Enabled = True
        cbo_Grid_FibreName.BackColor = Color.White
        ...
        cbo_Grid_FibreName.Visible = False
        cbo_Grid_MillName.Visible = False
        cbo_Grid_YarnType.Visible = False
        cbo_Grid_lotNo.Visible = False
        vdgvLevCol_FibreDetails = -1
        vdgv_FibreDet_PrevLotNo = ""
        NoCalc_Status = False
    End Sub
    ...
    Private Sub ControlGotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.ActiveControl.Name <> cbo_Grid_FibreName.Name Then
            cbo_Grid_FibreName.Visible = False
        End If
        ...
        If Me.ActiveControl.Name <> dgv_FibreDetails_Total.Name Then
            Grid_DeSelect()
        End If
    ...
    Private Sub Grid_DeSelect()
        ...
        If Not IsNothing(dgv_FibreDetails_Total.CurrentCell) Then dgv_FibreDetails_Total.CurrentCell.Selected = False
    End Sub
    ...
    Private Sub Fibre_Sales_Delivery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_Grid_FibreName.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "FIBRE" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_Grid_FibreName.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
    ...
    Private Sub Fibre_Sales_Delivery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub
    Private Sub Fibre_Sales_Delivery_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Vechile_No) from Fibre_Delivery_Head order by Vechile_No", con)
        da.Fill(dt7)
        ...
        da.Fill(dt5)
        cbo_Grid_FibreName.DataSource = dt5
        cbo_Grid_FibreName.DisplayMember = "Fibre_Name"
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then
            ...
            lbl_heading.Text = "GENERAL DELIVERY"
            Me.Text = "GENERAL DELIVERY"
        ...
        AddHandler cbo_Grid_FibreName.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_Grid_FibreName.LostFocus, AddressOf ControlLostFocus
    ...
    End Sub
    Private Sub Fibre_Sales_Delivery_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If ActiveControl.Name = dgv_FibreDetails.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then
            ...
            ElseIf dgv_FibreDetails.IsCurrentRowDirty = True Then
                dgv1 = dgv_FibreDetails
            Else
                dgv1 = dgv_FibreDetails
            End If
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from Fibre_Delivery_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Fibre_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Fibre_Delivery_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Fibre_Name , c. Mill_Name from Fibre_Delivery_Details a INNER JOIN Fibre_Head b on a.Fibre_IdNo = b.Fibre_IdNo  LEFT JOIN Mill_Head c on a.Mill_Idno=c.Mill_Idno where a.Fibre_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_FibreDetails.Rows(n).Cells(2).Value = dt2.Rows(i).Item("Yarn_Type").ToString
                        dgv_FibreDetails.Rows(n).Cells(3).Value = dt2.Rows(i).Item("Mill_Name").ToString
                        dgv_FibreDetails.Rows(n).Cells(4).Value = Val(dt2.Rows(i).Item("Bales").ToString)
                        dgv_FibreDetails.Rows(n).Cells(5).Value = Val(dt2.Rows(i).Item("Cones").ToString)
                        dgv_FibreDetails.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Weight").ToString), "########0.000")
                        dgv_FibreDetails.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                        dgv_FibreDetails.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                        ' dgv_FibreDetails.Rows(n).Cells(9).Value = (dt2.Rows(i).Item("Bale_No").ToString)
                        dgv_FibreDetails.Rows(n).Cells(9).Value = dt2.Rows(i).Item("Lot_No").ToString
                        dgv_FibreDetails.Rows(n).Cells(10).Value = Val(dt2.Rows(i).Item("Fibre_Delivery_Detail_SlNo").ToString)
                        dgv_FibreDetails.Rows(n).Cells(11).Value = Format(Val(dt2.Rows(i).Item("Sales_Weight").ToString), "########0.000")

                        dgv_FibreDetails.Rows(n).Cells(12).Value = Format(Val(dt2.Rows(i).Item("Purchase_Weight").ToString), "########0.000")
                        dgv_FibreDetails.Rows(n).Cells(13).Value = Format(Val(dt2.Rows(i).Item("Purchase_Rate").ToString), "########0.00")

                        'If Val(dgv_FibreDetails.Rows(n).Cells(11).Value) <> 0 Then

                        '    For j = 1 To dgv_FibreDetails.ColumnCount - 1
                        '        dgv_FibreDetails.Rows(n).Cells(j).Style.BackColor = Color.LightGray
                        '        dgv_FibreDetails.Rows(n).Cells(j).ReadOnly = True
                        '    Next j
                        '    LockSTS = True
                        'Else
                        '    For j = 1 To dgv_FibreDetails.ColumnCount - 1
                        '        dgv_FibreDetails.Rows(n).Cells(j).Style.BackColor = Color.White
                        '        dgv_FibreDetails.Rows(n).Cells(j).ReadOnly = False
                        '    Next j
                        'End If
                    Next i
                ...
                With dgv_FibreDetails_Total
                    ...
                    .Rows(0).Cells(12).Value = Format(Val(dt1.Rows(0).Item("Total_Purchase_Weight").ToString), "########0.000")
                    '   .Rows(0).Cells(13).Value = Format(Val(dt1.Rows(0).Item("Total_Purchase_Rate").ToString), "########0.00")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '  If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.yarn_Delivery_Entry, New_Entry, Me, con, "Fibre_Delivery_Head", "Fibre_Delivery_Code", NewCode, "Fibre_Delivery_Date", "(Fibre_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub


        If Common_Procedures.settings.Vefified_Status = 1 Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

            If Val(Common_Procedures.get_FieldValue(con, "Fibre_Delivery_Head", "Verified_Status", "(Fibre_Delivery_Code = '" & Trim(NewCode) & "')")) = 1 Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Sales_Weight) from Fibre_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Delivery_Head", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Fibre_Delivery_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Fibre_Delivery_Details", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Yarn_Type, Mill_IdNo,Fibre_Idno, bales, Cones, Weight , Rate, Amount, Bag_No,  Fibre_Delivery_Detail_SlNo ", "Sl_No", "Fibre_Delivery_Code, For_OrderBy, Company_IdNo, Fibre_Delivery_No, Fibre_Delivery_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "delete from Fibre_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Fibre_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        ...
        If Filter_Status = False Then
            ...
            cbo_Filter_CountName.DisplayMember = "Fibre_Name"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Delivery_No from Fibre_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Fibre_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Delivery_No from Fibre_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Fibre_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Delivery_No from Fibre_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Delivery_No from Fibre_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Delivery_Head", "Fibre_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red


            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Fibre_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Fibre_Delivery_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Fibre_Delivery_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Delivery_No from Fibre_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotYrnbales As Single, vTotYrnCones As Single, vTotYrnWeight, vTotYrnThiri As Single, vTotYrnAmount As Single
        Dim EntID As String = ""
        Dim Thiri_val As Single = 0
        Dim Stock_Weight As String = 0
        ...
        Dim vPurchaseRate_SalsAmt As String = 0

        Dim vTotPurWgt As Single
        Dim vTotPurRate As Single
        ...
        '    If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.yarn_Delivery_Entry, New_Entry, Me, con, "Fibre_Delivery_Head", "Fibre_Delivery_Code", NewCode, "Fibre_Delivery_Date", "(Fibre_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Fibre_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub

        If Common_Procedures.settings.Vefified_Status = 1 Then
            If Not (Val(Common_Procedures.User.IdNo) = 1 Or Common_Procedures.User.Show_Verified_Status = 1) Then
                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

                If Val(Common_Procedures.get_FieldValue(con, "Fibre_Delivery_Head", "Verified_Status", "(Fibre_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        For i = 0 To dgv_FibreDetails.RowCount - 1
            ...
            If Val(dgv_FibreDetails.Rows(i).Cells(6).Value) <> 0 Then

                YCnt_ID = Common_Procedures.Fibre_NameToIdNo(con, dgv_FibreDetails.Rows(i).Cells(1).Value)
                If Val(YCnt_ID) = 0 Then
                    MessageBox.Show("Invalid FibreName", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ...
                If Trim(dgv_FibreDetails.Rows(i).Cells(2).Value) = "" Then
                    ...
                    dgv_FibreDetails.CurrentCell = dgv_FibreDetails.Rows(0).Cells(2)
                    dgv_FibreDetails.Focus()
                    Exit Sub
                End If


                YMil_ID = Common_Procedures.Mill_NameToIdNo(con, dgv_FibreDetails.Rows(i).Cells(3).Value)
                If Val(YMil_ID) = 0 Then
                    MessageBox.Show("Invalid Mill Name", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    dgv_FibreDetails.CurrentCell = dgv_FibreDetails.Rows(0).Cells(3)
                    dgv_FibreDetails.Focus()
                    Exit Sub
                End If
            End If
        ...
        vTotYrnbales = 0 : vTotYrnCones = 0 : vTotYrnWeight = 0 : vTotYrnThiri = 0
        If dgv_FibreDetails_Total.RowCount > 0 Then
            vTotYrnbales = Val(dgv_FibreDetails_Total.Rows(0).Cells(4).Value())
            vTotYrnCones = Val(dgv_FibreDetails_Total.Rows(0).Cells(5).Value())
            vTotYrnWeight = Val(dgv_FibreDetails_Total.Rows(0).Cells(6).Value())
            vTotYrnAmount = Val(dgv_FibreDetails_Total.Rows(0).Cells(8).Value())

            vTotPurWgt = Val(dgv_FibreDetails_Total.Rows(0).Cells(12).Value())
            vTotPurRate = Val(dgv_FibreDetails_Total.Rows(0).Cells(13).Value())
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Delivery_Head", "Fibre_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Fibre_Delivery_Head(Fibre_Delivery_Code, Company_IdNo, Fibre_Delivery_No, for_OrderBy, Fibre_Delivery_Date, DeliveryTo_IdNo, ReceivedFrom_IdNo, Transport_IdNo,  Vechile_No, Total_Bales, Total_Cones, Total_Weight , Total_Amount, Freight,   User_Idno,Verified_Status,Remarks,Bill_No,DeliveryAt_idno,Agent_idno,Po_No_Date ,Total_purchase_weight  ,Total_Purchase_Rate) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & " , " & Str(Val(Trans_ID)) & ",   '" & Trim(cbo_Vechile.Text) & "' , " & Str(Val(vTotYrnbales)) & ", " & Str(Val(vTotYrnCones)) & ", " & Str(Val(vTotYrnWeight)) & " , " & Str(Val(vTotYrnAmount)) & ",   " & Str(Val(txt_Freight.Text)) & " ,  " & Val(lbl_UserName.Text) & ", " & Val(Verified_STS) & ",'" & Trim(txt_Remarks.Text) & "','" & Trim(txt_Bill_no.Text) & "'," & Val(Delv_At) & "," & Val(Agent) & ",'" & Trim(Txt_po_no_Date.Text) & "' , " & Val(dgv_FibreDetails_Total.Rows(0).Cells(12).Value) & "," & Val(dgv_FibreDetails_Total.Rows(0).Cells(13).Value) & ")"
                cmd.ExecuteNonQuery()

            Else


                'Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Fibre_Delivery_Head", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Fibre_Delivery_Code, Company_IdNo, for_OrderBy", tr)
                'Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Fibre_Delivery_Details", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Yarn_Type, Lot_No,Fibre_Idno, bales, Cones, Weight , Rate, Amount, Bale_No,  Fibre_Delivery_Detail_SlNo ", "Sl_No", "Fibre_Delivery_Code, For_OrderBy, Company_IdNo, Fibre_Delivery_No, Fibre_Delivery_Date, Ledger_Idno", tr)


                cmd.CommandText = "Update Fibre_Delivery_Head set Fibre_Delivery_Date = @EntryDate, DeliveryTo_IdNo = " & Str(Val(Delv_ID)) & ", ReceivedFrom_IdNo = " & Str(Val(Rec_ID)) & " , Transport_IdNo = " & Str(Val(Trans_ID)) & ",  Vechile_No = '" & Trim(cbo_Vechile.Text) & "' ,  Total_Bales = " & Str(Val(vTotYrnbales)) & ", Total_Cones = " & Str(Val(vTotYrnCones)) & ", Total_Weight = " & Str(Val(vTotYrnWeight)) & "  ,   Freight = " & Str(Val(txt_Freight.Text)) & ",  User_idNo = " & Val(lbl_UserName.Text) & ", Total_Amount = " & Str(Val(vTotYrnAmount)) & ",Verified_Status= " & Val(Verified_STS) & ",Remarks='" & Trim(txt_Remarks.Text) & "',Bill_no='" & Trim(txt_Bill_no.Text) & "',DeliveryAt_idno=" & Val(Delv_At) & " ,Agent_idno=" & Val(Agent) & ",Po_No_Date='" & Trim(Txt_po_no_Date.Text) & "'  , Total_purchase_weight =" & Val(dgv_FibreDetails_Total.Rows(0).Cells(12).Value) & " , Total_Purchase_Rate = " & Val(dgv_FibreDetails_Total.Rows(0).Cells(13).Value) & "   Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Fibre_Delivery_Code = '" & Trim(NewCode) & "' "
                cmd.ExecuteNonQuery()


            End If
            ' Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Fibre_Delivery_Head", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Fibre_Delivery_Code, Company_IdNo, for_OrderBy", tr)
            ...
            cmd.CommandText = "Delete from Fibre_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(NewCode) & "' and Sales_Weight = 0"
            cmd.ExecuteNonQuery()
            ...
            With dgv_FibreDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        YCnt_ID = Common_Procedures.Fibre_NameToIdNo(con, .Rows(i).Cells(1).Value, tr)

                        YMil_ID = Common_Procedures.Mill_NameToIdNo(con, .Rows(i).Cells(3).Value, tr)
                        Nr = 0
                        cmd.CommandText = "Update  Fibre_Delivery_Details set Fibre_Delivery_Date = @EntryDate , DeliveryTo_idNo = " & Val(Delv_ID) & " ,ReceiverFrom_idNo = " & Val(Rec_ID) & ",  Sl_No  = " & Str(Val(Sno)) & " , Fibre_Idno = " & Str(Val(YCnt_ID)) & " ,Yarn_Type = '" & Trim(.Rows(i).Cells(2).Value) & "',  Lot_No = '" & Trim(.Rows(i).Cells(9).Value) & "', Bales =  " & Val(.Rows(i).Cells(4).Value) & ", Cones = " & Val(.Rows(i).Cells(5).Value) & " , Weight = " & Str(Val(.Rows(i).Cells(6).Value)) & " ,Bale_No = '" & Trim(.Rows(i).Cells(9).Value) & "', Rate = " & Str(Val(.Rows(i).Cells(7).Value)) & ", Amount = " & Str(Val(.Rows(i).Cells(8).Value)) & " ,Mill_Idno=" & Val(YMil_ID) & ",Purchase_Weight=" & Val(.Rows(i).Cells(12).Value) & " ,Purchase_Rate=" & Val(.Rows(i).Cells(13).Value) & " where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Fibre_Delivery_Code = '" & Trim(NewCode) & "'  and Fibre_Delivery_Detail_SlNo = " & Val(.Rows(i).Cells(10).Value)
                        ...
                        If Nr = 0 Then
                            ...
                            cmd.CommandText = "Insert into Fibre_Delivery_Details(Fibre_Delivery_Code,                    Company_IdNo,                 Fibre_Delivery_No,                        for_OrderBy,                                                         Fibre_Delivery_Date                    ,DeliveryTo_idNo ,            ReceiverFrom_idNo,           Sl_No,                            Yarn_Type,                                  Lot_No,                       Fibre_Idno,                               Bales,                                Cones,                                               Weight ,                            Rate,                                   Amount,                            Bale_No,                                      Fibre_Delivery_Detail_SlNo          ,Mill_Idno ,               Purchase_Weight,                      Purchase_Rate ) " &
                                                                            " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",                    @EntryDate,                       " & Val(Delv_ID) & " ,        " & Val(Rec_ID) & " ,      " & Str(Val(Sno)) & ",  '" & Trim(.Rows(i).Cells(2).Value) & "', '" & Trim(.Rows(i).Cells(9).Value) & "' , " & Str(Val(YCnt_ID)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " ," & Str(Val(.Rows(i).Cells(7).Value)) & "," & Str(Val(.Rows(i).Cells(8).Value)) & ", '" & Trim(.Rows(i).Cells(9).Value) & "'," & Str(Val(.Rows(i).Cells(10).Value)) & " ," & Val(YMil_ID) & "," & Val(.Rows(i).Cells(12).Value) & "  ," & Val(.Rows(i).Cells(13).Value) & ")"
                            cmd.ExecuteNonQuery()
                        End If
                        Stock_Weight = Val(.Rows(i).Cells(6).Value)

                        If Val(.Rows(i).Cells(12).Value) <> 0 Then
                            vPurchaseRate_SalsAmt = Format((Val(.Rows(i).Cells(12).Value) * Val(.Rows(i).Cells(13).Value)), "############0.00")
                        Else
                            vPurchaseRate_SalsAmt = 0
                        End If


                        If Val(Stock_Weight) <> 0 Then
                            YSno = YSno + 1
                            cmd.CommandText = "Insert into Stock_Fibre_Processing_Details ( Reference_Code,                                   Company_IdNo                     , Reference_No                 , for_OrderBy                                            , Reference_Date,            DeliveryTo_Idno                 , ReceivedFrom_Idno, Entry_ID             , Particulars            , Party_Bill_No        , Sl_No                 , Fibre_Idno               , Yarn_Type              ,                    Mill_Idno               ,           Lot_No                ,                 Bale,                                        Cones,                 Weight,                                Rate,                                            Amount ,                           DeliveryToIdno_ForParticulars,  ReceivedFromIdno_ForParticulars  ,        Purchase_Weight                  ,   Purchase_Rate_Sales_Amount             ,            Fibre_Taxable_Amount) " &
                                                                            "Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate    , " & Str(Val(Delv_ID)) & "     ,        4                , '" & Trim(EntID) & "', '" & Trim(Partcls) & "', '" & Trim(PBlNo) & "',       " & Str(Val(YSno)) & ", " & Str(Val(YCnt_ID)) & ", '" & Trim(.Rows(i).Cells(2).Value) & "',        " & Val(YMil_ID) & ",         '" & Trim(.Rows(i).Cells(9).Value) & "', " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(Stock_Weight)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & ",           0                    , " & Str(Val(Rec_ID)) & " ,  " & Val(.Rows(i).Cells(12).Value) & "   ,   " & Str(Val(vPurchaseRate_SalsAmt)) & " , " & Str(Val(.Rows(i).Cells(8).Value)) & ")  "
                            cmd.ExecuteNonQuery()
                        End If
                ...
                Next
                '    Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Fibre_Delivery_Details", "Fibre_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Yarn_Type, Mill_IdNo,Fibre_Idno, bales, Cones, Weight , Rate, Amount, Bag_No,  Fibre_Delivery_Detail_SlNo ", "Sl_No", "Fibre_Delivery_Code, For_OrderBy, Company_IdNo, Fibre_Delivery_No, Fibre_Delivery_Date, Ledger_Idno", tr)

            End With

            'If Val(vTotYrnbales) <> 0 Or Val(vTotYrnCones) <> 0 Then
            '    cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details ( Reference_Code, Company_IdNo, Reference_No, for_OrderBy, Reference_Date, DeliveryTo_Idno, ReceivedFrom_Idno, Entry_ID, Party_Bill_No, Particulars, Sl_No, Empty_Beam, Yarn_bales, Yarn_Cones ) Values ( '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "', 1, 0 , " & Str(Val(vTotYrnbales)) & ", " & Str(Val(vTotYrnCones)) & ")"
            '    cmd.ExecuteNonQuery()
            'End If
    ...
    Private Sub cbo_Vechile_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Vechile.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Delivery_Head", "Vechile_No", "", "")
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Vechile.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vechile, cbo_TransportName, txt_Freight, "Fibre_Delivery_Head", "Vechile_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Vechile.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vechile, txt_Freight, "Fibre_Delivery_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub dgv_FibreDetails_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_FibreDetails.CellEndEdit
        ...
        If dgv_FibreDetails.CurrentRow.Cells(2).Value = "MILL" Then
    ...
    Private Sub dgv_FibreDetails_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_FibreDetails.CellEnter
        ...
        With dgv_FibreDetails
            ...
            If e.ColumnIndex = 1 Then
                ...
                If cbo_Grid_FibreName.Visible = False Or Val(cbo_Grid_FibreName.Tag) <> e.RowIndex Then

                    cbo_Grid_FibreName.Tag = -1
                    Da = New SqlClient.SqlDataAdapter("select Fibre_Name from Fibre_Head order by Fibre_Name", con)
                    Dt1 = New DataTable
                    Da.Fill(Dt1)
                    cbo_Grid_FibreName.DataSource = Dt1
                    cbo_Grid_FibreName.DisplayMember = "Fibre_Name"

                    rect = .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False)

                    cbo_Grid_FibreName.Left = .Left + rect.Left  '  .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Left
                    cbo_Grid_FibreName.Top = .Top + rect.Top  ' .GetCellDisplayRectangle(e.ColumnIndex, e.RowIndex, False).Top

                    cbo_Grid_FibreName.Width = rect.Width  ' .CurrentCell.Size.Width
                    cbo_Grid_FibreName.Height = rect.Height  ' rect.Height
                    cbo_Grid_FibreName.Text = .CurrentCell.Value  '  Trim(.CurrentRow.Cells(e.ColumnIndex).Value)

                    cbo_Grid_FibreName.Tag = Val(e.RowIndex)
                    cbo_Grid_FibreName.Visible = True

                    cbo_Grid_FibreName.BringToFront()
                    cbo_Grid_FibreName.Focus()
            ...
            If (.CurrentCell.ColumnIndex = 12 And vdgvLevCol_FibreDetails = 9) Or (.CurrentCell.ColumnIndex = 13 And Val(dgv_FibreDetails.Rows(e.RowIndex).Cells(13).Value) = 0) Then


                If Trim(UCase(vdgv_FibreDet_PrevLotNo)) <> Trim(UCase(dgv_FibreDetails.Rows(e.RowIndex).Cells(9).Value)) Or Val(dgv_FibreDetails.Rows(e.RowIndex).Cells(13).Value) = 0 Then

                    Dim YCnt_ID As Integer = 0
                    Dim YMil_ID As Integer = 0

                    YCnt_ID = Common_Procedures.Fibre_NameToIdNo(con, dgv_FibreDetails.Rows(e.RowIndex).Cells(1).Value)
                    YMil_ID = Common_Procedures.Mill_NameToIdNo(con, dgv_FibreDetails.Rows(e.RowIndex).Cells(3).Value)

                    Da = New SqlClient.SqlDataAdapter("select top 1 a.RATE from  Fibre_Purchase_details a  where Lot_No = '" & Trim(dgv_FibreDetails.Rows(e.RowIndex).Cells(9).Value) & "'       And  Fibre_Idno = " & Str(Val(YCnt_ID)) & " And   mill_idno =  " & Str(Val(YMil_ID)) & "      order by  fibre_purchase_Date  desc, for_Orderby  desc, fibre_purchase_No  desc, fibre_purchase_code desc, a.sl_No asc", con)
                    dt4 = New DataTable
                    Da.Fill(dt4)

                    If dt4.Rows.Count > 0 Then

                        .CurrentRow.Cells(13).Value = dt4.Rows(0).Item("Rate").ToString
            ...
            vdgv_FibreDet_PrevLotNo = dgv_FibreDetails.Rows(e.RowIndex).Cells(9).Value
    ...
    Private Sub dgv_FibreDetails_CellLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_FibreDetails.CellLeave
        ...
        vdgvLevCol_FibreDetails = e.ColumnIndex
    ...
    Private Sub dgv_FibreDetails_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_FibreDetails.CellValueChanged
        On Error Resume Next
        If Not IsNothing(dgv_FibreDetails_Total.CurrentCell) Then
            With dgv_FibreDetails


                If .Visible Then

                    If e.ColumnIndex = 1 Or e.ColumnIndex = 4 Or e.ColumnIndex = 5 Or e.ColumnIndex = 6 Or e.ColumnIndex = 8 Or e.ColumnIndex = 12 Then
                        TotalYarnTaken_Calculation()
                    End If
    ...
    Private Sub dgv_FibreDetails_EditingControlShowing(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles dgv_FibreDetails.EditingControlShowing
        dgtxt_Details = CType(dgv_FibreDetails.EditingControl, DataGridViewTextBoxEditingControl)
    End Sub

    Private Sub dgv_FibreDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgv_FibreDetails.KeyDown
    ...
    Private Sub dgv_FibreDetails_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgv_FibreDetails.KeyUp
        ...
        If e.Control = True And UCase(Chr(e.KeyCode)) = "D" Then
            ...
            With dgv_FibreDetails
                ...
                If Val(dgv_FibreDetails.Rows(dgv_FibreDetails.CurrentRow.Index).Cells(11).Value) <> 0 Then
                    Exit Sub
                End If
    ...
    '    CntID = Common_Procedures.Fibre_NameToIdNo(con, dgv_FibreDetails.Rows(dgv_FibreDetails.CurrentRow.Index).Cells(1).Value)
    '    MilID = Common_Procedures.Mill_NameToIdNo(con, dgv_FibreDetails.Rows(dgv_FibreDetails.CurrentRow.Index).Cells(3).Value)
    ...
    Private Sub TotalYarnTaken_Calculation()
        Dim Sno As Integer
        Dim Totbales As String, TotCones As String, TotWeight As String, TotThiri As Single, TotAmount As String, TotPurWgt As String, TotPurRate As String
        ...
        With dgv_FibreDetails
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(6).Value) <> 0 Then
                    Totbales = Totbales + Val(.Rows(i).Cells(4).Value)
                    ...
                    TotPurWgt = TotPurWgt + Val(.Rows(i).Cells(12).Value)
                    ' TotPurRate = TotPurRate + Val(.Rows(i).Cells(13).Value)
        ...
        With dgv_FibreDetails_Total
            If .RowCount = 0 Then .Rows.Add()
            .Rows(0).Cells(4).Value = Val(Totbales)
            .Rows(0).Cells(5).Value = Val(TotCones)
            .Rows(0).Cells(6).Value = Format(Val(TotWeight), "########0.000")
            .Rows(0).Cells(8).Value = Format(Val(TotAmount), "########0.00")

            If Val(Common_Procedures.settings.Weaver_YarnStock_InThiri_Status = 1) Then
                .Rows(0).Cells(9).Value = Format(Val(TotThiri), "########0.000")
            End If

            .Rows(0).Cells(12).Value = Format(Val(TotPurWgt), "########0.000")
            '  .Rows(0).Cells(13).Value = Format(Val(TotPurRate), "########0.000")
    ...
    Private Sub cbo_Grid_YarnType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_YarnType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_YarnType, cbo_Grid_FibreName, cbo_Grid_MillName, "YarnType_Head", "Yarn_Type", "", "Yarn_Type")
    ...
    Private Sub cbo_Grid_MillName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_MillName.TextChanged
        ...
        End Try
    End Sub
    Private Sub cbo_Grid_CountName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_FibreName.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Head", "Fibre_Name", "", "(Fibre_Idno = 0)")

    End Sub
    Private Sub cbo_Grid_CountName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_FibreName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_FibreName, Nothing, cbo_Grid_YarnType, "Fibre_Head", "Fibre_Name", "", "(Fibre_Idno = 0)")
        With dgv_FibreDetails
            With dgv_FibreDetails

                If (e.KeyValue = 38 And cbo_Grid_FibreName.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                    If .CurrentCell.RowIndex = 0 Then
                        txt_Bill_no.Focus()
                    Else
                        .Focus()
                        .CurrentCell = .Rows(.CurrentRow.Index - 1).Cells(13)
                    End If
                End If
                If (e.KeyValue = 40 And cbo_Grid_FibreName.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
                    .Focus()
                    '.CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex + 1)
                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(.CurrentCell.ColumnIndex + 2)
                End If
    ...
    Private Sub cbo_Grid_CountName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Grid_FibreName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_FibreName, Nothing, "Fibre_Head", "Fibre_Name", "", "(Fibre_Idno = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_Grid_CountName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_FibreName.KeyUp
        If e.Control = False And e.KeyValue = 17 Then
            Dim f As New Fibre_Creation

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_Grid_FibreName.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_Grid_CountName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_FibreName.TextChanged
        Try
            If cbo_Grid_FibreName.Visible Then

                If IsNothing(dgv_FibreDetails.CurrentCell) Then Exit Sub
                With dgv_FibreDetails
                    If Val(cbo_Grid_FibreName.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 1 Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(1).Value = Trim(cbo_Grid_FibreName.Text)
                    End If
                End With
            End If
        ...
        With dgv_FibreDetails
            If .Visible Then
                ...
                If .CurrentCell.ColumnIndex = 2 Or .CurrentCell.ColumnIndex = 3 Then
                    ...
                    If Val(dgv_FibreDetails.Rows(dgv_FibreDetails.CurrentCell.RowIndex).Cells(11).Value) <> 0 Then
                        e.Handled = True
                    End If
                End If
            End If
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Fibre_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(cbo_Filter_CountName.Text) <> "" Then
                Cnt_IdNo = Common_Procedures.Fibre_NameToIdNo(con, cbo_Filter_CountName.Text)
            End If
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Fibre_Delivery_Code IN ( select z1.Fibre_Delivery_Code from Fibre_Delivery_Details z1 where z1.Fibre_Idno = " & Str(Val(Cnt_IdNo)) & " )"
                'Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.Fibre_Idno = " & Str(Val(Cnt_IdNo)) & ""
            End If

            If Val(Mil_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Fibre_Delivery_Code IN ( select z2.Fibre_Delivery_Code from Fibre_Delivery_Details z2 where z2.Mill_IdNo = " & Str(Val(Mil_IdNo)) & " )"
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, e.Ledger_Name from Fibre_Delivery_Head a inner join Ledger_head e on a.DeliveryTo_IdNo = e.Ledger_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Fibre_Delivery_Date, a.for_orderby, a.Fibre_Delivery_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, e.Ledger_Name from Fibre_Delivery_Head a left outer join Fibre_Delivery_Details b on a.Fibre_Delivery_Code = b.Fibre_Delivery_Code left outer join Ledger_head e on a.Ledger_idno = e.Ledger_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Fibre_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Fibre_Delivery_Date, a.for_orderby, a.Fibre_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Fibre_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Fibre_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, dtp_Filter_ToDate, cbo_Filter_CountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, cbo_Filter_CountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_CountName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_CountName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_CountName, cbo_Filter_PartyName, cbo_Filter_MillName, "Fibre_Head", "Fibre_Name", "", "(Fibre_Idno = 0)")
    ...
    Private Sub cbo_Filter_CountName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_CountName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_CountName, btn_Filter_Show, "Fibre_Head", "Fibre_Name", "", "(Fibre_Idno = 0)")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Fibre_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1176" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1256" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1286" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1369" Then
            Printing_Format2(e)
        Else
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString) ' & "  " & Trim(prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Description").ToString)
                        ItmNm2 = ""
                        ...
                        BagNo1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Bale_No").ToString)
                        BagNo2 = ""
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*   from Fibre_Delivery_Details a  LEFT OUTER JOIN Fibre_Head d ON a.Fibre_Idno = d.Fibre_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Delivery_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Delivery_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        If is_LastPage = True Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Total_Bales").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) - 10, CurY, 1, 0, pFont)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1369" Then '---- ANCHANEYA TEXTILE INDUSTRIES(KARUMATHAMPATTI)
                            ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString) & "  Yarn"
                        Else
                            ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString) '& " - " & Trim(prn_DetDt.Rows(prn_DetIndx).Item("Lot_NO").ToString)
                        End If
                        ItmNm2 = ""
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, d.Fibre_Name  from Fibre_Delivery_Details a LEFT OUTER JOIN Fibre_Head d ON a.Fibre_Idno = d.Fibre_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        CurY = CurY + TxtHgt + 5
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1369" Then
        ...
        End If
        If prn_DetDt.Rows.Count > 0 Then
            If Trim(prn_DetDt.Rows(0).Item("Item_HSN_Code").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "HSN CODE", LMargin + C1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(0).Item("Item_HSN_Code").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            End If
        End If
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        If is_LastPage = True Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Total_Bales").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) - 10, CurY, 1, 0, pFont)
            'Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Total_Bales").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1369" Then
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, " ( GOODS RETURN AFTER JOBWORK ) ", PrintWidth - 15, CurY, 1, 0, p1Font)
        End If
    ...
    Private Sub dgtxt_Details_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgtxt_Details.TextChanged
        Try
            If Trim(dgtxt_Details.Text) <> "" Then
                dgv_FibreDetails.Rows(dgv_FibreDetails.CurrentCell.RowIndex).Cells(dgv_FibreDetails.CurrentCell.ColumnIndex).Value = dgtxt_Details.Text
            End If
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        ItmNm1 = Trim(prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString)
                        ItmNm2 = ""
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Lot_No").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format_New_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        p1Font = New Font("Calibri", 16, FontStyle.Bold)
        'If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1176" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1256" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1286" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1286" Then
        Common_Procedures.Print_To_PrintDocument(e, "FIBRE DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        'Else
        '    Common_Procedures.Print_To_PrintDocument(e, "YARN DELIVERY TO JOB WORK", LMargin, CurY, 2, PrintWidth, p1Font)
        'End If
        ...
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        Common_Procedures.Print_To_PrintDocument(e, "DC No. : " & prn_HdDt.Rows(0).Item("Fibre_Delivery_No").ToString, LMargin + 10, CurY, 0, 0, p1Font)
        Common_Procedures.Print_To_PrintDocument(e, "DATE : " & Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Delivery_Date").ToString), "dd-MM-yyyy"), LMargin + ClAr(1) + 90, CurY, 0, 0, p1Font)
    ...
    Private Sub cbo_Grid_lotNo_GotFocus(sender As Object, e As EventArgs) Handles cbo_Grid_lotNo.GotFocus
        'Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Purchase_Details", "Lot_No", "", "(Fibre_Purchase_No = '')")

        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = 0)")
    End Sub

    Private Sub cbo_Grid_lotNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Grid_lotNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_lotNo, Nothing, Nothing, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = 0)")
    ...
    Private Sub cbo_Grid_lotNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Grid_lotNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_lotNo, Nothing, "Fibre_Lot_Head", "LotNo_Name", "(CLOSE_STATUS=0)", "(Lot_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_Grid_lotNo_TextChanged(sender As Object, e As EventArgs) Handles cbo_Grid_lotNo.TextChanged
        Try
            If cbo_Grid_lotNo.Visible Then
                ...
                If IsNothing(dgv_FibreDetails.CurrentCell) Then Exit Sub
                With dgv_FibreDetails
                    If Val(cbo_Grid_lotNo.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 9 Then
