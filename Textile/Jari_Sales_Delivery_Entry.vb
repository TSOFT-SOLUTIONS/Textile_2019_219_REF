Public Class Jari_Sales_Delivery_Entry
    ...
    Private Pk_Condition As String = "JASDL-"
    Private Pk_Condition1 As String = "JDCFR-"

    Private Pk_Condition_GST As String = "GJASD-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Jari_Sales_Delivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo   Where a.Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Delete from Jari_Sales_Delivery_Jari_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Jari_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Jari_Sales_Delivery_No from Jari_Sales_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Jari_Sales_Delivery_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%' Order by for_Orderby desc, Jari_Sales_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Jari_Sales_Delivery_Head", "Jari_Sales_Delivery_Code", "For_OrderBy", "Jari_Sales_Delivery_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Jari_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Jari_Sales_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Jari_Sales_Delivery_No from Jari_Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code = '" & Trim(RecCode) & "' AND Jari_Sales_Delivery_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Jari_Sales_Delivery_Head", "Jari_Sales_Delivery_Code", "For_OrderBy", "Jari_Sales_Delivery_Code NOT LIKE '" & Trim(Pk_Condition_GST) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VechileNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VechileNo, cbo_Transport, txt_Freight, "Jari_Sales_Delivery_Head", "Vechile_No", "", "")
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Jari_Sales_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "' AND Jari_Sales_Delivery_Code NOT LIKE '" & Trim(Pk_Condition) & "%'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Jari_Sales_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Colour_Name, d.BorderSize_Name from Jari_Sales_Delivery_Jari_Details a INNER JOIN Count_Head b ON a.Count_idno = b.Count_idno LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Jari_Sales_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
