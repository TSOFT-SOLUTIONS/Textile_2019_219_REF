...
Public Class Yarn_Purchase_GST
    ...
    Private Pk_Condition As String = "GYPUR-"
    ...
    Private Sub clear()
        ...
        txt_transport_BillNo.Text = ""
        txt_Transport_BillDate.Text = ""
        ...
        If dgv_Details.Rows.Count > 0 Then
            dgv_Details.Rows(0).Cells(6).Value = "KG"
        End If
        ...
        cbo_Grid_RateFor.Enabled = True
        cbo_Grid_RateFor.BackColor = Color.White

        dgv_Details.ReadOnly = False
        dgv_Details.DefaultCellStyle.BackColor = Color.White
        ...
        dgv_Details.Columns(18).ReadOnly = True
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Yarn_Purchase_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_transport_BillNo.Text = dt1.Rows(0).Item("Transport_Bill_No").ToString
                txt_Transport_BillDate.Text = dt1.Rows(0).Item("Transport_Bill_Date").ToString
                ...
                If IsDBNull(dt1.Rows(0).Item("Purchase_Bill_Image")) = False Then
                    Dim imageData4 As Byte() = DirectCast(dt1.Rows(0).Item("Purchase_Bill_Image"), Byte())
                ...
                dtp_Test1Date.Text = dt1.Rows(0).Item("Test1_Date")
                dtp_Test2Date.Text = dt1.Rows(0).Item("Test2_Date")
                dtp_test3date.Text = dt1.Rows(0).Item("Test3_Date")
                ...
                If IsDBNull(dt1.Rows(0).Item("Yarn_Purchase_BillMaking_Code").ToString) = False Then
                    If Trim(dt1.Rows(0).Item("Yarn_Purchase_BillMaking_Code").ToString) <> "" Then
                        If Trim(dt1.Rows(0).Item("Yarn_Purchase_BillMaking_Code").ToString) <> "1-9999/CLOSE" Then
                            LockSTS = True
                        End If
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(24).Value = Trim(dt2.Rows(i).Item("LotCode_ForSelection").ToString)
                            .Rows(n).Cells(24).Value = Common_Procedures.YarnLotEntryReferenceCode_to_LotCodeSelection(con, dt2.Rows(i).Item("Lot_Entry_ReferenceCode").ToString)
                ...
                End With
                da4 = New SqlClient.SqlDataAdapter("Select a.* from Yarn_Purchase_GST_Tax_Details a Where a.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
            ...
            If LockSTS = True Then
                ...
                cbo_Grid_RateFor.Enabled = False
                cbo_Grid_RateFor.BackColor = Color.LightGray

                dgv_Details.ReadOnly = True
                dgv_Details.DefaultCellStyle.BackColor = Color.LightGray
    ...
    Private Sub Yarn_Purchase_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Common_Procedures.settings.Show_Yarn_LotNo_Status = 1 Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1082" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1464" Then  '---- BRT Textiles (Somanur)
        ...
        If Common_Procedures.settings.Show_Sales_OrderNumber_in_ALLEntry_Status = 1 Then
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
                ...
                cbo_Delvat.Width = cbo_PurchaseAc.Width

                lbl_ClothSales_OrderCode_forSelection_Caption.Location = lbl_jobcardno_Caption.Location
                lbl_ClothSales_OrderCode_forSelection_Caption.Left = lbl_deliveryterms_Caption.Left

                cbo_ClothSales_OrderCode_forSelection.Location = cbo_Sizing_JobCardNo.Location
                cbo_ClothSales_OrderCode_forSelection.Left = txt_delivery_terms.Left
                cbo_ClothSales_OrderCode_forSelection.Width = txt_delivery_terms.Width

                cbo_ClothSales_OrderCode_forSelection.TabIndex = 8
            ...
            Else
                ...
                cbo_ClothSales_OrderCode_forSelection.Left = txt_delivery_terms.Left
                cbo_ClothSales_OrderCode_forSelection.Top = txt_delivery_terms.Top
                cbo_ClothSales_OrderCode_forSelection.Width = txt_delivery_terms.Width
                cbo_ClothSales_OrderCode_forSelection.Height = txt_delivery_terms.Height

                cbo_ClothSales_OrderCode_forSelection.TabIndex = 4
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1464" Then
            ...
            dgv_Details_Total.Columns(24).Visible = True
        End If


        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1152" Then
            lbl_trans_Bill_No.Visible = True
            txt_transport_BillNo.Visible = True
            lbl_trans_bill_date.Visible = True
            txt_Transport_BillDate.Visible = True
        Else
            lbl_trans_Bill_No.Visible = False
            txt_transport_BillNo.Visible = False
            lbl_trans_bill_date.Visible = False
            txt_Transport_BillDate.Visible = False
        End If
        ...
        If Common_Procedures.settings.Show_Sizing_JobCard_Entry_Status = 1 Then
            ...
            cbo_Delvat.Width = cbo_PurchaseAc.Width
            lbl_jobcardno_Caption.Left = lbl_deliveryterms_Caption.Left
            cbo_Sizing_JobCardNo.Left = txt_delivery_terms.Left
            cbo_Sizing_JobCardNo.Width = txt_delivery_terms.Width
        ...
        If Common_Procedures.settings.Show_Weaver_JobCard_Entry_STATUS = 1 Then
            ...
            cbo_Agent.Width = lbl_RefNo.Width
        ...
        Else
            ...
            lbl_agent.Left = lbl_Delv_At.Left
            cbo_Agent.Left = cbo_Delvat.Left
            cbo_Agent.Width = cbo_VehicleNo.Width
        ...
        AddHandler txt_transport_BillNo.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Transport_BillDate.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_transport_BillNo.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Transport_BillDate.LostFocus, AddressOf ControlLostFocus
        ...
        'AddHandler cbo_weaving_job_no.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        'AddHandler cbo_weaving_job_no.KeyPress, AddressOf TextBoxControlKeyPress
        ...
        AddHandler txt_RefNo_Open.GotFocus, AddressOf ControlGotFocus

        AddHandler txt_BillNoOpen.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_RefNo_Open.LostFocus, AddressOf ControlLostFocus
                ...
                If keyData = Keys.Enter Or keyData = Keys.Down Then
                    ...
                    If dgv_Details.Columns(9).Visible = True Then
                        ...
                        ElseIf .CurrentCell.ColumnIndex = 5 Then
                            If Trim(UCase(cbo_EntryType.Text)) = "ORDER" Or .Columns(6).ReadOnly = True Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            ElseIf .CurrentCell.ColumnIndex = 8 Then
                                If .Columns(24).Visible Then

                                    .CurrentCell = .Rows(.CurrentRow.Index).Cells(24)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.settings.Vefified_Status = 1 Then
            ...
            If Val(Common_Procedures.get_FieldValue(con, "Yarn_Purchase_Head", "Verified_Status", "(Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')")) = 1 Then
        ...
        vLOTCODE_SELC = ""
        Da = New SqlClient.SqlDataAdapter("select lot_no from Yarn_Purchase_Head where Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' ", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)

        If Dt1.Rows.Count > 0 Then
            vLOTCODE_SELC = Dt1.Rows(0)(0) & "/" & Trim(Common_Procedures.FnYearCode) & "/" & Trim(Val(lbl_Company.Tag))
        End If
        Dt1.Clear()

        If Trim(vLOTCODE_SELC) <> "" Then
            Da = New SqlClient.SqlDataAdapter("select COUNT(*) as nooftimes from Stock_Yarn_Processing_Details Where LotCode_forSelection = '" & Trim(vLOTCODE_SELC) & "' and  Reference_Code <> '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            'Da = New SqlClient.SqlDataAdapter("select COUNT(*) as nooftimes from Stock_Yarn_Processing_Details Where Lot_Entry_ReferenceCode = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and  Reference_Code <> '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
                If IsDBNull(Dt1.Rows(0).Item("nooftimes").ToString) = False Then
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1061" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1558" Then
            ...
            Da = New SqlClient.SqlDataAdapter("select A. *, B.ledger_name  FROM YARN_PURCHASE_HEAD A  LEFT OUTER JOIN LEDGER_HEAD B  ON A.LEDGER_IDNO=B.LEDGER_IDNO WHERE  A.YARN_PURCHASE_BILLMAKING_Code <>'' AND  A.YARN_PURCHASE_CODE= '" & Trim(Pk_Condition) & Trim(NewCode) & "'   AND b.LEDGER_name ='" & Trim(cbo_PartyName.Text) & "'  ", con)
            Dt2 = New DataTable
            Da.Fill(Dt2)

            If Dt2.Rows.Count > 0 Then

                If IsDBNull(Dt2.Rows(0).Item("YARN_PURCHASE_BILLMAKING_Code").ToString) = False Then
                    If Trim(Dt2.Rows(0).Item("YARN_PURCHASE_BILLMAKING_Code").ToString) <> "" Then
                        If Trim(Dt2.Rows(0).Item("Yarn_Purchase_BillMaking_Code").ToString) <> "1-9999/CLOSE" Then
                            MessageBox.Show("Already this Bill Processed", "DOES NOT DELETE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                            Exit Sub
                        End If
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Yarn_Purchase_Head", "Yarn_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Yarn_Purchase_Code, Company_IdNo, for_OrderBy", trans)
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Yarn_Purchase_Details", "Yarn_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Yarn_Purchase_Receipt_No ,  Yarn_Purchase_Receipt_Code,  Yarn_Purchase_Receipt_Details_SlNo,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage", "Sl_No", "Yarn_Purchase_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_No, Yarn_Purchase_Date, Ledger_Idno", trans)
            ...
            cmd.CommandText = "Update SizSoft_Yarn_Receipt_Details set Yarn_Purchase_Code = '' Where Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Update Yarn_Purchase_Receipt_Details set Purchase_Bags = a.Purchase_Bags - b.Bags,Purchase_Cones = a.Purchase_Cones - b.Cones,Purchase_Weight = a.Purchase_Weight - b.Weight from Yarn_Purchase_Receipt_Details a, Yarn_Purchase_Details b, Yarn_Purchase_Head c Where b.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Purchase_Type = 'RECEIPT' and b.Yarn_Purchase_Code = c.Yarn_Purchase_Code and a.Yarn_Purchase_Receipt_Code = b.Yarn_Purchase_Receipt_Code and a.Yarn_Purchase_Receipt_Details_SlNo = b.Yarn_Purchase_Receipt_Details_SlNo"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Update Yarn_Purchase_Order_Details set Purchase_Bags = a.Purchase_Bags - b.Bags,Purchase_Cones = a.Purchase_Cones - b.Cones,Purchase_Weight = a.Purchase_Weight - b.Weight from Yarn_Purchase_order_Details a, Yarn_Purchase_Details b, Yarn_Purchase_Head c Where b.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and c.Purchase_Type = 'ORDER' and b.Yarn_Purchase_Code = c.Yarn_Purchase_Code and a.Yarn_Purchase_order_Code = b.Yarn_Purchase_Order_Code and a.Yarn_Purchase_Order_Details_SlNo = b.Yarn_Purchase_Order_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "delete from Yarn_Purchase_GST_Tax_Details  where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Yarn_Purchase_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code like  '%/" & Trim(Common_Procedures.FnYearCode) & "' and Yarn_Purchase_Code like  '" & Trim(Pk_Condition) & "%' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Yarn_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_No from Yarn_Purchase_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Yarn_Purchase_Code like  '" & Trim(Pk_Condition) & "%' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Yarn_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Yarn_Purchase_No from Yarn_Purchase_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'and  Yarn_Purchase_Code like  '" & Trim(Pk_Condition) & "%'  and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Yarn_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        ''''    Da = New SqlClient.SqlDataAdapter("select Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(RefCode) & "'", con)
        ''''    Da.Fill(Dt)
        ...
        '    inpno = InputBox("Enter Purchase Invoice No.", "FOR FINDING...")

        '    'RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

        '    Da = New SqlClient.SqlDataAdapter("select Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and upper(Bill_No) = '" & UCase(inpno) & "'", con)
        '    Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vFIRST_Mill_IDNO As Integer = 0
        Dim vFIRST_COUNT_IDNO As Integer = 0
        Dim vLOT_ENT_REFCODE = ""
        ...
        If Trim(lbl_OrderCode.Text) <> "" Then
            ...
            End If
        End If
        If cbo_EntryType.Visible = True Then
            If Trim(cbo_EntryType.Text) = "" Then
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1061" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1558" Then
            ...
            If Val(Led_ID) <> 0 Then
                Da = New SqlClient.SqlDataAdapter("select A. * FROM YARN_PURCHASE_HEAD A   WHERE  A.YARN_PURCHASE_BILLMAKING_Code <>'' AND  A.YARN_PURCHASE_CODE= '" & Trim(NewCode) & "'   AND  A.LEDGER_IDNO =" & Str(Val(Led_ID)) & "  ", con)
                Dt2 = New DataTable
                Da.Fill(Dt2)
                ...
                If Dt2.Rows.Count > 0 Then
                    ...
                    If IsDBNull(Dt2.Rows(0).Item("YARN_PURCHASE_BILLMAKING_Code").ToString) = False Then
                        If Trim(Dt2.Rows(0).Item("YARN_PURCHASE_BILLMAKING_Code").ToString) <> "" Then
                            If Trim(Dt2.Rows(0).Item("Yarn_Purchase_BillMaking_Code").ToString) <> "1-9999/CLOSE" Then
                                MessageBox.Show("Already this Bill Processed", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1007" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1050" Then
            Dim Delv_Ledtype As String

            Delv_Ledtype = Common_Procedures.get_FieldValue(con, "Ledger_Head", "Ledger_Type", "(Ledger_IdNo = " & Str(Val(Del_ID)) & ")")
            If Trim(UCase(Delv_Ledtype)) <> "GODOWN" Then
                If Trim(txt_RecNo.Text) = "" Then
                    MessageBox.Show("Invalid RecNo!....", "DOES NOT SAVE", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                    If txt_RecNo.Enabled And txt_RecNo.Visible Then txt_RecNo.Focus()
                    Exit Sub
                End If
            End If
        ...
        If Trim(txt_BillNo.Text) <> "" Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
            Da = New SqlClient.SqlDataAdapter("select * from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_IdNo = " & Str(Val(Led_ID)) & " and Bill_No = '" & Trim(txt_BillNo.Text) & "' and Yarn_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and Yarn_Purchase_Code <> '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            If Dt1.Rows.Count > 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Yarn_Purchase_Head", "Yarn_Purchase_Code", "For_OrderBy", "Yarn_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            Else
                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then
                    Throw New ApplicationException("Invalid Purchase Bill image attachment")
                End If
            End If
            ...
            Else
                ...
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Yarn_Purchase_Head", "Yarn_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Yarn_Purchase_Code, Company_IdNo, for_OrderBy", tr)
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Yarn_Purchase_Details", "Yarn_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Yarn_Purchase_Receipt_No ,  Yarn_Purchase_Receipt_Code,  Yarn_Purchase_Receipt_Details_SlNo,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage", "Sl_No", "Yarn_Purchase_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_No, Yarn_Purchase_Date, Ledger_Idno", tr)

                If Val(Common_Procedures.settings.Negative_Stock_Restriction_for_Yarn_Stock) = 1 Then

                    Dim vENTDB_TotWgt As String = 0

                    vENTDB_DelvToIDno = Val(Common_Procedures.get_FieldValue(con, "Yarn_Purchase_Head", "DeliveryTo_Idno", "(Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')", , tr))
                    vENTDB_TotWgt = Val(Common_Procedures.get_FieldValue(con, "Yarn_Purchase_Head", "Total_Weight", "(Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')", , tr))

                    If Val(vENTDB_DelvToIDno) <> Val(Del_ID) Or Val(vTotWght) < Val(vENTDB_TotWgt) Then
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        If vFIRST_Mill_IDNO = 0 Then vFIRST_Mill_IDNO = Mill_ID
                        If vFIRST_COUNT_IDNO = 0 Then vFIRST_COUNT_IDNO = Cnt_ID
                        ...
                        vLOT_ENT_REFCODE = ""
                        If Trim(.Rows(i).Cells(24).Value) <> "" Then
                            vLOT_ENT_REFCODE = Common_Procedures.YarnLotCodeSelection_To_LotEntryReferenceCode(con, .Rows(i).Cells(24).Value, tr)
                        End If

                        cmd.CommandText = "Insert into Yarn_Purchase_Details ( Yarn_Purchase_Code                        ,               Company_IdNo       ,   Yarn_Purchase_No            ,            for_OrderBy    , Yarn_Purchase_Date,             Sl_No     ,    Count_IdNo           ,          Mill_IdNo       ,                     Bags                 ,                 Cones                    ,                        Weight            ,                   Rate_For             ,                     Rate                 ,                  Amount                   , Colour_Idno            ,   Yarn_Purchase_Receipt_No ,  Yarn_Purchase_Receipt_Code,  Yarn_Purchase_Receipt_Details_SlNo ,         Cash_Discount_Percentage          ,              Cash_Discount_Amount         ,                      Taxable_Value        ,                  GST_Percentage           ,                    HSN_Code             , Yarn_Purchase_Order_No  , Yarn_Purchase_Order_Code   , Yarn_Purchase_Order_Details_Slno,  SizSoft_Yarn_Receipt_No , SizSoft_Yarn_Receipt_Code, SizSoft_Yarn_Receipt_Details_Slno ,               LotCode_ForSelection          ,       Lot_Entry_ReferenceCode  ) " &
                                            "     Values                 (   '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(vOrdByNo)) & ",   @PurchaseDate   ,  " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ", " & Str(Val(Mill_ID)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", '" & Trim(.Rows(i).Cells(6).Value) & "', " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & " , " & Str(Val(clr_ID)) & ",  '" & Trim(RecNo) & "'    , '" & Trim(RecCd) & "'      , " & Val(RecSlNo) & "                , " & Str(Val(.Rows(i).Cells(13).Value)) & ", " & Str(Val(.Rows(i).Cells(14).Value)) & ", " & Str(Val(.Rows(i).Cells(15).Value)) & ", " & Str(Val(.Rows(i).Cells(16).Value)) & ", '" & Trim(.Rows(i).Cells(17).Value) & "', '" & Trim(OrderNo) & "' ,    '" & Trim(OrderCd) & "' ,  " & Val(OrderSlNo) & "         , '" & Trim(SizRcptNo) & "', '" & Trim(SizRcptCd) & "',  " & Val(SizRcptSlNo) & "         ,   '" & Trim(.Rows(i).Cells(24).Value) & "'  , '" & Trim(vLOT_ENT_REFCODE) & "'  ) "
                        cmd.ExecuteNonQuery()
                        ...
                        ElseIf Trim(UCase(cbo_EntryType.Text)) = Trim(UCase("SIZING-YARNRECEIPT")) Then
                            If Trim(SizRcptCd) <> "" Then
                                Nr = 0
                                cmd.CommandText = "Update SizSoft_Yarn_Receipt_Details set Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Where Yarn_Receipt_Code = '" & Trim(SizRcptCd) & "' and Yarn_Receipt_DetailsSlno = " & Str(Val(SizRcptSlNo))
                                Nr = cmd.ExecuteNonQuery()
                                If Nr <> 1 Then
                        ...
                        If Trim(UCase(cbo_EntryType.Text)) <> "RECEIPT" Then
                            cmd.CommandText = "Insert into Stock_Yarn_Processing_Details(           Reference_Code                  ,           Company_IdNo         ,              Reference_No     ,          for_OrderBy       ,  Reference_Date ,        DeliveryTo_Idno   ,    ReceivedFrom_Idno   ,    Entry_ID         ,         Particulars    ,    Party_Bill_No      ,            Sl_No      ,        Count_IdNo      , Yarn_Type ,        Mill_IdNo          ,                           Bags            ,                           Cones       ,                               Weight       ,           Colour_IdNo    , DeliveryToIdno_ForParticulars , ReceivedFromIdno_ForParticulars  , Weaving_JobCode_forSelection ,         Sizing_JobCode_forSelection       ,     Lot_Entry_ReferenceCode      ,              ClothSales_OrderCode_forSelection             ) " &
                                "Values                                              ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(vOrdByNo)) & ", @PurchaseDate    , " & Str(Val(Del_ID)) & "  ,           0           , '" & Trim(EntID) & "', '" & Trim(Partcls) & "', '" & Trim(PBlNo) & "', " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ",   'MILL'  , " & Str(Val(Mill_ID)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & " , " & Str(Val(clr_ID)) & " ,                    0          ,        " & Str(Val(Led_ID)) & " ,'" & Trim(Weaver_Job_Code) & "','" & Trim(cbo_Sizing_JobCardNo.Text) & "'  , '" & Trim(vLOT_ENT_REFCODE) & "' , '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "' )"
                            cmd.ExecuteNonQuery()
                        End If
            ...
            If Trim(txt_LotNo.Text) <> "" And Val(vTotWght) <> 0 Then
                ...
                cmd.CommandText = "Insert into Yarn_Lot_Head (          Entry_ReferenceCode                ,               Company_IdNo       ,           Reference_No        ,            for_OrderBy    , Reference_Date,        LotCode_ForSelection  ,                  Lot_No        ,      forOrderBy_LotNo   ,            Weight     ,            Rate       ,             Count_IdNo         ,            Mill_IdNo           ) " &
                                        "     Values         ( '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(vOrdByNo)) & ",  @PurchaseDate, '" & Trim(vLOTCODE_SELC) & "',  '" & Trim(txt_LotNo.Text) & "', " & Val(vLotOrdByNo) & ",  " & Val(vTotWght) & ",  " & Val(vLOTRATE) & ",  " & Val(vFIRST_COUNT_IDNO) & ",  " & Val(vFIRST_Mill_IDNO) & " ) "
                cmd.ExecuteNonQuery()
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Yarn_Purchase_Details", "Yarn_Purchase_Code", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Count_IdNo,Mill_IdNo,Bags,Cones,Weight,Rate_For,Rate,Amount, Colour_Idno,Yarn_Purchase_Receipt_No ,  Yarn_Purchase_Receipt_Code,  Yarn_Purchase_Receipt_Details_SlNo,Cash_Discount_Percentage,Cash_Discount_Amount,Taxable_Value,GST_Percentage", "Sl_No", "Yarn_Purchase_Code, For_OrderBy, Company_IdNo, Yarn_Purchase_No, Yarn_Purchase_Date, Ledger_Idno", tr)
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Yarn_Purchase_GST_Tax_Details   ( Yarn_Purchase_Code          ,               Company_IdNo       ,      Yarn_Purchase_No                ,                   for_OrderBy     , Yarn_Purchase_Date    ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount                                   ,  GST_Percent        ) " &
            ...
            cmd.CommandText = "insert into Entry_GST_Tax_Details_Temp(GST_Percentage, CGST_Amount, SGST_Amount, IGST_Amount) select (CGST_Percentage + SGST_Percentage + IGST_Percentage), sum(CGST_Amount), sum(SGST_Amount), sum(IGST_Amount) from Yarn_Purchase_GST_Tax_Details where Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and (CGST_Percentage <> 0 or SGST_Percentage <> 0 or IGST_Percentage <> 0) and (CGST_Amount <> 0 or SGST_Amount <> 0 or IGST_Amount <> 0) Group by CGST_Percentage,  SGST_Percentage,  IGST_Percentage Having sum(CGST_Amount) <> 0 or sum(SGST_Amount) <> 0 or sum(IGST_Amount) <> 0"
            cmd.ExecuteNonQuery()
            ...
            vLed_IdNos = Led_ID & "|" & PurAc_ID & "|" & Trim(vVOUPOS_GSTAC_IDNOS) & "|" & Common_Procedures.CommonLedger.ADDLESS_AMOUNT_AC & "|" & Common_Procedures.CommonLedger.TCS_RECEIVABLE_AC & "|" & Common_Procedures.CommonLedger.ROUNDOFF_AC
            ...
            Dim vTransBill_No As String = "", vTransBill_Date As String = ""

            If Trim(txt_transport_BillNo.Text) <> "" Then
                vTransBill_No = "Bill No : " & Trim(txt_transport_BillNo.Text)
            End If

            If Trim(txt_Transport_BillDate.Text) <> "" Then
                vTransBill_Date = "Date : " & Trim(txt_Transport_BillDate.Text)
            End If
            ...
            vFrgtPartcls = "Purc : Ref No. " & Trim(lbl_RefNo.Text) & " - " & "Mill : " & Trim(vFrstMIlNm) & ", " & Trim(vTransBill_No) & " , " & Trim(vTransBill_Date) & "  , Bags : " & Trim(vTotBgs)
    ...
    Private Sub cbo_Delvat_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Delvat.KeyDown
        ...
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Delvat, msk_BillDate, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        End If
        ...
        If (e.KeyCode = 40 And sender.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            ...
            ElseIf cbo_ClothSales_OrderCode_forSelection.Visible And cbo_ClothSales_OrderCode_forSelection.Enabled Then
                If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1267" Then '---- SUBHAM Textiles (Somanur)
...
loop1:
    ...
    Private Sub cbo_Delvat_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Delvat.KeyPress
        ...
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Delvat, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'WEAVER' or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_IdNo = 0)")
        End If
...
loop1:
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, Nothing, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
        ...
        If (e.KeyValue = 40 And sender.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            ...
            ElseIf txt_LotNo.Enabled And txt_LotNo.Visible Then
                txt_LotNo.Focus()
            ElseIf (cbo_ClothSales_OrderCode_forSelection.Visible And cbo_ClothSales_OrderCode_forSelection.Enabled) And cbo_ClothSales_OrderCode_forSelection.TabIndex = 4 Then
                cbo_ClothSales_OrderCode_forSelection.Focus()
            Else
                If txt_BillNo.Visible And txt_BillNo.Enabled Then
                    txt_BillNo.Focus()
                Else
                    msk_BillDate.Focus()
            ...
            With dgv_Details
                If .Visible = True Then
                    If .Rows.Count > 0 Then
                        ...
                        If Trim(.CurrentRow.Cells(6).Value) = "" Then
                            .CurrentRow.Cells(6).Value = "KG"
                        End If
                        ...
                        If e.ColumnIndex = 6 And Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "1267" Then
                        ...
                        If dgv_Details.Columns(24).Visible = True Then
    ...
    Private Sub txt_Note_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Note.KeyDown
        ...
        If e.KeyValue = 40 Then
            ...
            If txt_transport_BillNo.Visible = True Then
                txt_transport_BillNo.Focus()
            Else
            ...
            If vTDS_DED_STS = True Then
                ...
                If txt_TDS_TaxableValue.Enabled = False Then
                    ...
                    If Common_Procedures.settings.CustomerCode = "1087" Then ' Kalaimagal Palladam
                        vTDS_AssVal = Format(Val(txt_AssessableValue.Text), "############0.00")
                        'vTDS_AssVal = Format(Val(lbl_GrossAmount.Text), "############0.00")

                    ElseIf Common_Procedures.settings.CustomerCode = "1098" Then ' Bannariamman Textile
                        vTDS_AssVal = Format(Val(lbl_BillAmount.Text), "############0.00")
    ...
    Private Sub Print_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Yarn_Purchase_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as Transport_Name , e.Ledger_Name as Agent_Name,CSH.State_Name as Company_State_Name  ,CSH.State_Code as Company_State_Code ,LSH.State_Name as Ledger_State_Name ,LSH.State_Code as Ledger_State_Code  from Yarn_Purchase_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_HEad CSH on b.Company_State_IdNo = CSH.State_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_HEad LSH on c.Ledger_State_IdNo = LSH.State_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.Agent_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.count_name , c.Mill_Name  from Yarn_Purchase_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Mill_Head c ON a.Mill_IdNo = c.Mill_IdNo where a.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.for_orderby, a.Yarn_Purchase_No", con)
...
LOOP2:
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            If Trim(prn_HdDt.Rows(0).Item("Transport_Bill_No").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "TRANSPORT Bill NO : " & prn_HdDt.Rows(0).Item("Transport_Bill_No").ToString, LMargin + C1 + 10, CurY, 0, 0, pFont)
            End If
            ...
            If Trim(prn_HdDt.Rows(0).Item("Transport_Bill_date").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "TRANSPORT Bill DATE : " & prn_HdDt.Rows(0).Item("Transport_Bill_date").ToString, LMargin + C1 + 10, CurY, 0, 0, pFont)
            End If
    ...
    Private Sub cbo_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Agent.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Agent, cbo_TaxType, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT')", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_Agent_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Agent.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            If txt_CommRate.Enabled And txt_CommRate.Visible = True Then
                txt_CommRate.Focus()
            End If
        End If
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        ElseIf Trim(UCase(cbo_EntryType.Text)) = Trim(UCase("ORDER")) Then
            ...
            With dgv_Order_Selection
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_nAME, d.Mill_Name,e.Ledger_Name as DeliveryAt ,f.Ledger_Name as Transport,h.Bags as Ent_Bags, h.Cones as Ent_Cones, h.Weight as Ent_Wgt,h.Rate as Ent_Rate from Yarn_Purchase_Order_Head a INNER JOIN Yarn_Purchase_Order_details b ON a.Yarn_Purchase_Order_Code = b.Yarn_Purchase_Order_Code INNER JOIN Count_Head c ON b.Count_IdNo = c.Count_IdNo INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo  LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.DeliveryTo_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Yarn_Purchase_details h ON h.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Purchase_Order_Code = h.Yarn_Purchase_Order_Code and b.Yarn_Purchase_Order_Details_SlNo = h.Yarn_Purchase_Order_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "  " & Trim(vLEDID_Cond) & " and ((b.Weight - b.Purchase_Weight - b.Cancelled_Weight) > 0 or h.Weight > 0 ) and a.Order_Close_Status = 0 order by a.Yarn_Purchase_Order_Date, a.for_orderby, a.Yarn_Purchase_Order_No", con)
                'Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_nAME, d.Mill_Name,e.Ledger_Name as DeliveryAt ,f.Ledger_Name as Transport,h.Bags as Ent_Bags, h.Cones as Ent_Cones, h.Weight as Ent_Wgt,h.Rate as Ent_Rate from Yarn_Purchase_Order_Head a INNER JOIN Yarn_Purchase_Order_details b ON a.Yarn_Purchase_Order_Code = b.Yarn_Purchase_Order_Code INNER JOIN Count_Head c ON b.Count_IdNo = c.Count_IdNo INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo  LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.DeliveryTo_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Yarn_Purchase_details h ON h.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Purchase_Order_Code = h.Yarn_Purchase_Order_Code and b.Yarn_Purchase_Order_Details_SlNo = h.Yarn_Purchase_Order_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "  " & Trim(vLEDID_Cond) & " and ((b.Weight - b.Purchase_Weight - b.Cancelled_Weight) > 0 or h.Weight > 0 ) order by a.Yarn_Purchase_Order_Date, a.for_orderby, a.Yarn_Purchase_Order_No", con)
                'Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_nAME, d.Mill_Name,e.Ledger_Name as DeliveryAt ,f.Ledger_Name as Transport,h.Bags as Ent_Bags, h.Cones as Ent_Cones, h.Weight as Ent_Wgt,h.Rate as Ent_Rate from Yarn_Purchase_Order_Head a INNER JOIN Yarn_Purchase_Order_details b ON a.Yarn_Purchase_Order_Code = b.Yarn_Purchase_Order_Code INNER JOIN Count_Head c ON b.Count_IdNo = c.Count_IdNo INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo  LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo = a.DeliveryTo_IdNo LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo LEFT OUTER JOIN Yarn_Purchase_details h ON h.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Purchase_Order_Code = h.Yarn_Purchase_Order_Code and b.Yarn_Purchase_Order_Details_SlNo = h.Yarn_Purchase_Order_Details_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "   a.Ledger_IdNo = " & Val(LedIdNo) & " and ((b.Weight - b.Purchase_Weight - b.Cancelled_Weight) > 0 or h.Weight > 0 ) order by a.Yarn_Purchase_Order_Date, a.for_orderby, a.Yarn_Purchase_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        SNo = SNo + 1
                        .Rows(n).Cells(0).Value = Val(SNo)
                        .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_No").ToString
                        .Rows(n).Cells(2).Value = Format(Convert.ToDateTime(Dt1.Rows(i).Item("Yarn_Purchase_Order_Date").ToString), "dd-MM-yyyy")
                        .Rows(n).Cells(3).Value = Dt1.Rows(i).Item("Count_Name").ToString
                        ...
                        .Rows(n).Cells(14).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_Code").ToString
                        .Rows(n).Cells(15).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_Details_SlNo").ToString
                        ...
                        .Rows(n).Cells(30).Value = (Dt1.Rows(i).Item("ClothSales_OrderCode_forSelection").ToString)
                    Next
        ...
        ElseIf Trim(UCase(cbo_EntryType.Text)) = Trim(UCase("SIZING-YARNRECEIPT")) Then
            ...
            With dgv_Sizing_YarnReceipt_Selection
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Count_nAME, d.Mill_Name, isnull(f.Ledger_Name,'') as TransportName, " &
                                                  ...
                                                  " INNER JOIN Yarn_Purchase_Order_Head tYPOH ON tYPOH.Ledger_IdNo = " & Str(Val(LedIdNo)) & " and tYPOH.Yarn_Purchase_Order_Code = b.Yarn_Purchase_Order_Code " &
                                                  " INNER JOIN Count_Head c ON b.Count_IdNo = c.Count_IdNo INNER JOIN Mill_Head d ON b.Mill_IdNo = d.Mill_IdNo " &
                                                  " LEFT OUTER JOIN Ledger_Head f ON f.Ledger_IdNo = a.Transport_IdNo " &
                                                  " LEFT OUTER JOIN Yarn_Purchase_details h ON h.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' and b.Yarn_Receipt_Code = h.SizSoft_Yarn_Receipt_Code and b.Yarn_Receipt_DetailsSlno = h.SizSoft_Yarn_Receipt_Details_Slno " &
                                                  " Where a.Entry_Type = 'ORDER' and (b.Yarn_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' or b.Yarn_Purchase_Code = '') and tYPOH.Ledger_IdNo = " & Str(Val(LedIdNo)) & " " &
                                                  " Order by b.Yarn_Purchase_Code Desc, a.Yarn_Receipt_Date, a.for_orderby, a.Yarn_Receipt_No, a.Yarn_Receipt_Code", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
                ...
                If Dt1.Rows.Count > 0 Then
                    ...
                    For i = 0 To Dt1.Rows.Count - 1
                        ...
                        .Rows(n).Cells(20).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_No").ToString
                        .Rows(n).Cells(21).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_Code").ToString
                        .Rows(n).Cells(22).Value = Dt1.Rows(i).Item("Yarn_Purchase_Order_Details_Slno").ToString
        ...
        ElseIf Trim(UCase(cbo_EntryType.Text)) = "DIRECT" Then
            ...
            With dgv_OwnOrderSelection
                If Val(LedIdNo) <> 0 Then
                    ...
                    Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Yarn_Purchase_Code = '" & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                    Dt1 = New DataTable
                    Da.Fill(Dt1)
                    ...
                    Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno INNER JOIN Own_Order_Yarn_Details c ON  c.Own_Order_Code = a.Own_Order_Code   LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Yarn_Purchase_Code = a.Own_order_Code    where a.Yarn_Purchase_Code = ''  and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                    Dt1 = New DataTable
                    Da.Fill(Dt1)
                ...
                Else
                    ...
                    Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Yarn_Purchase_Code = '" & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                    Dt1 = New DataTable
                    Da.Fill(Dt1)
                    ...
                    Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name from Own_Order_Head a INNER JOIN Cloth_Head b ON  b.Cloth_Idno = a.Cloth_Idno    LEFT OUTER JOIN Yarn_Purchase_Head d ON d.Yarn_Purchase_Code = a.Own_Order_Code    where a.Yarn_Purchase_Code = ''   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                    Dt1 = New DataTable
                    Da.Fill(Dt1)
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Yarn_Purchase_GST_Tax_Details Where Yarn_Purchase_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub Close_Purchase_Order_Selection()
        ...
        For i = 0 To dgv_Order_Selection.RowCount - 1
            ...
            If Val(dgv_Order_Selection.Rows(i).Cells(12).Value) = 1 Then
                ...
                If Trim(cbo_ClothSales_OrderCode_forSelection.Text) <> "" And Trim(cbo_ClothSales_OrderCode_forSelection.Text) <> Trim(dgv_Order_Selection.Rows(i).Cells(30).Value) Then
                    MessageBox.Show("Invalid Sales OrderNo Selection " & Chr(13) & "Don't Select Two Different Sales Order No : " & IIf(Trim(dgv_Order_Selection.Rows(i).Cells(30).Value) <> "", Trim(dgv_Order_Selection.Rows(i).Cells(30).Value), "Nothing") & " ", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                    Exit Sub
                End If

                If Trim(cbo_ClothSales_OrderCode_forSelection.Text) = "" Then
                    cbo_ClothSales_OrderCode_forSelection.Text = dgv_Order_Selection.Rows(i).Cells(30).Value
                End If
                ...
                End If
                If Trim(UCase(dgv_Order_Selection.Rows(i).Cells(9).Value)) = "BAG" Then
...
LOOP2:
    ...
    Private Sub btn_EDIT_TDS_TaxableValue_Click(sender As System.Object, e As System.EventArgs) Handles btn_EDIT_TDS_TaxableValue.Click
        ...
        If txt_TDS_TaxableValue.Enabled Then
            ...
            If Common_Procedures.settings.CustomerCode = "1098" Then
    ...
    Private Sub Close_SizingYarnReceipt_Selection()
        ...
        Dim vCLOTH_SALES_ORDER_NO As String = ""

        dgv_Details.Rows.Clear()
        vRec_Nos = ""
        vDUP_RecNos = ""

        vCLOTH_SALES_ORDER_NO = ""
        For i = 0 To dgv_Sizing_YarnReceipt_Selection.RowCount - 1
            ...
            If Val(dgv_Sizing_YarnReceipt_Selection.Rows(i).Cells(10).Value) = 1 Then
                ...
                If Dt.Rows.Count > 0 Then
                    ...
                    vCLOTH_SALES_ORDER_NO = Dt.Rows(0).Item("ClothSales_OrderCode_forSelection").ToString
                End If
                Dt.Clear()
                ...
                cbo_ClothSales_OrderCode_forSelection.Text = Trim(vCLOTH_SALES_ORDER_NO)
    ...
    Private Sub FindRecord()
        ...
        Try
            ...
            ElseIf Trim(txt_RefNo_Open.Text) <> "" Then
                ...
                Da = New SqlClient.SqlDataAdapter("select Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Yarn_Purchase_Code = '" & Trim(InvCode) & "'", con)
                Da.Fill(Dt)
            ...
            ElseIf Trim(txt_BillNoOpen.Text) <> "" Then
                ...
                Da = New SqlClient.SqlDataAdapter("select Yarn_Purchase_No from Yarn_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and upper(Bill_No) = '" & UCase(inpno) & "' and Yarn_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
                Da.Fill(Dt)
    ...
    'Private Sub cbo_weaving_job_no_GotFocus(sender As Object, e As EventArgs)
    ...
    Private Sub cbo_weaving_job_no_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_weaving_job_no.KeyDown
        ...
        If (e.KeyCode = 38 And sender.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
            If cbo_TaxType.Enabled And cbo_TaxType.Visible = True Then
                cbo_TaxType.Focus()
            End If
        End If
        ...
        If (e.KeyCode = 40 And sender.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            If cbo_Agent.Enabled And cbo_Agent.Visible = True Then
                cbo_Agent.Focus()
            End If
        End If
    End Sub
    ...
    Private Sub txt_Duedays_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Duedays.KeyDown
        If e.KeyCode = 38 Then
            If cbo_Sizing_JobCardNo.Enabled And cbo_Sizing_JobCardNo.Visible = True Then
                cbo_Sizing_JobCardNo.Focus()
            ElseIf cbo_ClothSales_OrderCode_forSelection.Visible And cbo_ClothSales_OrderCode_forSelection.Enabled Then
...
loop1:
    ...
    Private Sub cbo_jobcardno_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Sizing_JobCardNo.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Sizing_JobCardNo, txt_Duedays, "Sizing_JobCard_Head", "Sizing_JobCode_forSelection", "ledger_idno = " & Str(Val(Led_idno)) & "", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_jobcardno_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Sizing_JobCardNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Sizing_JobCardNo, cbo_Delvat, txt_Duedays, "Sizing_JobCard_Head", "Sizing_JobCode_forSelection", "", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub txt_RecNo_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_RecNo.KeyDown
        If e.KeyCode = 40 Then
            txt_Duedays.Focus()
        End If
        If e.KeyCode = 38 Then
    ...
    Private Sub Cbo_Grid_LotNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_Grid_LotNo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_Grid_LotNo, Nothing, Nothing, "Yarn_Lot_Head", "LotCode_forSelection", "", "(Lot_No = '')")
        ...
        With dgv_Details
            ...
            If (e.KeyValue = 40 And Cbo_Grid_LotNo.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
                If Trim(UCase(cbo_EntryType.Text)) <> "RECEIPT" And Trim(UCase(cbo_EntryType.Text)) <> "ORDER" Then
    ...
    Private Sub Cbo_Grid_LotNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_Grid_LotNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_Grid_LotNo, Nothing, "Yarn_Lot_Head", "LotCode_forSelection", "", "(Lot_No = '')")
        If Asc(e.KeyChar) = 13 Then
            If Trim(UCase(cbo_EntryType.Text)) <> "RECEIPT" And Trim(UCase(cbo_EntryType.Text)) <> "ORDER" Then
    ...
    Private Sub Cbo_Grid_LotNo_TextChanged(sender As Object, e As EventArgs) Handles Cbo_Grid_LotNo.TextChanged
        ...
        Try
            If Cbo_Grid_LotNo.Visible Then
                ...
                With dgv_Details
                    If Val(Cbo_Grid_LotNo.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 24 Then
                        .Rows(.CurrentCell.RowIndex).Cells.Item(24).Value = Trim(Cbo_Grid_LotNo.Text)
                    End If
                End With
            End If
    ...
    Private Sub cbo_ClothSales_OrderCode_forSelection_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_ClothSales_OrderCode_forSelection.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, sender, cbo_PurchaseAc, txt_BillNo, "ClothSales_Order_Head", "ClothSales_OrderCode_forSelection", vCLO_CONDT, "(ClothSales_Order_Code = '999999/00-00')")
        If (e.KeyCode = 40 And sender.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
    ...
    Private Sub txt_transport_BillNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_transport_BillNo.KeyPress

        If Asc(e.KeyChar) = 13 Then
            txt_Transport_BillDate.Focus()
        End If

    End Sub

    Private Sub txt_transport_BillNo_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_transport_BillNo.KeyDown
        If e.KeyCode = 40 Then
            txt_Transport_BillDate.Focus()
        End If
    ...
    Private Sub txt_Transport_BillDate_TextChanged(sender As Object, e As EventArgs) Handles txt_Transport_BillDate.TextChanged

    End Sub

    Private Sub txt_Transport_BillDate_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Transport_BillDate.KeyDown
        If e.KeyCode = 40 Then
            If MessageBox.Show("Do you want to save ?", "FOR SAVING...", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.Yes Then
                save_record()
            Else
    ...
    Private Sub txt_Transport_BillDate_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Transport_BillDate.KeyPress
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub cbo_EntryType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_EntryType.SelectedIndexChanged
        If Trim(UCase(cbo_EntryType.Text)) <> UCase("DIRECT") Then
