Public Class Stores_Item_Receipt_Entry
    ...
    Private Pk_Condition As String = "ITMRC-"
    Private Pk_Condition1 As String = "ITRAT-"
    ...
    Private Sub Item_Receipt_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Item_Receipt_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Item_Receipt_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Stores_Item_Receipt_Entry_Layout(sender As Object, e As System.Windows.Forms.LayoutEventArgs) Handles Me.Layout

    End Sub

    Private Sub Item_Receipt_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim da As New SqlClient.SqlDataAdapter
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Issued_Name) from Stores_Item_Receipt_Head order by Issued_Name", con)
        da.Fill(dt6)
        cbo_Issued.DataSource = dt6
        cbo_Issued.DisplayMember = "Issued_Name"

        da = New SqlClient.SqlDataAdapter("select distinct(Received_Name) from Stores_Item_Receipt_Head order by Received_Name ", con)
        da.Fill(dt7)
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_DisplayName from Stores_Item_Receipt_Head a INNER JOIN Ledger_AlaisHead b ON a.Ledger_IdNo = b.Ledger_IdNo Where a.Item_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RecNo.Text = dt1.Rows(0).Item("Item_Receipt_No").ToString
                dtp_date.Text = dt1.Rows(0).Item("Item_Receipt_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name, f.Brand_Name from Stores_Item_Receipt_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Item_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(7).Value = dt2.Rows(i).Item("Item_Delivery_No").ToString
                        dgv_Details.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Item_Delivery_Code").ToString
                        dgv_Details.Rows(n).Cells(9).Value = Val(dt2.Rows(i).Item("Item_Delivery_Details_SlNo").ToString)
                    Next i
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Receipt, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Receipt, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Store_Item_Receipt_Entry, New_Entry, Me, con, "Stores_Item_Receipt_Head", "Item_Receipt_Code", NewCode, "Item_Receipt_Date", "(Item_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Stores_Item_Receipt_Head", "Item_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Item_Receipt_Code, Company_IdNo, for_OrderBy", trans)

        Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Stores_Item_Receipt_Details", "Item_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo ,Item_Delivery_No, Item_Delivery_Code , Item_Delivery_Details_SlNo ", "Sl_No", "Item_Receipt_Code, For_OrderBy, Company_IdNo, Item_Receipt_No, Item_Receipt_Date, Ledger_Idno", trans)
        ...
        Try
            ...
            cmd.CommandText = "Update Stores_Item_Delivery_Details set Receipt_Quantity = a.Receipt_Quantity - b.Quantity from Stores_Item_Delivery_Details a, Stores_Item_Receipt_Details b Where b.Item_Receipt_Code = '" & Trim(NewCode) & "' and a.Item_Delivery_Code = b.Item_Delivery_Code and a.Item_Delivery_Details_SlNo = b.Item_Delivery_Details_SlNo"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Stores_Item_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Stores_Item_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Receipt, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Receipt, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
            If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Store_Item_Receipt_Entry, New_Entry, Me) = False Then Exit Sub

            inpno = InputBox("Enter New Rec.No.", "FOR NEW NO INSERTION...")

            RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("select Item_Receipt_No from Stores_Item_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Receipt_No from Stores_Item_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Receipt_No from Stores_Item_Receipt_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Receipt_No from Stores_Item_Receipt_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Receipt_No from Stores_Item_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Receipt_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Receipt_Head", "Item_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        vOrdByNo = Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text)
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Entry_Stores_Item_Receipt, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Store_Item_Receipt_Entry, New_Entry, Me, con, "Stores_Item_Receipt_Head", "Item_Receipt_Code", NewCode, "Item_Receipt_Date", "(Item_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Item_Receipt_No desc", dtp_date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Receipt_Head", "Item_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Stores_Item_Receipt_Head(Item_Receipt_Code, Company_IdNo, Item_Receipt_No, for_OrderBy, Item_Receipt_Date, Ledger_IdNo,Type , Party_DcNo, Received_Name, Issued_Name, New_Old, Particulars, Total_Quantity,    Remarks           ,  Freight                     ,Transport_Idno) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @RecDate, " & Str(Val(Led_ID)) & ", '" & Trim(cbo_Type.Text) & "', '" & Trim(txt_Party_DcNo.Text) & "', '" & Trim(cbo_Received.Text) & "', '" & Trim(cbo_Issued.Text) & "','" & Trim(cbo_New_Old.Text) & "', '" & Trim(txt_Particulars.Text) & "', " & Str(Val(vTotqty)) & ",'" & Trim(txt_Remarks.Text) & "'," & Val(txt_Transport_Freight.Text) & " , " & Val(Trans_ID) & " )"
                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Stores_Item_Receipt_Head", "Item_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Receipt_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Stores_Item_Receipt_Details", "Item_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo ,Item_Delivery_No, Item_Delivery_Code , Item_Delivery_Details_SlNo ", "Sl_No", "Item_Receipt_Code, For_OrderBy, Company_IdNo, Item_Receipt_No, Item_Receipt_Date, Ledger_Idno", tr)

                cmd.CommandText = "Update Stores_Item_Receipt_Head set Issued_Name = '" & Trim(cbo_Issued.Text) & "', Item_Receipt_Date = @RecDate ,Ledger_IdNo = " & Str(Val(Led_ID)) & ",Type = '" & Trim(cbo_Type.Text) & "', Party_DcNo = '" & Trim(txt_Party_DcNo.Text) & "', Received_Name = '" & Trim(cbo_Received.Text) & "', New_Old = '" & Trim(cbo_New_Old.Text) & "' , Particulars = '" & Trim(txt_Particulars.Text) & "', Total_Quantity = " & Str(Val(vTotqty)) & ",Remarks = '" & Trim(txt_Remarks.Text) & "',Freight = " & Val(txt_Transport_Freight.Text) & ", Transport_Idno= " & Val(Trans_ID) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Stores_Item_Receipt_Head", "Item_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_RecNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Receipt_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Stores_Item_Receipt_Details ( Item_Receipt_Code, Company_IdNo, Item_Receipt_No, for_OrderBy, Item_Receipt_Date, Sl_No, Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo ,Item_Delivery_No, Item_Delivery_Code , Item_Delivery_Details_SlNo ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))) & ", @RecDate, " & Str(Val(Sno)) & ", " & Str(Val(Item_ID)) & ", " & Str(Val(Brand_ID)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(Unit_ID)) & ",'" & Trim(.Rows(i).Cells(7).Value) & "' ,'" & Trim(.Rows(i).Cells(8).Value) & "'," & Str(Val(.Rows(i).Cells(9).Value)) & " )"
                        cmd.ExecuteNonQuery()

                        If Trim(UCase(cbo_Type.Text)) = "SELECTION" Then
                            nr = 0
                            cmd.CommandText = "Update Stores_Item_Delivery_Details set Receipt_Quantity = Receipt_Quantity + " & Str(Val(.Rows(i).Cells(5).Value)) & " Where Item_Delivery_Code = '" & Trim(.Rows(i).Cells(8).Value) & "' and Item_Delivery_Details_SlNo = " & Str(Val(.Rows(i).Cells(9).Value)) & " and Ledger_IdNo = " & Str(Val(Led_ID))
                            nr = cmd.ExecuteNonQuery()
                            If nr = 0 Then
            ...
            If Common_Procedures.Voucher_Updation(con, "ItemRec.Frgt", Val(lbl_Company.Tag), Trim(Pk_Condition1) & Trim(NewCode), Trim(lbl_RecNo.Text), Convert.ToDateTime(dtp_date.Text), Trim(txt_Remarks.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub cbo_Received_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Received.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Received, txt_Party_DcNo, cbo_Issued, "Stores_Item_Receipt_Head", "Received_name", "", "")
    End Sub
    ...
    Private Sub cbo_Received_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Received.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Received, cbo_Issued, "Stores_Item_Receipt_Head", "Received_Name", "", "", False)
    End Sub
    ...
    Private Sub cbo_Issued_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Issued.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Issued, cbo_Received, cbo_New_Old, "Stores_Item_Receipt_Head", "Issued_Name", "", "")
    ...
    Private Sub cbo_Issued_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Issued.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Issued, cbo_New_Old, "Stores_Item_Receipt_Head", "Issued_Name", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Item_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.quantity, c.item_name, d.unit_name from Stores_Item_Receipt_Head a left outer join Stores_Item_Receipt_Details b on a.Item_Receipt_Code = b.Item_Receipt_Code left outer join Stores_Item_Head c on b.item_idno = c.item_idno left outer join unit_head d on b.unit_idno = d.unit_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Item_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by Item_Receipt_Date, for_orderby, Item_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Item_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Item_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Dim dt1 As New DataTable
        Dim NewCode As String
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Store_Item_Receipt_Entry, New_Entry) = False Then Exit Sub

        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RecNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Stores_Item_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Receipt_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Stores_Item_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Receipt_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, f.Brand_Name from Stores_Item_Receipt_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Receipt_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = Val(45) : ClAr(2) = 320 : ClAr(3) = 120 : ClAr(4) = 120
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, f.Brand_Name from Stores_Item_Receipt_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "ITEM RECEIPT", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Item_Receipt_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Item_Receipt_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Party_DcNo").ToString.ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, cbo_Type, txt_Party_DcNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", " (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_idno = 0)")
        If Asc(e.KeyChar) = 13 Then
            If Trim(UCase(cbo_Type.Text)) = "SELECTION" Then
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name, d.Unit_name, e.Brand_Name,  g.Quantity as Ent_Rec_Quantity from Stores_Item_Delivery_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head e ON a.Brand_idno = e.Brand_idno  LEFT OUTER JOIN Stores_Item_Receipt_Details g ON g.Item_Receipt_Code = '" & Trim(NewCode) & "' and a.Item_Delivery_Code = g.Item_Delivery_Code and a.Item_Delivery_Details_SlNo = g.Item_Delivery_Details_SlNo Where a.ledger_idno = " & Str(Val(LedIdNo)) & " and ( (a.Quantity - a.Receipt_Quantity ) > 0 or g.Quantity > 0 ) Order by a.For_OrderBy, a.Item_Delivery_No, a.Item_Delivery_Details_SlNo", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    If (Val(Dt1.Rows(i).Item("Quantity").ToString) - Val(Dt1.Rows(i).Item("Receipt_Quantity").ToString) + Ent_Qty) > 0 Then
                        ...
                        .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("Item_Delivery_No").ToString
                        ...
                        .Rows(n).Cells(9).Value = Dt1.Rows(i).Item("Item_Delivery_Code").ToString
                        .Rows(n).Cells(10).Value = Val(Dt1.Rows(i).Item("Item_Delivery_Details_SlNo").ToString)
                        .Rows(n).Cells(11).Value = Val(Ent_Qty)
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(8).Value) = 1 Then
                ...
                If Val(dgv_Selection.Rows(i).Cells(11).Value) <> 0 Then
                    Ent_Qty = Val(dgv_Selection.Rows(i).Cells(11).Value)
