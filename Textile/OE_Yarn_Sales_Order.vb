Public Class OE_Yarn_Sales_Order
    ...
    Private Pk_Condition As String = "CTORD-"
    ...
    Private Sub Cotton_Order_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler dtp_DeliveryDate.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler dtp_DeliveryDate.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Cotton_Order_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Order_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_OrderNo.Text = dt1.Rows(0).Item("Cotton_Order_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Cotton_Order_Date").ToString
                ...
                txt_DelvAdd1.Text = dt1.Rows(0).Item("Delivery_Address").ToString
                txt_Remarks.Text = dt1.Rows(0).Item("Remarks").ToString

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Count_Name, c.Colour_Name from Cotton_Order_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo Where a.Cotton_Order_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Weight_Bag").ToString), "########0.000")
                            ...
                            .Rows(n).Cells(8).Value = (dt2.Rows(i).Item("Cotton_Order_details_SlNo").ToString)
                            .Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("Invoice_Weight").ToString), "########0.00")
                            .Rows(n).Cells(10).Value = (dt2.Rows(i).Item("Invoice_Bags").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.OEENTRY_ORDER_ENTRY, New_Entry, Me, con, "Cotton_Order_Head", "Cotton_Order_Code", NewCode, "Cotton_Order_Date", "(Cotton_Order_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_OrderNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        Da = New SqlClient.SqlDataAdapter("select count(*) from Cotton_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_code = '" & Trim(NewCode) & "' and Invoice_Weight <> 0", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
        ...
        Try
            ...
            cmd.CommandText = "delete from Cotton_Order_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Cotton_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Order_No from Cotton_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Cotton_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Order_No from Cotton_Order_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Cotton_Order_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Order_No from Cotton_Order_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Cotton_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Order_No from Cotton_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Cotton_Order_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_OrderNo.Text = Common_Procedures.get_MaxCode(con, "Cotton_Order_Head", "Cotton_Order_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Cotton_Order_No from Cotton_Order_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
            ...
            Else
                MessageBox.Show("Order  No. does not exists", "DOES NOT FIND...", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.OEENTRY_ORDER_ENTRY, New_Entry, Me) = False Then Exit Sub

        Try

            inpno = InputBox("Enter New Order No.", "FOR NEW ORDER NO. INSERTION...")
            ...
            Else
                If Val(inpno) = 0 Then
                    MessageBox.Show("Invalid Order No.", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_OrderNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.OEENTRY_ORDER_ENTRY, New_Entry, Me, con, "Cotton_Order_Head", "Cotton_Order_Code", NewCode, "Cotton_Order_Date", "(Cotton_Order_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Cotton_Order_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(3).Value) <> 0 Or Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                ...
                If Val(dgv_Details.Rows(i).Cells(3).Value) = 0 Then
                    MessageBox.Show("Invalid Bag", "DOES NOT SAVE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    If dgv_Details.Enabled And dgv_Details.Visible Then
                        dgv_Details.Focus()
        ...
        Try
            ...
            Else
                ...
                lbl_OrderNo.Text = Common_Procedures.get_MaxCode(con, "Cotton_Order_Head", "Cotton_Order_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            cmd.Parameters.AddWithValue("@OrderDate", dtp_Date.Value.Date)
            cmd.Parameters.AddWithValue("@DelDate", dtp_DeliveryDate.Value.Date)

            If New_Entry = True Then
                cmd.CommandText = "Insert into Cotton_Order_Head ( Cotton_Order_Code ,               Company_IdNo       ,     Cotton_Order_No  ,                                               for_OrderBy                                                     , Cotton_Order_Date  ,              Ledger_IdNo,            Agent_IdNo          ,  Delivery_Date               ,           Freight               ,     Delivery_Address           ,                  Remarks      ,           Total_Bags    ,          Total_Weight,             Total_Amount      ) " &
                                    "     Values                              (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_OrderNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_OrderNo.Text))) & ",       @OrderDate   , " & Str(Val(Led_ID)) & ",    " & Str(Val(Ag_ID)) & ",             @DelDate             ,     " & Str(Val(txt_Freight.Text)) & ",  '" & Trim(txt_DelvAdd1.Text) & "', '" & Trim(txt_Remarks.Text) & "' , " & Str(Val(vTotBgs)) & ", " & Str(Val(vTotWgt)) & ", " & Str(Val(vTotAmt)) & ") "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Cotton_Order_Head set Cotton_Order_Date = @OrderDate, Ledger_IdNo =  " & Str(Val(Led_ID)) & " ,    Agent_IdNo = " & Str(Val(Ag_ID)) & "    ,  Delivery_Date = @DelDate   , Freight = " & Val(txt_Freight.Text) & " ,     Delivery_Address = '" & Trim(txt_DelvAdd1.Text) & "',Remarks = '" & Trim(txt_Remarks.Text) & "' , Total_Bags = " & Str(Val(vTotBgs)) & "  ,  Total_Weight = " & Str(Val(vTotWgt)) & ", Total_Amount = " & Str(Val(vTotAmt)) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            End If

            cmd.CommandText = "Delete from Cotton_Order_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "' and Invoice_Weight =0"
            cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        Nr = 0
                        cmd.CommandText = "Update  Cotton_Order_Details set Cotton_Order_Date = @OrderDate , Ledger_IdNo = " & Str(Val(Led_ID)) & ", Sl_No  = " & Str(Val(Sno)) & " , Count_IdNo = " & Str(Val(Cnt_ID)) & " , Colour_IdNo = " & Str(Val(Clr_ID)) & " , Bags =  " & Str(Val(.Rows(i).Cells(3).Value)) & ", Weight_Bag = " & Str(Val(.Rows(i).Cells(4).Value)) & " ,       Weight = " & Str(Val(.Rows(i).Cells(5).Value)) & " , Rate= " & Str(Val(.Rows(i).Cells(6).Value)) & "  , Amount =  " & Str(Val(.Rows(i).Cells(7).Value)) & "  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "'  and Cotton_Order_Details_SlNo = " & Val(.Rows(i).Cells(8).Value)
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Cotton_Order_Details ( Cotton_Order_Code ,               Company_IdNo                 ,   Cotton_Order_No    ,                     for_OrderBy                                            , Cotton_Order_Date        ,                  Ledger_IdNo  ,   Sl_No       ,        Count_IdNo          ,       Colour_IdNo         ,                   Bags           ,             Weight_Bag                   ,                       Weight                ,                     Rate                   ,                                                 Amount  ) " &
                                                "     Values                        (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_OrderNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_OrderNo.Text))) & ",       @OrderDate            , " & Str(Val(Led_ID)) & ", " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & "   , " & Str(Val(Clr_ID)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ",  " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & ") "
                            cmd.ExecuteNonQuery()
                        End If
            ...
            If Val(Common_Procedures.settings.OnSave_MoveTo_NewEntry_Status) = 1 Then
                If New_Entry = True Then
                    new_record()
                Else
                    move_record(Trim(lbl_OrderNo.Text))
                End If
            Else
                move_record(Trim(lbl_OrderNo.Text))
            End If
    ...
    Private Sub cbo_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, dtp_Date, cbo_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyName, cbo_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Agent.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Agent, cbo_PartyName, dtp_DeliveryDate, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT')", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_Agent_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Agent.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Agent, dtp_DeliveryDate, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Grid_Count_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Count.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_Count, txt_Remarks, cbo_Grid_Colour, "Count_Head", "Count_Name", "", "(Count_IdNo = 0)")
        ...
        With dgv_Details
            ...
            If .Visible Then
                If .CurrentCell.ColumnIndex = 3 Or .CurrentCell.ColumnIndex = 4 Or .CurrentCell.ColumnIndex = 5 Or .CurrentCell.ColumnIndex = 6 Or .CurrentCell.ColumnIndex = 7 Then
                    ...
                    End If
                    If Val(.CurrentCell.ColumnIndex) = 5 Or Val(.CurrentCell.ColumnIndex) = 6 Then
                        .Rows(.CurrentCell.RowIndex).Cells(7).Value = Val(dgv_Details.Rows(.CurrentCell.RowIndex).Cells(5).Value) * Val(dgv_Details.Rows(.CurrentCell.RowIndex).Cells(6).Value)
                    End If
                End If
                Total_Calculation()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Cotton_Order_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Cotton_Order_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Cotton_Order_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.*,c.Count_Name, d.Colour_name, e.Ledger_Name, f.Ledger_Name as Agent_Name from Cotton_Order_Head a left outer join Cotton_Order_Details b on a.Cotton_Order_Code = b.Cotton_Order_Code left outer join Count_head c on b.Count_idno = c.Count_idno left outer join Colour_head d on b.Colour_idno = d.Colour_idno inner join Ledger_head e on a.Ledger_idno = e.Ledger_idno left outer join Ledger_head f on f.Ledger_idno = a.Agent_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Cotton_Order_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Cotton_Order_Date, a.for_orderby, a.Cotton_Order_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Cotton_Order_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Cotton_Order_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, cbo_Filter_Count, cbo_Filter_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, cbo_Filter_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) ) ", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Filter_AgentName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Filter_Agent.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT' ) ", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Filter_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_Agent.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_Agent, cbo_Filter_PartyName, btn_Filter_Show, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = 'AGENT')", "(Ledger_idno = 0)")
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_OrderNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.OEENTRY_ORDER_ENTRY, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Cotton_Order_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Order_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Cotton_Order_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Order_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_name, d.ClothType_name from Cotton_Order_Details a INNER JOIN Cloth_Head b ON a.Cloth_idno = b.Cloth_idno LEFT OUTER JOIN ClothType_Head d ON a.ClothType_idno = d.ClothType_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Order_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Cotton_Order_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Cotton_Order_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt + 10
