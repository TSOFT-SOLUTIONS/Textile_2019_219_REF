Public Class Inhouse_Pavu_Delivery
    ...
    Private Pk_Condition As String = "IPVDC-"
    ...
    Private Sub Inhouse_Pavu_Delivery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Inhouse_Pavu_Delivery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Inhouse_Pavu_Delivery_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Common_Procedures.settings.Show_Weaver_JobCard_Entry_STATUS = 1 Then
            ...
            cbo_weaving_job_no.Left = cbo_Transport.Left
            cbo_weaving_job_no.Width = cbo_Transport.Width
    ...
    Private Sub Inhouse_Pavu_Delivery_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as DelvName, c.Ledger_Name as TransportName, d.EndsCount_Name, e.Ledger_Name as RecFromName from Inhouse_Pavu_Delivery_Head a INNER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.ReceivedFrom_IdNo = e.Ledger_IdNO Where a.Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Inhouse_Pavu_Delivery_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Inhouse_Pavu_Delivery_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Pavu_Delivery_Increment, c.EndsCount_Name, d.Beam_Width_Name from Inhouse_Pavu_Delivery_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON a.Beam_Width_Idno = d.Beam_Width_Idno where a.Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Inhouse_Pavu_Delivery_Entry, New_Entry, Me, con, "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", NewCode, "Inhouse_Pavu_Delivery_Date", "(Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Inhouse_Pavu_Delivery_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Inhouse_Pavu_Delivery_Details", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Set_No,Beam_No,Pcs,Meters_Pc,Meters,EndsCount_IdNo,Beam_Width_IdNo,Noof_Used", "Sl_No", "Inhouse_Pavu_Delivery_Code, For_OrderBy, Company_IdNo, Inhouse_Pavu_Delivery_No, Inhouse_Pavu_Delivery_Date, Ledger_Idno", trans)

            Common_Procedures.Voucher_Deletion(con, Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), trans)

            Da = New SqlClient.SqlDataAdapter("Select * from Inhouse_Pavu_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'", con)
            ...
            cmd.CommandText = "delete from Inhouse_Pavu_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Inhouse_Pavu_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Inhouse_Pavu_Delivery_No from Inhouse_Pavu_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Inhouse_Pavu_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Inhouse_Pavu_Delivery_No from Inhouse_Pavu_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Inhouse_Pavu_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Inhouse_Pavu_Delivery_No from Inhouse_Pavu_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Inhouse_Pavu_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Inhouse_Pavu_Delivery_No from Inhouse_Pavu_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Inhouse_Pavu_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_DcNo.ForeColor = Color.Red


            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Inhouse_Pavu_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Inhouse_Pavu_Delivery_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Inhouse_Pavu_Delivery_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Inhouse_Pavu_Delivery_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Inhouse_Pavu_Delivery_No from Inhouse_Pavu_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Inhouse_Pavu_Delivery_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Inhouse_Pavu_Delivery_Entry, New_Entry, Me, con, "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", NewCode, "Inhouse_Pavu_Delivery_Date", "(Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Inhouse_Pavu_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Inhouse_Pavu_Delivery_Head ( Inhouse_Pavu_Delivery_Code, Company_IdNo, Inhouse_Pavu_Delivery_No, for_OrderBy, Inhouse_Pavu_Delivery_Date, DeliveryTo_IdNo, ReceivedFrom_IdNo, EndsCount_IdNo, Pavu_Meters, Empty_Beam, Vehicle_No , Transport_Idno, Total_Beam , Total_Pcs, Total_Meters ,Freight, Party_DcNo,Width_Type , User_idNo,Weaving_JobCode_forSelection , ClothSales_OrderCode_forSelection) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ",  " & Val(Rec_ID) & " ,  " & Str(Val(KuPvu_EdsCnt_ID)) & "," & Val(txt_KuraiPavuMeter.Text) & " , " & Val(txt_KuraiPavuBeam.Text) & ",  '" & Trim(cbo_VehicleNo.Text) & "' , " & Val(Trans_ID) & ", " & Str(Val(vTotPvuBms)) & " , " & Str(Val(vTotPvuPcs)) & " , " & Str(Val(vTotPvuMtrs)) & " ," & Val(txt_Freight.Text) & " ,  '" & Trim(txt_Party_DcNo.Text) & "' ,'" & Trim(cbo_WidthType.Text) & "', " & Val(lbl_UserName.Text) & ",'" & Trim(Weaver_Job_Code) & "', '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "') "
                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Inhouse_Pavu_Delivery_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Inhouse_Pavu_Delivery_Details", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Set_No,Beam_No,Pcs,Meters_Pc,Meters,EndsCount_IdNo,Beam_Width_IdNo,Noof_Used", "Sl_No", "Inhouse_Pavu_Delivery_Code, For_OrderBy, Company_IdNo, Inhouse_Pavu_Delivery_No, Inhouse_Pavu_Delivery_Date, Ledger_Idno", tr)

                cmd.CommandText = "Update Inhouse_Pavu_Delivery_Head set Inhouse_Pavu_Delivery_Date = @EntryDate, DeliveryTo_IdNo = " & Str(Val(Delv_ID)) & ", ReceivedFrom_IdNo = " & Str(Val(Rec_ID)) & ", Empty_Beam = " & Str(Val(txt_KuraiPavuBeam.Text)) & ", Pavu_Meters = " & Str(Val(txt_KuraiPavuMeter.Text)) & ", EndsCount_IdNo = " & Str(Val(KuPvu_EdsCnt_ID)) & ", Vehicle_No = '" & Trim(cbo_VehicleNo.Text) & "' , Transport_Idno = " & Str(Val(Trans_ID)) & ", Freight = " & Str(Val(txt_Freight.Text)) & ", Total_Beam = " & Str(Val(vTotPvuBms)) & ", Total_Pcs = " & Str(Val(vTotPvuPcs)) & ", Total_Meters = " & Str(Val(vTotPvuMtrs)) & ", Party_DcNo = '" & Trim(txt_Party_DcNo.Text) & "',Width_Type = '" & Trim(cbo_WidthType.Text) & "', User_IdNo = " & Val(lbl_UserName.Text) & ",Weaving_JobCode_forSelection = '" & Trim(Weaver_Job_Code) & "' , ClothSales_OrderCode_forSelection = '" & Trim(cbo_ClothSales_OrderCode_forSelection.Text) & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Inhouse_Pavu_Delivery_Head", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Inhouse_Pavu_Delivery_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(dgv_PavuDetails.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Inhouse_Pavu_Delivery_Details ( Inhouse_Pavu_Delivery_Code,              Company_IdNo        ,     Inhouse_Pavu_Delivery_No     ,                               for_OrderBy                          , Inhouse_Pavu_Delivery_Date,         DeliveryTo_IdNo  ,    ReceivedFrom_IdNo     ,          Sl_No        ,                    Set_No              ,                    Beam_No             ,                      Pcs                 ,                      Meters_Pc           ,                      Meters              ,             EndsCount_IdNo       ,      Beam_Width_IdNo     ,              Noof_Used        ,                  Set_Code                ) " & _
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Inhouse_Pavu_Delivery_Details", "Inhouse_Pavu_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Set_No,Beam_No,Pcs,Meters_Pc,Meters,EndsCount_IdNo,Beam_Width_IdNo,Noof_Used", "Sl_No", "Inhouse_Pavu_Delivery_Code, For_OrderBy, Company_IdNo, Inhouse_Pavu_Delivery_No, Inhouse_Pavu_Delivery_Date, Ledger_Idno", tr)
    ...
    Private Sub cbo_DelvAt_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_DelvAt.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DelvAt, txt_Party_DcNo, cbo_RecForm, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' and Close_status = 0)", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_DelvAt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_DelvAt.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DelvAt, cbo_RecForm, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_RecForm_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_RecForm.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'GODOWN' or Ledger_Type = 'JOBWORKER') and Close_status = 0", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_RecForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecForm.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecForm, cbo_DelvAt, cbo_EndsCount, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'GODOWN' or Ledger_Type = 'JOBWORKER') and Close_status = 0", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_RecForm_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RecForm.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RecForm, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'GODOWN' or Ledger_Type = 'JOBWORKER') and Close_status = 0", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_VehicleNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VehicleNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Inhouse_Pavu_Delivery_Head", "Vehicle_No", "", "")
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, txt_KuraiPavuBeam, cbo_Transport, "Inhouse_Pavu_Delivery_Head", "Vehicle_No", "", "")
    End Sub
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, cbo_Transport, "Inhouse_Pavu_Delivery_Head", "Vehicle_No", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Inhouse_Pavu_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Inhouse_Pavu_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Inhouse_Pavu_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,c.EndsCount_Name  from Inhouse_Pavu_Delivery_Head a INNER JOIN Ledger_Head b on a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head c on d.EndsCount_IdNo = c.EndsCount_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Inhouse_Pavu_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Inhouse_Pavu_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Inhouse_Pavu_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Inhouse_Pavu_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, dtp_Filter_ToDate, cbo_Filter_EndsCountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER' )and  Close_status = 0 ", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, cbo_Filter_EndsCountName, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'WEAVER') and Close_status = 0 ", "(Ledger_idno = 0)")
    End Sub
        ...
        With dgv_PavuDetails
            ...
            If e.KeyCode = Keys.Up Then
                If .CurrentCell.RowIndex = 0 Then
                    ...
                    ElseIf cbo_WidthType.Visible Then
                        cbo_WidthType.Focus()
                    Else
                        txt_Freight.Focus()
                    End If
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Inhouse_Pavu_Delivery_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.* , d.EndsCount_Name , e.Ledger_Name as Trasport_Name from Inhouse_Pavu_Delivery_Head a LEFT OUTER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.ReceivedFrom_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo  where a.Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.Ledger_Name as Receiver_Name , d.EndsCount_Name , e.Ledger_Name  as Trasport_Name  , f.* from Inhouse_Pavu_Delivery_Head a LEFT OUTER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.ReceivedFrom_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo INNER JOIN Company_Head f ON a.Company_IdNo = f.Company_IdNo  where a.Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.* , d.EndsCount_Name from Inhouse_Pavu_Delivery_Details a LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_idno = d.EndsCount_idno where Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "PAVU DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Inhouse_Pavu_Delivery_No").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Inhouse_Pavu_Delivery_Date").ToString), "dd-MM-yyyy"), LMargin + M1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY = CurY + TxtHgt - 10
            Common_Procedures.Print_To_PrintDocument(e, "Received From  :  " & Trim(prn_HdDt.Rows(0).Item("Receiver_Name").ToString), LMargin + 10, CurY, 0, 0, pFont)
            If Trim(prn_HdDt.Rows(0).Item("Vehicle_No").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Vehicle No  :  " & Trim(prn_HdDt.Rows(0).Item("Vehicle_No").ToString), PageWidth - 10, CurY, 1, 0, pFont)
            End If
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.noof_used as Ent_NoofUsed, b.*, c.EndsCount_Name, d.Beam_Width_Name from Inhouse_Pavu_Delivery_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON b.Beam_Width_Idno = d.Beam_Width_Idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Inhouse_Pavu_Delivery_Code = '" & Trim(NewCode) & "' and a.ReceivedFrom_IdNo = " & Str(Val(Led_IdNo)) & " order by a.for_orderby, a.Set_Code, b.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
