Public Class OE_Reeling_Delivery
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Count_Name, c.ConeType_Name from Reeling_Delivery_Details a LEFT OUTER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN ConeType_head c ON a.ConeType_IdNo = c.ConeType_IdNo Where a.Reeling_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.OEENTRY_REELING_DELIVERY_ENTRY, New_Entry, Me, con, "Reeling_Delivery_Head", "Reeling_Delivery_Code", NewCode, "Reeling_Delivery_Date", "(Reeling_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.OEENTRY_REELING_DELIVERY_ENTRY, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.OEENTRY_REELING_DELIVERY_ENTRY, New_Entry, Me, con, "Reeling_Delivery_Head", "Reeling_Delivery_Code", NewCode, "Reeling_Delivery_Date", "(Reeling_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Reeling_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Reeling_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Reeling_Delivery_Head ( Reeling_Delivery_Code ,               Company_IdNo       ,     Reeling_Delivery_No  ,                                               for_OrderBy                    , Reeling_Delivery_Date  ,              Ledger_IdNo,                JJFrom_No         ,                  Van_No      ,           Total_Bags    ,          Total_Weight   ) " &
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Reeling_Delivery_Details ( Reeling_Delivery_Code ,               Company_IdNo                 ,   Reeling_Delivery_No    ,                     for_OrderBy                                            , Reeling_Delivery_Date        ,                     Sl_No       ,        Count_IdNo          ,       ConeType_IdNo         ,                   Bags           ,                      Weight            ) " &
                                            "     Values                        (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",       @DcDate            ,  " & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & "   , " & Str(Val(CnTy_Id)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & " ) "
                        cmd.ExecuteNonQuery()
                        ...
                        cmd.CommandText = "Insert into Stock_Reeling_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                         ,        Reference_Date,     Party_Bill_No   ,Entry_ID ,   Sl_No      ,     Ledger_idNo      ,               Count_IdNo    ,           ConeType_IdNo     ,                   Form_No        ,        Weight                                 ) " &
                                                                  "   Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",    @DcDate   , '" & Trim(PBlNo) & "','" & Trim(EntID) & "'  , " & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & ", " & Str(Val(Cnt_ID)) & "," & Str(Val(CnTy_Id)) & ",  '" & Trim(txt_JJFromNo.Text) & "',   " & Str(Val(.Rows(i).Cells(4).Value)) & " )"
                        cmd.ExecuteNonQuery()
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.OEENTRY_REELING_DELIVERY_ENTRY, New_Entry) = False Then Exit Sub
