Public Class Processing_Return
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.Ledger_Name as Transport_Name from Cloth_Processing_Return_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo  Where a.ClothProcess_Return_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RetNo.Text = dt1.Rows(0).Item("ClothProcess_Return_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("ClothProcess_Return_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,b.Processed_Item_Name as Grey_Item_Name,c.Colour_Name,d.Lot_No,e.Process_Name from Cloth_Processing_Return_Details a INNER JOIN Processed_Item_Head b ON b.Processed_Item_IdNo = a.Item_Idno LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Lot_Head d ON a.Lot_IdNo = d.Lot_IdNo LEFT OUTER JOIN Process_Head e ON a.Processing_Idno = e.Process_IdNo where a.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(6).Value = Val(dt2.Rows(i).Item("Return_Pcs").ToString)
                        dgv_Details.Rows(n).Cells(7).Value = Val(dt2.Rows(i).Item("Return_Qty").ToString)
                        dgv_Details.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Return_Meters").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("ExcSht_Meters").ToString), "########0.00")


                        dgv_Details.Rows(n).Cells(10).Value = dt2.Rows(i).Item("Cloth_Processing_Delivery_Code").ToString
                        dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("Cloth_Processing_Delivery_Slno").ToString
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(9).Value = Format(Val(dt1.Rows(0).Item("Total_ExcessShort").ToString), "########0.00")
                End With
    ...
    Private Sub Processing_Delivery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Processing_Return_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub processing_Return_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Hide_CurrentStock_Display()
    End Sub

    Private Sub Processing_Return_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Processing_Return_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Processing_Return_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RetNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Processing_Return_Entry, New_Entry, Me, con, "Cloth_Processing_Return_Head", "ClothProcess_Return_Code", NewCode, "ClothProcess_Return_Date", "(ClothProcess_Return_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "Update Cloth_Processing_Delivery_Details set Return_Meters = a.Return_Meters - (b.Return_Meters-b.ExcSht_Meters) from Cloth_Processing_Delivery_Details a, Cloth_Processing_Return_Details b Where b.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' and a.Cloth_Processing_Delivery_code = b.Cloth_Processing_Delivery_code and a.Cloth_Processing_Delivery_SlNo = b.Cloth_Processing_Delivery_SlNo"
            cmd.ExecuteNonQuery()
          
            cmd.CommandText = "delete from Cloth_Processing_Return_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Cloth_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Cloth_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Return_No", con)
        da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Cloth_Processing_Return_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, ClothProcess_Return_No", con)
        da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Cloth_Processing_Return_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, ClothProcess_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Return_No from Cloth_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, ClothProcess_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RetNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Return_Head", "ClothProcess_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select ClothProcess_Return_No from Cloth_Processing_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Fp_Processing_Return_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Processing_Return_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Processing_Return_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Processing_Return_Entry, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_Processing_Return_Entry, New_Entry, Me, con, "Cloth_Processing_Return_Head", "ClothProcess_Return_Code", NewCode, "ClothProcess_Return_Date", "(ClothProcess_Return_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, ClothProcess_Return_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        With dgv_Details
            For i = 0 To dgv_Details.RowCount - 1
                If Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Or Val(.Rows(i).Cells(9).Value) <> 0 Then
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vExcSrt = Val(dgv_Details_Total.Rows(0).Cells(9).Value())
        End If
        ...
        Else
            ...
            lbl_RetNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Return_Head", "ClothProcess_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
        ...
        cmd.Parameters.AddWithValue("@RetDate", dtp_Date.Value.Date)
        cmd.CommandText = "Truncate Table TempTable_For_NegativeStock"
        cmd.ExecuteNonQuery()


        If New_Entry = True Then
            cmd.CommandText = "Insert into Cloth_Processing_Return_Head(ClothProcess_Return_Code, Company_IdNo, ClothProcess_Return_No, for_OrderBy, ClothProcess_Return_Date, Ledger_IdNo, Purchase_OrderNo, Transport_IdNo, Freight_Charges, DeliveryTo_Name,Total_Pcs,Total_Qty, Total_Meters,Total_ExcessShort  , User_IdNo   ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RetNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RetNo.Text))) & ", @RetDate, " & Str(Val(Led_ID)) & ", '" & Trim(txt_PoNo.Text) & "', " & Str(Val(Tr_ID)) & ", " & Str(Val(txt_Frieght.Text)) & ",  '" & Trim(txt_DelTo.Text) & "'," & Str(Val(vTotPcs)) & ", " & Val(vtotqty) & ", " & Str(Val(vTotMtrs)) & ", " & Val(vExcSrt) & ", " & Val(lbl_UserName.Text) & ")"
            cmd.ExecuteNonQuery()

        Else

            cmd.CommandText = "Update Cloth_Processing_Return_Head set ClothProcess_Return_Date = @RetDate, Ledger_IdNo = " & Val(Led_ID) & ", Purchase_OrderNo = '" & Trim(txt_PoNo.Text) & "' , Transport_IdNo = " & Val(Tr_ID) & ", Freight_Charges = " & Val(txt_Frieght.Text) & ", DeliveryTo_Name = '" & Trim(txt_DelTo.Text) & "', Total_Pcs = " & Val(vTotPcs) & " , Total_Qty = " & Val(vtotqty) & " , Total_Meters = " & Val(vTotMtrs) & " ,Total_ExcessShort = " & Val(vExcSrt) & " , User_IdNo = " & Val(lbl_UserName.Text) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
        ...
        Partcls = "Ret : Dc.No. " & Trim(lbl_RetNo.Text)
        PBlNo = Trim(lbl_RetNo.Text)
        EntID = Trim(Pk_Condition) & Trim(lbl_RetNo.Text)
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(8).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Or Val(.Rows(i).Cells(9).Value) <> 0 Then
                    Sno = Sno + 1
                    itgry_id = Common_Procedures.Processed_Item_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)
                    ' Itfp_ID = Common_Procedures.Processed_Item_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)
                    ...
                    cmd.CommandText = "Insert into Cloth_Processing_Return_Details(Cloth_Processing_Return_Code, Company_IdNo, Cloth_Processing_Return_No, for_OrderBy, Cloth_Processing_Return_Date,Sl_No,Dc_Rc_No,Item_Idno,Colour_Idno,Processing_Idno,Lot_IdNo,Return_Pcs,Return_Qty,Return_Meters,ExcSht_Meters , Cloth_Processing_Delivery_code , Cloth_Processing_Delivery_Slno ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RetNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RetNo.Text))) & ", @RetDate," & Str(Val(Sno)) & ", '" & Trim(.Rows(i).Cells(1).Value) & "', " & Str(Val(itgry_id)) & ", " & Val(Col_ID) & ",  " & Val(Proc_ID) & " , " & Val(Lot_ID) & " ," & Val(.Rows(i).Cells(6).Value) & ", " & Val(.Rows(i).Cells(7).Value) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & ", " & Str(Val(.Rows(i).Cells(9).Value)) & " , '" & Trim(.Rows(i).Cells(10).Value) & "', " & Str(Val(.Rows(i).Cells(11).Value)) & " )"
                    cmd.ExecuteNonQuery()

                    Nr = 0
                    cmd.CommandText = "Update Cloth_Processing_Delivery_Details set Return_Meters = Return_Meters + " & Str(Val(.Rows(i).Cells(8).Value) - Val(.Rows(i).Cells(9).Value)) & " Where Cloth_Processing_Delivery_code = '" & Trim(.Rows(i).Cells(10).Value) & "' and Cloth_Processing_Delivery_SlNo = " & Str(Val(.Rows(i).Cells(11).Value)) & " and Ledger_IdNo = " & Str(Val(Led_ID))
                    ...
                    cmd.CommandText = "Insert into Stock_Item_Processing_Details ( Reference_Code ,            Company_IdNo          ,            Reference_No    ,            For_OrderBy                                                 ,  Reference_Date     ,                   DeliveryTo_StockIdNo                     ,  ReceivedFrom_StockIdNo , Delivery_PartyIdNo              , Received_PartyIdNo           , Entry_ID             , Party_Bill_No                            , Particulars           , SL_No                   ,             Item_IdNo       , Rack_IdNo             ,                      Quantity           ,                      Meters                 ) " & _
                                                              " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RetNo.Text) & "'      , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RetNo.Text))) & ",    @RetDate  , 0                      , " & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & " , " & Str(Val(Led_ID)) & "        ,         0                    ,'" & Trim(EntID) & "' , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',  " & Str(Val(Sno)) & "  , " & Str(Val(itgry_id)) & "  , 0                    , " & Str(Math.Abs(Val(.Rows(i).Cells(6).Value))) & ", " & Str(Math.Abs(Val(.Rows(i).Cells(8).Value))) & " ) "
                    cmd.ExecuteNonQuery()
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details
            For i = 0 To dgv_Details.Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(6).Value) <> 0 Or Val(dgv_Details.Rows(i).Cells(8).Value) <> 0 Or Val(dgv_Details.Rows(i).Cells(9).Value) <> 0 Then
                    ...
                    vExcsrt = vExcsrt + Val(dgv_Details.Rows(i).Cells(9).Value)
                End If
            Next
        End With
        ...
        dgv_Details_Total.Rows(0).Cells(9).Value = Format(Val(vExcsrt), "#########0.00")
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, txt_DelTo, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1)", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_DelTo, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1) ", "(Ledger_idno = 0)")
    ...
    Private Sub dgv_Details_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEndEdit
        With dgv_Details
            ...
            If .CurrentCell.ColumnIndex = 9 Or .CurrentCell.ColumnIndex = 8 Then
    ...
    Private Sub dgv_Details_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEnter
        ...
        With dgv_Details
            ...
            '        Dt2 = New DataTable
            '        Da.Fill(Dt2)
            '        cbo_itemgrey.DataSource = Dt2
            '        cbo_itemgrey.DisplayMember = "Procesed_Item_Name"
    ...
    Private Sub dgtxt_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_details.KeyPress
        With dgv_Details
            ...
            If Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = 6 Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = 7 Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = 8 Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = 9 Then
    ...
    Private Sub cbo_colour_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Colour.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Colour, cbo_itemgrey, cbo_Processing, "colour_Head", "colour_Name", "", "(Colour_IdNo = 0)")
        With dgv_Details
    ...
    Private Sub cbo_itemgrey_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_itemgrey.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_itemgrey, Nothing, cbo_Colour, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'GREY' and Verified_Status = 1)", "(Processed_Item_idno = 0)")
         With dgv_Details
    ...
    Private Sub cbo_itemgrey_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_itemgrey.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_itemgrey, cbo_Colour, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'GREY' and Verified_Status = 1)", "(Processed_Item_idno = 0)")
       If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.ClothProcess_Return_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.ClothProcess_Return_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.ClothProcess_Return_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,z1.*,c.Processed_Item_Name,d.Process_Name from Cloth_Processing_Return_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Cloth_Processing_Return_Details z1 ON z1.Cloth_Processing_Return_Code = a.ClothProcess_Return_Code INNER JOIN Processed_Item_Head c ON z1.Item_IdNo = c.Processed_Item_IdNo  LEFT OUTER JOIN Process_Head d ON z1.Processing_Idno = d.Process_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.ClothProcess_Return_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("ClothProcess_Return_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("ClothProcess_Return_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_Filter_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_PartyName.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_PartyName, txt_filterpono, cbo_Filter_ProcessName, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1)", "(Ledger_idno = 0)")

    End Sub

    Private Sub cbo_Filter_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_PartyName, cbo_Filter_ProcessName, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1) ", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_ProcessName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_ProcessName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_ProcessName, cbo_Filter_PartyName, btn_Filter_Show, "Process_Head", "Process_name", "", "(Process_iDNO = 0)")
    ...
    Private Sub cbo_Filter_ProcessName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_ProcessName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_ProcessName, btn_Filter_Show, "Process_Head", "Process_name", "", "(Process_iDNO = 0)")
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.FP_Processing_Return_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Cloth_Processing_Return_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Return_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,d.Ledger_Name as Transport_Name from Cloth_Processing_Return_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo = a.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Return_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name as Processed_Grey_Name, c.Colour_Name ,d.Lot_No ,e.Process_Name  from Cloth_Processing_Return_Details a INNER JOIN Processed_Item_Head b on a.Item_IdNo = b.Processed_Item_IdNo LEFT OUTER JOIN Colour_Head c on a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN Lot_Head d ON d.Lot_IdNo = a.Lot_IdNo LEFT OUTER JOIN Process_Head e ON e.Process_IdNo = a.Processing_Idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Return_Pcs").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Return_Pcs").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 10, CurY, 1, 0, pFont)
                        End If
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Return_Meters").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Return_Meters").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 10, CurY, 1, 0, pFont)
                        End If
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("ExcSht_Meters").ToString), "########0.000"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "PROCESSING RETURN", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("ClothProcess_Return_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("ClothProcess_Return_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "EXCSHT METERS", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Val(prn_HdDt.Rows(0).Item("Total_Meters").ToString) <> 0 Then
                ...
                End If
            End If
            If Val(prn_HdDt.Rows(0).Item("ExcSht_Meters").ToString) <> 0 Then
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("ExcSht_Meters").ToString), "#########0.000"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, pFont)
                End If
            End If
    ...
    Private Sub cbo_TransportName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportName, txt_DelTo, txt_PoNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT' and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Transportname_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportName, txt_PoNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT' and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.*, b.*, e.Ledger_Name as Transportname,h.Return_Pcs As Ent_Pcs, h.Return_Meters as Ent_Mtrs, h.Return_Qty As Ent_Qty, g.Processed_Item_Name as Fp_Item_Name , I.Lot_No , j.Process_Name , k.Colour_Name from Cloth_Processing_Delivery_Head a INNER JOIN Cloth_Processing_Delivery_details b ON a.ClothProcess_Delivery_Code = b.Cloth_Processing_Delivery_Code INNER JOIN Processed_Item_Head g ON g.Processed_Item_IdNo = b.Item_Idno LEFT OUTER JOIN Lot_Head i ON b.Lot_IdNo = i.Lot_IdNo LEFT OUTER JOIN Process_Head J ON J.Process_IdNo = b.Processing_Idno LEFT OUTER JOIN Colour_Head k ON b.Colour_IdNo = k.Colour_IdNo LEFT OUTER JOIN Ledger_Head e ON a.Transport_IdNo = e.Ledger_IdNo LEFT OUTER JOIN Cloth_Processing_Return_Details h ON h.Cloth_Processing_Return_Code = '" & Trim(NewCode) & "' and b.Cloth_Processing_Delivery_Code = h.Cloth_Processing_Delivery_Code and b.Cloth_Processing_Delivery_SlNo = h.Cloth_Processing_Delivery_SlNo Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & " a.ledger_Idno = " & Str(Val(LedIdNo)) & " and ((b.Delivery_Meters - b.Receipt_Meters - b.Return_Meters) > 0 or h.Return_Meters > 0 ) order by a.ClothProcess_Delivery_Date, a.for_orderby, a.ClothProcess_Delivery_No", con)
            Dt1 = New DataTable
            nr = Da.Fill(Dt1)
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(7).Value = Val(Dt1.Rows(i).Item("Delivery_Pcs").ToString)
                    ...
                    .Rows(n).Cells(11).Value = Dt1.Rows(i).Item("Purchase_OrderNo").ToString
                    .Rows(n).Cells(12).Value = Dt1.Rows(i).Item("Cloth_Processing_Delivery_code").ToString
                    .Rows(n).Cells(13).Value = Dt1.Rows(i).Item("Cloth_Processing_Delivery_Slno").ToString

                    .Rows(n).Cells(14).Value = Ent_Pcs
                    .Rows(n).Cells(15).Value = Ent_Qty
                    .Rows(n).Cells(16).Value = Ent_Mtrs
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(10).Value) = 1 Then
                ...
                If txt_PoNo.Text = "" Then
                    If (dgv_Selection.Rows(i).Cells(11).Value) <> "" Then
                        txt_PoNo.Text = Trim(dgv_Selection.Rows(i).Cells(11).Value)
                    End If
                End If
                ...
                If Val(dgv_Selection.Rows(i).Cells(16).Value) <> 0 Then
                    dgv_Details.Rows(n).Cells(8).Value = dgv_Selection.Rows(i).Cells(16).Value
                Else
