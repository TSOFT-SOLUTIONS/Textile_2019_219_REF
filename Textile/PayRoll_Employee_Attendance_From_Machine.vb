Public Class PayRoll_Employee_Attendance_From_Machine
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ATTENDANCE, New_Entry, Me, con, "PayRoll_Employee_Attendance_Head", "Employee_Attendance_Code", Trim(Pk_Condition) & NewCode, "Employee_Attendance_Date", "(Employee_Attendance_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ATTENDANCE_FROM_MACHINE, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ATTENDANCE_FROM_MACHINE, New_Entry, Me, con, "PayRoll_Employee_Attendance_Head", "Employee_Attendance_Code", Pk_Condition & NewCode, "Employee_Attendance_Date", "(Employee_Attendance_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Employee_Attendance_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Employee_Attendance_No desc", dtp_Date.Value.Date) = False Then Exit Sub
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        cmd.CommandText = "Insert into PayRoll_Employee_Attendance_Details (              Employee_Attendance_Code         ,               Company_IdNo       ,   Employee_Attendance_No      ,         for_OrderBy    ,   Employee_Attendance_Date  ,             Sl_No     ,    Employee_IdNo         ,       Category_IdNo  ,        Shift_IdNo      ,                 In_Out_Timings          ,                      No_Of_Hours         ,        No_Of_Minutes      ,              Add_Less_Minutes             ,               Shift_Hours                ,     Shift_Minutes         ,                      No_Of_Shift         ,                      OT_Hours             ,           OT_Minutes     ,                      Late_Hours            ,         Late_Minutes     ,                      EarlyOut_Hours        ,        EarlyOut_Minutes     ) " & _
                    ...
                    If Val(Empe_ID) <> 0 Then
                        ...
                        If Trim(.Rows(i).Cells(1).Value) <> "" Then
                            ...
                            If IsDate(.Rows(i).Cells(1).Value) = True Then
                                ...
                                cmd.CommandText = "Insert into PayRoll_Attendance_Timing_Details (         Employee_Attendance_Code            ,               Company_IdNo       ,   Employee_Attendance_No      ,     for_OrderBy        ,   Employee_Attendance_Date,             Sl_No     ,      Employee_IdNo       ,  InOut_Type ,                 InOut_Time_Text        ,  InOut_DateTime  ) " & _
    ...
    Private Sub get_AttendanceTimings_from_Machine()
        ...
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Date1, Name2) select b.Card_No, a.InOut_DateTime, a.InOut_Type from PayRoll_Employee_Head b LEFT OUTER JOIN Payroll_Timing_Addition_Details a ON a.Timing_Addition_Code LIKE 'TIMAD-%' and a.Timing_Addition_Date = @EntryDate and b.Employee_IdNo = a.Employee_IdNo Where b.Join_DateTime <= @EntryDate and (b.Date_Status = 0 or (b.Date_Status = 1 and b.Releave_DateTime >= @EntryDate ) )"
        Cmd.ExecuteNonQuery()
        'Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Date1, Name2) select b.Card_No, a.InOut_DateTime, a.InOut_Type from Payroll_Timing_Addition_Details a, PayRoll_Employee_Head b where a.Timing_Addition_Code LIKE 'TIMAD-%' and a.Timing_Addition_Date = @EntryDate and a.Employee_IdNo = b.Employee_IdNo"
        'Cmd.ExecuteNonQuery()

        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSubTable) & "(Name1, Date1, Name2) select b.Card_No, InOut_DateTime, a.InOut_Type from Payroll_Timing_Addition_Details a, PayRoll_Employee_Head b where a.Timing_Addition_Code LIKE 'TIMAD-%' and a.Timing_Addition_Date = @NextDate and a.Employee_IdNo = b.Employee_IdNo"
        Cmd.ExecuteNonQuery()
        ...
        If Dt1.Rows.Count > 0 Then
            ...
            For I = 0 To Dt1.Rows.Count - 1
                ...
                If DateDiff(DateInterval.Day, dtp_Date.Value.Date, DtTm2) = 0 Then
                    Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Date1, Name2) values ('" & Trim(Dt1.Rows(I).Item("Employee_CardNo").ToString) & "', @IO_DateTime, '" & Trim(Dt1.Rows(I).Item("IN_Out").ToString) & "')"
                    Cmd.ExecuteNonQuery()

                ElseIf DateDiff(DateInterval.Day, dtp_Date.Value.Date, DtTm2) = 1 Then
                    Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSubTable) & "(Name1, Date1, Name2) values ('" & Trim(Dt1.Rows(I).Item("Employee_CardNo").ToString) & "', @IO_DateTime, '" & Trim(Dt1.Rows(I).Item("IN_Out").ToString) & "')"
                    Cmd.ExecuteNonQuery()
        ...
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSimpleTable) & "(Name1, Date1, Date2) Select b.Card_No, a.Employee_Attendance_Date, a.InOut_DateTime from PayRoll_Attendance_Timing_Details a, PayRoll_Employee_Head b where a.Employee_Attendance_Date = @PreviousDate and a.Employee_IdNo = b.Employee_IdNo"
        Cmd.ExecuteNonQuery()


        '********** Deleting the Timing , if it is already included in Previous Day
        Cmd.CommandText = "delete from " & Trim(Common_Procedures.EntryTempTable) & " where Date1 IN (Select sq1.date2 from " & Trim(Common_Procedures.EntryTempSimpleTable) & " sq1 where sq1.Name1 = " & Trim(Common_Procedures.EntryTempTable) & ".Name1)"
        Cmd.ExecuteNonQuery()
        ...
        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempSimpleTable) & " ( Name1, Date1, Name2 ) select a.Name1, a.Date1, a.Name2 from " & Trim(Common_Procedures.EntryTempSubTable) & " a where a.Date1 <= @NextDate and (Select COUNT(*) from " & Trim(Common_Procedures.EntryTempTable) & " sq1 where sq1.int1 = a.Int1) = 0"
        Cmd.ExecuteNonQuery()

        Cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "(Name1, Date1, Name2) select Name1, Date1, Name2 from " & Trim(Common_Procedures.EntryTempSimpleTable) & ""
        Cmd.ExecuteNonQuery()

        Cmd.CommandText = "delete from " & Trim(Common_Procedures.EntryTempSubTable) & " Where Date1 IN (Select sq1.date1 from " & Trim(Common_Procedures.EntryTempSimpleTable) & " sq1 where sq1.Name1 = " & Trim(Common_Procedures.EntryTempSubTable) & ".Name1)"
        Cmd.ExecuteNonQuery()


        '********** Displaying Timing from " & Trim(Common_Procedures.EntryTempTable) & "....
        ...
        Da = New SqlClient.SqlDataAdapter("Select b.Employee_Name, a.Name1 as EmpTicketNo, a.Date1 as InOutTiming, a.Name2 as In_Out from " & Trim(Common_Procedures.EntryTempTable) & " a LEFT OUTER JOIN PayRoll_Employee_Head b ON a.Name1 = b.card_no WHERE B.Date_Status = 0 order by b.Employee_Name, a.Name1, a.Date1", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
...
LOOP1:
    ...
    Private Sub Get_OutTime_From_NextDate(ByVal EmpCode As String, ByRef Ind As Integer, ByVal InOutTimeArr() As String)
        ...
        Da = New SqlClient.SqlDataAdapter("select * from " & Trim(Common_Procedures.EntryTempSubTable) & " where Name1 = '" & Trim(EmpCode) & "' Order by Date1", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
    ...
    Private Sub Employee_InOut_Update(ByVal EmpCode As String, ByRef Ind As Integer, ByVal InOutTimeArr() As String)
        ...
        If catg_id > 0 Then
            ...
            eOutMns = DateDiff(DateInterval.Minute, DtTm1, ShftOutTm)
            If eOutMns > 0 Then
                H = eOutMns \ 60
                M = eOutMns - (H * 60)
        ...
        If TotMins > 0 Then
            ...
            If Trim(UCase(SalTyp_ShftMnth)) = "SHIFT" Then
                If ActShftMnts <> 0 Then NoofShfts = Int(TotMins / ActShftMnts)
