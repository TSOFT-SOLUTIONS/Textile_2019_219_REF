Public Class Garments_PackingInward
    ...
    Private Pk_Condition As String = "GPINW-"
    ...
    Public Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select * from GarmentsInward_Rack_Head where GarmentsInward_Rack_Code='" & Trim(NewCode) & "'", con)
            da.Fill(dt)

            If dt.Rows.Count > 0 Then
                lbl_RefNo.Text = dt.Rows(0).Item("GarmentsInward_Rack_No").ToString
                dtp_Date.Text = dt.Rows(0).Item("GarmentsInward_Rack_Date").ToString
                msk_Date.Text = dtp_Date.Text
                da = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name,c.Rack_No from GarmentsInward_Rack_Details a INNER JOIN Item_Head b ON a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Rack_Head c ON a.Rack_IdNo = c.Rack_IdNo where a.GarmentsInward_Rack_Code = '" & Trim(NewCode) & "'  Order by a.sl_no", con)
                da.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_rackdetails.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Item_Name").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_delivery_Entry, New_Entry, Me, con, "GarmentsInward_Rack_Head", "GarmentsInward_Rack_Code", NewCode, "GarmentsInward_Rack_Date", "(GarmentsInward_Rack_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Stock_Type, Reference_Code, Reference_Date, Company_Idno, Ledger_Idno         , Item_IdNo, Rack_IdNo ) " &
                                    " Select                               'PI'    , Reference_Code, Reference_Date, Company_IdNo, DeliveryTo_StockIdNo, Item_IdNo, Rack_IdNo from Item_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from GarmentsInward_Rack_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select GarmentsInward_Rack_No from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 GarmentsInward_Rack_No from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, GarmentsInward_Rack_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 GarmentsInward_Rack_No from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, GarmentsInward_Rack_No desc", con)
            da.Fill(dt)
            movno = 0
            If dt.Rows.Count > 0 Then
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 GarmentsInward_Rack_No from GarmentsInward_Rack_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby , GarmentsInward_Rack_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 GarmentsInward_Rack_No from GarmentsInward_Rack_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,GarmentsInward_Rack_No desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            da.Fill(dt)
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from GarmentsInward_Rack_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, GarmentsInward_Rack_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)

                    If dt1.Rows(0).Item("GarmentsInward_Rack_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("GarmentsInward_Rack_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_delivery_Entry, New_Entry, Me, con, "GarmentsInward_Rack_Head", "GarmentsInward_Rack_Code", NewCode, "GarmentsInward_Rack_Date", "(GarmentsInward_Rack_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, GarmentsInward_Rack_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        With dgv_rackdetails
            For i = 0 To .RowCount - 1
                If Val(.Rows(i).Cells(3).Value) <> 0 Then
                    ...
                    it_idno = Common_Procedures.Item_NameToIdNo1(con, .Rows(i).Cells(1).Value)
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into GarmentsInward_Rack_Head(GarmentsInward_Rack_Code, Company_IdNo, GarmentsInward_Rack_No, for_OrderBy,GarmentsInward_Rack_Date,Total_Quantity,Total_Meters) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @DeliveryDate," & Val(TotQty) & "," & Val(TotMtrs) & ")"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update GarmentsInward_Rack_Head set GarmentsInward_Rack_Date = @DeliveryDate, Total_Quantity = " & Val(TotQty) & ", Total_Meters = " & Val(TotMtrs) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and GarmentsInward_Rack_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_rackdetails
                ...
                For i = 0 To .RowCount - 1
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        it_idno = Common_Procedures.Item_NameToIdNo1(con, .Rows(i).Cells(1).Value, tr)
                        '   rac_idno = Common_Procedures.Rack_NoToIdNo(con, .Rows(i).Cells(2).Value, tr)

                        Sno = Sno + 1
                        Stockno = Stockno + 1
                        cmd.CommandText = "Insert into GarmentsInward_Rack_Details(GarmentsInward_Rack_Code, Company_IdNo,GarmentsInward_Rack_No,for_OrderBy,GarmentsInward_Rack_Date, Sl_No , Item_IdNo, Rack_IdNo , Quantity) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @DeliveryDate, " & Str(Val(Sno)) & ", " & Str(Val(it_idno)) & ", " & Str(Val(rac_idno)) & " ," & Str(Val(.Rows(i).Cells(3).Value)) & ")"
                        cmd.ExecuteNonQuery()

                        'RecID = 0
                        'DlvID = Val(Common_Procedures.CommonLedger.Godown_Ac)

                        'cmd.CommandText = "Insert into Item_Processing_Details ( Reference_Code ,            Company_IdNo          ,            Reference_No    ,                                          For_OrderBy                                                 ,  Reference_Date ,  DeliveryTo_StockIdNo   ,  ReceivedFrom_StockIdNo, Delivery_PartyIdNo, Received_PartyIdNo , Entry_ID             , Party_Bill_No          , Particulars                    , SL_No   ,             Item_IdNo    ,                   Rack_IdNo           ,                   Quantity           ) " &
                        '                                  " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'      , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",              @DeliveryDate ,  " & Str(Val(DlvID)) & ", " & Str(Val(RecID)) & ",          0        ,          0        ,'" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',   " & Str(Val(Stockno)) & "  , " & Str(Val(it_idno)) & ", " & Str(Val(rac_idno)) & " , " & Str(Math.Abs(Val(.Rows(i).Cells(3).Value))) & " ) "
                        'cmd.ExecuteNonQuery()
                        ...
                        'cmd.CommandText = "Insert into Item_Processing_Details ( Reference_Code ,                           Company_IdNo          ,            Reference_No    ,                                  For_OrderBy                            ,          Reference_Date ,  DeliveryTo_StockIdNo   ,  ReceivedFrom_StockIdNo, Delivery_PartyIdNo, Received_PartyIdNo , Entry_ID             , Party_Bill_No          , Particulars          ,           SL_No   ,                     Item_IdNo    ,        Rack_IdNo,                             Quantity             ) " &
                        '                                 " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'      , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @DeliveryDate ,  " & Str(Val(DlvID)) & ", " & Str(Val(RecID)) & ",          0        ,          0        ,'" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',     " & Str(Val(Stockno)) & "  , " & Str(Val(it_idno)) & ",            0     ,       " & Str(Math.Abs(Val(.Rows(i).Cells(3).Value))) & " ) "
                        'cmd.ExecuteNonQuery()
                        ...
                        cmd.CommandText = "Insert into Item_Processing_Details (    Reference_Code    ,             Company_IdNo         ,            Reference_No           ,          for_OrderBy       ,                                             Reference_Date,          Ledger_IdNo    ,           Party_Bill_No           ,            SL_No     ,                  Item_IdNo      ,           Unit_IdNo     ,                         Quantity               ) " &
                                                 " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'  , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",   @DeliveryDate ,             ''       ,         '" & Trim(PBlNo) & "',              " & Str(Val(Sno)) & ",  " & Str(Val(it_idno)) & "  ,            1         ,                 " & Str(Val(.Rows(i).Cells(3).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            If Val(Common_Procedures.settings.NegativeStock_Restriction) = 1 Then
                cmd.CommandText = "Insert into TempTable_For_NegativeStock ( Stock_Type, Reference_Code, Reference_Date, Company_Idno, Ledger_Idno           , Item_IdNo, Rack_IdNo ) " &
                                        " Select                               'PI'    , Reference_Code, Reference_Date, Company_IdNo, ReceivedFrom_StockIdNo, Item_IdNo,     0        from Item_Processing_Details where Reference_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
    ...
    Private Sub btn_filtershow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_filtershow.Click
        ...
        Try
            ...
            If IsDate(dtp_FilterFrom_date.Value) = True And IsDate(dtp_FilterTo_date.Value) = True Then
                ...
                Condt = "a.GarmentsInward_Rack_Date between @fromdate and @todate "
                'Condt = "a.GarmentsInward_Rack_Date between '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterFrom_date.Value) = True Then
                cmd.Parameters.AddWithValue("@fromdate", dtp_FilterFrom_date.Value.Date)
                Condt = "a.GarmentsInward_Rack_Date = @fromdate "
                'Condt = "a.GarmentsInward_Rack_Date = '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterTo_date.Value) = True Then
                cmd.Parameters.AddWithValue("@todate", dtp_FilterTo_date.Value.Date)
                Condt = "a.GarmentsInward_Rack_Date = @todate "
                'Condt = "a. GarmentsInward_Rack_Date= '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            cmd.CommandText = "select a.*, b.Processed_Item_Name from GarmentsInward_Rack_Details a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.GarmentsInward_Rack_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.GarmentsInward_Rack_No"
            da = New SqlClient.SqlDataAdapter(cmd)

            'da = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name from GarmentsInward_Rack_Details a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.GarmentsInward_Rack_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.GarmentsInward_Rack_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_filter.Rows(n).Cells(0).Value = dt2.Rows(i).Item("GarmentsInward_Rack_No").ToString
                    dgv_filter.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("GarmentsInward_Rack_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub cbo_item_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_item.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_item, Nothing, cbo_rackno, "Item_Head", "Item_Name", "", "(Item_idno = 0)")
        With dgv_rackdetails
    ...
    Private Sub cbo_item_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_item.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_item, cbo_rackno, "Item_Head", "Item_Name", "", "(Item_idno = 0)")
        If Asc(e.KeyChar) = 13 Then
            ...
            With dgv_rackdetails
                ...
                If Trim(UCase(vCbo_ItmNm)) <> Trim(UCase(cbo_item.Text)) Then

                    Itm_idno = Common_Procedures.Item_NameToIdNo1(con, Trim(cbo_item.Text))
    ...
    Private Sub Total_Calculation()
        ...
        For i = 0 To dgv_rackdetails.Rows.Count - 1
            If Val(dgv_rackdetails.Rows(i).Cells(3).Value) <> 0 Then
    ...
    Private Sub Show_Item_CurrentStock(ByVal Rw As Integer)
        ...
        vItemID = Common_Procedures.Item_NameToIdNo1(con, dgv_rackdetails.Rows(Rw).Cells(1).Value)
    ...
    Private Sub OrderPending_Details()
        ...
        it_idno = Common_Procedures.Item_NameToIdNo1(con, Trim(cbo_item.Text))
