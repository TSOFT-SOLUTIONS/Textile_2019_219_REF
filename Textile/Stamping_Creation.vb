Public Class Stamping_Creation
    ...
    Private Sub ControlLostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNothing(Prec_ActCtrl) = False Then
            If TypeOf Prec_ActCtrl Is TextBox Or TypeOf Prec_ActCtrl Is ComboBox Then
                Prec_ActCtrl.BackColor = Color.LavenderBlush
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select a.* from Stamping_Head a where a.Stamping_IdNo = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Stamping_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("Stamping_Name").ToString
    ...
    Private Sub Stamping_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Stamping_CreationFormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Stamping_Creation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Stamping_Head where Stamping_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Stamping_IdNo, Stamping_Name from Stamping_Head where Stamping_IdNo <> 0 order by Stamping_IdNo", con)
        Dim dt As New DataTable
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "STAMPING NAME"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Stamping_IdNo) from Stamping_Head Where Stamping_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Stamping_IdNo) from Stamping_Head Where Stamping_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Stamping_IdNo) from Stamping_Head Where Stamping_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and Stamping_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Stamping_IdNo) from Stamping_Head Where Stamping_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and Stamping_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Stamping_Head", "Stamping_IdNo", "")
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Stamping_Name from Stamping_Head order by Stamping_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Open.DataSource = dt
        cbo_Open.DisplayMember = "Stamping_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Stamping_Head", "Stamping_IdNo", "", trans)
                If Val(lbl_IdNo.Text) < 101 Then lbl_IdNo.Text = 101
                cmd.CommandText = "Insert into Stamping_Head(Stamping_IdNo, Stamping_Name, sur_name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "') "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Stamping_Head set Stamping_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "'  where Stamping_IdNo = " & Str(Val(lbl_IdNo.Text)) & ""
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "STAMPING"
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), "ix_Stamping_Head") > 0 Then
                MessageBox.Show("Duplicate Stamping Name", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Open_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Open.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Stamping_IdNo from Stamping_Head where Stamping_Name = '" & Trim(cbo_Open.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Open_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Open.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Open, Nothing, Nothing, "Stamping_Head", "Stamping_Name", "", "(Stamping_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Open_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Open.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Open, Nothing, "Stamping_Head", "Stamping_Name", "", "(Stamping_IdNo = 0)")
