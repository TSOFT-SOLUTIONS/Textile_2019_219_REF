Public Class Rewinding_Cotton_Waste_Sales_GST
    ...
    Private Pk_Condition As String = "GSTWS-"
    Private Pk_Condition2 As String = "GSTWA-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Rewinding_Cotton_Waste_Sales_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Variety_Name, D.Colour_Name from Rewinding_Cotton_Waste_Sales_Details a LEFT OUTER JOIN Variety_Head b ON a.Variety_IdNo = b.Variety_IdNo  LEFT OUTER JOIN COLOUR_Head d ON a.Colour_IdNo = d.Colour_IdNo Where a.Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Rewinding_Cotton_Waste_Sales_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Rewinding_Cotton_Waste_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Waste_Sales_No from Rewinding_Cotton_Waste_Sales_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code LIKE '" & Trim(Pk_Condition) & "%' and Cotton_Waste_Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Cotton_Waste_Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Cotton_Waste_Sales_No from Rewinding_Cotton_Waste_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Cotton_Waste_Sales_No from Rewinding_Cotton_Waste_Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_BillNo.Text = Common_Procedures.get_MaxCode(con, "Rewinding_Cotton_Waste_Sales_Head", "Cotton_Waste_Sales_Code", "For_OrderBy", "(Cotton_Waste_Sales_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Rewinding_Cotton_Waste_Sales_Details ( Cotton_Waste_Sales_Code ,               Company_IdNo       ,   Cotton_Waste_Sales_No    ,                     for_OrderBy                                            ,   Cotton_Waste_Sales_Date,             Sl_No     ,   Ledger_idNo  ,         Colour_IdNo         ,     Variety_IdNo                  ,                Lot_No            ,    bale ,         Bale_No                       ,                 Weight                      ,         Cotton_Waste_Code     , Cotton_Waste_Details_Slno  ) " & _
            ...
            '                                    " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_BillNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_BillNo.Text))) & ",   @Salesdate  , " & Str(Led_ID) & ", " & Str(Val(Agt_Idno)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',  " & Str(Val(lbl_NetAmount.Text)) & ",   " & Str(Val(ComAmt)) & " ) "
            '    cmd.ExecuteNonQuery()
            ...
            vLed_IdNos = Led_ID & "|" & SalAc_ID
            vVou_Amts = -1 * Val(CSng(lbl_NetAmount.Text)) & "|" & (Val(CSng(lbl_NetAmount.Text)))

            If Common_Procedures.Voucher_Updation(con, "Waste.Sales", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_BillNo.Text), Convert.ToDateTime(dtp_Date.Text), "Bill No : " & Trim(lbl_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
                Throw New ApplicationException(ErrMsg)
                Exit Sub
            End If

            'If Val(CSng(lbl_NetAmount.Text)) <> 0 Then
            '    vLed_IdNos = Led_ID & "|" & SalAc_ID & "|" & TxAc_ID
            ...
            '    If Common_Procedures.Voucher_Updation(con, "Was.Sales", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_BillNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(lbl_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            '        Throw New ApplicationException(ErrMsg)
            '    End If
            'End If
            ...
            'If Common_Procedures.Voucher_Updation(con, "AgComm.Was.Sales", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_BillNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(lbl_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
            '    Throw New ApplicationException(ErrMsg)
            'End If

            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(lbl_BillNo.Text), Agt_Idno, Val(CSng(lbl_NetAmount.Text)), "DR", Trim(NewCode), tr)
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as PartyName, d.Ledger_Name as Agent_Name from Rewinding_Cotton_Waste_Sales_Head a INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo LEFT OUTER JOIN Ledger_Head d ON a.Agent_Idno = d.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Waste_Sales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Cotton_Waste_Sales_No", con)
            'da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Ledger_Name as Delv_Name from Rewinding_Cotton_Waste_Sales_Head a INNER JOIN Rewinding_Cotton_Waste_Sales_Details b ON a.Cotton_Waste_Sales_Code = b.Cotton_Waste_Sales_Code LEFT OUTER JOIN Ledger_Head c ON a.DeliveryTo_Idno = c.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Waste_Sales_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Cotton_Waste_Sales_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_Assessable.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(lbl_CmcAmount.Text)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Rewinding_Cotton_Waste_Sales_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* , e.Ledger_Name as Agent_Name ,SH.* ,Lsh.State_Name as Ledger_State_Name ,Lsh.State_Code as Ledger_State_Code from Rewinding_Cotton_Waste_Sales_Head a " & _
                                               "  INNER JOIN Company_Head b        ON a.Company_IdNo        = b.Company_IdNo " & _
                                               "  INNER JOIN Ledger_Head c         ON a.Ledger_IdNo         = c.Ledger_IdNo " & _
                                               "  LEFT OUTER JOIN Ledger_Head e    ON e.Ledger_IdNo         = a.Agent_IdNo " & _
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* , b.Variety_Name  from Rewinding_Cotton_Waste_Sales_Details a INNER JOIN Variety_Head b ON a.Variety_IdNo = b.Variety_IdNo  where a.Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Cotton_Waste_Sales_No", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("HSN_Code").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) - 10, CurY, 1, 0, pFont)
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("bale").ToString, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 10, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Rewinding_Cotton_Waste_Sales_Head a INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Waste_Sales_Code = '" & Trim(EntryCode) & "' Order by a.For_OrderBy", con)
        da2.Fill(dt2)
    ...
    Private Sub btn_Waste_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Waste_selection.Click
        ...
        With dgv_Waste_selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.*, b.*, c.Variety_Name,d.Colour_Name , h.Weight as Ent_Wste_Weight from Cotton_Waste_Head a INNER JOIN Cotton_Waste_details b ON a.Cotton_Waste_Code = b.Cotton_Waste_Code  LEFT OUTER JOIN Variety_Head c ON a.Variety_IdNo = c.Variety_IdNo  LEFT OUTER JOIN Colour_Head d ON a.colour_IdNo = d.Colour_IdNo  LEFT OUTER JOIN Rewinding_Cotton_Waste_Sales_Details h ON h.Cotton_Waste_Sales_Code = '" & Trim(NewCode) & "' and b.Cotton_Waste_Code = h.Cotton_Waste_Code and b.Cotton_Waste_Details_Slno = h.Cotton_Waste_Details_Slno Where " & CompIDCondt & IIf(Trim(CompIDCondt) <> "", " and ", "") & "  ((b.Weight -  b.Waste_Weight) > 0 or h.Weight > 0 ) order by a.Cotton_Waste_Date, a.for_orderby, a.Cotton_Waste_No", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
    ...
    Private Sub Cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_TaxType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, txt_VehicleNo, txt_DelAddress, "", "", "", "")
    End Sub

    Private Sub Cbo_TaxType_KeyPress(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_TaxType.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TaxType, txt_DelAddress, "", "", "", "")
    End Sub
