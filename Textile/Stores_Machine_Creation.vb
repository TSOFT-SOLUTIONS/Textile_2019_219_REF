...
Public Class Stores_Machine_Creation
    Implements Interface_MDIActions
    Dim con As New SqlClient.SqlConnection(Common_Procedures.Connection_String)
    Dim New_Entry As Boolean
    Private Prec_ActCtrl As New Control

    Private Sub Machine_Creation_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Machine_Creation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        ...
        End If
    End Sub
    Private Sub Machine_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Width = 477
        grp_Find.Left = 6
        grp_Find.Top = 250
        ...
        AddHandler txt_Oil_Sevice.GotFocus, AddressOf ControlGotFocus

        AddHandler txt_Name.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Oil_Sevice.LostFocus, AddressOf ControlLostFocus


        AddHandler txt_Oil_Sevice.KeyDown, AddressOf TextBoxControlKeyDown
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '  If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Master_Stores_Machine_Creation, "~L~") = 0 And InStr(Common_Procedures.UR.Master_Stores_Machine_Creation, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select * from Machine_head a where Machine_idno = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Machine_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("Machine_Name").ToString
            txt_Oil_Sevice.Text = dt.Rows(0).Item("Oil_Service_Day").ToString
        End If
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        cbo_Find.DisplayMember = "Machine_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Master_Stores_Machine_Creation, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Machine_Head(Machine_idno, Machine_Name, Oil_Service_Day, Sur_Name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', " & Str(Val(txt_Oil_Sevice.Text)) & ", '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Machine_Head set Machine_Name = '" & Trim(txt_Name.Text) & "', Oil_Service_Day = " & Str(Val(txt_Oil_Sevice.Text)) & ", Sur_Name = '" & Trim(Sur) & "' where Machine_idno = " & Str(Val(lbl_IdNo.Text))
                cmd.ExecuteNonQuery()
    ...
    Private Sub btn_FindOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_FindOpen.Click
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt As New DataTable
        Dim movid As Integer

        da = New SqlClient.SqlDataAdapter("select Machine_IdNo from Machine_Head where Machine_Name = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub btn_FindClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_FindClose.Click
        Me.Height = 280
        pnl_back.Enabled = True
        grp_Find.Visible = False
    End Sub
    ...
    Private Sub btn_FilterClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_FilterClose.Click
        Me.Height = 280
        pnl_back.Enabled = True
        grp_Filter.Visible = False
    End Sub
    ...
    Private Sub cbo_Find_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Find.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Find, Nothing, Nothing, "Machine_Head", "Machine_Name", "", "")
    End Sub
    ...
    Private Sub cbo_Find_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Find.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Find, Nothing, "Machine_Head", "Machine_Name", "", "")
    ...
    Private Sub txt_Oil_Sevice_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Oil_Sevice.KeyDown
    ...
    Private Sub txt_Oil_Sevice_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Oil_Sevice.KeyPress
