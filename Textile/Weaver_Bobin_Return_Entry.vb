Public Class Weaver_Bobin_Return_Entry
    ...
    Private Pk_Condition As String = "WBORT-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Weaver_BobinJari_Return_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo   Where a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_DcNo.Text = dt1.Rows(0).Item("Bobin_Jari_Return_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Bobin_Jari_Return_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.EndsCount_Name, c.Colour_Name, d.BorderSize_Name from Weaver_BobinJari_Return_Bobin_Details a INNER JOIN Endscount_Head b ON a.EndsCount_IdNo = b.EndsCount_IdNo LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo Where a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_BobinDetails.Rows(n).Cells(3).Value = dt2.Rows(i).Item("BorderSize_Name").ToString
                        dgv_BobinDetails.Rows(n).Cells(4).Value = Val(dt2.Rows(i).Item("Bobins").ToString)
                        dgv_BobinDetails.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Meter_Bobin").ToString), "########0.00")
                        dgv_BobinDetails.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("METERS").ToString), "########0.00")
                        'dgv_BobinDetails.Rows(n).Cells(7).Value = dt2.Rows(i).Item("Bobin_Jari_Sales_Invoice_Code").ToString
                        'dgv_BobinDetails.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Bobin_Jari_Return_Bobin_Slno").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Colour_Name, d.BorderSize_Name from Weaver_BobinJari_Return_Jari_Details a INNER JOIN Count_Head b ON a.Count_IdNo = b.Count_IdNo LEFT OUTER JOIN Colour_Head c ON a.Colour_IdNo = c.Colour_IdNo LEFT OUTER JOIN BorderSize_Head d ON a.BorderSize_IdNo = d.BorderSize_IdNo where a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        End If
                        dgv_KuriDetails.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Weight").ToString), "########0.000")
                        'dgv_KuriDetails.Rows(n).Cells(7).Value = dt2.Rows(i).Item("Bobin_Jari_Sales_Invoice_Code").ToString
                        'dgv_KuriDetails.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Bobin_Jari_Return_Jari_Slno").ToString
    ...
    Private Sub Weaver_Bobin_Return_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Weaver_Bobin_Return_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'da = New SqlClient.SqlDataAdapter("select distinct(Vechile_No) from Weaver_BobinJari_Return_Head order by Vechile_No", con)
        'da.Fill(dt4)
    ...
    Private Sub Weaver_Bobin_Return_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Hide_CurrentStock_Display()
    End Sub

    Private Sub Weaver_Bobin_Return_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If ActiveControl.Name = dgv_BobinDetails.Name Or ActiveControl.Name = dgv_KuriDetails.Name Or TypeOf ActiveControl Is DataGridViewTextBoxEditingControl Then
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry, Me, con, "Weaver_BobinJari_Return_Head", "Bobin_Jari_Return_Code", NewCode, "Bobin_Jari_Return_Date", "(Bobin_Jari_Return_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "Delete from Weaver_BobinJari_Return_Bobin_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "Delete from Weaver_BobinJari_Return_Jari_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Weaver_BobinJari_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Return_No from Weaver_BobinJari_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Bobin_Jari_Return_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Return_No from Weaver_BobinJari_Return_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Bobin_Jari_Return_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Return_No from Weaver_BobinJari_Return_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Bobin_Jari_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Jari_Return_No from Weaver_BobinJari_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Bobin_Jari_Return_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_BobinJari_Return_Head", "Bobin_Jari_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Bobin_Jari_Return_No from Weaver_BobinJari_Return_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Weaver_Bobin_Return_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Weaver_Bobin_Return_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Weaver_Bobin_Return_Entry, New_Entry) = False Then Exit Sub

        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Weaver_bobin_Return_Entry, New_Entry, Me, con, "Weaver_BobinJari_Return", "Bobin_Jari_Return_Code", NewCode, "Bobin_Jari_Return_Date", "(Bobin_Jari_Return_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Bobin_Jari_Return_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        If dgv_KuriDetails.RowCount > 0 Then
            vTotJumbo = Val(dgv_KuriDetails.Rows(0).Cells(4).Value())
            vTotCns = Val(dgv_KuriDetails.Rows(0).Cells(5).Value())
            vTotWgt = Val(dgv_KuriDetails.Rows(0).Cells(6).Value())
        End If
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_BobinJari_Return_Head", "Bobin_Jari_Return_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)

                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

            End If

            'Da = New SqlClient.SqlDataAdapter("select count(*) from Weaver_BobinJari_Return_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "' and BobinSales_Invoice_Code <> ''", con)
            ...
            With dgv_BobinDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Weaver_BobinJari_Return_Bobin_Details ( Bobin_Jari_Return_Code, Company_IdNo, Bobin_Jari_Return_No, for_OrderBy, Bobin_Jari_Return_Date, Sl_No, EndsCount_IdNo, Colour_IdNo, BorderSize_IdNo, Bobins, Meter_Bobin, Meters  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Ens_ID)) & ", " & Str(Val(Clr_ID)) & " , " & Str(Val(BthSz_ID)) & ", " & Val(.Rows(i).Cells(4).Value) & ", " & Val(.Rows(i).Cells(5).Value) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " )"
                        cmd.ExecuteNonQuery()
            ...
            With dgv_KuriDetails
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(6).Value) <> "" And Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        'Nr = 0
                        'cmd.CommandText = "Update  Weaver_BobinJari_Return_Jari_Details set Bobin_Jari_Return_Date = @EntryDate , Sl_No  = " & Str(Val(Sno)) & " , Count_IdNo = " & Str(Val(Cnt_ID)) & "  , Colour_IdNo = " & Str(Val(Clr_ID)) & "  , BorderSize_IdNo = " & Str(Val(BthSz_ID)) & " , Noof_Jumbos = " & Val(.Rows(i).Cells(4).Value) & " , Noof_Cones = " & Val(.Rows(i).Cells(5).Value) & " , Weight = " & Val(.Rows(i).Cells(6).Value) & " , Bobin_Jari_Sales_Invoice_Code = '" & Trim(.Rows(i).Cells(7).Value) & "'  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'  and Bobin_Jari_Return_Jari_Slno = " & Str(Val(.Rows(i).Cells(8).Value))
                        'Nr = cmd.ExecuteNonQuery()

                        'If Nr = 0 Then
                        cmd.CommandText = "Insert into Weaver_BobinJari_Return_Jari_Details ( Bobin_Jari_Return_Code, Company_IdNo, Bobin_Jari_Return_No, for_OrderBy, Bobin_Jari_Return_Date, Sl_No, Count_IdNo, Colour_IdNo, BorderSize_IdNo, Noof_Jumbos, Noof_Cones, Weight ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(vOrdByNo) & ", @EntryDate," & Str(Val(Sno)) & ", " & Str(Val(Cnt_ID)) & ", " & Str(Val(Clr_ID)) & " , " & Str(Val(BthSz_ID)) & ", " & Val(.Rows(i).Cells(4).Value) & ", " & Val(.Rows(i).Cells(5).Value) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ")"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_BobinDetails
            For i = 0 To .Rows.Count - 1
                ...
                If Val(.Rows(i).Cells(6).Value) <> 0 Then
                    ...
                    vTotBbnS = vTotBbnS + Val(.Rows(i).Cells(4).Value)
                    vTotMtrs = vTotMtrs + Val(.Rows(i).Cells(6).Value)
        ...
        With dgv_KuriDetails
            For i = 0 To .Rows.Count - 1
                ...
                If Val(.Rows(i).Cells(6).Value) <> 0 Then
                    ...
                    vTotWgt = vTotWgt + Val(.Rows(i).Cells(6).Value)
                End If
        ...
        dgv_KuriDetails_Total.Rows(0).Cells(6).Value = Format(Val(vTotWgt), "#########0.000")
    ...
    Private Sub Meters_Calculation()
        ...
        With dgv_BobinDetails
            For i = 0 To dgv_BobinDetails.Rows.Count - 1
                ...
                vtotMtrs = Val(dgv_BobinDetails.Rows(i).Cells(4).Value) * Val(dgv_BobinDetails.Rows(i).Cells(5).Value)

                dgv_BobinDetails.Rows(i).Cells(6).Value = Format(Val(vtotMtrs), "#########0.00")
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, cbo_Transport, "Ledger_AlaisHead", "Ledger_DisplayName", "(ledger_type = 'WEAVER'  or Ledger_Type = 'GODOWN' or Show_In_All_Entry = 1)", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub dgtxt_BobinDetails_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_BobinDetails.KeyPress
        ...
        With dgv_BobinDetails
            ...
            If Val(dgv_BobinDetails.CurrentCell.ColumnIndex.ToString) = 4 Or Val(dgv_BobinDetails.CurrentCell.ColumnIndex.ToString) = 5 Or Val(dgv_BobinDetails.CurrentCell.ColumnIndex.ToString) = 6 Then
    ...
    Private Sub cbo_BorderName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BobinColour.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            With dgv_BobinDetails
                ...
                .Focus()
                .Rows(.CurrentCell.RowIndex).Cells.Item(2).Value = Trim(cbo_BobinColour.Text)
                .CurrentCell = .Rows(.CurrentCell.RowIndex).Cells(.CurrentCell.ColumnIndex + 1)
    ...
    Private Sub cbo_BorderSize_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BobinBorderSize.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            With dgv_BobinDetails
                ...
                .Focus()
                .Rows(.CurrentCell.RowIndex).Cells.Item(3).Value = Trim(cbo_BobinBorderSize.Text)
                .CurrentCell = .Rows(.CurrentCell.RowIndex).Cells(.CurrentCell.ColumnIndex + 1)
    ...
    Private Sub cbo_BorderSize_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_BobinBorderSize.TextChanged
        Try
            If cbo_BobinBorderSize.Visible Then
                With dgv_BobinDetails
                    If Val(cbo_BobinBorderSize.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 3 Then
    ...
    Private Sub cbo_Vechile_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VechileNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VechileNo, cbo_Transport, txt_Freight, "Weaver_BobinJari_Return_Head", "Vechile_No", "", "")
    ...
    Private Sub cbo_Vechile_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VechileNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VechileNo, txt_Freight, "Weaver_BobinJari_Return_Head", "Vechile_No", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Bobin_Jari_Return_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Bobin_Jari_Return_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Bobin_Jari_Return_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Trim(cbo_Filter_EndsName.Text) <> "" Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Weaver_BobinJari_Return_Head IN (select z1.Weaver_BobinJari_Return_Head from Weaver_BobinJari_Return_Bobin_Details z1 where z1.Ends = '" & Trim(cbo_Filter_EndsName.Text) & "')"
            End If

            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Weaver_BobinJari_Return_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Return_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Bobin_Jari_Return_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Bobin_Jari_Return_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Bobin_Jari_Return_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub btn_Print_Return_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Print_Delivery.Click
        Printing_Delivery()
    ...
    Public Sub Printing_Delivery()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Weaver_BobinJari_Return_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Weaver_BobinJari_Return_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5         ) " & _
                                        "select  b.EndscOUNT_Name , c.Colour_name , a.Bobins , ''  , a.Meters from Weaver_BobinJari_Return_Bobin_Details a INNER JOIN EndscOUNT_Head b ON a.EndscOUNT_idno = b.endscOUNT_idno INNER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into " & Trim(Common_Procedures.EntryTempTable) & "( Name1   , Name2          ,Name3     ,Name4          ,Name5         ) " & _
                                       "select  b.cOUNT_Name , c.Colour_name , a.Noof_Jumbos , a.Noof_Cones  , a.Weight  from Weaver_BobinJari_Return_Jari_Details a INNER JOIN cOUNT_Head b ON a.cOUNT_idno = b.cOUNT_idno INNER JOIN Colour_Head c ON a.Colour_idno = c.Colour_idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Bobin_Jari_Return_Code = '" & Trim(NewCode) & "' Order by a.Sl_No"
                nr = cmd.ExecuteNonQuery()

                da2 = New SqlClient.SqlDataAdapter("select a.Name1   , a.Name2  , a.Name3  , a.Name4  , a.Name5  from  " & Trim(Common_Procedures.EntryTempTable) & " a  Order by a.Name1", con)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Printing_Return_Format1(e)

    End Sub

    Private Sub Printing_Return_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim pFont As Font
        'Dim ps As Printing.PaperSize
        ...
        Try
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_Return_Format1_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClAr)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_Return_Format1_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, False)
                        ...
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Name2").ToString) <> 0 Then
                ...
                Printing_Return_Format1_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClAr, NoofDets, True)
    ...
    Private Sub Printing_Return_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        ...
        Common_Procedures.Print_To_PrintDocument(e, "BOBIN RETURN", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Bobin_Jari_Return_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Bobin_Jari_Return_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt + 10
