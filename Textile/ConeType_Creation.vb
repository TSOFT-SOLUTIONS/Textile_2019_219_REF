Public Class ConeType_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select a.* from Cone_Type_Head a where a.Cone_Type_IdNo = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Cone_Type_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("Cone_Type_Name").ToString
        End If
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Cone_Type_IdNo, Cone_Type_Name from Cone_Type_Head where Cone_Type_IdNo <> 0 order by Cone_Type_IdNo", con)
        Dim dt As New DataTable
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "CONETYPE NAME"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Cone_Type_IdNo) from Cone_Type_Head Where Cone_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Cone_Type_IdNo) from Cone_Type_Head Where Cone_Type_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and Cone_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        cbo_Open.DisplayMember = "Cone_Type_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Cone_Type_Head(Cone_Type_IdNo, Cone_Type_Name, sur_name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Cone_Type_Head set Cone_Type_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "' where Cone_Type_IdNo = " & Str(Val(lbl_IdNo.Text)) & ""
                cmd.ExecuteNonQuery()
        ...
        Catch ex As Exception
            ...
            If InStr(1, Trim(LCase(ex.Message)), "ix_Cone_Type_Head") > 0 Then
                MessageBox.Show("Duplicate Conetype Name", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Open_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Open.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Cone_Type_IdNo from Cone_Type_Head where Cone_Type_Name = '" & Trim(cbo_Open.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Open_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Open.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Open, Nothing, Nothing, "Cone_Type_Head", "Cone_Type_Name", "", "(Cone_Type_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Open_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Open.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Open, Nothing, "Cone_Type_Head", "Cone_Type_Name", "", "(Cone_Type_IdNo = 0)")
