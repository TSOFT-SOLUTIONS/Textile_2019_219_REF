Public Class Bobin_Purchase_GST
    ...
    Private Pk_Condition As String = "GBPUR-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_Billamount.Text = Common_Procedures.Currency_Format(Val(dt1.Rows(0).Item("Net_Amount").ToString))
            ...
            If IsNothing(dgv1) = False Then
                ...
                With dgv1
                    ...
                    If keyData = Keys.Enter Or keyData = Keys.Down Then
                        ...
                        ElseIf .CurrentCell.ColumnIndex = DgvCol_BobinDetails.Meters Then

                            If dgv_Details.Columns(DgvCol_BobinDetails.MeterReel).Visible Then
                                .CurrentCell = .Rows(.CurrentRow.Index).Cells(DgvCol_BobinDetails.MeterReel)
                            Else
                                .CurrentCell = .Rows(.CurrentRow.Index).Cells(DgvCol_BobinDetails.NofReel)
                            End If
                    ...
                    ElseIf keyData = Keys.Up Then
                        ...
                        If .CurrentCell.ColumnIndex <= 1 Then
                            ...
                            End If
                        ElseIf .CurrentCell.ColumnIndex = DgvCol_BobinDetails.NofReel Then

                            If dgv_Details.Columns(DgvCol_BobinDetails.MeterReel).Visible Then
                                .CurrentCell = .Rows(.CurrentRow.Index).Cells(DgvCol_BobinDetails.MeterReel)
                            Else
                                .CurrentCell = .Rows(.CurrentRow.Index).Cells(DgvCol_BobinDetails.Meters)
                            End If
                        Else
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Bobin_Purchase_Head", "Bobin_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Bobin_Purchase_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Bobin_Purchase_Details", "Bobin_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "EndsCount_Idno, Mill_IdNo, Colour_IdNo, Bobins, Bobin_Size_IdNo, Meter_Bobin, Meters, Meter_Reel, Reel, Rate, Amount", "Sl_No", "Bobin_Purchase_Code, For_OrderBy, Company_IdNo, Bobin_Purchase_No, Bobin_Purchase_Date, Ledger_Idno", trans)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Purchase_No from Bobin_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Bobin_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby, Bobin_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Purchase_No from Bobin_Purchase_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Bobin_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Bobin_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Bobin_Purchase_No from Bobin_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Bobin_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Bobin_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Purchase_Head", "Bobin_Purchase_Code", "For_OrderBy", "( Bobin_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' )", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Bobin_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  and Bobin_Purchase_Code LIKE '" & Trim(Pk_Condition) & "%' Order by for_Orderby desc, Bobin_Purchase_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Purchase_Head", "Bobin_Purchase_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(DgvCol_BobinDetails.Colour).Value) <> 0 Or Val(.Rows(i).Cells(DgvCol_BobinDetails.Meters).Value) <> 0 Or Val(.Rows(i).Cells(DgvCol_BobinDetails.NofReel).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Bobin_Purchase_Details(Bobin_Purchase_Code, Company_IdNo                     , Bobin_Purchase_No             , for_OrderBy                                                            , Bobin_Purchase_Date, Sl_No                , EndsCount_Idno       , Mill_IdNo           , Colour_IdNo         , Bobins                                                            , Bobin_Size_IdNo            , Meter_Bobin                                                      , Meters                                                        , Meter_Reel                                                      , Reel                                                                , Rate                                                        , Amount                                                              ) " & _
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Bobin_Purchase_Details", "Bobin_Purchase_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "EndsCount_Idno, Mill_IdNo, Colour_IdNo, Bobins, Bobin_Size_IdNo, Meter_Bobin, Meters, Meter_Reel, Reel, Rate, Amount", "Sl_No", "Bobin_Purchase_Code, For_OrderBy, Company_IdNo, Bobin_Purchase_No, Bobin_Purchase_Date, Ledger_Idno", tr)
            ...
            If Val(vTotBns) <> 0 Or Val(vTotMtrs) <> 0 Then
                ...
                "Values                                    ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @PurchaseDate, " & Str(Val(Delv_ID)) & ", 0                 , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "', 1     , 0          , " & Str(Val(vTotBns)) & ", 0               , 0          )"
                cmd.ExecuteNonQuery()
            End If
            ...
            If Val(CSng(txt_Billamount.Text)) <> 0 Then
                ...
                If Common_Procedures.Voucher_Updation(con, "Bobin.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), dtp_Date.Text, "Bill No : " & Trim(txt_BillNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Textile_Software) = False Then
                    Throw New ApplicationException(ErrMsg)
                End If
            End If
    ...
    Private Sub dgv_Details_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellValueChanged
        ...
        With dgv_Details
            ...
            If .Visible Then
                ...
                If e.ColumnIndex = DgvCol_BobinDetails.Ends Or e.ColumnIndex = DgvCol_BobinDetails.Rate Or e.ColumnIndex = DgvCol_BobinDetails.NoOfBobins Then

                    If Trim(UCase(cbo_rateFor.Text)) = "ENDS" Then
                        .Rows(e.RowIndex).Cells(DgvCol_BobinDetails.Amount).Value = Format(Val(.Rows(e.RowIndex).Cells(DgvCol_BobinDetails.Ends).Value) * Val(.Rows(e.RowIndex).Cells(DgvCol_BobinDetails.Rate).Value) * Val(.Rows(e.RowIndex).Cells(DgvCol_BobinDetails.NoOfBobins).Value), "############0.00")
                    End If
    ...
    Private Sub dgtxt_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_details.KeyPress
        With dgv_Details
            ...
            If Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = DgvCol_BobinDetails.NoOfBobins Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = DgvCol_BobinDetails.Meters Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = DgvCol_BobinDetails.MeterBobin Or Val(dgv_Details.CurrentCell.ColumnIndex.ToString) = DgvCol_BobinDetails.NofReel Then
    ...
    Private Sub Print_Selection()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Bobin_Purchase_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Val(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        ...
        Try
            ...
            Da1 = New SqlClient.SqlDataAdapter("SELECT BPH.*, CH.*, CSH.State_Name as Company_State_Name, LH.* , LSH.State_Name as Ledger_State_Name, LAH.Ledger_Name, LTH.Ledger_Name,LDH.Ledger_Name,CSH.State_Code as Company_State_Code,LSH.State_Code as Ledger_State_Code,LAH.Ledger_Name AS Agent_Name,LTH.Ledger_Name AS Transport_Name FROM Bobin_Purchase_Head BPH INNER JOIN Company_Head CH ON BPH.Company_IdNo = CH.Company_IdNo INNER JOIN Ledger_Head LH ON BPH.Ledger_IdNo = LH.Ledger_IdNo LEFT OUTER JOIN State_Head CSH ON CH.Company_State_IdNo = CSH.State_IdNo LEFT OUTER JOIN State_Head LSH ON LH.Ledger_State_IdNo = LSH.State_IdNo  LEFT OUTER JOIN Ledger_Head LAH ON BPH.Agent_IdNo = LAH.Ledger_IdNo LEFT OUTER JOIN Ledger_Head LTH ON BPH.Transport_idno = LTH.Ledger_IdNo LEFT OUTER JOIN Ledger_Head LDH ON BPH.DeliveryTo_Idno = LDH.Ledger_IdNo WHERE BPH.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and BPH.Bobin_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            Dt = New DataTable
            Da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                Da2 = New SqlClient.SqlDataAdapter("SELECT BPD.*,ECH.EndsCount_Name,CLH.Colour_Name,MH.Mill_Name,BSH.Bobin_Size_Name FROM BOBIN_PURCHASE_DETAILS BPD INNER JOIN EndsCount_Head ECH ON BPD.EndsCount_Idno = ECH.EndsCount_IdNo LEFT OUTER JOIN Colour_Head CLH ON BPD.COLOUR_IDNO = CLH.Colour_IdNo INNER JOIN Mill_Head MH ON BPD.Mill_IdNo = MH.Mill_IdNo LEFT OUTER JOIN Bobin_Size_Head BSH ON BPD.Bobin_Size_IdNo = BSH.Bobin_Size_IdNo WHERE BPD.Bobin_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' ORDER BY BPD.For_OrderBy,BPD.Bobin_Purchase_No", con)
                Dt = New DataTable
                Da2.Fill(prn_DetDt)
    ...
    Private Sub Printing_FormatGST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Bobin_Purchase_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Bobin_Purchase_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Party_Bill_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
            CurY = CurY + TxtHgt
    ...
    Private Sub Printing_FormatGST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If is_LastPage = True Then
                Common_Procedures.Print_To_PrintDocument(e, "" & Format(Val(prn_HdDt.Rows(0).Item("Access_Value").ToString), "##########0.00"), PageWidth - 10, CurY, 1, 0, pFont)
            End If
