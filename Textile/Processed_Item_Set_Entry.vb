Public Class Processed_Item_Set_Entry
    ...
    Private Pk_Condition As String = "FPSEN-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name , C.Rack_No As Rackno from Set_Head a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_IdNo Left Outer Join Rack_Head c On a.Rack_Idno = C.Rack_Idno  Where a.Set_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_RefNo.Text = dt1.Rows(0).Item("Set_No").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,b.Processed_Item_Name , c.Rack_No from Set_Details a INNER JOIN Processed_Item_Head b ON a.Processed_Item_IdNo = b.Processed_Item_Idno Left Outer Join Rack_Head c On a.Rack_Idno = C.Rack_Idno where a.Set_Code = '" & Trim(NewCode) & "' Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '  If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Set_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Set_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Set_Entry, New_Entry, Me, con, "Set_Head", "Set_Code", NewCode, "Set_Date", "(Set_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from Set_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()



            cmd.CommandText = "delete from Set_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Set_No from Set_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,Set_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Set_No from Set_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby,Set_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Set_No from Set_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,Set_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Set_No from Set_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc,Set_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Set_Head", "Set_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Set_No from Set_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.FP_Set_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Set_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Set_Entry, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Set_No from Set_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Set_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Set_Head", "Set_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Set_Head (Set_Code, Company_IdNo,Set_No, for_OrderBy,Set_Date,Processed_Item_Idno , Rack_Idno , Quantity , Meters , Total_Qty , Total_Mtr_Qty , Total_Meters) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @SetDate, " & Str(Val(Procit_ID)) & "," & Str(Val(Rack_ID)) & "," & Val(txt_Quantity.Text) & "," & Val(txt_Meters.Text) & ", " & Str(Val(vTotQty)) & ", " & Str(Val(vTotMtrQty)) & "," & Val(vTotMtrs) & ")"
                cmd.ExecuteNonQuery()
            Else
                cmd.CommandText = "Update Set_Head set Set_Date = @SetDate, Processed_Item_Idno = " & Val(Procit_ID) & ", Rack_Idno = " & Str(Val(Rack_ID)) & " , Quantity = " & Val(txt_Quantity.Text) & ", Meters = " & Val(txt_Meters.Text) & ",Total_Qty = " & (vTotQty) & " , Total_Mtr_Qty = " & Val(vTotMtrQty) & ", Total_Meters = " & Val(vTotMtrs) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Set_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Insert into Stock_Item_Processing_Details ( Reference_Code                          ,            Company_IdNo          ,            Reference_No      ,            For_OrderBy                                                       ,  Reference_Date     ,                   DeliveryTo_StockIdNo             ,  ReceivedFrom_StockIdNo      , Delivery_PartyIdNo               , Received_PartyIdNo              , Entry_ID           , Party_Bill_No       , Particulars            , SL_No   ,       Item_IdNo            , Rack_IdNo                      ,                      Quantity   ,      Meters                 ) " & _
                                                             " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'      , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @SetDate  ," & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & "       , 0                     ,              0                   ,         0                    ,'" & Trim(EntID) & "' , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',  -1    , " & Str(Val(Procit_ID)) & "  , " & Str(Val(Rack_ID)) & " ,  " & Str(Val(txt_Quantity.Text)) & "   , " & Val(txt_Meters.Text) & "       ) "
            cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Set_Details(Set_Code, Company_IdNo,Set_No, for_OrderBy, Set_Date,Sl_No,Processed_Item_Idno,Quantity,Meter_Qty,Meters,Rack_Idno) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @SetDate," & Str(Val(Sno)) & "," & Str(Val(Procit_ID)) & ", " & Val(.Rows(i).Cells(2).Value) & "," & Val(.Rows(i).Cells(3).Value) & ", " & Val(.Rows(i).Cells(4).Value) & ", " & Str(Val(Rack_ID)) & ")"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Processed_Item_Name , C.Rack_No AS Rackno from Set_Head a INNER JOIN Processed_Item_Head b on a.Processed_Item_IdNo = b.Processed_Item_IdNo LEFT OUTER JOIN Rack_Head C ON a.RacK_Idno = C.RacK_Idno where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Set_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Set_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Set_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Set_Date").ToString), "dd-MM-yyyy")
