Public Class Other_GST_Purchase
    ...
    Private Pk_Condition As String = "GTPUR-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName, c.Ledger_Name as PurchaseAcName from Other_GST_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.PurchaseAc_IdNo = c.Ledger_IdNo  where a.GST_Purchase_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("GST_Purchase_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("GST_Purchase_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*  from Other_GST_Purchase_Details a  where a.GST_Purchase_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Chess_Perc").ToString), "########0.00")
                            dgv_Details.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("CHESS_Amount").ToString), "########0.00")
                        Next i
    ...
    Private Sub Other_GST_Sales_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_Chess_Perc.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Chess_Perc.LostFocus, AddressOf ControlLostFocus
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Other_Purchase_Entry, New_Entry, Me, con, "Other_GST_Purchase_Head", "GST_Purchase_Code", NewCode, "GST_Purchase_Date", "(GST_Purchase_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from Other_GST_Purchase_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            trans.Commit()
            new_record()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 GST_Purchase_No from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "  and GST_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, GST_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 GST_Purchase_No from Other_GST_Purchase_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & "  and GST_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, GST_Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 GST_Purchase_No from Other_GST_Purchase_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & "  and GST_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, GST_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 GST_Purchase_No from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "  and GST_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, GST_Purchase_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Other_GST_Purchase_Head", "GST_Purchase_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_InvoiceNo.ForeColor = Color.Red

            da = New SqlClient.SqlDataAdapter("select top 1 a.*, b.ledger_name as PurchaseAcName  from Other_GST_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.PurchaseAc_IdNo = b.Ledger_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.GST_Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.GST_Purchase_No desc", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                If dt2.Rows(0).Item("PurchaseAcName").ToString <> "" Then cbo_PurchaseAc.Text = dt2.Rows(0).Item("PurchaseAcName").ToString
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select GST_Purchase_No from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Other_Purchase_Entry, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select GST_Purchase_No from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotIGSTAmt As Single = 0, vTotChessAmt As Single = 0
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Other_Purchase_Entry, New_Entry, Me, con, "Other_GST_Purchase_Head", "GST_Purchase_code", NewCode, "GST_Purchase_Date", "(GST_Purchase_code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, GST_Purchase_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        If Trim(txt_Electronic_RefNo.Text) <> "" Then
            NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
            da = New SqlClient.SqlDataAdapter("select * from Other_GST_Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_IdNo = " & Str(Val(led_id)) & " and  Reference_No = '" & Trim(txt_Electronic_RefNo.Text) & "' and GST_Purchase_code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and GST_Purchase_Code <> '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vTotChessAmt = Val(dgv_Details_Total.Rows(0).Cells(8).Value())
        End If
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Other_GST_Purchase_Head", "GST_Purchase_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Other_GST_Purchase_Head (  GST_Purchase_Code  , Company_IdNo        ,                GST_Purchase_No           ,       for_OrderBy    , GST_Purchase_Date,         Ledger_IdNo    ,           PurchaseAc_IdNo      ,                Entry_GST_Tax_Type    , Total_Taxable_Value          ,           Total_CGST_Amount     ,      Total_SGST_Amount       , Total_IGST_Amount             ,            AddLess_Amount       ,              Round_Off             ,             Net_Amount                     ,          Remarks            ,   Roundoff_Status        ,  Reference_No                         , Chess_AMount ) " & _
                                        " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", @PurchaseDate   ,  " & Str(Val(led_id)) & ",  " & Str(Val(PurAc_ID)) & ",   '" & Trim(cbo_TaxType.Text) & "' ,  " & Str(Val(vTotTaxAmt)) & ", " & Str(Val(vTotCGSTAmt)) & ",   " & Str(Val(vTotSGCSTAmt)) & ", " & Str(Val(vTotIGSTAmt)) & ", " & Str(Val(txt_AddLess.Text)) & ", " & Str(Val(lbl_RoundOff.Text)) & ",  " & Str(Val(CSng(lbl_NetAmount.Text))) & ", '" & Trim(txt_Remarks.Text) & "',  " & Val(RndOff_Sts) & " ,  '" & Trim(txt_Electronic_RefNo.Text) & "'," & Val(vTotChessAmt) & " )"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Other_GST_Purchase_Head set GST_Purchase_Date = @PurchaseDate,  Ledger_IdNo = " & Str(Val(led_id)) & ", PurchaseAc_IdNo = " & Str(Val(PurAc_ID)) & ", Entry_GST_Tax_Type = '" & Trim(cbo_TaxType.Text) & "',  Total_Taxable_Value = " & Str(Val(vTotTaxAmt)) & ", Total_CGST_Amount = " & Str(Val(vTotCGSTAmt)) & ",  Total_SGST_Amount = " & Str(Val(vTotSGCSTAmt)) & ", Total_IGST_Amount = " & Str(Val(vTotIGSTAmt)) & ",  AddLess_Amount = " & Str(Val(txt_AddLess.Text)) & ", Round_Off = " & Str(Val(lbl_RoundOff.Text)) & ", Net_Amount = " & Str(Val(CSng(lbl_NetAmount.Text))) & ", Remarks = '" & Trim(txt_Remarks.Text) & "',  Roundoff_Status =" & Val(RndOff_Sts) & "       ,  Reference_No = '" & Trim(txt_Electronic_RefNo.Text) & "',Chess_AMount = " & Val(vTotChessAmt) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and GST_Purchase_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Other_GST_Purchase_Details ( GST_Purchase_Code,             Company_IdNo         ,               GST_Purchase_No            ,           for_OrderBy      , GST_Purchase_Date,          Ledger_IdNo    ,        Sl_No         ,          GST_Perc                   ,                HSN_SAC_Code             ,                 Taxable_Value              ,              CGST_Amount                ,            SGST_Amount               ,             IGST_Amount                , Chess_Perc                            ,    Chess_AMount  ) " & _
                                                " Values ('" & Trim(NewCode) & "'             , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", @PurchaseDate         , " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & "," & Val(.Rows(i).Cells(1).Value) & " ,  '" & Trim(.Rows(i).Cells(2).Value) & "', " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & " , " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & " )"
                        cmd.ExecuteNonQuery()
                        ...
                        '                        " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ",    @PurchaseDate , " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(-1 * Val(.Rows(i).Cells(5).Value)) & " )"
                        'cmd.ExecuteNonQuery()
            ...
            vVou_Amts = Val(CSng(lbl_NetAmount.Text)) & "|" & -1 * (Val(CSng(lbl_NetAmount.Text)) - Val(vTotCGSTAmt) - Val(vTotSGCSTAmt) - Val(vTotIGSTAmt)) & "|" & -1 * Val(vTotCGSTAmt) & "|" & -1 * Val(vTotSGCSTAmt) & "|" & -1 * Val(vTotIGSTAmt)
            If Common_Procedures.Voucher_Updation(con, "GST.OthPurc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_InvoiceNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(lbl_InvoiceNo.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Textile_Software) = False Then
            ...
            '                  "   Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ",  'Sales',  @PurchaseDate ,   1  , " & Str(Val(Ac_id)) & ", " & Str(-1 * Val(CSng(lbl_NetAmount.Text))) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            'cmd.ExecuteNonQuery()

            'Amt = Val(CSng(lbl_NetAmount.Text)) - Val(lbl_TaxAmount.Text) - Val(txt_Freight.Text) - Val(txt_AddLess.Text) - Val(lbl_RoundOff.Text)

            'cmd.CommandText = "Insert into Voucher_Details (      Voucher_Code                  ,          For_OrderByCode   ,             Company_IdNo         ,           Voucher_No              ,           For_OrderBy      , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo       ,     Voucher_Amount   ,     Narration                                 ,             Year_For_Report                               ,           Entry_Identification               ) " & _
            '                  " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ",  'Sales',  @PurchaseDate ,   2  , " & Str(Val(saleac_id)) & ", " & Str(Val(Amt)) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            'cmd.ExecuteNonQuery()

            'If Val(lbl_TaxAmount.Text) <> 0 Then
            '    cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo     ,             Voucher_Amount          ,         Narration                             ,             Year_For_Report                               ,           Entry_Identification               ) " & _
            '                      " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales' ,   @PurchaseDate,   3  , " & Str(Val(txac_id)) & ", " & Str(Val(lbl_TaxAmount.Text)) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            '    cmd.ExecuteNonQuery()
            'End If
            ...
            '    L_ID = 9
            '    cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo  ,             Voucher_Amount        ,         Narration                             ,             Year_For_Report                               ,           Entry_Identification               ) " & _
            '                      " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales' ,   @PurchaseDate,   4  , " & Str(Val(L_ID)) & ", " & Str(Val(txt_Freight.Text)) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            '    cmd.ExecuteNonQuery()
            'End If
            ...
            '    L_ID = 17
            '    cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo  ,             Voucher_Amount        ,         Narration                             ,             Year_For_Report                               ,           Entry_Identification               ) " & _
            '                      " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales' ,   @PurchaseDate,   5  , " & Str(Val(L_ID)) & ", " & Str(Val(txt_AddLess.Text)) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            '    cmd.ExecuteNonQuery()
            'End If
            ...
            '    L_ID = 24
            '    cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo  ,             Voucher_Amount         ,         Narration                             ,             Year_For_Report                               ,           Entry_Identification               ) " & _
            '                      " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales' ,   @PurchaseDate,   6  , " & Str(Val(L_ID)) & ", " & Str(Val(lbl_RoundOff.Text)) & ", 'Bill No . : " & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            '    cmd.ExecuteNonQuery()
            'End If
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(7).Value = Format(Val(txt_Chess_Perc.Text), "########0.00")
                    .Rows(i).Cells(8).Value = Format(Val(lbl_Chess_AMt.Text), "########0.00")
                    MtchSTS = True
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(7).Value = Format(Val(txt_Chess_Perc.Text), "########0.00")
                .Rows(n).Cells(8).Value = Format(Val(lbl_Chess_AMt.Text), "########0.00")
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        txt_Chess_Perc.Text = Format(Val(.Rows(i).Cells(7).Value), "########0.00")
                        lbl_Chess_AMt.Text = Format(Val(.Rows(i).Cells(8).Value), "########0.00")
                        Exit For
    ...
    Private Sub txt_Chess_Perc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Chess_Perc.KeyDown
        If e.KeyCode = 40 Then btn_Add.Focus() ' SendKeys.Send("{TAB}")
        If e.KeyCode = 38 Then SendKeys.Send("+{TAB}")
    End Sub

    Private Sub txt_Chess_Perc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Chess_Perc.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.GST_Purchase_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = " a.GST_Purchase_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.GST_Purchase_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Itm_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.GST_Purchase_Code IN (select z.GST_Purchase_Code from Other_GST_Purchase_Details z where z.Item_IdNo = " & Str(Val(Itm_IdNo)) & ") "
            End If

            da = New SqlClient.SqlDataAdapter("select a.GST_Purchase_No, a.GST_Purchase_Date, a.Total_Qty, a.Net_Amount, b.Ledger_Name from Other_GST_Purchase_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.GST_Purchase_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.GST_Purchase_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("GST_Purchase_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("GST_Purchase_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            txt_Chess_Perc.Text = Format(Val(dgv_Details.CurrentRow.Cells(7).Value), "########0.00")
            lbl_Chess_AMt.Text = Format(Val(dgv_Details.CurrentRow.Cells(8).Value), "########0.00")
            '***** GST END *****
    ...
    Private Sub Amount_Calculation(ByVal GridAll_Row_STS As Boolean)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(1).Value) <> 0 Then
                        ...
                        End If
                        .Rows(i).Cells(8).Value = Format(Val(.Rows(i).Cells(3).Value) * Val(.Rows(i).Cells(7).Value) / 100, "#########0.00")
                    End If
                Next
        ...
        Else
            ...
            End If
            lbl_Chess_AMt.Text = Format(Val(txt_Taxable.Text) * Val(txt_Chess_Perc.Text) / 100, "############0.00")
            If Val(lbl_Chess_AMt.Text) = 0 Then lbl_Chess_AMt.Text = ""
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(3).Value) <> 0 Then
                ...
                TotChessAmt = TotChessAmt + Val(dgv_Details.Rows(i).Cells(8).Value)
            End If
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(8).Value = Format(Val(TotChessAmt), "########0.00")
    ...
    Private Sub NetAmount_Calculation()
        ...
        Dim TaxAmt As Single, CGSTAmt As Single, SGStAmt As Single, IGSTAmt As Single, ChessAmt As Single
        TaxAmt = 0
        CGSTAmt = 0
        SGStAmt = 0
        IGSTAmt = 0
        ...
        With dgv_Details_Total
            If dgv_Details_Total.Rows.Count > 0 Then
                ...
                ChessAmt = Format(Val(.Rows(0).Cells(8).Value), "###########0.00")
            End If
        End With

        NtAmt = Val(TaxAmt) + Val(CGSTAmt) + Val(SGStAmt) + Val(IGSTAmt) + Val(ChessAmt) + Val(txt_AddLess.Text)
        ...
        Try
            ...
            For i = 0 To dgv_Details.Rows.Count - 1
                ...
                If chk_Roundoff_Status.Checked = True Then
                    ...
                    If Val(lbl_IGstAmount.Text) = 0 Then lbl_IGstAmount.Text = ""
                    lbl_Chess_AMt.Text = Format(Val(txt_Taxable.Text) * Val(txt_Chess_Perc.Text) / 100, "############0")
                    If Val(lbl_Chess_AMt.Text) = 0 Then lbl_Chess_AMt.Text = ""
                    ...
                    dgv_Details.Rows(i).Cells(8).Value = Format(Val(dgv_Details.Rows(i).Cells(3).Value) * Val(dgv_Details.Rows(i).Cells(7).Value) / 100, "#########0")
                Else
                    ...
                    dgv_Details.Rows(i).Cells(8).Value = Format(Val(dgv_Details.Rows(i).Cells(3).Value) * Val(dgv_Details.Rows(i).Cells(7).Value) / 100, "#########0.00")
                    lbl_CGstAmount.Text = Format(Val(txt_Taxable.Text) * Val(CGst_Perc) / 100, "############0.00")
                    If Val(lbl_CGstAmount.Text) = 0 Then lbl_CGstAmount.Text = ""
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Other_Purchase_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo from Other_GST_Purchase_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.GST_Purchase_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            '***** GST START *****
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Other_GST_Purchase_Head a " & _
                                               ...
                                               "LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.GST_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)
            '***** GST END *****
            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, b.Item_Name_tamil, c.Unit_Name from Other_GST_Purchase_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.unit_idno = c.unit_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.GST_Purchase_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
...
LOOP1:
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.sl_no, b.Item_Name, c.Unit_Name, a.Noof_Items, a.Rate, a.Tax_Rate, a.Amount, a.Discount_Perc, a.Discount_Amount, a.Tax_Perc, a.Tax_Amount, a.Total_Amount from Other_GST_Purchase_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on b.unit_idno = c.unit_idno where a.GST_Purchase_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        dt2 = New DataTable
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("GST_Purchase_No").ToString, LMargin + Cen1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("GST_Purchase_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 30, CurY + 10, 0, 0, pFont)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer)
        ...
        Try
            ...
            CurY = TMargin + 205
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("GST_Purchase_No").ToString, LMargin + 500, CurY, 0, 0, p1Font)

            CurY = TMargin + 205
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("GST_Purchase_Date").ToString), "dd-MM-yyyy"), LMargin + 683, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format3_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer)
        ...
        Try
            ...
            p1Font = New Font("Calibri", 16, FontStyle.Bold)
            CurY = 115
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("GST_Purchase_No").ToString, 100, CurY, 0, 0, p1Font)

            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("GST_Purchase_Date").ToString), "dd-MM-yyyy"), 630, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format_Gst1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("GST_Purchase_No").ToString, LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("GST_Purchase_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, pFont)
    ...
    Private Function get_GST_Noof_HSN_Codes_For_Printing(ByVal EntryCode As String) As Integer
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Sales_GST_Tax_Details Where GST_Purchase_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Function get_GST_Tax_Percentage_For_Printing(ByVal EntryCode As String) As Single
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Sales_GST_Tax_Details Where GST_Purchase_Code = '" & Trim(Pk_Condition) & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    Private Sub cbo_SalesAc_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_PurchaseAc.GotFocus
    ...
    Private Sub cbo_SalesAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, cbo_Ledger, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_SalesAc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PurchaseAc.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PurchaseAc, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub txt_Chess_Perc_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Chess_Perc.TextChanged
        Call Amount_Calculation(False)
    End Sub
