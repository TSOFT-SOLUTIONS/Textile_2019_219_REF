Public Class Company_Selection
    ...
    Private Sub Company_Selection_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Common_Procedures.settings.CompanyWise_User_Rights = True And Common_Procedures.User.IdNo <> 1 Then

            If Len(Trim(CompCondt)) > 0 Then

                CompCondt = CompCondt + " and "

            End If

            CompCondt = CompCondt + " Company_IdNo in " &
                                        ...
                                        " And User_IdNo = " & Common_Procedures.User.IdNo & ")"
    ...
    Private Sub btn_OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_OK.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Company_IdNo from Company_Head where Company_ShortName = '" & Trim(cbo_Company.Text) & "'", con)
        dt1 = New DataTable
        da.Fill(dt1)
