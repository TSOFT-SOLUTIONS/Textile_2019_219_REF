...
Public Class Empty_Bobin_Receipt_Entry
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Empty_Bobin_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_ReceiptNo.Text = dt1.Rows(0).Item("Empty_Bobin_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Empty_Bobin_Receipt_Date").ToString
                ...
                cbo_BobinSize.Text = Common_Procedures.BobinSize_IdNoToName(con, Val(dt1.Rows(0).Item("Bobin_Size_IdNo").ToString))
    ...
    Private Sub Empty_BeamBagCone_Receipt_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Pk_Condition = "EBREC-"
            Label11.Text = "EMPTY BOBIN RECEIPT ENTRY"
        ...
        Da = New SqlClient.SqlDataAdapter("select vehicle_No from Empty_Bobin_Receipt_Head order by Vehicle_No", con)
        Da.Fill(dt3)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Empty_Bobin_Receipt, New_Entry, Me, con, "Empty_Bobin_Receipt_Head", "Empty_Bobin_Receipt_Code", NewCode, "Empty_Bobin_Receipt_Date", "(Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Empty_Bobin_Receipt_Head", "Empty_Bobin_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_ReceiptNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Empty_Bobin_Receipt_Code, Company_IdNo, for_OrderBy", tr)
        ...
        Try
            ...
            cmd.CommandText = "Delete from Empty_Bobin_Receipt_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Empty_Bobin_Receipt, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Empty_Bobin_Receipt_No from Empty_Bobin_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Empty_Bobin_Receipt_No from Empty_Bobin_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' Order by for_Orderby, Empty_Bobin_Receipt_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select top 1 Empty_Bobin_Receipt_No from Empty_Bobin_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' Order by for_Orderby desc, Empty_Bobin_Receipt_No desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Empty_Bobin_Receipt_No from Empty_Bobin_Receipt_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' Order by for_Orderby, Empty_Bobin_Receipt_No"
            dr = cmd.ExecuteReader
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select top 1 Empty_Bobin_Receipt_No from Empty_Bobin_Receipt_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' Order by for_Orderby desc,Empty_Bobin_Receipt_No desc"
            dr = cmd.ExecuteReader
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Empty_Bobin_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' ", con)
            da.Fill(dt)
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from Empty_Bobin_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code like '%/" & Trim(vEntFnYrCode) & "' Order by for_Orderby desc, Empty_Bobin_Receipt_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Empty_Bobin_Receipt_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Empty_Bobin_Receipt_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Empty_Bobin_Receipt, New_Entry, Me, con, "Empty_Bobin_Receipt_Head", "Empty_Bobin_Receipt_Code", NewCode, "Empty_Bobin_Receipt_Date", "(Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Empty_Bobin_Receipt_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Empty_Bobin_Receipt_Head(Empty_Bobin_Receipt_Code, Company_IdNo                      , Empty_Bobin_Receipt_No            , for_OrderBy                                                                 , Empty_Bobin_Receipt_Date, Ledger_IdNo        , Party_DcNo                         , Book_No                         , Empty_Bobin                      , Vehicle_No                         , Remarks                          , Bobin_Size_IdNo             ) " & _
                "Values                                                ('" & Trim(NewCode) & "' , " & Str(Val(lbl_Company.Tag)) & " , '" & Trim(lbl_ReceiptNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_ReceiptNo.Text))) & " , @ReceiptDate            , " & Val(led_id) & ", '" & Trim(txt_Party_DcNo.Text) & "', '" & Trim(txt_Book_No.Text) & "', " & Val(txt_EmptyBobin.Text) & " , '" & Trim(cbo_vehicleno.Text) & "' , '" & Trim(txt_remarks.Text) & "' , " & Str(Val(BbnSz_Id)) & "  )"
                cmd.ExecuteNonQuery()

            Else
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Empty_Bobin_Receipt_Head", "Empty_Bobin_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_ReceiptNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Empty_Bobin_Receipt_Code, Company_IdNo, for_OrderBy", tr)


                cmd.CommandText = "Update Empty_Bobin_Receipt_Head set Empty_Bobin_Receipt_Date = @ReceiptDate, Ledger_IdNo = " & Val(led_id) & ",Party_DcNo = '" & Trim(txt_Party_DcNo.Text) & "',Book_No = '" & Trim(txt_Book_No.Text) & "', Empty_Bobin =" & Val(txt_EmptyBobin.Text) & " , Vehicle_No = '" & Trim(cbo_vehicleno.Text) & "', Remarks = '" & Trim(txt_remarks.Text) & "' , Bobin_Size_IdNo = " & Str(Val(BbnSz_Id)) & "    Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Empty_Bobin_Receipt_Head", "Empty_Bobin_Receipt_Code", Val(lbl_Company.Tag), NewCode, lbl_ReceiptNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Empty_Bobin_Receipt_Code, Company_IdNo, for_OrderBy", tr)
            ...
            If Trim(UCase(vEntryType)) = "OPENING" Then
                Partcls = "Opening  : Rec.No. " & Trim(lbl_ReceiptNo.Text)
            Else
            ...
            If Trim(UCase(vEntryType)) = "OPENING" Then
                If Val(txt_EmptyBobin.Text) <> 0 Then
                    cmd.CommandText = "Insert into Stock_Empty_Bobin_Processing_Details(Reference_Code                 , Company_IdNo                     , Reference_No                      , for_OrderBy                                                                , Reference_Date , DeliveryTo_Idno                                                , ReceivedFrom_Idno       , Entry_ID             , Party_Bill_No            , Particulars    , Sl_No ,    Empty_Bobin  ) " &
                                                                 " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReceiptNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_ReceiptNo.Text))) & ", @ReceiptDate   , " & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & ", " & Str(Val(led_id)) & ", '" & Trim(EntID) & "'   , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "'  , 1                       ,  " & Str(Val(txt_EmptyBobin.Text)) & " )"
                    cmd.ExecuteNonQuery()
                End If

            Else
                If Val(txt_EmptyBobin.Text) <> 0 Then
                    cmd.CommandText = "Insert into Stock_Empty_Bobin_Processing_Details(Reference_Code          , Company_IdNo                     , Reference_No                      , for_OrderBy                                                                , Reference_Date , DeliveryTo_Idno                                           , ReceivedFrom_Idno       , Entry_ID              , Party_Bill_No        , Particulars             , Sl_No , Empty_Bobin                                , Bobin_Size_IdNo            ) " &
                    "Values                                                            ('" & Trim(NewCode) & "' , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReceiptNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_ReceiptNo.Text))) & ", @ReceiptDate   , " & Str(Val(Common_Procedures.CommonLedger.Godown_Ac)) & ", " & Str(Val(led_id)) & ", '" & Trim(EntID) & "' , '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "' , 1     , " & Str(-1 * Val(txt_EmptyBobin.Text)) & " , " & Str(Val(BbnSz_Id)) & " )"
                    cmd.ExecuteNonQuery()
                End If
            ...
            If Val(txt_EmptyBobin.Text) <> 0 Then
                cmd.CommandText = "Insert into Stock_Empty_BeamBagCone_Processing_Details (      Reference_Code  ,              Company_IdNo        ,                 Reference_No      ,        for_OrderBy    , Reference_Date, DeliveryTo_Idno ,    ReceivedFrom_Idno     ,        Entry_ID      ,     Party_Bill_No    ,          Particulars   , Sl_No, Empty_Cones,              Empty_Bobin             , EmptyBobin_Party, Empty_Jumbo ) " &
                                    " Values                                             ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReceiptNo.Text) & "', " & Str(vOrdByNo) & ", @ReceiptDate   ,        4        ,  " & Str(Val(led_id)) & ", '" & Trim(EntID) & "', '" & Trim(PBlNo) & "', '" & Trim(Partcls) & "',   1  ,      0     , " & Str(Val(txt_EmptyBobin.Text)) & ",     0           ,      0      )  "
                cmd.ExecuteNonQuery()
            End If
    ...
    Private Sub cbo_vehicleno_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_vehicleno.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Empty_Bobin_Receipt_Head", "Vehicle_No", "", "Vehicle_No")
    ...
    Private Sub cbo_vehicleno_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_vehicleno.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_vehicleno, txt_EmptyBobin, cbo_BobinSize, "Empty_Bobin_Receipt_Head", "Vehicle_No", "", "Vehicle_No")
    ...
    Private Sub cbo_vehicleno_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_vehicleno.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_vehicleno, cbo_BobinSize, "Empty_Bobin_Receipt_Head", "Vehicle_No", "", "", False)
    ...
    Private Sub btn_filtershow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_filtershow.Click
        ...
        Try
            ...
            If IsDate(dtp_FilterFrom_date.Value) = True And IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a.Empty_Bobin_Receipt_Date between '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterFrom_date.Value) = True Then
                Condt = "a.Empty_Bobin_Receipt_Date = '" & Trim(Format(dtp_FilterFrom_date.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_FilterTo_date.Value) = True Then
                Condt = "a. Empty_Bobin_Receipt_Date= '" & Trim(Format(dtp_FilterTo_date.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Empty_Bobin_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Empty_Bobin_Receipt_Code LIKE '%/" & Trim(vEntFnYrCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Empty_Bobin_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_filter.Rows(n).Cells(0).Value = " " & dt2.Rows(i).Item("Empty_Bobin_Receipt_No").ToString
                    dgv_filter.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Empty_Bobin_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Empty_Bobin_Receipt, New_Entry) = False Then Exit Sub

        ' NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_ReceiptNo.Text) & "/" & Trim(vEntFnYrCode)
        NewCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_ReceiptNo.Text) & "/" & Trim(vEntFnYrCode)
        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Empty_Bobin_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Empty_Bobin_Receipt_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Empty_Bobin_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(prn_HdDt)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "EMPTY BOBIN RECEIPT", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Empty_Bobin_Receipt_No").ToString), LMargin + C1 + W1 + 25, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Empty_Bobin_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + C1 + W1 + 25, CurY, 0, 0, pFont)
        ...
        'Common_Procedures.Print_To_PrintDocument(e, "BEAM WIDTH", LMargin + 100 + ClArr(1), CurY, 0, 0, pFont)
