Public Class Transport_Creation
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Transport_Creation, "~L~") = 0 And InStr(Common_Procedures.UR.Transport_Creation, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Transport_Creation, New_Entry) = False Then Exit Sub
