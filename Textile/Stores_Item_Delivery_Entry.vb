Public Class Stores_Item_Delivery_Entry
    ...
    Private Pk_Condition As String = "ITMDC-"
    Private Pk_Condition1 As String = "ITDAT-"
    ...
    Private Sub clear()
        ...
        cbo_Received.Enabled = True
        cbo_Received.BackColor = Color.White

        cbo_Issued.Enabled = True
        cbo_Issued.BackColor = Color.White

        cbo_Grid_Department.Enabled = True
        cbo_Grid_Department.BackColor = Color.White

        cbo_Grid_Brand.Enabled = True
        cbo_Grid_Brand.BackColor = Color.White

        cbo_Grid_Item.Enabled = True
        cbo_Grid_Item.BackColor = Color.White
    ...
    Private Sub Item_Delivery_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Item_Delivery_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub
    ...
    Private Sub Item_Delivery_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Item_Delivery_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim da As New SqlClient.SqlDataAdapter
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Issued_Name) from Stores_Item_Delivery_Head order by Issued_Name", con)
        da.Fill(dt6)
        cbo_Issued.DataSource = dt6
        cbo_Issued.DisplayMember = "Issued_Name"

        da = New SqlClient.SqlDataAdapter("select distinct(Received_Name) from Stores_Item_Delivery_Head order by Received_Name ", con)
        da.Fill(dt7)
        ...
        cbo_Type.Items.Add("RETURNABLE")
        cbo_Type.Items.Add("NON-RETURNABLE")
        ...
        AddHandler txt_Work_OrderNo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Work_OrderNo.LostFocus, AddressOf ControlLostFocus
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_DisplayName from Stores_Item_Delivery_Head a INNER JOIN Ledger_AlaisHead b ON a.Ledger_IdNo = b.Ledger_IdNo Where a.Item_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Item_Delivery_No").ToString
                dtp_date.Text = dt1.Rows(0).Item("Item_Delivery_Date").ToString
                cbo_Ledger.Text = dt1.Rows(0).Item("Ledger_DisplayName").ToString
                cbo_Type.Text = dt1.Rows(0).Item("Type").ToString
                ...
                txt_Work_OrderNo.Text = dt1.Rows(0).Item("Work_OrderNo").ToString
                txt_styleno.Text = dt1.Rows(0).Item("Style_no").ToString

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, b.Drawing_No, c.Department_name,  f.Brand_Name from Stores_Item_Delivery_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Department_Head c ON b.Department_idno = c.Department_idno  LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Item_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(6).Value = Common_Procedures.Unit_IdNoToName(con, Val(dt2.Rows(0).Item("Unit_IdNo").ToString))
                        dgv_Details.Rows(n).Cells(7).Value = dt2.Rows(i).Item("Item_Delivery_Details_SlNo").ToString
                        dgv_Details.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Receipt_Quantity").ToString


                        If Trim(dgv_Details.Rows(n).Cells(8).Value) <> 0 Then
            ...
            If LockSTS = True Then
                ...
                'cbo_Received.Enabled = False
                'cbo_Received.BackColor = Color.LightGray

                'cbo_Issued.Enabled = False
                'cbo_Issued.BackColor = Color.LightGray

                cbo_Grid_Department.Enabled = False
                cbo_Grid_Department.BackColor = Color.LightGray

                cbo_Grid_Brand.Enabled = False
                cbo_Grid_Brand.BackColor = Color.LightGray

                cbo_Grid_Item.Enabled = False
                cbo_Grid_Item.BackColor = Color.LightGray
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Delivery, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Delivery, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Store_Item_Delivery_Entry, New_Entry, Me, con, "Stores_Item_Delivery_Head", "Item_Delivery_Code", NewCode, "Item_Delivery_Date", "(Item_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Receipt_Quantity) from Stores_Item_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
                If Val(Dt1.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already Some Item Delivered for this Entry", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Stores_Item_Delivery_Head", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Item_Delivery_Code, Company_IdNo, for_OrderBy", trans)

        Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Stores_Item_Delivery_Details", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo", "Sl_No", "Item_Delivery_Code, For_OrderBy, Company_IdNo, Item_Delivery_No, Item_Delivery_Date, Ledger_Idno", trans)
        ...
        Try
            ...
            cmd.CommandText = "Delete from Stores_Item_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Stores_Item_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Store_Item_Delivery_Entry, New_Entry, Me) = False Then Exit Sub

            ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Entry_Stores_Item_Delivery, "~L~") = 0 And InStr(Common_Procedures.UR.Entry_Stores_Item_Delivery, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub

            inpno = InputBox("Enter New Dc.No.", "FOR NEW NO INSERTION...")

            RefCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("select Item_Delivery_No from Stores_Item_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Delivery_No from Stores_Item_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Delivery_No from Stores_Item_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Item_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Delivery_No from Stores_Item_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Item_Delivery_No from Stores_Item_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Item_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Delivery_Head", "Item_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Entry_Stores_Item_Delivery, New_Entry) = False Then Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Store_Item_Delivery_Entry, New_Entry, Me, con, "Stores_Item_Delivery_Head", "Item_Delivery_Code", NewCode, "Item_Delivery_Date", "(Item_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Item_Delivery_No desc", dtp_date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Stores_Item_Delivery_Head", "Item_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Stores_Item_Delivery_Head(Item_Delivery_Code, Company_IdNo, Item_Delivery_No, for_OrderBy, Item_Delivery_Date, Ledger_IdNo,Type , Received_Name, Issued_Name, New_Old, Vehicle_No, Total_Quantity,     Remarks           ,  Freight                     ,Transport_Idno, Work_OrderNo, Style_no) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DcDate, " & Str(Val(Led_ID)) & ", '" & Trim(cbo_Type.Text) & "' ,'" & Trim(cbo_Received.Text) & "', '" & Trim(cbo_Issued.Text) & "','" & Trim(cbo_New_Old.Text) & "', '" & Trim(txt_Vehicle.Text) & "', " & Str(Val(vTotqty)) & ",'" & Trim(txt_Remarks.Text) & "'," & Val(txt_Transport_Freight.Text) & " , " & Val(Trans_ID) & " , '" & Trim(txt_Work_OrderNo.Text) & "', '" & Trim(txt_styleno.Text) & "')"
                cmd.ExecuteNonQuery()

            Else

                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Stores_Item_Delivery_Head", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Delivery_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Stores_Item_Delivery_Details", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo", "Sl_No", "Item_Delivery_Code, For_OrderBy, Company_IdNo, Item_Delivery_No, Item_Delivery_Date, Ledger_Idno", tr)

                cmd.CommandText = "Update Stores_Item_Delivery_Head set Issued_Name = '" & Trim(cbo_Issued.Text) & "', Item_Delivery_Date = @DcDate ,Ledger_IdNo = " & Str(Val(Led_ID)) & " ,Type = '" & Trim(cbo_Type.Text) & "', Received_Name = '" & Trim(cbo_Received.Text) & "', New_Old = '" & Trim(cbo_New_Old.Text) & "'  , Vehicle_No = '" & Trim(txt_Vehicle.Text) & "' , Total_Quantity = " & Str(Val(vTotqty)) & ",Remarks = '" & Trim(txt_Remarks.Text) & "',Freight = " & Val(txt_Transport_Freight.Text) & ", Transport_Idno= " & Val(Trans_ID) & " , Work_OrderNo ='" & Trim(txt_Work_OrderNo.Text) & "' , Style_no =  '" & Trim(txt_styleno.Text) & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            End If
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Stores_Item_Delivery_Head", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Item_Delivery_Code, Company_IdNo, for_OrderBy", tr)
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Stores_Item_Delivery_Details ( Item_Delivery_Code, Company_IdNo, Item_Delivery_No, for_OrderBy, Item_Delivery_Date,Ledger_idNo , Sl_No, Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DcDate, " & Val(Led_ID) & " ," & Str(Val(Sno)) & ", " & Str(Val(Item_ID)) & ", " & Str(Val(Brand_ID)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(Unit_ID)) & "  )"
                        cmd.ExecuteNonQuery()
                ...
                Next
                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "NEW", "Stores_Item_Delivery_Details", "Item_Delivery_Code", Val(lbl_Company.Tag), NewCode, lbl_DcNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Item_IdNo, Brand_IdNo, Quantity, Unit_IdNo", "Sl_No", "Item_Delivery_Code, For_OrderBy, Company_IdNo, Item_Delivery_No, Item_Delivery_Date, Ledger_Idno", tr)
            ...
            If Common_Procedures.Voucher_Updation(con, "ItemDc.Frgt", Val(lbl_Company.Tag), Trim(Pk_Condition1) & Trim(NewCode), Trim(lbl_DcNo.Text), Convert.ToDateTime(dtp_date.Text), Trim(txt_Remarks.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub cbo_Grid_Department_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Department.KeyDown
        ...
        With dgv_Details
            ...
            If (e.KeyValue = 38 And cbo_Grid_Department.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
                ...
                Else
                    .Focus()
                    .CurrentCell = dgv_Details.Rows(dgv_Details.CurrentRow.Index - 1).Cells(.ColumnCount - 4)
    ...
    Private Sub cbo_Received_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Received.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Received, cbo_Ledger, cbo_Issued, "Stores_Item_Delivery_Head", "Received_name", "", "")
    ...
    Private Sub cbo_Received_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Received.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Received, cbo_Issued, "Stores_Item_Delivery_Head", "Received_Name", "", "", False)
    End Sub
    ...
    Private Sub dgv_Details_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEnter
        ...
        With dgv_Details
            ...
            If e.ColumnIndex = 3 And (Val(.Rows(.CurrentCell.RowIndex).Cells(8).Value)) = 0 Then
    ...
    Private Sub dgtxt_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dgtxt_Details.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            With dgv_Details
                If Trim(.Rows(.CurrentRow.Index).Cells(5).Value) = "" And .CurrentRow.Index = .Rows.Count - 1 Then
    ...
    Private Sub cbo_Issued_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Issued.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Issued, cbo_Received, cbo_New_Old, "Stores_Item_Delivery_Head", "Issued_Name", "", "")
    ...
    Private Sub cbo_Issued_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Issued.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Issued, cbo_New_Old, "Stores_Item_Delivery_Head", "Issued_Name", "", "", False)
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Delivery_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Item_Delivery_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Item_Delivery_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.quantity, c.item_name, d.unit_name  from Stores_Item_Delivery_Head a left outer join Stores_Item_Delivery_Details b on a.Item_Delivery_Code = b.Item_Delivery_Code left outer join Stores_Item_Head c on b.item_idno = c.item_idno left outer join unit_head d on b.unit_idno = d.unit_idno  where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Item_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by Item_Delivery_Date, for_orderby, Item_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Item_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Item_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Store_Item_Delivery_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Stores_Item_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Item_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Stores_Item_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Delivery_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, f.Brand_Name from Stores_Item_Delivery_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Delivery_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = Val(35) : ClAr(2) = 320 : ClAr(3) = 120 : ClAr(4) = 110
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Unit_Name1").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, d.Unit_name, f.Brand_Name from Stores_Item_Delivery_Details a INNER JOIN Stores_Item_Head b ON a.Item_idno = b.Item_idno LEFT OUTER JOIN Unit_Head d ON a.Unit_idno = d.Unit_idno LEFT OUTER JOIN Brand_Head f ON a.Brand_idno = f.Brand_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Item_Delivery_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "ITEM DELIVERY", LMargin, CurY, 2, PrintWidth, p1Font)
        CurY = CurY + TxtHgt
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Item_Delivery_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Item_Delivery_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        W1 = e.Graphics.MeasureString("Through Vehicle No :", pFont).Width
        W2 = ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 30
        ...
        'If Val(prn_HdDt.Rows(0).Item("Vehicle_No").ToString) <> 0 Then
        Common_Procedures.Print_To_PrintDocument(e, "Through Vehicle No : ", LMargin + 20, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Vehicle_No").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
        'End If

        If Val(prn_HdDt.Rows(0).Item("Work_OrderNo").ToString) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "Work Order No : ", LMargin + W2, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Work_OrderNo").ToString, LMargin + W2 + 25, CurY, 0, 0, pFont)
        End If

        'If Val(prn_HdDt.Rows(0).Item("remarks").ToString) <> 0 Then
        CurY = CurY + TxtHgt
    ...
    Private Sub Printing_Format2(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = Val(35) : ClAr(2) = 220 : ClAr(3) = 110 : ClAr(4) = 80
            ClAr(5) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4))
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        ItmNm1 = "M/s." & prn_HdDt.Rows(0).Item("Ledger_MainName").ToString
        ItmNm2 = ""
        ...
        Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1).ToString, LMargin + S1 + 30, CurY, 0, 0, p1Font)
        If Trim(ItmNm2) <> "" Then
            CurY = CurY + TxtHgt
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        W1 = e.Graphics.MeasureString("Through Vehicle No :", pFont).Width
        W2 = ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4)
        ...
        If Val(prn_HdDt.Rows(0).Item("Work_OrderNo").ToString) <> 0 Then
            Common_Procedures.Print_To_PrintDocument(e, "Work Order No : ", LMargin + W2, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Work_OrderNo").ToString, LMargin + W2 + 15, CurY, 0, 0, pFont)
        End If
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("remarks").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
        ' End If
        'If Val(prn_HdDt.Rows(0).Item("Style_no").ToString) <> 0 Then
        Common_Procedures.Print_To_PrintDocument(e, "Style No : ", LMargin + W2 - 30, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Style_no").ToString, LMargin + W2 - 20, CurY, 0, 0, pFont)
        ' End If
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, cbo_Type, cbo_Received, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, cbo_Received, "Ledger_AlaisHead", "Ledger_DisplayName", " (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14)", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub txt_Vehicle_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Vehicle.KeyDown
    ...
    Private Sub txt_Vehicle_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Vehicle.KeyPress
        If Asc(e.KeyChar) = 13 Then
            'dgv_Details.Focus()
            'dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(1)
            txt_styleno.Focus()
    ...
    Private Sub cbo_New_Old_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_New_Old.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_New_Old, cbo_Issued, txt_Vehicle, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_New_Old_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_New_Old.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_New_Old, txt_Vehicle, "", "", "", "")
    End Sub
    ...
    Private Sub txt_Work_Order_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Work_OrderNo.KeyDown
        If e.KeyCode = 38 Then
            txt_styleno.Focus()
        End If
    ...
    Private Sub txt_Work_Order_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Work_OrderNo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            dgv_Details.Focus()
            dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(1)
        End If
    ...
    Private Sub txt_styleno_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_styleno.KeyDown
        If e.KeyCode = 38 Then
            txt_Vehicle.Focus()
        End If
        If e.KeyCode = 40 Then
            txt_Work_OrderNo.Focus()
        End If
    End Sub

    Private Sub txt_styleno_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_styleno.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Work_OrderNo.Focus()
        End If
    End Sub
