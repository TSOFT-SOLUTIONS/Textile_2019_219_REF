Public Class Cotton_Waste_Purchase_Entry
    ...
    Private Pk_Condition As String = "COWPE-"
    Private Pk_Condition2 As String = "COWPG-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Cotton_Waste_Production_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Cotton_Waste_Production_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Cotton_Waste_Production_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Cotton_Waste_Production_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*  from Cotton_Waste_Production_Details a  Where a.Cotton_Waste_Production_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            '.Rows(n).Cells(4).Value = Trim(dt2.Rows(i).Item("Bale_Nos").ToString)
                            '.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Gross_Weight").ToString), "########0.000")
                            '.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Tare_Weight").ToString), "##########0.000")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Cotton_Waste_Production_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Cotton_Waste_Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Waste_Production_No from Cotton_Waste_Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%'  and Cotton_Waste_Production_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Cotton_Waste_Production_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Waste_Production_No from Cotton_Waste_Production_Head where for_orderby > " & Str(Val(OrdByNo)) & " and Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%'  and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Cotton_Waste_Production_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Cotton_Waste_Production_No from Cotton_Waste_Production_Head where for_orderby < " & Str(Val(OrdByNo)) & " and Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%'  and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Cotton_Waste_Production_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Cotton_Waste_Production_Head", "Cotton_Waste_Production_Code", "For_OrderBy", " Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%' ", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Cotton_Waste_Production_No from Cotton_Waste_Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%' and  Cotton_Waste_Production_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Cotton_Waste_Production_No from Cotton_Waste_Production_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%'  and Cotton_Waste_Production_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If dgv_Details_Total.RowCount > 0 Then
            'vTotBale = Val(dgv_Details_Total.Rows(0).Cells(3).Value())
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Cotton_Waste_Production_Head", "Cotton_Waste_Production_Code", "For_OrderBy", "Cotton_Waste_Production_Code like '" & Trim(Pk_Condition) & "%' ", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Cotton_Waste_Production_Head (       Cotton_Waste_Production_Code  ,               Company_IdNo       ,           Cotton_Waste_Production_No  ,                               for_OrderBy                          , Cotton_Waste_Production_Date    ,       Total_Weight      ) " & _
                                    "     Values                  (   '" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "'    , " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",           @CotnDate             ,   " & Val(vTotWght) & "   ) "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Cotton_Waste_Production_Head set Cotton_Waste_Production_Date = @CotnDate,  Total_Weight = " & Str(Val(vTotWght)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Waste_Production_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            Partcls = "Mix : Lot No. " & Trim(lbl_RefNo.Text)
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(2).Value) <> 0 Then
                        ...
                        'If Nr = 0 Then
                        cmd.CommandText = "Insert into Cotton_Waste_Production_Details ( Cotton_Waste_Production_Code          ,   Company_IdNo                   ,   Cotton_Waste_Production_No  ,  for_OrderBy                                                           ,        Cotton_Waste_Production_Date,           Sl_No       ,     Variety_idNo         , Weight                                  ) " & _
                                            "     Values                 (   '" & Trim(Pk_Condition) & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",       @CotnDate                    ,  " & Str(Val(Sno)) & ", " & Str(Val(Vrty_ID)) & "," & Str(Val(.Rows(i).Cells(2).Value)) & " ) "
                        cmd.ExecuteNonQuery()
                        ' End If



                        cmd.CommandText = "Insert into Stock_Waste_Processing_Details ( Reference_Code           ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy                              ,        Reference_Date,   Entry_ID               ,  ledger_Idno ,    Sl_No      ,      Variety_IdNo     ,           Weight  ) " & _
                                                        "    Values  ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ",    @CotnDate         ,  '" & Trim(Partcls) & "' ," & Val(Led_ID) & "," & Val(Sno) & "," & Str(Val(Vrty_ID)) & ",  " & Str(Val(.Rows(i).Cells(2).Value)) & " )"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_PurchaseAc_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With dgv_Details
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" And Val(.Rows(i).Cells(2).Value) <> 0 Then
                    TotWgt = TotWgt + Format(Val(.Rows(i).Cells(2).Value), "########0.000")
                End If
    ...
    Private Sub dgv_Details_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_Details.RowsAdded
        ...
        With dgv_Details
            ...
            If Val(.Rows(e.RowIndex).Cells(2).Value) = 0 Then
                'If e.RowIndex = 0 Then
                '    .Rows(e.RowIndex).Cells(2).Value = 1
                'Else
                '    .Rows(e.RowIndex).Cells(2).Value = Val(.Rows(e.RowIndex - 1).Cells(2).Value) + 1
                'End If
            End If
        End With
    End Sub
    ...
    'Private Sub txt_AddLess_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub txt_BillKg_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    'Private Sub txt_BillKg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    '    Commission_Calculation()
    'End Sub

    'Private Sub txt_BillKg_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    '    If Val(txt_Freight.Text) <> 0 Then
    ...
    'Private Sub txt_BillKg_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Total_Calculation()
    'End Sub
    ...
    '                TotActValue = TotActValue + Val(.Rows(i).Cells(5).Value)
    ...
    '        .Rows(0).Cells(5).Value = Format(Val(TotActValue), "########0.000")
    ...
    'End Sub
    Private Sub btn_Tax_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        pnl_Back.Enabled = False
    ...
    '    If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1176" Then '---- SOMANUR KALPANA COTTON (INDIA) PVT LTD (KANIYUR)  --SPINNING MILL
    '        NtAmt = Val(GrsAmt) + Val(GST_Amt) + Val(txt_AddLess.Text)
    '    Else
    '        NtAmt = Val(GrsAmt) + Val(GST_Amt) + Val(txt_Freight.Text)
    '    End If
    ...
    'Private Sub cbo_Agent_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    'Private Sub cbo_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    vcbo_KeyDwnVal = e.KeyValue
    ...
    'Private Sub cbo_Agent_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    'Private Sub cbo_Agent_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    'Private Sub cbo_SalesAc_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    '        Common_Procedures.MDI_LedType = ""
    '        Dim f As New Ledger_Creation
    ...
    Private Sub txt_CommKg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub
    ...
    'Private Sub txt_CommRate_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Commission_Calculation()
    'End Sub


    'Private Sub lbl_NetAmount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    lbl_AmountInWords.Text = "Rupees  :  "
    ...
    Private Sub cbo_Filter_VarietyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Filter_VarietyName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Filter_VarietyName, cbo_Filter_PartyName, cbo_Filter_AgentName, "Variety_Head", "Variety_Name", "(variety_type='WASTE')", "(Variety_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Filter_VarietyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_VarietyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_VarietyName, cbo_Filter_AgentName, "Variety_Head", "Variety_Name", "(variety_type='WASTE')", "(Variety_IdNo = 0)")
    End Sub
    ...
    'Private Sub txt_BillNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub txt_BillNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    '                        .Rows(n).Cells(3).Value = Val(dgv_Direct_BaleDetails.Rows(I).Cells(3).Value)
            ...
            With dgv_Direct_BaleDetails
                ...
                For i = 0 To dgv_BaleDetails.RowCount - 1
                    If Det_SLNo = Val(dgv_BaleDetails.Rows(i).Cells(0).Value) Then
                        ...
                        .Rows(n).Cells(3).Value = Val(dgv_BaleDetails.Rows(i).Cells(3).Value)
    ...
    'Private Sub cbo_PartyName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Total_Calculation()
    'End Sub
