Public Class Motion_Type_Creation
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Motion_Type_Head where Motion_Type_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Motion_Type_IdNo ,Motion_Type_Name from Motion_Type_Head where Motion_Type_IdNo <> 0 order by Motion_Type_IdNo", con)
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select * from Motion_Type_Head a where Motion_Type_IdNo = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Motion_Type_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("Motion_Type_Name").ToString
            'txt_Sqft.Text = Val(dt.Rows(0).Item("Total_Sqft").ToString)0
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Motion_Type_IdNo) from Motion_Type_Head Where Motion_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Motion_Type_IdNo) from Motion_Type_Head Where Motion_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Motion_Type_IdNo) from Motion_Type_Head Where Motion_Type_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and Motion_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Motion_Type_IdNo) from Motion_Type_Head Where Motion_Type_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and Motion_Type_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Motion_Type_Head", "Motion_Type_IdNo", "")
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Motion_Type_Name from Motion_Type_Head order by Motion_Type_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Find.DataSource = dt
        cbo_Find.DisplayMember = "Motion_Type_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Motion_Type_Head", "Motion_Type_IdNo", "", trans)

                cmd.CommandText = "Insert into Motion_Type_Head(Motion_Type_IdNo, Motion_Type_Name , Sur_Name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "',  '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Motion_Type_Head set Motion_Type_Name = '" & Trim(txt_Name.Text) & "', Sur_Name = '" & Trim(Sur) & "' where Motion_Type_IdNo = " & Str(Val(lbl_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "MOTION"
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), "ix_Motion_Type_Head") > 0 Then
    ...
    Private Sub btn_FindOpen_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_FindOpen.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Motion_Type_IdNo from Motion_Type_Head where Motion_Type_Name = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Find_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Find.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Find, Nothing, Nothing, "Motion_Type_Head", "Motion_Type_Name", "", "")
    End Sub
    ...
    Private Sub cbo_Find_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Find.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Find, Nothing, "Motion_Type_Head", "Motion_Type_Name", "", "")
        If Asc(e.KeyChar) = 13 Then
            btn_FindOpen_Click(sender, e)
        End If
    End Sub
