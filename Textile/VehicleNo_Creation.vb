Public Class VehicleNo_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Vehicle_IdNo, Vehicle_No,Type from Vehicle_Head where Vehicle_IdNo = " & Str(Val(idno))

            dr = cmd.ExecuteReader

            If dr.HasRows Then
                If dr.Read() Then
                    txt_IdNo.Text = dr("Vehicle_IdNo").ToString()
                    txt_Name.Text = dr("Vehicle_No").ToString()
                    '  Cbo_Type.Text = dr("Type").ToString()
                End If
            End If
    ...
    Private Sub Area_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Cbo_Type.Items.Add("")
        'Cbo_Type.Items.Add("OWN")
        'Cbo_Type.Items.Add("PARTYSELF")
        ...
        AddHandler cbo_Find.KeyDown, AddressOf TextBoxControlKeyDown
        '   AddHandler Cbo_Type.KeyDown, AddressOf TextBoxControlKeyDown


        'AddHandler txt_Name.KeyPress, AddressOf TextBoxControlKeyPress
        ' AddHandler Cbo_Type.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler cbo_Find.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.VehicleNo_Creation, "~L~") = 0 And InStr(Common_Procedures.UR.VehicleNo_Creation, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error) : Exit Sub


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.VehicleNo_Creation, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            'da = New SqlClient.SqlDataAdapter("select count(*) from item_head where Vehicle_IdNo = " & Str(Val(txt_IdNo.Text)), con)
            'dt = New DataTable
            'da.Fill(dt)
            ...
            'da = New SqlClient.SqlDataAdapter("select count(*) from Sales_Details where Vehicle_IdNo = " & Str(Val(txt_IdNo.Text)), con)
            'dt = New DataTable
            'da.Fill(dt)
            'If dt.Rows.Count > 0 Then
            '    If IsDBNull(dt.Rows(0)(0).ToString) = False Then
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Vehicle_Head where Vehicle_IdNo = " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Vehicle_IdNo, Vehicle_No from Vehicle_Head where Vehicle_IdNo <> 0 order by Vehicle_IdNo", con)
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "DRIVER NAME"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Vehicle_IdNo) from Vehicle_Head Where Vehicle_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select max(Vehicle_IdNo) from Vehicle_Head WHERE Vehicle_IdNo <> 0"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select min(Vehicle_IdNo) from Vehicle_Head where Vehicle_IdNo > " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Vehicle_IdNo) from Vehicle_Head where Vehicle_IdNo < " & Str(Val(txt_IdNo.Text)) & " and Vehicle_IdNo <> 0 ", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Vehicle_Head", "Vehicle_IdNo", "")

        'cmd.Connection = con
        'cmd.CommandText = "select max(Vehicle_IdNo) from Vehicle_Head"
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Vehicle_No from Vehicle_Head order by Vehicle_No", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Find.DataSource = dt
        cbo_Find.DisplayMember = "Vehicle_No"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.userright_check(Common_Procedures.UR.VehicleNo_Creation, New_Entry) = False Then Exit Sub


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.VehicleNo_Creation, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Vehicle_Head", "Vehicle_IdNo", "", trans)

                cmd.CommandText = "Insert into Vehicle_Head(Vehicle_IdNo, Vehicle_No, sur_name, Type) values (" & Str(Val(txt_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "','OWN')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Vehicle_Head set Vehicle_No = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "',Type = 'OWN' where Vehicle_IdNo = " & Str(Val(txt_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "VEHICLENO"
        ...
        Catch ex As Exception
            ...
            If InStr(1, Trim(LCase(ex.Message)), "ix_vehicle_head") > 0 Then
                MessageBox.Show("Duplicate Vehicle No", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Find_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Find.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Vehicle_IdNo from Vehicle_Head where Vehicle_No = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
            ...
            With cbo_Find
                ...
                If Asc(e.KeyChar) <> 27 Then
                    ...
                    Else
                        ...
                        da = New SqlClient.SqlDataAdapter("select Vehicle_No from Vehicle_Head " & Condt & " order by Vehicle_No", con)
                        da.Fill(dt)
    ...
    'Private Sub Cbo_Type_GotFocus(sender As Object, e As System.EventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "", "", "", "")
    'End Sub

    'Private Sub Cbo_Type_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_Type, txt_Name, btn_Save, "", "", "", "")
    'End Sub


    'Private Sub Cbo_Type_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_Type, btn_Save, "", "", "", "")
    '    If Asc(e.KeyChar) = 13 Then
    '        If MessageBox.Show("Do you want to save?", "FOR SAVING...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    '            save_record()
    '        End If
