Public Class Pavu_Transfer_BeamWise
    ...
    Private Pk_Condition As String = "PVTRB-"
    ...
    Private Sub Pavu_Transfer_BeamWise_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Pavu_Transfer_BeamWise_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Pavu_Transfer_BeamWise_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Pavu_Transfer_BeamWise_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as DelvName,d.EndsCount_Name, e.Ledger_Name as RecFromName from Pavu_Transfer_BeamWise_Head a INNER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo LEFT OUTER JOIN Ledger_Head e ON a.ReceivedFrom_IdNo = e.Ledger_IdNO Where a.Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Pavu_Transfer_BeamWise_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Pavu_Transfer_BeamWise_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Pavu_Delivery_Increment, c.EndsCount_Name, d.Beam_Width_Name from Pavu_Transfer_BeamWise_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON a.Beam_Width_Idno = d.Beam_Width_Idno where a.Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Pavu_Transfer_Beam_wise_Entry, New_Entry, Me, con, "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", NewCode, "Pavu_Transfer_BeamWise_Date", "(Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Pavu_Transfer_BeamWise_Code, Company_IdNo, for_OrderBy", trans)

            Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "DELETE", "Pavu_Transfer_BeamWise_Details", "Pavu_Transfer_BeamWise_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "Set_No  , Beam_No  , Pcs  ,  Meters_Pc,  Meters , EndsCount_IdNo ,  Beam_Width_IdNo ,  Noof_Used ,  Set_Code", "Sl_No", "Pavu_Transfer_BeamWise_Code, For_OrderBy, Company_IdNo, Pavu_Transfer_BeamWise_No, Pavu_Transfer_BeamWise_Date, DeliveryTo_IdNo,ReceivedFrom_IdNo", trans)



            Common_Procedures.Voucher_Deletion(con, Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), trans)

            Da = New SqlClient.SqlDataAdapter("Select * from Pavu_Transfer_BeamWise_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'", con)
            ...
            cmd.CommandText = "delete from Pavu_Transfer_BeamWise_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Pavu_Transfer_BeamWise_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Transfer_BeamWise_No from Pavu_Transfer_BeamWise_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Pavu_Transfer_BeamWise_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Transfer_BeamWise_No from Pavu_Transfer_BeamWise_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Pavu_Transfer_BeamWise_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Transfer_BeamWise_No from Pavu_Transfer_BeamWise_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Transfer_BeamWise_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Pavu_Transfer_BeamWise_No from Pavu_Transfer_BeamWise_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Transfer_BeamWise_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red

            msk_date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1 * from Pavu_Transfer_BeamWise_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Pavu_Transfer_BeamWise_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Pavu_Transfer_BeamWise_Date").ToString <> "" Then msk_date.Text = dt1.Rows(0).Item("Pavu_Transfer_BeamWise_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Pavu_Transfer_BeamWise_No from Pavu_Transfer_BeamWise_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.Pavu_Transfer_Beam_wise_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Pavu_Transfer_Beam_wise_Entry, New_Entry, Me, con, "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", NewCode, "Pavu_Transfer_BeamWise_Date", "(Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Pavu_Transfer_BeamWise_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Pavu_Transfer_BeamWise_Head ( Pavu_Transfer_BeamWise_Code, Company_IdNo, Pavu_Transfer_BeamWise_No, for_OrderBy, Pavu_Transfer_BeamWise_Date, DeliveryTo_IdNo, ReceivedFrom_IdNo, EndsCount_IdNo, Pavu_Meters, Empty_Beam, Total_Beam , Total_Pcs, Total_Meters ,   User_IdNo  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ",  " & Val(Rec_ID) & " , " & Str(Val(KuPvu_EdsCnt_ID)) & "," & Val(txt_KuraiPavuMeter.Text) & " , " & Val(txt_KuraiPavuBeam.Text) & ",   " & Str(Val(vTotPvuBms)) & " , " & Str(Val(vTotPvuPcs)) & " , " & Str(Val(vTotPvuMtrs)) & " ," & Val(lbl_UserName.Text) & ") "
                cmd.ExecuteNonQuery()
            ...
            Else
                ...
                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Pavu_Transfer_BeamWise_Head", "Pavu_Transfer_BeamWise_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Pavu_Transfer_BeamWise_Code, Company_IdNo, for_OrderBy", tr)

                Call Common_Procedures.User_Modification_Updation(con, "DETAILS", Me.Name, "OLD", "Pavu_Transfer_BeamWise_Details", "Pavu_Transfer_BeamWise_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "Set_No  , Beam_No  , Pcs  ,  Meters_Pc,  Meters , EndsCount_IdNo ,  Beam_Width_IdNo ,  Noof_Used ,  Set_Code", "Sl_No", "Pavu_Transfer_BeamWise_Code, For_OrderBy, Company_IdNo, Pavu_Transfer_BeamWise_No, Pavu_Transfer_BeamWise_Date, DeliveryTo_IdNo,ReceivedFrom_IdNo", tr)



                cmd.CommandText = "Update Pavu_Transfer_BeamWise_Head set Pavu_Transfer_BeamWise_Date = @EntryDate, DeliveryTo_IdNo = " & Str(Val(Delv_ID)) & ", ReceivedFrom_IdNo = " & Str(Val(Rec_ID)) & ", Empty_Beam = " & Str(Val(txt_KuraiPavuBeam.Text)) & ", Pavu_Meters = " & Str(Val(txt_KuraiPavuMeter.Text)) & ",EndsCount_IdNo = " & Str(Val(KuPvu_EdsCnt_ID)) & ", Total_Beam = " & Str(Val(vTotPvuBms)) & ", Total_Pcs = " & Str(Val(vTotPvuPcs)) & ", Total_Meters = " & Str(Val(vTotPvuMtrs)) & " ,User_idNo = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            Partcls = "Trans : Ref.No. " & Trim(lbl_RefNo.Text)
            ...
            With dgv_PavuDetails
                ...
                For i = 0 To dgv_PavuDetails.RowCount - 1
                    ...
                    If Val(dgv_PavuDetails.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Pavu_Transfer_BeamWise_Details ( Pavu_Transfer_BeamWise_Code,              Company_IdNo        ,     Pavu_Transfer_BeamWise_No     ,                               for_OrderBy                          , Pavu_Transfer_BeamWise_Date,         DeliveryTo_IdNo  ,    ReceivedFrom_IdNo     ,          Sl_No        ,                    Set_No              ,                    Beam_No             ,                      Pcs                 ,                      Meters_Pc           ,                      Meters              ,             EndsCount_IdNo       ,      Beam_Width_IdNo     ,              Noof_Used        ,                  Set_Code                ) " & _
            ...
            '    If Common_Procedures.Voucher_Updation(con, "Pavu.Sales", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_Date.Text), Trim(Partc_AC), vLed_IdNos, vVou_Amts, ErrMsg, tr,Common_Procedures.SoftwareTypes.Textile_Software) = False Then
            ...
            ''Bill Posting
            'VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, Led_ID, Trim(lbl_RefNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "CR", Trim(Pk_Condition) & Trim(NewCode), tr,Common_Procedures.SoftwareTypes.Textile_Software)
    ...
    Private Sub cbo_RecForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecForm.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecForm, cbo_DelvAt, cbo_EndsCount, "Ledger_AlaisHead", "Ledger_DisplayName", "Ledger_Type = 'GODOWN'", "(Ledger_idno = 0)")
    ...
    Private Sub txt_KuraiPavuBeam_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_KuraiPavuBeam.KeyDown
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Transfer_BeamWise_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Pavu_Transfer_BeamWise_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Pavu_Transfer_BeamWise_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.EndsCount_Name from Pavu_Transfer_BeamWise_Head a INNER JOIN Pavu_Transfer_BeamWise_Details d on a.Pavu_Transfer_BeamWise_Code = d.Pavu_Transfer_BeamWise_Code INNER JOIN Ledger_Head b on a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head c on d.EndsCount_IdNo = c.EndsCount_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Transfer_BeamWise_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Pavu_Transfer_BeamWise_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Pavu_Transfer_BeamWise_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Pavu_Transfer_BeamWise_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.Pavu_Transfer_Beam_wise_Entry, New_Entry) = False Then Exit Sub

        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

        Try

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.* , d.EndsCount_Name  from Pavu_Transfer_BeamWise_Head a LEFT OUTER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.ReceivedFrom_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo   where a.Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.Ledger_Name as Receiver_Name , d.EndsCount_Name , f.* from Pavu_Transfer_BeamWise_Head a LEFT OUTER JOIN Ledger_Head b ON a.DeliveryTo_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.ReceivedFrom_IdNo = c.Ledger_IdNo LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_IdNo = d.EndsCount_IdNo  INNER JOIN Company_Head f ON a.Company_IdNo = f.Company_IdNo  where a.Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.* , d.EndsCount_Name from Pavu_Transfer_BeamWise_Details a LEFT OUTER JOIN EndsCount_Head d ON a.EndsCount_idno = d.EndsCount_idno where Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = 170 : ClArr(2) = 130 : ClArr(3) = 130 : ClArr(4) = 120
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "PAVU TRANSFER ", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Pavu_Transfer_BeamWise_No").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "REF DATE", LMargin + M1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Pavu_Transfer_BeamWise_Date").ToString), "dd-MM-yyyy"), LMargin + M1 + W1 + 25, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt
        ...
        If Trim(prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString) <> "" Then
            Common_Procedures.Print_To_PrintDocument(e, " TIN : " & prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString, LMargin + N1 + 10, CurY, 0, 0, pFont)
        End If
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            ...
            Da = New SqlClient.SqlDataAdapter("select a.noof_used as Ent_NoofUsed, b.*, c.EndsCount_Name, d.Beam_Width_Name from Pavu_Transfer_BeamWise_Details a INNER JOIN Stock_SizedPavu_Processing_Details b ON a.Set_Code = b.Set_Code and a.Beam_No = b.Beam_No INNER JOIN EndsCount_Head c ON a.EndsCount_IdNo = c.EndsCount_IdNo LEFT OUTER JOIN Beam_Width_Head d ON b.Beam_Width_Idno = d.Beam_Width_Idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Pavu_Transfer_BeamWise_Code = '" & Trim(NewCode) & "' and a.ReceivedFrom_IdNo = " & Str(Val(Led_IdNo)) & " order by a.for_orderby, a.Set_Code, b.ForOrderBy_BeamNo, a.Beam_No, a.sl_no", con)
            Dt1 = New DataTable
            Da.Fill(Dt1)
