...
Public Class Yarn_Delivery
    ...
    Private Pk_Condition As String = "TYNDL-"
    Private Pk_Condition1 As String = "TYNDC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from Weaver_Yarn_Delivery_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Count_Name, c.Mill_Name from Weaver_Yarn_Delivery_Details a INNER JOIN Count_Head b on a.Count_IdNo = b.Count_IdNo INNER JOIN Mill_Head c on a.Mill_IdNo = c.Mill_IdNo where a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Weaver_Yarn_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Weaver_Yarn_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_Yarn_Delivery_Head", "Weaver_Yarn_Delivery_Code", "For_OrderBy", "Weaver_Yarn_Delivery_Code like '" & Pk_Condition & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Weaver_Yarn_Delivery_Head", "Weaver_Yarn_Delivery_Code", "For_OrderBy", "Weaver_Yarn_Delivery_Code like '" & Pk_Condition & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Weaver_Yarn_Delivery_Head(Weaver_Yarn_Delivery_Code, Company_IdNo, Weaver_Yarn_Delivery_No, for_OrderBy, Weaver_Yarn_Delivery_Date, DeliveryTo_IdNo, ReceivedFrom_IdNo, Transport_IdNo, Empty_Beam, Vechile_No, Total_Bags, Total_Cones, Total_Weight , Total_Thiri , Freight, Party_DcNo,Cloth_IdNo ,  User_Idno ,Amount, Rate , Net_Amount ,Transportation_Mode ,Date_Time_Of_Supply ,Place_Of_Supply,Ewave_Bill_No, Our_Order_No     , Own_Order_Code) Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @EntryDate, " & Str(Val(Delv_ID)) & ", " & Str(Val(Rec_ID)) & " , " & Str(Val(Trans_ID)) & ",  " & Str(Val(txt_Empty_Beam.Text)) & " , '" & Trim(cbo_Vechile.Text) & "' , " & Str(Val(vTotYrnBags)) & ", " & Str(Val(vTotYrnCones)) & ", " & Str(Val(vTotYrnWeight)) & " ,  " & Str(Val(vTotYrnThiri)) & " ,  " & Str(Val(txt_Freight.Text)) & " , '" & Trim(txt_Party_DcNo.Text) & "' ," & Val(Clo_ID) & ", " & Val(lbl_UserName.Text) & " ," & Val(txt_Amount.Text) & ", " & Val(txt_rate.Text) & "," & Val(lbl_Amount.Text) & ",'" & Trim(cbo_TransportMode.Text) & "','" & Trim(txt_DateTime_Of_Supply.Text) & "','" & Trim(txt_place_Supply.Text) & "','" & Trim(txt_Ewave_Bill_No.Text) & "','" & Trim(lbl_OrderNo.Text) & "' ,    '" & Trim(lbl_OrderCode.Text) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Weaver_Yarn_Delivery_Head set Weaver_Yarn_Delivery_Date = @EntryDate, DeliveryTo_IdNo = " & Str(Val(Delv_ID)) & ", ReceivedFrom_IdNo = " & Str(Val(Rec_ID)) & " , Transport_IdNo = " & Str(Val(Trans_ID)) & ", Empty_Beam = " & Str(Val(txt_Empty_Beam.Text)) & " , Vechile_No = '" & Trim(cbo_Vechile.Text) & "' ,  Total_Bags = " & Str(Val(vTotYrnBags)) & ", Total_Cones = " & Str(Val(vTotYrnCones)) & ", Total_Weight = " & Str(Val(vTotYrnWeight)) & "  , Total_Thiri = " & Str(Val(vTotYrnThiri)) & "  ,  Freight = " & Str(Val(txt_Freight.Text)) & ", Party_DcNo =  '" & Trim(txt_Party_DcNo.Text) & "' ,Cloth_IdNo = " & Val(Clo_ID) & " , User_idNo = " & Val(lbl_UserName.Text) & " ,Amount = " & Val(txt_Amount.Text) & ", Rate = " & Val(txt_rate.Text) & ", Net_Amount = " & Val(lbl_Amount.Text) & ",Transportation_Mode = '" & Trim(cbo_TransportMode.Text) & "' ,Date_Time_Of_Supply = '" & Trim(txt_DateTime_Of_Supply.Text) & "' ,Place_Of_Supply = '" & Trim(txt_place_Supply.Text) & "',Ewave_Bill_No = '" & Trim(txt_Ewave_Bill_No.Text) & "' ,Our_Order_No = '" & Trim(lbl_OrderNo.Text) & "',Own_Order_Code = '" & Trim(lbl_OrderCode.Text) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' "
                cmd.ExecuteNonQuery()
            ...
            If Common_Procedures.Voucher_Updation(con, "Wea.YDelv.Frg", Val(lbl_Company.Tag), Trim(Pk_Condition1) & Trim(NewCode), Trim(lbl_DcNo.Text), Convert.ToDateTime(msk_date.Text), vWeaFrgt_Partcls, vVou_LedIdNos, vVou_Amts, vVou_ErrMsg, tr) = False Then
                Throw New ApplicationException(vVou_ErrMsg)
            End If
    ...
    Private Sub cbo_DelvTo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_DelvTo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' OR Ledger_Type = 'SIZING' OR Ledger_Type = 'REWINDING' or (Ledger_Type = '' and AccountsGroup_Idno = 10) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_DelvTo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DelvTo, msk_date, cbo_RecFrom, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' OR Ledger_Type = 'SIZING' OR Ledger_Type = 'REWINDING' or (Ledger_Type = '' and AccountsGroup_Idno = 10) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_DelvTo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DelvTo, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' OR Ledger_Type = 'SIZING' OR Ledger_Type = 'REWINDING' or (Ledger_Type = '' and AccountsGroup_Idno = 10) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Rec_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_RecFrom.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RecFrom, cbo_DelvTo, txt_Empty_Beam, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'GODOWN' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'REWINDING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Rec_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_RecFrom.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RecFrom, txt_Empty_Beam, "Ledger_AlaisHead", "Ledger_DisplayName", "( ( Ledger_Type = 'WEAVER' or Ledger_Type = 'SIZING' or Ledger_Type = 'GODOWN' or Ledger_Type = 'JOBWORKER' or Ledger_Type = 'REWINDING' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1 ) and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub TotalYarn_Calculation()
        Dim Sno As Integer
        Dim TotBags As String, TotCones As String, TotWeight As String, TotThiri As String
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Weaver_Yarn_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as Ledger1_Name ,d.Ledger_Address1 as RecAdd1,d.Ledger_Address2 as RecAdd2,d.Ledger_Address3 as RecAdd3,d.Ledger_Address4 as RecAdd4,d.Area_Idno as RecArea, e.Transport_Name ,Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code  from Weaver_Yarn_Delivery_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_Head Csh ON b.Company_State_IdNo = Csh.State_IdNo  INNER JOIN Ledger_Head c ON a.DeliveryTo_IdNo = c.Ledger_IdNo LEFT OUTER JOIN State_Head Lsh ON c.Ledger_State_IdNo = Lsh.State_IdNo Left Outer JOIN Ledger_Head d ON a.ReceivedFrom_IdNo = d.Ledger_IdNo Left Outer JOIN Transport_Head e ON a.Transport_IdNo = e.Transport_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Mill_name, d.* ,e.*  from Weaver_Yarn_Delivery_Details a INNER JOIN Mill_Head b ON a.Mill_idno = b.Mill_idno LEFT OUTER JOIN Count_Head d ON a.Count_idno = d.Count_idno LEFT OUTER JOIN itemgroup_head e ON d.itemgroup_idno = e.itemgroup_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.Sl_No", con)
...
LOOP2:
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        If Entry_dt >= Common_Procedures.GST_Start_Date Then
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Selection.Click
        ...
        With dgv_Selection
            If Val(LedIdNo) <> 0 Then
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name,c.*  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno  INNER JOIN Own_Order_Weaving_Details c ON  c.Own_Order_Code = a.Own_Order_Code LEFT OUTER JOIN Weaver_Yarn_Delivery_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'   and c.Ledger_IdNo = " & Val(LedIdNo) & " order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
            ...
            Else
                ...
                Da = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_Name  from Own_Order_Head a INNER JOIN CLOTH_Head b ON  b.Cloth_IdNo = a.Cloth_Idno   LEFT OUTER JOIN Weaver_Yarn_Delivery_Head d ON d.Own_Order_Code = a.Own_Order_Code  where a.Weaver_Yarn_Delivery_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'   order by a.Own_Order_Date, a.for_orderby, a.Own_Order_No", con)
                Dt1 = New DataTable
                Da.Fill(Dt1)
