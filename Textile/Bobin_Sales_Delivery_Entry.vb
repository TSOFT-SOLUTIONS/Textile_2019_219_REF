...
Public Class Bobin_Sales_Delivery_Entry
    ...
    Private Pk_Condition As String = "BSDLV-"
    Private Pk_Condition1 As String = "BDCFR-"

    Private GSTPk_Condition As String = "GBSDL-"
    Private GSTPk_Condition1 As String = "GBDCF-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Bobin_Jari_SalesDelivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo   Where a.Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_BobinDetails.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Meter_Reel").ToString), "########0.00")
                        dgv_BobinDetails.Rows(n).Cells(8).Value = Val(dt2.Rows(i).Item("reel").ToString)
                        dgv_BobinDetails.Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                        dgv_BobinDetails.Rows(n).Cells(10).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select BobinSales_Invoice_Code from Bobin_Jari_SalesDelivery_Head Where Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.CommandText = "Delete from Bobin_Jari_SalesDelivery_Bobin_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "delete from Bobin_Jari_SalesDelivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Jari_SalesDelivery_Head", "Bobin_Jari_Delivery_Code", "For_OrderBy", "(Bobin_Jari_Delivery_Code Not LIKE '" & Trim(GSTPk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Bobin_Jari_Delivery_No from Bobin_Jari_SalesDelivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Bobin_Jari_SalesDelivery_Head", "Bobin_Jari_Delivery_Code", "For_OrderBy", "(Bobin_Jari_Delivery_Code Not LIKE '" & Trim(GSTPk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
    ...
    Private Sub Total_Calculation()
        ...
        Try
            ...
            With dgv_BobinDetails
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Then
                        ...
                        vTotReel = vTotReel + Val(.Rows(i).Cells(8).Value)
            ...
            lbl_TaxableValue.Text = Format(Val(vTotAmt) + (txt_Freight.Text), "#########0.00")
            ...
            If chk_GSTTax_Invocie.Checked = True Then
                ...
                lbl_ItemGrp_ID.Text = Val(Common_Procedures.get_FieldValue(con, "EndsCount_Head", "ItemGroup_IdNo", "EndsCount_Name = '" & Trim(cbo_BobinEnds.Text) & "'"))
    ...
    End Sub
    'Private Sub HSN_GST_Details()

    '    lbl_ItemGrp_ID.Text = Val(Common_Procedures.get_FieldValue(con, "EndsCount_Head", "ItemGroup_IdNo", "EndsCount_Name = '" & Trim(EndsCount) & "'"))
            ...
            With dgv_BobinDetails
                If .Visible Then
                    If .Rows.Count > 0 Then
                        ...
                        If .CurrentCell.ColumnIndex = 4 Or .CurrentCell.ColumnIndex = 6 Or .CurrentCell.ColumnIndex = 7 Or .CurrentCell.ColumnIndex = 8 Or .CurrentCell.ColumnIndex = 9 Or .CurrentCell.ColumnIndex = 8 Then

                            If Trim(.CurrentRow.Cells(1).Value) <> "" Then
                                Ends_Idno = Common_Procedures.EndsCount_NameToIdNo(con, Trim(.CurrentRow.Cells(1).Value))
                            ...
                            If Val(.CurrentRow.Cells(6).Value) <> 0 Then
                                .Rows(.CurrentCell.RowIndex).Cells(8).Value = Format((Val(.Rows(.CurrentCell.RowIndex).Cells(6).Value) * Val(Ends)) / Val(.Rows(.CurrentCell.RowIndex).Cells(7).Value), "#########0")
                            End If
    ...
    Private Sub cbo_BobinEnds_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_BobinEnds.LostFocus
        Total_Calculation()
    End Sub

    Private Sub cbo_BobinEnds_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_BobinEnds.SelectedIndexChanged
        Total_Calculation()
    End Sub
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Bobin_Jari_SalesDelivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Bobin_Jari_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub Printing_Delivery_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClAr(1) = 35 : ClAr(2) = 120 : ClAr(3) = 145 : ClAr(4) = 60 : ClAr(5) = 70 : ClAr(6) = 85 : ClAr(7) = 65 : ClAr(8) = 70
        ClAr(9) = PageWidth - (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8))

        If Val(vPrnt_2Copy_In_SinglePage) = 1 Then
            TxtHgt = 16
        Else
            TxtHgt = 17.55 ' 18 ' 18.5
        End If
        ...
        For PCnt = 1 To PrntCnt
            ...
            Try
                If prn_HdDt.Rows.Count > 0 Then
                    ...
                    Printing_Delivery_Format1_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TpMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClAr)
                    NoofItems_PerPage = 4
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            CurY = CurY + TxtHgt
                            SNo = SNo + 1
                            Common_Procedures.Print_To_PrintDocument(e, Trim(Val(prn_DetDt.Rows(prn_DetIndx).Item("Sl_No").ToString)), LMargin + 10, CurY, 0, 0, pFont)
