Public Class Opening_Balance_Stock_OE
    Implements Interface_MDIActions

    Private con As New SqlClient.SqlConnection(Common_Procedures.Connection_String)
    Private FrmLdSTS As Boolean = False
    Private New_Entry As Boolean = False
    Private Pk_Condition As String = "OEOPN-"
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If Trim(.Rows(i).Cells(7).Value) <> "" And Val(.Rows(i).Cells(6).Value) <> 0 Then
                            ...
                            cmd.CommandText = "update voucher_bill_head set " _
                                                        ...
                                                        & " Software_Module_IdNo = " & Str(Val(Common_Procedures.SoftwareTypes.OE_Software)) & ", " _
