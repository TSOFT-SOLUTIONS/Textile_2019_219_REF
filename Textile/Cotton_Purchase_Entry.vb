Public Class Cotton_Purchase_Entry
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*  from Cotton_Purchase_Bale_Details a  where a.Cotton_Purchase_Code = '" & Trim(NewCode) & "'  Order by Sl_No", con)
                dt2 = New DataTable
                da2.Fill(dt3)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Cotton_purchase_Head (       Cotton_Purchase_Code ,               Company_IdNo       ,           Cotton_Purchase_No    ,                               for_OrderBy                              , Cotton_Purchase_Date,        Ledger_IdNo      ,           Bill_No              ,                       Commission_Kg      ,      Commission_Amount  ,           Agent_IdNo    ,        PurchaseAc_IdNo    ,         Total_Bales    ,         Total_Weight      ,  Total_Amount   ,            Freight        ,                 Amount          ,           VatAc_IdNo      ,              Vat_Type           ,             Vat_Percentage       ,             Vat_Amount                  ,           Transport_IdNo          ,              AddLess_Amount       ,                         Net_Amount               ,                Vehicle_No             ) " & _
            ...
            cmd.CommandText = "Delete from Cotton_Purchase_Bale_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cotton_Purchase_Code = '" & Trim(NewCode) & "' and Mixing_Code =''  "
            cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        'If Nr = 0 Then
                        cmd.CommandText = "Insert into Cotton_Purchase_Details ( Cotton_Purchase_Code ,               Company_IdNo       ,   Cotton_Purchase_No    ,                     for_OrderBy                                            ,              Cotton_Purchase_Date,             Sl_No     ,    Ledger_idNo           ,   Variety_idNo    ,                      Bales               ,                  Bale_Nos                ,                        Weight                      ,                    Rate                       ,                 Amount      ,     Detail_SlNo                         ) " & _
                        ...
                        cmd.CommandText = "Insert into Stock_Cotton_Processing_Details ( Reference_Code                        ,             Company_IdNo         ,           Reference_No        ,                               For_OrderBy          ,        Reference_Date,  Entry_ID               ,   Party_Bill_No   ,   Sl_No      ,            Ledger_idNo      ,        Variety_IdNo       ,  Bale ,         Weight  ) " & _
    ...
    Private Sub cbo_Party_Name_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, msk_Date, cbo_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Party_Name_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyName, cbo_Agent, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Transport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Transport.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Transport, txt_Freight, cbo_VatAc, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_Transport_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Transport.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Transport, cbo_VatAc, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT')", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_Amount.Text) + Val(lbl_VatAmount.Text) + Val(txt_AddLess.Text) + Val(txt_Freight.Text)
    ...
    Private Sub cbo_VatAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VatAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VatAc, cbo_Transport, cbo_VatType, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 12)", "(Ledger_IdNo = 0)")
    End Sub
