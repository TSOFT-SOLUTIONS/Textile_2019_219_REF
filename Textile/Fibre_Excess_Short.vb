Public Class Fibre_Excess_Short
    ...
    Private Pk_Condition As String = "FIBES-"         ' "YRNES-"
    ...
    Private Sub Fibre_Excess_Short_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_Fibre.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "FIBRE" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_Fibre.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
    ...
    Private Sub Fibre_Excess_Short_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Fibre_Excess_Short_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Fibre_Excess_Short_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        da.Fill(dt5)
        cbo_Fibre.DataSource = dt5
        cbo_Fibre.DisplayMember = "Fibre_Name"
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1186" Then
            lbl_heading.Text = "GENERAL EXCESS SHORT"
            Me.Text = "GENERAL EXCESS SHORT"
        End If
        ...
        AddHandler cbo_Fibre.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_Fibre.LostFocus, AddressOf ControlLostFocus
        ...
        cbo_type.Text = ""
        cbo_type.Items.Add("")
        cbo_type.Items.Add("LOT")
        cbo_type.Items.Add("BILL")
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from Fibre_Excess_Short_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Fibre_Excess_Short_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Fibre_Excess_Short_Date").ToString
                ...
                cbo_Fibre.Text = Common_Procedures.Fibre_IdNoToName(con, Val(dt1.Rows(0).Item("Fibre_IdNo").ToString))
                ...
                End If
                If Val(dt1.Rows(0).Item("Bale").ToString) <> 0 Then
                    txt_Bale.Text = Val(dt1.Rows(0).Item("Bale").ToString)
                End If
                ...
                cbo_type.Text = Trim(dt1.Rows(0).Item("Excess_type").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        '  If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Fibre_Excess_Short_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Fibre_Excess_Short_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        ' If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.Yarn_Excess_Short_Entry, New_Entry, Me, con, "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", NewCode, "Fibre_Excess_Short_Date", "(Fibre_Excess_Short_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "DELETE", "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, True, "", "", "Fibre_Excess_Short_Code, Company_IdNo, for_OrderBy", trans)
            ...
            cmd.CommandText = "delete from Fibre_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Excess_Short_No from Fibre_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Fibre_Excess_Short_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Excess_Short_No from Fibre_Excess_Short_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Fibre_Excess_Short_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Excess_Short_No from Fibre_Excess_Short_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Excess_Short_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Fibre_Excess_Short_No from Fibre_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Excess_Short_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)

            lbl_RefNo.ForeColor = Color.Red

            dtp_Date.Text = Date.Today.ToShortDateString
            da = New SqlClient.SqlDataAdapter("select top 1  * from Fibre_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Fibre_Excess_Short_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Fibre_Excess_Short_Date").ToString <> "" Then dtp_Date.Text = dt1.Rows(0).Item("Fibre_Excess_Short_Date").ToString
                Else
                    If dt1.Rows(0).Item("Excess_Type").ToString <> "" Then cbo_type.Text = dt1.Rows(0).Item("Excess_Type").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Fibre_Excess_Short_No from Fibre_Excess_Short_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code = '" & Trim(RecCode) & "'", con)
            da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Fibre_Excess_Short_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Fibre_Excess_Short_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' Common_Procedures.UserRight_Check(Common_Procedures.UR.Fibre_Excess_Short_Entry, New_Entry) = False Then Exit Sub
        NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_RefNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
        ' If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.Yarn_Excess_Short_Entry, New_Entry, Me, con, "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", NewCode, "Fibre_Excess_Short_Date", "(Fibre_Excess_Short_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Fibre_Excess_Short_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        YCnt_ID = Common_Procedures.Fibre_NameToIdNo(con, cbo_Fibre.Text)
        If YCnt_ID = 0 Then
            MessageBox.Show("Invalid Fibre Name", "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
            If cbo_Fibre.Enabled And cbo_Fibre.Visible Then cbo_Fibre.Focus()
            Exit Sub
        End If
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Fibre_Excess_Short_Head(Fibre_Excess_Short_Code, Company_IdNo, Fibre_Excess_Short_No, for_OrderBy, Fibre_Excess_Short_Date, Ledger_IdNo, Lot_No, Fibre_IdNo , Mill_IdNo, Excess_Short , Bale , Weight , Amount , ExcessShort_Ac_IdNo  , User_idNo,Taxable_Amount,CGST_Percentage,CGST_Amount,SGST_Percentage,SGST_Amount,IGST_Percentage,IGST_Amount, Remarks,Party_BillNo ,Excess_Type) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @DcDate, " & Str(Val(Led_ID)) & ", '" & Trim(cbo_LotNo.Text) & "' ,  " & Str(Val(YCnt_ID)) & ",  " & Str(Val(YMil_ID)) & ",  '" & Trim(cbo_Excess_Short.Text) & "'  ,  " & Str(Val(txt_Bale.Text)) & " ,  " & Str(Val(txt_Weight.Text)) & " ,  " & Str(Val(txt_Amount.Text)) & " , " & Str(Val(Acc_ID)) & ", " & Val(lbl_UserName.Text) & " ," & Str(Val(txt_taxable.Text)) & "," & Str(Val(txt_CGST_Percentage.Text)) & "," & Str(Val(lbl_CGST_Amount.Text)) & "," & Str(Val(txt_SGST_Percentage.Text)) & "," & Str(Val(lbl_SGST_Amount.Text)) & "," & Str(Val(txt_IGST_Percentage.Text)) & "," & Str(Val(lbl_IGST_Amount.Text)) & ",'" & Trim(Txt_remarks.Text) & "','" & Trim(txt_party_BillNo.Text) & "' , '" & Trim(cbo_type.Text) & "')"
                cmd.ExecuteNonQuery()

            Else

                Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "OLD", "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Fibre_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)


                cmd.CommandText = "Update Fibre_Excess_Short_Head set Fibre_Excess_Short_Date = @DcDate, Ledger_IdNo = " & Str(Val(Led_ID)) & ", ExcessShort_Ac_IdNo = " & Str(Val(Acc_ID)) & " ,  Bale = " & Str(Val(txt_Bale.Text)) & "  , Weight = " & Str(Val(txt_Weight.Text)) & " , Amount = " & Str(Val(txt_Amount.Text)) & " , Lot_No = '" & Trim(cbo_LotNo.Text) & "' ,  Fibre_IdNo = " & Str(Val(YCnt_ID)) & ", Mill_IdNo = " & Str(Val(YMil_ID)) & "  ,  Excess_Short = '" & Trim(cbo_Excess_Short.Text) & "',user_IdNo =  " & Val(lbl_UserName.Text) & " ,Taxable_Amount =" & Str(Val(txt_taxable.Text)) & ",CGST_Percentage =" & Str(Val(txt_CGST_Percentage.Text)) & " ,CGST_Amount =" & Str(Val(lbl_CGST_Amount.Text)) & " ,SGST_Percentage =" & Str(Val(txt_SGST_Percentage.Text)) & ",SGST_Amount =" & Str(Val(lbl_SGST_Amount.Text)) & ",IGST_Percentage =" & Str(Val(txt_IGST_Percentage.Text)) & ",IGST_Amount =" & Str(Val(lbl_IGST_Amount.Text)) & " ,Remarks='" & Trim(Txt_remarks.Text) & "' ,Party_BillNo= '" & Trim(txt_party_BillNo.Text) & "' , Excess_Type = '" & Trim(cbo_type.Text) & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code = '" & Trim(NewCode) & "' "
                cmd.ExecuteNonQuery()

            End If

            Call Common_Procedures.User_Modification_Updation(con, "HEAD", Me.Name, "NEW", "Fibre_Excess_Short_Head", "Fibre_Excess_Short_Code", Val(lbl_Company.Tag), NewCode, lbl_RefNo.Text, Val(vOrdByNo), Pk_Condition, "", "", New_Entry, False, "", "", "Fibre_Excess_Short_Code, Company_IdNo, for_OrderBy", tr)
            ...
            cmd.CommandText = "Insert into Stock_Fibre_Processing_Details ( Reference_Code,                                              Company_IdNo        ,         Reference_No          ,                               for_OrderBy                                   ,            Reference_Date,      DeliveryTo_Idno           ,     ReceivedFrom_Idno      ,                     Entry_ID       ,                Particulars      ,           Party_Bill_No      ,            Sl_No,                Fibre_IdNo            ,                   Lot_No             ,         Yarn_Type          ,                  Mill_IdNo              ,                     Bale                ,               Cones                ,                Weight                        ,      DeliveryToIdno_ForParticulars   ,              ReceivedFromIdno_ForParticulars    ,           Excess_Short_Bill_Lot_Type ,                   AMount           ,  Fibre_Taxable_Amount ) " &
                                                                    " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "'   , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & "                 , @DcDate        , " & Str(Val(Delv_ID)) & ",    " & Str(Val(Rec_ID)) & ",                 '" & Trim(EntID) & "',            '" & Trim(Partcls) & "',        '" & Trim(PBlNo) & "',            1  ,              " & Str(Val(YCnt_ID)) & ",       '" & Trim(cbo_LotNo.Text) & "'  ,         'MILL'           ,         " & Str(Val(YMil_ID)) & "       ,        " & Str(Val(txt_Bale.Text)) & "    ,               0                  ,       " & Str(Val(txt_Weight.Text)) & "       ,   " & Str(Val(Prtcls_DelvIdNo)) & "   ,      " & Str(Val(Prtcls_RecIdNo)) & "         ,   '" & Trim(cbo_type.Text) & "'    ,  " & Str(Val(txt_Amount.Text)) & "   ,  " & Str(Val(txt_taxable.Text)) & "  )"
            cmd.ExecuteNonQuery()
            ...
            If Common_Procedures.Voucher_Updation(con, "Fibre.Exc\Sht", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_RefNo.Text), Convert.ToDateTime(dtp_Date.Text), 0, vLed_IdNos, vVou_Amts, ErrMsg, tr, Common_Procedures.SoftwareTypes.Textile_Software) = False Then
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, txt_party_BillNo, cbo_Fibre, "Ledger_AlaisHead", "Ledger_DisplayName", "( (Ledger_Type = 'WEAVER' or Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'REWINDING' or Ledger_Type = 'JOBWORKER' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1 )  and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, cbo_Fibre, "Ledger_AlaisHead", "Ledger_DisplayName", "( (Ledger_Type = 'WEAVER' or Ledger_Type = 'GODOWN' or Ledger_Type = 'SIZING' or Ledger_Type = 'REWINDING' or Ledger_Type = 'JOBWORKER' or (Ledger_Type = '' and Stock_Maintenance_Status = 1) or Show_In_All_Entry = 1 )  and Close_status = 0 )", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Acc_Name_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Acc_Name.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Acc_Name, txt_taxable, txt_CGST_Percentage, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    ...
    Private Sub cbo_Acc_Name_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Acc_Name.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Acc_Name, txt_CGST_Percentage, "Ledger_AlaisHead", "Ledger_DisplayName", "", "(Ledger_idno = 0)")
    End Sub
    ...
    Private Sub cbo_Acc_Name_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Acc_Name.KeyUp
        ...
        End If
    End Sub
    Private Sub cbo_Grid_FibreName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Fibre.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Fibre, cbo_Ledger, cbo_LotNo, "Fibre_Head", "Fibre_Name", "", "(Fibre_IdNo = 0)")
    End Sub


    Private Sub cbo_Grid_FibreName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Fibre.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Fibre, cbo_LotNo, "Fibre_Head", "Fibre_Name", "", "(Fibre_IdNo = 0)")
    End Sub

    Private Sub cbo_Grid_FibreName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Fibre.KeyUp
        If e.Control = False And e.KeyValue = 17 Then
            Dim f As New Fibre_Creation

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_Fibre.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    'Private Sub cbo_YarnType_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_YarnType, cbo_Fibre, cbo_Mill, "YarnType_Head", "Yarn_Type", "", "Yarn_Type")
    ...
    Private Sub cbo_Grid_MillName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Mill.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Mill, cbo_LotNo, cbo_Excess_Short, "Mill_Head", "Mill_Name", "", "(Mill_IdNo = 0)")
    ...
    Private Sub cbo_Excess_Short_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Excess_Short.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Excess_Short, cbo_Mill, txt_Bale, "", "", "", "")
    ...
    Private Sub cbo_Excess_Short_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Excess_Short.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Excess_Short, txt_Bale, "", "", "", "")
    End Sub
    ...
    Private Sub txt_Cones_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub txt_Weight_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Weight.KeyPress
        ...
        End If
    End Sub
    Private Sub txt_Weight_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_Weight.KeyDown
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Excess_Short_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.Fibre_Excess_Short_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.Fibre_Excess_Short_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Cnt_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Fibre_Excess_Short_Code IN ( select z1.Fibre_Excess_Short_Code from Fibre_Excess_Short_Head z1 where z1.Fibre_IdNo = " & Str(Val(Cnt_IdNo)) & " )"
                'Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.Fibre_IdNo = " & Str(Val(Cnt_IdNo)) & ""
            End If

            If Val(Mil_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Fibre_Excess_Short_Code IN ( select z2.Fibre_Excess_Short_Code from Fibre_Excess_Short_Head z2 where z2.Mill_IdNo = " & Str(Val(Mil_IdNo)) & " )"
                'Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " b.Mill_IdNo = " & Str(Val(Mil_IdNo))
            End If

            da = New SqlClient.SqlDataAdapter("select a.*, e.Ledger_Name from Fibre_Excess_Short_Head a inner join Ledger_head e on a.Ledger_idno = e.Ledger_idno where a.company_idno =" & Str(Val(lbl_Company.Tag)) & "and a.Fibre_Excess_Short_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.Fibre_Excess_Short_Date, a.for_orderby, a.Fibre_Excess_Short_No", con)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Fibre_Excess_Short_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Fibre_Excess_Short_Date").ToString), "dd-MM-yyyy")
                    dgv_Filter_Details.Rows(n).Cells(3).Value = dt2.Rows(i).Item("Ledger_Name").ToString
                    dgv_Filter_Details.Rows(n).Cells(4).Value = Val(dt2.Rows(i).Item("Bale").ToString)
                    dgv_Filter_Details.Rows(n).Cells(5).Value = Val(dt2.Rows(i).Item("Lot_No").ToString)
    ...
    Private Sub cbo_Filter_CountName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Filter_CountName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Filter_CountName, cbo_Filter_MillName, "Fibre_Head", "Fibre_Name", "", "(Fibre_IdNo = 0)")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            'da1 = New SqlClient.SqlDataAdapter("select * from Fibre_Excess_Short_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            'dt1 = New DataTable
            'da1.Fill(dt1)
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo ,c.Fibre_Name ,m.Ledger_name As Mill_name from Fibre_Excess_Short_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head m ON a.mill_IdNo = m.Ledger_IdNo LEFT OUTER JOIN Fibre_Head c ON a.Fibre_IdNo = c.Fibre_IdNo where a.Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            If dt1.Rows.Count <= 0 Then
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            'da1 = New SqlClient.SqlDataAdapter("select a.*, b.* , c.* from Fibre_Excess_Short_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            'prn_HdDt = New DataTable
            'da1.Fill(prn_HdDt)

            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* ,Lsh.State_Name as Ledger_state_name , Lsh.State_Code as Ledger_State_Code , Csh.State_Name as Company_State_Name ,Csh.State_Code as Company_State_Code from Fibre_Excess_Short_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN State_Head Lsh ON b.Ledger_State_IdNo = lsh.State_Idno  INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = Csh.State_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)
            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Fibre_Name, c.Mill_name from Fibre_Excess_Short_Head a LEFT OUTER JOIN Fibre_Head b ON a.Fibre_IdNo = b.Fibre_IdNo LEFT OUTER JOIN Mill_Head c ON a.Mill_idno = c.Mill_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Fibre_Excess_Short_Code = '" & Trim(NewCode) & "'", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Try
            If prn_HdDt.Rows.Count > 0 Then
                ...
                CurY = CurY + TxtHgt + 10
                Common_Procedures.Print_To_PrintDocument(e, "Fibre Name", LMargin + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + d1 + 10, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString, LMargin + d1 + 30, CurY, 0, 0, p1Font)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "FIBRE EXCESS SHORT", LMargin, CurY, 2, PrintWidth, p1Font)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Excess_Short_No").ToString, LMargin + M1 + W1 + 25, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + M1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Excess_Short_Date").ToString), "dd-MM-yyyy"), LMargin + M1 + W1 + 25, CurY, 0, 0, pFont)
    ...
    Private Sub txt_taxable_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txt_taxable.KeyPress
        ...
        End If
    End Sub
    Private Sub txt_taxable_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_taxable.KeyDown
        If e.KeyValue = 38 Then
            txt_Weight.Focus()
    ...
    Private Sub txt_CGST_Percentage_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_CGST_Percentage.KeyDown
    ...
    Private Sub Printing_Format_GST1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 50 : ClArr(2) = 160 : ClArr(3) = 190 : ClArr(4) = 80 : ClArr(5) = 80 : ClArr(6) = 80
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            ItmNm1 = prn_DetDt.Rows(prn_DetIndx).Item("Fibre_Name").ToString
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Bale").ToString), "#########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("LOT_NO").ToString), "##########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont)
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Taxable_Amount").ToString), "#############0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format_GST1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal vFontName As String)
        ...
        vPrntHeading = "FIBRE EXCESS SHORT"
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Fibre_Excess_Short_No").ToString, LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Fibre_Excess_Short_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "FIBER NAME", LMargin + ClAr(1), CurY, 2, ClAr(2), pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "LOTNO", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
    ...
    Private Function get_GST_Noof_HSN_Codes_For_Printing(ByVal EntryCode As String) As Integer
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Fibre_Excess_Short_Head Where Fibre_Excess_Short_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
    ...
    'Private Sub txt_LotNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_LotNo.KeyPress
    ...
    Private Sub cbo_type_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_type.KeyDown

        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_type, txt_IGST_Percentage, Txt_remarks, "", "", "", "")
    ...
    Private Sub cbo_type_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_type.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_type, Txt_remarks, "", "", "", "")
        'Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Excess_Short, txt_Bale, "", "", "", "")
        'If Asc(e.KeyChar) = 13 Then
    ...
    End Sub
    Private Sub cbo_LotNo_GotFocus(sender As Object, e As EventArgs) Handles cbo_LotNo.GotFocus

        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Fibre_Lot_Head", "LotNo_Name", "", "(Lot_Idno = 0)")

    End Sub
    Private Sub cbo_LotNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_LotNo.KeyDown

        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_LotNo, cbo_Fibre, cbo_Mill, "Fibre_Lot_Head", "LotNo_Name", "", "(Lot_Idno = 0)")

    End Sub

    Private Sub cbo_LotNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_LotNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_LotNo, cbo_Mill, "Fibre_Lot_Head", "LotNo_Name", "", "(Lot_Idno = 0)")
