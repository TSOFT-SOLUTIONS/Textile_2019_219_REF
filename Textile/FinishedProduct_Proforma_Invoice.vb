Public Class FinishedProduct_Proforma_Invoice
    ...
    Private Pk_Condition As String = "GFPCP-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* ,lh.* from FinishedProduct_Proforma_Head a LEFT OUTER JOIN Ledger_Head lh ON a.Ledger_idno = lh.ledger_idno Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "' and a.Tax_Type = 'GST'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_InvoiceNo.Text = dt1.Rows(0).Item("FinishedProduct_Proforma_No").ToString
                txt_InvoiceNoPrefix.Text = dt1.Rows(0).Item("FinishedProduct_Proforma_No_Prefix").ToString

                dtp_Date.Text = dt1.Rows(0).Item("FinishedProduct_Proforma_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Processed_Item_Name, c.Rack_No, d.Unit_Name from FinishedProduct_Proforma_Details a INNER JOIN Processed_Item_Head b ON a.FinishedProduct_IdNo = b.Processed_Item_IdNo LEFT OUTER JOIN Rack_Head c ON a.Rack_IdNo = c.Rack_IdNo LEFT OUTER JOIN Unit_Head d ON a.Unit_IdNo = d.Unit_IdNo Where a.FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                End With
                da4 = New SqlClient.SqlDataAdapter("Select a.* from  FinishedProduct_Proforma_GST_Tax_Details    a Where a.FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da4.Fill(dt4)
    ...
    Private Sub FinishedProduct_CashSales_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '   AddHandler txt_InvoiceNoPrefix.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        '  AddHandler txt_InvoiceNoPrefix.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Proforma_Invoice_Entry, New_Entry, Me, con, "FinishedProduct_Proforma_Head", "FinishedProduct_Proforma_Code", NewCode, "FinishedProduct_Proforma_Date", "(FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Try
            ...
            cmd.CommandText = "delete from FinishedProduct_Proforma_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from FinishedProduct_Proforma_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "Delete from FinishedProduct_Proforma_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FinishedProduct_Proforma_No from FinishedProduct_Proforma_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%' and Tax_Type = 'GST' Order by for_Orderby, FinishedProduct_Proforma_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FinishedProduct_Proforma_No from FinishedProduct_Proforma_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%' and Tax_Type = 'GST' Order by for_Orderby, FinishedProduct_Proforma_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 FinishedProduct_Proforma_No from FinishedProduct_Proforma_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%' and Tax_Type = 'GST' Order by for_Orderby desc, FinishedProduct_Proforma_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "FinishedProduct_Proforma_Head", "FinishedProduct_Proforma_Code", "For_OrderBy", "(FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_InvoiceNo.ForeColor = Color.Red

            msk_Date.Text = Date.Today.ToShortDateString
            Da1 = New SqlClient.SqlDataAdapter("select Top 1 a.*, b.ledger_name as SalesAcName from FinishedProduct_Proforma_Head a LEFT OUTER JOIN Ledger_Head b ON a.SalesAc_IdNo = b.Ledger_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " AND FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%' AND  a.FinishedProduct_Proforma_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.FinishedProduct_Proforma_No desc", con)
            Da1.Fill(Dt1)

            If Dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)

                    If Dt1.Rows(0).Item("FinishedProduct_Proforma_Date").ToString <> "" Then msk_Date.Text = Dt1.Rows(0).Item("FinishedProduct_Proforma_Date").ToString
                End If
                If Val(Dt1.Rows(0).Item("GST_Tax_Invoice_Status").ToString) = 1 Then chk_GSTTax_Invocie.Checked = True Else chk_GSTTax_Invocie.Checked = False
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Dim vFPInvNo As String = ""
        Dim FPInvCode As String = ""
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select FinishedProduct_Proforma_No from FinishedProduct_Proforma_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code = '" & Trim(InvCode) & "' and FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%' and Tax_Type = 'GST'", con)
            Da.Fill(Dt)
            ...
            FPInvCode = "GFPIN-" & Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)

            Da = New SqlClient.SqlDataAdapter("Select FinishedProduct_Invoice_No from FinishedProduct_Invoice_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Invoice_Code = '" & Trim(FPInvCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
            ...
            If Dt.Rows.Count > 0 Then
                If IsDBNull(Dt.Rows(0)(0).ToString) = False Then
                    vFPInvNo = Trim(Dt.Rows(0)(0).ToString)
                End If
            End If
            Dt.Clear()
            ...
            ElseIf Val(vFPInvNo) <> 0 Then
                MessageBox.Show("This Invoice No. in FP Invoice", "DOES NOT FIND...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Proforma_Invoice_Entry, New_Entry, Me) = False Then Exit Sub
        ...
        Try
            ...
            ElseIf Val(vFPInvNo) <> 0 Then
                MessageBox.Show("Already this Invoice No. in FP Invoice", "DOES NOT INSERT NEW BILL...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_Proforma_Invoice_Entry, New_Entry, Me, con, "FinishedProduct_Proforma_Head", "FinishedProduct_Proforma_Code", NewCode, "FinishedProduct_Proforma_Date", "(FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, FinishedProduct_Proforma_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "FinishedProduct_Proforma_Head", "FinishedProduct_Proforma_Code", "For_OrderBy", "(FinishedProduct_Proforma_Code LIKE '" & Trim(Pk_Condition) & "%')", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into FinishedProduct_Proforma_Head ( FinishedProduct_Proforma_Code ,               Company_IdNo       ,     FinishedProduct_Proforma_No  ,                     for_OrderBy                                            , FinishedProduct_Proforma_Date  ,              Ledger_Idno           ,          Agent_IdNo    ,            SalesAc_IdNo    ,           Transport_IdNo  ,           Vehicle_No              ,          Total_Quantity  ,          Total_Meters     ,               Total_Amount            ,             Discount_Percentage    ,              Discount_Amount         ,     Tax_Type           ,              Freight_Amount     ,              AddLess_Amount       ,               RoundOff_Amount      ,                  Net_Amount               ,               Prepared_By          ,               Note              ,           Total_Taxable_Value  ,Total_CGST_Amount                      ,Total_SGST_Amount                    ,Total_IGST_Amount                     ,Electronic_Reference_No                 ,Date_And_Time_Of_Supply                     ,Transport_Mode                         , GST_Tax_Invoice_Status              ,FinishedProduct_Proforma_No_Prefix ) " & _
            ...
            With dgv_Tax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into FinishedProduct_Proforma_GST_Tax_Details   ( FinishedProduct_Proforma_Code  ,               Company_IdNo       ,      FinishedProduct_Proforma_No    ,                               for_OrderBy             , FinishedProduct_Proforma_Date  ,         Ledger_IdNo     ,            Sl_No     , HSN_Code                               ,Taxable_Amount                            ,CGST_Percentage                           ,CGST_Amount                               ,SGST_Percentage                            ,SGST_Amount                              ,IGST_Percentage                          ,IGST_Amount ) " & _
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FinishedProduct_Proforma_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = "a.FinishedProduct_Proforma_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = "a.FinishedProduct_Proforma_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            da = New SqlClient.SqlDataAdapter("select a.* from FinishedProduct_Proforma_Head a where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_Proforma_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and a.Tax_Type = 'GST' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.FinishedProduct_Proforma_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("FinishedProduct_Proforma_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("FinishedProduct_Proforma_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.FP_Proforma_Invoice_Entry, New_Entry) = False Then Exit Sub
    ...
    Public Sub printing_invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from FinishedProduct_Proforma_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*,tP.Ledger_Name as LedgerName ,tP.Ledger_GSTinNo , d.Ledger_Name as Transport_Name , Csh.State_Name as Company_State_Name , Csh.State_Code as Company_State_Code ,e.Ledger_Name as Agent_Name from FinishedProduct_Proforma_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo LEFT OUTER JOIN State_Head Csh ON b.Company_State_IdNo = Csh.State_IdNo  LEFT OUTER JOIN Ledger_Head d ON d.Ledger_IdNo =a.Transport_IdNo LEFT OUTER JOIN Ledger_Head e ON e.Ledger_IdNo =a.Agent_IdNo   LEFT OUTER JOIN Ledger_Head tP ON tP.Ledger_IdNo =a.Ledger_IdNo  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Processed_Item_Name, d.Unit_Name from FinishedProduct_Proforma_Details a INNER JOIN Processed_Item_Head b ON a.FinishedProduct_IdNo = b.Processed_Item_IdNo  LEFT OUTER JOIN Unit_Head d ON a.Unit_IdNo = d.Unit_IdNo Where a.FinishedProduct_Proforma_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format2(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                CurY = TMargin + 150
                p1Font = New Font("Calibri", 14, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_No").ToString, CurX, CurY, 0, 0, p1Font)
                CurY = TMargin + 170
                Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_Date").ToString), "dd-MM-yyyy"), CurX, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_TransportMode_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_TransportMode.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "FinishedProduct_Proforma_Head", "Transport_Mode", "", "")
    ...
    Private Sub cbo_TransportMode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportMode.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportMode, txt_DateAndTimeOFSupply, cbo_Agent, "FinishedProduct_Proforma_Head", "Transport_Mode", "", "")
    End Sub
    ...
    Private Sub cbo_TransportMode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportMode.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportMode, cbo_Agent, "FinishedProduct_Proforma_Head", "Transport_Mode", "", "", False)
    End Sub
    ...
    Private Sub Cbo_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_PartyName, Nothing, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    ...
    Private Sub Cbo_PartyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_PartyName, txt_ElectronicRefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    ...
    Private Sub Printing_GST_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "TO  :  " & "M/s." & prn_HdDt.Rows(0).Item("LedgerName").ToString, LMargin + 10, CurY, 0, 0, p1Font)
            Common_Procedures.Print_To_PrintDocument(e, "NO", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, IIf(Trim(prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString) <> "", "GSTIN : " & prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString, ""), LMargin + S1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "DATE", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("FinishedProduct_Proforma_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1005" Then
                ...
                ElseIf InStr(UCase(Trim(prn_HdDt.Rows(0).Item("Company_Name").ToString)), "JENO") > 0 Then
                    ...
                    p1Font = New Font("Calibri", 12, FontStyle.Bold)
                    Common_Procedures.Print_To_PrintDocument(e, "AC No. : 02850095604720501", LMargin, CurY, 2, PageClm_Width, p1Font)
