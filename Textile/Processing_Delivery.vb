Public Class Processing_Delivery
    ...
    Private Pk_Condition As String = "FPRDC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name , c.Ledger_Name as Transport_Name from Cloth_Processing_Delivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN Ledger_Head c ON a.Transport_IdNo = c.Ledger_IdNo  Where a.ClothProcess_Delivery_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(6).Value = Val(dt2.Rows(i).Item("Delivery_Pcs").ToString)
                        dgv_Details.Rows(n).Cells(7).Value = Val(dt2.Rows(i).Item("Delivery_Qty").ToString)
                        dgv_Details.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Meter_Qty").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("Delivery_Meters").ToString), "########0.00")

                        dgv_Details.Rows(n).Cells(10).Value = Format(Val(dt2.Rows(i).Item("Delivery_Weight").ToString), "########0.000")
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(9).Value = Format(Val(dt1.Rows(0).Item("Total_Meters").ToString), "########0.00")
                    .Rows(0).Cells(10).Value = Format(Val(dt1.Rows(0).Item("Total_Weight").ToString), "########0.000")
                End With
    ...
    Private Sub Processing_Delivery_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(UCase(EntFnYrCode)) <> Trim(UCase(Common_Procedures.FnYearCode)) Then
            lnl_EntHeading.Text = "PROCESSING DELIVERY (OPENING)"
        Else
            lnl_EntHeading.Text = "PROCESSING DELIVERY"
        End If
    ...
    Private Sub processing_Delivery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
        Common_Procedures.Hide_CurrentStock_Display()
    End Sub

    Private Sub Processing_Delivery_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Processing_Delivery_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Processing_Delivery_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.FP_Processing_Delivery_Entry, New_Entry, Me, con, "Cloth_Processing_Delivery_Head", "ClothProcess_Delivery_Code", NewCode, "ClothProcess_Delivery_Date", "(ClothProcess_Delivery_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Receipt_Meters) from Cloth_Processing_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Delivery_code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Return_Meters) from Cloth_Processing_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Delivery_code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
        ...
        Try
            ...
            cmd.CommandText = "delete from Cloth_Processing_Delivery_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Cloth_Processing_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Delivery_No from Cloth_Processing_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, ClothProcess_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Delivery_No from Cloth_Processing_Delivery_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby, ClothProcess_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Delivery_No from Cloth_Processing_Delivery_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, ClothProcess_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 ClothProcess_Delivery_No from Cloth_Processing_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code like '%/" & Trim(EntFnYrCode) & "' Order by for_Orderby desc, ClothProcess_Delivery_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Delivery_Head", "ClothProcess_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select ClothProcess_Delivery_No from Cloth_Processing_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        ' If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Processing_Delivery_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Processing_Delivery_Entry, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.FP_Processing_Delivery_Entry, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        ' If Common_Procedures.UserRight_Check(Common_Procedures.UR.Processing_Delivery_Entry, New_Entry) = False Then Exit Sub
      


        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.FP_Processing_Delivery_Entry, New_Entry, Me, con, "Cloth_Processing_Delivery_Head", "ClothProcess_Delivery_Code", NewCode, "ClothProcess_Delivery_Date", "(ClothProcess_Delivery_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, ClothProcess_Delivery_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        With dgv_Details
            For i = 0 To dgv_Details.RowCount - 1
                If Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Or Val(.Rows(i).Cells(10).Value) <> 0 Then
                    ...
                    If Val(dgv_Details.Rows(i).Cells(9).Value) = 0 Then
                        ...
                        dgv_Details.CurrentCell = dgv_Details.Rows(0).Cells(9)
                        Exit Sub
                    End If
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vTotMtrs = Val(dgv_Details_Total.Rows(0).Cells(9).Value())
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Cloth_Processing_Delivery_Head", "ClothProcess_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), EntFnYrCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Cloth_Processing_Delivery_Head(ClothProcess_Delivery_Code, Company_IdNo, ClothProcess_Delivery_No, for_OrderBy, ClothProcess_Delivery_Date, Ledger_IdNo, Purchase_OrderNo, Transport_IdNo, Freight_Charges, Note,Total_Pcs,Total_Qty, Total_Meters, Total_Weight,  User_IdNo  ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DeliveryDate, " & Str(Val(Led_ID)) & ", '" & Trim(txt_PoNo.Text) & "', " & Str(Val(Tr_ID)) & ", " & Str(Val(txt_Frieght.Text)) & ",  '" & Trim(txt_Note.Text) & "'," & Str(Val(vTotPcs)) & "," & Str(Val(vtotqty)) & " , " & Str(Val(vTotMtrs)) & ", " & Str(Val(vTotWeight)) & ", " & Val(lbl_UserName.Text) & ")"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Cloth_Processing_Delivery_Head set ClothProcess_Delivery_Date = @DeliveryDate, Ledger_IdNo = " & Val(Led_ID) & ", Purchase_OrderNo = '" & Trim(txt_PoNo.Text) & "' , Transport_IdNo = " & Val(Tr_ID) & ", Freight_Charges = " & Val(txt_Frieght.Text) & ", Note = '" & Trim(txt_Note.Text) & "', Total_Pcs = " & Val(vTotPcs) & ",Total_Qty = " & Val(vtotqty) & ", Total_Meters = " & Val(vTotMtrs) & ",Total_Weight = " & Val(vTotWeight) & ", User_IdNo = " & Val(lbl_UserName.Text) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from Cloth_Processing_Delivery_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Delivery_Code = '" & Trim(NewCode) & "' and Receipt_Meters = 0 And Return_Meters = 0 "
            cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(9).Value) <> 0 Or Val(.Rows(i).Cells(10).Value) <> 0 Then
                        Sno = Sno + 1
                        ...
                        Nr = 0
                        cmd.CommandText = "Update  Cloth_Processing_Delivery_Details set Cloth_Processing_Delivery_Date = @DeliveryDate , Ledger_IdNo = " & Str(Val(Led_ID)) & ", Sl_No  = " & Str(Val(Sno)) & " , Item_Idno = " & Str(Val(itgry_id)) & " , Item_To_Idno = " & Str(Val(Itfp_ID)) & " , Colour_Idno = " & Val(Col_ID) & " , Lot_IdNo = " & Val(Lot_ID) & " ,Processing_Idno = " & Val(Proc_ID) & " , Delivery_Pcs =  " & Val(.Rows(i).Cells(6).Value) & ", Delivery_Qty = " & Val(.Rows(i).Cells(7).Value) & " ,  Meter_Qty = " & Str(Val(.Rows(i).Cells(8).Value)) & " ,    Delivery_Meters = " & Str(Val(.Rows(i).Cells(9).Value)) & " ,    Delivery_Weight = " & Str(Val(.Rows(i).Cells(10).Value)) & " where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Cloth_Processing_Delivery_code = '" & Trim(NewCode) & "'  and Cloth_Processing_Delivery_Slno = " & Val(.Rows(i).Cells(11).Value)
                        Nr = cmd.ExecuteNonQuery()

                        If Nr = 0 Then
                            cmd.CommandText = "Insert into Cloth_Processing_Delivery_Details(Cloth_Processing_Delivery_Code, Company_IdNo, Cloth_Processing_Delivery_No, for_OrderBy, Cloth_Processing_Delivery_Date,Sl_No, Ledger_IdNo,  Item_Idno,Item_To_Idno, Colour_Idno ,Lot_IdNo,Processing_Idno,Delivery_Pcs,Delivery_Qty,Meter_Qty,Delivery_Meters,Delivery_Weight ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ", @DeliveryDate," & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & " ," & Str(Val(itgry_id)) & ", " & Str(Val(Itfp_ID)) & ", " & Val(Col_ID) & ", " & Val(Lot_ID) & " , " & Val(Proc_ID) & " ," & Val(.Rows(i).Cells(6).Value) & ", " & Val(.Rows(i).Cells(7).Value) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & ", " & Str(Val(.Rows(i).Cells(9).Value)) & " ," & Str(Val(.Rows(i).Cells(10).Value)) & ")"
                            cmd.ExecuteNonQuery()
                        End If
    ...
    Private Sub Total_Calculation()
        ...
        With dgv_Details
            For i = 0 To dgv_Details.Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(6).Value) <> 0 Or Val(dgv_Details.Rows(i).Cells(9).Value) <> 0 Or Val(dgv_Details.Rows(i).Cells(10).Value) <> 0 Then
                    ...
                    vTotMtrs = vTotMtrs + Val(dgv_Details.Rows(i).Cells(9).Value)
                    vtotweight = vtotweight + Val(dgv_Details.Rows(i).Cells(10).Value)
                End If
            Next
        End With
        ...
        dgv_Details_Total.Rows(0).Cells(9).Value = Format(Val(vTotMtrs), "#########0.00")
        dgv_Details_Total.Rows(0).Cells(10).Value = Format(Val(vtotweight), "#########0.000")
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, txt_PoNo, Nothing, "Ledger_AlaisHead", "Ledger_DisplayName", " (Ledger_Type = '' and ( AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) and Verified_Status = 1)", "(Ledger_idno = 0)")
    ...
    Private Sub dgv_Details_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellEnter
        ...
        With dgv_Details
            ...
            If e.ColumnIndex = 1 And (Val(.Rows(.CurrentCell.RowIndex).Cells(12).Value)) = 0 Then
            ...
            If e.ColumnIndex = 2 And (Val(.Rows(.CurrentCell.RowIndex).Cells(12).Value)) = 0 Then
            ...
            If e.ColumnIndex = 3 And (Val(.Rows(.CurrentCell.RowIndex).Cells(12).Value)) = 0 Then
            ...
            If e.ColumnIndex = 9 And dgv_LevColNo <> 9 Then
                Show_Item_CurrentStock(e.RowIndex)
                .Focus()
            End If
    ...
    Private Sub dgv_Details_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Details.CellValueChanged
        ...
        With dgv_Details
            If .Visible Then
                If .CurrentCell.ColumnIndex = 6 Or .CurrentCell.ColumnIndex = 7 Or .CurrentCell.ColumnIndex = 8 Or .CurrentCell.ColumnIndex = 9 Or .CurrentCell.ColumnIndex = 10 Then

                    If Val(.CurrentCell.ColumnIndex) = 7 Or Val(.CurrentCell.ColumnIndex) = 8 Then
    ...
    Private Sub cbo_lotno_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_LotNo.TextChanged
        Try
            If cbo_LotNo.Visible Then
                With dgv_Details
                    If Val(cbo_LotNo.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 4 Then
    ...
    Private Sub cbo_Processing_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Processing.TextChanged
        Try
            If cbo_Processing.Visible Then
                With dgv_Details
                    If Val(cbo_Processing.Tag) = Val(.CurrentCell.RowIndex) And .CurrentCell.ColumnIndex = 5 Then
    ...
    Private Sub cbo_itemfp_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_itemfp.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_itemfp, cbo_itemgrey, cbo_Colour, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1 )", "(Processed_Item_idno = 0)")
        With dgv_Details
    ...
    Private Sub cbo_itemfp_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_itemfp.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_itemfp, cbo_Colour, "Processed_Item_Head", "Processed_Item_Name", "(Processed_Item_idno = 0 or Processed_Item_Type = 'FP' and Verified_Status = 1)", "(Processed_Item_idno = 0)")
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,c.*,d.Processed_Item_Name,e.Process_Name from Cloth_Processing_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Cloth_Processing_Delivery_Details c ON c.Cloth_Processing_Delivery_Code = a.ClothProcess_Delivery_Code INNER JOIN Processed_Item_Head d ON d.Processed_Item_IdNo = c.Item_IdNo LEFT OUTER JOIN Process_Head e ON c.Processing_Idno = e.Process_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.ClothProcess_Delivery_Code LIKE '%/" & Trim(EntFnYrCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.ClothProcess_Delivery_No", con)
            da.Fill(dt2)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.PrintEntry, Common_Procedures.UR.FP_Processing_Delivery_Entry, New_Entry) = False Then Exit Sub

        Try

            da1 = New SqlClient.SqlDataAdapter("select * from Cloth_Processing_Delivery_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and ClothProcess_Delivery_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        For I = 0 To PrintDocument1.PrinterSettings.PaperSizes.Count - 1
            ...
            If (ps.Width >= 798 And ps.Width <= 810) And (ps.Height >= 598 And ps.Height <= 610) Then
        ...
        ClArr(1) = Val(35) : ClArr(2) = 180 : ClArr(3) = 90 : ClArr(4) = 80 : ClArr(5) = 130 : ClArr(6) = 70 : ClArr(7) = 85
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        End If
                        If Val(prn_DetDt.Rows(prn_DetIndx).Item("Delivery_Qty").ToString) <> 0 Then
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Delivery_Qty").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 10, CurY, 1, 0, pFont)
                        End If
                        ...
                        HSN_Code = ""
                        Da1 = New SqlClient.SqlDataAdapter("select a.* from ItemGroup_Head a INNER JOIN Processed_Item_Head b ON a.ItemGroup_IdNo = b.Processed_ItemGroup_IdNo Where b.Processed_Item_IdNo = " & Str(Val(prn_DetDt.Rows(prn_DetIndx).Item("Item_IdNo").ToString)), con)
                        Dt2 = New DataTable
                        Da1.Fill(Dt2)

                        If Dt2.Rows.Count > 0 Then
                            If IsDBNull(Dt2.Rows(0).Item("Item_HSN_Code").ToString) = False Then
                                HSN_Code = Trim(Dt2.Rows(0).Item("Item_HSN_Code").ToString)
                            End If
                        End If
                        Dt2.Clear()

                        If Trim(HSN_Code) <> "" Then
                            CurY = CurY + TxtHgt - 5
                            p1FonT = New Font("Calibri", 11, FontStyle.Regular)
                            Common_Procedures.Print_To_PrintDocument(e, "HSN CODE :" & Trim(HSN_Code), LMargin + ClArr(1) + 25, CurY, 0, 0, p1Font)
                            NoofDets = NoofDets + 1
                        End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Dim Entry_Date As Date = Convert.ToDateTime(prn_HdDt.Rows(0).Item("ClothProcess_Delivery_Date").ToString)
        ...
        Try
            ...
            Else
                If prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString <> "" Then
                    Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString, LMargin + S1 + 10, CurY, 0, 0, pFont)
                End If
    ...
    Private Sub cbo_TransportName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportName.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportName, Nothing, txt_Frieght, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT'and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_Transportname_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportName, txt_Frieght, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'TRANSPORT' and Verified_Status = 1)", "(Ledger_IdNo = 0)")
    End Sub
