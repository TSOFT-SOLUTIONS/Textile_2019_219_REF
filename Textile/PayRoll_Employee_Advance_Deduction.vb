Public Class PayRoll_Employee_Advance_Deduction
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_MessAmount.Text = Format(Val(dt1.Rows(0).Item("Mess_Amount").ToString), "#########0.00")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.DeletingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ADVANCE_ADDITION, New_Entry, Me, con, "PayRoll_Employee_Deduction_Head", "Employee_Deduction_Code", NewCode, "Employee_Deduction_Date", "(Employee_Deduction_Code = '" & Trim(NewCode) & "')") = False Then Exit Sub
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Dim NewCode As String
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.InsertingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ADVANCE_ADDITION, New_Entry, Me) = False Then Exit Sub
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 * from PayRoll_Employee_Deduction_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Employee_Deduction_No desc", con)
            dt1 = New DataTable
            da.Fill(dt1)
            If dt1.Rows.Count > 0 Then
                If Val(Common_Procedures.settings.PreviousEntryDate_ByDefault) = 1 Then '---- M.S Textiles (Tirupur)
                    If dt1.Rows(0).Item("Employee_Deduction_Date").ToString <> "" Then msk_Date.Text = dt1.Rows(0).Item("Employee_Deduction_Date").ToString
                End If
            End If
            dt1.Clear()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_NEWCheck(Common_Procedures.UserRightsCheckFor.SavingEntry, Common_Procedures.UR.PAYROLL_ENTRY_EMPLOYEE_ADVANCE_ADDITION, New_Entry, Me, con, "PayRoll_Employee_Deduction_Head", "Employee_Deduction_Code", NewCode, "Employee_Deduction_Date", "(Employee_Deduction_Code = '" & Trim(NewCode) & "')", "(Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "')", "for_Orderby desc, Employee_Deduction_No desc", dtp_Date.Value.Date) = False Then Exit Sub
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@EmpDate", Convert.ToDateTime(msk_Date.Text))

            If New_Entry = True Then

                cmd.CommandText = "Insert into PayRoll_Employee_Deduction_Head( Employee_Deduction_Code, Company_IdNo, Employee_Deduction_No, for_OrderBy, Employee_Deduction_Date, Employee_IdNo,    Advance_Deduction_Amount   ,Remarks ,Mess_Amount ) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_Refno.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Refno.Text))) & ", @EmpDate, " & Val(Emp_id) & "," & Val(txt_Amount.Text) & ",'" & Trim(txt_remarks.Text) & "' ," & Val(txt_MessAmount.Text) & " )"

                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update  PayRoll_Employee_Deduction_Head set Employee_Deduction_Date = @EmpDate, Employee_IdNo = " & Val(Emp_id) & ", Advance_Deduction_Amount = " & Val(txt_Amount.Text) & ", Remarks = '" & Trim(txt_remarks.Text) & "',Mess_Amount = " & Val(txt_MessAmount.Text) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  Employee_Deduction_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_PartyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_EmployeeName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_EmployeeName, msk_Date, txt_Amount, "PayRoll_Employee_Head", "Employee_Name", "", "(Employee_IdNo = 0)")
    ...
    Private Sub Employee_Deduction_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_MessAmount.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_MessAmount.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_MessAmount.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_MessAmount.KeyPress, AddressOf TextBoxControlKeyPress
